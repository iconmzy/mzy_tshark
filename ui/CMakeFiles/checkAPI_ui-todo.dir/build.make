...
ui/CMakeFiles/checkAPI_ui-todo:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/CLionProjects/tshark_test/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running checkAPI_ui-todo"
	cd /root/CLionProjects/tshark_test/ui && /usr/bin/perl /root/CLionProjects/tshark_test/tools/checkAPIs.pl -M alert_box.c capture.c capture_ui_utils.c clopts_common.c cmdarg_err.c commandline.c console.c decode_as_utils.c dissect_opts.c export_object_ui.c export_pdu_ui_utils.c help_url.c failure_message.c file_dialog.c filter_files.c firewall_rules.c iface_toolbar.c iface_lists.c io_graph_item.c language.c mcast_stream.c packet_list_utils.c packet_range.c persfilepath_opt.c preference_utils.c profile.c proto_hier_stats.c recent.c rtp_media.c rtp_stream.c rtp_stream_id.c service_response_time.c software_update.c ssl_key_export.c summary.c tap_export_pdu.c tap-iax2-analysis.c tap-rtp-analysis.c tap-rtp-common.c tap-sctp-analysis.c tap-rlc-graph.c tap-tcp-stream.c text_import.c time_shift.c traffic_table_ui.c util.c voip_calls.c
