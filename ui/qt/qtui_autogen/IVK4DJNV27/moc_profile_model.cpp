...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProfileSortModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProfileSortModel_t qt_meta_stringdata_ProfileSortModel = {
    {
QT_MOC_LITERAL(0, 0, 16) // "ProfileSortModel"
...
const QMetaObject ProfileSortModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_ProfileSortModel.data,
      qt_meta_data_ProfileSortModel,  qt_static_metacall, nullptr, nullptr}
};
...
void ProfileModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ProfileModel *_t = static_cast<ProfileModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemChanged((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ProfileModel::*_t)(const QModelIndex & );
...
const QMetaObject ProfileModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_ProfileModel.data,
      qt_meta_data_ProfileModel,  qt_static_metacall, nullptr, nullptr}
};
