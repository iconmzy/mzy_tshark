/****************************************************************************
** Meta object code from reading C++ file 'path_chooser_delegate.h'
**
...
#include "../../models/path_chooser_delegate.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'path_chooser_delegate.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PathChooserDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PathChooserDelegate_t qt_meta_stringdata_PathChooserDelegate = {
    {
QT_MOC_LITERAL(0, 0, 19), // "PathChooserDelegate"
QT_MOC_LITERAL(1, 20, 19), // "browseButtonClicked"
QT_MOC_LITERAL(2, 40, 0) // ""

    },
    "PathChooserDelegate\0browseButtonClicked\0"
    ""
};
...
const QMetaObject PathChooserDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_PathChooserDelegate.data,
      qt_meta_data_PathChooserDelegate,  qt_static_metacall, nullptr, nullptr}
};
...
void *PathChooserDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PathChooserDelegate.stringdata0))
