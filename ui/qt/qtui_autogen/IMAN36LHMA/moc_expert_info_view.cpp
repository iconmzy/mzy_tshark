...
QT_MOC_LITERAL(6, 63, 7), // "current"
QT_MOC_LITERAL(7, 71, 8) // "previous"

    },
    "ExpertInfoTreeView\0goToPacket\0\0"
    "packet_num\0hf_id\0currentChanged\0current\0"
    "previous"
};
...
void ExpertInfoTreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ExpertInfoTreeView::*_t)(int , int );
...
const QMetaObject ExpertInfoTreeView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_ExpertInfoTreeView.data,
      qt_meta_data_ExpertInfoTreeView,  qt_static_metacall, nullptr, nullptr}
};
