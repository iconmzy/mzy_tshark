...
public:
    ...
    void setupUi(AccordionFrame *PreferenceEditorFrame)
    {
        ...
        preferenceBrowseButton->setObjectName(QStringLiteral("preferenceBrowseButton"));
    ...
    {
        PreferenceEditorFrame->setWindowTitle(QApplication::translate("PreferenceEditorFrame", "Frame", Q_NULLPTR));
        modulePreferencesToolButton->setText(QApplication::translate("PreferenceEditorFrame", "\342\200\246", Q_NULLPTR));
        preferenceTitleLabel->setText(QApplication::translate("PreferenceEditorFrame", "a preference", Q_NULLPTR));
        preferenceBrowseButton->setText(QApplication::translate("PreferenceEditorFrame", "Browse\342\200\246", Q_NULLPTR));
    } // retranslateUi
