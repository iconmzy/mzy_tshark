...
public:
    ...
    {
        SCTPAssocAnalyseDialog->setWindowTitle(QApplication::translate("SCTPAssocAnalyseDialog", "Wireshark - Analyse Association", Q_NULLPTR));
        SCTPAssocAnalyseTab->setWindowTitle(QApplication::translate("SCTPAssocAnalyseDialog", "TabWidget", Q_NULLPTR));
        chunkStatisticsButton->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Chunk Statistics", Q_NULLPTR));
        setFilterButton->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Filter Association", Q_NULLPTR));
        pushButton->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Close", Q_NULLPTR));
        label_17->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Number of Data Chunks from EP2 to EP1: ", Q_NULLPTR));
        label_15->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Checksum Type:", Q_NULLPTR));
        label_16->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Number of Data Chunks from EP1 to EP2: ", Q_NULLPTR));
        label_13->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Number of Data Bytes from EP1 to EP2:", Q_NULLPTR));
        label_18->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Number of Data Bytes from EP2 to EP1: ", Q_NULLPTR));
        data12Label->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        checksumLabel->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        bytes12Label->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        data21Label->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        bytes21Label->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        SCTPAssocAnalyseTab->setTabText(SCTPAssocAnalyseTab->indexOf(Statistics), QApplication::translate("SCTPAssocAnalyseDialog", "Statistics", Q_NULLPTR));
        GraphTSN_1->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Graph TSN", Q_NULLPTR));
        GraphBytes_1->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Graph Bytes", Q_NULLPTR));
        labelEP1->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Complete list of IP Addresses as provided in the INIT Chunk", Q_NULLPTR));
        label_213->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Requested Number of Inbound Streams:", Q_NULLPTR));
        label_211->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Port:", Q_NULLPTR));
        label_222->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_212->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Sent Verification Tag:", Q_NULLPTR));
        label_224->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_214->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Minimum Number of Inbound Streams:", Q_NULLPTR));
        label_221->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_215->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Minimum Number of Outbound Streams:", Q_NULLPTR));
        label_223->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_225->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_216->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_226->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Close", Q_NULLPTR));
        GraphArwnd_1->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Graph Arwnd", Q_NULLPTR));
        SCTPAssocAnalyseTab->setTabText(SCTPAssocAnalyseTab->indexOf(Endpoint_1), QApplication::translate("SCTPAssocAnalyseDialog", "Endpoint 1", Q_NULLPTR));
        GraphTSN_2->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Graph TSN", Q_NULLPTR));
        GraphBytes_2->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Graph Bytes", Q_NULLPTR));
        label_313->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Requested Number of Inbound Streams:", Q_NULLPTR));
        label_324->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_321->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_312->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Sent Verification Tag:", Q_NULLPTR));
        label_316->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Minimum Number of Outbound Streams:", Q_NULLPTR));
        label_311->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Port:", Q_NULLPTR));
        label_314->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Minimum Number of Inbound Streams:", Q_NULLPTR));
        label_322->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_323->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_326->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        label_315->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Provided Number of Outbound Streams:", Q_NULLPTR));
        label_325->setText(QApplication::translate("SCTPAssocAnalyseDialog", "TextLabel", Q_NULLPTR));
        labelEP2->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Complete list of IP Addresses as provided in the INIT-ACK Chunk", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Close", Q_NULLPTR));
        GraphArwnd_2->setText(QApplication::translate("SCTPAssocAnalyseDialog", "Graph a_rwnd", Q_NULLPTR));
        SCTPAssocAnalyseTab->setTabText(SCTPAssocAnalyseTab->indexOf(Endpoint_2), QApplication::translate("SCTPAssocAnalyseDialog", "Endpoint 2", Q_NULLPTR));
    } // retranslateUi
