...
public:
    ...
    {
        groupBox->setTitle(QApplication::translate("RsaKeysFrame", "RSA Keys", Q_NULLPTR));
        keysLabel->setText(QApplication::translate("RsaKeysFrame", "RSA private keys are loaded from a file or PKCS #11 token.", Q_NULLPTR));
        addFileButton->setText(QApplication::translate("RsaKeysFrame", "Add new keyfile\342\200\246", Q_NULLPTR));
        addItemButton->setText(QApplication::translate("RsaKeysFrame", "Add new token\342\200\246", Q_NULLPTR));
        deleteItemButton->setText(QApplication::translate("RsaKeysFrame", "Remove key", Q_NULLPTR));
        libsLabel->setText(QApplication::translate("RsaKeysFrame", "PKCS #11 provider libraries.", Q_NULLPTR));
        addLibraryButton->setText(QApplication::translate("RsaKeysFrame", "Add new provider\342\200\246", Q_NULLPTR));
        deleteLibraryButton->setText(QApplication::translate("RsaKeysFrame", "Remove provider", Q_NULLPTR));
