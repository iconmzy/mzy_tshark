...
public:
    ...
    {
        PacketFormatGroupBox->setWindowTitle(QApplication::translate("PacketFormatGroupBox", "GroupBox", Q_NULLPTR));
        PacketFormatGroupBox->setTitle(QApplication::translate("PacketFormatGroupBox", "Packet Format", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        summaryCheckBox->setToolTip(QApplication::translate("PacketFormatGroupBox", "<html><head/><body><p>Packet summary lines similar to the packet list</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        summaryCheckBox->setText(QApplication::translate("PacketFormatGroupBox", "Summary line", Q_NULLPTR));
        includeColumnHeadingsCheckBox->setText(QApplication::translate("PacketFormatGroupBox", "Include column headings", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        detailsCheckBox->setToolTip(QApplication::translate("PacketFormatGroupBox", "<html><head/><body><p>Packet details similar to the protocol tree</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        detailsCheckBox->setText(QApplication::translate("PacketFormatGroupBox", "Details:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        allCollapsedButton->setToolTip(QApplication::translate("PacketFormatGroupBox", "<html><head/><body><p>Export only top-level packet detail items</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        allCollapsedButton->setText(QApplication::translate("PacketFormatGroupBox", "All co&llapsed", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        asDisplayedButton->setToolTip(QApplication::translate("PacketFormatGroupBox", "<html><head/><body><p>Expand and collapse packet details as they are currently displayed.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        asDisplayedButton->setText(QApplication::translate("PacketFormatGroupBox", "As displa&yed", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        allExpandedButton->setToolTip(QApplication::translate("PacketFormatGroupBox", "<html><head/><body><p>Export all packet detail items</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        allExpandedButton->setText(QApplication::translate("PacketFormatGroupBox", "All e&xpanded", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        bytesCheckBox->setToolTip(QApplication::translate("PacketFormatGroupBox", "<html><head/><body><p>Export a hexdump of the packet data similar to the packet bytes view</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bytesCheckBox->setText(QApplication::translate("PacketFormatGroupBox", "Bytes", Q_NULLPTR));
    } // retranslateUi
