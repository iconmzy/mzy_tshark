...
public:
    ...
    {
        ExportPDUDialog->setWindowTitle(QApplication::translate("ExportPDUDialog", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("ExportPDUDialog", "Display filter:", Q_NULLPTR));
    } // retranslateUi
