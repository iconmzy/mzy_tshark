...
public:
    ...
    {
        SCTPGraphDialog->setWindowTitle(QApplication::translate("SCTPGraphDialog", "SCTP Graph", Q_NULLPTR));
        actionGoToPacket->setText(QApplication::translate("SCTPGraphDialog", "goToPacket", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionGoToPacket->setToolTip(QApplication::translate("SCTPGraphDialog", "Go to Packet", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        relativeTsn->setText(QApplication::translate("SCTPGraphDialog", "Relative TSNs", Q_NULLPTR));
        pushButton->setText(QApplication::translate("SCTPGraphDialog", "Only SACKs", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("SCTPGraphDialog", "Only TSNs", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("SCTPGraphDialog", "Show both", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("SCTPGraphDialog", "Reset to full size", Q_NULLPTR));
        saveButton->setText(QApplication::translate("SCTPGraphDialog", "Save Graph", Q_NULLPTR));
    } // retranslateUi
