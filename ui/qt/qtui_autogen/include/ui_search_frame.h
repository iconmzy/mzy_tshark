...
public:
    ...
    {
        SearchFrame->setWindowTitle(QApplication::translate("SearchFrame", "Frame", Q_NULLPTR));
        searchInComboBox->clear();
        searchInComboBox->insertItems(0, QStringList()
         << QApplication::translate("SearchFrame", "Packet list", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "Packet details", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "Packet bytes", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        searchInComboBox->setToolTip(QApplication::translate("SearchFrame", "<html><head/><body><p>Search the Info column of the packet list (summary pane), decoded packet display labels (tree view pane) or the ASCII-converted packet data (hex view pane).</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        charEncodingComboBox->clear();
        charEncodingComboBox->insertItems(0, QStringList()
         << QApplication::translate("SearchFrame", "Narrow & Wide", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "Narrow (UTF-8 / ASCII)", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "Wide (UTF-16)", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        charEncodingComboBox->setToolTip(QApplication::translate("SearchFrame", "<html><head/><body><p>Search for strings containing narrow (UTF-8 and ASCII) or wide (UTF-16) characters.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        caseCheckBox->setText(QApplication::translate("SearchFrame", "Case sensitive", Q_NULLPTR));
        searchTypeComboBox->clear();
        searchTypeComboBox->insertItems(0, QStringList()
         << QApplication::translate("SearchFrame", "Display filter", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "Hex value", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "String", Q_NULLPTR)
         << QApplication::translate("SearchFrame", "Regular Expression", Q_NULLPTR)
        );
#ifndef QT_NO_TOOLTIP
        searchTypeComboBox->setToolTip(QApplication::translate("SearchFrame", "<html><head/><body><p>Search for data using display filter syntax (e.g. ip.addr==10.1.1.1), a hexadecimal string (e.g. fffffda5), a plain string (e.g. My String) or a regular expression (e.g. colou?r).</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        findButton->setText(QApplication::translate("SearchFrame", "Find", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("SearchFrame", "Cancel", Q_NULLPTR));
    } // retranslateUi
