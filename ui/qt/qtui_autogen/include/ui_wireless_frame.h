...
public:
    ...
    {
        WirelessFrame->setWindowTitle(QApplication::translate("WirelessFrame", "Frame", Q_NULLPTR));
        interfaceLabel->setText(QApplication::translate("WirelessFrame", "Interface", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        channelLabel->setToolTip(QApplication::translate("WirelessFrame", "<html><head/><body><p>Set the 802.11 channel.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        channelLabel->setText(QApplication::translate("WirelessFrame", "Channel", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fcsLabel->setToolTip(QApplication::translate("WirelessFrame", "<html><head/><body><p>When capturing, show all frames, ones that have a valid frame check sequence (FCS), or ones with an invalid FCS.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fcsLabel->setText(QApplication::translate("WirelessFrame", "FCS Filter", Q_NULLPTR));
        fcsComboBox->clear();
        fcsComboBox->insertItems(0, QStringList()
         << QApplication::translate("WirelessFrame", "All Frames", Q_NULLPTR)
         << QApplication::translate("WirelessFrame", "Valid Frames", Q_NULLPTR)
         << QApplication::translate("WirelessFrame", "Invalid Frames", Q_NULLPTR)
        );
        noWirelessLabel->setText(QApplication::translate("WirelessFrame", "Wireless controls are not supported in this version of Wireshark.", Q_NULLPTR));
        helperToolButton->setText(QApplication::translate("WirelessFrame", "External Helper", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        prefsToolButton->setToolTip(QApplication::translate("WirelessFrame", "<html><head/><body><p>Show the IEEE 802.11 preferences, including decryption keys.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        prefsToolButton->setText(QApplication::translate("WirelessFrame", "802.11 Preferences", Q_NULLPTR));
    } // retranslateUi
