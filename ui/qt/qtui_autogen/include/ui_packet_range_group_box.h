...
public:
    ...
    {
        PacketRangeGroupBox->setWindowTitle(QApplication::translate("PacketRangeGroupBox", "Form", Q_NULLPTR));
        PacketRangeGroupBox->setTitle(QApplication::translate("PacketRangeGroupBox", "Packet Range", Q_NULLPTR));
        selectedDisplayedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        displayedButton->setText(QApplication::translate("PacketRangeGroupBox", "Displayed", Q_NULLPTR));
        allCapturedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        markedButton->setText(QApplication::translate("PacketRangeGroupBox", "&Marked packets only", Q_NULLPTR));
        rangeButton->setText(QApplication::translate("PacketRangeGroupBox", "&Range:", Q_NULLPTR));
        rangeDisplayedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        ignoredCheckBox->setText(QApplication::translate("PacketRangeGroupBox", "Remove &ignored packets", Q_NULLPTR));
        markedDisplayedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        ftlMarkedButton->setText(QApplication::translate("PacketRangeGroupBox", "First &to last marked", Q_NULLPTR));
        selectedCapturedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        allButton->setText(QApplication::translate("PacketRangeGroupBox", "&All packets", Q_NULLPTR));
        ftlCapturedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        allDisplayedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        rangeCapturedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        selectedButton->setText(QApplication::translate("PacketRangeGroupBox", "&Selected packets only", Q_NULLPTR));
        capturedButton->setText(QApplication::translate("PacketRangeGroupBox", "Captured", Q_NULLPTR));
        markedCapturedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        ftlDisplayedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        ignoredCapturedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
        ignoredDisplayedLabel->setText(QApplication::translate("PacketRangeGroupBox", "-", Q_NULLPTR));
    } // retranslateUi
