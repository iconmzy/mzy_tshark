...
public:
    ...
    {
        formatGroupBox->setTitle(QApplication::translate("PrintDialog", "Packet Format", Q_NULLPTR));
        formFeedCheckBox->setText(QApplication::translate("PrintDialog", "Print each packet on a new page", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        zoomLabel->setToolTip(QApplication::translate("PrintDialog", "<html><head/><body><p>Use the &quot;+&quot; and &quot;-&quot; keys to zoom the preview in and out. Use the &quot;0&quot; key to reset the zoom level.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        zoomLabel->setText(QApplication::translate("PrintDialog", "<html><head/><body><p><span style=\" font-size:small; font-style:italic;\">+ and - zoom, 0 resets</span></p></body></html>", Q_NULLPTR));
        rangeGroupBox->setTitle(QApplication::translate("PrintDialog", "Packet Range", Q_NULLPTR));
