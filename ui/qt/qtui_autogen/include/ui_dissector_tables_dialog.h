...
public:
    ...
    {
        DissectorTablesDialog->setWindowTitle(QApplication::translate("DissectorTablesDialog", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("DissectorTablesDialog", "Search:", Q_NULLPTR));
    } // retranslateUi
