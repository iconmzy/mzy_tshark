...
public:
    ...
    {
        TapParameterDialog->setWindowTitle(QApplication::translate("TapParameterDialog", "Dialog", Q_NULLPTR));
        actionCopyToClipboard->setText(QApplication::translate("TapParameterDialog", "Copy", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionCopyToClipboard->setToolTip(QApplication::translate("TapParameterDialog", "Copy a text representation of the tree to the clipboard", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveAs->setText(QApplication::translate("TapParameterDialog", "Save as\342\200\246", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveAs->setToolTip(QApplication::translate("TapParameterDialog", "Save the displayed data in various formats", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QTreeWidgetItem *___qtreewidgetitem = statsTreeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("TapParameterDialog", "Item", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("TapParameterDialog", "<small><i>A hint.</i></small>", Q_NULLPTR));
        label->setText(QApplication::translate("TapParameterDialog", "Display filter:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        applyFilterButton->setToolTip(QApplication::translate("TapParameterDialog", "Regenerate statistics using this display filter", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        applyFilterButton->setText(QApplication::translate("TapParameterDialog", "Apply", Q_NULLPTR));
    } // retranslateUi
