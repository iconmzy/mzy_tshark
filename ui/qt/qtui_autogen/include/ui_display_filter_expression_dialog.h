...
public:
    ...
    {
        DisplayFilterExpressionDialog->setWindowTitle(QApplication::translate("DisplayFilterExpressionDialog", "Dialog", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fieldLabel->setToolTip(QApplication::translate("DisplayFilterExpressionDialog", "Select a field to start building a display filter.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fieldLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "Field Name", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        searchLabel->setToolTip(QApplication::translate("DisplayFilterExpressionDialog", "<html><head/><body><p>Search the list of field names.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        searchLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "Search:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        relationLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "Relation", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        valueLabel->setToolTip(QApplication::translate("DisplayFilterExpressionDialog", "Match against this value.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        valueLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "Value", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        enumLabel->setToolTip(QApplication::translate("DisplayFilterExpressionDialog", "If the field you have selected has a known set of valid values they will be listed here.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        enumLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "Predefined Values", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rangeLabel->setToolTip(QApplication::translate("DisplayFilterExpressionDialog", "If the field you have selected covers a range of bytes (e.g. you have selected a protocol) you can restrict the match to a range of bytes here.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rangeLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "Range (offset:length)", Q_NULLPTR));
        displayFilterLineEdit->setPlaceholderText(QApplication::translate("DisplayFilterExpressionDialog", "No display filter", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("DisplayFilterExpressionDialog", "<small><i>A hint.</i></small>", Q_NULLPTR));
    } // retranslateUi
