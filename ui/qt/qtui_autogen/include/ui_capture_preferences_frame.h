...
public:
    ...
    {
        CapturePreferencesFrame->setWindowTitle(QApplication::translate("CapturePreferencesFrame", "Frame", Q_NULLPTR));
        label->setText(QApplication::translate("CapturePreferencesFrame", "Default interface", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        capturePromModeCheckBox->setText(QApplication::translate("CapturePreferencesFrame", "Capture packets in promiscuous mode", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        capturePcapNgCheckBox->setToolTip(QApplication::translate("CapturePreferencesFrame", "<html><head/><body><p>Capture packets in the next-generation capture file format.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        capturePcapNgCheckBox->setText(QApplication::translate("CapturePreferencesFrame", "Capture packets in pcapng format", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        captureRealTimeCheckBox->setToolTip(QApplication::translate("CapturePreferencesFrame", "<html><head/><body><p>Update the list of packets while capture is in progress. This can result in dropped packets on high-speed networks.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        captureRealTimeCheckBox->setText(QApplication::translate("CapturePreferencesFrame", "Update list of packets in real time", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        captureAutoScrollCheckBox->setToolTip(QApplication::translate("CapturePreferencesFrame", "<html><head/><body><p>Keep the packet list scrolled to the bottom while capturing.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        captureAutoScrollCheckBox->setText(QApplication::translate("CapturePreferencesFrame", "Automatic scrolling in live capture", Q_NULLPTR));
        captureNoInterfaceLoad->setText(QApplication::translate("CapturePreferencesFrame", "Don't load interfaces on startup", Q_NULLPTR));
        captureNoExtcapCheckBox->setText(QApplication::translate("CapturePreferencesFrame", "Disable external capture interfaces", Q_NULLPTR));
    } // retranslateUi
