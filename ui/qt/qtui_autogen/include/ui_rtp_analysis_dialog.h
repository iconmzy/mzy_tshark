...
public:
    ...
    {
        RtpAnalysisDialog->setWindowTitle(QApplication::translate("RtpAnalysisDialog", "Dialog", Q_NULLPTR));
        actionSaveAudioUnsync->setText(QApplication::translate("RtpAnalysisDialog", "Unsynchronized Forward and Reverse Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveAudioUnsync->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the unsynchronized audio data for both channels.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveForwardAudioUnsync->setText(QApplication::translate("RtpAnalysisDialog", "Unsynchronized Forward Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardAudioUnsync->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the unsynchronized forward stream audio data.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveReverseAudioUnsync->setText(QApplication::translate("RtpAnalysisDialog", "Unsynchronized Reverse Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseAudioUnsync->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the unsynchronized reverse stream audio data.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveCsv->setText(QApplication::translate("RtpAnalysisDialog", "CSV", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveCsv->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save both tables as CSV.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveForwardCsv->setText(QApplication::translate("RtpAnalysisDialog", "Forward Stream CSV", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardCsv->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the forward table as CSV.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveReverseCsv->setText(QApplication::translate("RtpAnalysisDialog", "Reverse Stream CSV", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseCsv->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the reverse table as CSV.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveGraph->setText(QApplication::translate("RtpAnalysisDialog", "Save Graph", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveGraph->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the graph image.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionGoToPacket->setText(QApplication::translate("RtpAnalysisDialog", "Go to Packet", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionGoToPacket->setToolTip(QApplication::translate("RtpAnalysisDialog", "Select the corresponding packet in the packet list.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
        actionGoToPacket->setShortcut(QApplication::translate("RtpAnalysisDialog", "G", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        actionNextProblem->setText(QApplication::translate("RtpAnalysisDialog", "Next Problem Packet", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionNextProblem->setToolTip(QApplication::translate("RtpAnalysisDialog", "Go to the next problem packet", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
        actionNextProblem->setShortcut(QApplication::translate("RtpAnalysisDialog", "N", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        actionSaveAudioSyncStream->setText(QApplication::translate("RtpAnalysisDialog", "Stream Synchronized Forward and Reverse Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveAudioSyncStream->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the audio data for both channels synchronized to start of earlier stream.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveForwardAudioSyncStream->setText(QApplication::translate("RtpAnalysisDialog", "Stream Synchronized Forward Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardAudioSyncStream->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the forward stream audio data synchronized to start of earlier stream.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveReverseAudioSyncStream->setText(QApplication::translate("RtpAnalysisDialog", "Stream Synchronized Reverse Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseAudioSyncStream->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the reverse stream audio data synchronized to start of earlier stream.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveAudioSyncFile->setText(QApplication::translate("RtpAnalysisDialog", "File Synchronized Forward and Reverse Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveAudioSyncFile->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the audio data for both channels synchronized to start of file.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveForwardAudioSyncFile->setText(QApplication::translate("RtpAnalysisDialog", "File Synchronized Forward Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardAudioSyncFile->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the forward stream audio data synchronized to start of file.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveReverseAudioSyncFile->setText(QApplication::translate("RtpAnalysisDialog", "File Synchronized Reverse Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseAudioSyncFile->setToolTip(QApplication::translate("RtpAnalysisDialog", "Save the reverse stream audio data synchronized to start of file.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        statisticsLabel->setText(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p><span style=\" font-size:medium; font-weight:600;\">Forward</span></p><p><span style=\" font-size:medium; font-weight:600;\">Reverse</span></p></body></html>", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = forwardTreeWidget->headerItem();
        ___qtreewidgetitem->setText(7, QApplication::translate("RtpAnalysisDialog", "Status", Q_NULLPTR));
        ___qtreewidgetitem->setText(6, QApplication::translate("RtpAnalysisDialog", "Marker", Q_NULLPTR));
        ___qtreewidgetitem->setText(5, QApplication::translate("RtpAnalysisDialog", "Bandwidth", Q_NULLPTR));
        ___qtreewidgetitem->setText(4, QApplication::translate("RtpAnalysisDialog", "Skew", Q_NULLPTR));
        ___qtreewidgetitem->setText(3, QApplication::translate("RtpAnalysisDialog", "Jitter (ms)", Q_NULLPTR));
        ___qtreewidgetitem->setText(2, QApplication::translate("RtpAnalysisDialog", "Delta (ms)", Q_NULLPTR));
        ___qtreewidgetitem->setText(1, QApplication::translate("RtpAnalysisDialog", "Sequence", Q_NULLPTR));
        ___qtreewidgetitem->setText(0, QApplication::translate("RtpAnalysisDialog", "Packet", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(forwardTreeWidget), QApplication::translate("RtpAnalysisDialog", "Forward", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(reverseTreeWidget), QApplication::translate("RtpAnalysisDialog", "Reverse", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fJitterCheckBox->setToolTip(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide forward jitter values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fJitterCheckBox->setText(QApplication::translate("RtpAnalysisDialog", "Forward Jitter", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fDiffCheckBox->setToolTip(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide forward difference values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fDiffCheckBox->setText(QApplication::translate("RtpAnalysisDialog", "Forward Difference", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fDeltaCheckBox->setToolTip(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide forward delta values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fDeltaCheckBox->setText(QApplication::translate("RtpAnalysisDialog", "Forward Delta", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rJitterCheckBox->setToolTip(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide reverse jitter values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rJitterCheckBox->setText(QApplication::translate("RtpAnalysisDialog", "Reverse Jitter", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rDiffCheckBox->setToolTip(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide reverse difference values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rDiffCheckBox->setText(QApplication::translate("RtpAnalysisDialog", "Reverse Difference", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rDeltaCheckBox->setToolTip(QApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide reverse delta values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rDeltaCheckBox->setText(QApplication::translate("RtpAnalysisDialog", "Reverse Delta", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(graphTab), QApplication::translate("RtpAnalysisDialog", "Graph", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("RtpAnalysisDialog", "<small><i>A hint.</i></small>", Q_NULLPTR));
    } // retranslateUi
