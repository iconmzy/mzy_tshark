...
public:
    ...
    {
        FilterExpressionFrame->setWindowTitle(QApplication::translate("FilterExpressionFrame", "Frame", Q_NULLPTR));
        filterExpressionPreferencesPushButton->setText(QApplication::translate("FilterExpressionFrame", "Filter Buttons Preferences\342\200\246", Q_NULLPTR));
        labelLabel->setText(QApplication::translate("FilterExpressionFrame", "Label:", Q_NULLPTR));
        labelLineEdit->setPlaceholderText(QApplication::translate("FilterExpressionFrame", "Enter a description for the filter button", Q_NULLPTR));
        filterLabel->setText(QApplication::translate("FilterExpressionFrame", "Filter:", Q_NULLPTR));
        displayFilterLineEdit->setPlaceholderText(QApplication::translate("FilterExpressionFrame", "Enter a filter expression to be applied", Q_NULLPTR));
        commentLabel->setText(QApplication::translate("FilterExpressionFrame", "Comment:", Q_NULLPTR));
        commentLineEdit->setPlaceholderText(QApplication::translate("FilterExpressionFrame", "Enter a comment for the filter button", Q_NULLPTR));
    } // retranslateUi
