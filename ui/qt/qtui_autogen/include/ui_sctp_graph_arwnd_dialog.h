...
public:
    ...
    {
        SCTPGraphArwndDialog->setWindowTitle(QApplication::translate("SCTPGraphArwndDialog", "SCTP Graph", Q_NULLPTR));
        actionGoToPacket->setText(QApplication::translate("SCTPGraphArwndDialog", "goToPacket", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionGoToPacket->setToolTip(QApplication::translate("SCTPGraphArwndDialog", "Go to Packet", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        hintLabel->setText(QApplication::translate("SCTPGraphArwndDialog", "<html><head/><body><p><br/></p></body></html>", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("SCTPGraphArwndDialog", "Reset to full size", Q_NULLPTR));
        saveButton->setText(QApplication::translate("SCTPGraphArwndDialog", "Save Graph", Q_NULLPTR));
    } // retranslateUi
