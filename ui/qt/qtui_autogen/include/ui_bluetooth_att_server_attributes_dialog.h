...
public:
    ...
    {
        BluetoothAttServerAttributesDialog->setWindowTitle(QApplication::translate("BluetoothAttServerAttributesDialog", "Bluetooth ATT Server Attributes", Q_NULLPTR));
        actionCopy_Cell->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Copy Cell", Q_NULLPTR));
        actionCopy_Rows->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Copy Rows", Q_NULLPTR));
        actionCopy_All->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Copy All", Q_NULLPTR));
        actionSave_as_image->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Save as image", Q_NULLPTR));
        actionMark_Unmark_Row->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Mark/Unmark Row", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionMark_Unmark_Row->setToolTip(QApplication::translate("BluetoothAttServerAttributesDialog", "Mark/Unmark Row", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
        actionMark_Unmark_Row->setShortcut(QApplication::translate("BluetoothAttServerAttributesDialog", "Ctrl-M", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        actionMark_Unmark_Cell->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Mark/Unmark Cell", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = tableTreeWidget->headerItem();
        ___qtreewidgetitem->setText(2, QApplication::translate("BluetoothAttServerAttributesDialog", "UUID Name", Q_NULLPTR));
        ___qtreewidgetitem->setText(1, QApplication::translate("BluetoothAttServerAttributesDialog", "UUID", Q_NULLPTR));
        ___qtreewidgetitem->setText(0, QApplication::translate("BluetoothAttServerAttributesDialog", "Handle", Q_NULLPTR));
        interfaceComboBox->clear();
        interfaceComboBox->insertItems(0, QStringList()
         << QApplication::translate("BluetoothAttServerAttributesDialog", "All Interfaces", Q_NULLPTR)
        );
        deviceComboBox->clear();
        deviceComboBox->insertItems(0, QStringList()
         << QApplication::translate("BluetoothAttServerAttributesDialog", "All Devices", Q_NULLPTR)
        );
        removeDuplicatesCheckBox->setText(QApplication::translate("BluetoothAttServerAttributesDialog", "Remove duplicates", Q_NULLPTR));
    } // retranslateUi
