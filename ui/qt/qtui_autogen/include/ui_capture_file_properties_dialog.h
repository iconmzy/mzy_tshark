...
public:
    ...
    {
        detailsLabel->setText(QApplication::translate("CaptureFilePropertiesDialog", "Details", Q_NULLPTR));
        commentsLabel->setText(QApplication::translate("CaptureFilePropertiesDialog", "Capture file comments", Q_NULLPTR));
