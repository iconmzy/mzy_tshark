...
public:
    ...
    {
        shiftAllButton->setText(QApplication::translate("TimeShiftDialog", "Shift all packets by", Q_NULLPTR));
        label_6->setText(QApplication::translate("TimeShiftDialog", "<html><head/><body><p><span style=\" font-size:small; font-style:italic;\">[-][[hh:]mm:]ss[.ddd] </span></p></body></html>", Q_NULLPTR));
        setOneButton->setText(QApplication::translate("TimeShiftDialog", "Set the time for packet", Q_NULLPTR));
        label_2->setText(QApplication::translate("TimeShiftDialog", "to", Q_NULLPTR));
        setTwoCheckBox->setText(QApplication::translate("TimeShiftDialog", "\342\200\246then set packet", Q_NULLPTR));
        setTwoToLabel->setText(QApplication::translate("TimeShiftDialog", "to", Q_NULLPTR));
        extrapolateLabel->setText(QApplication::translate("TimeShiftDialog", "and extrapolate the time for all other packets", Q_NULLPTR));
        label_5->setText(QApplication::translate("TimeShiftDialog", "<html><head/><body><p align=\"right\"><span style=\" font-size:small; font-style:italic;\">[YYYY-MM-DD] hh:mm:ss[.ddd] </span></p></body></html>", Q_NULLPTR));
        unshiftAllButton->setText(QApplication::translate("TimeShiftDialog", "Undo all shifts", Q_NULLPTR));
