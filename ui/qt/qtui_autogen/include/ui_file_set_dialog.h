...
public:
    ...
    {
        FileSetDialog->setWindowTitle(QApplication::translate("FileSetDialog", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("FileSetDialog", "Directory:", Q_NULLPTR));
