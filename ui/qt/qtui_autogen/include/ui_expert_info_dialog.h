...
public:
    ...
    {
        ExpertInfoDialog->setWindowTitle(QApplication::translate("ExpertInfoDialog", "Dialog", Q_NULLPTR));
        actionShowError->setText(QApplication::translate("ExpertInfoDialog", "Error", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionShowError->setToolTip(QApplication::translate("ExpertInfoDialog", "Show error packets.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionShowWarning->setText(QApplication::translate("ExpertInfoDialog", "Warning", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionShowWarning->setToolTip(QApplication::translate("ExpertInfoDialog", "Show warning packets.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionShowNote->setText(QApplication::translate("ExpertInfoDialog", "Note", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionShowNote->setToolTip(QApplication::translate("ExpertInfoDialog", "Show note packets.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionShowChat->setText(QApplication::translate("ExpertInfoDialog", "Chat", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionShowChat->setToolTip(QApplication::translate("ExpertInfoDialog", "Show chat packets.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionShowComment->setText(QApplication::translate("ExpertInfoDialog", "Comment", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionShowComment->setToolTip(QApplication::translate("ExpertInfoDialog", "Show comment packets.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        hintLabel->setText(QApplication::translate("ExpertInfoDialog", "<small><i>A hint.</i></small>", Q_NULLPTR));
        limitCheckBox->setText(QApplication::translate("ExpertInfoDialog", "Limit to Display Filter", Q_NULLPTR));
        groupBySummaryCheckBox->setText(QApplication::translate("ExpertInfoDialog", "Group by summary", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("ExpertInfoDialog", "Search expert summaries.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("ExpertInfoDialog", "Search:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        searchLineEdit->setToolTip(QApplication::translate("ExpertInfoDialog", "Search expert summaries.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        severitiesPushButton->setText(QApplication::translate("ExpertInfoDialog", "Show\342\200\246", Q_NULLPTR));
    } // retranslateUi
