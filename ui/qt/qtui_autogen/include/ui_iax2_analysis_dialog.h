...
public:
    ...
    {
        Iax2AnalysisDialog->setWindowTitle(QApplication::translate("Iax2AnalysisDialog", "Dialog", Q_NULLPTR));
        actionSaveAudio->setText(QApplication::translate("Iax2AnalysisDialog", "Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveAudio->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save the audio data for both channels.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveForwardAudio->setText(QApplication::translate("Iax2AnalysisDialog", "Forward Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardAudio->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save the forward stream audio data.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveReverseAudio->setText(QApplication::translate("Iax2AnalysisDialog", "Reverse Stream Audio", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseAudio->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save the reverse stream audio data.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveCsv->setText(QApplication::translate("Iax2AnalysisDialog", "CSV", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveCsv->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save both tables as CSV.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveForwardCsv->setText(QApplication::translate("Iax2AnalysisDialog", "Forward Stream CSV", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveForwardCsv->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save the forward table as CSV.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveReverseCsv->setText(QApplication::translate("Iax2AnalysisDialog", "Reverse Stream CSV", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveReverseCsv->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save the reverse table as CSV.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionSaveGraph->setText(QApplication::translate("Iax2AnalysisDialog", "Save Graph", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionSaveGraph->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Save the graph image.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionGoToPacket->setText(QApplication::translate("Iax2AnalysisDialog", "Go to Packet", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionGoToPacket->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Select the corresponding packet in the packet list.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
        actionGoToPacket->setShortcut(QApplication::translate("Iax2AnalysisDialog", "G", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        actionNextProblem->setText(QApplication::translate("Iax2AnalysisDialog", "Next Problem Packet", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionNextProblem->setToolTip(QApplication::translate("Iax2AnalysisDialog", "Go to the next problem packet", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
        actionNextProblem->setShortcut(QApplication::translate("Iax2AnalysisDialog", "N", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        statisticsLabel->setText(QApplication::translate("Iax2AnalysisDialog", "<html><head/><body><p><span style=\" font-size:medium; font-weight:600;\">Forward</span></p><p><span style=\" font-size:medium; font-weight:600;\">Reverse</span></p></body></html>", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem = forwardTreeWidget->headerItem();
        ___qtreewidgetitem->setText(5, QApplication::translate("Iax2AnalysisDialog", "Length", Q_NULLPTR));
        ___qtreewidgetitem->setText(4, QApplication::translate("Iax2AnalysisDialog", "Status", Q_NULLPTR));
        ___qtreewidgetitem->setText(3, QApplication::translate("Iax2AnalysisDialog", "Bandwidth", Q_NULLPTR));
        ___qtreewidgetitem->setText(2, QApplication::translate("Iax2AnalysisDialog", "Jitter (ms)", Q_NULLPTR));
        ___qtreewidgetitem->setText(1, QApplication::translate("Iax2AnalysisDialog", "Delta (ms)", Q_NULLPTR));
        ___qtreewidgetitem->setText(0, QApplication::translate("Iax2AnalysisDialog", "Packet", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(forwardTreeWidget), QApplication::translate("Iax2AnalysisDialog", "Forward", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(reverseTreeWidget), QApplication::translate("Iax2AnalysisDialog", "Reverse", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fJitterCheckBox->setToolTip(QApplication::translate("Iax2AnalysisDialog", "<html><head/><body><p>Show or hide forward jitter values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fJitterCheckBox->setText(QApplication::translate("Iax2AnalysisDialog", "Forward Jitter", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        fDiffCheckBox->setToolTip(QApplication::translate("Iax2AnalysisDialog", "<html><head/><body><p>Show or hide forward difference values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        fDiffCheckBox->setText(QApplication::translate("Iax2AnalysisDialog", "Forward Difference", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rJitterCheckBox->setToolTip(QApplication::translate("Iax2AnalysisDialog", "<html><head/><body><p>Show or hide reverse jitter values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rJitterCheckBox->setText(QApplication::translate("Iax2AnalysisDialog", "Reverse Jitter", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        rDiffCheckBox->setToolTip(QApplication::translate("Iax2AnalysisDialog", "<html><head/><body><p>Show or hide reverse difference values.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        rDiffCheckBox->setText(QApplication::translate("Iax2AnalysisDialog", "Reverse Difference", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(graphTab), QApplication::translate("Iax2AnalysisDialog", "Graph", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("Iax2AnalysisDialog", "<small><i>A hint.</i></small>", Q_NULLPTR));
    } // retranslateUi
