...
public:
    ...
    {
        ShowPacketBytesDialog->setWindowTitle(QApplication::translate("ShowPacketBytesDialog", "Show Packet Bytes", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("ShowPacketBytesDialog", "Hint.", Q_NULLPTR));
        lDecodeAs->setText(QApplication::translate("ShowPacketBytesDialog", "Decode as", Q_NULLPTR));
        lShowAs->setText(QApplication::translate("ShowPacketBytesDialog", "Show as", Q_NULLPTR));
        lStart->setText(QApplication::translate("ShowPacketBytesDialog", "Start", Q_NULLPTR));
        lEnd->setText(QApplication::translate("ShowPacketBytesDialog", "End", Q_NULLPTR));
        lFind->setText(QApplication::translate("ShowPacketBytesDialog", "Find:", Q_NULLPTR));
        bFind->setText(QApplication::translate("ShowPacketBytesDialog", "Find &Next", Q_NULLPTR));
    } // retranslateUi
