...
public:
    ...
    {
        SCTPGraphByteDialog->setWindowTitle(QApplication::translate("SCTPGraphByteDialog", "SCTP Graph", Q_NULLPTR));
        actionGoToPacket->setText(QApplication::translate("SCTPGraphByteDialog", "goToPacket", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionGoToPacket->setToolTip(QApplication::translate("SCTPGraphByteDialog", "Go to Packet", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        hintLabel->setText(QApplication::translate("SCTPGraphByteDialog", "<html><head/><body><p><br/></p></body></html>", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("SCTPGraphByteDialog", "Reset to full size", Q_NULLPTR));
        saveButton->setText(QApplication::translate("SCTPGraphByteDialog", "Save Graph", Q_NULLPTR));
    } // retranslateUi
