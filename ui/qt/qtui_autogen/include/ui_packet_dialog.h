...
public:
    ...
    {
        PacketDialog->setWindowTitle(QApplication::translate("PacketDialog", "Dialog", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("PacketDialog", "<small><i></i></small>", Q_NULLPTR));
    } // retranslateUi
