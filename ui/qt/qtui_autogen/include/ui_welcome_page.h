...
public:
    ...
    void setupUi(QWidget *WelcomePage)
    {
        ...
        btnInterfaceType->setObjectName(QStringLiteral("btnInterfaceType"));
    ...
    void retranslateUi(QWidget *WelcomePage)
    {
        ...
        mainWelcomeBanner->setText(QApplication::translate("WelcomePage", "<html><head/><body><p><span style=\" font-size:large;\">Welcome to Wireshark</span></p></body></html>", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        recentLabel->setToolTip(QApplication::translate("WelcomePage", "<html><head/><body><p>Open a file on your file system</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        recentLabel->setText(QApplication::translate("WelcomePage", "<h2>Open</h2>", Q_NULLPTR));
#ifndef QT_NO_ACCESSIBILITY
        recentList->setAccessibleName(QApplication::translate("WelcomePage", "Recent capture files", Q_NULLPTR));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        recentList->setAccessibleDescription(QApplication::translate("WelcomePage", "Capture files that have been opened previously", Q_NULLPTR));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_TOOLTIP
        captureLabel->setToolTip(QApplication::translate("WelcomePage", "<html><head/><body><p>Capture live packets from your network.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        captureLabel->setText(QApplication::translate("WelcomePage", "<h2>Capture</h2>", Q_NULLPTR));
        label->setText(QApplication::translate("WelcomePage", "\342\200\246using this filter:", Q_NULLPTR));
        btnInterfaceType->setText(QString());
#ifndef QT_NO_ACCESSIBILITY
        interfaceFrame->setAccessibleName(QApplication::translate("WelcomePage", "Interface list", Q_NULLPTR));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        interfaceFrame->setAccessibleDescription(QApplication::translate("WelcomePage", "List of available capture interfaces", Q_NULLPTR));
#endif // QT_NO_ACCESSIBILITY
        helpLabel->setText(QApplication::translate("WelcomePage", "<h2>Learn</h2>", Q_NULLPTR));
