...
public:
    ...
    {
        FunnelTextDialog->setWindowTitle(QApplication::translate("FunnelTextDialog", "Dialog", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("FunnelTextDialog", "<html><head/><body><p>Enter some text or a regular expression. It will be highlighted above.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("FunnelTextDialog", "Highlight:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        findLineEdit->setToolTip(QApplication::translate("FunnelTextDialog", "<html><head/><body><p>Enter some text or a regular expression. It will be highlighted above.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
