...
public:
    ...
    {
        FontColorPreferencesFrame->setWindowTitle(QApplication::translate("FontColorPreferencesFrame", "Frame", Q_NULLPTR));
        label->setText(QApplication::translate("FontColorPreferencesFrame", "Main window font:", Q_NULLPTR));
        fontPushButton->setText(QApplication::translate("FontColorPreferencesFrame", "Select Font", Q_NULLPTR));
        fontSampleLineEdit->setText(QString());
        label_3->setText(QApplication::translate("FontColorPreferencesFrame", "Colors:", Q_NULLPTR));
        activeSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample active selected item", Q_NULLPTR));
        label_2->setText(QApplication::translate("FontColorPreferencesFrame", "Style:", Q_NULLPTR));
        activeStyleComboBox->clear();
        activeStyleComboBox->insertItems(0, QStringList()
         << QApplication::translate("FontColorPreferencesFrame", "System Default", Q_NULLPTR)
         << QApplication::translate("FontColorPreferencesFrame", "Solid", Q_NULLPTR)
         << QApplication::translate("FontColorPreferencesFrame", "Gradient", Q_NULLPTR)
        );
        inactiveFGPushButton->setText(QString());
        inactiveBGPushButton->setText(QString());
        inactiveSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample inactive selected item", Q_NULLPTR));
        label_4->setText(QApplication::translate("FontColorPreferencesFrame", "Style:", Q_NULLPTR));
        ...
        markedSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample marked packet text", Q_NULLPTR));
        ignoredSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample ignored packet text", Q_NULLPTR));
        clientSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample \"Follow Stream\" client text", Q_NULLPTR));
        serverSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample \"Follow Stream\" server text", Q_NULLPTR));
        validFilterSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample valid filter", Q_NULLPTR));
        invalidFilterSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample invalid filter", Q_NULLPTR));
        deprecatedFilterSampleLineEdit->setText(QApplication::translate("FontColorPreferencesFrame", "Sample warning filter", Q_NULLPTR));
    } // retranslateUi
