...
public:
    ...
    {
        SupportedProtocolsDialog->setWindowTitle(QApplication::translate("SupportedProtocolsDialog", "Dialog", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        searchLabel->setToolTip(QApplication::translate("SupportedProtocolsDialog", "<html><head/><body><p>Search the list of field names.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        searchLabel->setText(QApplication::translate("SupportedProtocolsDialog", "Search:", Q_NULLPTR));
        hintLabel->setText(QApplication::translate("SupportedProtocolsDialog", "<small><i>Gathering protocol information\342\200\246</i></small>", Q_NULLPTR));
    } // retranslateUi
