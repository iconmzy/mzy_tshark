...
public:
    ...
    {
        label->setText(QApplication::translate("FirewallRulesDialog", "Create rules for", Q_NULLPTR));
        inboundCheckBox->setText(QApplication::translate("FirewallRulesDialog", "Inbound", Q_NULLPTR));
        denyCheckBox->setText(QApplication::translate("FirewallRulesDialog", "Deny", Q_NULLPTR));
