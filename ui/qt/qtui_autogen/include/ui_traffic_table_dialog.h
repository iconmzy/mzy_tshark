...
public:
    ...
    void retranslateUi(QDialog *TrafficTableDialog)
    {
        ...
        nameResolutionCheckBox->setToolTip(QApplication::translate("TrafficTableDialog", "<html><head/><body><p>Show resolved addresses and port names rather than plain values. The corresponding name resolution preference must be enabled.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        nameResolutionCheckBox->setText(QApplication::translate("TrafficTableDialog", "Name resolution", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        displayFilterCheckBox->setToolTip(QApplication::translate("TrafficTableDialog", "<html><head/><body><p>Only show conversations matching the current display filter</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        displayFilterCheckBox->setText(QApplication::translate("TrafficTableDialog", "Limit to display filter", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        absoluteTimeCheckBox->setToolTip(QApplication::translate("TrafficTableDialog", "<html><head/><body><p>Show absolute times in the start time column.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        absoluteTimeCheckBox->setText(QApplication::translate("TrafficTableDialog", "Absolute start time", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        enabledTypesPushButton->setToolTip(QApplication::translate("TrafficTableDialog", "<html><head/><body><p>Add and remove conversation types.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
