...
public:
    ...
    {
        SCTPChunkStatisticsDialog->setWindowTitle(QApplication::translate("SCTPChunkStatisticsDialog", "Dialog", Q_NULLPTR));
        actionHideChunkType->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Hide Chunk Type", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionHideChunkType->setToolTip(QApplication::translate("SCTPChunkStatisticsDialog", "Remove the chunk type from the table", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionChunkTypePreferences->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Chunk Type Preferences", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionChunkTypePreferences->setToolTip(QApplication::translate("SCTPChunkStatisticsDialog", "Go to the chunk type preferences dialog to show or hide other chunk types", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionShowAllChunkTypes->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Show All Registered Chunk Types", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionShowAllChunkTypes->setToolTip(QApplication::translate("SCTPChunkStatisticsDialog", "Show all chunk types with defined names", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Association", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Endpoint 1", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Endpoint 2", Q_NULLPTR));
        pushButton->setText(QApplication::translate("SCTPChunkStatisticsDialog", "Save Chunk Type Order", Q_NULLPTR));
    } // retranslateUi
