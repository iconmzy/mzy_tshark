...
#define DISSECTOR_ASSERT(expression)                                                      \
    ((void)((expression) ? (void)0 : __DISSECTOR_ASSERT(expression, __FILE__, __LINE__))) \
...
#define DISSECTOR_ASSERT_HINT(expression, hint)                                                      \
    ((void)((expression) ? (void)0 : __DISSECTOR_ASSERT_HINT(expression, __FILE__, __LINE__, hint))) \
        __DISSECTOR_ASSERT_STATIC_ANALYSIS_HINT(expression)
...
#define DISSECTOR_ASSERT_CMPINT(a, op, b)                                                                 \
    ((void)((a op b) ? (void)0 : __DISSECTOR_ASSERT_CMPINT(a, op, b, gint64, "%" G_GINT64_MODIFIER "d"))) \
...
#define DISSECTOR_ASSERT_CMPUINT(a, op, b)                                                                 \
    ((void)((a op b) ? (void)0 : __DISSECTOR_ASSERT_CMPINT(a, op, b, guint64, "%" G_GINT64_MODIFIER "u"))) \
        __DISSECTOR_ASSERT_STATIC_ANALYSIS_HINT(a op b)
...
#define DISSECTOR_ASSERT_CMPUINTHEX(a, op, b)                                                                \
    ((void)((a op b) ? (void)0 : __DISSECTOR_ASSERT_CMPINT(a, op, b, guint64, "0x%" G_GINT64_MODIFIER "X"))) \
        __DISSECTOR_ASSERT_STATIC_ANALYSIS_HINT(a op b)
...
#define DISSECTOR_ASSERT_FIELD_TYPE(hfinfo, t)                                             \
    ((void)(((hfinfo)->type == t) ? (void)0 : __DISSECTOR_ASSERT_FIELD_TYPE((hfinfo), t))) \
...
#define DISSECTOR_ASSERT_FIELD_TYPE_IS_STRING(hfinfo)                                                    \
    ((void)(IS_FT_STRING((hfinfo)->type) ? (void)0 : __DISSECTOR_ASSERT_FIELD_TYPE_IS_STRING((hfinfo)))) \
...
/*文件操作新增*/
typedef void (*proto_tree_foreach_func2)(proto_node *, gpointer, char *f, writeFile_fields *one_result, int flag);
...
WS_DLL_PUBLIC void proto_tree_children_foreach2(proto_tree *tree,
                                                proto_tree_foreach_func2 func, gpointer data, char *f,
                                                writeFile_fields *one_result, int flag);
...
proto_tree_add_bitmask_len(proto_tree *tree, tvbuff_t *tvb, const guint offset, const guint len,
                           const int hf_hdr, const gint ett, int *const *fields, struct expert_field *exp,
...
proto_tree_add_uint64_bits_format_value(proto_tree *tree, const int hf_index, tvbuff_t *tvb,
                                        const guint bit_offset, const gint no_of_bits, guint64 value,
                                        const char *format, ...)
G_GNUC_PRINTF(7, 8);
...
proto_tree_add_boolean_bits_format_value(proto_tree *tree, const int hf_index, tvbuff_t *tvb,
                                         const guint bit_offset, const gint no_of_bits, guint32 value,
                                         const char *format, ...)
G_GNUC_PRINTF(7, 8);
