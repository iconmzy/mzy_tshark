...
proto_register_mongo(void)
{
  ...
  static hf_register_info hf[] = {
    ...
    { &hf_mongo_query_flags,
      { "Query Flags", "mongo_query_flags",
      FT_NONE, BASE_NONE, NULL, 0x0,
      "Bit vector of query options.", HFILL }
    },
    { &hf_mongo_fullcollectionname,
      { "fullCollectionName", "mongo_full_collection_name",
    ...
    { &hf_mongo_database_name,
      { "Database Name", "mongo_database_name",
    ...
    { &hf_mongo_reply_flags,
      { "Reply Flags", "mongo_reply_flags",
      FT_NONE, BASE_NONE, NULL, 0x0,
      "Bit vector of reply options.", HFILL }
    },
    { &hf_mongo_reply_flags_cursornotfound,
      { "Cursor Not Found", "mongo_reply_flags_cursornotfound",
    ...
    { &hf_mongo_reply_flags_queryfailure,
      { "Query Failure", "mongo_reply_flags_queryfailure",
    ...
    { &hf_mongo_reply_flags_sharedconfigstale,
      { "Shared Config Stale", "mongo_reply_flags_sharedconfigstale",
      FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000004,
      NULL, HFILL }
    },
    { &hf_mongo_reply_flags_awaitcapable,
      { "Await Capable", "mongo_reply_flags_awaitcapable",
    ...
    { &hf_mongo_update_flags_multiupdate,
      { "Multi Update", "mongo_update_flags_multiupdate",
      FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000002,
    ...
    { &hf_mongo_insert_flags,
      { "Insert Flags", "mongo_insert_flags",
      FT_NONE, BASE_NONE, NULL, 0x0,
      "Bit vector of insert options.", HFILL }
    },
    { &hf_mongo_insert_flags_continueonerror,
      { "ContinueOnError", "mongo_insert_flags_continueonerror",
      FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000001,
    ...
    { &hf_mongo_query_flags_awaitdata,
      { "AwaitData", "mongo_query_flags_awaitdata",
    ...
    { &hf_mongo_query_flags_exhaust,
      { "Exhaust", "mongo_query_flags_exhaust",
    ...
    { &hf_mongo_query_flags_partial,
      { "Partial", "mongo_query_flags_partial",
    ...
    { &hf_mongo_number_to_skip,
      { "Number To Skip", "mongo_number_to_skip",
      FT_INT32, BASE_DEC, NULL, 0x0,
      "Number of documents in the skip", HFILL }
    },
    { &hf_mongo_number_to_return,
      { "Number to Return", "mongo_number_to_return",
      FT_INT32, BASE_DEC, NULL, 0x0,
    ...
    { &hf_mongo_commandargs,
      { "CommandArgs", "mongo_commandargs",
      FT_NONE, BASE_NONE, NULL, 0x0,
      NULL, HFILL }
    },
    { &hf_mongo_commandreply,
      { "CommandReply", "mongo_commandreply",
      FT_NONE, BASE_NONE, NULL, 0x0,
      NULL, HFILL }
    },
    { &hf_mongo_outputdocs,
      { "OutputDocs", "mongo_outputdocs",
      FT_NONE, BASE_NONE, NULL, 0x0,
      NULL, HFILL }
    },
    { &hf_mongo_unknown,
      { "Unknown", "mongo_unknown",
      FT_BYTES, BASE_NONE, NULL, 0x0,
