...
/* #endif */
        ...
        { &hf_iscsi_SCSIResponse_BidiReadResidualCount,
          { "BidiReadResidualCount", "iscsi_scsiresponse_bidireadresidualcount",
            FT_UINT32, BASE_HEX, NULL, 0,
            "Bi-directional read residual count", HFILL }
        },
        { &hf_iscsi_SenseLength,
          { "SenseLength", "iscsi_scsiresponse_senselength",
        ...
        { &hf_iscsi_TargetTransferTag,
          { "TargetTransferTag", "iscsi_targettransfertag",
            FT_UINT32, BASE_HEX, NULL, 0,
            "Target transfer tag", HFILL }
        },
        { &hf_iscsi_BufferOffset,
          { "BufferOffset", "iscsi_bufferOffset",
            FT_UINT32, BASE_HEX, NULL, 0,
            "Buffer offset", HFILL }
        },
        { &hf_iscsi_SCSIData_ResidualCount,
          { "ResidualCount", "iscsi_scsidata_readresidualcount",
            FT_UINT32, BASE_HEX, NULL, 0,
            "Residual count", HFILL }
        },
        { &hf_iscsi_DataSN,
...
/* #endif */
        ...
        { &hf_iscsi_BegRun,
          { "BegRun", "iscsi_snack_begrun",
            FT_UINT32, BASE_HEX, NULL, 0,
            "First missed DataSN or StatSN", HFILL }
        },
        { &hf_iscsi_RunLength,
          { "RunLength", "iscsi_snack_runlength",
            FT_UINT32, BASE_HEX, NULL, 0,
