...
#line 1 "./asn1/ilp/packet-ilp-hfarr.c"
    ...
    { &hf_ilp_version,
      { "version", "ilp_version_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_sessionID2,
      { "sessionID2", "ilp_sessionID2_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_message,
      { "message", "ilp_message",
        ...
        "IlpMessage", HFILL }},
    { &hf_ilp_msPREQ,
      { "msPREQ", "ilp_msPREQ_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PREQ", HFILL }},
    { &hf_ilp_msPRES,
      { "msPRES", "ilp_msPRES_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PRES", HFILL }},
    { &hf_ilp_msPRPT,
      { "msPRPT", "ilp_msPRPT_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PRPT", HFILL }},
    { &hf_ilp_msPLREQ,
      { "msPLREQ", "ilp_msPLREQ_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PLREQ", HFILL }},
    { &hf_ilp_msPLRES,
      { "msPLRES", "ilp_msPLRES_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PLRES", HFILL }},
    { &hf_ilp_msPINIT,
      { "msPINIT", "ilp_msPINIT_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PINIT", HFILL }},
    { &hf_ilp_msPAUTH,
      { "msPAUTH", "ilp_msPAUTH_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PAUTH", HFILL }},
    { &hf_ilp_msPALIVE,
      { "msPALIVE", "ilp_msPALIVE_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PALIVE", HFILL }},
    { &hf_ilp_msPEND,
      { "msPEND", "ilp_msPEND_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PEND", HFILL }},
    { &hf_ilp_msPMESS,
      { "msPMESS", "ilp_msPMESS_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PMESS", HFILL }},
    { &hf_ilp_sLPMode,
      { "sLPMode", "ilp_sLPMode",
    ...
    { &hf_ilp_approvedPosMethods,
      { "approvedPosMethods", "ilp_approvedPosMethods_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PosTechnology", HFILL }},
    { &hf_ilp_locationId,
      { "locationId", "ilp_locationId_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_multipleLocationIds,
      { "multipleLocationIds", "ilp_multipleLocationIds",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_position,
      { "position", "ilp_position_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_triggerParams,
      { "triggerParams", "ilp_triggerParams_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_sPCSETKey,
      { "sPCSETKey", "ilp_sPCSETKey",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_spctid,
      { "spctid", "ilp_spctid_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_sPCSETKeylifetime,
      { "sPCSETKeylifetime", "ilp_sPCSETKeylifetime",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_qoP,
      { "qoP", "ilp_qoP_element",
    ...
    { &hf_ilp_sETCapabilities,
      { "sETCapabilities", "ilp_sETCapabilities_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_notificationMode,
      { "notificationMode", "ilp_notificationMode",
        FT_UINT32, BASE_DEC, VALS(ilp_NotificationMode_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_triggerType,
      { "triggerType", "ilp_triggerType",
        FT_UINT32, BASE_DEC, VALS(ilp_TriggerType_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_periodicTriggerParams,
      { "periodicTriggerParams", "ilp_periodicTriggerParams_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_numberOfFixes,
      { "numberOfFixes", "ilp_numberOfFixes",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_8639999", HFILL }},
    { &hf_ilp_intervalBetweenFixes,
      { "intervalBetweenFixes", "ilp_intervalBetweenFixes",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_8639999", HFILL }},
    { &hf_ilp_startTime,
      { "startTime", "ilp_startTime",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_2678400", HFILL }},
    { &hf_ilp_preferredPosMethod,
      { "preferredPosMethod", "ilp_preferredPosMethod",
        FT_UINT32, BASE_DEC, VALS(ilp_PosMethod_vals), 0,
        "PosMethod", HFILL }},
    { &hf_ilp_gnssPosTechnology,
      { "gnssPosTechnology", "ilp_gnssPosTechnology_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_supportedPosMethods,
      { "supportedPosMethods", "ilp_supportedPosMethods_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PosTechnology", HFILL }},
    { &hf_ilp_sPCstatusCode,
      { "sPCstatusCode", "ilp_sPCstatusCode",
        FT_UINT32, BASE_DEC, VALS(ilp_SPCStatusCode_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_fixNumber,
      { "fixNumber", "ilp_fixNumber",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_8639999", HFILL }},
    { &hf_ilp_statusCode,
      { "statusCode", "ilp_statusCode",
        FT_UINT32, BASE_DEC, VALS(ilp_StatusCode_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_positionResults,
      { "positionResults", "ilp_positionResults",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_PositionResults_item,
      { "PositionResult", "ilp_PositionResult",
        FT_UINT32, BASE_DEC, VALS(ilp_PositionResult_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_posMethod,
      { "posMethod", "ilp_posMethod",
        FT_UINT32, BASE_DEC, VALS(ilp_PosMethod_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_requestedAssistData,
      { "requestedAssistData", "ilp_requestedAssistData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_posPayLoad,
      { "posPayLoad", "ilp_posPayLoad",
        FT_UINT32, BASE_DEC, VALS(ilp_PosPayLoad_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_utran_GPSReferenceTimeResult,
      { "utran-GPSReferenceTimeResult", "ilp_utran_GPSReferenceTimeResult_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_utran_GANSSReferenceTimeResult,
      { "utran-GANSSReferenceTimeResult", "ilp_utran_GANSSReferenceTimeResult_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_almanacRequested,
      { "almanacRequested", "ilp_almanacRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_utcModelRequested,
      { "utcModelRequested", "ilp_utcModelRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ionosphericModelRequested,
      { "ionosphericModelRequested", "ilp_ionosphericModelRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_dgpsCorrectionsRequested,
      { "dgpsCorrectionsRequested", "ilp_dgpsCorrectionsRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_referenceLocationRequested,
      { "referenceLocationRequested", "ilp_referenceLocationRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_referenceTimeRequested,
      { "referenceTimeRequested", "ilp_referenceTimeRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_acquisitionAssistanceRequested,
      { "acquisitionAssistanceRequested", "ilp_acquisitionAssistanceRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_realTimeIntegrityRequested,
      { "realTimeIntegrityRequested", "ilp_realTimeIntegrityRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_navigationModelRequested,
      { "navigationModelRequested", "ilp_navigationModelRequested",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_navigationModelData,
      { "navigationModelData", "ilp_navigationModelData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "NavigationModel", HFILL }},
    { &hf_ilp_ganssRequestedCommonAssistanceDataList,
      { "ganssRequestedCommonAssistanceDataList", "ilp_ganssRequestedCommonAssistanceDataList_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssRequestedGenericAssistanceDataList,
      { "ganssRequestedGenericAssistanceDataList", "ilp_ganssRequestedGenericAssistanceDataList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_extendedEphemeris,
      { "extendedEphemeris", "ilp_extendedEphemeris_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_extendedEphemerisCheck,
      { "extendedEphemerisCheck", "ilp_extendedEphemerisCheck_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "ExtendedEphCheck", HFILL }},
    { &hf_ilp_validity,
      { "validity", "ilp_validity",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_256", HFILL }},
    { &hf_ilp_beginTime,
      { "beginTime", "ilp_beginTime_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GPSTime", HFILL }},
    { &hf_ilp_endTime,
      { "endTime", "ilp_endTime_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GPSTime", HFILL }},
    { &hf_ilp_gPSWeek,
      { "gPSWeek", "ilp_gPSWeek",
    ...
    { &hf_ilp_gPSTOWhour,
      { "gPSTOWhour", "ilp_gPSTOWhour",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_167", HFILL }},
    { &hf_ilp_ganssReferenceTime,
      { "ganssReferenceTime", "ilp_ganssReferenceTime",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssIonosphericModel,
      { "ganssIonosphericModel", "ilp_ganssIonosphericModel",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssAdditionalIonosphericModelForDataID00,
      { "ganssAdditionalIonosphericModelForDataID00", "ilp_ganssAdditionalIonosphericModelForDataID00",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssAdditionalIonosphericModelForDataID11,
      { "ganssAdditionalIonosphericModelForDataID11", "ilp_ganssAdditionalIonosphericModelForDataID11",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssEarthOrientationParameters,
      { "ganssEarthOrientationParameters", "ilp_ganssEarthOrientationParameters",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssAdditionalIonosphericModelForDataID01,
      { "ganssAdditionalIonosphericModelForDataID01", "ilp_ganssAdditionalIonosphericModelForDataID01",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_GanssRequestedGenericAssistanceDataList_item,
      { "GanssReqGenericData", "ilp_GanssReqGenericData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssId,
      { "ganssId", "ilp_ganssId",
        ...
        "INTEGER_0_15", HFILL }},
    { &hf_ilp_ganssSBASid,
      { "ganssSBASid", "ilp_ganssSBASid",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_3", HFILL }},
    { &hf_ilp_ganssRealTimeIntegrity,
      { "ganssRealTimeIntegrity", "ilp_ganssRealTimeIntegrity",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssDifferentialCorrection,
      { "ganssDifferentialCorrection", "ilp_ganssDifferentialCorrection",
        FT_BYTES, BASE_NONE, NULL, 0,
        "DGANSS_Sig_Id_Req", HFILL }},
    { &hf_ilp_ganssAlmanac,
      { "ganssAlmanac", "ilp_ganssAlmanac",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssNavigationModelData,
      { "ganssNavigationModelData", "ilp_ganssNavigationModelData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssTimeModels,
      { "ganssTimeModels", "ilp_ganssTimeModels",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_16", HFILL }},
    { &hf_ilp_ganssReferenceMeasurementInfo,
      { "ganssReferenceMeasurementInfo", "ilp_ganssReferenceMeasurementInfo",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssDataBits,
      { "ganssDataBits", "ilp_ganssDataBits_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssUTCModel,
      { "ganssUTCModel", "ilp_ganssUTCModel",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssAdditionalDataChoices,
      { "ganssAdditionalDataChoices", "ilp_ganssAdditionalDataChoices_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssAuxiliaryInformation,
      { "ganssAuxiliaryInformation", "ilp_ganssAuxiliaryInformation",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssExtendedEphemeris,
      { "ganssExtendedEphemeris", "ilp_ganssExtendedEphemeris_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "ExtendedEphemeris", HFILL }},
    { &hf_ilp_ganssExtendedEphemerisCheck,
      { "ganssExtendedEphemerisCheck", "ilp_ganssExtendedEphemerisCheck_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GanssExtendedEphCheck", HFILL }},
    { &hf_ilp_bds_DifferentialCorrection,
      { "bds-DifferentialCorrection", "ilp_bds_DifferentialCorrection",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BDS_Sig_Id_Req", HFILL }},
    { &hf_ilp_bds_GridModelReq,
      { "bds-GridModelReq", "ilp_bds_GridModelReq",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_ganssWeek,
      { "ganssWeek", "ilp_ganssWeek",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4095", HFILL }},
    { &hf_ilp_ganssToe,
      { "ganssToe", "ilp_ganssToe",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_167", HFILL }},
    { &hf_ilp_t_toeLimit,
      { "t-toeLimit", "ilp_t_toeLimit",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_10", HFILL }},
    { &hf_ilp_satellitesListRelatedDataList,
      { "satellitesListRelatedDataList", "ilp_satellitesListRelatedDataList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_SatellitesListRelatedDataList_item,
      { "SatellitesListRelatedData", "ilp_SatellitesListRelatedData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_satId,
      { "satId", "ilp_satId",
    ...
    { &hf_ilp_iod,
      { "iod", "ilp_iod",
        ...
        "INTEGER_0_1023", HFILL }},
    { &hf_ilp_ganssTODmin,
      { "ganssTODmin", "ilp_ganssTODmin",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_59", HFILL }},
    { &hf_ilp_reqDataBitAssistanceList,
      { "reqDataBitAssistanceList", "ilp_reqDataBitAssistanceList_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_gnssSignals,
      { "gnssSignals", "ilp_gnssSignals",
        FT_BYTES, BASE_NONE, NULL, 0,
        "GANSSSignals", HFILL }},
    { &hf_ilp_ganssDataBitInterval,
      { "ganssDataBitInterval", "ilp_ganssDataBitInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_15", HFILL }},
    { &hf_ilp_ganssDataBitSatList,
      { "ganssDataBitSatList", "ilp_ganssDataBitSatList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssDataBitSatList_item,
      { "ganssDataBitSatList item", "ilp_ganssDataBitSatList_item",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_63", HFILL }},
    { &hf_ilp_orbitModelID,
      { "orbitModelID", "ilp_orbitModelID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    { &hf_ilp_clockModelID,
      { "clockModelID", "ilp_clockModelID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    { &hf_ilp_utcModelID,
      { "utcModelID", "ilp_utcModelID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    { &hf_ilp_almanacModelID,
      { "almanacModelID", "ilp_almanacModelID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    { &hf_ilp_beginTime_01,
      { "beginTime", "ilp_beginTime_element",
    ...
    { &hf_ilp_endTime_01,
      { "endTime", "ilp_endTime_element",
        ...
        "GANSSextEphTime", HFILL }},
    { &hf_ilp_gANSSday,
      { "gANSSday", "ilp_gANSSday",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_8191", HFILL }},
    { &hf_ilp_gANSSTODhour,
      { "gANSSTODhour", "ilp_gANSSTODhour",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_23", HFILL }},
    { &hf_ilp_gpsWeek,
      { "gpsWeek", "ilp_gpsWeek",
    ...
    { &hf_ilp_SatelliteInfo_item,
      { "SatelliteInfoElement", "ilp_SatelliteInfoElement_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_iode,
      { "iode", "ilp_iode",
    ...
    { &hf_ilp_sPCStatusCode,
      { "sPCStatusCode", "ilp_sPCStatusCode",
        ...
        NULL, HFILL }},
    { &hf_ilp_velocity,
      { "velocity", "ilp_velocity",
        FT_UINT32, BASE_DEC, VALS(ilp_Velocity_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_utran_GPSReferenceTimeAssistance,
      { "utran-GPSReferenceTimeAssistance", "ilp_utran_GPSReferenceTimeAssistance_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_utran_GANSSReferenceTimeAssistance,
      { "utran-GANSSReferenceTimeAssistance", "ilp_utran_GANSSReferenceTimeAssistance_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_maj,
      { "maj", "ilp_maj",
    ...
    { &hf_ilp_servind,
      { "servind", "ilp_servind",
        ...
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_slcSessionID,
      { "slcSessionID", "ilp_slcSessionID_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_setSessionID,
      { "setSessionID", "ilp_setSessionID_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_spcSessionID,
      { "spcSessionID", "ilp_spcSessionID_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_sessionId,
      { "sessionId", "ilp_sessionId",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_65535", HFILL }},
    { &hf_ilp_setId,
      { "setId", "ilp_setId",
    ...
    { &hf_ilp_spcId,
      { "spcId", "ilp_spcId",
        ...
        "NodeAddress", HFILL }},
    { &hf_ilp_ipv4Address,
      { "ipv4Address", "ilp_ipv4Address",
        FT_IPv4, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_4", HFILL }},
    { &hf_ilp_ipv6Address,
      { "ipv6Address", "ilp_ipv6Address",
    ...
    { &hf_ilp_MultipleLocationIds_item,
      { "LocationIdData", "ilp_LocationIdData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_relativetimestamp,
      { "relativetimestamp", "ilp_relativetimestamp",
        FT_UINT32, BASE_DEC, NULL, 0,
        "RelativeTime", HFILL }},
    { &hf_ilp_servingFlag,
      { "servingFlag", "ilp_servingFlag",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_posTechnology,
      { "posTechnology", "ilp_posTechnology_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_prefMethod,
      { "prefMethod", "ilp_prefMethod",
        FT_UINT32, BASE_DEC, VALS(ilp_PrefMethod_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_posProtocol,
      { "posProtocol", "ilp_posProtocol_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_supportedBearers,
      { "supportedBearers", "ilp_supportedBearers_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_agpsSETassisted,
      { "agpsSETassisted", "ilp_agpsSETassisted",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_agpsSETBased,
      { "agpsSETBased", "ilp_agpsSETBased",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_autonomousGPS,
      { "autonomousGPS", "ilp_autonomousGPS",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_aflt,
      { "aflt", "ilp_aflt",
    ...
    { &hf_ilp_gANSSPositionMethods,
      { "gANSSPositionMethods", "ilp_gANSSPositionMethods",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_additionalPositioningMethods,
      { "additionalPositioningMethods", "ilp_additionalPositioningMethods",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_GANSSPositionMethods_item,
      { "GANSSPositionMethod", "ilp_GANSSPositionMethod_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_gANSSPositioningMethodTypes,
      { "gANSSPositioningMethodTypes", "ilp_gANSSPositioningMethodTypes_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_gANSSSignals,
      { "gANSSSignals", "ilp_gANSSSignals",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_setAssisted,
      { "setAssisted", "ilp_setAssisted",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_setBased,
      { "setBased", "ilp_setBased",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_autonomous,
      { "autonomous", "ilp_autonomous",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_AdditionalPositioningMethods_item,
      { "AddPosSupport-Element", "ilp_AddPosSupport_Element_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_addPosID,
      { "addPosID", "ilp_addPosID",
        FT_UINT32, BASE_DEC, VALS(ilp_T_addPosID_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_addPosMode,
      { "addPosMode", "ilp_addPosMode",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_tia801,
      { "tia801", "ilp_tia801",
    ...
    { &hf_ilp_posProtocolVersionRRLP,
      { "posProtocolVersionRRLP", "ilp_posProtocolVersionRRLP_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PosProtocolVersion3GPP", HFILL }},
    { &hf_ilp_posProtocolVersionRRC,
      { "posProtocolVersionRRC", "ilp_posProtocolVersionRRC_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PosProtocolVersion3GPP", HFILL }},
    { &hf_ilp_posProtocolVersionTIA801,
      { "posProtocolVersionTIA801", "ilp_posProtocolVersionTIA801",
        FT_UINT32, BASE_DEC, NULL, 0,
        "PosProtocolVersion3GPP2", HFILL }},
    { &hf_ilp_posProtocolVersionLPP,
      { "posProtocolVersionLPP", "ilp_posProtocolVersionLPP_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PosProtocolVersion3GPP", HFILL }},
    { &hf_ilp_lppe,
      { "lppe", "ilp_lppe",
    ...
    { &hf_ilp_posProtocolVersionLPPe,
      { "posProtocolVersionLPPe", "ilp_posProtocolVersionLPPe_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "PosProtocolVersionOMA", HFILL }},
    { &hf_ilp_majorVersionField,
      { "majorVersionField", "ilp_majorVersionField",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_technicalVersionField,
      { "technicalVersionField", "ilp_technicalVersionField",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_editorialVersionField,
      { "editorialVersionField", "ilp_editorialVersionField",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_PosProtocolVersion3GPP2_item,
      { "Supported3GPP2PosProtocolVersion", "ilp_Supported3GPP2PosProtocolVersion_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_revisionNumber,
      { "revisionNumber", "ilp_revisionNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_6", HFILL }},
    { &hf_ilp_pointReleaseNumber,
      { "pointReleaseNumber", "ilp_pointReleaseNumber",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_internalEditLevel,
      { "internalEditLevel", "ilp_internalEditLevel",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_minorVersionField,
      { "minorVersionField", "ilp_minorVersionField",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_gsm,
      { "gsm", "ilp_gsm",
    ...
    { &hf_ilp_nr,
      { "nr", "ilp_nr",
        ...
        "BOOLEAN", HFILL }},
    { &hf_ilp_gsmCell,
      { "gsmCell", "ilp_gsmCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GsmCellInformation", HFILL }},
    { &hf_ilp_wcdmaCell,
      { "wcdmaCell", "ilp_wcdmaCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "WcdmaCellInformation", HFILL }},
    { &hf_ilp_cdmaCell,
      { "cdmaCell", "ilp_cdmaCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "CdmaCellInformation", HFILL }},
    { &hf_ilp_hrpdCell,
      { "hrpdCell", "ilp_hrpdCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "HrpdCellInformation", HFILL }},
    { &hf_ilp_umbCell,
      { "umbCell", "ilp_umbCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "UmbCellInformation", HFILL }},
    { &hf_ilp_lteCell,
      { "lteCell", "ilp_lteCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "LteCellInformation", HFILL }},
    { &hf_ilp_wlanAP,
      { "wlanAP", "ilp_wlanAP_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "WlanAPInformation", HFILL }},
    { &hf_ilp_wimaxBS,
      { "wimaxBS", "ilp_wimaxBS_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "WimaxBSInformation", HFILL }},
    { &hf_ilp_nrCell,
      { "nrCell", "ilp_nrCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "NRCellInformation", HFILL }},
    { &hf_ilp_set_GPSTimingOfCell,
      { "set-GPSTimingOfCell", "ilp_set_GPSTimingOfCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
    ...
    { &hf_ilp_modeSpecificInfo,
      { "modeSpecificInfo", "ilp_modeSpecificInfo",
    ...
    { &hf_ilp_referenceIdentity,
      { "referenceIdentity", "ilp_referenceIdentity_element",
        FT_NONE, BASE_NONE, NULL, 0,
    ...
    { &hf_ilp_referenceIdentity_01,
      { "referenceIdentity", "ilp_referenceIdentity",
        FT_UINT32, BASE_DEC, NULL, 0,
    ...
    { &hf_ilp_gpsReferenceTimeUncertainty,
      { "gpsReferenceTimeUncertainty", "ilp_gpsReferenceTimeUncertainty",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_ganssTimeID,
      { "ganssTimeID", "ilp_ganssTimeID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_15", HFILL }},
    { &hf_ilp_set_GANSSReferenceTime,
      { "set-GANSSReferenceTime", "ilp_set_GANSSReferenceTime_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_set_GANSSTimingOfCell,
      { "set-GANSSTimingOfCell", "ilp_set_GANSSTimingOfCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
    ...
    { &hf_ilp_ganss_TODUncertainty,
      { "ganss-TODUncertainty", "ilp_ganss_TODUncertainty",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_gps,
      { "gps", "ilp_gps",
    ...
    { &hf_ilp_modernized_gps,
      { "modernized-gps", "ilp_modernized_gps",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_ilp_qzss,
      { "qzss", "ilp_qzss",
    ...
    { &hf_ilp_bds,
      { "bds", "ilp_bds",
        ...
        "BOOLEAN", HFILL }},
    { &hf_ilp_timestamp,
      { "timestamp", "ilp_timestamp",
        FT_STRING, BASE_NONE, NULL, 0,
        "UTCTime", HFILL }},
    { &hf_ilp_positionEstimate,
      { "positionEstimate", "ilp_positionEstimate_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_latitudeSign,
      { "latitudeSign", "ilp_latitudeSign",
        FT_UINT32, BASE_DEC, VALS(ilp_T_latitudeSign_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_latitude,
      { "latitude", "ilp_latitude",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_8388607", HFILL }},
    { &hf_ilp_longitude,
      { "longitude", "ilp_longitude",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M8388608_8388607", HFILL }},
    { &hf_ilp_uncertainty,
      { "uncertainty", "ilp_uncertainty_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_uncertaintySemiMajor,
      { "uncertaintySemiMajor", "ilp_uncertaintySemiMajor",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_uncertaintySemiMinor,
      { "uncertaintySemiMinor", "ilp_uncertaintySemiMinor",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_orientationMajorAxis,
      { "orientationMajorAxis", "ilp_orientationMajorAxis",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_180", HFILL }},
    { &hf_ilp_confidence,
      { "confidence", "ilp_confidence",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_100", HFILL }},
    { &hf_ilp_altitudeInfo,
      { "altitudeInfo", "ilp_altitudeInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_altitudeDirection,
      { "altitudeDirection", "ilp_altitudeDirection",
        FT_UINT32, BASE_DEC, VALS(ilp_T_altitudeDirection_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_altitude,
      { "altitude", "ilp_altitude",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_32767", HFILL }},
    { &hf_ilp_altUncertainty,
      { "altUncertainty", "ilp_altUncertainty",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_refNID,
      { "refNID", "ilp_refNID",
    ...
    { &hf_ilp_refSID,
      { "refSID", "ilp_refSID",
        ...
        "INTEGER_0_32767", HFILL }},
    { &hf_ilp_refBASEID,
      { "refBASEID", "ilp_refBASEID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_65535", HFILL }},
    { &hf_ilp_refBASELAT,
      { "refBASELAT", "ilp_refBASELAT",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4194303", HFILL }},
    { &hf_ilp_reBASELONG,
      { "reBASELONG", "ilp_reBASELONG",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_8388607", HFILL }},
    { &hf_ilp_refREFPN,
      { "refREFPN", "ilp_refREFPN",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_511", HFILL }},
    { &hf_ilp_refWeekNumber,
      { "refWeekNumber", "ilp_refWeekNumber",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_65535", HFILL }},
    { &hf_ilp_refSeconds,
      { "refSeconds", "ilp_refSeconds",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4194303", HFILL }},
    { &hf_ilp_refMCC,
      { "refMCC", "ilp_refMCC",
    ...
    { &hf_ilp_frequencyInfo,
      { "frequencyInfo", "ilp_frequencyInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_primaryScramblingCode,
      { "primaryScramblingCode", "ilp_primaryScramblingCode",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_511", HFILL }},
    { &hf_ilp_measuredResultsList,
      { "measuredResultsList", "ilp_measuredResultsList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cellParametersId,
      { "cellParametersId", "ilp_cellParametersId",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_timingAdvance,
      { "timingAdvance", "ilp_timingAdvance_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ta_01,
      { "ta", "ilp_ta",
        ...
        "INTEGER_0_8191", HFILL }},
    { &hf_ilp_tAResolution,
      { "tAResolution", "ilp_tAResolution",
        FT_UINT32, BASE_DEC, VALS(ilp_TAResolution_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_chipRate,
      { "chipRate", "ilp_chipRate",
        FT_UINT32, BASE_DEC, VALS(ilp_ChipRate_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_refSECTORID,
      { "refSECTORID", "ilp_refSECTORID",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_128", HFILL }},
    { &hf_ilp_cellGlobalIdEUTRA,
      { "cellGlobalIdEUTRA", "ilp_cellGlobalIdEUTRA_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_physCellId,
      { "physCellId", "ilp_physCellId",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_trackingAreaCode,
      { "trackingAreaCode", "ilp_trackingAreaCode",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_rsrpResult,
      { "rsrpResult", "ilp_rsrpResult",
        FT_UINT32, BASE_DEC, NULL, 0,
        "RSRP_Range", HFILL }},
    { &hf_ilp_rsrqResult,
      { "rsrqResult", "ilp_rsrqResult",
        FT_UINT32, BASE_DEC, NULL, 0,
        "RSRQ_Range", HFILL }},
    { &hf_ilp_ta_02,
      { "ta", "ilp_ta",
    ...
    { &hf_ilp_measResultListEUTRA,
      { "measResultListEUTRA", "ilp_measResultListEUTRA",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_earfcn,
      { "earfcn", "ilp_earfcn",
        ...
        "INTEGER_0_65535", HFILL }},
    { &hf_ilp_earfcn_ext,
      { "earfcn-ext", "ilp_earfcn_ext",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_65536_262143", HFILL }},
    { &hf_ilp_rsrpResult_ext,
      { "rsrpResult-ext", "ilp_rsrpResult_ext",
        FT_INT32, BASE_DEC, NULL, 0,
        "RSRP_Range_Ext", HFILL }},
    { &hf_ilp_rsrqResult_ext,
      { "rsrqResult-ext", "ilp_rsrqResult_ext",
        FT_INT32, BASE_DEC, NULL, 0,
        "RSRQ_Range_Ext", HFILL }},
    { &hf_ilp_rs_sinrResult,
      { "rs-sinrResult", "ilp_rs_sinrResult",
        FT_UINT32, BASE_DEC, NULL, 0,
        "RS_SINR_Range", HFILL }},
    { &hf_ilp_servingInformation5G,
      { "servingInformation5G", "ilp_servingInformation5G_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_MeasResultListEUTRA_item,
      { "MeasResultEUTRA", "ilp_MeasResultEUTRA_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cgi_Info,
      { "cgi-Info", "ilp_cgi_Info_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cellGlobalId,
      { "cellGlobalId", "ilp_cellGlobalId_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "CellGlobalIdEUTRA", HFILL }},
    { &hf_ilp_measResult,
      { "measResult", "ilp_measResult_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_neighbourInformation5G,
      { "neighbourInformation5G", "ilp_neighbourInformation5G_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_plmn_Identity,
      { "plmn-Identity", "ilp_plmn_Identity_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cellIdentity,
      { "cellIdentity", "ilp_cellIdentity",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_mcc,
      { "mcc", "ilp_mcc",
    ...
    { &hf_ilp_mnc,
      { "mnc", "ilp_mnc",
        ...
        NULL, HFILL }},
    { &hf_ilp_MCC_item,
      { "MCC-MNC-Digit", "ilp_MCC_MNC_Digit",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_MNC_item,
      { "MCC-MNC-Digit", "ilp_MCC_MNC_Digit",
    ...
    { &hf_ilp_apMACAddress,
      { "apMACAddress", "ilp_apMACAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_48", HFILL }},
    { &hf_ilp_apTransmitPower,
      { "apTransmitPower", "ilp_apTransmitPower",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_apAntennaGain,
      { "apAntennaGain", "ilp_apAntennaGain",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_apSignaltoNoise,
      { "apSignaltoNoise", "ilp_apSignaltoNoise",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_apDeviceType,
      { "apDeviceType", "ilp_apDeviceType",
        FT_UINT32, BASE_DEC, VALS(ilp_T_apDeviceType_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_apSignalStrength,
      { "apSignalStrength", "ilp_apSignalStrength",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_apChannelFrequency,
      { "apChannelFrequency", "ilp_apChannelFrequency",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_256", HFILL }},
    { &hf_ilp_apRoundTripDelay,
      { "apRoundTripDelay", "ilp_apRoundTripDelay_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "RTD", HFILL }},
    { &hf_ilp_setTransmitPower,
      { "setTransmitPower", "ilp_setTransmitPower",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_setAntennaGain,
      { "setAntennaGain", "ilp_setAntennaGain",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_setSignaltoNoise,
      { "setSignaltoNoise", "ilp_setSignaltoNoise",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_setSignalStrength,
      { "setSignalStrength", "ilp_setSignalStrength",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M127_128", HFILL }},
    { &hf_ilp_apReportedLocation,
      { "apReportedLocation", "ilp_apReportedLocation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "ReportedLocation", HFILL }},
    { &hf_ilp_apRepLocation,
      { "apRepLocation", "ilp_apRepLocation",
        FT_UINT32, BASE_DEC, VALS(ilp_RepLocation_vals), 0,
        "RepLocation", HFILL }},
    { &hf_ilp_apSignalStrengthDelta,
      { "apSignalStrengthDelta", "ilp_apSignalStrengthDelta",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_ilp_apSignaltoNoiseDelta,
      { "apSignaltoNoiseDelta", "ilp_apSignaltoNoiseDelta",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_ilp_setSignalStrengthDelta,
      { "setSignalStrengthDelta", "ilp_setSignalStrengthDelta",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_ilp_setSignaltoNoiseDelta,
      { "setSignaltoNoiseDelta", "ilp_setSignaltoNoiseDelta",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_ilp_operatingClass,
      { "operatingClass", "ilp_operatingClass",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_apSSID,
      { "apSSID", "ilp_apSSID",
    ...
    { &hf_ilp_apPHYType,
      { "apPHYType", "ilp_apPHYType",
        FT_UINT32, BASE_DEC, VALS(ilp_T_apPHYType_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_setMACAddress,
      { "setMACAddress", "ilp_setMACAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_48", HFILL }},
    { &hf_ilp_rTDValue,
      { "rTDValue", "ilp_rTDValue",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_16777216", HFILL }},
    { &hf_ilp_rTDUnits,
      { "rTDUnits", "ilp_rTDUnits",
        FT_UINT32, BASE_DEC, VALS(ilp_RTDUnits_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_rTDAccuracy,
      { "rTDAccuracy", "ilp_rTDAccuracy",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_ilp_locationEncodingDescriptor,
      { "locationEncodingDescriptor", "ilp_locationEncodingDescriptor",
        FT_UINT32, BASE_DEC, VALS(ilp_LocationEncodingDescriptor_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_locationData,
      { "locationData", "ilp_locationData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_locationAccuracy,
      { "locationAccuracy", "ilp_locationAccuracy",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4294967295", HFILL }},
    { &hf_ilp_locationValue,
      { "locationValue", "ilp_locationValue",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1_128", HFILL }},
    { &hf_ilp_lciLocData,
      { "lciLocData", "ilp_lciLocData_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_locationDataLCI,
      { "locationDataLCI", "ilp_locationDataLCI_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_latitudeResolution,
      { "latitudeResolution", "ilp_latitudeResolution",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_6", HFILL }},
    { &hf_ilp_latitude_01,
      { "latitude", "ilp_latitude",
    ...
    { &hf_ilp_longitudeResolution,
      { "longitudeResolution", "ilp_longitudeResolution",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_6", HFILL }},
    { &hf_ilp_longitude_01,
      { "longitude", "ilp_longitude",
        ...
        "BIT_STRING_SIZE_34", HFILL }},
    { &hf_ilp_altitudeType,
      { "altitudeType", "ilp_altitudeType",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_4", HFILL }},
    { &hf_ilp_altitudeResolution,
      { "altitudeResolution", "ilp_altitudeResolution",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_6", HFILL }},
    { &hf_ilp_altitude_01,
      { "altitude", "ilp_altitude",
    ...
    { &hf_ilp_wimaxBsID,
      { "wimaxBsID", "ilp_wimaxBsID_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_wimaxRTD,
      { "wimaxRTD", "ilp_wimaxRTD_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_wimaxNMRList,
      { "wimaxNMRList", "ilp_wimaxNMRList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_bsID_MSB,
      { "bsID-MSB", "ilp_bsID_MSB",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_24", HFILL }},
    { &hf_ilp_bsID_LSB,
      { "bsID-LSB", "ilp_bsID_LSB",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_24", HFILL }},
    { &hf_ilp_rtd,
      { "rtd", "ilp_rtd",
    ...
    { &hf_ilp_WimaxNMRList_item,
      { "WimaxNMR", "ilp_WimaxNMR_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_relDelay,
      { "relDelay", "ilp_relDelay",
        FT_INT32, BASE_DEC, NULL, 0,
        "INTEGER_M32768_32767", HFILL }},
    { &hf_ilp_relDelaystd,
      { "relDelaystd", "ilp_relDelaystd",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1023", HFILL }},
    { &hf_ilp_rssi,
      { "rssi", "ilp_rssi",
    ...
    { &hf_ilp_cINRstd,
      { "cINRstd", "ilp_cINRstd",
        ...
        "INTEGER_0_63", HFILL }},
    { &hf_ilp_bSLocation,
      { "bSLocation", "ilp_bSLocation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "ReportedLocation", HFILL }},
    { &hf_ilp_servingCellInformation,
      { "servingCellInformation", "ilp_servingCellInformation",
        FT_UINT32, BASE_DEC, NULL, 0,
        "ServingCellInformationNR", HFILL }},
    { &hf_ilp_measuredResultsListNR,
      { "measuredResultsListNR", "ilp_measuredResultsListNR",
        FT_UINT32, BASE_DEC, NULL, 0,
        "MeasResultListNR", HFILL }},
    { &hf_ilp_ServingCellInformationNR_item,
      { "ServCellNR", "ilp_ServCellNR_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_ilp_ssb_Measurements,
      { "ssb-Measurements", "ilp_ssb_Measurements_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "NR_Measurements", HFILL }},
    { &hf_ilp_csi_rs_Measurements,
      { "csi-rs-Measurements", "ilp_csi_rs_Measurements_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "NR_Measurements", HFILL }},
    { &hf_ilp_ta_03,
      { "ta", "ilp_ta",
    ...
    { &hf_ilp_MeasResultListNR_item,
      { "MeasResultNR", "ilp_MeasResultNR_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cellIdentityNR,
      { "cellIdentityNR", "ilp_cellIdentityNR",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_rsrp_Range,
      { "rsrp-Range", "ilp_rsrp_Range",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_rsrq_Range,
      { "rsrq-Range", "ilp_rsrq_Range",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    { &hf_ilp_sinr_Range,
      { "sinr-Range", "ilp_sinr_Range",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_127", HFILL }},
    ...
    { &hf_ilp_uarfcn_UL,
      { "uarfcn-UL", "ilp_uarfcn_UL",
        FT_UINT32, BASE_DEC, NULL, 0,
        "UARFCN", HFILL }},
    { &hf_ilp_uarfcn_DL,
      { "uarfcn-DL", "ilp_uarfcn_DL",
        FT_UINT32, BASE_DEC, NULL, 0,
        "UARFCN", HFILL }},
    { &hf_ilp_uarfcn_Nt,
      { "uarfcn-Nt", "ilp_uarfcn_Nt",
        FT_UINT32, BASE_DEC, NULL, 0,
        "UARFCN", HFILL }},
    { &hf_ilp_NMR_item,
      { "NMRelement", "ilp_NMRelement_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_arfcn,
      { "arfcn", "ilp_arfcn",
    ...
    { &hf_ilp_MeasuredResultsList_item,
      { "MeasuredResults", "ilp_MeasuredResults_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_utra_CarrierRSSI,
      { "utra-CarrierRSSI", "ilp_utra_CarrierRSSI",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cellMeasuredResultsList,
      { "cellMeasuredResultsList", "ilp_cellMeasuredResultsList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_CellMeasuredResultsList_item,
      { "CellMeasuredResults", "ilp_CellMeasuredResults_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_ilp_primaryCPICH_Info,
      { "primaryCPICH-Info", "ilp_primaryCPICH_Info_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cpich_Ec_N0,
      { "cpich-Ec-N0", "ilp_cpich_Ec_N0",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_cpich_RSCP,
      { "cpich-RSCP", "ilp_cpich_RSCP",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_pathloss,
      { "pathloss", "ilp_pathloss",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_tdd_02,
      { "tdd", "ilp_tdd_element",
    ...
    { &hf_ilp_cellParametersID,
      { "cellParametersID", "ilp_cellParametersID",
        ...
        NULL, HFILL }},
    { &hf_ilp_proposedTGSN,
      { "proposedTGSN", "ilp_proposedTGSN",
        FT_UINT32, BASE_DEC, NULL, 0,
        "TGSN", HFILL }},
    { &hf_ilp_primaryCCPCH_RSCP,
      { "primaryCCPCH-RSCP", "ilp_primaryCCPCH_RSCP",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_timeslotISCP_List,
      { "timeslotISCP-List", "ilp_timeslotISCP_List",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_TimeslotISCP_List_item,
      { "TimeslotISCP", "ilp_TimeslotISCP",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_utran_GPSReferenceTime,
      { "utran-GPSReferenceTime", "ilp_utran_GPSReferenceTime_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_utranGPSDriftRate,
      { "utranGPSDriftRate", "ilp_utranGPSDriftRate",
        FT_UINT32, BASE_DEC, VALS(ilp_UTRANGPSDriftRate_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_utran_GPSTimingOfCell,
      { "utran-GPSTimingOfCell", "ilp_utran_GPSTimingOfCell_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ms_part_02,
      { "ms-part", "ilp_ms_part",
    ...
    { &hf_ilp_utran_GANSSReferenceTime,
      { "utran-GANSSReferenceTime", "ilp_utran_GANSSReferenceTime_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_ganssDay,
      { "ganssDay", "ilp_ganssDay",
    ...
    { &hf_ilp_utranGANSSDriftRate,
      { "utranGANSSDriftRate", "ilp_utranGANSSDriftRate",
        FT_UINT32, BASE_DEC, VALS(ilp_UTRANGANSSDriftRate_vals), 0,
        NULL, HFILL }},
    { &hf_ilp_ganssTOD,
      { "ganssTOD", "ilp_ganssTOD",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_86399", HFILL }},
    { &hf_ilp_utran_GANSSTimingOfCell,
      { "utran-GANSSTimingOfCell", "ilp_utran_GANSSTimingOfCell",
        FT_UINT32, BASE_DEC, NULL, 0,
    ...
    { &hf_ilp_ver2_responseTime,
      { "ver2-responseTime", "ilp_ver2_responseTime",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_128", HFILL }},
    { &hf_ilp_horvel,
      { "horvel", "ilp_horvel_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_horandvervel,
      { "horandvervel", "ilp_horandvervel_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_horveluncert,
      { "horveluncert", "ilp_horveluncert_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_horandveruncert,
      { "horandveruncert", "ilp_horandveruncert_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_bearing,
      { "bearing", "ilp_bearing",
    ...
    { &hf_ilp_horspeed,
      { "horspeed", "ilp_horspeed",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_16", HFILL }},
    { &hf_ilp_verdirect,
      { "verdirect", "ilp_verdirect",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_1", HFILL }},
    { &hf_ilp_verspeed,
      { "verspeed", "ilp_verspeed",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_8", HFILL }},
    { &hf_ilp_uncertspeed,
      { "uncertspeed", "ilp_uncertspeed",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_8", HFILL }},
    { &hf_ilp_horuncertspeed,
      { "horuncertspeed", "ilp_horuncertspeed",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_8", HFILL }},
    { &hf_ilp_veruncertspeed,
      { "veruncertspeed", "ilp_veruncertspeed",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_8", HFILL }},
    { &hf_ilp_rand,
      { "rand", "ilp_rand",
    ...
    { &hf_ilp_slpFQDN,
      { "slpFQDN", "ilp_slpFQDN",
        ...
        "FQDN", HFILL }},
    { &hf_ilp_rrcPayload,
      { "rrcPayload", "ilp_rrcPayload",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1_8192", HFILL }},
    { &hf_ilp_rrlpPayload,
      { "rrlpPayload", "ilp_rrlpPayload",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_multiPosPayload,
      { "multiPosPayload", "ilp_multiPosPayload_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_lPPPayload,
      { "lPPPayload", "ilp_lPPPayload",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_lPPPayload_item,
      { "lPPPayload item", "ilp_lPPPayload_item",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_tia801Payload,
      { "tia801Payload", "ilp_tia801Payload",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_ilp_tia801Payload_item,
      { "tia801Payload item", "ilp_tia801Payload_item",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1_60000", HFILL }},
    { &hf_ilp_GANSSSignals_signal1,
      { "signal1", "ilp_GANSSSignals_signal1",
        FT_BOOLEAN, 8, NULL, 0x80,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal2,
      { "signal2", "ilp_GANSSSignals_signal2",
        FT_BOOLEAN, 8, NULL, 0x40,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal3,
      { "signal3", "ilp_GANSSSignals_signal3",
        FT_BOOLEAN, 8, NULL, 0x20,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal4,
      { "signal4", "ilp_GANSSSignals_signal4",
        FT_BOOLEAN, 8, NULL, 0x10,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal5,
      { "signal5", "ilp_GANSSSignals_signal5",
        FT_BOOLEAN, 8, NULL, 0x08,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal6,
      { "signal6", "ilp_GANSSSignals_signal6",
        FT_BOOLEAN, 8, NULL, 0x04,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal7,
      { "signal7", "ilp_GANSSSignals_signal7",
        FT_BOOLEAN, 8, NULL, 0x02,
        NULL, HFILL }},
    { &hf_ilp_GANSSSignals_signal8,
      { "signal8", "ilp_GANSSSignals_signal8",
        FT_BOOLEAN, 8, NULL, 0x01,
        NULL, HFILL }},
    { &hf_ilp_T_addPosMode_standalone,
      { "standalone", "ilp_T_addPosMode_standalone",
        FT_BOOLEAN, 8, NULL, 0x80,
        NULL, HFILL }},
    { &hf_ilp_T_addPosMode_setBased,
      { "setBased", "ilp_T_addPosMode_setBased",
        FT_BOOLEAN, 8, NULL, 0x40,
        NULL, HFILL }},
    { &hf_ilp_T_addPosMode_setAssisted,
      { "setAssisted", "ilp_T_addPosMode_setAssisted",
        FT_BOOLEAN, 8, NULL, 0x20,
        NULL, HFILL }},
...
#line 91 "./asn1/ilp/packet-ilp-template.c"
    { &hf_ilp_mobile_directory_number,
      { "Mobile Directory Number", "ilp_mobile_directory_number",
        FT_STRING, BASE_NONE, NULL, 0,
        NULL, HFILL }},
  };
