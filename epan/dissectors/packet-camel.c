...
void proto_register_camel(void) {
  ...
  static hf_register_info hf[] = {
    ...
    { &hf_camel_CAMEL_FCIBillingChargingCharacteristics,
      { "CAMEL-FCIBillingChargingCharacteristics", "camel_CAMEL_FCIBillingChargingCharacteristics",
    ...
    { &hf_camel_CAMEL_FCIGPRSBillingChargingCharacteristics,
      { "CAMEL-FCIGPRSBillingChargingCharacteristics", "camel_CAMEL_FCIGPRSBillingChargingCharacteristics",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},

    { &hf_camel_CAMEL_FCISMSBillingChargingCharacteristics,
      { "CAMEL-FCISMSBillingChargingCharacteristics", "camel_CAMEL_FCISMSBillingChargingCharacteristics",
    ...
    { &hf_camel_CAMEL_SCIBillingChargingCharacteristics,
      { "CAMEL-SCIBillingChargingCharacteristics", "camel_CAMEL_SCIBillingChargingCharacteristics",
    ...
    { &hf_camel_CAMEL_SCIGPRSBillingChargingCharacteristics,
      { "CAMEL-SCIGPRSBillingChargingCharacteristics", "camel_CAMEL_SCIGPRSBillingChargingCharacteristics",
        FT_UINT32, BASE_DEC, NULL, 0,
        "CAMEL-FSCIGPRSBillingChargingCharacteristics", HFILL }},

    { &hf_camel_CAMEL_CallResult,
      { "CAMEL-CAMEL_CallResult", "camel_CAMEL_CallResult",
  ...
  /* Camel Service Response Time */
    { &hf_camelsrt_SessionId,
      { "Session Id",
        "camel_srt_session_id",
        FT_UINT32, BASE_DEC, NULL, 0x0,
        NULL, HFILL }
    },
    { &hf_camelsrt_RequestNumber,
      { "Request Number",
        "camel_srt_request_number",
...
#line 1 "./asn1/camel/packet-camel-hfarr.c"
    { &hf_camel_PAR_cancelFailed_PDU,
      { "PAR-cancelFailed", "camel_PAR_cancelFailed_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_PAR_requestedInfoError_PDU,
      { "PAR-requestedInfoError", "camel_PAR_requestedInfoError",
        FT_UINT32, BASE_DEC, VALS(camel_PAR_requestedInfoError_vals), 0,
        NULL, HFILL }},
    { &hf_camel_UnavailableNetworkResource_PDU,
      { "UnavailableNetworkResource", "camel_UnavailableNetworkResource",
        FT_UINT32, BASE_DEC, VALS(camel_UnavailableNetworkResource_vals), 0,
        NULL, HFILL }},
    { &hf_camel_PAR_taskRefused_PDU,
      { "PAR-taskRefused", "camel_PAR_taskRefused",
        FT_UINT32, BASE_DEC, VALS(camel_PAR_taskRefused_vals), 0,
        NULL, HFILL }},
    { &hf_camel_CAP_GPRS_ReferenceNumber_PDU,
      { "CAP-GPRS-ReferenceNumber", "camel_CAP_GPRS_ReferenceNumber_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_PlayAnnouncementArg_PDU,
      { "PlayAnnouncementArg", "camel_PlayAnnouncementArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_PromptAndCollectUserInformationArg_PDU,
      { "PromptAndCollectUserInformationArg", "camel_PromptAndCollectUserInformationArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ReceivedInformationArg_PDU,
      { "ReceivedInformationArg", "camel_ReceivedInformationArg",
        FT_UINT32, BASE_DEC, VALS(camel_ReceivedInformationArg_vals), 0,
        NULL, HFILL }},
    { &hf_camel_SpecializedResourceReportArg_PDU,
      { "SpecializedResourceReportArg", "camel_SpecializedResourceReportArg",
        FT_UINT32, BASE_DEC, VALS(camel_SpecializedResourceReportArg_vals), 0,
        NULL, HFILL }},
    { &hf_camel_ApplyChargingArg_PDU,
      { "ApplyChargingArg", "camel_ApplyChargingArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ApplyChargingReportArg_PDU,
      { "ApplyChargingReportArg", "camel_ApplyChargingReportArg",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_AssistRequestInstructionsArg_PDU,
      { "AssistRequestInstructionsArg", "camel_AssistRequestInstructionsArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_CallGapArg_PDU,
      { "CallGapArg", "camel_CallGapArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_CallInformationReportArg_PDU,
      { "CallInformationReportArg", "camel_CallInformationReportArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_CallInformationRequestArg_PDU,
      { "CallInformationRequestArg", "camel_CallInformationRequestArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_CancelArg_PDU,
      { "CancelArg", "camel_CancelArg",
        FT_UINT32, BASE_DEC, VALS(camel_CancelArg_vals), 0,
        NULL, HFILL }},
    { &hf_camel_CollectInformationArg_PDU,
      { "CollectInformationArg", "camel_CollectInformationArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ConnectArg_PDU,
      { "ConnectArg", "camel_ConnectArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ConnectToResourceArg_PDU,
      { "ConnectToResourceArg", "camel_ConnectToResourceArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ContinueWithArgumentArg_PDU,
      { "ContinueWithArgumentArg", "camel_ContinueWithArgumentArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_DisconnectForwardConnectionWithArgumentArg_PDU,
      { "DisconnectForwardConnectionWithArgumentArg", "camel_DisconnectForwardConnectionWithArgumentArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_DisconnectLegArg_PDU,
      { "DisconnectLegArg", "camel_DisconnectLegArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_EntityReleasedArg_PDU,
      { "EntityReleasedArg", "camel_EntityReleasedArg",
        FT_UINT32, BASE_DEC, VALS(camel_EntityReleasedArg_vals), 0,
        NULL, HFILL }},
    { &hf_camel_EstablishTemporaryConnectionArg_PDU,
      { "EstablishTemporaryConnectionArg", "camel_EstablishTemporaryConnectionArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_EventReportBCSMArg_PDU,
      { "EventReportBCSMArg", "camel_EventReportBCSMArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_FurnishChargingInformationArg_PDU,
      { "FurnishChargingInformationArg", "camel_FurnishChargingInformationArg",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_InitialDPArg_PDU,
      { "InitialDPArg", "camel_InitialDPArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_InitiateCallAttemptArg_PDU,
      { "InitiateCallAttemptArg", "camel_InitiateCallAttemptArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_InitiateCallAttemptRes_PDU,
      { "InitiateCallAttemptRes", "camel_InitiateCallAttemptRes_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_MoveLegArg_PDU,
      { "MoveLegArg", "camel_MoveLegArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_PlayToneArg_PDU,
      { "PlayToneArg", "camel_PlayToneArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ReleaseCallArg_PDU,
      { "ReleaseCallArg", "camel_ReleaseCallArg",
        FT_UINT32, BASE_DEC, VALS(camel_ReleaseCallArg_vals), 0,
        NULL, HFILL }},
    { &hf_camel_RequestReportBCSMEventArg_PDU,
      { "RequestReportBCSMEventArg", "camel_RequestReportBCSMEventArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ResetTimerArg_PDU,
      { "ResetTimerArg", "camel_ResetTimerArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_SendChargingInformationArg_PDU,
      { "SendChargingInformationArg", "camel_SendChargingInformationArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_SplitLegArg_PDU,
      { "SplitLegArg", "camel_SplitLegArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ApplyChargingGPRSArg_PDU,
      { "ApplyChargingGPRSArg", "camel_ApplyChargingGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ApplyChargingReportGPRSArg_PDU,
      { "ApplyChargingReportGPRSArg", "camel_ApplyChargingReportGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_CancelGPRSArg_PDU,
      { "CancelGPRSArg", "camel_CancelGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ConnectGPRSArg_PDU,
      { "ConnectGPRSArg", "camel_ConnectGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ContinueGPRSArg_PDU,
      { "ContinueGPRSArg", "camel_ContinueGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_EntityReleasedGPRSArg_PDU,
      { "EntityReleasedGPRSArg", "camel_EntityReleasedGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_EventReportGPRSArg_PDU,
      { "EventReportGPRSArg", "camel_EventReportGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_FurnishChargingInformationGPRSArg_PDU,
      { "FurnishChargingInformationGPRSArg", "camel_FurnishChargingInformationGPRSArg",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_InitialDPGPRSArg_PDU,
      { "InitialDPGPRSArg", "camel_InitialDPGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ReleaseGPRSArg_PDU,
      { "ReleaseGPRSArg", "camel_ReleaseGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_RequestReportGPRSEventArg_PDU,
      { "RequestReportGPRSEventArg", "camel_RequestReportGPRSEventArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ResetTimerGPRSArg_PDU,
      { "ResetTimerGPRSArg", "camel_ResetTimerGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_SendChargingInformationGPRSArg_PDU,
      { "SendChargingInformationGPRSArg", "camel_SendChargingInformationGPRSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ConnectSMSArg_PDU,
      { "ConnectSMSArg", "camel_ConnectSMSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_EventReportSMSArg_PDU,
      { "EventReportSMSArg", "camel_EventReportSMSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_FurnishChargingInformationSMSArg_PDU,
      { "FurnishChargingInformationSMSArg", "camel_FurnishChargingInformationSMSArg",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_InitialDPSMSArg_PDU,
      { "InitialDPSMSArg", "camel_InitialDPSMSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ReleaseSMSArg_PDU,
      { "ReleaseSMSArg", "camel_ReleaseSMSArg",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_RequestReportSMSEventArg_PDU,
      { "RequestReportSMSEventArg", "camel_RequestReportSMSEventArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ResetTimerSMSArg_PDU,
      { "ResetTimerSMSArg", "camel_ResetTimerSMSArg_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_CAP_U_ABORT_REASON_PDU,
      { "CAP-U-ABORT-REASON", "camel_CAP_U_ABORT_REASON",
    ...
    { &hf_camel_srfConnection,
      { "srfConnection", "camel_srfConnection",
        FT_UINT32, BASE_DEC, NULL, 0,
        "CallSegmentID", HFILL }},
    { &hf_camel_aOCInitial,
      { "aOCInitial", "camel_aOCInitial_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "CAI_GSM0224", HFILL }},
    { &hf_camel_aOCSubsequent,
      { "aOCSubsequent", "camel_aOCSubsequent_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_cAI_GSM0224,
      { "cAI-GSM0224", "camel_cAI_GSM0224_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_aocSubsequent_tariffSwitchInterval,
      { "tariffSwitchInterval", "camel_tariffSwitchInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
    ...
    { &hf_camel_audibleIndicatorTone,
      { "tone", "camel_tone",
        ...
        "BOOLEAN", HFILL }},
    { &hf_camel_burstList,
      { "burstList", "camel_burstList_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_conferenceTreatmentIndicator,
      { "conferenceTreatmentIndicator", "camel_conferenceTreatmentIndicator",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1", HFILL }},
    { &hf_camel_callCompletionTreatmentIndicator,
      { "callCompletionTreatmentIndicator", "camel_callCompletionTreatmentIndicator",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1", HFILL }},
    { &hf_camel_calledAddressValue,
      { "calledAddressValue", "camel_calledAddressValue",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Digits", HFILL }},
    { &hf_camel_gapOnService,
      { "gapOnService", "camel_gapOnService_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_calledAddressAndService,
      { "calledAddressAndService", "camel_calledAddressAndService_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_serviceKey,
      { "serviceKey", "camel_serviceKey",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callingAddressAndService,
      { "callingAddressAndService", "camel_callingAddressAndService_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callingAddressValue,
      { "callingAddressValue", "camel_callingAddressValue",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Digits", HFILL }},
    { &hf_camel_eventTypeBCSM,
      { "eventTypeBCSM", "camel_eventTypeBCSM",
        FT_UINT32, BASE_DEC, VALS(camel_EventTypeBCSM_vals), 0,
        NULL, HFILL }},
    { &hf_camel_monitorMode,
      { "monitorMode", "camel_monitorMode",
        FT_UINT32, BASE_DEC, VALS(camel_MonitorMode_vals), 0,
        NULL, HFILL }},
    { &hf_camel_dpSpecificCriteria,
      { "dpSpecificCriteria", "camel_dpSpecificCriteria",
        FT_UINT32, BASE_DEC, VALS(camel_DpSpecificCriteria_vals), 0,
        NULL, HFILL }},
    { &hf_camel_automaticRearm,
      { "automaticRearm", "camel_automaticRearm_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_cause,
      { "cause", "camel_cause",
        ...
        NULL, HFILL }},
    { &hf_camel_bearerCap,
      { "bearerCap", "camel_bearerCap",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_numberOfBursts,
      { "numberOfBursts", "camel_numberOfBursts",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_3", HFILL }},
    { &hf_camel_burstInterval,
      { "burstInterval", "camel_burstInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_1200", HFILL }},
    { &hf_camel_numberOfTonesInBurst,
      { "numberOfTonesInBurst", "camel_numberOfTonesInBurst",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_3", HFILL }},
    { &hf_camel_burstToneDuration,
      { "toneDuration", "camel_toneDuration",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_20", HFILL }},
    { &hf_camel_toneInterval,
      { "toneInterval", "camel_toneInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_20", HFILL }},
    { &hf_camel_warningPeriod,
      { "warningPeriod", "camel_warningPeriod",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_1200", HFILL }},
    { &hf_camel_bursts,
      { "bursts", "camel_bursts_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "Burst", HFILL }},
    { &hf_camel_e1,
      { "e1", "camel_e1",
    ...
    { &hf_camel_callSegmentID,
      { "callSegmentID", "camel_callSegmentID",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_invokeID,
      { "invokeID", "camel_invokeID",
        FT_INT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_timeDurationCharging,
      { "timeDurationCharging", "camel_timeDurationCharging_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_maxCallPeriodDuration,
      { "maxCallPeriodDuration", "camel_maxCallPeriodDuration",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_864000", HFILL }},
    { &hf_camel_releaseIfdurationExceeded,
      { "releaseIfdurationExceeded", "camel_releaseIfdurationExceeded",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    ...
    { &hf_camel_appendFreeFormatData,
      { "appendFreeFormatData", "camel_appendFreeFormatData",
    ...
    { &hf_camel_aOCBeforeAnswer,
      { "aOCBeforeAnswer", "camel_aOCBeforeAnswer_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_aOCAfterAnswer,
      { "aOCAfterAnswer", "camel_aOCAfterAnswer_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "AOCSubsequent", HFILL }},
    { &hf_camel_aOC_extension,
      { "aOC-extension", "camel_aOC_extension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "CAMEL_SCIBillingChargingCharacteristicsAlt", HFILL }},
    { &hf_camel_aOCGPRS,
      { "aOCGPRS", "camel_aOCGPRS_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ChangeOfPositionControlInfo_item,
      { "ChangeOfLocation", "camel_ChangeOfLocation",
        FT_UINT32, BASE_DEC, VALS(camel_ChangeOfLocation_vals), 0,
        NULL, HFILL }},
    { &hf_camel_cellGlobalId,
      { "cellGlobalId", "camel_cellGlobalId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CellGlobalIdOrServiceAreaIdFixedLength", HFILL }},
    { &hf_camel_serviceAreaId,
      { "serviceAreaId", "camel_serviceAreaId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CellGlobalIdOrServiceAreaIdFixedLength", HFILL }},
    { &hf_camel_locationAreaId,
      { "locationAreaId", "camel_locationAreaId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "LAIFixedLength", HFILL }},
    { &hf_camel_inter_SystemHandOver,
      { "inter-SystemHandOver", "camel_inter_SystemHandOver_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_inter_PLMNHandOver,
      { "inter-PLMNHandOver", "camel_inter_PLMNHandOver_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_inter_MSCHandOver,
      { "inter-MSCHandOver", "camel_inter_MSCHandOver_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_changeOfLocationAlt,
      { "changeOfLocationAlt", "camel_changeOfLocationAlt_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_maxTransferredVolume,
      { "maxTransferredVolume", "camel_maxTransferredVolume",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_4294967295", HFILL }},
    { &hf_camel_maxElapsedTime,
      { "maxElapsedTime", "camel_maxElapsedTime",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_86400", HFILL }},
    { &hf_camel_transferredVolume,
      { "transferredVolume", "camel_transferredVolume",
        FT_UINT32, BASE_DEC, VALS(camel_TransferredVolume_vals), 0,
        NULL, HFILL }},
    { &hf_camel_elapsedTime,
      { "elapsedTime", "camel_elapsedTime",
        FT_UINT32, BASE_DEC, VALS(camel_ElapsedTime_vals), 0,
        NULL, HFILL }},
    { &hf_camel_transferredVolumeRollOver,
      { "transferredVolumeRollOver", "camel_transferredVolumeRollOver",
        FT_UINT32, BASE_DEC, VALS(camel_TransferredVolumeRollOver_vals), 0,
        NULL, HFILL }},
    { &hf_camel_elapsedTimeRollOver,
      { "elapsedTimeRollOver", "camel_elapsedTimeRollOver",
        FT_UINT32, BASE_DEC, VALS(camel_ElapsedTimeRollOver_vals), 0,
        NULL, HFILL }},
    { &hf_camel_minimumNbOfDigits,
      { "minimumNbOfDigits", "camel_minimumNbOfDigits",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_30", HFILL }},
    { &hf_camel_maximumNbOfDigits,
      { "maximumNbOfDigits", "camel_maximumNbOfDigits",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_30", HFILL }},
    { &hf_camel_endOfReplyDigit,
      { "endOfReplyDigit", "camel_endOfReplyDigit",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1_2", HFILL }},
    { &hf_camel_cancelDigit,
      { "cancelDigit", "camel_cancelDigit",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1_2", HFILL }},
    { &hf_camel_startDigit,
      { "startDigit", "camel_startDigit",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1_2", HFILL }},
    { &hf_camel_firstDigitTimeOut,
      { "firstDigitTimeOut", "camel_firstDigitTimeOut",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_127", HFILL }},
    { &hf_camel_interDigitTimeOut,
      { "interDigitTimeOut", "camel_interDigitTimeOut",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_127", HFILL }},
    { &hf_camel_errorTreatment,
      { "errorTreatment", "camel_errorTreatment",
        FT_UINT32, BASE_DEC, VALS(camel_ErrorTreatment_vals), 0,
        NULL, HFILL }},
    { &hf_camel_interruptableAnnInd,
      { "interruptableAnnInd", "camel_interruptableAnnInd",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_camel_voiceInformation,
      { "voiceInformation", "camel_voiceInformation",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_camel_voiceBack,
      { "voiceBack", "camel_voiceBack",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_camel_collectedDigits,
      { "collectedDigits", "camel_collectedDigits_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_basicGapCriteria,
      { "basicGapCriteria", "camel_basicGapCriteria",
    ...
    { &hf_camel_DestinationRoutingAddress_item,
      { "CalledPartyNumber", "camel_CalledPartyNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_applicationTimer,
      { "applicationTimer", "camel_applicationTimer",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_midCallControlInfo,
      { "midCallControlInfo", "camel_midCallControlInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_dpSpecificCriteriaAlt,
      { "dpSpecificCriteriaAlt", "camel_dpSpecificCriteriaAlt_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_changeOfPositionControlInfo,
      { "changeOfPositionControlInfo", "camel_changeOfPositionControlInfo",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_numberOfDigits,
      { "numberOfDigits", "camel_numberOfDigits",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_interDigitTimeout,
      { "interDigitTimeout", "camel_interDigitTimeout",
    ...
    { &hf_camel_oServiceChangeSpecificInfo,
      { "oServiceChangeSpecificInfo", "camel_oServiceChangeSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ext_basicServiceCode,
      { "ext-basicServiceCode", "camel_ext_basicServiceCode",
        FT_UINT32, BASE_DEC, VALS(gsm_map_Ext_BasicServiceCode_vals), 0,
        NULL, HFILL }},
    { &hf_camel_initiatorOfServiceChange,
      { "initiatorOfServiceChange", "camel_initiatorOfServiceChange",
        FT_UINT32, BASE_DEC, VALS(camel_InitiatorOfServiceChange_vals), 0,
        NULL, HFILL }},
    { &hf_camel_natureOfServiceChange,
      { "natureOfServiceChange", "camel_natureOfServiceChange",
        FT_UINT32, BASE_DEC, VALS(camel_NatureOfServiceChange_vals), 0,
        NULL, HFILL }},
    { &hf_camel_tServiceChangeSpecificInfo,
      { "tServiceChangeSpecificInfo", "camel_tServiceChangeSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_collectedInfoSpecificInfo,
      { "collectedInfoSpecificInfo", "camel_collectedInfoSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_timeGPRSIfNoTariffSwitch,
      { "timeGPRSIfNoTariffSwitch", "camel_timeGPRSIfNoTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_86400", HFILL }},
    { &hf_camel_timeGPRSIfTariffSwitch,
      { "timeGPRSIfTariffSwitch", "camel_timeGPRSIfTariffSwitch_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_timeGPRSSinceLastTariffSwitch,
      { "timeGPRSSinceLastTariffSwitch", "camel_timeGPRSSinceLastTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_86400", HFILL }},
    { &hf_camel_timeGPRSTariffSwitchInterval,
      { "timeGPRSTariffSwitchInterval", "camel_timeGPRSTariffSwitchInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_86400", HFILL }},
    { &hf_camel_rO_TimeGPRSIfNoTariffSwitch,
      { "rO-TimeGPRSIfNoTariffSwitch", "camel_rO_TimeGPRSIfNoTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_camel_rO_TimeGPRSIfTariffSwitch,
      { "rO-TimeGPRSIfTariffSwitch", "camel_rO_TimeGPRSIfTariffSwitch_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_rO_TimeGPRSSinceLastTariffSwitch,
      { "rO-TimeGPRSSinceLastTariffSwitch", "camel_rO_TimeGPRSSinceLastTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_camel_rO_TimeGPRSTariffSwitchInterval,
      { "rO-TimeGPRSTariffSwitchInterval", "camel_rO_TimeGPRSTariffSwitchInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_camel_pDPTypeOrganization,
      { "pDPTypeOrganization", "camel_pDPTypeOrganization",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_pDPTypeNumber,
      { "pDPTypeNumber", "camel_pDPTypeNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_pDPAddress,
      { "pDPAddress", "camel_pDPAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_routeSelectFailureSpecificInfo,
      { "routeSelectFailureSpecificInfo", "camel_routeSelectFailureSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_routeSelectfailureCause,
      { "failureCause", "camel_failureCause",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Cause", HFILL }},
    { &hf_camel_oCalledPartyBusySpecificInfo,
      { "oCalledPartyBusySpecificInfo", "camel_oCalledPartyBusySpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_busyCause,
      { "busyCause", "camel_busyCause",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Cause", HFILL }},
    { &hf_camel_oNoAnswerSpecificInfo,
      { "oNoAnswerSpecificInfo", "camel_oNoAnswerSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_oAnswerSpecificInfo,
      { "oAnswerSpecificInfo", "camel_oAnswerSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_destinationAddress,
      { "destinationAddress", "camel_destinationAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CalledPartyNumber", HFILL }},
    { &hf_camel_or_Call,
      { "or-Call", "camel_or_Call_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_forwardedCall,
      { "forwardedCall", "camel_forwardedCall_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_chargeIndicator,
      { "chargeIndicator", "camel_chargeIndicator",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_ext_basicServiceCode2,
      { "ext-basicServiceCode2", "camel_ext_basicServiceCode2",
        FT_UINT32, BASE_DEC, VALS(gsm_map_Ext_BasicServiceCode_vals), 0,
        "Ext_BasicServiceCode", HFILL }},
    { &hf_camel_oMidCallSpecificInfo,
      { "oMidCallSpecificInfo", "camel_oMidCallSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_omidCallEvents,
      { "midCallEvents", "camel_midCallEvents",
        FT_UINT32, BASE_DEC, VALS(camel_T_omidCallEvents_vals), 0,
        "T_omidCallEvents", HFILL }},
    { &hf_camel_dTMFDigitsCompleted,
      { "dTMFDigitsCompleted", "camel_dTMFDigitsCompleted",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Digits", HFILL }},
    { &hf_camel_dTMFDigitsTimeOut,
      { "dTMFDigitsTimeOut", "camel_dTMFDigitsTimeOut",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Digits", HFILL }},
    { &hf_camel_oDisconnectSpecificInfo,
      { "oDisconnectSpecificInfo", "camel_oDisconnectSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_releaseCause,
      { "releaseCause", "camel_releaseCause",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Cause", HFILL }},
    { &hf_camel_tBusySpecificInfo,
      { "tBusySpecificInfo", "camel_tBusySpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callForwarded,
      { "callForwarded", "camel_callForwarded_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_routeNotPermitted,
      { "routeNotPermitted", "camel_routeNotPermitted_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_forwardingDestinationNumber,
      { "forwardingDestinationNumber", "camel_forwardingDestinationNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CalledPartyNumber", HFILL }},
    { &hf_camel_tNoAnswerSpecificInfo,
      { "tNoAnswerSpecificInfo", "camel_tNoAnswerSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tAnswerSpecificInfo,
      { "tAnswerSpecificInfo", "camel_tAnswerSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tMidCallSpecificInfo,
      { "tMidCallSpecificInfo", "camel_tMidCallSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_tDisconnectSpecificInfo,
      { "tDisconnectSpecificInfo", "camel_tDisconnectSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_oTermSeizedSpecificInfo,
      { "oTermSeizedSpecificInfo", "camel_oTermSeizedSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_locationInformation,
      { "locationInformation", "camel_locationInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callAcceptedSpecificInfo,
      { "callAcceptedSpecificInfo", "camel_callAcceptedSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_oAbandonSpecificInfo,
      { "oAbandonSpecificInfo", "camel_oAbandonSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_oChangeOfPositionSpecificInfo,
      { "oChangeOfPositionSpecificInfo", "camel_oChangeOfPositionSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_metDPCriteriaList,
      { "metDPCriteriaList", "camel_metDPCriteriaList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tChangeOfPositionSpecificInfo,
      { "tChangeOfPositionSpecificInfo", "camel_tChangeOfPositionSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_dpSpecificInfoAlt,
      { "dpSpecificInfoAlt", "camel_dpSpecificInfoAlt_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_o_smsFailureSpecificInfo,
      { "o-smsFailureSpecificInfo", "camel_o_smsFailureSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_o_smsSubmissionSpecificInfo,
      { "o-smsSubmissionSpecificInfo", "camel_o_smsSubmissionSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_t_smsFailureSpecificInfo,
      { "t-smsFailureSpecificInfo", "camel_t_smsFailureSpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
    ...
    { &hf_camel_t_smsDeliverySpecificInfo,
      { "t-smsDeliverySpecificInfo", "camel_t_smsDeliverySpecificInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "T_t_smsDeliverySpecificInfo", HFILL }},
    { &hf_camel_Extensions_item,
      { "ExtensionField", "camel_ExtensionField_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_type,
      { "type", "camel_type",
    ...
    { &hf_camel_criticality,
      { "criticality", "camel_criticality",
        FT_UINT32, BASE_DEC, VALS(inap_CriticalityType_vals), 0,
        "CriticalityType", HFILL }},
    { &hf_camel_value,
      { "value", "camel_value_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callDiversionTreatmentIndicator,
      { "callDiversionTreatmentIndicator", "camel_callDiversionTreatmentIndicator",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1", HFILL }},
    { &hf_camel_callingPartyRestrictionIndicator,
      { "callingPartyRestrictionIndicator", "camel_callingPartyRestrictionIndicator",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_1", HFILL }},
    { &hf_camel_compoundGapCriteria,
      { "compoundGapCriteria", "camel_compoundGapCriteria_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "CompoundCriteria", HFILL }},
    { &hf_camel_gapIndicatorsDuration,
      { "duration", "camel_duration",
        FT_INT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_gapInterval,
      { "gapInterval", "camel_gapInterval",
        FT_INT32, BASE_DEC, NULL, 0,
        "Interval", HFILL }},
    { &hf_camel_informationToSend,
      { "informationToSend", "camel_informationToSend",
        FT_UINT32, BASE_DEC, VALS(camel_InformationToSend_vals), 0,
        NULL, HFILL }},
    { &hf_camel_GenericNumbers_item,
      { "GenericNumber", "camel_GenericNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_short_QoS_format,
      { "short-QoS-format", "camel_short_QoS_format",
        FT_BYTES, BASE_NONE, NULL, 0,
        "QoS_Subscribed", HFILL }},
    { &hf_camel_long_QoS_format,
      { "long-QoS-format", "camel_long_QoS_format",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Ext_QoS_Subscribed", HFILL }},
    { &hf_camel_supplement_to_long_QoS_format,
      { "supplement-to-long-QoS-format", "camel_supplement_to_long_QoS_format",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Ext2_QoS_Subscribed", HFILL }},
    { &hf_camel_additionalSupplement,
      { "additionalSupplement", "camel_additionalSupplement",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Ext3_QoS_Subscribed", HFILL }},
    { &hf_camel_gPRSEventType,
      { "gPRSEventType", "camel_gPRSEventType",
        FT_UINT32, BASE_DEC, VALS(camel_GPRSEventType_vals), 0,
        NULL, HFILL }},
    { &hf_camel_attachChangeOfPositionSpecificInformation,
      { "attachChangeOfPositionSpecificInformation", "camel_attachChangeOfPositionSpecificInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_locationInformationGPRS,
      { "locationInformationGPRS", "camel_locationInformationGPRS_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_pdp_ContextchangeOfPositionSpecificInformation,
      { "pdp-ContextchangeOfPositionSpecificInformation", "camel_pdp_ContextchangeOfPositionSpecificInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_accessPointName,
      { "accessPointName", "camel_accessPointName",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_chargingID,
      { "chargingID", "camel_chargingID",
        FT_BYTES, BASE_NONE, NULL, 0,
        "GPRSChargingID", HFILL }},
    { &hf_camel_endUserAddress,
      { "endUserAddress", "camel_endUserAddress_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_qualityOfService,
      { "qualityOfService", "camel_qualityOfService_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_timeAndTimeZone,
      { "timeAndTimeZone", "camel_timeAndTimeZone",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_gGSNAddress,
      { "gGSNAddress", "camel_gGSNAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "GSN_Address", HFILL }},
    { &hf_camel_detachSpecificInformation,
      { "detachSpecificInformation", "camel_detachSpecificInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_initiatingEntity,
      { "initiatingEntity", "camel_initiatingEntity",
        FT_UINT32, BASE_DEC, VALS(camel_InitiatingEntity_vals), 0,
        NULL, HFILL }},
    { &hf_camel_routeingAreaUpdate,
      { "routeingAreaUpdate", "camel_routeingAreaUpdate_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_disconnectSpecificInformation,
      { "disconnectSpecificInformation", "camel_disconnectSpecificInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_pDPContextEstablishmentSpecificInformation,
      { "pDPContextEstablishmentSpecificInformation", "camel_pDPContextEstablishmentSpecificInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_pDPInitiationType,
      { "pDPInitiationType", "camel_pDPInitiationType",
        FT_UINT32, BASE_DEC, VALS(camel_PDPInitiationType_vals), 0,
        NULL, HFILL }},
    { &hf_camel_secondaryPDP_context,
      { "secondaryPDP-context", "camel_secondaryPDP_context_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_pDPContextEstablishmentAcknowledgementSpecificInformation,
      { "pDPContextEstablishmentAcknowledgementSpecificInformation", "camel_pDPContextEstablishmentAcknowledgementSpecificInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_messageID,
      { "messageID", "camel_messageID",
        FT_UINT32, BASE_DEC, VALS(camel_MessageID_vals), 0,
        NULL, HFILL }},
    { &hf_camel_numberOfRepetitions,
      { "numberOfRepetitions", "camel_numberOfRepetitions",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_127", HFILL }},
    ...
    { &hf_camel_interval,
      { "interval", "camel_interval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_32767", HFILL }},
    { &hf_camel_inbandInfo,
      { "inbandInfo", "camel_inbandInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tone,
      { "tone", "camel_tone_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_cellGlobalIdOrServiceAreaIdOrLAI,
      { "cellGlobalIdOrServiceAreaIdOrLAI", "camel_cellGlobalIdOrServiceAreaIdOrLAI",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_routeingAreaIdentity,
      { "routeingAreaIdentity", "camel_routeingAreaIdentity",
        FT_BYTES, BASE_NONE, NULL, 0,
        "RAIdentity", HFILL }},
    { &hf_camel_geographicalInformation,
      { "geographicalInformation", "camel_geographicalInformation",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_sgsn_Number,
      { "sgsn-Number", "camel_sgsn_Number",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ISDN_AddressString", HFILL }},
    { &hf_camel_selectedLSAIdentity,
      { "selectedLSAIdentity", "camel_selectedLSAIdentity",
        FT_BYTES, BASE_NONE, NULL, 0,
        "LSAIdentity", HFILL }},
    { &hf_camel_extensionContainer,
      { "extensionContainer", "camel_extensionContainer_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_sai_Present,
      { "sai-Present", "camel_sai_Present_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_userCSGInformation,
      { "userCSGInformation", "camel_userCSGInformation",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_elementaryMessageID,
      { "elementaryMessageID", "camel_elementaryMessageID",
        FT_UINT32, BASE_DEC, NULL, 0,
        "Integer4", HFILL }},
    { &hf_camel_text,
      { "text", "camel_text_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_messageContent,
      { "messageContent", "camel_messageContent",
        FT_STRING, BASE_NONE, NULL, 0,
        "IA5String_SIZE_bound__minMessageContentLength_bound__maxMessageContentLength", HFILL }},
    { &hf_camel_attributes,
      { "attributes", "camel_attributes",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_bound__minAttributesLength_bound__maxAttributesLength", HFILL }},
    { &hf_camel_elementaryMessageIDs,
      { "elementaryMessageIDs", "camel_elementaryMessageIDs",
        FT_UINT32, BASE_DEC, NULL, 0,
        "SEQUENCE_SIZE_1_bound__numOfMessageIDs_OF_Integer4", HFILL }},
    { &hf_camel_elementaryMessageIDs_item,
      { "Integer4", "camel_Integer4",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_variableMessage,
      { "variableMessage", "camel_variableMessage_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_variableParts,
      { "variableParts", "camel_variableParts",
        FT_UINT32, BASE_DEC, NULL, 0,
        "SEQUENCE_SIZE_1_5_OF_VariablePart", HFILL }},
    { &hf_camel_variableParts_item,
      { "VariablePart", "camel_VariablePart",
        FT_UINT32, BASE_DEC, VALS(camel_VariablePart_vals), 0,
        NULL, HFILL }},
    { &hf_camel_MetDPCriteriaList_item,
      { "MetDPCriterion", "camel_MetDPCriterion",
        FT_UINT32, BASE_DEC, VALS(camel_MetDPCriterion_vals), 0,
        NULL, HFILL }},
    { &hf_camel_enteringCellGlobalId,
      { "enteringCellGlobalId", "camel_enteringCellGlobalId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CellGlobalIdOrServiceAreaIdFixedLength", HFILL }},
    { &hf_camel_leavingCellGlobalId,
      { "leavingCellGlobalId", "camel_leavingCellGlobalId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CellGlobalIdOrServiceAreaIdFixedLength", HFILL }},
    { &hf_camel_enteringServiceAreaId,
      { "enteringServiceAreaId", "camel_enteringServiceAreaId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CellGlobalIdOrServiceAreaIdFixedLength", HFILL }},
    { &hf_camel_leavingServiceAreaId,
      { "leavingServiceAreaId", "camel_leavingServiceAreaId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CellGlobalIdOrServiceAreaIdFixedLength", HFILL }},
    { &hf_camel_enteringLocationAreaId,
      { "enteringLocationAreaId", "camel_enteringLocationAreaId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "LAIFixedLength", HFILL }},
    { &hf_camel_leavingLocationAreaId,
      { "leavingLocationAreaId", "camel_leavingLocationAreaId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "LAIFixedLength", HFILL }},
    { &hf_camel_inter_SystemHandOverToUMTS,
      { "inter-SystemHandOverToUMTS", "camel_inter_SystemHandOverToUMTS_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_inter_SystemHandOverToGSM,
      { "inter-SystemHandOverToGSM", "camel_inter_SystemHandOverToGSM_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_metDPCriterionAlt,
      { "metDPCriterionAlt", "camel_metDPCriterionAlt_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_minimumNumberOfDigits,
      { "minimumNumberOfDigits", "camel_minimumNumberOfDigits",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_30", HFILL }},
    { &hf_camel_maximumNumberOfDigits,
      { "maximumNumberOfDigits", "camel_maximumNumberOfDigits",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_1_30", HFILL }},
    { &hf_camel_requested_QoS,
      { "requested-QoS", "camel_requested_QoS",
        FT_UINT32, BASE_DEC, VALS(camel_GPRS_QoS_vals), 0,
        "GPRS_QoS", HFILL }},
    { &hf_camel_subscribed_QoS,
      { "subscribed-QoS", "camel_subscribed_QoS",
        FT_UINT32, BASE_DEC, VALS(camel_GPRS_QoS_vals), 0,
        "GPRS_QoS", HFILL }},
    { &hf_camel_negotiated_QoS,
      { "negotiated-QoS", "camel_negotiated_QoS",
        FT_UINT32, BASE_DEC, VALS(camel_GPRS_QoS_vals), 0,
        "GPRS_QoS", HFILL }},
    { &hf_camel_requested_QoS_Extension,
      { "requested-QoS-Extension", "camel_requested_QoS_Extension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GPRS_QoS_Extension", HFILL }},
    { &hf_camel_subscribed_QoS_Extension,
      { "subscribed-QoS-Extension", "camel_subscribed_QoS_Extension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GPRS_QoS_Extension", HFILL }},
    { &hf_camel_negotiated_QoS_Extension,
      { "negotiated-QoS-Extension", "camel_negotiated_QoS_Extension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "GPRS_QoS_Extension", HFILL }},
    { &hf_camel_receivingSideID,
      { "receivingSideID", "camel_receivingSideID",
        FT_BYTES, BASE_NONE, NULL, 0,
        "LegType", HFILL }},
    { &hf_camel_RequestedInformationList_item,
      { "RequestedInformation", "camel_RequestedInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_RequestedInformationTypeList_item,
      { "RequestedInformationType", "camel_RequestedInformationType",
    ...
    { &hf_camel_timeIfNoTariffSwitch,
      { "timeIfNoTariffSwitch", "camel_timeIfNoTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_timeIfTariffSwitch,
      { "timeIfTariffSwitch", "camel_timeIfTariffSwitch_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_toneID,
      { "toneID", "camel_toneID",
    ...
    { &hf_camel_volumeIfNoTariffSwitch,
      { "volumeIfNoTariffSwitch", "camel_volumeIfNoTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4294967295", HFILL }},
    { &hf_camel_volumeIfTariffSwitch,
      { "volumeIfTariffSwitch", "camel_volumeIfTariffSwitch_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_volumeSinceLastTariffSwitch,
      { "volumeSinceLastTariffSwitch", "camel_volumeSinceLastTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4294967295", HFILL }},
    { &hf_camel_volumeTariffSwitchInterval,
      { "volumeTariffSwitchInterval", "camel_volumeTariffSwitchInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_4294967295", HFILL }},
    { &hf_camel_rO_VolumeIfNoTariffSwitch,
      { "rO-VolumeIfNoTariffSwitch", "camel_rO_VolumeIfNoTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_camel_rO_VolumeIfTariffSwitch,
      { "rO-VolumeIfTariffSwitch", "camel_rO_VolumeIfTariffSwitch_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_rO_VolumeSinceLastTariffSwitch,
      { "rO-VolumeSinceLastTariffSwitch", "camel_rO_VolumeSinceLastTariffSwitch",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_camel_rO_VolumeTariffSwitchInterval,
      { "rO-VolumeTariffSwitchInterval", "camel_rO_VolumeTariffSwitchInterval",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_255", HFILL }},
    { &hf_camel_integer,
      { "integer", "camel_integer",
        FT_UINT32, BASE_DEC, NULL, 0,
        "Integer4", HFILL }},
    { &hf_camel_number,
      { "number", "camel_number",
    ...
    { &hf_camel_par_cancelFailedProblem,
      { "problem", "camel_problem",
        FT_UINT32, BASE_DEC, VALS(camel_T_par_cancelFailedProblem_vals), 0,
        "T_par_cancelFailedProblem", HFILL }},
    { &hf_camel_operation,
      { "operation", "camel_operation",
        FT_INT32, BASE_DEC, NULL, 0,
        "InvokeID", HFILL }},
    { &hf_camel_destinationReference,
      { "destinationReference", "camel_destinationReference",
        FT_UINT32, BASE_DEC, NULL, 0,
        "Integer4", HFILL }},
    { &hf_camel_originationReference,
      { "originationReference", "camel_originationReference",
        FT_UINT32, BASE_DEC, NULL, 0,
        "Integer4", HFILL }},
    { &hf_camel_disconnectFromIPForbidden,
      { "disconnectFromIPForbidden", "camel_disconnectFromIPForbidden",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_camel_requestAnnouncementCompleteNotification,
      { "requestAnnouncementCompleteNotification", "camel_requestAnnouncementCompleteNotification",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_camel_requestAnnouncementStartedNotification,
      { "requestAnnouncementStartedNotification", "camel_requestAnnouncementStartedNotification",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    { &hf_camel_collectedInfo,
      { "collectedInfo", "camel_collectedInfo",
        FT_UINT32, BASE_DEC, VALS(camel_CollectedInfo_vals), 0,
        NULL, HFILL }},
    { &hf_camel_digitsResponse,
      { "digitsResponse", "camel_digitsResponse",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Digits", HFILL }},
    { &hf_camel_allAnnouncementsComplete,
      { "allAnnouncementsComplete", "camel_allAnnouncementsComplete_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_firstAnnouncementStarted,
      { "firstAnnouncementStarted", "camel_firstAnnouncementStarted_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_aChBillingChargingCharacteristics,
      { "aChBillingChargingCharacteristics", "camel_aChBillingChargingCharacteristics",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_requestedInformationTypeList,
      { "requestedInformationTypeList", "camel_requestedInformationTypeList",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_legID_02,
      { "legID", "camel_legID",
    ...
    { &hf_camel_allRequests,
      { "allRequests", "camel_allRequests_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callSegmentToCancel,
      { "callSegmentToCancel", "camel_callSegmentToCancel_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_destinationRoutingAddress,
      { "destinationRoutingAddress", "camel_destinationRoutingAddress",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_alertingPattern,
      { "alertingPattern", "camel_alertingPattern",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_originalCalledPartyID,
      { "originalCalledPartyID", "camel_originalCalledPartyID",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_carrier,
      { "carrier", "camel_carrier",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callingPartysCategory,
      { "callingPartysCategory", "camel_callingPartysCategory",
        FT_UINT16, BASE_DEC|BASE_EXT_STRING, &isup_calling_partys_category_value_ext, 0,
        NULL, HFILL }},
    { &hf_camel_redirectingPartyID,
      { "redirectingPartyID", "camel_redirectingPartyID",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_redirectionInformation,
      { "redirectionInformation", "camel_redirectionInformation",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_genericNumbers,
      { "genericNumbers", "camel_genericNumbers",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_serviceInteractionIndicatorsTwo,
      { "serviceInteractionIndicatorsTwo", "camel_serviceInteractionIndicatorsTwo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_chargeNumber,
      { "chargeNumber", "camel_chargeNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_legToBeConnected,
      { "legToBeConnected", "camel_legToBeConnected",
        FT_UINT32, BASE_DEC, VALS(inap_LegID_vals), 0,
        "LegID", HFILL }},
    { &hf_camel_cug_Interlock,
      { "cug-Interlock", "camel_cug_Interlock",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_cug_OutgoingAccess,
      { "cug-OutgoingAccess", "camel_cug_OutgoingAccess_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_suppressionOfAnnouncement,
      { "suppressionOfAnnouncement", "camel_suppressionOfAnnouncement_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_oCSIApplicable,
      { "oCSIApplicable", "camel_oCSIApplicable_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_naOliInfo,
      { "naOliInfo", "camel_naOliInfo",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_bor_InterrogationRequested,
      { "bor-InterrogationRequested", "camel_bor_InterrogationRequested_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_suppress_N_CSI,
      { "suppress-N-CSI", "camel_suppress_N_CSI_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_resourceAddress,
      { "resourceAddress", "camel_resourceAddress",
        FT_UINT32, BASE_DEC, VALS(camel_T_resourceAddress_vals), 0,
        NULL, HFILL }},
    { &hf_camel_ipRoutingAddress,
      { "ipRoutingAddress", "camel_ipRoutingAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_none,
      { "none", "camel_none_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_suppress_O_CSI,
      { "suppress-O-CSI", "camel_suppress_O_CSI_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_continueWithArgumentArgExtension,
      { "continueWithArgumentArgExtension", "camel_continueWithArgumentArgExtension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_suppress_D_CSI,
      { "suppress-D-CSI", "camel_suppress_D_CSI_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_suppressOutgoingCallBarring,
      { "suppressOutgoingCallBarring", "camel_suppressOutgoingCallBarring_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_legOrCallSegment,
      { "legOrCallSegment", "camel_legOrCallSegment",
        FT_UINT32, BASE_DEC, VALS(camel_LegOrCallSegment_vals), 0,
        NULL, HFILL }},
    { &hf_camel_legToBeReleased,
      { "legToBeReleased", "camel_legToBeReleased",
        FT_UINT32, BASE_DEC, VALS(inap_LegID_vals), 0,
        "LegID", HFILL }},
    { &hf_camel_callSegmentFailure,
      { "callSegmentFailure", "camel_callSegmentFailure_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_bCSM_Failure,
      { "bCSM-Failure", "camel_bCSM_Failure_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_assistingSSPIPRoutingAddress,
      { "assistingSSPIPRoutingAddress", "camel_assistingSSPIPRoutingAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callingPartyNumber,
      { "callingPartyNumber", "camel_callingPartyNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_eventSpecificInformationBCSM,
      { "eventSpecificInformationBCSM", "camel_eventSpecificInformationBCSM",
        FT_UINT32, BASE_DEC, VALS(camel_EventSpecificInformationBCSM_vals), 0,
        NULL, HFILL }},
    { &hf_camel_miscCallInfo,
      { "miscCallInfo", "camel_miscCallInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_cGEncountered,
      { "cGEncountered", "camel_cGEncountered",
        FT_UINT32, BASE_DEC, VALS(camel_CGEncountered_vals), 0,
        NULL, HFILL }},
    { &hf_camel_locationNumber,
      { "locationNumber", "camel_locationNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_highLayerCompatibility,
      { "highLayerCompatibility", "camel_highLayerCompatibility",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_additionalCallingPartyNumber,
      { "additionalCallingPartyNumber", "camel_additionalCallingPartyNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_bearerCapability,
      { "bearerCapability", "camel_bearerCapability",
        FT_UINT32, BASE_DEC, VALS(camel_BearerCapability_vals), 0,
        NULL, HFILL }},
    { &hf_camel_cug_Index,
      { "cug-Index", "camel_cug_Index",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_iMSI,
      { "iMSI", "camel_iMSI",
    ...
    { &hf_camel_subscriberState,
      { "subscriberState", "camel_subscriberState",
        FT_UINT32, BASE_DEC, VALS(gsm_map_ms_SubscriberState_vals), 0,
        NULL, HFILL }},
    { &hf_camel_callReferenceNumber,
      { "callReferenceNumber", "camel_callReferenceNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_mscAddress,
      { "mscAddress", "camel_mscAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ISDN_AddressString", HFILL }},
    { &hf_camel_calledPartyBCDNumber,
      { "calledPartyBCDNumber", "camel_calledPartyBCDNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_timeAndTimezone,
      { "timeAndTimezone", "camel_timeAndTimezone",
    ...
    { &hf_camel_callForwardingSS_Pending,
      { "callForwardingSS-Pending", "camel_callForwardingSS_Pending_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_initialDPArgExtension,
      { "initialDPArgExtension", "camel_initialDPArgExtension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_gmscAddress,
      { "gmscAddress", "camel_gmscAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ISDN_AddressString", HFILL }},
    { &hf_camel_ms_Classmark2,
      { "ms-Classmark2", "camel_ms_Classmark2",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_iMEI,
      { "iMEI", "camel_iMEI",
    ...
    { &hf_camel_supportedCamelPhases,
      { "supportedCamelPhases", "camel_supportedCamelPhases",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_offeredCamel4Functionalities,
      { "offeredCamel4Functionalities", "camel_offeredCamel4Functionalities",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_bearerCapability2,
      { "bearerCapability2", "camel_bearerCapability2",
        FT_UINT32, BASE_DEC, VALS(camel_BearerCapability_vals), 0,
        "BearerCapability", HFILL }},
    { &hf_camel_highLayerCompatibility2,
      { "highLayerCompatibility2", "camel_highLayerCompatibility2",
        FT_BYTES, BASE_NONE, NULL, 0,
        "HighLayerCompatibility", HFILL }},
    { &hf_camel_lowLayerCompatibility,
      { "lowLayerCompatibility", "camel_lowLayerCompatibility",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_lowLayerCompatibility2,
      { "lowLayerCompatibility2", "camel_lowLayerCompatibility2",
        FT_BYTES, BASE_NONE, NULL, 0,
        "LowLayerCompatibility", HFILL }},
    { &hf_camel_enhancedDialledServicesAllowed,
      { "enhancedDialledServicesAllowed", "camel_enhancedDialledServicesAllowed_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_uu_Data,
      { "uu-Data", "camel_uu_Data_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_collectInformationAllowed,
      { "collectInformationAllowed", "camel_collectInformationAllowed_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_releaseCallArgExtensionAllowed,
      { "releaseCallArgExtensionAllowed", "camel_releaseCallArgExtensionAllowed_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_legToBeCreated,
      { "legToBeCreated", "camel_legToBeCreated",
        FT_UINT32, BASE_DEC, VALS(inap_LegID_vals), 0,
        "LegID", HFILL }},
    { &hf_camel_newCallSegment,
      { "newCallSegment", "camel_newCallSegment",
        FT_UINT32, BASE_DEC, NULL, 0,
        "CallSegmentID", HFILL }},
    { &hf_camel_gsmSCFAddress,
      { "gsmSCFAddress", "camel_gsmSCFAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ISDN_AddressString", HFILL }},
    { &hf_camel_suppress_T_CSI,
      { "suppress-T-CSI", "camel_suppress_T_CSI_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_legIDToMove,
      { "legIDToMove", "camel_legIDToMove",
        FT_UINT32, BASE_DEC, VALS(inap_LegID_vals), 0,
        "LegID", HFILL }},
    { &hf_camel_allCallSegments,
      { "allCallSegments", "camel_allCallSegments",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_allCallSegmentsWithExtension,
      { "allCallSegmentsWithExtension", "camel_allCallSegmentsWithExtension_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_bcsmEvents,
      { "bcsmEvents", "camel_bcsmEvents",
        FT_UINT32, BASE_DEC, NULL, 0,
        "SEQUENCE_SIZE_1_bound__numOfBCSMEvents_OF_BCSMEvent", HFILL }},
    { &hf_camel_bcsmEvents_item,
      { "BCSMEvent", "camel_BCSMEvent_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_timerID,
      { "timerID", "camel_timerID",
        FT_UINT32, BASE_DEC, VALS(camel_TimerID_vals), 0,
        NULL, HFILL }},
    { &hf_camel_timervalue,
      { "timervalue", "camel_timervalue",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_sCIBillingChargingCharacteristics,
      { "sCIBillingChargingCharacteristics", "camel_sCIBillingChargingCharacteristics",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_legToBeSplit,
      { "legToBeSplit", "camel_legToBeSplit",
        FT_UINT32, BASE_DEC, VALS(inap_LegID_vals), 0,
        "LegID", HFILL }},
    { &hf_camel_chargingCharacteristics,
      { "chargingCharacteristics", "camel_chargingCharacteristics",
    ...
    { &hf_camel_chargingResult,
      { "chargingResult", "camel_chargingResult",
    ...
    { &hf_camel_chargingRollOver,
      { "chargingRollOver", "camel_chargingRollOver",
    ...
    { &hf_camel_pdpID,
      { "pdpID", "camel_pdpID",
        ...
        NULL, HFILL }},
    { &hf_camel_gPRSCause,
      { "gPRSCause", "camel_gPRSCause",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_miscGPRSInfo,
      { "miscGPRSInfo", "camel_miscGPRSInfo_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "MiscCallInfo", HFILL }},
    { &hf_camel_gPRSEventSpecificInformation,
      { "gPRSEventSpecificInformation", "camel_gPRSEventSpecificInformation",
    ...
    { &hf_camel_gPRSMSClass,
      { "gPRSMSClass", "camel_gPRSMSClass_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_sGSNCapabilities,
      { "sGSNCapabilities", "camel_sGSNCapabilities",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_gprsCause,
      { "gprsCause", "camel_gprsCause",
        ...
        NULL, HFILL }},
    { &hf_camel_gPRSEvent,
      { "gPRSEvent", "camel_gPRSEvent",
        FT_UINT32, BASE_DEC, NULL, 0,
        "SEQUENCE_SIZE_1_bound__numOfGPRSEvents_OF_GPRSEvent", HFILL }},
    { &hf_camel_gPRSEvent_item,
      { "GPRSEvent", "camel_GPRSEvent_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_sCIGPRSBillingChargingCharacteristics,
      { "sCIGPRSBillingChargingCharacteristics", "camel_sCIGPRSBillingChargingCharacteristics",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_callingPartysNumber,
      { "callingPartysNumber", "camel_callingPartysNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        "SMS_AddressString", HFILL }},
    { &hf_camel_destinationSubscriberNumber,
      { "destinationSubscriberNumber", "camel_destinationSubscriberNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        "CalledPartyBCDNumber", HFILL }},
    { &hf_camel_sMSCAddress,
      { "sMSCAddress", "camel_sMSCAddress",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ISDN_AddressString", HFILL }},
    { &hf_camel_eventSpecificInformationSMS,
      { "eventSpecificInformationSMS", "camel_eventSpecificInformationSMS",
    ...
    { &hf_camel_locationInformationMSC,
      { "locationInformationMSC", "camel_locationInformationMSC_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "LocationInformation", HFILL }},
    { &hf_camel_tPShortMessageSpecificInfo,
      { "tPShortMessageSpecificInfo", "camel_tPShortMessageSpecificInfo",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tPProtocolIdentifier,
      { "tPProtocolIdentifier", "camel_tPProtocolIdentifier",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tPDataCodingScheme,
      { "tPDataCodingScheme", "camel_tPDataCodingScheme",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_tPValidityPeriod,
      { "tPValidityPeriod", "camel_tPValidityPeriod",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_smsReferenceNumber,
      { "smsReferenceNumber", "camel_smsReferenceNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
    ...
    { &hf_camel_extensions_item,
      { "ExtensionField", "camel_ExtensionField_element",
        ...
        NULL, HFILL }},
    { &hf_camel_na_info,
      { "na-info", "camel_na_info_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_naCarrierInformation,
      { "naCarrierInformation", "camel_naCarrierInformation_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_naCarrierId,
      { "naCarrierId", "camel_naCarrierId",
        FT_BYTES, BASE_NONE, NULL, 0,
        "NAEA_CIC", HFILL }},
    { &hf_camel_naCICSelectionType,
      { "naCICSelectionType", "camel_naCICSelectionType",
        FT_BYTES, BASE_NONE, NULL, 0,
        "NACarrierSelectionInfo", HFILL }},
    { &hf_camel_naChargeNumber,
      { "naChargeNumber", "camel_naChargeNumber",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_releaseIfdurationExceeded_01,
      { "releaseIfdurationExceeded", "camel_releaseIfdurationExceeded_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_global,
      { "global", "camel_global",
        ...
        NULL, HFILL }},
    { &hf_camel_invoke,
      { "invoke", "camel_invoke_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_returnResult,
      { "returnResult", "camel_returnResult_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_returnError,
      { "returnError", "camel_returnError_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_reject,
      { "reject", "camel_reject_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_invokeId,
      { "invokeId", "camel_invokeId",
    ...
    { &hf_camel_opcode,
      { "opcode", "camel_opcode",
        ...
        "Code", HFILL }},
    { &hf_camel_argument,
      { "argument", "camel_argument_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_result,
      { "result", "camel_result_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    ...
    { &hf_camel_errcode,
      { "errcode", "camel_errcode",
        FT_UINT32, BASE_DEC, VALS(camel_Code_vals), 0,
        "Code", HFILL }},
    { &hf_camel_parameter,
      { "parameter", "camel_parameter_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_camel_problem,
      { "problem", "camel_problem",
    ...
    { &hf_camel_InvokeId_present,
      { "InvokeId.present", "camel_InvokeId_present",
        FT_INT32, BASE_DEC, NULL, 0,
