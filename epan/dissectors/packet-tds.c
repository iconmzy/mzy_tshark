...
proto_register_tds(void)
{
    static hf_register_info hf[] = {
        ...
        /* CAPABILITY token */
        { &hf_tds_capability,
          { "Token - Capability", "tds_capability",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_capability_length,
          { "Token length", "tds_capability_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_capability_captype,
          { "Capability type", "tds_capability_captype",
            FT_UINT8, BASE_DEC, VALS(tds_capability_type), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_capability_caplen,
          { "Capability len", "tds_capability_caplen",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_lang,
          { "Language requests", "tds_capability_req_lang",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_rpc,
          { "RPC requests", "tds_capability_req_rpc",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_evt,
          { "RPC event notifications", "tds_capability_req_evt",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_mstmt,
          { "Multiple commands per request", "tds_capability_req_mstmt",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_bcp,
          { "Bulk copy requests", "tds_capability_req_bcp",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_cursor,
          { "Cursor command requests", "tds_capability_req_cursor",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_dynf,
          { "Dynamic SQL requests", "tds_capability_req_dynf",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_msg,
          { "TDS_MSG requests", "tds_capability_req_msg",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_param,
          { "TDS_DBRPC/TDS_PARAM requests", "tds_capability_req_param",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_not_allowed), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_int1,
          { "Support 1-byte unsigned ints", "tds_capability_data_int1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_int2,
          { "Support 2-byte ints", "tds_capability_data_int2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_int4,
          { "Support 4-byte ints", "tds_capability_data_int4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_bit,
          { "Support bits", "tds_capability_data_bit",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_char,
          { "Support fixed-length character types", "tds_capability_data_char",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_vchar,
          { "Support variable-length character types", "tds_capability_data_vchar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_bin,
          { "Support fixed-length binary", "tds_capability_data_bin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_vbin,
          { "Support variable-length binary", "tds_capability_data_vbin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_mny8,
          { "Support 8-byte money", "tds_capability_data_mny8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_mny4,
          { "Support 4-byte money", "tds_capability_data_mny4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_date8,
          { "Support 8-byte datetime", "tds_capability_data_date8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_date4,
          { "Support 4-byte datetime", "tds_capability_data_date4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_flt4,
          { "Support 4-byte float", "tds_capability_data_flt4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_flt8,
          { "Support 8-byte float", "tds_capability_data_flt8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_num,
          { "Support numeric", "tds_capability_data_num",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_text,
          { "Support text data", "tds_capability_data_text",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_image,
          { "Support image data", "tds_capability_data_image",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_dec,
          { "Support decimal", "tds_capability_data_dec",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_lchar,
          { "Support long variable-length character types", "tds_capability_data_lchar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_lbin,
          { "Support long variable-length binary types", "tds_capability_data_lbin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_intn,
          { "Support nullable ints", "tds_capability_data_intn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_datetimen,
          { "Support nullable datetime", "tds_capability_data_datetimen",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_moneyn,
          { "Support nullable money", "tds_capability_data_moneyn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_prev,
          { "Support fetch previous cursor", "tds_capability_csr_prev",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_first,
          { "Support fetch first cursor", "tds_capability_csr_first",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_last,
          { "Support fetch last cursor", "tds_capability_csr_last",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_abs,
          { "Support fetch absolute cursor", "tds_capability_csr_abs",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_rel,
          { "Support fetch relative cursor", "tds_capability_csr_rel",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_multi,
          { "Support fetch multi-row cursor", "tds_capability_csr_multi",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_con_oob,
          { "Support expedited attention", "tds_capability_con_oob",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_con_inband,
          { "Support non-expedited attention", "tds_capability_con_inband",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_con_logical,
          { "Support logical logout", "tds_capability_con_logout",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_proto_text,
          { "Support tokenized text/image", "tds_capability_proto_text",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_proto_bulk,
          { "Support tokenized bcp", "tds_capability_proto_bulk",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_urgevt,
          { "Use new event notification", "tds_capability_req_urgevt",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_sensitivity,
          { "Support sensitivity data", "tds_capability_data_sensitivity",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_boundary,
          { "Support boundary data", "tds_capability_data_boundary",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_proto_dynamic,
          { "Use DESCIN/DESCOUT dynamic protocol", "tds_capability_proto_dynamic",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_proto_dynproc,
          { "Prepend \"create proc\" to dynamic prepares", "tds_capability_proto_dynproc",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_fltn,
          { "Support nullable floats", "tds_capability_data_fltn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_bitn,
          { "Support nullable bits", "tds_capability_data_bitn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_int8,
          { "Support 8-byte ints", "tds_capability_data_int8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_void,
          { "Undocumented TDS_DATA_VOID", "tds_capability_data_void",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_dol_bulk,
          { "Undocumented TDS_DOL_VOID", "tds_capability_dol_bulk",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_object_java1,
          { "Support serialized java objects", "tds_capability_object_java1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_object_char,
          { "Support streaming char data", "tds_capability_object_char",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_object_binary,
          { "Support streaming binary data", "tds_capability_object_binary",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_columnstatus,
          { "Add status field to ROW/PARAMS", "tds_capability_data_columnstatus",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_widetable,
          { "Allow wide-table tokens", "tds_capability_widetable",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_uint2,
          { "Support 2-byte unsigned ints", "tds_capability_data_uint2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_uint4,
          { "Support 4-byte unsigned ints", "tds_capability_data_uint4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_uint8,
          { "Support 8-byte unsigned ints", "tds_capability_data_uint8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_uintn,
          { "Support nullable unsigned ints", "tds_capability_data_uintn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_cur_implicit,
          { "Support TDS_CUR_DOPT_IMPLICIT", "tds_capability_cur_implicit",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nlbin,
          { "Support UTF-16 LONGBINARY", "tds_capability_data_nlbin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_image_nchar,
          { "Support UTF-16 IMAGE", "tds_capability_image_nchar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_blob_nchar_16,
          { "Support BLOB serialization 0", "tds_capability_blob_nchar_16",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_blob_nchar_8,
          { "Support BLOB serialization 1", "tds_capability_blob_nchar_8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_blob_nchar_scsu,
          { "Support BLOB serialization 2", "tds_capability_blob_nchar_scsu",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_date,
          { "Support DATE", "tds_capability_data_date",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_time,
          { "Support TIME", "tds_capability_data_time",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_interval,
          { "Support INTERVAL", "tds_capability_data_interval",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_scroll,
          { "Support scrollable cursor", "tds_capability_csr_scroll",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_sensitive,
          { "Support sens. scr csr", "tds_capability_csr_sensitive",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_insensitive,
          { "Support insens. scr csr", "tds_capability_csr_insensitive",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_semisensitive,
          { "Support semisens. scr csr", "tds_capability_csr_semisensitive",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_csr_keysetdriven,
          { "Support scr keyset driven csr", "tds_capability_csr_keysetdriven",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_srvpktsize,
          { "Support server-spec. packet size", "tds_capability_req_srvpktsize",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_unitext,
          { "Support UTF-16 text", "tds_capability_data_unitext",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_cap_clusterfailover,
          { "Support cluster failover", "tds_capability_cap_clusterfailover",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_sint1,
          { "Support signed 1-byte ints", "tds_capability_data_sint1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_largeident,
          { "Support large identifiers", "tds_capability_req_largeident",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_blob_nchar_16,
          { "Support BLOB serialization 0 (new)", "tds_capability_req_blob_nchar_16",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_xml,
          { "Support XML type", "tds_capability_data_xml",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_curinfo3,
          { "Support TDS_CURINFO3 token", "tds_capability_req_curinfo3",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_req_dbrpc2,
          { "Support TDS_DBRPC2 token", "tds_capability_req_dbrpc2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_nomsg,
          { "No sup. for TDS_MSG result", "tds_capability_res_nomsg",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_noeed,
          { "No sup. for TDS_EED token", "tds_capability_res_noeed",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_noparam,
          { "No sup. for TDS_PARAM return param", "tds_capability_res_noparam",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noint1,
          { "No sup. for unsigned 1-byte ints", "tds_capability_data_noint1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noint2,
          { "No sup. for 2-byte ints", "tds_capability_data_noint2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noint4,
          { "No sup. for 4-byte ints", "tds_capability_data_noint4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nobit,
          { "No sup. for BIT type", "tds_capability_data_nobit",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nochar,
          { "No sup. for fixed-length char", "tds_capability_data_nochar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_novchar,
          { "No sup. for variable-length char", "tds_capability_data_novchar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nobin,
          { "No sup. for fixed-length binary", "tds_capability_data_nobin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_novbin,
          { "No sup. for variable-length binary", "tds_capability_data_novbin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nomny8,
          { "No sup. for 8-byte money", "tds_capability_data_nomny8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nomny4,
          { "No sup. for 4-byte money", "tds_capability_data_nomny4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nodate8,
          { "No sup. for 8-byte datetime", "tds_capability_data_nodate8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nodate4,
          { "No sup. for 4-byte datetime", "tds_capability_data_nodate4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noflt4,
          { "No sup. for 4-byte floats", "tds_capability_data_noflt4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noflt8,
          { "No sup. for 8-byte floats", "tds_capability_data_noflt8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nonum,
          { "No sup. for NUMERIC", "tds_capability_data_nonum",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_notext,
          { "No sup. for TEXT", "tds_capability_data_notext",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noimage,
          { "No sup. for IMAGE", "tds_capability_data_noimage",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nodec,
          { "No sup. for DECIMAL", "tds_capability_data_nodec",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nolchar,
          { "No sup. for long character types", "tds_capability_data_nolchar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nolbin,
          { "No sup. for long binary types", "tds_capability_data_nolbin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nointn,
          { "No sup. for nullable ints", "tds_capability_data_nointn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nodatetimen,
          { "No sup. for nullable datetime", "tds_capability_data_nodatetimen",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nomoneyn,
          { "No sup. for nullable money", "tds_capability_data_nomoneyn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_con_nooob,
          { "No sup. for expedited attentions", "tds_capability_con_nooob",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_con_noinband,
          { "No sup. for non-expedited attentions", "tds_capability_con_noinband",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_proto_notext,
          { "No sup. for tokenized text/image", "tds_capability_proto_notext",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_proto_nobulk,
          { "No sup. for tokenized BCP", "tds_capability_proto_nobulk",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nosensitivity,
          { "No sup. for sensitivity", "tds_capability_data_nosensitivity",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noboundary,
          { "No sup. for BOUNDARY", "tds_capability_data_noboundary",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_notdsdebug,
          { "No sup. for TDS_DEBUG token", "tds_capability_res_notdsdebug",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_nostripblanks,
          { "Do not strip blanks from CHAR", "tds_capability_res_nostripblanks",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noint8,
          { "No sup. for 8-byte ints", "tds_capability_data_noint8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_object_nojava1,
          { "No sup. for serialized Java objects", "tds_capability_object_nojava1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_object_nochar,
          { "No sup. for streaming char data", "tds_capability_object_nochar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nocolumnstatus,
          { "No sup. for columnstatus byte", "tds_capability_data_nocolumnstatus",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_object_nobinary,
          { "No sup. for streaming binary data", "tds_capability_object_nobinary",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nouint2,
          { "No sup. for 2-byte unsigned ints", "tds_capability_data_nouint2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nouint4,
          { "No sup. for 4-byte unsigned ints", "tds_capability_data_nouint4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nouint8,
          { "No sup. for 8-byte unsigned ints", "tds_capability_data_nouint8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nouintn,
          { "No sup. for nullable unsigned ints", "tds_capability_data_nouintn",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_no_widetables,
          { "No sup. for wide-table tokens", "tds_capability_no_widetables",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nonlbin,
          { "No sup. for LONGBINARY with UTF-16", "tds_capability_data_nonlbin",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_image_nonchar,
          { "No sup. for IMAGE with UTF-16", "tds_capability_image_nonchar",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_blob_nonchar_16,
          { "No sup. for BLOB subtype 0", "tds_capability_blob_nonchar_16",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_blob_nonchar_8,
          { "No sup. for BLOB subtype 1", "tds_capability_blob_nonchar_8",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_blob_nonchar_scsu,
          { "No sup. for BLOB subtype 2", "tds_capability_blob_nonchar_scsu",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nodate,
          { "No sup. for DATE", "tds_capability_data_nodate",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_notime,
          { "No sup. for TIME", "tds_capability_data_notime",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nointerval,
          { "No sup. for INTERVAL", "tds_capability_data_nointerval",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nounitext,
          { "No sup. for TEXT with UTF-16", "tds_capability_data_nounitext",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_nosint1,
          { "No sup. for 1-byte signed ints", "tds_capability_data_nosint1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_no_largeident,
          { "No sup. for large identifiers", "tds_capability_no_largeident",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_tds_capability_no_blob_nchar_16,
          { "No sup. for BLOB type 0 (replacement)", "tds_capability_no_blob_nchar_16",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_tds_capability_no_srvpktsize,
          { "No sup. for server spec pkt size", "tds_capability_no_srvpktsize",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_tds_capability_data_noxml,
          { "No sup. for XML data", "tds_capability_data_noxml",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_tds_capability_no_nint_return_value,
          { "No sup. for non-int return value", "tds_capability_no_nint_return_value",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_noxnldata,
          { "No req. for ROWFMT2 data", "tds_capability_res_noxnldata",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_suppress_fmt,
          { "Srvr can suppress ROWFMT for DYNAMIC", "tds_capability_res_suppress_fmt",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_suppress_doneinproc,
          { "Srvr can suppress DONEINPROC", "tds_capability_res_suppress_doneinproc",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_tds_capability_res_force_rowfmt2,
          { "Force use of ROWFMT2", "tds_capability_res_force_rowfmt2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        ...
        /* COLINFO token (TDS_COLFMT_TOKEN) */
        { &hf_tds_colfmt,
          { "Token - ColFormat", "tds_colfmt",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_length,
          { "Token length - ColFormat", "tds_colfmt_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_column,
          { "Column", "tds_colfmt_column",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_utype,
          { "ColFormat - Column Usertype", "tds_colfmt_utype",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_ctype,
          { "ColFormat - Column Datatype", "tds_colfmt_ctype",
            FT_UINT8, BASE_DEC, &tds_data_type_names, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_csize,
          { "ColFormat - Column size", "tds_colfmt_csize",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_csize_long,
          { "ColFormat - Column size - long", "tds_colfmt_csize_long",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colfmt_text_tablename,
          { "ColFormat - Text Tablename", "tds_colfmt_text_tablename",
        ...
        /* COLNAME token (TDS_COL_NAME_TOKEN) */
        { &hf_tds_colname,
          { "Token - ColName", "tds_colname",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colname_length,
          { "Token length - ColName", "tds_colname_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colname_column,
          { "Column", "tds_colname_column",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colname_name,
          { "Column name", "tds_colname_name",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* COLMETADATA token (TDS7_COL_METADATA_TOKEN) */
        { &hf_tds_colmetadata,
          { "Token - ColumnMetaData", "tds_colmetadata",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_columns,
          { "Columns", "tds_colmetadata_columns",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_usertype32,
          { "Usertype", "tds_colmetadata_usertype",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_colmetadata_results_token_flags,
          { "Flags", "tds_colmetadata_results_token_flags",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_results_token_type,
          { "Type", "tds_colmetadata_results_token_type",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_csize,
          { "Type size", "tds_colmetadata_type_size",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_large2_type_size,
          { "Large type size", "tds_colmetadata_large_type_size",
        ...
        { &hf_tds_colmetadata_collate_codepage,
          { "Collate codepage", "tds_colmetadata_collate_codepage",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_collate_flags,
          { "Collate flags", "tds_colmetadata_collate_flags",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_collate_charset_id,
          { "Collate charset ID", "tds_colmetadata_collate_charset_id",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_precision,
          { "Precision", "tds_colmetadata_precision",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_scale,
          { "Scale", "tds_colmetadata_scale",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_colname_length,
          { "Column name length", "tds_colmetadata_colname_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_colname,
          { "Column Name", "tds_colmetadata_colname",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_table_name_parts,
          { "Table name parts", "tds_colmetadata_table_name_parts",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_table_name,
          { "Table name", "tds_colmetadata_table_name",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_table_name_length,
          { "Table name length", "tds_colmetadata_table_name_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_field,
          { "Field", "tds_colmetadata_field",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_nullable,
          { "Nullable", "tds_colmetadata_flags_nullable",
            FT_BOOLEAN, 16, NULL, 0x8000,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_casesen,
          { "Case sensitive", "tds_colmetadata_flags_casesen",
            FT_BOOLEAN, 16, NULL, 0x4000,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_updateable,
          { "Updateable", "tds_colmetadata_flags_updateable",
            FT_BOOLEAN, 16, NULL, 0x3000,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_identity,
          { "Identity", "tds_colmetadata_flags_identity",
            FT_BOOLEAN, 16, NULL, 0x0800,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_computed,
          { "Computed", "tds_colmetadata_flags_computed",
            FT_BOOLEAN, 16, NULL, 0x0400,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_reservedodbc,
          { "Reserved ODBC", "tds_colmetadata_flags_reservedodbc",
            FT_BOOLEAN, 16, NULL, 0x0300,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_fixedlenclrtype,
          { "Fixed length CLR type", "tds_colmetadata_flags_fixedlenclrtype",
            FT_BOOLEAN, 16, NULL, 0x0080,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_sparsecolumnset,
          { "Sparse column set", "tds_colmetadata_flags_sparsecolumnset",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_encrypted,
          { "Encrypted", "tds_colmetadata_flags_encrypted",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_hidden,
          { "Hidden", "tds_colmetadata_flags_hidden",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_key,
          { "Flags", "tds_colmetadata_flags_key",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_flags_nullableunknown,
          { "Nullable unknown", "tds_colmetadata_flags_nullableunknown",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_maxbytesize,
          { "Max byte size", "tds_colmetadata_maxbytesize",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_dbname_length,
          { "Database name length", "tds_colmetadata_dbname_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_dbname,
          { "Database name length", "tds_colmetadata_dbname",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_schemaname_length,
          { "Schema name length", "tds_colmetadata_schemaname_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_schemaname,
          { "Schema name", "tds_colmetadata_schemaname",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_typename_length,
          { "Type name length", "tds_colmetadata_typename_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_typename,
          { "Type name", "tds_colmetadata_typename",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_assemblyqualifiedname_length,
          { "Assembly qualified name length", "tds_colmetadata_assemblyqualifiedname_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_assemblyqualifiedname,
          { "Assembly qualified name", "tds_colmetadata_assemblyqualifiedname",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_owningschema_length,
          { "Owning schema name length", "tds_colmetadata_owningschema_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_owningschema,
          { "Owning schema name", "tds_colmetadata_owningschema",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_xmlschemacollection_length,
          { "XML schema collection length", "tds_colmetadata_xmlschemacollection_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_colmetadata_xmlschemacollection,
          { "XML schema collection", "tds_colmetadata_xmlschemacollection",
            FT_STRING, STR_UNICODE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* CONTROL token (TDS_CONTROL_TOKEN) */
        { &hf_tds_control,
          { "Token - Control", "tds_control",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_control_length,
          { "Token Length - Control", "tds_control_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_control_fmt,
          { "Control - Fmt", "tds_control_fmt",
        ...
        /* CURCLOSE token (TDS_CURCLOSE_TOKEN) */
        { &hf_tds_curclose,
          { "Token - CurClose", "tds_curclose",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curclose_length,
          { "Token Length - CurClose", "tds_curclose_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curclose_cursorid,
          { "CursorId", "tds_curclose_cursorid",
            FT_UINT32, BASE_DEC_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curclose_cursor_name,
          { "Cursorname", "tds_curclose_cursor_name_len",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curclose_option_deallocate,
          { "Deallocate", "tds_curclose_option_deallocate",
        ...
        /* CURDECLARE token (TDS_CURDECLARE_TOKEN) */
        { &hf_tds_curdeclare,
          { "Token - CurDeclare", "tds_curdeclare",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_length,
          { "Token Length - CurDeclare", "tds_curdeclare_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_cursor_name,
          { "Cursorname", "tds_curdeclare_cursor_name_len",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_options,
          { "Options", "tds_curdeclare_options",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_options_rdonly,
          { "Read Only", "tds_curdeclare_options_rdonly",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_options_updatable,
          { "Updatable", "tds_curdeclare_options_updatable",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_options_sensitive,
          { "Sensitive", "tds_curdeclare_options_sensitive",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_options_dynamic,
          { "Dynamic", "tds_curdeclare_options_dynamic",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_options_implicit,
          { "Implicit", "tds_curdeclare_options_implicit",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_status_parameterized,
          { "Status Parameterized", "tds_curdeclare_status_parameterized",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_statement,
          { "Statement", "tds_curdeclare_statement",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_update_columns_num,
          { "Number of updatable columns", "tds_curdeclare_update_columns_num",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curdeclare_update_columns_name,
          { "Updatable Column Name", "tds_curdeclare_update_columns_name",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* CURFETCH token (TDS_CURFETCH_TOKEN) */
        { &hf_tds_curfetch,
          { "Token - CurFetch", "tds_curfetch",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curfetch_length,
          { "Token Length - CurFetch", "tds_curfetch_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curfetch_cursorid,
          { "CursorId", "tds_curfetch_cursorid",
            FT_UINT32, BASE_DEC_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curfetch_cursor_name,
          { "CurFetch - Cursorname", "tds_curfetch_cursor_name_len",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curfetch_type,
          { "CurFetch - Type", "tds_curinfo_type",
            FT_UINT8, BASE_DEC, VALS(tds_curfetch_types), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curfetch_rowcnt,
          { "CurFetch - Rowcnt", "tds_curfetch_rowcnt",
        ...
        /* CURINFO token (TDS_CURINFO_TOKEN) */
        { &hf_tds_curinfo,
          { "Token - CurInfo", "tds_curinfo",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_length,
          { "Token Length - Curinfo", "tds_curinfo_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursorid,
          { "CursorId", "tds_curinfo_cursorid",
            FT_UINT32, BASE_DEC_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_name,
          { "Cursorname", "tds_curinfo_cursor_name_len",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_command,
          { "Cursor Command", "tds_curinfo_cursor_command",
            FT_UINT8, BASE_DEC, VALS(tds_curinfo_commands), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status,
          { "Cursor Status", "tds_curinfo_cursor_status",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_declared,
          { "Declared", "tds_curinfo_cursor_status_declared",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_open,
          { "Open", "tds_curinfo_cursor_status_open",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_closed,
          { "Closed", "tds_curinfo_cursor_status_closed",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_rdonly,
          { "Read only", "tds_curinfo_cursor_status_rdonly",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_updatable,
          { "Updatable", "tds_curinfo_cursor_status_updatable",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_rowcnt,
          { "Rowcount valid", "tds_curinfo_cursor_status_rowcnt",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_status_dealloc,
          { "Deallocated", "tds_curinfo_cursor_status_dealloc",
            FT_BOOLEAN, 16, NULL, 0x0040,
            NULL, HFILL }
        },
        { &hf_tds_curinfo_cursor_rowcnt,
          { "Cursor Rowcnt", "tds_curinfo_cursor_rowcnt",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* CUROPEN token (TDS_CUROPEN_TOKEN) */
        { &hf_tds_curopen,
          { "Token - CurOpen", "tds_curopen",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curopen_length,
          { "Token Length - CurOpen", "tds_curopen_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curopen_cursorid,
          { "CursorId", "tds_curopen_cursorid",
            FT_UINT32, BASE_DEC_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curopen_cursor_name,
          { "Cursorname", "tds_curopen_cursor_name_len",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_curopen_status_parameterized,
          { "Status Parameterized", "tds_curopen_status_parameterized",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        ...
        { &hf_tds_dbrpc,
          { "Token - DBRPC", "tds_dbrpc",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_dbrpc_length,
          { "Token Length - DBRPC", "tds_dbrpc_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_dbrpc_rpcname_len,
          { "DBRPC - RPC Name Length", "tds_dbrpc_rpcname_len",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_dbrpc_rpcname,
          { "DBRPC - RPC Name", "tds_dbrpc_rpcname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_dbrpc_options,
          { "DBRPC - Options", "tds_dbrpc_options",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_dbrpc_options_recompile,
          { "Recompile", "tds_dbrpc_options_recompile",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_tds_dbrpc_options_params,
          { "Has parameters", "tds_dbrpc_options_params",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        ...
        { &hf_tds_done_donerowcount_64,
          { "Row count", "tds_done_donerowcount64",
            FT_UINT64, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_done_donerowcount_32,
          { "Row count", "tds_done_donerowcount",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_done_status,
          { "Status flags", "tds_done_status",
            FT_UINT16, BASE_HEX, NULL, 0x017f,
            NULL, HFILL }
        },
        { &hf_tds_done_status_more,
          { "More",   "tds_done_status_more",
            FT_BOOLEAN, 16, TFS(&tds_tfs_more_final), 0x0001,
            NULL, HFILL }
        },
        { &hf_tds_done_status_error,
          { "Error",   "tds_done_status_error",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0002,
            NULL, HFILL }
        },
        { &hf_tds_done_status_inxact,
          { "In Transaction",   "tds_done_status_inxact",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0004,
            NULL, HFILL }
        },
        { &hf_tds_done_status_proc,
          { "Procedure",   "tds_done_status_proc",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0008,
            NULL, HFILL }
        },
        { &hf_tds_done_status_count,
          { "Row count valid",   "tds_done_status_count",
            FT_BOOLEAN, 16, TFS(&tfs_valid_invalid), 0x0010,
            NULL, HFILL }
        },
        { &hf_tds_done_status_attn,
          { "Acknowledge ATTN",   "tds_done_status_attn",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0020,
            NULL, HFILL }
        },
        { &hf_tds_done_status_event,
          { "Event",   "tds_done_status_event",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0040,
            NULL, HFILL }
        },
        { &hf_tds_done_status_rpcinbatch,
          { "RPC in batch",   "tds_done_status_rpcinbatch",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0080,
            NULL, HFILL }
        },
        { &hf_tds_done_status_srverror,
          { "Server Error",   "tds_done_status_srverror",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0100,
            NULL, HFILL }
        },
        { &hf_tds_done_curcmd,
          { "Operation", "tds_done_curcmd",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_doneproc,
          { "Token - DoneProc", "tds_doneproc",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_doneproc_donerowcount_64,
          { "Row count", "tds_doneproc_donerowcount64",
            FT_UINT64, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_doneproc_donerowcount_32,
          { "Row count", "tds_doneproc_donerowcount",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_doneproc_status,
          { "Status flags", "tds_doneproc_status",
            FT_UINT16, BASE_HEX, NULL, 0x01ff,
            NULL, HFILL }
        },
        { &hf_tds_doneproc_curcmd,
          { "Operation", "tds_doneproc_curcmd",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
          },
        ...
        { &hf_tds_doneinproc,
          { "Token - DoneInProc", "tds_doneinproc",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_doneinproc_donerowcount_64,
          { "Row count", "tds_doneinproc_donerowcount64",
            FT_UINT64, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_doneinproc_donerowcount_32,
          { "Row count", "tds_doneinproc_donerowcount",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_doneinproc_status,
          { "Status flags", "tds_doneinproc_status",
            FT_UINT16, BASE_HEX, NULL, 0x0177,
            NULL, HFILL }
        },
        { &hf_tds_doneinproc_curcmd,
          { "Operation", "tds_doneinproc_curcmd",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
          },
        ...
        /* EED token (TDS5_EED_TOKEN) */
        { &hf_tds_eed,
          { "Token - ExtendedErrorDiagnostic", "tds_eed",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_length,
          { "Token length", "tds_eed_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_number,
          { "SQL Error Number", "tds_eed_number",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_state,
        ...
        { &hf_tds_eed_class,
          { "Class (Severity)", "tds_eed_class",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_sql_state,
          { "SQL State", "tds_eed_sql_state",
            FT_UINT_BYTES, BASE_NONE|BASE_ALLOW_ZERO, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_status,
          { "EED Following", "tds_eed_status",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_transtate,
          { "Transaction state", "tds_eed_transtate",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_msgtext,
          { "Error message", "tds_eed_msgtext",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_servername,
          { "Server name", "tds_eed_servername",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_procname,
          { "Procedure name", "tds_eed_procname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_eed_linenumber,
          { "Line number", "tds_eed_linenumber",
          FT_UINT16, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
        },
        ...
        /* ENVCHANGE token (TDS_ENVCHG_TOKEN) */
        { &hf_tds_envchg,
          { "Token - EnvChange", "tds_envchange",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_length,
          { "Token length", "tds_envchange_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_type,
          { "Type", "tds_envchange_type",
            FT_UINT8, BASE_DEC, VALS(envchg_names), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_newvalue_length,
          { "New Value Length", "tds_envchange_newvalue_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_newvalue_string,
          { "New Value", "tds_envchange_newvalue_string",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_newvalue_bytes,
          { "New Value", "tds_envchange_newvalue",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_oldvalue_length,
          { "Old Value Length", "tds_envchange_oldvalue_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_oldvalue_string,
          { "Old Value", "tds_envchange_oldvalue_string",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_oldvalue_bytes,
          { "Old Value", "tds_envchange_oldvalue",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_collate_codepage,
          { "Collate codepage", "tds_envchange_collate_codepage",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_collate_flags,
          { "Collate flags", "tds_envchange_collate_flags",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_envchg_collate_charset_id,
          { "Collate charset ID", "tds_envchange_collate_charset_id",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* ERROR token (TDS_ERR_TOKEN) */
        { &hf_tds_error,
          { "Token - Error", "tds_error",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_length,
          { "Token length", "tds_error_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_number,
          { "SQL Error Number", "tds_error_number",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_state,
          { "State", "tds_error_state",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_class,
          { "Class (Severity)", "tds_error_class",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_msgtext_length,
          { "Error message length", "tds_error_msgtext_length",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_characters, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_msgtext,
          { "Error message", "tds_error_msgtext",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_error_servername_length,
          { "Server name length", "tds_error_servername_length",
          FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_characters, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_error_servername,
          { "Server name", "tds_error_servername",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_error_procname_length,
          { "Process name length", "tds_error_procname_length",
          FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_characters, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_error_procname,
          { "Process name", "tds_error_procname",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_error_linenumber_16,
          { "Line number", "tds_error_linenumber",
          FT_UINT16, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
        },
        ...
        { &hf_tds_featureextack,
          { "Token - FeatureExtAct", "tds_featureextack",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_featureextack_feature,
            { "Feature", "tds_featureextack_feature",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_featureextack_featureid,
          { "Feature ID", "tds_featureextack_featureid",
            FT_UINT8, BASE_DEC, VALS(featureextack_feature_names), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_featureextack_featureackdatalen,
          { "Feature length", "tds_featureextack_featureackdatalen",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_featureextack_featureackdata,
          { "Feature data", "tds_featureextack_featureackdata",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_info_length,
          { "Token length", "tds_info_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_info_number,
          { "SQL Error Number", "tds_info_number",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_info_state,
          { "State", "tds_info_state",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_info_class,
          { "Class (Severity)", "tds_info_class",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_info_msgtext_length,
          { "Error message length", "tds_info_msgtext_length",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_characters, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_info_msgtext,
          { "Error message", "tds_info_msgtext",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_info_servername_length,
          { "Server name length", "tds_info_servername_length",
          FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_characters, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_info_servername,
          { "Server name", "tds_info_servername",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_info_procname_length,
          { "Process name length", "tds_info_procname_length",
          FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_characters, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_info_procname,
          { "Process name", "tds_info_procname",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
        },
        { &hf_tds_info_linenumber_16,
          { "Line number", "tds_info_linenumber",
          FT_UINT16, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
        },
        ...
        /* LOGINACK token (TDS_LOGIN_ACK_TOKEN) */
        { &hf_tds_loginack,
          { "Token - LoginAck", "tds_loginack",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_loginack_length,
          { "Token length", "tds_loginack_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_loginack_interface,
          { "Interface", "tds_loginack_interface",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_loginack_tdsversion,
          { "TDS version", "tds_loginack_tdsversion",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_loginack_progversion,
          { "Server Version", "tds_loginack_progversion",
            FT_UINT32, BASE_CUSTOM, CF_FUNC(version_convert), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_loginack_progname,
          { "Server name", "tds_loginack_progname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* LOGOUT token (TDS5_LOGOUT_TOKEN) */
        { &hf_tds_logout,
          { "Token - Logout", "tds_logout",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_logout_options,
          { "Logout Options", "tds_logout_options",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_msg_length,
          { "Token length - Msg", "tds_msg_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_msg_status,
          { "Status", "tds_msg_status",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_msg_msgid,
          { "Message Id", "tds_msg_msgid",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* OFFSET token */
        { &hf_tds_offset,
          { "Token - Offset", "tds_offset",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_tds_offset_id,
          { "Offset ID", "tds_offset_id",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_tds_offset_len,
          { "Offset length", "tds_offset_len",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        /* ORDER token (TDS_ORDER_TOKEN) */
        { &hf_tds_order,
          { "Token - Order", "tds_order",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_tds_order_length,
          { "Token length", "tds_order_length",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_tds_order_colnum,
          { "Order column", "tds_order_colnum",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        /* PARAMFMT token (TDS5_PARAMFMT_TOKEN) */
        { &hf_tds_paramfmt,
          { "Token - Paramfmt", "tds_paramfmt",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_length,
          { "Token length - Paramfmt", "tds_paramfmt_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_numparams,
          { "Number of Parameters", "tds_paramfmt_numparams",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_colname,
          { "Parameter name", "tds_paramfmt_colname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_status,
          { "Column Status", "tds_paramfmt_status",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_utype,
          { "Parameter Usertype", "tds_paramfmt_utype",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_ctype,
          { "Parameter Datatype", "tds_paramfmt_ctype",
            FT_UINT8, BASE_DEC, &tds_data_type_names, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_csize,
          { "Parameter size", "tds_paramfmt_csize",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt_locale_info,
          { "Locale info", "tds_paramfmt_locale_info",
            FT_UINT_BYTES, BASE_NONE|BASE_ALLOW_ZERO, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_paramfmt2,
          { "Token - Paramfmt2", "tds_paramfmt2",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_length,
          { "Token length - Paramfmt2", "tds_paramfmt2_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_numparams,
          { "Number of Parameters", "tds_paramfmt2_numparams",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_colname,
          { "Parameter name", "tds_paramfmt2_paramname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_status,
          { "Parameter Status", "tds_paramfmt2_status",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_utype,
          { "Parameter Usertype", "tds_paramfmt2_utype",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_ctype,
          { "Parameter Datatype", "tds_paramfmt2_ctype",
            FT_UINT8, BASE_DEC, &tds_data_type_names, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_csize,
          { "Parameter size", "tds_paramfmt2_csize",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_paramfmt2_locale_info,
          { "Locale info", "tds_paramfmt2_locale_info",
            FT_UINT_BYTES, BASE_NONE|BASE_ALLOW_ZERO, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* PARAMS token (TDS5_PARAMS_TOKEN) */
        { &hf_tds_params,
          { "Token - Params", "tds_params",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_params_field,
          { "Parameter", "tds_params_parameter",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* PROCID token (TDS_PROCID_TOKEN) */
        { &hf_tds_procid,
          { "Token - Procid", "tds_procid",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_tds_procid_value,
          { "Procid Value", "tds_procid_value",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        /* RETURNSTATUS token (TDS_RET_STAT_TOKEN) */
        { &hf_tds_returnstatus,
          { "Token - ReturnStatus", "tds_returnstatus",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_returnstatus_value,
          { "Value", "tds_returnstatus_value",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* ROWFMT token (TDS5_ROWFMT_TOKEN) */
        { &hf_tds_rowfmt,
          { "Token - Rowfmt", "tds_rowfmt",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_length,
          { "Token length - Rowfmt", "tds_rowfmt_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_numcols,
          { "Number of Columns", "tds_rowfmt_numcols",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_colname,
          { "Column name", "tds_rowfmt_colname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_status,
          { "Column Status", "tds_rowfmt_status",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_utype,
          { "Column Usertype", "tds_rowfmt_utype",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_ctype,
          { "Column Datatype", "tds_rowfmt_ctype",
            FT_UINT8, BASE_DEC, &tds_data_type_names, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_csize,
          { "Column size", "tds_rowfmt_csize",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_text_tablename,
          { "Text Tablename", "tds_rowfmt_text_tablename",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_precision,
          { "Precision", "tds_rowfmt_precision",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_scale,
          { "Scale", "tds_rowfmt_scale",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt_locale_info,
          { "Locale info", "tds_rowfmt_locale_info",
            FT_UINT_BYTES, BASE_NONE|BASE_ALLOW_ZERO, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_rowfmt2,
          { "Token - Rowfmt2", "tds_rowfmt2",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_length,
          { "Token length - Rowfmt2", "tds_rowfmt2_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_numcols,
          { "Number of Columns", "tds_rowfmt2_numcols",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_labelname,
          { "Label name", "tds_rowfmt2_labelname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_catalogname,
          { "Catalog name", "tds_rowfmt2_catalogname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_schemaname,
          { "Schema name", "tds_rowfmt2_schemaname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_tablename,
          { "Table name", "tds_rowfmt2_tablename",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_colname,
          { "Column name", "tds_rowfmt2_colname",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_status,
          { "Column Status", "tds_rowfmt2_status",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_utype,
          { "Column Usertype", "tds_rowfmt2_utype",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_ctype,
          { "Column Datatype", "tds_rowfmt2_ctype",
            FT_UINT8, BASE_DEC, &tds_data_type_names, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_csize,
          { "Column size", "tds_rowfmt2_csize",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_text_tablename,
          { "Text Tablename", "tds_rowfmt2_text_tablename",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_precision,
          { "Precision", "tds_rowfmt2_precision",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_scale,
          { "Scale", "tds_rowfmt2_scale",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rowfmt2_locale_info,
          { "Locale info", "tds_rowfmt2_locale_info",
            FT_UINT_BYTES, BASE_NONE|BASE_ALLOW_ZERO, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* SESSIONSTATE token (TDS_SESSIONSTATE_TOKEN) */
        { &hf_tds_sessionstate,
          { "Token - Session state", "tds_sessionstate",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_sessionstate_length,
          { "Token length", "tds_sessionstate_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_sessionstate_seqno,
          { "Sequence number", "tds_sessionstate_seqno",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_sessionstate_status,
          { "Status", "tds_sessionstate_status",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_sessionstate_stateid,
          { "State ID", "tds_sessionstate_stateid",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_sessionstate_statelen,
          { "State Length", "tds_sessionstate_statelen",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_sessionstate_statevalue,
          { "State Value", "tds_sessionstate_statevalue",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* TDS5 Lang Token */
        { &hf_tds_lang_length,
          { "Token Length - Language", "tds_lang_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_lang_token_status,
          { "Status", "tds_lang_token_status",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_lang_status_parameterized,
          { "Parameters follow", "tds_lang_token_status_parameterized",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_tds_lang_language_text,
          { "Language text", "tds_lang_language_text",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_unknown_tds_token,
          { "Token - Unknown", "tds_unknown_tds_token",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        /* LOGIN Token */
        { &hf_tdslogin,
          { "Hostname length", "tds_login",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_hostname_length,
          { "Hostname length", "tds_login_hostname_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_hostname,
          { "Hostname", "tds_login_hostname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_username_length,
          { "Username length", "tds_login_username_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_username,
          { "Username", "tds_login_username",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_password_length,
          { "Password length", "tds_login_password_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_password,
          { "Password", "tds_login_password",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_hostprocess_length,
          { "Host Process Id length", "tds_login_hostprocess_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_hostprocess,
          { "Host Process Id", "tds_login_pid",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_int2,
          { "Short (2-byte) integer format", "tds_login_option_int2",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_int4,
          { "Long (4-byte) integer format", "tds_login_option_int4",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_char,
          { "Character set", "tds_login_option_char",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_float,
          { "Double (8 byte) float format", "tds_login_option_float",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_date8,
          { "Long (8 byte) date format", "tds_login_option_date",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_usedb,
          { "Use DB", "tds_login_option_usedb",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_no_yes), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_bulk,
          { "Bulk Copy", "tds_login_option_bulk",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_no_yes), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_server_to_server,
          { "Server to server options", "tds_login_option_server_to_server",
            FT_UINT8, BASE_DEC, VALS(login_server_to_server), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_server_to_server_loginack,
          { "Server to server loginack", "tds_login_option_server_to_server_loginack",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_set_notset), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option_conversation_type,
          { "Conversation type", "tds_login_option_type",
            FT_UINT8, BASE_DEC, VALS(login_conversation_type), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_appname_length,
          { "Application name length", "tds_login_appname_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_appname,
          { "Application name", "tds_login_appname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_servername_length,
          { "Server name length", "tds_login_servername_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_servername,
          { "Server name", "tds_login_servname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_remotepassword_length,
          { "Remote password length", "tds_login_rempw_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_rempw_servername_length,
          { "Remote password servername length", "tds_login_rempw_servername_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_rempw_servername,
          { "Remote password server name", "tds_login_rempw_servername",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_rempw_password_length,
          { "Remote password password length", "tds_login_rempw_password_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_rempw_password,
          { "Remote password password", "tds_login_rempw_password",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_proto_version,
          { "Protocol version", "tds_login_protoversion",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_progname_length,
          { "Program name length", "tds_login_progname_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_progname,
          { "Program name", "tds_login_progname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_progvers,
          { "Program version", "tds_login_progversion",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option2_noshort,
          { "Convert shorts to longs", "tds_login_option_noshort",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option2_flt4,
          { "Single (4 byte) float format", "tds_login_option_flt4",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_option2_date4,
          { "Short (4 byte) date format", "tds_login_option_date4",
            FT_UINT8, BASE_DEC, VALS(login_options), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_language,
          { "Language", "tds_login_language",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_language_length,
          { "Language name length", "tds_login_language_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_setlang,
          { "Notify client of language changes", "tds_login_setlang",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_seclogin,
          { "Secure login", "tds_login_seclogin",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_secbulk,
          { "Secure bulk copy", "tds_login_secbulk",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_halogin,
          { "High Availability login", "tds_login_halogin",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_hasessionid,
          { "High Availability session id", "tds_login_hasessionid",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_charset,
          { "Character set", "tds_login_charset",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_charset_length,
          { "Character set name length", "tds_login_charset_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_setcharset,
          { "Notify client of character set changes", "tds_login_setcharset",
            FT_BOOLEAN, BASE_NONE, TFS(&tfs_yes_no), 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_packetsize,
          { "Packet size", "tds_login_packetsize",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tdslogin_packetsize_length,
          { "Packet size length", "tds_login_packetsize_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds7login_total_size,
          { "Total Packet Length", "tds_7login_total_len",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "TDS7 Login Packet total packet length", HFILL }
        },
        { &hf_tds7login_version,
          { "TDS version", "tds_7login_version",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_packet_size,
          { "Packet Size", "tds_7login_packet_size",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_client_version,
          { "Client version", "tds_7login_client_version",
            FT_UINT32, BASE_CUSTOM, CF_FUNC(version_convert), 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_client_pid,
          { "Client PID", "tds_7login_client_pid",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_connection_id,
          { "Connection ID", "tds_7login_connection_id",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_option_flags1,
          { "Option Flags 1", "tds_7login_option_flags1",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_option_flags2,
          { "Option Flags 2", "tds_7login_option_flags2",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_sql_type_flags,
          { "SQL Type Flags", "tds_7login_sql_type_flags",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_reserved_flags,
          { "Reserved Flags", "tds_7login_reserved_flags",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_time_zone,
          { "Time Zone", "tds_7login_time_zone",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_collation,
          { "Collation", "tds_7login_collation",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_offset,
          { "Offset", "tds_7login_offset",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_length,
          { "Length", "tds_7login_length",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_password,
          { "Password", "tds_7login_password",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_clientname,
          { "Client name", "tds_7login_clientname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_username,
          { "Username", "tds_7login_username",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_appname,
          { "App name", "tds_7login_appname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_servername,
          { "Server name", "tds_7login_servername",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_libraryname,
          { "Library name", "tds_7login_libraryname",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_locale,
          { "Locale", "tds_7login_locale",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds7login_databasename,
          { "Database name", "tds_7login_databasename",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_rpc,
          { "Remote Procedure Call", "tds_rpc",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rpc_name_length8,
          { "Procedure name length", "tds_rpc_name_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_rpc_name,
          { "Procedure name",   "tds_rpc_name",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_rpc_proc_id,
          { "Stored procedure ID", "tds_rpc_proc_id",
        ...
        /* Transaction Manager Request Stream */
        { &hf_tds_transmgr,
          { "Transaction Manager Request", "tds_transmgr",
            FT_UINT16, BASE_DEC, VALS(transmgr_types), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_transmgr_payload,
          { "Payload", "tds_transmgr_payload",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_type_info_collation_lcid,
          { "LCID", "tds_type_info_collation_lcid",
        ...
        { &hf_tds_type_varbyte_data_int8,
          { "Data", "tds_type_varbyte_data_int64",
            FT_INT64, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_float,
          { "Data", "tds_type_varbyte_data_float",
        ...
        { &hf_tds_type_varbyte_data_bytes,
          { "Data", "tds_type_varbyte_data_bytes",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_uint_bytes,
          { "Data", "tds_type_varbyte_data_uint_bytes",
            FT_UINT_BYTES, BASE_NONE|BASE_ALLOW_ZERO, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_guid,
          { "Data", "tds_type_varbyte_data_guid",
            FT_GUID, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_string,
          { "Data", "tds_type_varbyte_data_string",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_uint_string,
          { "Data", "tds_type_varbyte_data_uint_string",
            FT_UINT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_absdatetime,
          { "Data", "tds_type_varbyte_data_datetime",
            FT_ABSOLUTE_TIME, ABSOLUTE_TIME_UTC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_reltime,
          { "Time", "tds_type_varbyte_data_time",
            FT_RELATIVE_TIME, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_sign,
          { "Sign", "tds_type_varbyte_data_sign",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_textptr_len,
          { "Data Textptr Len", "tds_type_varbyte_textptr_len",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_textptr,
          { "Data Textptr", "tds_type_varbyte_data_textptr",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_data_text_ts,
          { "Data Text timestamp", "tds_type_varbyte_data_text_ts",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_plp_len,
          { "PLP length", "tds_type_varbyte_plp_len",
            FT_INT64, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_plp_chunk_len,
          { "PLP chunk length", "tds_type_varbyte_plp_chunk_len",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_plp_chunk,
          { "PLP chunk", "tds_type_varbyte_plp_chunk",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_type_varbyte_column_name,
          { "Column name", "tds_type_varbyte_column_name",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_tds_packet_number,
          { "Packet Number", "tds_packet_number",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_window,
        ...
        { &hf_tds_fragment_overlap,
          { "Segment overlap", "tds_fragment_overlap",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            "Fragment overlaps with other fragments", HFILL }
        },
        { &hf_tds_fragment_overlap_conflict,
          { "Conflicting data in fragment overlap", "tds_fragment_overlap_conflict",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            "Overlapping fragments contained conflicting data", HFILL }
        },
        { &hf_tds_fragment_multiple_tails,
          { "Multiple tail fragments found", "tds_fragment_multipletails",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            "Several tails were found when defragmenting the packet", HFILL }
        },
        { &hf_tds_fragment_too_long_fragment,
          { "Segment too long", "tds_fragment_toolongfragment",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            "Segment contained data past end of packet", HFILL }
        },
        { &hf_tds_fragment_error,
          { "Defragmentation error", "tds_fragment_error",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            "Defragmentation error due to illegal fragments", HFILL }
        },
        { &hf_tds_fragment_count,
          { "Segment count", "tds_fragment_count",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_fragment,
          { "TDS Fragment", "tds_fragment",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_fragments,
          { "TDS Fragments", "tds_fragments",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_tds_reassembled_in,
          { "Reassembled TDS in frame", "tds_reassembled_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            "This TDS packet is reassembled in this frame", HFILL }
        },
        { &hf_tds_reassembled_length,
          { "Reassembled TDS length", "tds_reassembled_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "The total length of the reassembled payload", HFILL }
        },
        { &hf_tds_all_headers,
          { "Packet data stream headers", "tds_all_headers",
            FT_NONE, BASE_NONE, NULL, 0x0,
            "The ALL_HEADERS rule", HFILL }
        },
        { &hf_tds_all_headers_total_length,
          { "Total length", "tds_all_headers_total_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "Total length of ALL_HEADERS stream", HFILL }
        },
        { &hf_tds_all_headers_header_length,
          { "Length", "tds_all_headers_header_length",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "Total length of an individual header", HFILL }
        },
        { &hf_tds_all_headers_header_type,
          { "Type", "tds_all_headers_header_type",
            FT_UINT16, BASE_HEX, VALS(header_type_names), 0x0,
            NULL, HFILL }
        },
        { &hf_tds_all_headers_trans_descr,
          { "Transaction descriptor", "tds_all_headers_header_trans_descr",
            FT_UINT64, BASE_DEC, NULL, 0x0,
        ...
        { &hf_tds_all_headers_request_cnt,
          { "Outstanding request count", "tds_all_headers_header_request_cnt",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "Number of requests currently active on the connection", HFILL }
        },
        { &hf_tds_unknown_tds_packet,
          { "TDS Packet", "tds_unknown_tds_packet",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        }
    };
