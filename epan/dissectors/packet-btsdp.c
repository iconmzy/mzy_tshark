...
proto_register_btsdp(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_tid,
            { "Transaction Id",                  "btsdp_tid",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL}
        },
        { &hf_parameter_length,
          { "Parameter Length",                  "btsdp_len",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL}
        },
        { &hf_error_code,
            { "Error Code",                      "btsdp_error_code",
            FT_UINT16, BASE_HEX, VALS(vs_error_code), 0,
            NULL, HFILL}
        },
        { &hf_ssr_total_count,
            { "Total Service Record Count",      "btsdp_ssr_total_count",
            FT_UINT16, BASE_DEC, NULL, 0,
            "Total count of service records", HFILL}
        },
        { &hf_ssr_current_count,
            { "Current Service Record Count",    "btsdp_ssr_current_count",
            FT_UINT16, BASE_DEC, NULL, 0,
            "Count of service records in this message", HFILL}
        },
        { &hf_attribute_id_list,
            { "Attribute ID List",               "btsdp_attribute_id_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_attribute_id_range,
            { "Attribute Range",                 "btsdp_attribute_range",
            FT_UINT32, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_attribute_id_range_from,
            { "Attribute Range From",            "btsdp_attribute_range_from",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_attribute_id_range_to,
            { "Attribute Range To",              "btsdp_attribute_range_to",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_attribute_list_byte_count,
            { "Attribute List Byte Count",       "btsdp_attribute_list_byte_count",
            FT_UINT16, BASE_DEC, NULL, 0,
            "Count of bytes in attribute list response", HFILL}
        },
        { &hf_maximum_service_record_count,
            {"Maximum Service Record Count",     "btsdp_maximum_service_record_count",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL}
        },
        { &hf_maximum_attribute_byte_count,
            {"Maximum Attribute Byte Count",     "btsdp_maximum_attribute_byte_count",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL}
        },
        { &hf_service_attribute,
            { "Service Attribute",               "btsdp_service_attribute",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_service_attribute_id,
            { "Attribute",                       "btsdp_service_attribute_attribute",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_service_attribute_value,
            { "Value",                           "btsdp_service_attribute_value",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_profile_descriptor_list,
            { "Profile Descriptor List",         "btsdp_profile_descriptor_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_attribute_list,
            { "Attribute List",                  "btsdp_attribute_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_attribute_lists,
            { "Attribute Lists",                  "btsdp_attribute_lists",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_service_search_pattern,
            { "Service Search Pattern",          "btsdp_service_search_pattern",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_service_record_handle_list,
            { "Service Record Handle List",      "btsdp_service_record_handle_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_continuation_state,
            { "Continuation State",              "btsdp_continuation_state",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_continuation_state_length,
            { "Continuation State Length",       "btsdp_continuation_state_length",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_continuation_state_value,
            { "Continuation State Value",        "btsdp_continuation_state_value",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element,
            { "Data Element",                    "btsdp_data_element",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_type,
            { "Data Element Type",               "btsdp_data_element_type",
            FT_UINT8, BASE_DEC, VALS(vs_data_element_type), 0xF8,
            NULL, HFILL }
        },
        { &hf_data_element_size,
            { "Data Element Size",               "btsdp_data_element_size",
            FT_UINT8, BASE_DEC, VALS(vs_data_element_size), 0x07,
            NULL, HFILL }
        },
        { &hf_data_element_var_size,
            { "Data Element Var Size",           "btsdp_data_element_var_size",
            FT_UINT32, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value,
            { "Data Value",                      "btsdp_data_element_value",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_nil,
            { "Value: Nil",                      "btsdp_data_element_value_nil",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_signed_int,
            { "Value: Signed Int",               "btsdp_data_element_value_signed_int",
            FT_INT64, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_unsigned_int,
            { "Value: Unsigned Int",             "btsdp_data_element_value_unsigned_int",
            FT_UINT64, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_boolean,
            { "Value: Boolean",                  "btsdp_data_element_value_boolean",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_string,
            { "Value: String",                   "btsdp_data_element_value_string",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_url,
            { "Value: URL",                      "btsdp_data_element_value_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_uuid_16,
            { "Value: UUID",                     "btsdp_data_element_value_uuid_16",
            FT_UINT16, BASE_HEX | BASE_EXT_STRING, &bluetooth_uuid_vals_ext, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_uuid_32,
            { "Value: UUID",                     "btsdp_data_element_value_uuid_32",
            FT_UINT32, BASE_HEX | BASE_EXT_STRING, &bluetooth_uuid_vals_ext, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_uuid_128,
            { "Value: UUID",                     "btsdp_data_element_value_uuid_128",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_uuid,
            { "Value: Custom UUID",              "btsdp_data_element_value_custom_uuid",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_sequence,
            { "Value: Sequence",                 "btsdp_data_element_value_sequence",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_data_element_value_alternative,
            { "Value: Alternative",              "btsdp_data_element_value_alternative",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_fragment,
            { "Data Fragment",                   "btsdp_fragment",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_partial_attribute_list,
            { "Partial Attribute List",          "btsdp_partial_attribute_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_reassembled_attribute_list,
            { "Reassembled Attribute List",      "btsdp_reassembled_attribute_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_partial_record_handle_list,
            { "Partial Record Handle List",      "btsdp_partial_record_handle_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_reassembled_record_handle_list,
            { "Reassembled Record Handle List",  "btsdp_reassembled_attribute_list",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_service_attribute_id_generic,
            { "Attribute ID",                    "btsdp_service_attribute",
        ...
        { &hf_did_specification_id,
            { "Specification ID",                "btsdp_service_did_specification_id",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_did_vendor_id,
            { "Vendor ID",                       "btsdp_service_did_vendor_id",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        ...
        { &hf_did_product_id,
            { "Product ID",                      "btsdp_service_did_product_id",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_did_primary_record,
            { "Primary Record",                  "btsdp_service_did_primary_record",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_did_version,
            { "Version",                         "btsdp_service_did_version",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_did_vendor_id_source,
            { "Vendor ID Source",                "btsdp_service_did_vendor_id_source",
            FT_UINT16, BASE_HEX, VALS(did_vendor_id_source_vals), 0,
            NULL, HFILL }
        },
        { &hf_a2dp_sink_supported_features_reserved,
            { "Supported Features: Reserved",    "btsdp_service_a2dp_sink_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFFF0,
            NULL, HFILL }
        },
        { &hf_a2dp_sink_supported_features_amplifier,
            { "Supported Features: Amplifier",   "btsdp_service_a2dp_sink_supported_features_amplifier",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_a2dp_sink_supported_features_recorder,
            { "Supported Features: Recorder",    "btsdp_service_a2dp_sink_supported_features_recorder",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_a2dp_sink_supported_features_speaker,
            { "Supported Features: Speaker",     "btsdp_service_a2dp_sink_supported_features_speaker",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_a2dp_sink_supported_features_headphone,
            { "Supported Features: Headphone",   "btsdp_service_a2dp_sink_supported_features_headphone",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_a2dp_source_supported_features_reserved,
            { "Supported Features: Reserved",    "btsdp_service_a2dp_source_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFFF0,
            NULL, HFILL }
        },
        { &hf_a2dp_source_supported_features_mixer,
            { "Supported Features: Mixer",       "btsdp_service_a2dp_source_supported_features_mixer",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_a2dp_source_supported_features_tuner,
            { "Supported Features: Tuner",       "btsdp_service_a2dp_source_supported_features_tuner",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_a2dp_source_supported_features_microphone,
            { "Supported Features: Microphone",  "btsdp_service_a2dp_source_supported_features_microphone",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_a2dp_source_supported_features_player,
            { "Supported Features: Player",      "btsdp_service_a2dp_source_supported_features_player",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_synch_supported_data_store,
            { "Supported Data Store",            "btsdp_service_synch_supported_data_store",
            FT_UINT8, BASE_HEX, VALS(synch_supported_data_store_vals), 0,
            NULL, HFILL }
        },
        { &hf_ctp_external_network,
            { "External Network",                "btsdp_service_ctp_external_network",
            FT_UINT8, BASE_HEX, VALS(ctp_external_network_vals), 0,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_reserved_10_15,
            { "Supported Features: Reserved",      "btsdp_service_avrcp_ct_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFC00,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_cover_art_get_linked_thumbnail,
            { "Supported Features: Cover Art - Get Linked Thumbnail",      "btsdp_service_avrcp_ct_supported_features_cover_art_get_linked_thumbnail",
            FT_BOOLEAN, 16, NULL, 0x0200,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_cover_art_get_image,
            { "Supported Features: Cover Art - Get Image",      "btsdp_service_avrcp_ct_supported_features_cover_art_get_image",
            FT_BOOLEAN, 16, NULL, 0x0100,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_cover_art_get_image_properties,
            { "Supported Features: Cover Art - Get Image Properties",      "btsdp_service_avrcp_ct_supported_features_cover_art_get_linked_thumbnail",
            FT_BOOLEAN, 16, NULL, 0x0080,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_browsing,
            { "Supported Features: Browsing",      "btsdp_service_avrcp_ct_supported_features_browsing",
        ...
        { &hf_avrcp_ct_supported_features_category_4,
            { "Supported Features: Category 4: Menu",                "btsdp_service_avrcp_ct_supported_features_category_4",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_category_3,
            { "Supported Features: Category 3: Tuner",               "btsdp_service_avrcp_ct_supported_features_category_3",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_category_2,
            { "Supported Features: Category 2: Monitor/Amplifier",   "btsdp_service_avrcp_ct_supported_features_category_2",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_avrcp_ct_supported_features_category_1,
            { "Supported Features: Category 1: Player/Recorder",     "btsdp_service_avrcp_ct_supported_features_category_1",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_reserved_9_15,
            { "Supported Features: Reserved",                        "btsdp_service_avrcp_tg_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFE00,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_cover_art,
            { "Supported Features: Cover Art",                 "btsdp_service_avrcp_tg_supported_features_cover_art",
            FT_BOOLEAN, 16, NULL, 0x0100,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_multiple_player,
            { "Supported Features: Multiple Player",                 "btsdp_service_avrcp_tg_supported_features_multiple_player",
            FT_BOOLEAN, 16, NULL, 0x0080,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_browsing,
            { "Supported Features: Browsing",                        "btsdp_service_avrcp_tg_supported_features_browsing",
            FT_BOOLEAN, 16, NULL, 0x0040,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_group_navigation,
            { "Supported Features: Group Navigation",                "btsdp_service_avrcp_tg_supported_features_group_navigation",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_settings,
            { "Supported Features: Settings",                        "btsdp_service_avrcp_tg_supported_features_settings",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_category_4,
            { "Supported Features: Category 4: Menu",                "btsdp_service_avrcp_tg_supported_features_category_4",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_category_3,
            { "Supported Features: Category 3: Tuner",               "btsdp_service_avrcp_tg_supported_features_category_3",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_category_2,
            { "Supported Features: Category 2: Monitor/Amplifier",   "btsdp_service_avrcp_tg_supported_features_category_2",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_avrcp_tg_supported_features_category_1,
            { "Supported Features: Category 1: Player/Recorder",     "btsdp_service_avrcp_tg_supported_features_category_1",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_hsp_remote_audio_volume_control,
            { "Remote Audio Volume Control",     "btsdp_service_hsp_remote_audio_volume_control",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_gnss_supported_features,
            { "Supported Features: Reserved",    "btsdp_service_gnss_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFFFF,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_repositories,
            { "Supported Repositories",     "btsdp_service_pbap_pse_supported_repositories",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_repositories_reserved,
            { "Reserved",                   "btsdp_service_pbap_pse_supported_repositories_reserved",
            FT_UINT8, BASE_HEX, NULL, 0xF0,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_repositories_favourites,
            { "Favourites",                 "btsdp_service_pbap_pse_supported_repositories_favourites",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_repositories_speed_dial,
            { "Speed Dial",                 "btsdp_service_pbap_pse_supported_repositories_speed_dial",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_repositories_sim_card,
            { "SIM Card",                   "btsdp_service_pbap_pse_supported_repositories_sim_card",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_repositories_local_phonebook,
            { "Local Phonebook",            "btsdp_service_pbap_pse_supported_repositories_local_phonebook",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features,
            { "Supported Features",              "btsdp_service_pbap_pse_supported_features",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_reserved,
            { "Reserved",                        "btsdp_service_pbap_pse_supported_features_reserved",
            FT_UINT32, BASE_HEX, NULL, 0xFFFFFC00,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_default_contact_image_format,
            { "Default Contact Image Format",    "btsdp_service_pbap_pse_supported_features_default_contact_image_format",
            FT_BOOLEAN, 32, NULL, 0x00000200,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_contact_referencing,
            { "Contact Referencing",             "btsdp_service_pbap_pse_supported_features_contact_referencing",
            FT_BOOLEAN, 32, NULL, 0x00000100,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_x_bt_uid_vcard_property,
            { "X-BT-UID vCard Property",         "btsdp_service_pbap_pse_supported_features_x_bt_uid_vcard_property",
            FT_BOOLEAN, 32, NULL, 0x00000080,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_x_bt_uci_vcard_property,
            { "X-BT-UCI vCard Property",         "btsdp_service_pbap_pse_supported_features_x_bt_uci_vcard_property",
            FT_BOOLEAN, 32, NULL, 0x00000040,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_enhanced_missed_calls,
            { "Enhanced Missed Calls",           "btsdp_service_pbap_pse_supported_features_enhanced_missed_calls",
            FT_BOOLEAN, 32, NULL, 0x00000020,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_vcard_selecting,
            { "vCard Selecting",                 "btsdp_service_pbap_pse_supported_features_vcard_selecting",
            FT_BOOLEAN, 32, NULL, 0x00000010,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_folder_version_counters,
            { "Folder Version Counters",         "btsdp_service_pbap_pse_supported_features_folder_version_counters",
            FT_BOOLEAN, 32, NULL, 0x00000008,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_database_identifier,
            { "Database Identifier",             "btsdp_service_pbap_pse_supported_features_database_identifier",
            FT_BOOLEAN, 32, NULL, 0x00000004,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_browsing,
            { "Browsing",                        "btsdp_service_pbap_pse_supported_features_browsing",
            FT_BOOLEAN, 32, NULL, 0x00000002,
            NULL, HFILL }
        },
        { &hf_pbap_pse_supported_features_download,
            { "Download",                        "btsdp_service_pbap_pse_supported_features_download",
            FT_BOOLEAN, 32, NULL, 0x00000001,
            NULL, HFILL }
        },
        { &hf_pbap_goep_l2cap_psm,
            { "GOEP L2CAP PSM",                  "btsdp_pbap_goep_l2cap_psm",
            FT_UINT16, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_dun_support_audio_feedback,
            { "Support: Audio Feedback",         "btsdp_dun_support_audio_feedback",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_dun_escape_sequence,
            { "Escape Sequence",                 "btsdp_dun_support_escape_sequence",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_fax_support_class_1,
            { "Support: Fax Class 1",            "btsdp_fax_support_class_1",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_fax_support_class_2,
            { "Support: Fax Class 2_0",          "btsdp_fax_support_class_2",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_fax_support_class_2_vendor,
            { "Support: Fax Class 2 Vendor",     "btsdp_fax_support_class_2_vendor",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_fax_support_audio_feedback,
            { "Support: Audio Feedback",         "btsdp_fax_support_audio_feedback",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ftp_goep_l2cap_psm,
            { "GOEP L2CAP PSM",                  "btsdp_ftp_goep_l2cap_psm",
            FT_UINT16, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_map_mas_instance_id,
            { "MAS Instance ID",                 "btsdp_map_mas_instance_id",
            FT_UINT8, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_map_mas_goep_l2cap_psm,
            { "GOEP L2CAP PSM",                  "btsdp_map_mas_goep_l2cap_psm",
            FT_UINT16, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_map_mns_goep_l2cap_psm,
            { "GOEP L2CAP PSM",                  "btsdp_map_mns_goep_l2cap_psm",
            FT_UINT16, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_map_mas_supported_message_types_reserved,
            { "Supported Message Types: Reserved",         "btsdp_map_mas_supported_message_types_reserved",
            FT_UINT8, BASE_DEC_HEX, NULL, 0xF0,
            NULL, HFILL }
        },
        { &hf_map_mas_supported_message_types_mms,
            { "Supported Message Types: MMS",              "btsdp_map_mas_supported_message_types_mms",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_map_mas_supported_message_types_sms_cdma,
            { "Supported Message Types: SMS CDMA",         "btsdp_map_mas_supported_message_types_sms_cdma",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_map_mas_supported_message_types_sms_gsm,
            { "Supported Message Types: SMS GSM",          "btsdp_map_mas_supported_message_types_sms_gsm",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_map_mas_supported_message_types_email,
            { "Supported Message Types: Email",              "btsdp_map_mas_supported_message_types_email",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_hcrp_1284_id,
            { "1284 ID",                         "btsdp_hcrp_1284_id",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hcrp_device_location,
            { "Service Location",                 "btsdp_hcrp_device_location",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hcrp_device_name,
            { "Device Name",                     "btsdp_hcrp_device_name",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hcrp_friendly_name,
            { "Friendly Name",                   "btsdp_hcrp_friendly_name",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_wap_network_address,
            { "Network Address",                 "btsdp_wap_network_address",
            FT_IPv4, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_wap_homepage_url,
            { "Homepage URL",                    "btsdp_wap_homepage_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_wap_gateway,
            { "Gateway",                         "btsdp_wap_gateway",
            FT_UINT8, BASE_HEX, VALS(wap_gateway_vals), 0,
            NULL, HFILL }
        },
        { &hf_wap_stack_type,
            { "Stack Type",                      "btsdp_wap_stack_type",
            FT_UINT8, BASE_HEX, VALS(wap_stack_type_vals), 0,
            NULL, HFILL }
        },
        { &hf_hdp_support_procedure_reserved_5_7,
            { "Support: Reserved_5_7",           "btsdp_hdp_support_reserved_5_7",
            FT_UINT8, BASE_HEX, NULL, 0xE0,
            NULL, HFILL }
        },
        { &hf_hdp_support_procedure_sync_master_role,
            { "Support: SyncMaster Role",        "btsdp_hdp_support_sync_master_role",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_hdp_support_procedure_clock_synchronization_protocol,
            { "Support: Clock Synchronization Protocol",   "btsdp_hdp_support_clock_synchronization_protocol",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_hdp_support_procedure_reconnect_acceptance,
            { "Support: Reconnect Acceptance",   "btsdp_hdp_support_reconnect_acceptance",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_hdp_support_procedure_reconnect_initiation,
            { "Support: Reconnect Initiation",   "btsdp_hdp_support_reconnect_initiation",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_hdp_support_procedure_reserved,
            { "Support: Reserved",               "btsdp_hdp_support_reserved",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_hdp_data_exchange,
            { "Data Exchange Specification",     "btsdp_hdp_data_exchange_specification",
            FT_UINT8, BASE_HEX, VALS(hdp_data_exchange_specification_vals), 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_data,
            { "Supported Features",              "btsdp_hdp_supported_features_data",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_data_mdep_id,
            { "MDEP ID",                         "btsdp_hdp_supported_features_data_mdep_id",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_data_mdep_data_type,
            { "MDEP Data Type",                  "btsdp_hdp_supported_features_data_mdep_data_type",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_data_mdep_role,
            { "MDEP Role",                       "btsdp_hdp_supported_features_data_mdep_role",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_data_mdep_description,
            { "MDEP Description",                "btsdp_hdp_supported_features_data_mdep_description",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_mdep_id,
            { "MDEP ID",                         "btsdp_hdp_supported_features_mdep_id",
            FT_UINT8, BASE_DEC_HEX|BASE_RANGE_STRING, RVALS(hdp_mdep_id_rvals), 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_mdep_data_type_01,
            { "MDEP Data Type",                  "btsdp_hdp_supported_features_mdep_data_type",
        ...
        { &hf_hdp_supported_features_mdep_role,
            { "MDEP Role",                       "btsdp_hdp_supported_features_mdep_role",
            FT_UINT8, BASE_HEX, VALS(hdp_mdep_role_vals), 0,
            NULL, HFILL }
        },
        { &hf_hdp_supported_features_mdep_description,
            { "MDEP Description",                "btsdp_hdp_supported_features_mdep_description",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_pan_sercurity_description,
            { "Security Description",            "btsdp_pan_security_description",
            FT_UINT16, BASE_HEX, VALS(pan_security_description_vals), 0,
            NULL, HFILL }
        },
        { &hf_pan_ipv4_subnet,
            { "IPv4 Subnet",                     "btsdp_pan_ipv4_subnet",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_pan_ipv6_subnet,
            { "IPv6 Subnet",                     "btsdp_pan_ipv6_subnet",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_pan_net_access_type,
            { "Net Access Type",                 "btsdp_pan_net_access_type",
            FT_UINT16, BASE_HEX, VALS(pan_net_access_type_vals), 0,
            NULL, HFILL }
        },
        { &hf_pan_max_net_access_rate,
            { "Max Net Access Rate",             "btsdp_pan_max_net_access_rate",
            FT_UINT32, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_opp_goep_l2cap_psm,
            { "GOEP L2CAP PSM",                  "btsdp_opp_goep_l2cap_psm",
            FT_UINT16, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_opp_supported_format,
            { "Supported Format",                  "btsdp_opp_supported_format",
            FT_UINT8, BASE_HEX, VALS(opp_supported_format_vals), 0,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_reserved,
            { "Supported Features: Reserved",                             "btsdp_service_hfp_hf_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFFC0,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_wide_band_speech,
            { "Supported Features: Wide Band Speech",                     "btsdp_service_hfp_hf_supported_features_wide_band_speech",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_remote_volume_control,
            { "Supported Features: Remote Volume Control",                "btsdp_service_hfp_hf_supported_features_remote_volume_control",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_voice_recognition_activation,
            { "Supported Features: Voice Recognition Activation",         "btsdp_service_hfp_hf_supported_features_voice_recognition_activation",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_cli_presentation_capability,
            { "Supported Features: CLI Presentation Capability",          "btsdp_service_hfp_hf_supported_features_cli_presentation_capability",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_call_waiting_or_three_way_calling,
            { "Supported Features: Call Waiting or Three Way Calling",    "btsdp_service_hfp_hf_supported_features_call_waiting_or_three_way_calling",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_hfp_hf_supported_features_ec_and_or_nr_function,
            { "Supported Features: EC and/or Nr Function",                "btsdp_service_hfp_hf_supported_features_ec_and_or_nr_function",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_reserved,
            { "Supported Features: Reserved",                             "btsdp_service_hfp_gw_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFFC0,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_wide_band_speech,
            { "Supported Features: Wide Band Speech",                     "btsdp_service_hfp_gw_supported_features_wide_band_speech",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_attach_phone_number_to_voice_tag,
            { "Supported Features: Attach a Phone Number to a Voice Tag", "btsdp_service_hfp_gw_supported_features_attach_a_phone_number_to_a_voice_tag",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_inband_ring_tone_capability,
            { "Supported Features: Inband Ring Tone Capability",          "btsdp_service_hfp_gw_supported_features_inband_ring_tone_capability",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_voice_recognition_function,
            { "Supported Features: Voice Recognition Function",           "btsdp_service_hfp_gw_supported_features_voice_recognition_function",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_ec_and_or_nr_function,
            { "Supported Features: EC and/or Nr Function",                "btsdp_service_hfp_gw_supported_features_ec_and_or_nr_function",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_hfp_gw_supported_features_three_way_calling,
            { "Supported Features: Three Way Calling",                    "btsdp_service_hfp_gw_supported_features_three_way_calling",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_hfp_gw_network,
            { "Network",                                                  "btsdp_service_hfp_gw_network",
            FT_UINT8, BASE_HEX, VALS(hfp_gw_network_vals), 0,
            NULL, HFILL }
        },
        { &hf_ctn_instance_id,
            { "Instance ID",                     "btsdp_ctn_instance_id",
            FT_UINT8, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features,
            { "Supported Features",              "btsdp_ctn_supported_features",
            FT_UINT32, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_reserved,
            { "Reserved",                        "btsdp_ctn_supported_features_reserved",
            FT_BOOLEAN, 32, NULL, 0xFFFFFF80,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_forward,
            { "Forward",                         "btsdp_ctn_supported_features_forward",
            FT_BOOLEAN, 32, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_delete,
            { "Delete",                          "btsdp_ctn_supported_features_delete",
            FT_BOOLEAN, 32, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_uploading,
            { "Uploading",                       "btsdp_ctn_supported_features_uploading",
            FT_BOOLEAN, 32, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_downloading,
            { "Downloading",                     "btsdp_ctn_supported_features_downloading",
            FT_BOOLEAN, 32, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_browsing,
            { "Browsing",                        "btsdp_ctn_supported_features_browsing",
            FT_BOOLEAN, 32, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_notification,
            { "Notification",                    "btsdp_ctn_supported_features_notification",
            FT_BOOLEAN, 32, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_ctn_supported_features_account_management,
            { "Account Management",              "btsdp_ctn_supported_features_account_management",
            FT_BOOLEAN, 32, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios,
            { "Supported Profile and Protocol Dependency",                                                   "btsdp_mps_mpsd_scenarios",
            FT_UINT64, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_reserved,
            { "Reserved",                                                                                    "btsdp_mps_mpsd_scenarios_reserved",
            FT_UINT64, BASE_HEX, NULL, G_GUINT64_CONSTANT(0xFFFFFFC000000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_37,
            { "Phonebook Download during Audio Streaming (A2DP-SNK_PBAP-Client)",                            "btsdp_mps_mpsd_scenarios_37",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000002000000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_36,
            { "Phonebook Download during Audio Streaming (A2DP-SRC_PBAP-Server)",                            "btsdp_mps_mpsd_scenarios_36",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000001000000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_35,
            { "Data communication establishment in Personal Area Network during Audio Streaming (A2DP-SNK_PAN_PANU)",  "btsdp_mps_mpsd_scenarios_35",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000800000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_34,
            { "Data communication establishment in Personal Area Network during Audio Streaming (A2DP-SRC_PAN-NAP)",   "btsdp_mps_mpsd_scenarios_34",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000400000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_33,
            { "Start Audio Streaming during Data communication in Personal Area Network (A2DP-SNK_PAN-PANU)",          "btsdp_mps_mpsd_scenarios_33",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000200000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_32,
            { "Start Audio Streaming during Data communication in Personal Area Network (A2DP-SRC_PAN-NAP)",           "btsdp_mps_mpsd_scenarios_32",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000100000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_31,
            { "Incoming voice call during Data communication in Personal Area Network (HFP-HF_PAN-PANU)",              "btsdp_mps_mpsd_scenarios_31",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000080000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_30,
            { "Incoming voice call during Data communication in Personal Area Network (HFP-AG_PAN-NAP)",               "btsdp_mps_mpsd_scenarios_30",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000040000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_29,
            { "Outgoing voice call during Data communication in Personal Area Network (HFP-HF_PAN-PANU)",              "btsdp_mps_mpsd_scenarios_29",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000020000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_28,
            { "Outgoing voice call during Data communication in Personal Area Network (HFP-AG_PAN-NAP)",               "btsdp_mps_mpsd_scenarios_28",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000010000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_27,
            { "Data communication in Personal Area Network during active voice call (HFP-HF_PAN-PANU)",                "btsdp_mps_mpsd_scenarios_27",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000008000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_26,
            { "Data communication in Personal Area Network during active voice call (HFP-AG_PAN-NAP)",                 "btsdp_mps_mpsd_scenarios_26",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000004000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_25,
            { "Terminate voice call / data call during data communication and voice call (HFP-HF_DUN-DT)",             "btsdp_mps_mpsd_scenarios_25",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000002000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_24,
            { "Terminate voice call / data call during data communication and voice call (HFP-AG_DUN-GW)",             "btsdp_mps_mpsd_scenarios_24",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000001000000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_23,
            { "Data communication establishment under PSDM (DUN) during Audio Streaming (A2DP-SNK_DUN-DT)",            "btsdp_mps_mpsd_scenarios_23",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000800000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_22,
            { "Data communication establishment under PSDM (DUN) during Audio Streaming (A2DP-SRC_DUN-GW)",            "btsdp_mps_mpsd_scenarios_22",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000400000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_21,
            { "Start Audio Streaming during Data communication under PSDM (DUN) (A2DP-SNK_DUN-DT)",                    "btsdp_mps_mpsd_scenarios_21",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000200000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_20,
            { "Start Audio Streaming during Data communication under PSDM (DUN) (A2DP-SRC_DUN-GW)",                    "btsdp_mps_mpsd_scenarios_20",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000100000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_19,
            { "Incoming voice call during Data communication under PSDM (DUN) (HFP-HF_DUN-DT)",                        "btsdp_mps_mpsd_scenarios_19",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000080000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_18,
            { "Incoming voice call during Data communication under PSDM (DUN) (HFP-AG_DUN-GW)",                        "btsdp_mps_mpsd_scenarios_18",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000040000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_17,
            { "Outgoing voice call during Data communication under PSDM (DUN) (HFP-HF_DUN-DT)",                        "btsdp_mps_mpsd_scenarios_17",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000020000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_16,
            { "Outgoing voice call during Data communication under PSDM (DUN) (HFP-AG_DUN-GW)",                        "btsdp_mps_mpsd_scenarios_16",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000010000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_15,
            { "Data communication under PSDM (DUN) during active voice call (HFP-HF_DUN-DT)",                          "btsdp_mps_mpsd_scenarios_15",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000008000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_14,
            { "Data communication under PSDM (DUN) during active voice call (HFP-AG_DUN-GW)",                          "btsdp_mps_mpsd_scenarios_14",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000004000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_13,
            { "Suspend Audio Streaming after AVRCP Pause/Stop (HFP-HF_A2DP-SNK)",                            "btsdp_mps_mpsd_scenarios_13",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000002000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_12,
            { "Suspend Audio Streaming after AVRCP Pause/Stop (HFP-AG_A2DP-SRC)",                            "btsdp_mps_mpsd_scenarios_12",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000001000),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_11,
            { "Start Audio Streaming after AVRCP Play Command (HFP-HF_A2DP-SNK)",                            "btsdp_mps_mpsd_scenarios_11",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000800),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_10,
            { "Start Audio Streaming after AVRCP Play Command (HFP-AG_A2DP-SRC)",                            "btsdp_mps_mpsd_scenarios_10",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000400),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_9,
            { "Press Play on Audio Player during active call (HFP-HF_A2DP-SNK)",                             "btsdp_mps_mpsd_scenarios_9",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000200),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_8,
            { "Press Play on Audio Player during active call (HFP-AG_A2DP-SRC)",                             "btsdp_mps_mpsd_scenarios_8",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000100),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_7,
            { "HFP call termination during AVP connection (HFP-HF_A2DP-SNK)",                                "btsdp_mps_mpsd_scenarios_7",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000080),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_6,
            { "HFP call termination during AVP connection (HFP-AG_A2DP-SRC)",                                "btsdp_mps_mpsd_scenarios_6",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000040),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_5,
            { "Reject/Ignore Incoming Call during Audio Streaming (HFP-HF_A2DP-SNK)",                        "btsdp_mps_mpsd_scenarios_5",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000020),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_4,
            { "Reject/Ignore Incoming Call during Audio Streaming (HFP-AG_A2DP-SRC)",                        "btsdp_mps_mpsd_scenarios_4",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000010),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_3,
            { "Outgoing Call during Audio Streaming (HFP-HF_A2DP-SNK)",                                      "btsdp_mps_mpsd_scenarios_3",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000008),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_2,
            { "Outgoing Call during Audio Streaming (HFP-AG_A2DP-SRC)",                                      "btsdp_mps_mpsd_scenarios_2",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000004),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_1,
            { "Answer Incoming Call during Audio Streaming (HFP-HF_A2DP-SNK)",                               "btsdp_mps_mpsd_scenarios_1",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000002),
            NULL, HFILL }
        },
        { &hf_mps_mpsd_scenarios_0,
            { "Answer Incoming Call during Audio Streaming (HFP-AG_A2DP-SRC)",                               "btsdp_mps_mpsd_scenarios_0",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000001),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios,
            { "Supported Profile and Protocol Dependency",                                                   "btsdp_mps_mpmd_scenarios",
            FT_UINT64, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_reserved,
            { "Reserved",                                                                                    "btsdp_mps_mpmd_scenarios_reserved",
            FT_UINT64, BASE_HEX, NULL, G_GUINT64_CONSTANT(0xFFFFFFFFFFF80000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_18,
            { "Start Packet data communication during Audio streaming (A2DP-SNK_AVRCP-CT_DUN-DT)",           "btsdp_mps_mpmd_scenarios_18",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000040000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_17,
            { "Start Packet data communication during Audio streaming (A2DP-SRC_AVRCP-TG)",                  "btsdp_mps_mpmd_scenarios_17",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000020000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_16,
            { "Start Audio streaming during Data communication under PSDM (A2DP-SNK_AVRCP-CT_DUN-DT)",       "btsdp_mps_mpmd_scenarios_16",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000010000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_15,
            { "Start Audio streaming during Data communication under PSDM (A2DP-SRC_AVRCP-TG)",              "btsdp_mps_mpmd_scenarios_15",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000008000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_14,
            { "Suspend Audio Streaming after AVRCP Pause/Stop (A2DP-SRC_AVRCP-TG)",                          "btsdp_mps_mpmd_scenarios_14",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000004000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_13,
            { "Suspend Audio Streaming after AVRCP Pause/Stop (AVRCP-CT where the same device does not carry out the role of an A2DP SNK)",     "btsdp_mps_mpmd_scenarios_13",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000002000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_12,
            { "Start Audio Streaming after AVRCP Play Command (A2DP-SRC_AVRCP-TG)",                                                             "btsdp_mps_mpmd_scenarios_12",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000001000),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_11,
            { "Start Audio Streaming after AVRCP Play Command (AVRCP-CT where the same device does not carry out the role of an A2DP SNK)",     "btsdp_mps_mpmd_scenarios_11",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000800),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_10,
            { "Press Play on Audio Player during active call (A2DP-SRC_AVRCP-TG)",                 "btsdp_mps_mpmd_scenarios_10",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000400),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_9,
            { "Press Play on Audio Player during active call (HFP-HF_A2DP-SNK_AVRCP-CT)",          "btsdp_mps_mpmd_scenarios_9",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000200),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_8,
            { "HFP Call termination during AVP connection (A2DP-SRC_AVRCP-TG)",                    "btsdp_mps_mpmd_scenarios_8",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000100),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_7,
            { "HFP Call termination during AVP connection (HFP-HF_ A2DP-SNK_AVRCP-CT)",            "btsdp_mps_mpmd_scenarios_7",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000080),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_6,
            { "HFP Call termination during AVP connection (HFP-AG)",                               "btsdp_mps_mpmd_scenarios_6",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000040),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_5,
            { "Reject/Ignore Incoming Call during Audio Streaming (A2DP-SRC_AVRCP-TG)",            "btsdp_mps_mpmd_scenarios_5",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000020),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_4,
            { "Reject/Ignore Incoming Call during Audio Streaming (HFP-HF_A2DP-SNK_AVRCP-CT)",     "btsdp_mps_mpmd_scenarios_4",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000010),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_3,
            { "Outgoing Call during Audio Streaming (A2DP-SRC_AVRCP-TG)",                          "btsdp_mps_mpmd_scenarios_3",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000008),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_2,
            { "Outgoing Call during Audio Streaming (HFP-HF_A2DP-SNK_AVRCP-CT)",                   "btsdp_mps_mpmd_scenarios_2",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000004),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_1,
            { "Answer Incoming Call during Audio Streaming (A2DP-SRC_AVRCP-TG)",                   "btsdp_mps_mpmd_scenarios_1",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000002),
            NULL, HFILL }
        },
        { &hf_mps_mpmd_scenarios_0,
            { "Answer Incoming Call during Audio Streaming (HFP-HF_A2DP-SNK_AVRCP-CT)",            "btsdp_mps_mpmd_scenarios_0",
            FT_BOOLEAN, 64, NULL, G_GUINT64_CONSTANT(0x0000000000000001),
            NULL, HFILL }
        },
        { &hf_mps_supported_profile_and_protocol_dependency,
            { "Supported Profile and Protocol Dependency",           "btsdp_mps_supported_profile_and_protocol_dependency",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_mps_supported_profile_and_protocol_dependency_reserved,
            { "Reserved",                                  "btsdp_mps_supported_profile_and_protocol_dependency_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFFF8,
            NULL, HFILL }
        },
        { &hf_mps_supported_profile_and_protocol_dependency_dis_connection_order_behaviour,
            { "(Dis)Connection Order/Behaviour",           "btsdp_mps_supported_profile_and_protocol_dependency_dis_connection_order_behaviour",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_mps_supported_profile_and_protocol_dependency_gavdp_requirements,
            { "GAVDP Requirements",                        "btsdp_mps_supported_profile_and_protocol_dependency_gavdp_requirements",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_mps_supported_profile_and_protocol_dependency_sniff_mode_during_streaming,
            { "Sniff Mode During Streaming",               "btsdp_mps_supported_profile_and_protocol_dependency_sniff_mode_during_streaming",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_map_supported_features,
            { "Supported Features",    "btsdp_map_supported_features",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_map_supported_features_reserved,
            { "Reserved",              "btsdp_map_supported_features_reserved",
            FT_UINT32, BASE_HEX, NULL, 0xFFFFFF80,
            NULL, HFILL }
        },
        { &hf_map_supported_features_extended_event_report_1_1,
            { "Extended Event Report 1.1",  "btsdp_map_supported_features_extended_event_report_1_1",
            FT_BOOLEAN, 32, NULL, 0x00000040,
            NULL, HFILL }
        },
        { &hf_map_supported_features_instance_information_feature,
            { "Instance Information Feature",  "btsdp_map_supported_features_instance_information_feature",
            FT_BOOLEAN, 32, NULL, 0x00000020,
            NULL, HFILL }
        },
        { &hf_map_supported_features_delete_feature,
            { "Delete Feature",  "btsdp_map_supported_features_delete_feature",
            FT_BOOLEAN, 32, NULL, 0x00000010,
            NULL, HFILL }
        },
        { &hf_map_supported_features_uploading_feature,
            { "Uploading Feature",  "btsdp_map_supported_features_uploading_feature",
            FT_BOOLEAN, 32, NULL, 0x00000008,
            NULL, HFILL }
        },
        { &hf_map_supported_features_browsing_feature,
            { "Browsing Feature",  "btsdp_map_supported_features_browsing_feature",
            FT_BOOLEAN, 32, NULL, 0x00000004,
            NULL, HFILL }
        },
        { &hf_map_supported_features_notification_feature,
            { "Notification Feature",  "btsdp_map_supported_features_notification_feature",
            FT_BOOLEAN, 32, NULL, 0x00000002,
            NULL, HFILL }
        },
        { &hf_map_supported_features_notification_registration_feature,
            { "Notification Registration Feature",  "btsdp_map_supported_features_notification_registration_feature",
            FT_BOOLEAN, 32, NULL, 0x00000001,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_item,
            { "Protocol",                        "btsdp_protocol_item",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol,
            { "Protocol Entry",                  "btsdp_protocol",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_psm,
            { "L2CAP PSM",                       "btsdp_protocol_psm",
            FT_UINT16, BASE_DEC_HEX | BASE_EXT_STRING, &ext_psm_vals, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_channel,
            { "RFCOMM Channel",                  "btsdp_protocol_channel",
            FT_UINT8, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_gatt_handle_start,
            { "GATT Handle Start",               "btsdp_protocol_gatt_handle_start",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_gatt_handle_end,
            { "GATT Handle Start",               "btsdp_protocol_gatt_handle_end",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_version,
            { "Protocol Version",                "btsdp_protocol_version",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_protocol_bnep_type,
            { "BNEP Type",                       "btsdp_protocol_bnep_type",
            FT_UINT16, BASE_HEX, VALS(etype_vals), 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_record_handle,
            { "Service Record Handle",           "btsdp_service_record_handle",
            FT_UINT32, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_record_state,
            { "Service Record State",            "btsdp_service_record_state",
            FT_UINT32, BASE_HEX_DEC, NULL, 0,
            NULL, HFILL }
        },

        { &hf_sdp_service_info_time_to_live,
            { "Service Info Time to Live",       "btsdp_service_info_time_to_live",
            FT_UINT32, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_availability,
            { "Service Availability",            "btsdp_service_availability",
            FT_UINT8, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_documentation_url,
            { "Documentation URL",               "btsdp_documentation_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_client_executable_url,
            { "Service Client Executable URL",   "btsdp_service_client_executable_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_icon_url,
            { "Icon URL",                        "btsdp_icon_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_name,
            { "Service Name",                    "btsdp_service_name",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_description,
            { "Service Description",             "btsdp_service_description",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_service_provider_name,
            { "Provider Name",                   "btsdp_provider_name",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_lang,
        ...
        { &hf_sdp_lang_code,
            { "Language Code",                   "btsdp_lang_code",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_sdp_lang_id,
            { "Language ID",                     "btsdp_lang_id",
            FT_UINT16, BASE_HEX | BASE_EXT_STRING, &usb_langid_vals_ext, 0,
            NULL, HFILL }
        },
        { &hf_sdp_lang_encoding,
            { "Language Encoding",               "btsdp_lang_encoding",
            FT_UINT16, BASE_DEC | BASE_EXT_STRING, &mibenum_vals_character_sets_ext, 0,
            NULL, HFILL }
        },
        { &hf_sdp_lang_attribute_base,
            { "Attribute Base",                  "btsdp_lang_attribute_base",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_device_release_number,
            { "Device Release Number",           "btsdp_service_hid_device_release_number",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_parser_version,
            { "Parser Version",                  "btsdp_service_hid_parser_version",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_device_subclass_type,
            { "Device Subclass: Type",           "btsdp_service_hid_device_subclass_type",
            FT_UINT8, BASE_HEX, VALS(hid_device_subclass_type_vals), 0xC0,
            NULL, HFILL }
        },
        { &hf_hid_device_subclass_subtype,
            { "Device Subclass: SubType",        "btsdp_service_hid_device_subclass_subtype",
            FT_UINT8, BASE_HEX, VALS(hid_device_subclass_subtype_vals), 0x3C,
            NULL, HFILL }
        },
        { &hf_hid_device_subclass_reserved,
            { "Device Subclass: Reserved",       "btsdp_service_hid_device_subclass_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x03,
            NULL, HFILL }
        },
        { &hf_hid_country_code,
            { "Country Code",                    "btsdp_service_hid_country_code",
            FT_UINT8, BASE_DEC_HEX, VALS(hid_country_code_vals), 0,
            NULL, HFILL }
        },
        { &hf_hid_virtual_cable,
            { "Virtual Cable",                   "btsdp_service_hid_virtual_cable",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_reconnect_initiate,
            { "Reconnect Initiate",              "btsdp_service_hid_reconnect_initiate",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_sdp_disable,
            { "SDP Disable",                     "btsdp_service_hid_sdp_disable",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_battery_power,
            { "Battery Power",                    "btsdp_service_hid_battery_power",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_remote_wake,
            { "Remote Wake",                     "btsdp_service_hid_remote_wake",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_normally_connectable,
            { "Normally Connectable",            "btsdp_service_hid_normally_connectable",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_boot_device,
            { "Boot Device",                     "btsdp_service_hid_boot_device",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_profile_version,
            { "Profile Version",                 "btsdp_service_hid_profile_version",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_supervision_timeout,
            { "Supervision Timeout",             "btsdp_service_hid_supervision_timeout",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_ssr_host_max_latency,
            { "SSR Host Max Latency",            "btsdp_service_hid_ssr_host_max_latency",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_ssr_host_min_timeout,
            { "SSR Host Min Timeout",            "btsdp_service_hid_ssr_host_min_timeout",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_descriptor_list_type,
            { "Descriptor Type",                 "btsdp_service_hid_descriptor_type",
            FT_UINT8, BASE_HEX, VALS(descriptor_list_type_vals), 0,
            NULL, HFILL }
        },
        { &hf_hid_lang,
            { "Language",                        "btsdp_service_hid_lang",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_descriptor_list_descriptor_data,
            { "Descriptor",                      "btsdp_service_hid_descriptor_list_descriptor_data",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_hid_descriptor_list_descriptor,
            { "Descriptor",                      "btsdp_service_hid_descriptor_list_descriptor",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bip_supported_capabilities_reserved_4_7,
            { "Supported Capabilities: Reserved",          "btsdp_service_bip_supported_capabilities_reserved",
            FT_UINT8, BASE_HEX, NULL, 0xF0,
            NULL, HFILL }
        },
        { &hf_bip_supported_capabilities_displaying,
            { "Supported Capabilities: Displaying",        "btsdp_service_bip_supported_capabilities_displaying",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bip_supported_capabilities_printing,
            { "Supported Capabilities: Printing",          "btsdp_service_bip_supported_capabilities_printing",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bip_supported_capabilities_capturing,
            { "Supported Capabilities: Capturing",         "btsdp_service_bip_supported_capabilities_capturing",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bip_supported_capabilities_genering_imaging,
            { "Supported Capabilities: Genering Imaging",  "btsdp_service_bip_supported_capabilities_genering_imaging",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_reserved_9_15,
            { "Supported Features: Reserved",              "btsdp_service_bip_supported_features_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFE00,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_remote_display,
            { "Supported Features: Remote Display",        "btsdp_service_bip_supported_features_remote_display",
            FT_BOOLEAN, 16, NULL, 0x0100,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_remote_camera,
            { "Supported Features: Remote Camera",         "btsdp_service_bip_supported_features_remote_camera",
            FT_BOOLEAN, 16, NULL, 0x0080,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_automatic_archive,
            { "Supported Features: Automatic Archive",     "btsdp_service_bip_supported_features_automatic_archive",
            FT_BOOLEAN, 16, NULL, 0x0040,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_advanced_image_printing,
            { "Supported Features: Advanced Image Printing","btsdp_service_bip_supported_features_advanced_image_printing",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_image_pull,
            { "Supported Features: Image Pull",            "btsdp_service_bip_supported_features_image_pull",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_image_push_display,
            { "Supported Features: Image Push Display",    "btsdp_service_bip_supported_features_image_push_display",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_image_push_print,
            { "Supported Features: Image Push Print",     "btsdp_service_bip_supported_features_image_push_print",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_image_push_store,
            { "Supported Features: Image Push Store",      "btsdp_service_bip_supported_features_image_push_store",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_bip_supported_features_image_push,
            { "Supported Features: Image Push",            "btsdp_service_bip_supported_features_image_push",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_reserved_17_31,
            { "Supported Functions: Reserved",            "btsdp_service_bip_supported_functions_reserved",
        ...
        { &hf_bip_supported_functions_get_status,
            { "Supported Functions: Get Status",           "btsdp_service_bip_supported_functions_get_status",
            FT_BOOLEAN, 32, NULL, 0x00010000,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_reserved_15,
            { "Supported Functions: Reserved",             "btsdp_service_bip_supported_functions_reserved_15",
            FT_BOOLEAN, 32, NULL, 0x00008000,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_monitoring_image,
            { "Supported Functions: Get Monitoring Image", "btsdp_service_bip_supported_functions_get_monitoring_image",
            FT_BOOLEAN, 32, NULL, 0x00004000,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_start_archive,
            { "Supported Functions: Start Archive",        "btsdp_service_bip_supported_functions_start_archive",
            FT_BOOLEAN, 32, NULL, 0x00002000,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_reserved_12,
            { "Supported Functions: Reserved",             "btsdp_service_bip_supported_functions_reserved_12",
            FT_BOOLEAN, 32, NULL, 0x00001000,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_partial_image,
            { "Supported Functions: Get Partial Image",    "btsdp_service_bip_supported_functions_get_partial_image",
            FT_BOOLEAN, 32, NULL, 0x00001000,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_start_print,
            { "Supported Functions: Start Print",          "btsdp_service_bip_supported_functions_start_print",
            FT_BOOLEAN, 32, NULL, 0x00000800,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_delete_image,
            { "Supported Functions: Delete Image",         "btsdp_service_bip_supported_functions_delete_image",
            FT_BOOLEAN, 32, NULL, 0x00000400,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_linked_attachment,
            { "Supported Functions: Get Linked Attachment","btsdp_service_bip_supported_functions_get_linked_attachment",
            FT_BOOLEAN, 32, NULL, 0x00000200,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_linked_thumbnail,
            { "Supported Functions: Get Linked Thumbnail", "btsdp_service_bip_supported_functions_get_linked_thumbnail",
            FT_BOOLEAN, 32, NULL, 0x00000100,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_image,
            { "Supported Functions: Get Image",            "btsdp_service_bip_supported_functions_get_image",
            FT_BOOLEAN, 32, NULL, 0x00000080,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_image_property,
            { "Supported Functions: Get Image Property",   "btsdp_service_bip_supported_functions_get_image_property",
            FT_BOOLEAN, 32, NULL, 0x00000040,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_images_list,
            { "Supported Functions: Get Images List",      "btsdp_service_bip_supported_functions_get_images_list",
            FT_BOOLEAN, 32, NULL, 0x00000020,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_remote_display,
            { "Supported Functions: Remote Display",       "btsdp_service_bip_supported_functions_remote_display",
            FT_BOOLEAN, 32, NULL, 0x00000010,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_put_linked_thumbnail,
            { "Supported Functions: Put Linked Thumbnail", "btsdp_service_bip_supported_functions_put_linked_thumbnail",
            FT_BOOLEAN, 32, NULL, 0x00000008,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_put_linked_attachment,
            { "Supported Functions: Put Linked Attachment","btsdp_service_bip_supported_functions_put_linked_attachment",
            FT_BOOLEAN, 32, NULL, 0x00000004,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_put_image,
            { "Supported Functions: Put Image",            "btsdp_service_bip_supported_functions_put_image",
            FT_BOOLEAN, 32, NULL, 0x00000002,
            NULL, HFILL }
        },
        { &hf_bip_supported_functions_get_capabilities,
            { "Supported Functions: Get Capabilities",     "btsdp_service_bip_supported_functions_get_capabilities",
            FT_BOOLEAN, 32, NULL, 0x00000001,
            NULL, HFILL }
        },
        { &hf_bip_total_imaging_data_capacity,
            { "Total Imaging Data Capacity",     "btsdp_bip_total_imaging_data_capacity",
            FT_UINT64, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bip_goep_l2cap_psm,
            { "GOEP L2CAP PSM",                  "btsdp_bip_goep_l2cap_psm",
            FT_UINT16, BASE_DEC_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_document_formats_supported,
            { "Document Formats Supported",       "btsdp_service_bpp_document_formats_supported",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_character_repertoires_support,
            { "Character Repertoires Support",   "btsdp_service_bpp_character_repertoires_support",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_xhtml_print_image_formats_supported,
            { "XHTML Print Image Formats Supported",       "btsdp_service_bpp_xhtml_print_image_formats_supported",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_color_supported,
            { "Color Supported",                 "btsdp_service_bpp_color_supported",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_1284_id,
            { "1284 ID",                         "btsdp_service_bpp_1284_id",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_printer_name,
            { "Printer Name",                    "btsdp_service_bpp_printer_name",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_printer_location,
            { "Printer Location",                "btsdp_service_bpp_location",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_duplex_supported,
            { "Duplex Supported",                "btsdp_service_bpp_duplex_supported",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_media_types_supported,
            { "Media Types Supported",           "btsdp_service_bpp_media_types_supported",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_max_media_width,
            { "Max Media Width",                 "btsdp_service_bpp_max_media_width",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_max_media_length,
            { "Max Media Length",                "btsdp_service_bpp_max_media_length",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_enhanced_layout_supported,
            { "Enhanced Layout Supported",       "btsdp_service_bpp_enhanced_layout_supported",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_rui_formats_supported,
            { "RUI Formats Supported",           "btsdp_service_bpp_rui_formats_supported",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_reference_printing_rui_supported,
            { "Reference Printing RUI Supported","btsdp_service_bpp_reference_printing_rui_supported",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_direct_printing_rui_supported,
            { "Direct Printing RUI Supported",   "btsdp_service_bpp_direct_printing_rui_supported",
            FT_BOOLEAN, 8, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_reference_printing_top_url,
            { "Reference Printing Top URL",      "btsdp_service_bpp_reference_printing_top_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_direct_printing_top_url,
            { "Direct Printing Top URL",         "btsdp_service_bpp_direct_printing_top_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_device_name,
            { "Device Name",                     "btsdp_service_bpp_device_name",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_bpp_printer_admin_rui_top_url,
            { "Printer Admin RUI Top URL",       "btsdp_service_bpp_printer_admin_rui_top_url",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        }
    };
