...
proto_register_bthci_evt(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_bthci_evt_ret_params,
          { "Return Parameter",       "bthci_evt_ret_params",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_status,
          { "Status",           "bthci_evt_status",
        ...
        { &hf_bthci_evt_curr_mode,
          { "Current Mode",        "bthci_evt_current_mode",
            FT_UINT8, BASE_HEX, VALS(evt_modes), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_interval,
          { "Interval",        "bthci_evt_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            "Interval - Number of Baseband slots", HFILL }
        },
        { &hf_bthci_evt_link_key,
          { "Link Key",        "bthci_evt_link_key",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            "Link Key for the associated BD_ADDR", HFILL }
        },
        { &hf_bthci_evt_key_type,
          { "Key Type",        "bthci_evt_key_type",
            FT_UINT8, BASE_HEX, VALS(evt_key_types), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_slots,
          { "Maximum Number of Slots",        "bthci_evt_max_slots",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "Maximum Number of slots allowed for baseband packets", HFILL }
        },
        { &hf_bthci_evt_clock_offset,
          { "Clock Offset",        "bthci_evt_clock_offset",
            FT_UINT16, BASE_HEX, NULL, 0x7FFF,
            "Bit 2-16 of the Clock Offset between CLKmaster-CLKslave", HFILL }
        },
        { &hf_bthci_evt_page_scan_mode,
          { "Page Scan Mode",        "bthci_evt_page_scan_mode",
            FT_UINT8, BASE_HEX, VALS(bthci_cmd_page_scan_modes), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_page_scan_repetition_mode,
          { "Page Scan Repetition Mode",        "bthci_evt_page_scan_repetition_mode",
            FT_UINT8, BASE_HEX, VALS(bthci_cmd_page_scan_repetition_modes), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_reserved,
          { "Reserved",        "bthci_evt_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_page_scan_period_mode,
          { "Page Scan Period Mode",        "bthci_evt_page_scan_period_mode",
            FT_UINT8, BASE_HEX, VALS(bthci_cmd_page_scan_period_modes), 0x0,
            NULL, HFILL }
        },
        { &hf_packet_type_acl,
          { "Packet Type for ACL",               "bthci_evt_packet_type",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_dh5,
          { "DH5 may be used",                   "bthci_evt_packet_type_dh5",
            FT_BOOLEAN, 16, NULL, 0x8000,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_dm5,
          { "DM5 may be used",                   "bthci_evt_packet_type_dm5",
            FT_BOOLEAN, 16, NULL, 0x4000,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_3dh5,
          { "3-DH5 shall NOT be used",           "bthci_evt_packet_type_3dh5",
            FT_BOOLEAN, 16, NULL, 0x2000,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_2dh5,
          { "2-DH5 shall NOT be used",           "bthci_evt_packet_type_2dh5",
            FT_BOOLEAN, 16, NULL, 0x1000,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_dh3,
          { "DH3 may be used",                   "bthci_evt_packet_type_dh3",
            FT_BOOLEAN, 16, NULL, 0x0800,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_dm3,
          { "DM3 may be used",                   "bthci_evt_packet_type_dm3",
            FT_BOOLEAN, 16, NULL, 0x0400,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_3dh3,
          { "3-DH3 shall NOT be used",           "bthci_evt_packet_type_3dh3",
            FT_BOOLEAN, 16, NULL, 0x0200,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_2dh3,
          { "2-DH3 shall NOT be used",           "bthci_evt_packet_type_2dh3",
            FT_BOOLEAN, 16, NULL, 0x0100,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_reserved_5_7,
          { "Reserved",                          "bthci_evt_packet_type_reserved_5_7",
            FT_UINT16, BASE_HEX, NULL, 0x00E0,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_dh1,
          { "DH1 may be used",                   "bthci_evt_packet_type_dh1",
            FT_BOOLEAN, 16, NULL, 0x0010,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_dm1,
          { "DM1 may be used",                   "bthci_evt_packet_type_dm1",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_3dh1,
          { "3-DH1 shall NOT be used",           "bthci_evt_packet_type_3dh1",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_2dh1,
          { "2-DH1 shall NOT be used",           "bthci_evt_packet_type_2dh1",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_packet_type_acl_reserved_0,
          { "Reserved",                          "bthci_evt_packet_type_reserved_0",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_packet_type_sco,
          { "Packet Type for SCO",               "bthci_evt_packet_type",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_packet_type_sco_reserved_15_8,
          { "Reserved",                          "bthci_evt_packet_type_reserved_15_8",
            FT_UINT16, BASE_HEX, NULL, 0xFF00,
            NULL, HFILL }
        },
        { &hf_packet_type_sco_hv3,
          { "HV3",                               "bthci_evt_packet_type_hv3",
            FT_BOOLEAN, 16, NULL, 0x0080,
            NULL, HFILL }
        },
        { &hf_packet_type_sco_hv2,
          { "HV2",                               "bthci_evt_packet_type_hv2",
            FT_BOOLEAN, 16, NULL, 0x0040,
            NULL, HFILL }
        },
        { &hf_packet_type_sco_hv1,
          { "HV1",                               "bthci_evt_packet_type_hv1",
            FT_BOOLEAN, 16, NULL, 0x0020,
            NULL, HFILL }
        },
        { &hf_packet_type_sco_reserved_4_0,
          { "Reserved",                          "bthci_evt_packet_type_reserved_4_0",
            FT_UINT16, BASE_HEX, NULL, 0x001F,
            NULL, HFILL }
        },
        { &hf_lmp_features,
          { "LMP Features",        "bthci_evt_lmp_features",
            FT_NONE, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_lmp_feature_3slot_packets,
          { "3-slot packets",                         "bthci_evt_lmp_features_3slot_packets",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_5slot_packets,
          { "5-slot packets",                         "bthci_evt_lmp_features_5slot_packets",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_encryption,
          { "Encryption",                             "bthci_evt_lmp_features_encryption",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_slot_offset,
          { "Slot Offset",                            "bthci_evt_lmp_features_slot_offset",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_timing_accuracy,
          { "Timing Accuracy",                        "bthci_evt_lmp_features_timing_accuracy",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_lmp_feature_role_switch,
          { "Role Switch",                            "bthci_evt_lmp_features_role_switch",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_lmp_feature_hold_mode,
          { "Hold Mode",                              "bthci_evt_lmp_features_hold_mode",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_lmp_feature_sniff_mode,
          { "Sniff Mode",                             "bthci_evt_lmp_features_sniff_mode",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_park_state,
          { "Park Mode",                              "bthci_evt_lmp_features_park_state",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_power_control_requests,
          { "Power Control Requests",                 "bthci_evt_lmp_features_power_control_requests",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_channel_quality_driven_data_rate,
          { "Channel Quality Driven Data Rate",       "bthci_evt_lmp_features_channel_quality_driven_data_rate",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_sco_link,
          { "SCO Link",                               "bthci_evt_lmp_features_sco_link",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_hv2_packets,
          { "HV2 packets",                            "bthci_evt_lmp_features_hv2_packets",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_lmp_feature_hv3_packets,
          { "HV3 packets",                            "bthci_evt_lmp_features_hv3_packets",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_lmp_feature_u_law_log_synchronous_data,
          { "u-law Log Synchronous Data",             "bthci_evt_lmp_features_u_law_log_synchronous_data",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_lmp_feature_a_law_log_synchronous_data,
          { "A-law Log Synchronous Data",             "bthci_evt_lmp_features_a_law_log_synchronous_data",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_cvsd_synchronous_data,
          { "CVSD Synchronous Data",                  "bthci_evt_lmp_features_cvsd_synchronous_data",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_paging_parameter_negotiation,
          { "Paging Parameter Negotiation",           "bthci_evt_lmp_features_paging_parameter_negotiation",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_power_control,
          { "Power Control",                          "bthci_evt_lmp_features_power_control",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_transparent_synchronous_data,
          { "Transparent Synchronous Data",           "bthci_evt_lmp_features_transparent_synchronous_data",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_flow_control_lag,
          { "Flow Control Lag",                       "bthci_evt_lmp_features_flow_control_lag",
            FT_UINT8, BASE_DEC, NULL, 0x70,
            NULL, HFILL }
        },
        { &hf_lmp_feature_broadcast_encryption,
          { "Broadband Encryption",                   "bthci_evt_lmp_features_broadcast_encryption",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_reserved_24,
          { "Reserved",                               "bthci_evt_lmp_features_reserved_24",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_edr_acl_2mbps_mode,
          { "EDR ACL 2 Mbps Mode",                    "bthci_evt_lmp_features_edr_acl_2mbps_mode",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_edr_acl_3mbps_mode,
          { "EDR ACL 3 Mbps Mode",                    "bthci_evt_lmp_features_edr_acl_3mbps_mode",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_enhanced_inquiry_scan,
          { "Enhanced Inquiry Scan",                  "bthci_evt_lmp_features_enhanced_inquiry_scan",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_interlaced_inquiry_scan,
          { "Interlaced Inquiry Scan",                "bthci_evt_lmp_features_interlaced_inquiry_scan",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_lmp_feature_interlaced_page_scan,
          { "Interlaced Page Scan",                   "bthci_evt_lmp_features_interlaced_page_scan",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_lmp_feature_rssi_with_inquiry_results,
          { "RSSI with Inquiry Results",              "bthci_evt_lmp_features_rssi_with_inquiry_results",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_lmp_feature_ev3_packets,
          { "EV3 Packets",                            "bthci_evt_lmp_features_ev3_packets",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_ev4_packets,
          { "EV4 Packets",                            "bthci_evt_lmp_features_ev4_packets",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_ev5_packets,
          { "EV5 Packets",                            "bthci_evt_lmp_features_ev5_packets",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_reserved_34,
          { "Reserved",                               "bthci_evt_lmp_features_reserved_34",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_afh_capable_slave,
          { "AFH Capable Slave",                      "bthci_evt_lmp_features_afh_capable_slave",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_afh_classification_slave,
          { "AFH Classification Slave",               "bthci_evt_lmp_features_afh_classification_slave",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_lmp_feature_br_edr_not_supported,
          { "BR/EDR Not Supported",                   "bthci_evt_lmp_features_br_edr_not_supported",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_lmp_feature_le_supported_controller,
          { "LE Supported Controller",                "bthci_evt_lmp_features_le_supported_controller",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_lmp_feature_3slot_edr_acl_packets,
          { "3-slot EDR ACL packets",                 "bthci_evt_lmp_features_3slot_edr_acl_packets",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_5slot_edr_acl_packets,
          { "5-slot EDR ACL packets",                 "bthci_evt_lmp_features_5slot_edr_acl_packets",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_sniff_subrating,
          { "Sniff Subrating",                        "bthci_evt_lmp_features_sniff_subrating",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_pause_encryption,
          { "Pause Encryption",                       "bthci_evt_lmp_features_pause_encryption",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_afh_capable_master,
          { "AFH Capable Master",                     "bthci_evt_lmp_features_afh_capable_master",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_afh_classification_master,
          { "AFH Classification Master",              "bthci_evt_lmp_features_afh_classification_master",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_lmp_feature_edr_esco_2mbps_mode,
          { "EDR eSCO 2 Mbps Mode",                   "bthci_evt_lmp_features_edr_esco_2mbps_mode",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_lmp_feature_edr_esco_3mbps_mode,
          { "EDR eSCO 3 Mbps Mode",                   "bthci_evt_lmp_features_edr_esco_3mbps_mode",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_lmp_feature_3slot_edr_esco_packets,
          { "3-slot EDR eSCO Packets",                "bthci_evt_lmp_features_3slot_edr_esco_packets",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_extended_inquiry_response,
          { "Extended Inquiry Response",              "bthci_evt_lmp_features_extended_inquiry_response",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_simultaneous_le_and_br_edr_controller,
          {"Simultaneous LE and BR/EDR to Same Device Capable Controller", "bthci_evt_lmp_features_simultaneous_le_and_br_edr_controller",
           FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL}
        },
        { &hf_lmp_feature_reserved_50,
          { "Reserved",                               "bthci_evt_lmp_features_reserved_50",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_secure_simple_pairing,
          { "Secure Simple Pairing",                  "bthci_evt_lmp_features_secure_simple_pairing",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_lmp_feature_encapsulated_pdu,
          { "Encapsulated PDU",                       "bthci_evt_lmp_features_encapsulated_pdu",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_lmp_feature_erroneous_data_reporting,
          { "Erroneous Data Reporting",               "bthci_evt_lmp_features_erroneous_data_reporting",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_lmp_feature_non_flushable_packet_boundary_flag,
          { "Non-flushable Packet Boundary Flag",     "bthci_evt_lmp_features_non_flushable_packet_boundary_flag",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_lmp_feature_reserved_55,
          { "Reserved",                               "bthci_evt_lmp_features_reserved_55",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_link_supervision_timeout_changed_event,
          { "Link Supervision Timeout Changed Event", "bthci_evt_lmp_features_supervision_timeout_changed_event",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_lmp_feature_inquiry_tx_power_level,
          { "Inquiry TX Power Level",                 "bthci_evt_lmp_features_inquiry_tx_power_level",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_lmp_feature_enhanced_power_control,
          { "Enhanced Power Control",                 "bthci_evt_lmp_features_enhanced_power_control",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_lmp_feature_reserved_59_62,
          { "Reserved",                               "bthci_evt_lmp_features_reserved_59_62",
            FT_BOOLEAN, 8, NULL, 0x78,
            NULL, HFILL }
        },
        { &hf_lmp_feature_extended_features,
          { "Extended Features",                      "bthci_evt_lmp_features_extended_features",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_lmp_feature_secure_simple_pairing_host,
          {"Secure Simple Pairing Host",              "bthci_evt_lmp_features_secure_simple_pairing_host",
           FT_BOOLEAN, 8, NULL, 0x01,
           NULL, HFILL}
        },
        { &hf_lmp_feature_le_supported_host,
          {"LE Supported Host",                            "bthci_evt_lmp_features_le_supported_host",
           FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL}
        },
        { &hf_lmp_feature_simultaneous_le_and_br_edr_host,
          {"Simultaneous LE and BR/EDR to Same Device Capable Host", "bthci_evt_lmp_features_simultaneous_le_and_br_edr_host",
           FT_BOOLEAN, 8, NULL, 0x04,
           NULL, HFILL}
        },
        { &hf_lmp_feature_secure_connections_host,
          {"Secure Connections Host", "bthci_evt_lmp_features_secure_connections_host",
           FT_BOOLEAN, 8, NULL, 0x08,
           NULL, HFILL}
        },
        { &hf_lmp_feature_reserved_68_71,
          {"Reserved",                                "bthci_evt_lmp_features_reserved_68_71",
           FT_UINT8, BASE_HEX, NULL, 0xF0,
           NULL, HFILL}
        },
        { &hf_lmp_feature_csb_master_operation,
          {"Connectionless Slave Broadcast Master Operation",   "bthci_evt_lmp_features_csb_master_operation",
           FT_BOOLEAN, 8, NULL, 0x01,
           NULL, HFILL}
        },
        { &hf_lmp_feature_csb_slave_operation,
          {"Connectionless Slave Broadcast Slave Operation",    "bthci_evt_lmp_features_csb_slave_operation",
           FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL}
        },
        { &hf_lmp_feature_synchronization_train,
          {"Synchronization Train",             "bthci_evt_lmp_features_synchronization_train",
           FT_BOOLEAN, 8, NULL, 0x04,
           NULL, HFILL}
        },
        { &hf_lmp_feature_synchronization_scan,
          {"Synchronization Scan",              "bthci_evt_lmp_features_synchronization_scan",
           FT_BOOLEAN, 8, NULL, 0x08,
           NULL, HFILL}
        },
        { &hf_lmp_feature_inquiry_response_notification_event,
          {"Inquiry Response Notification Event", "bthci_evt_lmp_features_inquiry_response_notification_event",
           FT_BOOLEAN, 8, NULL, 0x10,
           NULL, HFILL}
        },
        { &hf_lmp_feature_generalized_interlaced_scan,
          {"Generalized Interlaced Scan",       "bthci_evt_lmp_features_generalized_interlaced_scan",
           FT_BOOLEAN, 8, NULL, 0x20,
           NULL, HFILL}
        },
        { &hf_lmp_feature_coarse_clock_adjustment,
          {"Coarse Clock Adjustment",           "bthci_evt_lmp_features_coarse_clock_adjustment",
           FT_BOOLEAN, 8, NULL, 0x40,
           NULL, HFILL}
        },
        { &hf_lmp_feature_reserved_135,
          {"Reserved",                          "bthci_evt_lmp_features_reserved_135",
           FT_BOOLEAN, 8, NULL, 0x80,
           NULL, HFILL}
        },
        { &hf_lmp_feature_secure_connections_controller,
          {"Secure Connections Controller",     "bthci_evt_lmp_features_secure_connections_controller",
           FT_BOOLEAN, 8, NULL, 0x01,
           NULL, HFILL}
        },
        { &hf_lmp_feature_ping,
          {"Ping",                              "bthci_evt_lmp_features_ping",
           FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL}
        },
        { &hf_lmp_feature_reserved_138,
          {"Reserved",                          "bthci_evt_lmp_features_reserved_138",
           FT_BOOLEAN, 8, NULL, 0x04,
           NULL, HFILL}
        },
        { &hf_lmp_feature_train_nudging,
          {"Train Nudging",                     "bthci_evt_lmp_features_train_nudging",
           FT_BOOLEAN, 8, NULL, 0x08,
           NULL, HFILL}
        },
        { &hf_lmp_feature_slot_availability_mask,
          {"Slot Availability Mask",            "bthci_evt_lmp_features_slot_availability_mask",
           FT_BOOLEAN, 8, NULL, 0x10,
           NULL, HFILL}
        },
        { &hf_lmp_feature_reserved,
          {"Reserved",                          "bthci_evt_lmp_features_reserved",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_num_keys,
          { "Number of Link Keys",        "bthci_evt_num_keys",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "Number of Link Keys contained", HFILL }
        },
        { &hf_bthci_evt_num_keys_read,
          { "Number of Link Keys Read",        "bthci_evt_num_keys_read",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_keys_deleted,
          { "Number of Link Keys Deleted",        "bthci_evt_num_keys_deleted",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_keys_written,
          { "Number of Link Keys Written",        "bthci_evt_num_keys_written",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_num_keys,
          { "Max Num Keys",        "bthci_evt_max_num_keys",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            "Total Number of Link Keys that the Host Controller can store", HFILL }
        },
        { &hf_bthci_evt_num_responses,
          { "Number of responses",        "bthci_evt_num_responses",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "Number of Responses from Inquiry", HFILL }
        },
        { &hf_bthci_evt_link_policy_setting_switch,
          { "Enable Master Slave Switch", "bthci_evt_link_policy_switch",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_bthci_evt_link_policy_setting_hold,
          { "Enable Hold Mode", "bthci_evt_link_policy_hold",
            FT_BOOLEAN, 16, NULL, 0x0002,
            NULL, HFILL }
        },
        { &hf_bthci_evt_link_policy_setting_sniff,
          { "Enable Sniff Mode", "bthci_evt_link_policy_sniff",
            FT_BOOLEAN, 16, NULL, 0x0004,
            NULL, HFILL }
        },
        { &hf_bthci_evt_link_policy_setting_park,
          { "Enable Park Mode", "bthci_evt_link_policy_park",
            FT_BOOLEAN, 16, NULL, 0x0008,
            NULL, HFILL }
        },
        ...
        { &hf_bthci_evt_host_total_num_sco_data_packets,
          {"Host Total Num SCO Data Packets", "bthci_evt_max_data_num_sco",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           "Total Number of HCI SCO Data Packets that can be stored in the data buffers of the Host", HFILL }
        },
        { &hf_bthci_evt_page_number,
          {"Page Number", "bthci_evt_page_number",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_max_page_number,
          {"Max. Page Number", "bthci_evt_max_page_number",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_local_supported_cmds,
          { "Local Supported Commands",        "bthci_evt_local_supported_cmds",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_fec_required,
          {"FEC Required", "bthci_evt_fec_required",
           FT_BOOLEAN, 8, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_err_data_reporting,
          {"Erroneous Data Reporting", "bthci_evt_err_data_reporting",
           FT_UINT8, BASE_DEC, VALS(evt_enable_values), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_scan_type,
          {"Scan Type", "bthci_evt_inq_scan_type",
           FT_UINT8, BASE_DEC, VALS(evt_scan_types), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_inq_mode,
          {"Inquiry Mode", "bthci_evt_inq_mode",
           FT_UINT8, BASE_DEC, VALS(bthci_cmd_inq_modes), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_power_level_type,
          {"Type", "bthci_evt_power_level_type",
           FT_UINT8, BASE_HEX, VALS(evt_power_level_types), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_sync_link_type,
          {"Link Type", "bthci_evt_sync_link_type",
           FT_UINT8, BASE_HEX, VALS(evt_sync_link_types), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_sync_tx_interval,
          {"Transmit Interval", "bthci_evt_sync_tx_interval",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_le_local_p_256_public_key,
          { "Local-256_Public_Key", "bthci_evt_le_local_p_256_public_key",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_dhkey,
          { "DHKey", "bthci_evt_dhkey",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sync_rtx_window,
          {"Retransmit Window", "bthci_evt_sync_rtx_window",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_sync_rx_packet_length,
          {"Rx Packet Length", "bthci_evt_sync_rx_pkt_len",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_sync_tx_packet_length,
          {"Tx Packet Length", "bthci_evt_sync_tx_pkt_len",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_air_mode,
          {"Air Mode", "bthci_evt_air_mode",
           FT_UINT8, BASE_DEC, VALS(evt_air_mode_vals), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_max_tx_latency,
          {"Max. Tx Latency", "bthci_evt_max_tx_latency",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_max_rx_latency,
          {"Max. Rx Latency", "bthci_evt_max_rx_latency",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_min_remote_timeout,
          {"Min. Remote Timeout", "bthci_evt_min_remote_timeout",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_min_local_timeout,
          {"Min. Local Timeout", "bthci_evt_min_local_timeout",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_link_supervision_timeout,
          {"Link Supervision Timeout", "bthci_evt_link_supervision_timeout",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_token_bucket_size,
          { "Token Bucket Size",        "bthci_evt_token_bucket_size",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "Token Bucket Size (bytes)", HFILL }
        },
        { &hf_bthci_evt_flow_direction,
          {"Flow Direction", "bthci_evt_flow_direction",
           FT_UINT8, BASE_DEC, VALS(evt_flow_direction_values), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_afh_ch_assessment_mode,
          {"AFH Channel Assessment Mode", "bthci_evt_afh_ch_assessment_mode",
           FT_UINT8, BASE_DEC, VALS(evt_enable_values), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_lmp_handle,
          { "LMP Handle",             "bthci_evt_lmp_handle",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_clock,
          { "Clock",        "bthci_evt_clock",
            FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_clock_accuracy,
          { "Clock",        "bthci_evt_clock_accuracy",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_afh_mode,
          {"AFH Mode", "bthci_evt_afh_mode",
           FT_UINT8, BASE_DEC, VALS(evt_enable_values), 0x0,
           NULL, HFILL}
        },
/* TODO: More detailed dissection */
        { &hf_bthci_evt_afh_channel_map,
          {"AFH Channel Map", "bthci_evt_afh_channel_map",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_simple_pairing_mode,
          {"Simple Pairing Mode", "bthci_evt_simple_pairing_mode",
           FT_UINT8, BASE_DEC, VALS(evt_enable_values), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_hash_c,
          {"Hash C", "bthci_evt_hash_c",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_randomizer_r,
          {"Randomizer R", "bthci_evt_randomizer_r",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_io_capability,
          {"IO Capability", "bthci_evt_io_capability",
           FT_UINT8, BASE_HEX, VALS(bthci_cmd_io_capability_vals), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_oob_data_present,
          {"OOB Data Present", "bthci_evt_oob_data_present",
           FT_UINT8, BASE_DEC, VALS(bthci_cmd_oob_data_present_vals), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_auth_requirements,
          {"Authentication Requirements", "bthci_evt_auth_requirements",
           FT_UINT8, BASE_DEC|BASE_EXT_STRING, &bthci_cmd_auth_req_vals_ext, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_numeric_value,
          {"Numeric Value", "bthci_evt_numeric_value",
           FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_passkey,
          {"Passkey", "bthci_evt_passkey",
           FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_notification_type,
          {"Notification Type", "bthci_evt_notification_type",
           FT_UINT8, BASE_DEC, VALS(bthci_cmd_notification_types), 0x0,
           NULL, HFILL}
        },
        { &hf_bthci_evt_data_length,
          { "Data Length",           "bthci_evt_data_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_location_domain_aware,
          { "Location Domain Aware", "bthci_evt_location_domain_aware",
            FT_BOOLEAN, 8, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_location_domain,
          { "Location Domain", "bthci_evt_location_domain",
            FT_STRING, BASE_NONE, NULL, 0x0,
            "ISO 3166-1 Country Code", HFILL }
        },
        { &hf_bthci_evt_location_domain_options,
          { "Location Domain Options", "bthci_evt_location_domain_options",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_location_options,
          { "Location Options", "bthci_evt_location_options",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_flow_control_mode,
          { "Flow Control Mode", "bthci_evt_flow_control_mode",
            FT_UINT8, BASE_HEX, VALS(evt_flow_ctrl_mode), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_physical_link_handle,
          { "Physical Link Handle", "bthci_evt_physical_link_handle",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_flow_spec_identifier,
          { "Flow Spec Identifier", "bthci_evt_flow_spec_id",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_logical_link_handle,
          { "Logical Link Handle", "bthci_evt_logical_link_handle",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_max_acl_data_packet_length,
          { "Max. ACL Data Packet Length", "bthci_evt_max_acl_data_packet_length",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_data_block_length,
          { "Max. Data Block Length", "bthci_evt_data_block_length",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_total_num_data_blocks,
          { "Total Number of Data Blocks", "bthci_evt_total_num_data_blocks",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_enc_key_size,
          { "Encryption Key Size", "bthci_evt_enc_key_size",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_amp_remaining_assoc_length,
          { "AMP Remaining Assoc Length", "bthci_evt_amp_remaining_assoc_length",
            FT_UINT16, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_amp_assoc_fragment,
          { "AMP Assoc Fragment", "bthci_evt_amp_assoc_fragment",
            FT_BYTES, BASE_NONE, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_amp_status,
          { "AMP Status", "bthci_evt_amp_status",
            FT_UINT8, BASE_HEX, VALS(evt_amp_status), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_total_bandwidth,
          { "Total Bandwidth (kbps)", "bthci_evt_total_bandwidth",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_guaranteed_bandwidth,
          { "Max Guaranteed Bandwidth (kbps)", "bthci_evt_max_guaranteed_bandwidth",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_min_latency,
          { "Min Latency (us)", "bthci_evt_min_latency",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_pdu_size,
          { "Max PDU Size", "bthci_evt_max_pdu_size",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_amp_controller_type,
          { "Controller Type", "bthci_evt_controller_type",
            FT_UINT8, BASE_HEX, VALS(bthci_evt_controller_types), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pal_capabilities_00,
          { "Guaranteed Service",        "bthci_evt_pal_capabilities",
            FT_BOOLEAN, 16, NULL, 0x0001,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_amp_assoc_length,
          { "Max AMP Assoc Length", "bthci_evt_max_amp_assoc_length",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_flush_to_us,
          { "Max Flush Timeout (us)", "bthci_evt_max_flush_to",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_best_effort_flush_to_us,
          { "Best Effort Flush Timeout (us)", "bthci_evt_best_effort_flush_to",
            FT_UINT32, BASE_DEC, 0x0, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_link_loss_reason,
          { "Reason", "bthci_evt_link_loss_reason",
            FT_UINT8, BASE_HEX, VALS(evt_link_loss_reasons), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_compl_blocks,
          { "Number Of Completed Blocks", "bthci_evt_num_compl_blocks",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_test_scenario,
          { "Test Scenario", "bthci_evt_test_scenario",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_report_reason,
          { "Reason", "bthci_evt_report_reason",
            FT_UINT8, BASE_HEX, VALS(evt_report_reasons), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_report_event_type,
          { "Report Event Type", "bthci_evt_report_event_type",
            FT_UINT8, BASE_HEX, VALS(evt_report_event_types), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_frames,
          { "Number Of Frames", "bthci_evt_num_frames",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_error_frames,
          { "Number Of Error Frames", "bthci_evt_num_error_frames",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_bits,
          { "Number Of Bits", "bthci_evt_num_bits",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_error_bits,
          { "Number Of Error Bits", "bthci_evt_num_error_bits",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_short_range_mode_state,
          { "Short Range Mode State",        "bthci_evt_short_range_mode_state",
            FT_BOOLEAN, 8, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_gfsk,
          { "Transmit Power Level GFSK (dBm)", "bthci_evt_transmit_power_level_gfsk",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_dqpsk,
          { "Transmit Power Level DQPSK (dBm)", "bthci_evt_transmit_power_level_dqpsk",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_8dpsk,
          { "Transmit Power Level 8DPSK (dBm)", "bthci_evt_transmit_power_level_8dpsk",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_flush_to_us,
          { "Flush Timeout (us)",  "bthci_evt_flushto",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_supported_host,
          { "LE Supported Host", "bthci_evt_le_supported_host",
            FT_BOOLEAN, 8, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_simultaneous_host,
          { "Simultaneous LE Host", "bthci_evt_le_simultaneous_host",
            FT_BOOLEAN, 8, NULL, 0x0,
            "Support for both LE and BR/EDR to same device", HFILL }
        },
        { &hf_bthci_evt_le_acl_data_pkt_len,
          { "LE ACL Data Packet Length", "bthci_evt_le_acl_data_pkt_len",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_total_num_le_acl_data_pkts,
          { "Total Number LE ACL Data Packets", "bthci_evt_le_total_num_acl_data_pkts",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_iso_data_pkt_len,
          { "ISO Data Packet Length", "bthci_evt_iso_data_pkt_len",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_total_num_iso_data_pkts,
          { "Total Number ISO Data Packets", "bthci_evt_total_num_iso_data_pkts",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_white_list_size,
          { "White List Size",        "bthci_evt_le_white_list_size",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "Max. total whitelist entries storable in controller", HFILL }
        },
        { &hf_bthci_evt_le_channel_map,
          { "Channel Map", "bthci_evt_le_channel_map",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_encrypted_data,
          { "Plaintext",        "bthci_evt_le_encrypted_data",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_random_number,
          { "Random Number",        "bthci_evt_le_random_number",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_num_packets,
          { "Number of Packets",        "bthci_evt_le_num_packets",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_meta_subevent,
          { "Sub Event",        "bthci_evt_le_meta_subevent",
            FT_UINT8, BASE_HEX, VALS(evt_le_meta_subevent), 0x00,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_peer_address_type,
          { "Peer Address Type", "bthci_evt_le_peer_address_type",
            FT_UINT8, BASE_HEX, VALS(bthci_cmd_address_types_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_local_rpa,
          { "Local Resolvable Private Address",          "bthci_evt_le_local_rpa",
            FT_ETHER, BASE_NONE, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_le_peer_rpa,
          { "Peer Resolvable Private Address",          "bthci_evt_le_peer_rpa",
            FT_ETHER, BASE_NONE, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_le_con_interval,
          { "Connection Interval", "bthci_evt_le_con_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_min_interval,
          { "Min Connection Interval", "bthci_evt_le_min_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_max_interval,
          { "Min Connection Interval", "bthci_evt_le_max_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_con_latency,
          { "Connection Latency", "bthci_evt_le_con_latency",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_number_events, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_supervision_timeout,
          { "Supervision Timeout", "bthci_evt_le_supv_timeout",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_max_tx_octets,
          { "Max TX Octets", "bthci_evt_max_tx_octets",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_max_tx_time,
          { "Max TX Time", "bthci_evt_max_tx_time",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_max_rx_octets,
          { "Max RX Octets", "bthci_evt_max_rx_octets",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_max_rx_time,
          { "Max RX Time", "bthci_evt_max_rx_time",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_encrypted_diversifier,
          { "Encrypted Diversifier", "bthci_evt_le_encrypted_diversifier",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_master_clock_accuracy,
          { "Master Clock Accuracy", "bthci_evt_le_master_clock_accuracy",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_clock_accuray_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_reports,
          { "Num Reports", "bthci_evt_le_num_reports",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_advts_event_type,
          { "Event Type", "bthci_evt_le_advts_event_type",
            FT_UINT8, BASE_HEX, VALS(evt_le_advertising_evt_types), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type,
          { "Event Type", "bthci_evt_le_ext_advts_event_type",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states,
          { "Supported LE States", "bthci_evt_le_states",
            FT_NONE, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_00,
          { "Non-connectable Advertising State", "bthci_evt_le_states_00",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_01,
          { "Scannable Advertising State", "bthci_evt_le_states_01",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_02,
          { "Connectable Advertising State", "bthci_evt_le_states_02",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_03,
          { "Directed Advertising State", "bthci_evt_le_states_03",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_04,
          { "Passive Scanning State", "bthci_evt_le_states_04",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_05,
          { "Active Scanning State", "bthci_evt_le_states_05",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_06,
          { "Initiating State. Connection State in Master Role", "bthci_evt_le_states_06",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_07,
          { "Connection State in Slave Role", "bthci_evt_le_states_07",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_10,
          { "Non-connectable Advertising State and Passive Scanning State combination", "bthci_evt_le_states_10",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_11,
          { "Scannable Advertising State and Passive Scanning State combination", "bthci_evt_le_states_11",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_12,
          { "Connectable Advertising State and Passive Scanning State combination", "bthci_evt_le_states_12",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_13,
          { "Directed Advertising State and Passive Scanning State combination", "bthci_evt_le_states_13",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_14,
          { "Non-connectable Advertising State and Active Scanning State combination", "bthci_evt_le_states_14",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_15,
          { "Scannable Advertising State and Active Scanning State combination", "bthci_evt_le_states_15",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_16,
          { "Connectable Advertising State and Active Scanning State combination", "bthci_evt_le_states_16",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_17,
          { "Directed Advertising State and Active Scanning State combination", "bthci_evt_le_states_17",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_20,
          { "Non-connectable Advertising State and Initiating State combination", "bthci_evt_le_states_20",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_21,
          { "Scannable Advertising State and Initiating State combination", "bthci_evt_le_states_21",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_22,
          { "Non-connectable Advertising State and Master Role combination", "bthci_evt_le_states_22",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_23,
          { "Scannable Advertising State and Master Role combination", "bthci_evt_le_states_23",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_24,
          { "Non-connectable Advertising State and Slave Role combination", "bthci_evt_le_states_24",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_25,
          { "Scannable Advertising State and Slave Role combination", "bthci_evt_le_states_25",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_26,
          { "Passive Scanning State and Initiating State combination", "bthci_evt_le_states_26",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_27,
          { "Active Scanning State and Initiating State combination", "bthci_evt_le_states_27",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_30,
          { "Passive Scanning State and Master Role combination", "bthci_evt_le_states_30",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_31,
          { "Active Scanning State and Master Role combination", "bthci_evt_le_states_31",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_32,
          { "Passive Scanning state and Slave Role combination", "bthci_evt_le_states_32",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_33,
          { "Active Scanning state and Slave Role combination", "bthci_evt_le_states_33",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_states_34,
          { "Initiating State and Master Role combination. Master Role and Master Role combination", "bthci_evt_le_states_34",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_changed_in_frame,
            { "Change in Frame",                              "bthci_evt_change_in_frame",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_command_in_frame,
            { "Command in frame",                "bthci_evt_command_in_frame",
            FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_REQUEST), 0x0,
            NULL, HFILL }
        },
        { &hf_pending_in_frame,
            { "Pending in frame",                "bthci_evt_pending_in_frame",
            FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_RESPONSE), 0x0,
            NULL, HFILL }
        },
        { &hf_response_in_frame,
            { "Response in frame",               "bthci_evt_response_in_frame",
            FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_RESPONSE), 0x0,
            NULL, HFILL }
        },
        { &hf_command_response_time_delta,
            { "Command-Response Delta",          "bthci_evt_command_response_delta",
            FT_DOUBLE, BASE_NONE|BASE_UNIT_STRING, &units_milliseconds, 0x00,
            NULL, HFILL }
        },
        { &hf_command_pending_time_delta,
            { "Command-Pending Delta",          "bthci_evt_command_pending_delta",
            FT_DOUBLE, BASE_NONE|BASE_UNIT_STRING, &units_milliseconds, 0x00,
            NULL, HFILL }
        },
        { &hf_pending_response_time_delta,
            { "Pending-Response Delta",          "bthci_evt_pending_response_delta",
            FT_DOUBLE, BASE_NONE|BASE_UNIT_STRING, &units_milliseconds, 0x00,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features,
          { "Supported LE Features",                       "bthci_evt_le_features",
            FT_UINT64, BASE_HEX, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_encryption,
          { "LE Encryption",                               "bthci_evt_le_features_encryption",
            FT_BOOLEAN, 64, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_connection_parameters_request_procedure,
          { "Connection Parameters Request Procedure",     "bthci_evt_le_features_connection_parameters_request_procedure",
            FT_BOOLEAN, 64, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_extended_reject_indication,
          { "Extended Reject Indication",                  "bthci_evt_le_features_extended_reject_indication",
            FT_BOOLEAN, 64, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_slave_initiated_features_exchange,
          { "Slave-Initiated Features Exchange",           "bthci_evt_le_features_slave_initiated_features_exchange",
            FT_BOOLEAN, 64, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_ping,
          { "Ping",                                        "bthci_evt_le_features_ping",
            FT_BOOLEAN, 64, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_data_packet_length_extension,
          { "Data Packet Length Extension",                "bthci_evt_le_features_data_packet_length_extension",
            FT_BOOLEAN, 64, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_ll_privacy,
          { "LL Privacy",                                  "bthci_evt_le_features_ll_privacy",
            FT_BOOLEAN, 64, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_extended_scanner_filter_policies,
          { "Extended Scanner Filter Policies",            "bthci_evt_le_features_extended_scanner_filter_policies",
            FT_BOOLEAN, 64, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_2m_phy,
          { "LE 2M PHY",            "bthci_evt_le_features_2m_phy",
            FT_BOOLEAN, 64, NULL, 0x100,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_stable_modulation_index_tx,
          { "Stable Modulation Index - Tx",            "bthci_evt_le_features_stable_modulation_index_tx",
            FT_BOOLEAN, 64, NULL, 0x200,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_stable_modulation_index_rx,
          { "Stable Modulation Index - Rx",            "bthci_evt_le_features_stable_modulation_index_rx",
            FT_BOOLEAN, 64, NULL, 0x400,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_coded_phy,
          { "LE Coded PHY",            "bthci_evt_le_features_coded_phy",
            FT_BOOLEAN, 64, NULL, 0x800,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_extended_advertising,
          { "LE Extended Advertising",           "bthci_evt_le_features_extended_advertising",
            FT_BOOLEAN, 64, NULL, 0x1000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_periodic_advertising,
          { "LE Periodic Advertising",           "bthci_evt_le_features_periodic_advertising",
            FT_BOOLEAN, 64, NULL, 0x2000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_channel_selection_algorithm_2,
          { "Channel Selection Algorithm #2",    "bthci_evt_le_features_channel_selection_algorithm_2",
            FT_BOOLEAN, 64, NULL, 0x4000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_power_class_1,
          { "Power Class 1",                     "bthci_evt_le_features_power_class_1",
            FT_BOOLEAN, 64, NULL, 0x8000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_minimum_number_of_used_channels_procedure,
          { "Minimum Number of Used Channels Procedure", "bthci_evt_le_features_minimum_number_of_used_channels_procedure",
            FT_BOOLEAN, 64, NULL, 0x10000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_connection_cte_request,
          { "Connection CTE Request", "bthci_evt_le_features_connection_cte_request",
            FT_BOOLEAN, 64, NULL, 0x20000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_connection_cte_response,
          { "Connection CTE Response", "bthci_evt_le_features_connection_cte_response",
            FT_BOOLEAN, 64, NULL, 0x40000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_connectionless_cte_tx,
          { "Connectionless CTE Tx", "bthci_evt_le_features_connectionless_cte_tx",
            FT_BOOLEAN, 64, NULL, 0x80000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_connectionless_cte_rx,
          { "Connectionless CTE Rx", "bthci_evt_le_features_connectionless_cte_rx",
            FT_BOOLEAN, 64, NULL, 0x100000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_antenna_switching_during_cte_tx_aod,
          { "Antenna Switching During CTE Tx (AoD)", "bthci_evt_le_features_antenna_switching_during_cte_tx_aod",
            FT_BOOLEAN, 64, NULL, 0x200000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_antenna_switching_during_cte_rx_aoa,
          { "Antenna Switching During CTE Rx (AoA)", "bthci_evt_le_features_antenna_switching_during_cte_rx_aoa",
            FT_BOOLEAN, 64, NULL, 0x400000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_receiving_cte,
          { "Receiving CTE", "bthci_evt_le_features_receiving_cte",
            FT_BOOLEAN, 64, NULL, 0x800000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_periodic_advertising_sync_transfer_sender,
          { "Periodic Advertising Sync Transfer - Sender", "bthci_evt_le_features_periodic_advertising_sync_transfer_sender",
            FT_BOOLEAN, 64, NULL, 0x1000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_periodic_advertising_sync_transfer_receiver,
          { "Periodic Advertising Sync Transfer - Receiver", "bthci_evt_le_features_periodic_advertising_sync_transfer_receiver",
            FT_BOOLEAN, 64, NULL, 0x2000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_sleep_clock_accuracy_updates,
          { "Sleep Clock Accuracy Updates", "bthci_evt_le_features_sleep_clock_accuracy_updates",
            FT_BOOLEAN, 64, NULL, 0x4000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_remote_public_key_validation,
          { "Remote Public Key Validation", "bthci_evt_le_features_remote_public_key_validation",
            FT_BOOLEAN, 64, NULL, 0x8000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_cis_master,
          { "Connected Isochronous Stream - Master", "bthci_evt_le_features_cis_master",
            FT_BOOLEAN, 64, NULL, 0x10000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_cis_slave,
          { "Connected Isochronous Stream - Slave", "bthci_evt_le_features_cis_slave",
            FT_BOOLEAN, 64, NULL, 0x20000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_isochronous_broadcaster,
          { "Isochronous Broadcaster", "bthci_evt_le_features_isochronous_broadcaster",
            FT_BOOLEAN, 64, NULL, 0x40000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_synchronized_receiver,
          { "Synchronized Receiver", "bthci_evt_le_features_synchronized_receiver",
            FT_BOOLEAN, 64, NULL, 0x80000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_isochronous_channels_host_support,
          { "Isochronous Channels (Host_support)", "bthci_evt_le_features_isochronous_channels_host_support",
            FT_BOOLEAN, 64, NULL, 0x100000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_power_control_request,
          { "Power Control Request", "bthci_evt_le_features_power_control_request",
            FT_BOOLEAN, 64, NULL, 0x200000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_power_change_indication,
          { "Power Change Indication", "bthci_evt_le_features_power_change_indication",
            FT_BOOLEAN, 64, NULL, 0x400000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_path_loss_monitoring,
          { "Path Loss Monitoring", "bthci_evt_le_features_path_loss_monitoring",
            FT_BOOLEAN, 64, NULL, 0x800000000,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_features_reserved,
            { "Reserved",                                  "bthci_evt_le_features_reserved",
            FT_UINT64, BASE_HEX, NULL, G_GUINT64_CONSTANT(0xFFFFFFF000000000),
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_number_of_transports,
          { "Number of Transports",                        "bthci_evt_mws_number_of_transports",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_transport_layers,
          { "Transport Layers",                            "bthci_evt_mws_transport_layers",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_transport_layers_item,
          { "Transport Layer Item",                        "bthci_evt_mws_transport_layers_item",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_transport_layer,
          { "Transport Layer",                             "bthci_evt_mws_transport_layers_item_transport_layer",
            FT_UINT8, BASE_HEX, VALS(bthci_evt_mws_transport_layer_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_number_of_baud_rates,
          { "Number of Baud Rates",                        "bthci_evt_mws_number_of_baud_rates",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_to_mws_baud_rates,
          { "To MWS Baud Rates",                           "bthci_evt_mws_to_mws_baud_rates",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_to_mws_baud_rates_tranport_item,
          { "To MWS Baud Rates Item",                      "bthci_evt_mws_to_mws_baud_rates_item",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_to_mws_baud_rate,
          { "To MWS Baud Rate",                            "bthci_evt_mws_to_mws_baud_rates_item_baud_rate",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_from_mws_baud_rates,
          { "From MWS Baud Rates",                         "bthci_evt_mws_from_mws_baud_rates",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_from_mws_baud_rates_tranport_item,
          { "From MWS Baud Rates Item",                    "bthci_evt_mws_from_mws_baud_rates_item",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_from_mws_baud_rate,
          { "From MWS Baud Rate",                          "bthci_evt_mws_from_mws_baud_rates_item_baud_rate",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_selected_tx_power,
          { "Selected TX Power (dBm)",                     "bthci_evt_transmit_power_level",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_which_clock,
          { "Which Clock",                                 "bthci_evt_which_clock",
            FT_UINT8, BASE_HEX, VALS(which_clock_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_slot_offset,
          { "Slot Offset",                                 "bthci_evt_slot_offset",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_clock_offset_32,
          { "Clock Offset",                                "bthci_evt_clock_offset_32",
        ...
        { &hf_bthci_evt_next_broadcast_instant,
          { "Next Broadcast Instant",                      "bthci_evt_next_broadcast_instant",
            FT_UINT32, BASE_HEX, NULL, 0x0FFFFFFF,
            "CLK of a future broadcast on this channel", HFILL }
        },
        { &hf_bthci_evt_lt_addr,
          { "LT_ADDR",                                     "bthci_evt_lt_addr",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_connectionless_slave_broadcast_interval,
          { "Connectionless Slave Broadcast Interval",     "bthci_evt_connectionless_slave_broadcast_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_service_data,
          { "Service Data",                                "bthci_evt_service_data",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_local_sam_index,
          { "Local SAM Index",                  "bthci_evt_local_sam_index",
            FT_UINT8, BASE_HEX|BASE_SPECIAL_VALS, VALS(unique_sam_disabled), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_local_sam_tx_availability,
          { "Local SAM Tx Availability",        "bthci_evt_local_sam_tx_availability",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_local_sam_rx_availability,
          { "Local SAM Rx Availability",        "bthci_evt_local_sam_rx_availability",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_remote_sam_index,
          { "Remote SAM Index",                 "bthci_evt_remote_sam_index",
            FT_UINT8, BASE_HEX|BASE_SPECIAL_VALS, VALS(unique_sam_disabled), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_remote_sam_tx_availability,
          { "Remote SAM Tx Availability",       "bthci_evt_remote_sam_tx_availability",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_remote_sam_rx_availability,
          { "Remote SAM Rx Availability",       "bthci_evt_remote_sam_rx_availability",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_receive_status,
          { "Receive Status",                              "bthci_evt_receive_status",
            FT_UINT8, BASE_HEX, VALS(receive_status_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_fragment,
          { "Fragment",                                    "bthci_evt_fragment",
        ...
        { &hf_bthci_evt_le_number_of_reports,
          { "Number of Reports",                           "bthci_evt_number_of_reports",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_report,
          { "Report",                                      "bthci_evt_report",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_event_type,
          { "Event Type",                           "bthci_evt_event_type",
            FT_UINT8, BASE_HEX, VALS(event_type_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_direct_bd_addr,
          { "Direct BD_ADDR",          "bthci_evt_direct_bd_addr",
            FT_ETHER, BASE_NONE, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_bthci_evt_le_direct_address_type,
          { "Direct Address Type", "bthci_evt_le_direct_address_type",
            FT_UINT8, BASE_HEX, VALS(bthci_cmd_address_types_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_address_type,
          { "Address Type", "bthci_evt_le_address_type",
            FT_UINT8, BASE_HEX, VALS(bthci_cmd_address_types_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_rssi,
          { "RSSI (dBm)", "bthci_evt_le_rssi",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_tx_phy,
          { "Tx PHY", "bthci_evt_le_tx_phy",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_le_phy_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_le_rx_phy,
          { "Rx PHY", "bthci_evt_le_rx_phy",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_le_phy_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_adv_data_length,
          { "Maximum Advertising Data Length", "bthci_evt_max_adv_data_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_supported_adv_sets,
          { "Number of Supported Advertising Sets", "bthci_evt_num_supported_adv_sets",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_number_of_supported_codecs,
          { "Number of Supported Codecs", "bthci_evt_number_of_supported_codecs",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_number_of_supported_vendor_codecs,
          { "Number of Supported Vendor Codecs", "bthci_evt_number_of_supported_vendor_codecs",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_codecs,
          { "Vendor Codecs", "bthci_evt_codecs",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_vendor_codecs,
          { "Vendor Codecs", "bthci_evt_vendor_codecs",
            FT_NONE, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_vendor_codecs_item,
          { "Item", "bthci_evt_vendor_codecs_item",
            FT_STRING, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_codec_id,
          { "Codec", "bthci_evt_codec_id",
            FT_UINT8, BASE_HEX, VALS(bthci_evt_codec_id_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_vendor_codec_id,
          { "Vendor Codec ID", "bthci_evt_vendor_codecs_item_codec_id",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_rx_priority_assert_offset,
          { "Bluetooth Rx Priority Assert Offset", "bthci_evt_mws_bt_rx_priority_assert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_rx_priority_assert_jitter,
          { "Bluetooth Rx Priority Assert Jitter", "bthci_evt_mws_bt_rx_priority_assert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_rx_priority_deassert_offset,
          { "Bluetooth Rx Priority Deassert Offset", "bthci_evt_mws_bt_rx_priority_deassert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_rx_priority_deassert_jitter,
          { "Bluetooth Rx Priority Deassert Jitter", "bthci_evt_mws_bt_rx_priority_deassert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_tx_priority_assert_offset,
          { "Bluetooth Tx Priority Assert Offset", "bthci_evt_mws_bt_tx_priority_assert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_tx_priority_assert_jitter,
          { "Bluetooth Tx Priority Assert Jitter", "bthci_evt_mws_bt_tx_priority_assert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_tx_priority_deassert_offset,
          { "Bluetooth Tx Priority Deassert Offset", "bthci_evt_mws_bt_tx_priority_deassert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_bt_tx_priority_deassert_jitter,
          { "Bluetooth Tx Priority Deassert Jitter", "bthci_evt_mws_bt_tx_priority_deassert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_rx_priority_assert_offset,
          { "802 Rx Priority Assert Offset", "bthci_evt_mws_802_rx_priority_assert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_rx_priority_assert_jitter,
          { "802 Rx Priority Assert Jitter", "bthci_evt_mws_802_rx_priority_assert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_rx_priority_deassert_offset,
          { "802 Rx Priority Deassert Offset", "bthci_evt_mws_802_rx_priority_deassert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_rx_priority_deassert_jitter,
          { "802 Rx Priority Deassert Jitter", "bthci_evt_mws_802_rx_priority_deassert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_tx_priority_assert_offset,
          { "802 Tx Priority Assert Offset", "bthci_evt_mws_802_tx_priority_assert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_tx_priority_assert_jitter,
          { "802 Tx Priority Assert Jitter", "bthci_evt_mws_802_tx_priority_assert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_tx_priority_deassert_offset,
          { "802 Tx Priority Deassert Offset", "bthci_evt_mws_802_tx_priority_deassert_offset",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_mws_802_tx_priority_deassert_jitter,
          { "802 Tx Priority Deassert Jitter", "bthci_evt_mws_802_tx_priority_deassert_jitter",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sync_train_interval,
          { "Synchronization Train Interval", "bthci_evt_sync_train_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sync_train_to,
          { "Synchronization Train To", "bthci_evt_sync_train_to",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_secure_connection_host_support,
          { "Secure Connection Host Support", "bthci_evt_secure_connection_host_support",
            FT_UINT8, BASE_HEX, VALS(evt_enable_values), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_authenticated_payload_timeout,
          { "Authenticated Payload Timeout", "bthci_evt_authenticated_payload_timeout",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_c192,
          { "C 192", "bthci_evt_c192",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_r192,
          { "R 192", "bthci_evt_r192",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_c256,
          { "C 256", "bthci_evt_c256",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_r256,
          { "R 256", "bthci_evt_r256",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_extended_inquiry_length,
          { "Extended Inquiry Length",        "bthci_evt_extended_inquiry_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_suggested_max_tx_octets,
          { "Suggested Max Tx Octets",        "bthci_evt_suggested_max_tx_octets",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_suggested_max_tx_time,
          { "Suggested Max Tx Time",        "bthci_evt_suggested_max_tx_time",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_suggested_max_rx_octets,
          { "Suggested Max Rx Octets",        "bthci_evt_suggested_max_rx_octets",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_suggested_max_rx_time,
          { "Suggested Max Rx Time",        "bthci_evt_suggested_max_rx_time",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_resolving_list_size,
          { "Resolving List Size",        "bthci_evt_resolving_list_size",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_connectable,
          { "Connectable",     "bthci_evt_le_ext_advts_event_type_connectable",
            FT_BOOLEAN, 16, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_scannable,
          { "Scannable",     "bthci_evt_le_ext_advts_event_type_scannable",
            FT_BOOLEAN, 16, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_directed,
          { "Directed",     "bthci_evt_le_ext_advts_event_type_directed",
            FT_BOOLEAN, 16, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_scan_response,
          { "Scan Response",     "bthci_evt_le_ext_advts_event_type_scan_response",
            FT_BOOLEAN, 16, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_legacy,
          { "Legacy",     "bthci_evt_le_ext_advts_event_type_legacy",
            FT_BOOLEAN, 16, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_data_status,
          { "Data Status",     "bthci_evt_le_ext_advts_event_type_data_status",
            FT_UINT16, BASE_HEX, VALS(ext_adv_data_status_vals), 0x60,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ext_advts_event_type_reserved,
          { "Reserved",     "bthci_evt_le_ext_advts_event_type_reserved",
            FT_UINT16, BASE_HEX, NULL, 0xFF80,
            NULL, HFILL }
        },
        { &hf_bthci_evt_primary_phy,
          { "Primary PHY", "bthci_evt_primary_phy",
            FT_UINT8, BASE_HEX, VALS(bthci_evt_primary_phy_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_secondary_phy,
          { "Secondary PHY", "bthci_evt_secondary_phy",
            FT_UINT8, BASE_HEX, VALS(bthci_evt_secondary_phy_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_advertising_sid,
          { "Advertising SID", "bthci_evt_advertising_sid",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_tx_power,
          { "TX Power", "bthci_evt_tx_power",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_periodic_advertising_interval,
          { "Periodic Advertising Interval", "bthci_evt_periodic_advertising_interval",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sync_handle,
          { "Sync Handle", "bthci_evt_sync_handle",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_data_status,
          { "Data Status", "bthci_evt_data_status",
            FT_UINT8, BASE_HEX, VALS(ext_adv_data_status_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_advertising_handle,
          { "Advertising Handle", "bthci_evt_adv_handle",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_compl_ext_advertising_events,
          { "Number Completed Extended Advertising Events", "bthci_evt_num_compl_ext_adv_events",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_channel_selection_algorithm,
          { "Channel Selection Algorithm", "bthci_evt_channel_selection_algorithm",
            FT_UINT8, BASE_HEX, VALS(channel_selection_algo_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_advertiser_clock_accuracy,
          { "Advertiser Clock Accuracy", "bthci_evt_adv_clock_accuracy",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_clock_accuray_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_advertiser_phy,
          { "Advertiser PHY", "bthci_evt_adv_phy",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_le_phy_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_periodic_adv_list_size,
          { "Periodic Advertiser List Size",        "bthci_evt_le_periodic_adv_list_size",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_min_tx_power,
          { "Minimum TX Power", "bthci_evt_min_tx_power",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_tx_power,
          { "Maximum TX Power", "bthci_evt_max_tx_power",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_rf_tx_path_compensation,
          { "RF Tx Path Compensation Value",   "bthci_evt_rf_tx_path_compensation_value",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_rf_rx_path_compensation,
          { "RF Rx Path Compensation Value",   "bthci_evt_rf_rx_path_compensation_value",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_channel_index,
          { "Channel Index",        "bthci_evt_channel_index",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cte_rssi,
          { "RSSI",   "bthci_evt_cte_rssi",
            FT_INT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_antenna_id,
          { "Antenna Id",        "bthci_evt_antenna_id",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cte_type,
          { "CTE Type",        "bthci_evt_cte_type",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_cte_type_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_slot_durations,
          { "Slot Durations",        "bthci_evt_slot_durations",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_slot_durations_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_packet_status,
          { "Packet Status",        "bthci_evt_packet_status",
            FT_UINT8, BASE_HEX, VALS(packet_status_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_event_counter,
          { "Event Counter",        "bthci_evt_event_counter",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sample_count,
          { "Sample Count",        "bthci_evt_sample_count",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_i_sample,
          { "I",        "bthci_evt_i_sample",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_q_sample,
          { "Q",        "bthci_evt_q_sample",
            FT_INT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_service_data_past,
          { "Service Data",        "bthci_evt_service_data_past",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_number_antennae,
          { "Number of Antennae",        "bthci_evt_number_antennae",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_cte_length,
          { "Max CTE Length",        "bthci_evt_max_cte_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_length_antenna_switching_pattern,
          { "Max Length Antenna Switching Pattern", "bthci_evt_max_length_antenna_switching_pattern",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_supported_switching_sample_rates,
          { "Supported Switching Sampling Rates", "bthci_evt_supported_switching_sample_rates",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_supported_switching_sample_rates_1us_switching_aod_tx,
          { "1 usec switching for AoD Tx",  "bthci_evt_supported_switching_sample_rates_1us_switching_aod_tx",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_supported_switching_sample_rates_1us_sampling_aod_rx,
          { "1 usec sampling for AoD Rx",   "bthci_evt_supported_switching_sample_rates_1us_sampling_aod_rx",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_supported_switching_sample_rates_1us_switching_and_sampling_aoa_rx,
          { "1 usec switching and sampling for AoA Rx", "bthci_evt_supported_switching_sample_rates_1us_switching_and_sampling_aoa_rx",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_bthci_evt_supported_switching_sample_rates_reserved,
          { "Reserved",     "bthci_evt_supported_switching_sample_rates_reserved",
            FT_UINT8, BASE_HEX, NULL, 0xF8,
            NULL, HFILL }
        },
        { &hf_bthci_evt_simple_pairing_options,
          { "Simple Pairing Options", "bthci_evt_simple_pairing_options",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_simple_pairing_options_remote_public_key_validation,
          { "Remote Public Key Validation",     "bthci_evt_simple_pairing_options_remote_public_key_validation",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_simple_pairing_options_reserved,
          { "Reserved",     "bthci_evt_simple_pairing_options_reserved",
            FT_UINT8, BASE_HEX, NULL, 0xFE,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_encryption_key_size,
          { "Max Encryption Key Size",        "bthci_evt_max_encryption_key_size",
            FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_octet_octets, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sdu_packet_seq_num,
          { "SDU Packet Sequence Number",     "bthci_evt_sdu_packet_seq_num",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sdu_packet_timestamp,
          { "SDU Packet Timestamp",     "bthci_evt_sdu_packet_timestamp",
            FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sdu_packet_offset,
          { "SDU Packet Offset",     "bthci_evt_sdu_packet_offset",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cig_id,
          { "CIG Id",     "bthci_evt_cig_id",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cis_id,
          { "CIS Id",     "bthci_evt_cis_id",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cis_count,
          { "CIS Count",     "bthci_evt_cis_count",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cis_handle,
          { "CIS Handle",     "bthci_evt_cis_handle",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cis_bis_handle,
          { "CIS/BIS Handle",     "bthci_evt_cis_bis_handle",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_big_handle,
          { "BIG Handle",     "bthci_evt_big_handle",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_received_packet_counter,
          { "Received Packet Counter",     "bthci_evt_received_packet_counter",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_missed_packet_counter,
          { "Missed Packet Counter",     "bthci_evt_missed_packet_counter",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_failed_packet_counter,
          { "Failed Packet Counter",     "bthci_evt_failed_packet_counter",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_tx_unacked,
          { "Tx UnACKed Packets",     "bthci_evt_pkt_count_tx_unacked",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_tx_flushed,
          { "Tx Flushed Packets",     "bthci_evt_pkt_count_tx_flushed",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_tx_last_subevent,
          { "Tx Last Subevent Packets",     "bthci_evt_pkt_count_tx_last_subevent",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_tx_retransmitted,
          { "Tx Retransmitted Packets",     "bthci_evt_pkt_count_tx_retransmitted",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_rx_crc_error,
          { "Rx CRC Error Packets",     "bthci_evt_pkt_count_rx_crc_error",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_rx_unreceived,
          { "Rx Unreceived Packets",     "bthci_evt_pkt_count_rx_unreceived",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pkt_count_rx_duplicate,
          { "Rx Duplicate Packets",     "bthci_evt_pkt_count_rx_duplicate",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_phy_and_coding,
          { "PHY", "bthci_evt_phy_and_coding",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_phy_and_coding_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cig_sync_delay,
          { "CIG Sync Delay",     "bthci_evt_cig_sync_delay",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_big_sync_delay,
          { "BIG Sync Delay",     "bthci_evt_big_sync_delay",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_cis_sync_delay,
          { "CIS Sync Delay",     "bthci_evt_cis_sync_delay",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transport_latency_m_to_s,
          { "Transport Latency Master to Slave",     "bthci_evt_transport_latency_m_to_s",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transport_latency_s_to_m,
          { "Transport Latency Slave to Master",     "bthci_evt_transport_latency_s_to_m",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_big_transport_latency,
          { "BIG Transport Latency",     "bthci_evt_big_transport_latency",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_phy_m_to_s,
          { "PHY Master to Slave", "bthci_evt_phy_m_to_s",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_le_phy_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_phy_s_to_m,
          { "PHY Slave to Master", "bthci_evt_phy_s_to_m",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_le_phy_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_bn_m_to_s,
          { "Burst Number Master to Slave", "bthci_evt_bn_m_to_s",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_bn_s_to_m,
          { "Burst Number Slave to Master", "bthci_evt_bn_s_to_m",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ft_m_to_s,
          { "Flush Timeout Master to Slave", "bthci_evt_ft_m_to_s",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_ft_s_to_m,
          { "Flush Timeout Slave to Master", "bthci_evt_ft_s_to_m",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_pdu_m_to_s,
          { "Max PDU Master to Slave", "bthci_evt_max_pdu_m_to_s",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_octet_octets, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_pdu_s_to_m,
          { "Max PDU Slave to Master", "bthci_evt_max_pdu_s_to_m",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_octet_octets, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_phy,
        ...
        { &hf_bthci_evt_nse,
          { "Number of Sub-Events", "bthci_evt_nse",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_bn,
          { "Burst Number", "bthci_evt_bn",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_pto,
          { "Pre-Transmission Offset", "bthci_evt_pto",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_irc,
          { "Scheduled Payload Retransmissions", "bthci_evt_irc",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_pdu,
          { "Max PDU", "bthci_evt_max_pdu",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_octet_octets, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_iso_interval,
          { "ISO Interval", "bthci_evt_iso_interval",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_num_bis,
          { "Number of BISes", "bthci_evt_num_bis",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_bis_handle,
          { "BIS Handle", "bthci_evt_bis_handle",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_current_path_loss,
          { "Current Path Loss", "bthci_evt_current_path_loss",
            FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_decibels, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_zone_entered,
          { "Zone Entered", "bthci_evt_zone_entered",
            FT_UINT8, BASE_HEX, VALS(zone_entered_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_power_report_reason,
          { "Reason", "bthci_evt_power_report_reason",
            FT_UINT8, BASE_HEX, VALS(power_report_reason_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_flags,
          { "Transmit Power Level Flags", "bthci_evt_power_level_flags",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_flags_minimum_power,
          { "At Minimum Power Level",     "bthci_evt_transmit_power_level_flags_minimum_power",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_flags_maximum_power,
          { "At Maximum Power Level",     "bthci_evt_transmit_power_level_flags_maximum_power",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_bthci_evt_transmit_power_level_flags_reserved,
          { "Reserved",     "bthci_evt_transmit_power_level_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0xFC,
            NULL, HFILL }
        },
        { &hf_bthci_evt_power_level_delta,
          { "Transmit Power Delta", "bthci_evt_power_level_delta",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_decibels, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_sdu_interval,
          { "SDU Interval",   "bthci_evt_sdu_interval",
            FT_UINT24, BASE_DEC|BASE_UNIT_STRING, &units_microseconds, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_max_sdu,
          { "Max SDU", "bthci_evt_max_sdu",
            FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_octet_octets, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_framing,
          { "Framing", "bthci_evt_framing",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_framing_vals_ext, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_evt_peer_clock_accuracy,
          { "Peer Clock Accuracy", "bthci_evt_peer_clock_accuracy",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bthci_cmd_clock_accuray_vals_ext, 0x0,
            NULL, HFILL }
        },
