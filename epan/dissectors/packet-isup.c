...
/* Setup list of header fields  See Section 1.6.1 for details*/
  static hf_register_info hf[] = {
    ...
    { &hf_isup_number_different_meaning,
      { "Different meaning for number",  "isup_number_different_meaning",
        FT_UINT8, BASE_HEX, NULL, 0,
        NULL, HFILL }},

    { &hf_isup_screening_indicator,
      { "Screening indicator",  "isup_screening_indicator",
        FT_UINT8, BASE_DEC, VALS(isup_screening_ind_value), ISUP_SCREENING_IND_MASK,
        NULL, HFILL }},

    { &hf_isup_screening_indicator_enhanced,
      { "Screening indicator",  "isup_screening_indicator_enhanced",
    ...
    { &hf_isup_called_party_odd_address_signal_digit,
      { "Address signal digit",  "isup_called_party_odd_address_signal_digit",
        FT_UINT8, BASE_DEC | BASE_EXT_STRING, &isup_called_party_address_digit_value_ext, ISUP_ODD_ADDRESS_SIGNAL_DIGIT_MASK,
        NULL, HFILL }},

    { &hf_isup_calling_party_odd_address_signal_digit,
      { "Address signal digit",  "isup_calling_party_odd_address_signal_digit",
    ...
    { &hf_isup_cgs_message_type,
      { "Circuit group supervision message type",  "isup_cgs_message_type",
        FT_UINT8, BASE_DEC, VALS(isup_cgs_message_type_value), BA_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_mtc_blocking_state1,
      { "Maintenance blocking state",  "isup_mtc_blocking_state",
    ...
    { &hf_isup_Broadband_narrowband_interworking_ind,
      { "Broadband narrowband interworking indicator Bits JF",  "isup_broadband_narrowband_interworking_ind",
        FT_UINT8, BASE_HEX, VALS(ISUP_Broadband_narrowband_interworking_indicator_vals), BA_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_Broadband_narrowband_interworking_ind2,
      { "Broadband narrowband interworking indicator Bits GF",  "isup_broadband_narrowband_interworking_ind2",
        FT_UINT8, BASE_HEX, VALS(ISUP_Broadband_narrowband_interworking_indicator_vals), GF_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_app_cont_ident,
      { "Application context identifier",  "isup_app_context_identifier",
        FT_UINT16, BASE_DEC, VALS(isup_application_transport_parameter_value), GFEDCBA_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_app_Release_call_ind,
      { "Release call indicator (RCI)",  "isup_app_Release_call_indicator",
        FT_BOOLEAN, 8, TFS(&isup_Release_call_indicator_value), A_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_app_Send_notification_ind,
      { "Send notification indicator (SNI)",  "isup_app_Send_notification_ind",
        FT_BOOLEAN, 8, TFS(&isup_Send_notification_ind_value), B_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_apm_segmentation_ind,
      { "APM segmentation indicator",  "isup_apm_segmentation_ind",
        FT_UINT8, BASE_DEC, VALS(isup_APM_segmentation_ind_value), FEDCBA_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_apm_si_ind,
      { "Sequence indicator (SI)",  "isup_APM_Sequence_ind",
        FT_BOOLEAN, 8, TFS(&isup_Sequence_ind_value), G_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_orig_addr_len,
      { "Originating Address length",  "isup_orig_addr_len",
        FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_dest_addr_len,
      { "Destination Address length",  "isup_dest_addr_len",
        FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_apm_slr,
      { "Segmentation local reference (SLR)",  "isup_APM_slr",
        FT_UINT8, BASE_DEC, NULL, GFEDCBA_8BIT_MASK,
        NULL, HFILL }},
    { &hf_isup_cause_location,
      { "Cause location", "isup_cause_location",
        FT_UINT8, BASE_DEC|BASE_EXT_STRING, &q931_cause_location_vals_ext, 0x0f,
        NULL, HFILL }},

    { &hf_ansi_isup_coding_standard,
      { "Coding standard", "ansi_isup_coding_standard",
        FT_UINT8, BASE_HEX, VALS(ansi_isup_coding_standard_vals), 0x60,
        NULL, HFILL }},
    { &hf_ansi_isup_spare_b7,
      { "Spare", "ansi_isup_spare_b7",
      FT_UINT8, BASE_DEC, NULL, 0x80,
      NULL, HFILL }},
    { &hf_ansi_isup_type_of_nw_id,
      { "Type of network identification", "ansi_isup_type_of_nw_id",
        FT_UINT8, BASE_DEC, VALS(ansi_isup_type_of_nw_id_vals), 0x70,
        NULL, HFILL } },
    { &hf_ansi_isup_nw_id_plan,
      { "Network identification plan", "ansi_isup_nw_id_plan",
        FT_UINT8, BASE_DEC, VALS(ansi_isup_nw_id_plan_vals), 0x0f,
        NULL, HFILL } },
    { &hf_ansi_isup_tns_nw_id_plan,
      { "Network identification plan", "ansi_isup_tns_nw_id_plan",
        FT_UINT8, BASE_DEC, VALS(ansi_isup_tns_nw_id_plan_vals), 0x0f,
        NULL, HFILL } },
    { &hf_ansi_isup_nw_id,
      { "Network id",  "ansi_isup_nw_id",
        FT_STRING, BASE_NONE, NULL, 0x0,
        NULL, HFILL } },
    { &hf_ansi_isup_circuit_code,
      { "Circuit code", "ansi_isup_circuit_code",
        FT_UINT8, BASE_DEC, NULL, 0xf0,
        NULL, HFILL } },

      { &hf_bat_ase_identifier,
      { "BAT ASE Identifiers",  "bicc_bat_ase_identifier",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bat_ase_list_of_Identifiers_vals_ext, 0x0,
        NULL, HFILL }},

    { &hf_length_indicator,
      { "BAT ASE Element length indicator",  "bicc_bat_ase_length_indicator",
        FT_UINT16, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_Action_Indicator,
      { "BAT ASE action indicator field",  "bicc_bat_ase_bat_ase_action_indicator_field",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bat_ase_action_indicator_field_vals_ext, 0x00,
        NULL, HFILL }},

    { &hf_Instruction_ind_for_general_action,
      { "BAT ASE Instruction indicator for general action",  "bicc_bat_ase_Instruction_ind_for_general_action",
        FT_UINT8, BASE_HEX, VALS(Instruction_indicator_for_general_action_vals), 0x03,
        NULL, HFILL }},

    { &hf_Send_notification_ind_for_general_action,
      { "Send notification indicator for general action",  "bicc_bat_ase_Send_notification_ind_for_general_action",
        FT_BOOLEAN, 8, TFS(&isup_Send_notification_ind_value), 0x04,
        NULL, HFILL }},

    { &hf_Instruction_ind_for_pass_on_not_possible,
      { "Instruction ind for pass-on not possible",  "bicc_bat_ase_Instruction_ind_for_pass_on_not_possible",
        FT_UINT8, BASE_HEX, VALS(Instruction_indicator_for_pass_on_not_possible_vals), 0x30,
        NULL, HFILL }},

    { &hf_Send_notification_ind_for_pass_on_not_possible,
      { "Send notification indication for pass-on not possible",  "bicc_bat_ase_Send_notification_ind_for_pass_on_not_possible",
        FT_BOOLEAN, 8, TFS(&isup_Send_notification_ind_value), 0x40,
        NULL, HFILL }},

    { &hf_BCTP_Version_Indicator,
      { "BCTP Version Indicator",  "bicc_bat_ase_BCTP_Version_Indicator",
        FT_UINT8, BASE_DEC, NULL, 0x1f,
        NULL, HFILL }},

    { &hf_BVEI,
      { "BVEI",  "bicc_bat_ase_BCTP_BVEI",
        FT_BOOLEAN, 8, TFS(&BCTP_BVEI_value), 0x40,
        NULL, HFILL }},

    { &hf_Tunnelled_Protocol_Indicator,
      { "Tunnelled Protocol Indicator",  "bicc_bat_ase_BCTP_Tunnelled_Protocol_Indicator",
        FT_UINT8, BASE_DEC, VALS(BCTP_Tunnelled_Protocol_Indicator_vals), 0x3f,
        NULL, HFILL }},

    { &hf_TPEI,
      { "TPEI",  "bicc_bat_ase_BCTP_tpei",
        FT_BOOLEAN, 8, TFS(&BCTP_TPEI_value), 0x40,
        NULL, HFILL }},

    { &hf_bncid,
      { "Backbone Network Connection Identifier (BNCId)", "bat_ase_bncid",
    ...
    { &hf_afi,
      { "X.213 Address Format Information (AFI)",  "x213_afi",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &x213_afi_value_ext, 0x0,
        NULL, HFILL }},

    { &hf_bicc_nsap_dsp,
      { "X.213 Address Format Information (DSP)",  "x213_dsp",
        FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_bicc_nsap_dsp_length,
      { "DSP Length",  "x213_dsp_length",
        FT_UINT32, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_characteristics,
      { "Backbone network connection characteristics", "bat_ase_char",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bearer_network_connection_characteristics_vals_ext, 0x0,
        NULL, HFILL }},

    { &hf_Organization_Identifier,
      { "Organization identifier subfield",  "bat_ase_organization_identifier_subfield",
        FT_UINT8, BASE_DEC, VALS(bat_ase_organization_identifier_subfield_vals), 0x0,
        NULL, HFILL }},

    { &hf_codec_type,
      { "ITU-T codec type subfield",  "bat_ase_ITU_T_codec_type_subfield",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &ITU_T_codec_type_subfield_vals_ext, 0x0,
        NULL, HFILL }},

    { &hf_etsi_codec_type,
      { "ETSI codec type subfield",  "bat_ase_ETSI_codec_type_subfield",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &ETSI_codec_type_subfield_vals_ext, 0x0,
        NULL, HFILL }},

    { &hf_active_code_set,
      { "Active Code Set",  "bat_ase_acs",
        FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},

    { &hf_active_code_set_12_2,
      { "12.2 kbps rate",  "bat_ase_acs_12_2",
        FT_UINT8, BASE_HEX, NULL, 0x80,
        NULL, HFILL }},

    { &hf_active_code_set_10_2,
      { "10.2 kbps rate",  "bat_ase_acs_10_2",
        FT_UINT8, BASE_HEX, NULL, 0x40,
        NULL, HFILL }},

    { &hf_active_code_set_7_95,
      { "7.95 kbps rate",  "bat_ase_acs_7_95",
        FT_UINT8, BASE_HEX, NULL, 0x20,
        NULL, HFILL }},

    { &hf_active_code_set_7_40,
      { "7.40 kbps rate",  "bat_ase_acs_7_40",
        FT_UINT8, BASE_HEX, NULL, 0x10,
        NULL, HFILL }},

    { &hf_active_code_set_6_70,
      { "6.70 kbps rate",  "bat_ase_acs_6_70",
        FT_UINT8, BASE_HEX, NULL, 0x08,
        NULL, HFILL }},

    { &hf_active_code_set_5_90,
      { "5.90 kbps rate",  "bat_ase_acs_5_90",
        FT_UINT8, BASE_HEX, NULL, 0x04,
        NULL, HFILL }},

    { &hf_active_code_set_5_15,
      { "5.15 kbps rate",  "bat_ase_acs_5_15",
        FT_UINT8, BASE_HEX, NULL, 0x02,
        NULL, HFILL }},

    { &hf_active_code_set_4_75,
      { "4.75 kbps rate",  "bat_ase_acs_4_75",
        FT_UINT8, BASE_HEX, NULL, 0x01,
        NULL, HFILL }},

    { &hf_supported_code_set,
      { "Supported Code Set",  "bat_ase_scs",
        FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},

    { &hf_supported_code_set_12_2,
      { "12.2 kbps rate",  "bat_ase_scs_12_2",
        FT_UINT8, BASE_HEX, NULL, 0x80,
        NULL, HFILL }},

    { &hf_supported_code_set_10_2,
      { "10.2 kbps rate",  "bat_ase_scs_10_2",
        FT_UINT8, BASE_HEX, NULL, 0x40,
        NULL, HFILL }},

    { &hf_supported_code_set_7_95,
      { "7.95 kbps rate",  "bat_ase_scs_7_95",
        FT_UINT8, BASE_HEX, NULL, 0x20,
        NULL, HFILL }},

    { &hf_supported_code_set_7_40,
      { "7.40 kbps rate",  "bat_ase_scs_7_40",
        FT_UINT8, BASE_HEX, NULL, 0x10,
        NULL, HFILL }},

    { &hf_supported_code_set_6_70,
      { "6.70 kbps rate",  "bat_ase_scs_6_70",
        FT_UINT8, BASE_HEX, NULL, 0x08,
        NULL, HFILL }},

    { &hf_supported_code_set_5_90,
      { "5.90 kbps rate",  "bat_ase_scs_5_90",
        FT_UINT8, BASE_HEX, NULL, 0x04,
        NULL, HFILL }},

    { &hf_supported_code_set_5_15,
      { "5.15 kbps rate",  "bat_ase_scs_5_15",
        FT_UINT8, BASE_HEX, NULL, 0x02,
        NULL, HFILL }},

    { &hf_supported_code_set_4_75,
      { "4.75 kbps rate",  "bat_ase_scs_4_75",
        FT_UINT8, BASE_HEX, NULL, 0x01,
        NULL, HFILL }},

    { &hf_optimisation_mode,
      { "Optimisation Mode for ACS , OM",  "bat_ase_optimisation_mode",
        FT_UINT8, BASE_HEX, VALS(optimisation_mode_vals), 0x8,
        NULL, HFILL }},

    { &hf_max_codec_modes,
      { "Maximal number of Codec Modes, MACS",  "bat_ase_macs",
        FT_UINT8, BASE_DEC, NULL, 0x07,
        NULL, HFILL }},


    { &hf_bearer_control_tunneling,
      { "Bearer control tunneling",  "bat_ase_bearer_control_tunneling",
        FT_BOOLEAN, 8, TFS(&Bearer_Control_Tunnelling_ind_value), 0x01,
        NULL, HFILL }},

    { &hf_BAT_ASE_Comp_Report_Reason,
      { "Compatibility report reason",  "bat_ase_Comp_Report_Reason",
        FT_UINT8, BASE_HEX, VALS(BAT_ASE_Report_Reason_vals), 0x0,
        NULL, HFILL }},


    { &hf_BAT_ASE_Comp_Report_ident,
      { "Compatibility report ident",  "bat_ase_Comp_Report_ident",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &bat_ase_list_of_Identifiers_vals_ext, 0x0,
        NULL, HFILL }},

    { &hf_BAT_ASE_Comp_Report_diagnostic,
      { "Diagnostics",  "bat_ase_Comp_Report_diagnostic",
        FT_UINT16, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},

    { &hf_Local_BCU_ID,
      { "Local BCU ID",  "bat_ase_Local_BCU_ID",
        FT_UINT32, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},

    { &hf_late_cut_through_cap_ind,
      { "Late Cut-through capability indicator",  "bat_ase_late_cut_through_cap_ind",
        FT_BOOLEAN, 8, TFS(&late_cut_through_cap_ind_value), 0x01,
        NULL, HFILL }},

    { &hf_bat_ase_signal,
      { "Q.765.5 - Signal Type",  "bat_ase_signal_type",
        FT_UINT8, BASE_HEX|BASE_EXT_STRING, &BAT_ASE_Signal_Type_vals_ext, 0x0,
        NULL, HFILL }},

    { &hf_bat_ase_duration,
      { "Duration in ms",  "bat_ase_duration",
        FT_UINT16, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_bat_ase_default,
      { "Default",  "bat_ase_default",
        FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    ...
    { &hf_nsap_ipv4_addr,
      { "IWFA IPv4 Address", "nsap_ipv4_addr",
        FT_IPv4, BASE_NONE, NULL, 0x0,
        "IPv4 address", HFILL }},

    { &hf_nsap_ipv6_addr,
      { "IWFA IPv6 Address", "nsap_ipv6_addr",
        FT_IPv6, BASE_NONE, NULL, 0x0,
        "IPv6 address", HFILL}},

    { &hf_iana_icp,
      { "IANA ICP",  "nsap_iana_icp",
        FT_UINT16, BASE_HEX, VALS(iana_icp_values), 0x0,
        NULL, HFILL }},

    { &hf_isup_called,
      { "Called Party Number",  "isup_called",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_calling,
      { "Calling Party Number",  "isup_calling",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_redirecting,
      { "Redirecting Number",  "isup_redirecting",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_redirection_number,
      { "Redirection Number",  "isup_redirection_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_subsequent_number,
      { "Subsequent Number",  "isup_subsequent_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_connected_number,
      { "Connected Number",  "isup_connected_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_transit_network_selection,
      { "Transit Network Selection",  "isup_transit_network_selection",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_original_called_number,
      { "Original Called Number",  "isup_original_called_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_location_number,
      { "Location Number",  "isup_location_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_call_transfer_number,
      { "Call Transfer Number",  "isup_call_transfer_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_called_in_number,
      { "Called IN Number",  "isup_called_in_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_generic_number,
      { "Generic Number",  "isup_generic_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_jurisdiction,
      { "Jurisdiction",  "isup_jurisdiction",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_charge_number,
      { "Charge Number",  "isup_charge_number",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragments,
     { "Message fragments", "isup_apm_msg_fragments",
      FT_NONE, BASE_NONE, NULL, 0x00,
      NULL, HFILL }},

    { &hf_isup_apm_msg_fragment,
      { "Message fragment", "isup_apm_msg_fragment",
        FT_FRAMENUM, BASE_NONE, NULL, 0x00,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragment_overlap,
      { "Message fragment overlap", "isup_apm_msg_fragment_overlap",
        FT_BOOLEAN, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragment_overlap_conflicts,
      { "Message fragment overlapping with conflicting data", "isup_apm_msg_fragment_overlap_conflicts",
        FT_BOOLEAN, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragment_multiple_tails,
      { "Message has multiple tail fragments", "isup_apm_msg_fragment_multiple_tails",
        FT_BOOLEAN, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragment_too_long_fragment,
      { "Message fragment too long", "isup_apm_msg_fragment_too_long_fragment",
        FT_BOOLEAN, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragment_error,
      { "Message defragmentation error", "isup_apm_msg_fragment_error",
        FT_FRAMENUM, BASE_NONE, NULL, 0x00,
        NULL, HFILL }},

    { &hf_isup_apm_msg_fragment_count,
      { "Message fragment count", "isup_apm_msg_fragment_count",
        FT_UINT32, BASE_DEC, NULL, 0x00,
        NULL, HFILL }},

    { &hf_isup_apm_msg_reassembled_in,
      { "Reassembled in", "isup_apm_msg_reassembled_in",
        FT_FRAMENUM, BASE_NONE, NULL, 0x00,
        NULL, HFILL }},

    { &hf_isup_apm_msg_reassembled_length,
      { "Reassembled ISUP length", "isup_apm_msg_reassembled_length",
        FT_UINT32, BASE_DEC, NULL, 0x00, NULL, HFILL }},

    { &hf_isup_cvr_rsp_ind,
      { "CVR Response Ind", "isup_conn_rsp_ind",
        FT_UINT8, BASE_DEC, VALS(isup_cvr_rsp_ind_value), BA_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_cvr_cg_car_ind,
      { "CVR Circuit Group Carrier", "isup_cg_carrier_ind",
        FT_UINT8, BASE_HEX, VALS(isup_cvr_cg_car_ind_value), BA_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_cvr_cg_double_seize,
      { "Double Seize Control", "isup_cg_char_ind_doubleSeize",
        FT_UINT8, BASE_HEX, VALS(isup_cvr_cg_double_seize_value), DC_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_cvr_cg_alarm_car_ind,
      { "Alarm Carrier Indicator", "isup_cg_alarm_car_ind",
        FT_UINT8, BASE_HEX, VALS(isup_cvr_alarm_car_ind_value), FE_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_cvr_cont_chk_ind,
      { "Continuity Check Indicator", "isup_cg_alarm_cnt_chk",
        FT_UINT8, BASE_HEX, VALS(isup_cvr_cont_chk_ind_value), HG_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_geo_loc_presentation_restricted_ind,
      { "Calling Geodetic Location presentation restricted indicator",  "isup_location_presentation_restr_ind",
        FT_UINT8, BASE_DEC, VALS(isup_location_presentation_restricted_ind_value), DC_8BIT_MASK,
        NULL, HFILL }},

    { &hf_isup_geo_loc_screening_ind,
      { "Calling Geodetic Location screening indicator",  "isup_location_screening_ind",
    ...
    { &hf_isup_carrier_info_cat_of_carrier,
      { "Category of Carrier", "isup_carrier_info_cat_of_carrier",
        FT_UINT8, BASE_HEX, VALS(isup_carrier_info_category_value), 0x00,
        NULL, HFILL }},

    { &hf_isup_carrier_info_type_of_carrier_info,
      { "Type of Carrier", "isup_carrier_info_type_of_carrier",
        FT_UINT8, BASE_HEX, VALS(isup_carrier_info_type_of_carrier_value), 0x00,
        NULL, HFILL }},
#endif

    { &hf_japan_isup_carrier_info_length,
      { "Length of Carrier Information", "isup_jpn_arrier_info_length",
        FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_isup_carrier_info_odd_no_digits,
      { "CID", "isup_carrier_info_cid_odd_digit",
        FT_UINT8, BASE_DEC, VALS(isup_carrier_info_digits_value), 0x0F,
        NULL, HFILL }},

    { &hf_isup_carrier_info_even_no_digits,
      { "CID", "isup_carrier_info_cid_even_digit",
        FT_UINT8, BASE_DEC, VALS(isup_carrier_info_digits_value), 0xF0,
        NULL, HFILL }},

    { &hf_isup_carrier_info_ca_odd_no_digits,
      { "CA", "isup_carrier_info_ca_odd_digit",
      FT_UINT8, BASE_DEC, VALS(isup_carrier_info_digits_value), 0x0F,
      NULL, HFILL }},

    { &hf_isup_carrier_info_ca_even_no_digits,
      { "CA", "isup_carrier_info_ca_even_digit",
        FT_UINT8, BASE_DEC, VALS(isup_carrier_info_digits_value), 0xF0,
        NULL, HFILL }},

    { &hf_isup_carrier_info_poi_exit_HEI,
      { "Exit POI Hierarchy", "isup_carrier_info_exit_hierarchy",
        FT_UINT8, BASE_DEC, VALS(isup_carrier_info_poihie_value), 0x0F,
        NULL, HFILL }},

    { &hf_isup_carrier_info_poi_entry_HEI,
      { "Entry POI Hierarchy", "isup_carrier_info_entry_hierarchy",
        FT_UINT8, BASE_DEC, VALS(isup_carrier_info_poihie_value), 0xF0,
        NULL, HFILL }},

    { &hf_japan_isup_charge_delay_type,
      { "Type of delayed charging information", "isup_japan_charge_delay_type",
        FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(japan_isup_charge_delay_type_value), 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_charge_info_type,
      { "Charge information type", "isup_japan_chg_inf_type",
        FT_UINT8, BASE_DEC, VALS(japan_isup_chg_info_type_value), 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_sig_elem_type,
      { "Signal element type", "isup_japan_sig_elem_type",
        FT_UINT8, BASE_DEC, VALS(japan_isup_sig_elem_type_values), 0x7f,
        NULL, HFILL }},

    { &hf_japan_isup_activation_id,
      { "Activation id", "isup_japan_activation_id",
        FT_UINT8, BASE_DEC, NULL, 0x7F,
        NULL, HFILL }},

    { &hf_japan_isup_op_cls,
      { "Operation class", "isup_japan_op_cls",
        FT_UINT8, BASE_DEC, VALS(japan_isup_op_cls_values), 0x60,
        NULL, HFILL }},

    { &hf_japan_isup_op_type,
      { "Operation type", "isup_japan_op_type",
        FT_UINT8, BASE_DEC, VALS(japan_isup_op_type_values), 0x1f,
        NULL, HFILL }},

    { &hf_japan_isup_charging_party_type,
      { "Charging party type", "isup_japan_charging_party_type",
        FT_UINT8, BASE_DEC, VALS(japan_isup_charging_party_type_values), 0x70,
        NULL, HFILL }},

    { &hf_japan_isup_utp,
      { "Unit per Time Period (UTP)", "isup_japan_utp",
        FT_UINT8, BASE_DEC, VALS(japan_isup_utp_values), 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_crci1,
      { "Charge rate information category 1 (CRIC 1)", "isup_japan_crci1",
        FT_UINT8, BASE_DEC, VALS(japan_isup_crci1_values), 0x7f,
        NULL, HFILL }},

    { &hf_japan_isup_crci2,
      { "Charge rate information category 2 (CRIC 2)", "isup_japan_crci2",
        FT_UINT8, BASE_DEC, VALS(japan_isup_crci1_values), 0x7f,
        NULL, HFILL }},

    { &hf_japan_isup_crci1_len,
      { "Length",  "isup_japan_crci1_len",
        FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_iu,
      { "Initial units (IU)",  "isup_japan_iu",
        FT_STRING, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_dcr,
      { "Daytime Charge rate (DCR)",  "isup_japan_dcr",
        FT_STRING, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_ecr,
      { "Evening Charge rate (ECR)",  "isup_japan_ecr",
        FT_STRING, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_ncr,
      { "Nighttime Charge rate (NCR)",  "isup_japan_ncr",
        FT_STRING, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_scr,
      { "Spare charge rate (SCR)",  "isup_japan_scr",
        FT_STRING, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_japan_isup_collecting_method,
      { "Charging party type", "isup_japan_collecting_method",
        FT_UINT8, BASE_DEC, VALS(japan_isup_collecting_method_values), 0x0f,
        NULL, HFILL }},

    { &hf_japan_isup_tariff_rate_pres,
      { "Tariff rate presentation", "isup_japan_tariff_rate_pres",
        FT_UINT8, BASE_DEC, VALS(japan_isup_tariff_rate_pres_values), 0x7f,
        NULL, HFILL }},

      /* Generated from convert_proto_tree_add_text.pl */
      { &hf_isup_cause_indicators, { "Cause indicators (-> Q.850)", "isup_cause_indicators", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_diagnostic, { "Diagnostic", "isup_diagnostic", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_user_to_user_info, { "User-to-user info (-> Q.931)", "isup_user_to_user_info", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_call_identity, { "Call identity", "isup_call_identity", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_signalling_point_code, { "Signalling Point Code", "isup_signalling_point_code", FT_UINT16, BASE_DEC, NULL, 0x3FFF, NULL, HFILL }},
      { &hf_isup_access_transport_parameter_field, { "Access transport parameter field (-> Q.931)", "isup_access_transport_parameter_field", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_idp, { "IDP", "isup_idp", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_dsp, { "DSP", "isup_dsp", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_idi, { "IDI", "isup_idi", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_configuration_data, { "Configuration data", "isup_configuration_data", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_unknown_organisation_identifier, { "Unknown organisation Identifier (Non ITU-T/ETSI codec)", "isup_unknown_organisation_identifier", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_tunnelled_protocol_data, { "Tunnelled Protocol Data", "isup_tunnelled_protocol_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_network_id_length_indicator, { "Network ID Length indicator", "isup_network_id_length_indicator", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_network_id, { "Network ID", "isup_network_id", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_app_transport_param_field8, { "Application transport parameter fields", "isup_app_transport_param_field", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_app_transport_param_field16, { "Application transport parameter fields", "isup_app_transport_param_field", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_app_transport_instruction_indicator, { "Application transport instruction indicators", "isup_app_transport_instruction_indicator", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_apm_seg_indicator, { "APM segmentation indicator", "isup_apm_seg_indicator", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_address_digits, { "Address digits", "isup_address_digits", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_apm_user_info_field, { "APM-user information field", "isup_apm_user_info_field", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_local_reference, { "Local Reference", "isup_local_reference", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_protocol_class, { "Protocol Class", "isup_protocol_class", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_credit, { "Credit", "isup_credit", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_network_identity, { "Network Identity", "isup_network_identity", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_binary_code, { "Binary Code", "isup_binary_code", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_user_service_information, { "User service information (-> Q.931 Bearer_capability)", "isup_user_service_information", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_circuit_assignment_map, { "Circuit assignment map (bit position indicates usage of corresponding circuit->3.69/Q.763)", "isup_circuit_assignment_map", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_origination_isc_point_code, { "Origination ISC Point Code", "isup_origination_isc_point_code", FT_UINT16, BASE_DEC, NULL, 0x3FFF, NULL, HFILL }},
      { &hf_isup_call_history_info, { "Call history info", "isup_call_history_info", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_network_specific_facility, { "Network specific facility (refer to 3.36/Q.763 for detailed decoding)", "isup_network_specific_facility", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_user_service_information_prime, { "User service information prime (-> Q.931 Bearer capability information IE)", "isup_user_service_information_prime", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_propagation_delay_counter, { "Propagation delay counter", "isup_propagation_delay_counter", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_milliseconds, 0x0, NULL, HFILL }},
      { &hf_isup_remote_operations, { "Remote operations", "isup_remote_operations", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_feature_code, { "Feature Code", "isup_feature_code", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_user_teleservice_information, { "User teleservice information (-> Q.931 High Layer Compatibility IE)", "isup_user_teleservice_information", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_call_diversion_information, { "Call diversion information", "isup_call_diversion_information", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_echo_control_information, { "Echo control information", "isup_echo_control_information", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_message_compatibility_information, { "Message compatibility information", "isup_message_compatibility_information", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_upgraded_parameter, { "Upgraded parameter", "isup_upgraded_parameter", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &isup_parameter_type_value_ext, 0x0, NULL, HFILL }},
      { &hf_isup_instruction_indicators, { "Instruction indicators", "isup_instruction_indicators", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_look_forward_busy, { "Look forward busy", "isup_look_forward_busy", FT_UINT8, BASE_DEC, VALS(isup_mlpp_precedence_look_forward_busy_vals), 0x60, NULL, HFILL }},
      { &hf_isup_precedence_level, { "Precedence Level", "isup_precedence_level", FT_UINT8, BASE_DEC, VALS(isup_mlpp_precedence_level_vals), 0x0F, NULL, HFILL }},
      { &hf_isup_mlpp_service_domain, { "MLPP service domain", "isup_mlpp_service_domain", FT_UINT24, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_mcid_request_indicators, { "MCID request indicators", "isup_mcid_request_indicators", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_mcid_response_indicators, { "MCID response indicators", "isup_mcid_response_indicators", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_hop_counter, { "Hop counter", "isup_hop_counter", FT_UINT8, BASE_DEC, NULL, EDCBA_8BIT_MASK, NULL, HFILL }},
      { &hf_isup_originating_line_info, { "Originating line info", "isup_originating_line_info", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_presentation_indicator, { "Presentation indicator", "isup_presentation_indicator", FT_UINT8, BASE_DEC, VALS(isup_redirection_presentation_indicator_vals), BA_8BIT_MASK, NULL, HFILL }},
      { &hf_isup_call_transfer_identity, { "Call transfer identity", "isup_call_transfer_identity", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_loop_prevention_indicator_type, { "Type", "isup_loop_prevention_indicator_type", FT_BOOLEAN, 8, TFS(&tfs_response_request), A_8BIT_MASK, NULL, HFILL }},
      { &hf_isup_ccss_call_indicator, { "CCSS call indicator", "isup_ccss_call_indicator", FT_BOOLEAN, 8, TFS(&tfs_ccss_call_no_indication), A_8BIT_MASK, NULL, HFILL }},
      { &hf_isup_forward_gvns, { "Forward GVNS (refer to 3.66/Q.763 for detailed decoding)", "isup_forward_gvns", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_redirect_capability, { "Redirect capability", "isup_redirect_capability", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_backward_gvns, { "Backward GVNS", "isup_backward_gvns", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_correlation_id, { "Correlation ID (-> Q.1281)", "isup_correlation_id", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_scf_id, { "SCF ID (-> Q.1281)", "isup_scf_id", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_charged_party_identification, { "Charged party identification (format is national network specific)", "isup_charged_party_identification", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_display_information, { "Display information (-> Q.931)", "isup_display_information", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_uid_action_indicators, { "UID action indicators", "isup_uid_action_indicators", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_uid_capability_indicators, { "UID capability indicators", "isup_uid_capability_indicators", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_redirect_counter, { "Redirect counter", "isup_redirect_counter", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_collect_call_request_indicator, { "Collect call request indicator", "isup_collect_call_request_indicator", FT_BOOLEAN, 8, TFS(&tfs_collect_call_req_no_indication), A_8BIT_MASK, NULL, HFILL }},
      { &hf_isup_geo_loc_shape, { "Calling geodetic location type of shape", "isup_geo_loc_shape", FT_UINT8, BASE_DEC, VALS(isup_location_type_of_shape_value), GFEDCBA_8BIT_MASK, NULL, HFILL }},
      { &hf_isup_geo_loc_shape_description, { "Shape description", "isup_shape_description", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_isup_number_qualifier_indicator, { "Number qualifier indicator", "isup_number_qualifier_indicator", FT_UINT8, BASE_HEX|BASE_RANGE_STRING, RVALS(number_qualifier_indicator_vals), 0x0, NULL, HFILL }},
      { &hf_isup_generic_digits, { "Generic digits (refer to 3.24/Q.673 for detailed decoding)", "isup_generic_digits", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
  };
