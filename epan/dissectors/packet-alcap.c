...
proto_register_alcap(void)
{
    ...
    { &hf_alcap_dnsea,
      { "Address", "alcap_dnsea_addr",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_alc_max_br_fw,
      { "Maximum Forward Bit Rate", "alcap_alc_bitrate_max_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_alc_max_br_bw,
      { "Maximum Backwards Bit Rate", "alcap_alc_bitrate_max_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_alc_avg_br_fw,
      { "Average Forward Bit Rate", "alcap_alc_bitrate_avg_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_alc_avg_br_bw,
      { "Average Backwards Bit Rate", "alcap_alc_bitrate_avg_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_alc_max_sdu_fw,
      { "Maximum Forward CPS SDU Size", "alcap_alc_sdusize_max_fw",
        FT_UINT8, BASE_DEC, NULL, 0x7f,
        NULL, HFILL }
    },
    { &hf_alcap_alc_max_sdu_bw,
      { "Maximum Backwards CPS SDU Size", "alcap_alc_sdusize_max_bw",
        FT_UINT8, BASE_DEC, NULL, 0x7f,
        NULL, HFILL }
    },
    { &hf_alcap_alc_avg_sdu_fw,
      { "Average Forward CPS SDU Size", "alcap_alc_sdusize_avg_fw",
        FT_UINT8, BASE_DEC, NULL, 0x7f,
        NULL, HFILL }
    },
    { &hf_alcap_alc_avg_sdu_bw,
      { "Average Backwards CPS SDU Size", "alcap_alc_sdusize_avg_bw",
        FT_UINT8, BASE_DEC, NULL, 0x7f,
        NULL, HFILL }
    },
    ...
    { &hf_alcap_ssia_pcm,
      { "PCM Mode", "alcap_ssia_pcm",
        FT_UINT8, BASE_DEC, VALS(alaw_ulaw), 0x01,
        NULL, HFILL }
    },
    { &hf_alcap_ssia_max_len,
      { "Max Len of FM Data", "alcap_ssia_max_fmdata_len",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssia_oui,
    ...
    { &hf_alcap_ssim_frm,
      { "Frame Mode", "alcap_ssim_frm",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x80,
        NULL, HFILL }
    },
    { &hf_alcap_ssim_mult,
      { "Multiplier", "alcap_ssim_mult",
        FT_UINT8, BASE_DEC, NULL, 0x1f,
        NULL, HFILL }
    },
    { &hf_alcap_ssim_max,
      { "Max Len", "alcap_ssim_max",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_ssisa_max_sssar_fw,
      { "Maximum Len of SSSAR-SDU Forward", "alcap_ssisa_sssar_max_len_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisa_max_sssar_bw,
      { "Maximum Len of SSSAR-SDU Backwards", "alcap_ssisa_sssar_max_len_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisa_max_sscop_sdu_fw,
      { "Maximum Len of SSSAR-SDU Forward", "alcap_ssisa_sscop_max_sdu_len_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisa_max_sscop_sdu_bw,
      { "Maximum Len of SSSAR-SDU Backwards", "alcap_ssisa_sscop_max_sdu_len_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisa_max_sscop_uu_fw,
      { "Maximum Len of SSSAR-SDU Forward", "alcap_ssisa_sscop_max_uu_len_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisa_max_sscop_uu_bw,
      { "Maximum Len of SSSAR-SDU Backwards", "alcap_ssisa_sscop_max_uu_len_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_ssisu_max_sssar_fw,
      { "Maximum Len of SSSAR-SDU Forward", "alcap_ssisu_sssar_max_len_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisu_max_sssar_bw,
      { "Maximum Len of SSSAR-SDU Backwards", "alcap_ssisu_sssar_max_len_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssisu_ted,
      { "Transmission Error Detection", "alcap_ssisu_ted",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x80,
        NULL, HFILL }
    },

    { &hf_alcap_pt,
      { "QoS Codepoint", "alcap_pt_codepoint",
        FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }
    },

    { &hf_alcap_plc_max_br_fw,
      { "Maximum Forward Bit Rate", "alcap_plc_bitrate_max_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_plc_max_br_bw,
      { "Maximum Backwards Bit Rate", "alcap_plc_bitrate_max_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_plc_avg_br_fw,
      { "Average Forward Bit Rate", "alcap_plc_bitrate_avg_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_plc_avg_br_bw,
      { "Average Backwards Bit Rate", "alcap_plc_bitrate_avg_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_plc_max_sdu_fw,
      { "Maximum Forward CPS SDU Size", "alcap_plc_sdusize_max_fw",
        FT_UINT8, BASE_DEC, NULL, 0x7f,
        NULL, HFILL }
    },
    { &hf_alcap_plc_max_sdu_bw,
      { "Maximum Backwards CPS SDU Size", "alcap_plc_sdusize_max_bw",
        FT_UINT8, BASE_DEC, NULL, 0x7f,
        NULL, HFILL }
    },
    ...
    { &hf_alcap_pssiae_pr_type,
      { "Profile Type", "alcap_pssiae_profile_type",
        FT_UINT8, BASE_DEC, VALS(audio_profile_type), 0xc0,
        "I.366.2 Profile Type", HFILL }
    },
    { &hf_alcap_pssiae_pr_id,
      { "Profile Id", "alcap_pssiae_profile_id",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_lb,
      { "Loopback", "alcap_pssiae_lb",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0xc0,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_rc,
      { "Rate Control", "alcap_pssiae_rc",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0xc0,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_syn,
      { "Synchronization", "alcap_pssiae_syn",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0xc0,
        "Transport of synchronization of change in SSCS operation", HFILL }
    },
    { &hf_alcap_pssiae_frm,
      { "Frame Mode", "alcap_pssiae_frm",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x80,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_cmd,
      { "Circuit Mode", "alcap_pssiae_cmd",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x40,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_mfr2,
      { "Multi-Frequency R2", "alcap_pssiae_mfr2",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x20,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_mfr1,
      { "Multi-Frequency R1", "alcap_pssiae_mfr1",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x10,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_dtmf,
      { "DTMF", "alcap_pssiae_dtmf",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x08,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_cas,
      { "CAS", "alcap_pssiae_cas",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x04,
        "Channel Associated Signalling", HFILL }
    },
    { &hf_alcap_pssiae_fax,
      { "Fax", "alcap_pssiae_fax",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x02,
        "Facsimile", HFILL }
    },
    { &hf_alcap_pssiae_pcm,
      { "PCM Mode", "alcap_pssiae_pcm",
        FT_UINT8, BASE_DEC, VALS(alaw_ulaw), 0x01,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_max_len,
      { "Max Len of FM Data", "alcap_pssiae_max_fmdata_len",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pssiae_oui,
      { "OUI", "alcap_pssiae_oui",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Organizational Unique Identifier", HFILL }
    },

    { &hf_alcap_pssime_frm,
      { "Frame Mode", "alcap_pssime_frm",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x80,
        NULL, HFILL }
    },
    { &hf_alcap_pssime_lb,
      { "Loopback", "alcap_pssime_lb",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x40,
        NULL, HFILL }
    },
    { &hf_alcap_pssime_mult,
      { "Multiplier", "alcap_pssime_mult",
        FT_UINT8, BASE_DEC, NULL, 0x1f,
        NULL, HFILL }
    },
    { &hf_alcap_pssime_max,
      { "Max Len", "alcap_pssime_max",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    ...
    { &hf_alcap_onsea,
      { "Address", "alcap_onsea_addr",
        FT_BYTES, BASE_NONE, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_ssiae_pr_type,
      { "Profile Type", "alcap_ssiae_profile_type",
        FT_UINT8, BASE_DEC, VALS(audio_profile_type), 0xc0,
        "I.366.2 Profile Type", HFILL }
    },
    { &hf_alcap_ssiae_lb,
      { "Loopback", "alcap_ssiae_lb",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0xc0,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_rc,
      { "Rate Control", "alcap_ssiae_rc",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0xc0,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_syn,
      { "Synchronization", "alcap_ssiae_syn",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0xc0,
        "Transport of synchronization of change in SSCS operation", HFILL }
    },
    { &hf_alcap_ssiae_pr_id,
      { "Profile Id", "alcap_ssiae_profile_id",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_frm,
      { "Frame Mode", "alcap_ssiae_frm",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x80,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_cmd,
      { "Circuit Mode", "alcap_ssiae_cmd",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x40,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_mfr2,
      { "Multi-Frequency R2", "alcap_ssiae_mfr2",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x20,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_mfr1,
      { "Multi-Frequency R1", "alcap_ssiae_mfr1",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x10,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_dtmf,
      { "DTMF", "alcap_ssiae_dtmf",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x08,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_cas,
    ...
    { &hf_alcap_ssiae_pcm,
      { "PCM Mode", "alcap_ssiae_pcm",
        FT_UINT8, BASE_DEC, VALS(alaw_ulaw), 0x01,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_max_len,
      { "Max Len of FM Data", "alcap_ssiae_max_fmdata_len",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_ssiae_oui,
    ...
    { &hf_alcap_ssime_frm,
      { "Frame Mode", "alcap_ssime_frm",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x80,
        NULL, HFILL }
    },
    { &hf_alcap_ssime_lb,
      { "Loopback", "alcap_ssime_lb",
        FT_UINT8, BASE_DEC, VALS(enabled_disabled), 0x40,
        NULL, HFILL }
    },
    { &hf_alcap_ssime_mult,
      { "Multiplier", "alcap_ssime_mult",
        FT_UINT8, BASE_DEC, NULL, 0x1f,
        NULL, HFILL }
    },
    { &hf_alcap_ssime_max,
      { "Max Len", "alcap_ssime_max",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_acc_level,
      { "Congestion Level", "alcap_acc_level",
        FT_UINT8, BASE_DEC, VALS(congestion_level), 0,
        NULL, HFILL }
    },

    { &hf_alcap_cp,
      { "Level", "alcap_cp_level",
        FT_UINT8, BASE_DEC, VALS(connection_priority), 0x07,
        NULL, HFILL }
    },

    { &hf_alcap_hc,
      { "Codepoint", "alcap_hc_codepoint",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_pfbw_br_fw,
      { "CPS Forward Bitrate", "alcap_pfbw_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pfbw_br_bw,
      { "CPS Backwards Bitrate", "alcap_pfbw_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pfbw_bucket_fw,
      { "Forward CPS Bucket Size", "alcap_pfbw_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pfbw_bucket_bw,
      { "Backwards CPS Bucket Size", "alcap_pfbw_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pfbw_size_fw,
      { "Forward CPS Packet Size", "alcap_pfbw_max_size_fw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pfbw_size_bw,
      { "Backwards CPS Packet Size", "alcap_pfbw_max_size_bw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_pvbws_br_fw,
      { "Peak CPS Forward Bitrate", "alcap_pvbws_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbws_br_bw,
      { "Peak CPS Backwards Bitrate", "alcap_pvbws_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbws_bucket_fw,
      { "Peak Forward CPS Bucket Size", "alcap_pvbws_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbws_bucket_bw,
      { "Peak Backwards CPS Bucket Size", "alcap_pvbws_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbws_size_fw,
      { "Forward CPS Packet Size", "alcap_pvbws_max_size_fw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbws_size_bw,
      { "Backwards CPS Packet Size", "alcap_pvbws_max_size_bw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbws_stt,
      { "Source Traffic Type", "alcap_pvbws_stt",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_pvbwt_peak_br_fw,
      { "Peak CPS Forward Bitrate", "alcap_pvbwt_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_peak_br_bw,
      { "Peak CPS Backwards Bitrate", "alcap_pvbwt_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_peak_bucket_fw,
      { "Peak Forward CPS Bucket Size", "alcap_pvbwt_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_peak_bucket_bw,
      { "Peak Backwards CPS Bucket Size", "alcap_pvbwt_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_sust_br_fw,
      { "Sustainable CPS Forward Bitrate", "alcap_pvbwt_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_sust_br_bw,
      { "Sustainable CPS Backwards Bitrate", "alcap_pvbwt_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_sust_bucket_fw,
      { "Sustainable Forward CPS Bucket Size", "alcap_pvbwt_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_sust_bucket_bw,
      { "Sustainable Backwards CPS Bucket Size", "alcap_pvbwt_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_size_fw,
      { "Forward CPS Packet Size", "alcap_pvbwt_max_size_fw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_pvbwt_size_bw,
      { "Backwards CPS Packet Size", "alcap_pvbwt_max_size_bw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_fbw_br_fw,
      { "CPS Forward Bitrate", "alcap_fbw_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_fbw_br_bw,
      { "CPS Backwards Bitrate", "alcap_fbw_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_fbw_bucket_fw,
      { "Forward CPS Bucket Size", "alcap_fbw_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_fbw_bucket_bw,
      { "Backwards CPS Bucket Size", "alcap_fbw_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_fbw_size_fw,
      { "Forward CPS Packet Size", "alcap_fbw_max_size_fw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_fbw_size_bw,
      { "Backwards CPS Packet Size", "alcap_fbw_max_size_bw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_vbws_br_fw,
      { "CPS Forward Bitrate", "alcap_vbws_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbws_br_bw,
      { "CPS Backwards Bitrate", "alcap_vbws_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbws_bucket_fw,
      { "Forward CPS Bucket Size", "alcap_vbws_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbws_bucket_bw,
      { "Backwards CPS Bucket Size", "alcap_vbws_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbws_size_fw,
      { "Forward CPS Packet Size", "alcap_vbws_max_size_fw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbws_size_bw,
      { "Backwards CPS Packet Size", "alcap_vbws_max_size_bw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbws_stt,
      { "Source Traffic Type", "alcap_vbws_stt",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_vbwt_peak_br_fw,
      { "Peak CPS Forward Bitrate", "alcap_vbwt_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_peak_br_bw,
      { "Peak CPS Backwards Bitrate", "alcap_vbwt_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_peak_bucket_fw,
      { "Peak Forward CPS Bucket Size", "alcap_vbwt_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_peak_bucket_bw,
      { "Peak Backwards CPS Bucket Size", "alcap_vbwt_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_sust_br_fw,
      { "Sustainable CPS Forward Bitrate", "alcap_vbwt_bitrate_fw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_sust_br_bw,
      { "Sustainable CPS Backwards Bitrate", "alcap_vbwt_bitrate_bw",
        FT_UINT24, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_sust_bucket_fw,
      { "Sustainable Forward CPS Bucket Size", "alcap_vbwt_bucket_size_fw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_sust_bucket_bw,
      { "Sustainable Backwards CPS Bucket Size", "alcap_vbwt_bucket_size_bw",
        FT_UINT16, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_size_fw,
      { "Forward CPS Packet Size", "alcap_vbwt_max_size_fw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_vbwt_size_bw,
      { "Backwards CPS Packet Size", "alcap_vbwt_max_size_bw",
        FT_UINT8, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },

    { &hf_alcap_leg_osaid,
      { "Leg's ERQ OSA id", "alcap_leg_osaid",
        FT_UINT32, BASE_HEX, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_dsaid,
      { "Leg's ECF OSA id", "alcap_leg_dsaid",
        FT_UINT32, BASE_HEX, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_pathid,
      { "Leg's path id", "alcap_leg_pathid",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_cid,
      { "Leg's channel id", "alcap_leg_cid",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_sugr,
      { "Leg's SUGR", "alcap_leg_sugr",
        FT_UINT32, BASE_HEX, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_dnsea,
      { "Leg's destination NSAP", "alcap_leg_dnsea",
        FT_STRING, BASE_NONE, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_onsea,
      { "Leg's originating NSAP", "alcap_leg_onsea",
        FT_STRING, BASE_NONE, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_frame,
      { "a message of this leg", "alcap_leg_msg",
        FT_FRAMENUM, BASE_NONE, NULL, 0,
        NULL, HFILL }
    },
    { &hf_alcap_leg_release_cause,
      { "Leg's cause value in REL", "alcap_leg_cause",
