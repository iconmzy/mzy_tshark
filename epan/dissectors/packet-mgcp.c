...
void proto_register_mgcp(void)
{
	...
	static hf_register_info hf[] =
		{
			{ &hf_mgcp_req,
			  { "Request", "mgcp_req", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
			    "True if MGCP request", HFILL }},
			{ &hf_mgcp_rsp,
			  { "Response", "mgcp_rsp", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
			    "TRUE if MGCP response", HFILL }},
			{ &hf_mgcp_req_frame,
			  { "Request Frame", "mgcp_reqframe", FT_FRAMENUM, BASE_NONE, NULL, 0,
			    NULL, HFILL }},
			{ &hf_mgcp_rsp_frame,
			  { "Response Frame", "mgcp_rspframe", FT_FRAMENUM, BASE_NONE, NULL, 0,
			    NULL, HFILL }},
			{ &hf_mgcp_time,
			  { "Time from request", "mgcp_time", FT_RELATIVE_TIME, BASE_NONE, NULL, 0,
			    "Timedelta between Request and Response", HFILL }},
			{ &hf_mgcp_req_verb,
			  { "Verb", "mgcp_req_verb", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Name of the verb", HFILL }},
			{ &hf_mgcp_req_endpoint,
			  { "Endpoint", "mgcp_req_endpoint", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Endpoint referenced by the message", HFILL }},
			{ &hf_mgcp_transid,
			  { "Transaction ID", "mgcp_transid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Transaction ID of this message", HFILL }},
			{ &hf_mgcp_version,
			  { "Version", "mgcp_version", FT_STRING, BASE_NONE, NULL, 0x0,
			    "MGCP Version", HFILL }},
			{ &hf_mgcp_rsp_rspcode,
			  { "Response Code", "mgcp_rsp_rspcode", FT_UINT32, BASE_DEC|BASE_EXT_STRING, &mgcp_return_code_vals_ext, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_rsp_rspstring,
			  { "Response String", "mgcp_rsp_rspstring", FT_STRING, BASE_NONE, NULL, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_params,
			  { "Parameters", "mgcp_params", FT_NONE, BASE_NONE, NULL, 0x0,
			    "MGCP parameters", HFILL }},
			{ &hf_mgcp_param_rspack,
			  { "ResponseAck (K)", "mgcp_param_rspack", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Response Ack", HFILL }},
			{ &hf_mgcp_param_bearerinfo,
			  { "BearerInformation (B)", "mgcp_param_bearerinfo", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Bearer Information", HFILL }},
			{ &hf_mgcp_param_callid,
			  { "CallId (C)", "mgcp_param_callid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Call Id", HFILL }},
			{ &hf_mgcp_param_connectionid,
			  {"ConnectionIdentifier (I)", "mgcp_param_connectionid", FT_STRING, BASE_NONE, NULL, 0x0,
			   "Connection Identifier", HFILL }},
			{ &hf_mgcp_param_secondconnectionid,
			  { "SecondConnectionID (I2)", "mgcp_param_secondconnectionid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Second Connection Identifier", HFILL }},
			{ &hf_mgcp_param_notifiedentity,
			  { "NotifiedEntity (N)", "mgcp_param_notifiedentity", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Notified Entity", HFILL }},
			{ &hf_mgcp_param_requestid,
			  { "RequestIdentifier (X)", "mgcp_param_requestid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Request Identifier", HFILL }},
			{ &hf_mgcp_param_localconnoptions,
			  { "LocalConnectionOptions (L)", "mgcp_param_localconnectionoptions", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Local Connection Options", HFILL }},
			{ &hf_mgcp_param_localconnoptions_p,
			  { "Packetization period (p)", "mgcp_param_localconnectionoptions_p", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Packetization period", HFILL }},
			{ &hf_mgcp_param_localconnoptions_a,
			  { "Codecs (a)", "mgcp_param_localconnectionoptions_a", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Codecs", HFILL }},
			{ &hf_mgcp_param_localconnoptions_s,
			  { "Silence Suppression (s)", "mgcp_param_localconnectionoptions_s", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Silence Suppression", HFILL }},
			{ &hf_mgcp_param_localconnoptions_e,
			  { "Echo Cancellation (e)", "mgcp_param_localconnectionoptions_e", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Echo Cancellation", HFILL }},
			{ &hf_mgcp_param_localconnoptions_scrtp,
			  { "RTP ciphersuite (sc-rtp)", "mgcp_param_localconnectionoptions_scrtp", FT_STRING, BASE_NONE, NULL, 0x0,
			    "RTP ciphersuite", HFILL }},
			{ &hf_mgcp_param_localconnoptions_scrtcp,
			  { "RTCP ciphersuite (sc-rtcp)", "mgcp_param_localconnectionoptions_scrtcp", FT_STRING, BASE_NONE, NULL, 0x0,
			    "RTCP ciphersuite", HFILL }},
			{ &hf_mgcp_param_localconnoptions_b,
			  { "Bandwidth (b)", "mgcp_param_localconnectionoptions_b", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Bandwidth", HFILL }},
			{ &hf_mgcp_param_localconnoptions_esccd,
			  { "Content Destination (es-ccd)", "mgcp_param_localconnectionoptions_esccd", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Content Destination", HFILL }},
			{ &hf_mgcp_param_localconnoptions_escci,
			  { "Content Identifier (es-cci)", "mgcp_param_localconnectionoptions_escci", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Content Identifier", HFILL }},
			{ &hf_mgcp_param_localconnoptions_dqgi,
			  { "D-QoS GateID (dq-gi)", "mgcp_param_localconnectionoptions_dqgi", FT_STRING, BASE_NONE, NULL, 0x0,
			    "D-QoS GateID", HFILL }},
			{ &hf_mgcp_param_localconnoptions_dqrd,
			  { "D-QoS Reserve Destination (dq-rd)", "mgcp_param_localconnectionoptions_dqrd", FT_STRING, BASE_NONE, NULL, 0x0,
			    "D-QoS Reserve Destination", HFILL }},
			{ &hf_mgcp_param_localconnoptions_dqri,
			  { "D-QoS Resource ID (dq-ri)", "mgcp_param_localconnectionoptions_dqri", FT_STRING, BASE_NONE, NULL, 0x0,
			    "D-QoS Resource ID", HFILL }},
			{ &hf_mgcp_param_localconnoptions_dqrr,
			  { "D-QoS Resource Reservation (dq-rr)", "mgcp_param_localconnectionoptions_dqrr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "D-QoS Resource Reservation", HFILL }},
			{ &hf_mgcp_param_localconnoptions_k,
			  { "Encryption Key (k)", "mgcp_param_localconnectionoptions_k", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Encryption Key", HFILL }},
			{ &hf_mgcp_param_localconnoptions_gc,
			  { "Gain Control (gc)", "mgcp_param_localconnectionoptions_gc", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Gain Control", HFILL }},
			{ &hf_mgcp_param_localconnoptions_fmtp,
			  { "Media Format (fmtp)", "mgcp_param_localconnectionoptions_fmtp", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Media Format", HFILL }},
			{ &hf_mgcp_param_localconnoptions_nt,
			  { "Network Type (nt)", "mgcp_param_localconnectionoptions_nt", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Network Type", HFILL }},
			{ &hf_mgcp_param_localconnoptions_ofmtp,
			  { "Optional Media Format (o-fmtp)", "mgcp_param_localconnectionoptions_ofmtp", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Optional Media Format", HFILL }},
			{ &hf_mgcp_param_localconnoptions_r,
			  { "Resource Reservation (r)", "mgcp_param_localconnectionoptions_r", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Resource Reservation", HFILL }},
			{ &hf_mgcp_param_localconnoptions_t,
			  { "Type of Service (r)", "mgcp_param_localconnectionoptions_t", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Type of Service", HFILL }},
			{ &hf_mgcp_param_localconnoptions_rcnf,
			  { "Reservation Confirmation (r-cnf)", "mgcp_param_localconnectionoptions_rcnf", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Reservation Confirmation", HFILL }},
			{ &hf_mgcp_param_localconnoptions_rdir,
			  { "Reservation Direction (r-dir)", "mgcp_param_localconnectionoptions_rdir", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Reservation Direction", HFILL }},
			{ &hf_mgcp_param_localconnoptions_rsh,
			  { "Resource Sharing (r-sh)", "mgcp_param_localconnectionoptions_rsh", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Resource Sharing", HFILL }},
			{ &hf_mgcp_param_localconnoptions_mp,
			  { "Multiple Packetization period (mp)", "mgcp_param_localconnectionoptions_mp", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Multiple Packetization period", HFILL }},
			{ &hf_mgcp_param_localconnoptions_fxr,
			  { "FXR (fxr/fx)", "mgcp_param_localconnectionoptions_fxr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "FXR", HFILL }},
			{ &hf_mgcp_param_localvoicemetrics,
			  { "LocalVoiceMetrics (XRM/LVM)", "mgcp_param_localvoicemetrics", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Local Voice Metrics", HFILL }},
			{ &hf_mgcp_param_remotevoicemetrics,
			  { "RemoteVoiceMetrics (XRM/RVM)", "mgcp_param_remotevoicemetrics", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Remote Voice Metrics", HFILL }},
			{ &hf_mgcp_param_voicemetrics_nlr,
			  { "Network packet loss rate(NLR)", "mgcp_param_voicemetrics_nlr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics NLR", HFILL }},
			{ &hf_mgcp_param_voicemetrics_jdr,
			  { "Jitter buffer discard rate(JDR)", "mgcp_param_voicemetrics_jdr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics JDR", HFILL }},
			{ &hf_mgcp_param_voicemetrics_bld,
			  { "Burst loss density(BLD)", "mgcp_param_voicemetrics_bld", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics BLD", HFILL }},
			{ &hf_mgcp_param_voicemetrics_gld,
			  { "Gap loss density(GLD)", "mgcp_param_voicemetrics_gld", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics GLD", HFILL }},
			{ &hf_mgcp_param_voicemetrics_bd,
			  { "Burst duration(BD)", "mgcp_param_voicemetrics_bd", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics BD", HFILL }},
			{ &hf_mgcp_param_voicemetrics_gd,
			  { "Gap duration(GD)", "mgcp_param_voicemetrics_gd", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics GD", HFILL }},
			{ &hf_mgcp_param_voicemetrics_rtd,
			  { "Round trip network delay(RTD)", "mgcp_param_voicemetrics_rtd", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics RTD", HFILL }},
			{ &hf_mgcp_param_voicemetrics_esd,
			  { "End system delay(ESD)", "mgcp_param_voicemetrics_esd", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics ESD", HFILL }},
			{ &hf_mgcp_param_voicemetrics_sl,
			  { "Signal level(SL)", "mgcp_param_voicemetrics_sl", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics SL", HFILL }},
			{ &hf_mgcp_param_voicemetrics_nl,
			  { "Noise level(NL)", "mgcp_param_voicemetrics_nl", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metricsx NL", HFILL }},
			{ &hf_mgcp_param_voicemetrics_rerl,
			  { "Residual echo return loss(RERL)", "mgcp_param_voicemetrics_rerl", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics ERL", HFILL }},
			{ &hf_mgcp_param_voicemetrics_gmn,
			  { "Minimum gap threshold(GMN)", "mgcp_param_voicemetrics_gmn", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics GMN", HFILL }},
			{ &hf_mgcp_param_voicemetrics_nsr,
			  { "R factor(NSR)", "mgcp_param_voicemetrics_nsr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics NSR", HFILL }},
			{ &hf_mgcp_param_voicemetrics_xsr,
			  { "External R factor(XSR)", "mgcp_param_voicemetrics_xsr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics XSR", HFILL }},
			{ &hf_mgcp_param_voicemetrics_mlq,
			  { "Estimated MOS-LQ(MLQ)", "mgcp_param_voicemetrics_mlq", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics MLQ", HFILL }},
			{ &hf_mgcp_param_voicemetrics_mcq,
			  { "Estimated MOS-CQ(MCQ)", "mgcp_param_voicemetrics_mcq", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics MCQ", HFILL }},
			{ &hf_mgcp_param_voicemetrics_plc,
			  { "Packet loss concealment type(PLC)", "mgcp_param_voicemetrics_plc", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics PLC", HFILL }},
			{ &hf_mgcp_param_voicemetrics_jba,
			  { "Jitter Buffer Adaptive(JBA)", "mgcp_param_voicemetrics_jba", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics JBA", HFILL }},
			{ &hf_mgcp_param_voicemetrics_jbr,
			  { "Jitter Buffer Rate(JBR)", "mgcp_param_voicemetrics_jbr", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics JBR", HFILL }},
			{ &hf_mgcp_param_voicemetrics_jbn,
			  { "Nominal jitter buffer delay(JBN)", "mgcp_param_voicemetrics_jbn", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics JBN", HFILL }},
			{ &hf_mgcp_param_voicemetrics_jbm,
			  { "Maximum jitter buffer delay(JBM)", "mgcp_param_voicemetrics_jbm", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics JBM", HFILL }},
			{ &hf_mgcp_param_voicemetrics_jbs,
			  { "Absolute maximum jitter buffer delay(JBS)", "mgcp_param_voicemetrics_jbs", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics JBS", HFILL }},
			{ &hf_mgcp_param_voicemetrics_iaj,
			  { "Inter-arrival Jitter(IAJ)", "mgcp_param_voicemetrics_iaj", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Voice Metrics IAJ", HFILL }},
			{ &hf_mgcp_param_connectionmode,
			  { "ConnectionMode (M)", "mgcp_param_connectionmode", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Connection Mode", HFILL }},
			{ &hf_mgcp_param_reqevents,
			  { "RequestedEvents (R)", "mgcp_param_reqevents", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Requested Events", HFILL }},
			{ &hf_mgcp_param_signalreq,
			  { "SignalRequests (S)", "mgcp_param_signalreq", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Signal Request", HFILL }},
			{ &hf_mgcp_param_restartmethod,
			  { "RestartMethod (RM)", "mgcp_param_restartmethod", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Restart Method", HFILL }},
			{ &hf_mgcp_param_restartdelay,
			  { "RestartDelay (RD)", "mgcp_param_restartdelay", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Restart Delay", HFILL }},
			{ &hf_mgcp_param_digitmap,
			  { "DigitMap (D)", "mgcp_param_digitmap", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Digit Map", HFILL }},
			{ &hf_mgcp_param_observedevent,
			  { "ObservedEvents (O)", "mgcp_param_observedevents", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Observed Events", HFILL }},
			{ &hf_mgcp_param_connectionparam,
			  { "ConnectionParameters (P)", "mgcp_param_connectionparam", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Connection Parameters", HFILL }},
			{ &hf_mgcp_param_connectionparam_ps,
			  { "Packets sent (PS)", "mgcp_param_connectionparam_ps", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Packets sent (P:PS)", HFILL }},
			{ &hf_mgcp_param_connectionparam_os,
			  { "Octets sent (OS)", "mgcp_param_connectionparam_os", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Octets sent (P:OS)", HFILL }},
			{ &hf_mgcp_param_connectionparam_pr,
			  { "Packets received (PR)", "mgcp_param_connectionparam_pr", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Packets received (P:PR)", HFILL }},
			{ &hf_mgcp_param_connectionparam_or,
			  { "Octets received (OR)", "mgcp_param_connectionparam_or", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Octets received (P:OR)", HFILL }},
			{ &hf_mgcp_param_connectionparam_pl,
			  { "Packets lost (PL)", "mgcp_param_connectionparam_pl", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Packets lost (P:PL)", HFILL }},
			{ &hf_mgcp_param_connectionparam_ji,
			  { "Jitter (JI)", "mgcp_param_connectionparam_ji", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Average inter-packet arrival jitter in milliseconds (P:JI)", HFILL }},
			{ &hf_mgcp_param_connectionparam_la,
			  { "Latency (LA)", "mgcp_param_connectionparam_la", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Average latency in milliseconds (P:LA)", HFILL }},
			{ &hf_mgcp_param_connectionparam_pcrps,
			  { "Remote Packets sent (PC/RPS)", "mgcp_param_connectionparam_pcrps", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Remote Packets sent (P:PC/RPS)", HFILL }},
			{ &hf_mgcp_param_connectionparam_pcros,
			  { "Remote Octets sent (PC/ROS)", "mgcp_param_connectionparam_pcros", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Remote Octets sent (P:PC/ROS)", HFILL }},
			{ &hf_mgcp_param_connectionparam_pcrpl,
			  { "Remote Packets lost (PC/RPL)", "mgcp_param_connectionparam_pcrpl", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Remote Packets lost (P:PC/RPL)", HFILL }},
			{ &hf_mgcp_param_connectionparam_pcrji,
			  { "Remote Jitter (PC/RJI)", "mgcp_param_connectionparam_pcrji", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Remote Jitter (P:PC/RJI)", HFILL }},
			{ &hf_mgcp_param_connectionparam_x,
			  { "Vendor Extension", "mgcp_param_connectionparam_x", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Vendor Extension (P:X-*)", HFILL }},
			{ &hf_mgcp_param_reasoncode,
			  { "ReasonCode (E)", "mgcp_param_reasoncode", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Reason Code", HFILL }},
			{ &hf_mgcp_param_eventstates,
			  { "EventStates (ES)", "mgcp_param_eventstates", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Event States", HFILL }},
			{ &hf_mgcp_param_specificendpoint,
			  { "SpecificEndpointID (Z)", "mgcp_param_specificendpointid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Specific Endpoint ID", HFILL }},
			{ &hf_mgcp_param_secondendpointid,
			  { "SecondEndpointID (Z2)", "mgcp_param_secondendpointid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Second Endpoint ID", HFILL }},
			{ &hf_mgcp_param_reqinfo,
			  { "RequestedInfo (F)", "mgcp_param_reqinfo", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Requested Info", HFILL }},
			{ &hf_mgcp_param_quarantinehandling,
			  { "QuarantineHandling (Q)", "mgcp_param_quarantinehandling", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Quarantine Handling", HFILL }},
			{ &hf_mgcp_param_detectedevents,
			  { "DetectedEvents (T)", "mgcp_param_detectedevents", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Detected Events", HFILL }},
			{ &hf_mgcp_param_capabilities,
			  { "Capabilities (A)", "mgcp_param_capabilities", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Capabilities", HFILL }},
			{ &hf_mgcp_param_maxmgcpdatagram,
			  {"MaxMGCPDatagram (MD)", "mgcp_param_maxmgcpdatagram", FT_STRING, BASE_NONE, NULL, 0x0,
			   "Maximum MGCP Datagram size", HFILL }},
			{ &hf_mgcp_param_packagelist,
			  {"PackageList (PL)", "mgcp_param_packagelist", FT_STRING, BASE_NONE, NULL, 0x0,
			   "Package List", HFILL }},
			{ &hf_mgcp_param_extension,
			  { "Extension Parameter (non-critical)", "mgcp_param_extension", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Extension Parameter", HFILL }},
			{ &hf_mgcp_param_extension_critical,
			  { "Extension Parameter (critical)", "mgcp_param_extensioncritical", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Critical Extension Parameter", HFILL }},
			{ &hf_mgcp_param_resourceid,
			  { "ResourceIdentifier (DQ-RI)", "mgcp_param_resourceid", FT_STRING, BASE_NONE, NULL, 0x0,
			    "Resource Identifier", HFILL }},
			{ &hf_mgcp_param_invalid,
			  { "Invalid Parameter", "mgcp_param_invalid", FT_STRING, BASE_NONE, NULL, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_messagecount,
			  { "MGCP Message Count", "mgcp_messagecount", FT_UINT32, BASE_DEC, NULL, 0x0,
			    "Number of MGCP message in a packet", HFILL }},
			{ &hf_mgcp_dup,
			  { "Duplicate Message", "mgcp_dup", FT_UINT32, BASE_DEC, NULL, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_req_dup,
			  { "Duplicate Request", "mgcp_req_dup", FT_UINT32, BASE_DEC, NULL, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_req_dup_frame,
			  { "Original Request Frame", "mgcp_req_dup_frame", FT_FRAMENUM, BASE_NONE, NULL, 0x0,
			    "Frame containing original request", HFILL }},
			{ &hf_mgcp_rsp_dup,
			  { "Duplicate Response", "mgcp_rsp_dup", FT_UINT32, BASE_DEC, NULL, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_rsp_dup_frame,
			  { "Original Response Frame", "mgcp_rsp_dup_frame", FT_FRAMENUM, BASE_NONE, NULL, 0x0,
			    "Frame containing original response", HFILL }},
			{ &hf_mgcp_unknown_parameter,
			  { "Unknown parameter", "mgcp_unknown_parameter", FT_STRING, BASE_NONE, NULL, 0x0,
			    NULL, HFILL }},
			{ &hf_mgcp_malformed_parameter,
			  { "Malformed parameter", "mgcp_rsp_malformed_parameter", FT_STRING, BASE_NONE, NULL, 0x0,
			    NULL, HFILL }},
		};
