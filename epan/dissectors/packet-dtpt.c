...
proto_register_dtpt(void)
{
	static hf_register_info hf[] = {
		...
		{ &hf_dtpt_connect_addr,
		  { "Address", "dtpt_connect_addr",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    "Connect to Address", HFILL }},

		{ &hf_dtpt_padding,
		  { "Padding", "dtpt_padding",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},
	};
	static gint *ett[] = {
