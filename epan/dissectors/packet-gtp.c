...
proto_register_gtp(void)
{
    ...
    static hf_register_info hf_gtp[] = {
        ...
        {&hf_gtp_ext_hdr,
         { "Extension header", "gtp_ext_hdr",
           FT_NONE, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_next,
         { "Next extension header type", "gtp_ext_hdr_next",
           FT_UINT8, BASE_HEX, VALS(next_extension_header_fieldvals), 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_ran_cont,
         { "RAN Container", "gtp_ext_hdr_ran_cont",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_spare_bits,
         { "Spare", "gtp_ext_hdr_spare_bits",
           FT_UINT8, BASE_HEX, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_spare_bytes,
         { "Spare", "gtp_ext_hdr_spare_bytes",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_long_pdcp_sn,
         { "Long PDCP Sequence Number", "gtp_ext_hdr_long_pdcp_sn",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_xw_ran_cont,
         { "Xw RAN Container", "gtp_ext_hdr_xw_ran_cont",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },

        { &hf_gtp_ext_hdr_pdu_ses_cont_pdu_type,
         { "PDU Type", "gtp_ext_hdr_pdu_ses_con_pdu_type",
           FT_UINT8, BASE_DEC, VALS(gtp_ext_hdr_pdu_ses_cont_pdu_type_vals), 0xf0,
           NULL, HFILL}
        },
        { &hf_gtp_ext_hdr_pdu_ses_cont_ppp,
         { "Paging Policy Presence (PPP)", "gtp_ext_hdr_pdu_ses_cont_ppp",
           FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x80,
           NULL, HFILL}
        },
        { &hf_gtp_ext_hdr_pdu_ses_cont_rqi,
         { "Reflective QoS Indicator (RQI)", "gtp_ext_hdr_pdu_ses_cont_rqi",
           FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x40,
           NULL, HFILL}
        },
        { &hf_gtp_ext_hdr_pdu_ses_cont_qos_flow_id,
         { "QoS Flow Identifier (QFI)", "gtp_ext_hdr_pdu_ses_con_qos_flow_id",
           FT_UINT8, BASE_DEC, NULL, 0x3f,
           NULL, HFILL}
        },
        { &hf_gtp_ext_hdr_pdu_ses_cont_ppi,
         { "Paging Policy Indicator (PPI)", "gtp_ext_hdr_pdu_ses_cont_ppi",
           FT_UINT8, BASE_DEC, NULL, 0xe0,
           NULL, HFILL}
        },

        {&hf_pdcp_cont,
         { "PDCP Protocol", "gtp_pdcp",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_pdcpsn,
         { "PDCP Sequence Number", "gtp_ext_hdr_pdcp_sn",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_udp_port,
         { "UDP Port", "gtp_ext_hdr_udp_port",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_hdr_length,
         { "Extension Header Length", "gtp_ext_hdr_length",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_flags_ver,
         { "Version", "gtp_flags_version",
           FT_UINT8, BASE_DEC, VALS(ver_types), GTP_VER_MASK,
           "GTP Version", HFILL}
        },
        {&hf_gtp_prime_flags_ver,
         { "Version", "gtp_prim_flags_version",
           FT_UINT8, BASE_DEC,NULL, GTP_VER_MASK,
           "GTP' Version", HFILL}
        },
        {&hf_gtp_flags_pt,
         { "Protocol type", "gtp_flags_payload",
           FT_UINT8, BASE_DEC, VALS(pt_types), GTP_PT_MASK,
           NULL, HFILL}
        },
        {&hf_gtp_flags_spare1,
         { "Reserved", "gtp_flags_reserved",
           FT_UINT8, BASE_DEC, NULL, GTP_SPARE1_MASK,
           "Reserved (shall be sent as '111' )", HFILL}
        },
        {&hf_gtp_flags_hdr_length,
         { "Header length", "gtp_flags_hdr_length",
           FT_BOOLEAN, 8,  TFS(&gtp_hdr_length_vals), 0x01,
           NULL, HFILL}
        },
        {&hf_gtp_flags_snn,
         { "Is SNDCP N-PDU included?", "gtp_flags_snn",
        ...
        {&hf_gtp_qos_ul_mbr,
         {"Uplink Maximum Bit Rate", "gtp_qos_ul_mbr",
          FT_UINT64, BASE_DEC, NULL, 0x0,
          NULL, HFILL}
        },
        {&hf_gtp_qos_dl_mbr,
         {"Downlink Maximum Bit Rate", "gtp_qos_dl_mbr",
          FT_UINT64, BASE_DEC, NULL, 0x0,
          NULL, HFILL}
        },
        {&hf_gtp_qos_ul_gbr,
         {"Uplink Guaranteed Bit Rate", "gtp_qos_ul_gbr",
          FT_UINT64, BASE_DEC, NULL, 0x0,
          NULL, HFILL}
        },
        {&hf_gtp_qos_dl_gbr,
         {"Downlink Guaranteed Bit Rate", "gtp_qos_dl_gbr",
          FT_UINT64, BASE_DEC, NULL, 0x0,
          NULL, HFILL}
        },
        {&hf_gtp_qos_ul_apn_ambr,
         {"Uplink APN Aggregate Maximum Bit Rate", "gtp_qos_ul_apn_ambr",
          FT_UINT32, BASE_DEC, NULL, 0x0,
          NULL, HFILL}
        },
        {&hf_gtp_qos_dl_apn_ambr,
         {"Downlink APN Aggregate Maximum Bit Rate", "gtp_qos_dl_apn_ambr",
          FT_UINT32, BASE_DEC, NULL, 0x0,
          NULL, HFILL}
        },
        {&hf_gtp_pkt_flow_id,
         { "Packet Flow ID", "gtp_pkt_flow_id",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_ptmsi,
        ...
        {&hf_gtp_ptmsi_sig,
         { "P-TMSI Signature", "gtp_ptmsi_sig",
           FT_UINT24, BASE_HEX, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_rab_gtpu_dn,
         { "Downlink GTP-U seq number", "gtp_rab_gtp_dn",
           FT_UINT16, BASE_DEC, NULL, 0,
           "Downlink GTP-U sequence number", HFILL}
        },
        {&hf_gtp_rab_gtpu_up,
         { "Uplink GTP-U seq number", "gtp_rab_gtp_up",
           FT_UINT16, BASE_DEC, NULL, 0,
           "Uplink GTP-U sequence number", HFILL}
        },
        {&hf_gtp_rab_pdu_dn,
         { "Downlink next PDCP-PDU seq number", "gtp_rab_pdu_dn",
           FT_UINT16, BASE_DEC, NULL, 0,
           "Downlink next PDCP-PDU sequence number", HFILL}
        },
        {&hf_gtp_rab_pdu_up,
         { "Uplink next PDCP-PDU seq number", "gtp_rab_pdu_up",
           FT_UINT16, BASE_DEC, NULL, 0,
           "Uplink next PDCP-PDU sequence number", HFILL}
        },
        {&hf_gtp_uli_geo_loc_type,
         { "Geographic Location Type", "gtp_geo_loc_type",
           FT_UINT8, BASE_DEC, VALS(geographic_location_type),  0,
           NULL, HFILL}
        },
        {&hf_gtp_cgi_ci,
         { "Cell ID (CI)", "gtp_cgi_ci",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_sai_sac,
         { "Service Area Code (SAC)", "gtp_sai_sac",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_rai_rac,
         { "Routing Area Code (RAC)", "gtp_rai_rac",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_lac,
         { "Location Area Code (LAC)", "gtp_lac",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        { &hf_gtp_tac,
        ...
        {&hf_gtp_sndcp_number,
         { "SNDCP N-PDU LLC Number", "gtp_sndcp_number",
           FT_UINT8, BASE_HEX, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_tear_ind,
         { "Teardown Indicator", "gtp_tear_ind",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_teid,
        ...
        {&hf_gtp_tr_comm,
         { "Packet transfer command", "gtp_tr_comm",
           FT_UINT8, BASE_DEC, VALS(tr_comm_type), 0,
           NULL, HFILL}
        },
        {&hf_gtp_trace_ref,
         { "Trace reference", "gtp_trace_ref",
           FT_UINT16, BASE_HEX, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_trace_type,
         { "Trace type", "gtp_trace_type",
           FT_UINT16, BASE_HEX, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_user_addr_pdp_org,
         { "PDP type organization", "gtp_user_addr_pdp_org",
           FT_UINT8, BASE_DEC, VALS(pdp_org_type), 0,
           NULL, HFILL}
        },
        {&hf_gtp_user_addr_pdp_type,
         { "PDP type number", "gtp_user_addr_pdp_type",
           FT_UINT8, BASE_HEX, VALS(pdp_type), 0,
           NULL, HFILL}
        },
        {&hf_gtp_user_ipv4,
         { "End user address IPv4", "gtp_user_ipv4",
           FT_IPv4, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_user_ipv6,
         { "End user address IPv6", "gtp_user_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_security_mode,
         { "Security Mode", "gtp_security_mode",
           FT_UINT8, BASE_DEC, VALS(mm_sec_modep), 0xc0,
           NULL, HFILL}
        },
        {&hf_gtp_no_of_vectors,
         { "No of Vectors", "gtp_no_of_vectors",
           FT_UINT8, BASE_DEC, NULL, 0x38,
           NULL, HFILL}
        },
        {&hf_gtp_cipher_algorithm,
         { "Cipher Algorithm", "gtp_cipher_algorithm",
           FT_UINT8, BASE_DEC, VALS(gtp_cipher_algorithm), 0x07,
           NULL, HFILL}
        },
        {&hf_gtp_cksn_ksi,
         { "Ciphering Key Sequence Number (CKSN)/Key Set Identifier (KSI)", "gtp_cksn_ksi",
           FT_UINT8, BASE_DEC, NULL, 0x07,
           "CKSN/KSI", HFILL}
        },
        {&hf_gtp_cksn,
         { "Ciphering Key Sequence Number (CKSN)", "gtp_cksn",
           FT_UINT8, BASE_DEC, NULL, 0x07,
           "CKSN", HFILL}
        },
        {&hf_gtp_ksi,
         { "Key Set Identifier (KSI)", "gtp_ksi",
           FT_UINT8, BASE_DEC, NULL, 0x07,
           "KSI", HFILL}
        },
        {&hf_gtp_ext_length,
         { "Length", "gtp_ext_length",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           "IE Length", HFILL}
        },
        {&hf_gtp_utran_field,
         { "UTRAN Transparent Field", "gtp_utran_field",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_apn_res,
         { "Restriction Type", "gtp_ext_apn_res",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_rat_type,
         { "RAT Type", "gtp_ext_rat_type",
           FT_UINT8, BASE_DEC, VALS(gtp_ext_rat_type_vals), 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_ext_imeisv,
         { "IMEI(SV)", "gtp_ext_imeisv",
           FT_STRING, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_gtp_target_rnc_id,
          { "targetRNC-ID", "gtp_targetRNC_ID",
            FT_UINT16, BASE_HEX, NULL, 0x0fff,
            NULL, HFILL }
        },
        { &hf_gtp_target_ext_rnc_id,
          { "Extended RNC-ID", "gtp_target_ext_RNC_ID",
            FT_UINT16, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        {&hf_gtp_bssgp_cause,
         { "BSSGP Cause", "gtp_bssgp_cause",
           FT_UINT8, BASE_DEC|BASE_EXT_STRING, &bssgp_cause_vals_ext, 0,
           NULL, HFILL}
        },
        { &hf_gtp_bssgp_ra_discriminator,
          { "Routing Address Discriminator", "gtp_bssgp_rad",
            FT_UINT8, BASE_DEC, VALS(gtp_bssgp_ra_discriminator_vals), 0x0f,
            NULL, HFILL }
        },
        {&hf_gtp_sapi,
         { "PS Handover XID SAPI", "gtp_ps_handover_xid_sapi",
           FT_UINT8, BASE_DEC, NULL, 0x0F,
           "SAPI", HFILL}
        },
        {&hf_gtp_xid_par_len,
         { "PS Handover XID parameter length", "gtp_ps_handover_xid_par_len",
           FT_UINT8, BASE_DEC, NULL, 0xFF,
           "XID parameter length", HFILL}
        },
        {&hf_gtp_rep_act_type,
         { "Action", "gtp_ms_inf_chg_rep_act",
           FT_UINT8, BASE_DEC, VALS(chg_rep_act_type_vals), 0xFF,
           NULL, HFILL}
        },
        {&hf_gtp_correlation_id,
         { "Correlation-ID", "gtp_correlation_id",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        {&hf_gtp_earp_pci,
         { "PCI Pre-emption Capability", "gtp_EARP_pre_emption_Capability",
           FT_BOOLEAN, 8, TFS(&tfs_disabled_enabled), 0x40,
           NULL, HFILL}
        },
        {&hf_gtp_earp_pl,
         { "PL Priority Level", "gtp_EARP_priority_level",
           FT_UINT8, BASE_DEC, NULL, 0x3C,
           NULL, HFILL}
        },
        {&hf_gtp_earp_pvi,
         { "PVI Pre-emption Vulnerability", "gtp_EARP_pre_emption_par_vulnerability",
           FT_BOOLEAN, 8, TFS(&tfs_disabled_enabled), 0x01,
           NULL, HFILL}
        },
        {&hf_gtp_ext_comm_flags_uasi,
         { "UASI", "gtp_ext_comm_flags_uasi",
           FT_BOOLEAN, 8, NULL, 0x80,
           NULL, HFILL}
        },
        {&hf_gtp_ext_comm_flags_II_pnsi,
         { "PNSI", "gtp_ext_comm_flags_II_pnsi",
           FT_UINT8, BASE_DEC, NULL, 0x01,
           NULL, HFILL}
        },
        {&hf_gtp_ext_comm_flags_II_dtci,
         { "DTCI", "gtp_ext_comm_flags_II_dtci",
           FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL}
        },
        {&hf_gtp_ext_comm_flags_II_pmtsmi,
         { "PMTSMI", "gtp_ext_comm_flags_II_pmtsmi",
           FT_UINT8, BASE_DEC, NULL, 0x04,
           NULL, HFILL}
        },
        {&hf_gtp_ext_comm_flags_II_spare,
         { "SPARE", "gtp_ext_comm_flags_II_spare",
           FT_UINT8, BASE_HEX, NULL, 0xF8,
           NULL, HFILL}
        },
        {&hf_gtp_cdr_app,
         { "Application Identifier", "gtp_cdr_app",
           FT_UINT8, BASE_DEC, NULL, 0xf0,
           NULL, HFILL}
        },
        { &hf_gtp_cdr_rel,
          { "Release Identifier", "gtp_cdr_rel",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL}
        },
        { &hf_gtp_cdr_ver,
          { "Version Identifier", "gtp_cdr_ver",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_cdr_length,
          { "Length", "gtp_cdr_length",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_cdr_context,
          { "Context", "gtp_cdr_context",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_ppc,
         { "Prohibit Payload Compression", "gtp_cmn_flg_ppc",
           FT_BOOLEAN, 8, NULL, 0x01,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_mbs_srv_type,
         { "MBMS Service Type", "gtp_cmn_flg_mbs_srv_type",
           FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_mbs_ran_pcd_rdy,
         { "RAN Procedures Ready", "gtp_cmn_flg_mbs_ran_pcd_rdy",
           FT_BOOLEAN, 8, NULL, 0x04,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_mbs_cnt_inf,
         { "MBMS Counting Information", "gtp_cmn_flg_mbs_cnt_inf",
           FT_BOOLEAN, 8, NULL, 0x08,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_no_qos_neg,
         { "No QoS negotiation", "gtp_cmn_flg_no_qos_neg",
           FT_BOOLEAN, 8, NULL, 0x10,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_nrsn,
         { "NRSN bit field", "gtp_cmn_flg_nrsn",
           FT_BOOLEAN, 8, NULL, 0x20,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_upgrd_qos_sup,
         { "Upgrade QoS Supported", "gtp_cmn_flg_upgrd_qos_sup",
           FT_BOOLEAN, 8, NULL, 0x40,
           NULL, HFILL}
        },
        {&hf_gtp_cmn_flg_dual_addr_bearer_flg,
         { "Dual Address Bearer Flag", "gtp_cmn_flg_dual_addr_bearer_flg",
           FT_BOOLEAN, 8, NULL, 0x80,
           NULL, HFILL}
        },
        {&hf_gtp_tmgi,
         { "Temporary Mobile Group Identity (TMGI)", "gtp_tmgi",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_no_of_mbms_sa_codes,
         { "Number of MBMS service area codes", "gtp_no_of_mbms_sa_codes",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           "Number N of MBMS service area codes", HFILL}
        },

        {&hf_gtp_mbms_ses_dur_days,
         { "Estimated session duration days", "gtp_mbms_ses_dur_days",
           FT_UINT24, BASE_DEC, NULL, 0x00007F,
           NULL, HFILL}
        },
        {&hf_gtp_mbms_ses_dur_s,
         { "Estimated session duration seconds", "gtp_mbms_ses_dur_s",
           FT_UINT24, BASE_DEC, NULL, 0xFFFF80,
           NULL, HFILL}
        },
        {&hf_gtp_mbms_sa_code,
         { "MBMS service area code", "gtp_mbms_sa_code",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_mbs_2g_3g_ind,
         { "MBMS 2G/3G Indicator", "gtp_mbs_2g_3g_ind",
           FT_UINT8, BASE_DEC, VALS(gtp_mbs_2g_3g_ind_vals), 0x0,
           NULL, HFILL}
        },
        {&hf_gtp_time_2_dta_tr,
         { "Time to MBMS Data Transfer", "gtp_time_2_dta_tr",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
        },
        { &hf_gtp_ext_ei,
          { "Error Indication (EI)", "gtp_ei",
            FT_UINT8, BASE_DEC, NULL, 0x04,
            NULL, HFILL}
        },
        {&hf_gtp_ext_gcsi,
         { "GPRS-CSI (GCSI)", "gtp_gcsi",
           FT_UINT8, BASE_DEC, NULL, 0x02,
           NULL, HFILL}
        },
        { &hf_gtp_ext_dti,
          { "Direct Tunnel Indicator (DTI)", "gtp_dti",
            FT_UINT8, BASE_DEC, NULL, 0x01,
            NULL, HFILL}
        },
        { &hf_gtp_ra_prio_lcs,
          { "Radio Priority LCS", "gtp_raplcs",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL}
        },
        { &hf_gtp_bcm,
          { "Bearer Control Mode", "gtp_bcm",
        ...
        { &hf_gtp_rim_routing_addr,
          { "RIM Routing Address value", "gtp_rim_routing_addr_val",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL}
        },
        { &hf_gtp_mbms_flow_id,
          { "MBMS Flow Identifier", "gtp_mbms_flow_id",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL}
        },
        { &hf_gtp_mbms_dist_indic,
          { "Distribution Indication", "gtp_mbms_dist_indic",
            FT_UINT8, BASE_DEC, VALS(gtp_mbms_dist_indic_vals), 0x03,
            NULL, HFILL}
        },
        { &hf_gtp_ext_apn_ambr_ul,
          { "APN-AMBR for Uplink", "gtp_apn_ambr_ul",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_apn_ambr_dl,
          { "APN-AMBR for Downlink", "gtp_apn_ambr_dl",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_sub_ue_ambr_ul,
          { "Subscribed UE-AMBR for Uplink", "gtp_sub_ue_ambr_ul",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_sub_ue_ambr_dl,
          { "Subscribed UE-AMBR for Downlink", "gtp_sub_ue_ambr_dl",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_auth_ue_ambr_ul,
          { "Authorized UE-AMBR for Uplink", "gtp_auth_ue_ambr_ul",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_auth_ue_ambr_dl,
          { "Authorized UE-AMBR for Downlink", "gtp_auth_ue_ambr_dl",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_auth_apn_ambr_ul,
          { "Authorized APN-AMBR for Uplink", "gtp_auth_apn_ambr_ul",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_auth_apn_ambr_dl,
          { "Authorized APN-AMBR for Downlink", "gtp_auth_apn_ambr_dl",
            FT_INT32, BASE_DEC|BASE_UNIT_STRING, &units_kbps, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_ggsn_back_off_time_units,
          { "Timer unit", "gtp_ggsn_back_off_time_units",
            FT_UINT8, BASE_DEC, VALS(gtp_ggsn_back_off_time_units_vals), 0xe0,
            NULL, HFILL}
        },
        { &hf_gtp_ext_ggsn_back_off_timer,
          { "Timer value", "gtp_ggsn_back_off_timer",
            FT_UINT8, BASE_DEC, NULL, 0x1f,
            NULL, HFILL}
        },
        { &hf_gtp_higher_br_16mb_flg,
          { "Higher bitrates than 16 Mbps flag", "gtp_higher_br_16mb_flg",
            FT_UINT8, BASE_DEC, VALS(gtp_higher_br_16mb_flg_vals), 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_max_mbr_apn_ambr_ul,
          { "Max MBR/APN-AMBR for uplink", "gtp_max_mbr_apn_ambr_ul",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL}
        },
        { &hf_gtp_max_mbr_apn_ambr_dl,
          { "Max MBR/APN-AMBR for downlink", "gtp_max_mbr_apn_ambr_dl",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL}
        },

      { &hf_gtp_rand, { "RAND", "gtp_rand", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_sres, { "SRES", "gtp_sres", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_kc, { "Kc", "gtp_kc", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_xres_length, { "XRES length", "gtp_xres_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_xres, { "XRES", "gtp_xres", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_quintuplet_ciphering_key, { "Quintuplet Ciphering Key", "gtp_quintuplet_ciphering_key", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_quintuplet_integrity_key, { "Quintuplet Integrity Key", "gtp_quintuplet_integrity_key", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_authentication_length, { "Authentication length", "gtp_authentication_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_auth, { "AUTH", "gtp_auth", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ciphering_key_ck, { "Ciphering key CK", "gtp_ciphering_key_ck", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_integrity_key_ik, { "Integrity key IK", "gtp_integrity_key_ik", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_quintuplets_length, { "Quintuplets length", "gtp_quintuplets_length", FT_UINT16, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ciphering_key_kc, { "Ciphering key Kc", "gtp_ciphering_key_kc", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_container_length, { "Container length", "gtp_container_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_extended_end_user_address, { "Extended End User Address", "gtp_extended_end_user_address", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80, NULL, HFILL }},
      { &hf_gtp_vplmn_address_allowed, { "VPLMN address allowed", "gtp_vplmn_address_allowed", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40, NULL, HFILL }},
      { &hf_gtp_activity_status_indicator, { "Activity Status Indicator", "gtp_activity_status_indicator", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20, NULL, HFILL }},
      { &hf_gtp_reordering_required, { "Reordering required", "gtp_reordering_required", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10, NULL, HFILL }},
      { &hf_gtp_pdp_cntxt_sapi, { "SAPI", "gtp_pdp_cntxt_sapi", FT_UINT8, BASE_DEC, NULL, 0x0F, NULL, HFILL }},
      { &hf_gtp_sequence_number_down, { "Sequence number down", "gtp_sequence_number_down", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_sequence_number_up, { "Sequence number up", "gtp_sequence_number_up", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_send_n_pdu_number, { "Send N-PDU number", "gtp_send_n_pdu_number", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_receive_n_pdu_number, { "Receive N-PDU number", "gtp_receive_n_pdu_number", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_uplink_flow_label_signalling, { "Uplink flow label signalling", "gtp_uplink_flow_label_signalling", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_pdp_context_identifier, { "PDP context identifier", "gtp_pdp_context_identifier", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_pdp_organization, { "PDP organization", "gtp_pdp_organization", FT_UINT8, BASE_DEC, VALS(pdp_type), 0x0F, NULL, HFILL }},
      { &hf_gtp_pdp_type, { "PDP type", "gtp_pdp_type", FT_UINT8, BASE_DEC, VALS(pdp_type), 0x0, NULL, HFILL }},
      { &hf_gtp_pdp_address_length, { "PDP address length", "gtp_pdp_address_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_pdp_address_ipv4, { "PDP address", "gtp_pdp_address_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_pdp_address_ipv6, { "PDP address", "gtp_pdp_address_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ggsn_address_length, { "GGSN address length", "gtp_ggsn_address_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ggsn_address_for_control_plane_ipv4, { "GGSN Address for control plane", "gtp_ggsn_address_for_control_plane_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ggsn_address_for_control_plane_ipv6, { "GGSN Address for control plane", "gtp_ggsn_address_for_control_plane_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ggsn_address_for_user_traffic_ipv4, { "GGSN Address for User Traffic", "gtp_ggsn_address_for_user_traffic_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ggsn_address_for_user_traffic_ipv6, { "GGSN Address for User Traffic", "gtp_ggsn_address_for_user_traffic_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_apn_length, { "APN length", "gtp_apn_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_transaction_identifier, { "Transaction identifier", "gtp_transaction_identifier", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_gsn_address_length, { "GSN address length", "gtp_gsn_address_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_gsn_address_information_element_length, { "GSN address Information Element length", "gtp_gsn_address_information_element_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_tft_length, { "TFT length", "gtp_tft_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_rab_setup_length, { "RAB setup length", "gtp_rab_setup_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_timezone, { "Timezone", "gtp_timezone", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_timezone_dst, { "DST", "gtp_timezone_dst", FT_UINT8, BASE_DEC, VALS(daylight_saving_time_vals), 0x03, NULL, HFILL }},
      { &hf_gtp_rfsp_index, { "RFSP Index", "gtp_rfsp_index", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_fqdn_length, { "FQDN length", "gtp_fqdn_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_number_of_data_records, { "Number of data records", "gtp_number_of_data_records", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_data_record_format, { "Data record format", "gtp_data_record_format", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_node_address_length, { "Node address length", "gtp_node_address_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_seq_num_released, { "Sequence number released", "gtp_seq_num_released", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_seq_num_canceled, { "Sequence number cancelled", "gtp_seq_num_canceled", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_requests_responded, { "Requests responded", "gtp_requests_responded", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_hyphen_separator, { "Hyphen separator: -", "gtp_hyphen_separator", FT_NONE, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ms_network_cap_content_len, { "Length of MS network capability contents", "gtp_ms_network_cap_content_len", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_iei, { "IEI", "gtp_iei", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_iei_mobile_id_len, { "Length", "gtp_iei_mobile_id_len", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_qos_umts_length, { "Length", "gtp_qos_umts_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_num_ext_hdr_types, { "Number of Extension Header Types in list (i.e., length)", "gtp_num_ext_hdr_types", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_gtp_ext_hdr_type, { "Extension Header Type", "gtp_ext_hdr_type", FT_UINT8, BASE_DEC, VALS(next_extension_header_fieldvals), 0x0, NULL, HFILL }},
      { &hf_gtp_tpdu_data, { "T-PDU Data", "gtp_tpdu_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL } },
      { &hf_gtp_ext_enb_type, { "enb_type", "gtp_enb_type", FT_UINT8, BASE_DEC, VALS(gtp_enb_type_vals), 0x0, NULL, HFILL } },
      { &hf_gtp_macro_enodeb_id,
      { "Macro eNodeB ID", "gtp_macro_enodeb_id",
      FT_UINT24, BASE_HEX, NULL, 0x0fffff,
      NULL, HFILL }
      },
      { &hf_gtp_home_enodeb_id,
      { "Home eNodeB ID", "gtp_home_enodeb_id",
      FT_UINT32, BASE_HEX, NULL, 0x0fffffff,
      NULL, HFILL }
      },
      { &hf_gtp_dummy_octets,
      { "Dummy octets", "gtp_dummy_octets",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
      },
      { &hf_gtp_spare_b4b0,
      { "Spare", "gtp_spare_b4b0",
      FT_UINT8, BASE_HEX, NULL, 0x1f,
      NULL, HFILL }
      },
      { &hf_gtp_spare_b7b6,
      { "Spare", "gtp_spare_b7b6",
      ...
      { "RNC IP address", "gtp_rnc_ip_addr_v4",
      FT_IPv4, BASE_NONE, NULL, 0x0,
      NULL, HFILL }
      },
      { &hf_gtp_rnc_ip_addr_v6,
      { "RNC IP address", "gtp_rnc_ip_addr_v6",
      FT_IPv6, BASE_NONE, NULL, 0x0,
      NULL, HFILL }
      },
      { &hf_gtp_ms_cm_2_len,
      { "Length of the Mobile Station Classmark 2", "gtp_ms_cm_2_len",
      FT_UINT8, BASE_DEC, NULL, 0x0,
      NULL, HFILL }
      },
      { &hf_gtp_ms_cm_3_len,
      { "Length of the Mobile Station Classmark 3", "gtp_ms_cm_3_len",
      FT_UINT8, BASE_DEC, NULL, 0x0,
      NULL, HFILL }
      },
      { &hf_gtp_sup_codec_lst_len,
      { "Length of the Supported Codec List", "gtp_sup_codec_lst_len",
      FT_UINT8, BASE_DEC, NULL, 0x0,
      NULL, HFILL }
      },
      { &hf_gtp_add_flg_for_srvcc_ics,
      { "ICS (IMS Centralized Service)", "gtp_add_flg_for_srvcc_ics",
      FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x01,
      NULL, HFILL }
      },
      { &hf_gtp_sel_mode_val,
      { "Selection Mode Value", "gtp_sel_mode_val",
   ...
   static hf_register_info hf_nrup[] =
   {
      ...
      {&hf_nrup_retransmission_flag,
        { "Retransmission Flag", "nrup_retransmission_flag",
      ...
      { &hf_nrup_ass_inf_rep_poll_flag,
        { "Assistance Info. Report Polling Flag", "nrup_ass_inf_rep_poll_flag",
      ...
      { &hf_nrup_request_out_of_seq_report,
        { "Request Out Of Seq Report", "nrup_request_out_of_seq_report",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
           NULL, HFILL}
      },

      {&hf_nrup_report_delivered,
         { "Report Delivered", "nrup_report_delivered",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
           "Presence of DL report NR PDCP PDU SN", HFILL}
      },
      {&hf_nrup_user_data_existence_flag,
         { "User Data Existence Flag", "nrup_user_data_existence_flag",
      ...
      {&hf_nrup_nr_u_seq_num,
         { "NR-U Sequence Number", "nrup_seq_num",
           FT_UINT24, BASE_DEC, NULL, 0,
           "NR-U sequence number as assigned by the node hosting the NR PDCP entity", HFILL}
      },
      {&hf_nrup_dl_disc_nr_pdcp_pdu_sn,
         { "DL discard NR PDCP PDU SN", "nrup_dl_disc_nr_pdcp_pdu_sn",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_dl_disc_num_blks,
         { "DL discard Number of blocks", "nrup_dl_disc_num_blks",
           FT_UINT8, BASE_DEC, NULL, 0xff,
           NULL, HFILL}
      },
      {&hf_nrup_dl_disc_nr_pdcp_pdu_sn_start,
         { "DL discard NR PDCP PDU SN Start", "nrup_dl_disc_nr_pdcp_pdu_sn_start",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_dl_disc_blk_sz,
         { "Discarded block size", "nrup_disc_blk_sz",
           FT_UINT8, BASE_DEC, NULL, 0,
           "The number of NR PDCP PDUs counted from the starting SN to be discarded", HFILL}
      },
       {&hf_nrup_dl_report_nr_pdcp_pdu_sn,
          { "DL report NR PDCP PDU SN", "nrup_dl_report_nr_pdcp_pdu_sn",
            FT_UINT24, BASE_DEC, NULL, 0,
            "DL delivery status report wanted when this SN has been delivered", HFILL}
       },

      {&hf_nrup_high_tx_nr_pdcp_sn_ind,
         { "Highest Transmitted NR PDCP SN Ind", "nrup_high_tx_nr_pdcp_sn_ind",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
           NULL, HFILL}
      },
      {&hf_nrup_high_delivered_nr_pdcp_sn_ind,
         { "Highest Delivered NR PDCP SN Ind", "nrup_high_delivered_nr_pdcp_sn_ind",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
           NULL, HFILL}
      },
      {&hf_nrup_final_frame_ind,
         { "Final Frame Indication", "nrup_final_frame_ind",
           FT_BOOLEAN, 8, TFS(&tfs_final_frame_indication), 0x02,
           "Whether the frame is the last DL status report", HFILL}
      },
      {&hf_nrup_lost_pkt_rpt,
         { "Lost Packet Report", "nrup_lost_pkt_rpt",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
           "Indicates the presence of Number of lost NR-U Sequence Number ranges reported" , HFILL}
      },
      {&hf_nrup_high_retx_nr_pdcp_sn_ind,
         { "Highest Retransmitted NR PDCP SN Ind", "nrup_high_retx_nr_pdcp_sn_ind",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
           NULL, HFILL}
      },
      {&hf_nrup_cause_rpt,
         { "Cause Report", "nrup_cause_rpt",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
           "Presence of Cause Value", HFILL}
      },
      {&hf_nrup_delivered_nr_pdcp_sn_range_ind,
         { "Delivered NR PDCP SN Range Ind", "nrup_delivered_nr_pdcp_sn_range_ind",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
           NULL, HFILL}
      },
      {&hf_nrup_data_rate_ind,
         { "Data Rate Ind", "nrup_data_rate_ind",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
           NULL, HFILL}
      },
      {&hf_nrup_desrd_buff_sz_data_radio_bearer,
         { "Desired buffer size for the data radio bearer", "nrup_desrd_buff_sz_data_radio_bearer",
           FT_UINT32, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_high_delivered_retx_nr_pdcp_sn_ind,
         { "Highest Delivered Retransmitted NR PDCP SN Ind", "nrup_high_delivered_retx_nr_pdcp_sn_ind",
           FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
           NULL, HFILL}
      },
      {&hf_nrup_desrd_data_rate,
         { "Desired data rate", "nrup_desrd_data_rate",
           FT_UINT32, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_num_lost_nru_seq_num,
         { "Number of lost NR-U Sequence Number ranges reported", "nrup_num_lost_nru_seq_num",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_start_lost_nru_seq_num,
         { "Start of lost NR-U Sequence Number range", "nrup_start_num_lost_nru_seq_num",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_end_lost_nru_seq_num,
         { "End of lost NR-U Sequence Number range", "nrup_end_num_lost_nru_seq_num",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_high_success_delivered_nr_pdcp_sn,
         { "Highest Successfully Delivered NR PDCP SN", "nrup_high_success_delivered_nr_pdcp_sn",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_high_tx_nr_pdcp_sn,
         { "Highest transmitted NR PDCP SN", "nrup_high_tx_nr_pdcp_sn",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_cause_val ,
         { "Cause Value", "nrup_cause_val",
      ...
      {&hf_nrup_high_success_delivered_retx_nr_pdcp_sn,
         { "Highest Successfully Delivered Retransmitted NR PDCP SN", "nrup_high_success_delivered_retx_nr_pdcp_sn",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },
      {&hf_nrup_high_retx_nr_pdcp_sn,
         { "Highest Retransmitted NR PDCP SN Ind", "nrup_high_retx_nr_pdcp_sn",
           FT_UINT24, BASE_DEC, NULL, 0,
           NULL, HFILL}
      },

      {&hf_nrup_pdcp_duplication_ind,
         { "PDCP Duplication Indication", "nrup_pdcp_duplication_ind",
           FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x08,
           NULL, HFILL}
      },
      {&hf_nrup_assistance_information_ind,
         { "Assistance Information Indication", "nrup_assistance_information_ind",
           FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x04,
           NULL, HFILL}
      },
      {&hf_nrup_ul_delay_ind,
         { "UL Delay Indicator", "nrup_ul_delay_ind",
           FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x02,
           NULL, HFILL}
      },
      {&hf_nrup_dl_delay_ind,
         { "DL Delay Indicator", "nrup_dl_delay_ind",
      ...
      {&hf_nrup_pdcp_duplication_activation_suggestion,
         { "PDCP Duplication Activation Suggestion", "nrup_pdcp_duplication_activation_suggestion",
           FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x01,
           NULL, HFILL}
      },
      {&hf_nrup_num_assistance_info_fields,
         { "Number of Assistance Information Fields", "nrup_num_assistance_info_fields",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
      },
      {&hf_nrup_assistance_information_type,
         { "Assistance Information Type", "nrup_assistance_info_type",
           FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(assistance_info_type), 0x0,
           NULL, HFILL}
      },
      {&hf_nrup_num_octets_radio_qa_info,
         { "Number of octets for Radio Quality Assistance Information Fields", "nrup_num_octets_radio_qa_info",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
      },
      {&hf_nrup_radio_qa_info,
         { "Radio Quality Assistance Information", "nrup_radio_qa_info",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL}
      },
      {&hf_nrup_ul_delay_du_result,
         { "UL Delay DU Result", "nrup_ul_delay_du_result",
           FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
      },
      {&hf_nrup_dl_delay_du_result,
         { "DL Delay DU Result", "nrup_dl_delay_du_result",
           FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL}
      }
    };
