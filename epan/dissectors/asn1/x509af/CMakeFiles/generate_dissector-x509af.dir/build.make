...
epan/dissectors/asn1/x509af/packet-x509af-stamp: epan/dissectors/asn1/x509sat/x509sat-exp.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/CLionProjects/tshark_test/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-x509af-stamp"
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509af && /usr/bin/python3.6 /root/CLionProjects/tshark_test/tools/asn2wrs.py -b -p x509af -c /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509af/x509af.cnf -s /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509af/packet-x509af-template -D /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509af -O /root/CLionProjects/tshark_test/epan/dissectors AuthenticationFramework.asn
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509af && /usr/bin/python3.6 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /root/CLionProjects/tshark_test/epan/dissectors/packet-x509af.c packet-x509af-stamp
...
epan/dissectors/asn1/x509af/CMakeFiles/generate_dissector-x509af.dir/clean:
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509af && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-x509af.dir/cmake_clean.cmake
