...
epan/dissectors/asn1/x509if/packet-x509if-stamp: epan/dissectors/asn1/x509sat/x509sat-exp.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/CLionProjects/tshark_test/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-x509if-stamp"
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if && /usr/bin/python3.6 /root/CLionProjects/tshark_test/tools/asn2wrs.py -b -p x509if -c /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if/x509if.cnf -s /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if/packet-x509if-template -D /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if -O /root/CLionProjects/tshark_test/epan/dissectors InformationFramework.asn ServiceAdministration.asn
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if && /usr/bin/python3.6 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /root/CLionProjects/tshark_test/epan/dissectors/packet-x509if.c packet-x509if-stamp
...
epan/dissectors/asn1/x509if/CMakeFiles/generate_dissector-x509if.dir/clean:
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-x509if.dir/cmake_clean.cmake
...
epan/dissectors/asn1/x509if/CMakeFiles/generate_dissector-x509if.dir/depend:
	cd /root/CLionProjects/tshark_test && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/CLionProjects/tshark_test /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if /root/CLionProjects/tshark_test /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if /root/CLionProjects/tshark_test/epan/dissectors/asn1/x509if/CMakeFiles/generate_dissector-x509if.dir/DependInfo.cmake --color=$(COLOR)
