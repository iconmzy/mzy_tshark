...
epan/dissectors/asn1/s1ap/packet-s1ap-stamp: epan/dissectors/asn1/s1ap/s1ap.cnf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/root/CLionProjects/tshark_test/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating packet-s1ap-stamp"
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap && /usr/bin/python3.6 /root/CLionProjects/tshark_test/tools/asn2wrs.py -p s1ap -c /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap/s1ap.cnf -s /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap/packet-s1ap-template -D /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap -O /root/CLionProjects/tshark_test/epan/dissectors S1AP-CommonDataTypes.asn S1AP-Constants.asn S1AP-Containers.asn S1AP-IEs.asn S1AP-PDU-Contents.asn S1AP-PDU-Descriptions.asn S1AP-SonTransfer-IEs.asn
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap && /usr/bin/python3.6 -c "import shutil, sys; x,s,d=sys.argv; open(d, 'w'); shutil.copystat(s, d)" /root/CLionProjects/tshark_test/epan/dissectors/packet-s1ap.c packet-s1ap-stamp
...
epan/dissectors/asn1/s1ap/CMakeFiles/generate_dissector-s1ap.dir/clean:
	cd /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap && $(CMAKE_COMMAND) -P CMakeFiles/generate_dissector-s1ap.dir/cmake_clean.cmake
...
epan/dissectors/asn1/s1ap/CMakeFiles/generate_dissector-s1ap.dir/depend:
	cd /root/CLionProjects/tshark_test && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/CLionProjects/tshark_test /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap /root/CLionProjects/tshark_test /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap /root/CLionProjects/tshark_test/epan/dissectors/asn1/s1ap/CMakeFiles/generate_dissector-s1ap.dir/DependInfo.cmake --color=$(COLOR)
