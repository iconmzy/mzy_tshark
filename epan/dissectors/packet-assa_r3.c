...
void proto_register_r3 (void)
{
  ...
  static hf_register_info hf [] =
    {
      { &hf_r3_tildex3ds,
        { "DPAC Attention", "r3_dpac_attention",
      ...
      { &hf_r3_packetnumber,
        { "Packet Number", "r3_packetnumber",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_packetlength,
        { "Packet Length", "r3_packetlength",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_encryption,
        { "Crypt Type", "r3_encryption",
      ...
      { &hf_r3_commandlength,
        { "Command Length", "r3_command_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_command,
        { "Command", "r3_command_command",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_cmdnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_commanddata,
        { "Command Data", "r3_command_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_commandmfglength,
        { "Mfg Command Length", "r3_commandmfg_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_commandmfg,
        { "Mfg Command", "r3_commandmfg_command",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_cmdmfgnames_ext, 0x0,
          NULL, HFILL }
      },
#if 0
      { &hf_r3_commandmfgdata,
        { "Mfg Command Data", "r3_commandmfg_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
#endif
      ...
      { &hf_r3_responselength,
        { "Response Length", "r3_response_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_responsecommand,
        { "Response Command", "r3_response_command",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_cmdnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_responsetype,
        { "Response Type", "r3_response_responsetype",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_responsetypenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_responsetocommand,
        { "Response To Command", "r3_response_to_command",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_cmdnames_ext, 0x0,
          NULL, HFILL }
      },
#if 0
      { &hf_r3_responsedata,
        { "Response Data", "r3_response_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
#endif
      ...
      { &hf_r3_eventlog_hour,
        { "Hours", "r3_eventlog_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlog_minute,
        { "Minutes", "r3_eventlog_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlog_second,
        { "Seconds", "r3_eventlog_seconds",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlog_usernumber,
        { "User Number", "r3_eventlog_usernumber",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      ...
      { &hf_r3_declinedlog_recordnumber,
        { "Record Number", "r3_declinedlog_recordnumber",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_year,
        { "Year", "r3_declinedlog_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_month,
        { "Month", "r3_declinedlog_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_day,
        { "Day", "r3_declinedlog_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_hour,
        { "Hours", "r3_declinedlog_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_minute,
        { "Minutes", "r3_declinedlog_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_second,
        { "Seconds", "r3_declinedlog_seconds",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_usernumber,
        { "User Number", "r3_declinedlog_usernumber",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_cred1type,
        { "Credential 1 Type", "r3_declinedlog_cred1type",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_fieldtypenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_cred2type,
        { "Credential 2 Type", "r3_declinedlog_cred2type",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_fieldtypenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_cred1,
        { "Credential 1", "r3_declinedlog_cred1",
          FT_BYTES, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlog_cred2,
        { "Credential 2", "r3_declinedlog_cred2",
          FT_BYTES, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_alarmlog_recordnumber,
        { "Record Number", "r3_alarmlog_recordnumber",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlog_year,
        { "Year", "r3_alarmlog_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlog_month,
        { "Month", "r3_alarmlog_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlog_day,
      ...
      { &hf_r3_alarmlog_hour,
        { "Hours", "r3_alarmlog_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlog_minute,
        { "Minutes", "r3_alarmlog_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlog_second,
        { "Seconds", "r3_alarmlog_seconds",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlog_id,
      ...
      { &hf_r3_alarmlog_usernumber,
        { "User Number", "r3_alarmlog_usernumber",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_debugmsg,
        { "Debug Message", "r3_debug",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_setdate_year,
        { "Year", "r3_setdate_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_setdate_month,
        { "Month", "r3_setdate_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_setdate_day,
      ...
      { &hf_r3_setdate_dow,
        { "Day-Of-Week", "r3_setdate_dow",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_daynames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_setdate_hours,
        { "Hours", "r3_setdate_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_setdate_minutes,
        { "Minutes", "r3_setdate_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_setdate_seconds,
        { "Seconds", "r3_setdate_seconds",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_deleteusers,
        { "Delete Users", "r3_deleteusers",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_deleteusersnames_ext, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_defineexception_number,
        { "Exception Number", "r3_defineexception_number",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_startdate_month,
        { "Start Month", "r3_defineexception_start_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_startdate_day,
        { "Start Day", "r3_defineexception_start_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_startdate_hours,
        { "Start Hours", "r3_defineexception_start_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_startdate_minutes,
        { "Start Minutes", "r3_defineexception_start_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_enddate_month,
        { "End Month", "r3_defineexception_end_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_enddate_day,
        { "End Day", "r3_defineexception_end_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_enddate_hours,
        { "End Hours", "r3_defineexception_end_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexception_enddate_minutes,
        { "End Minutes", "r3_defineexception_end_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_defineexceptiongroup_number,
        { "Define Exception Group Number", "r3_defineexceptiongroup_number",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_defineexceptiongroup_bits,
        { "Define Exception Group Bit Field", "r3_defineexceptiongroup_field",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_definecalendar_number,
        { "Define Calendar Number", "r3_definecalendar_number",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definecalendar_bits,
        { "Define Calendar Bit Field", "r3_definecalendar_field",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_definetimezone_number,
        { "Timezone Number", "r3_definetimezone_number",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_starttime_hours,
        { "Start Hours", "r3_definetimezone_start_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_starttime_minutes,
        { "Start Minutes", "r3_definetimezone_start_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_endtime_hours,
        { "End Hours", "r3_definetimezone_end_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_endtime_minutes,
        { "End Minutes", "r3_definetimezone_end_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap,
        { "Day Map", "r3_definetimezone_daymap",
          FT_UINT8, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap0,
        { "Sunday", "r3_definetimezone_daymap_sunday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000001,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap1,
        { "Monday", "r3_definetimezone_daymap_monday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000002,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap2,
        { "Tuesday", "r3_definetimezone_daymap_tuesday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000004,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap3,
        { "Wednesday", "r3_definetimezone_daymap_wednesday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000008,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap4,
        { "Thursday", "r3_definetimezone_daymap_thursday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000010,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap5,
        { "Friday", "r3_definetimezone_daymap_friday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000020,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_daymap6,
        { "Saturday", "r3_definetimezone_daymap_saturday",
          FT_BOOLEAN, 8, TFS (&tfs_enabled_disabled), 0x00000040,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_exceptiongroup,
        { "Exception Group", "r3_definetimezone_exceptiongroup",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_mode,
        { "Mode", "r3_definetimezone_mode",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_timezonemodenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_definetimezone_calendar,
        { "Calendar", "r3_definetimezone_calendar",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_rmtauthretry_sequence,
        { "Remote Auth Retry Sequence", "r3_rmtauthretry_sequence",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_rmtauthretry_retry,
        { "Remote Auth Retry Mode", "r3_rmtauthretry_mode",
          FT_BOOLEAN, BASE_NONE, TFS (&tfs_rmtauthretry_flags), 0x0,
          NULL, HFILL }
      },

      { &hf_r3_eventlogdump_starttime_year,
        { "Start Year", "r3_eventlogdump_start_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_starttime_month,
        { "Start Month", "r3_eventlogdump_start_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_starttime_day,
        { "Start Day", "r3_eventlogdump_start_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_starttime_hours,
        { "Start Hours", "r3_eventlogdump_start_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_starttime_minutes,
        { "Start Minutes", "r3_eventlogdump_start_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_endtime_year,
        { "End Year", "r3_eventlogdump_end_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_endtime_month,
        { "End Month", "r3_eventlogdump_end_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_endtime_day,
        { "End Day", "r3_eventlogdump_end_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_endtime_hours,
        { "End Hours", "r3_eventlogdump_end_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_endtime_minutes,
        { "End Minutes", "r3_eventlogdump_end_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_eventlogdump_user,
        { "Filter User", "r3_eventlogdump_user",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_declinedlogdump_starttime_year,
        { "Start Year", "r3_declinedlogdump_start_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_starttime_month,
        { "Start Month", "r3_declinedlogdump_start_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_starttime_day,
        { "Start Day", "r3_declinedlogdump_start_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_starttime_hours,
        { "Start Hours", "r3_declinedlogdump_start_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_starttime_minutes,
        { "Start Minutes", "r3_declinedlogdump_start_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_endtime_year,
        { "End Year", "r3_declinedlogdump_end_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_endtime_month,
        { "End Month", "r3_declinedlogdump_end_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_endtime_day,
        { "End Day", "r3_declinedlogdump_end_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_endtime_hours,
        { "End Hours", "r3_declinedlogdump_end_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_declinedlogdump_endtime_minutes,
        { "End Minutes", "r3_declinedlogdump_end_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_alarmlogdump_starttime_year,
        { "Start Year", "r3_alarmlogdump_start_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_starttime_month,
        { "Start Month", "r3_alarmlogdump_start_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_starttime_day,
        { "Start Day", "r3_alarmlogdump_start_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_starttime_hours,
        { "Start Hours", "r3_alarmlogdump_start_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_starttime_minutes,
        { "Start Minutes", "r3_alarmlogdump_start_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_endtime_year,
        { "End Year", "r3_alarmlogdump_end_year",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_endtime_month,
        { "End Month", "r3_alarmlogdump_end_month",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_monthnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_endtime_day,
        { "End Day", "r3_alarmlogdump_end_day",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_endtime_hours,
        { "End Hours", "r3_alarmlogdump_end_hours",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_alarmlogdump_endtime_minutes,
        { "End Minutes", "r3_alarmlogdump_end_minutes",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_nvramclearoptions,
        { "NVRAM Clean Options", "r3_nvramclear",
          FT_UINT16, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions0,
        { "NVRAMCLEAROPTIONS_CFGINSTALLER", "r3_nvramclear_cfginstaller",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000001,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions1,
        { "NVRAMCLEAROPTIONS_CFGADMIN", "r3_nvramclear_cfgadmin",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000002,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions2,
        { "NVRAMCLEAROPTIONS_EXCEPTIONS", "r3_nvramclear_exceptions",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000004,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions3,
        { "NVRAMCLEAROPTIONS_EXCEPTIONGROUPS", "r3_nvramclear_exceptiongroups",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000008,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions4,
        { "NVRAMCLEAROPTIONS_CALENDARS", "r3_nvramclear_calendars",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000010,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions5,
        { "NVRAMCLEAROPTIONS_TIMEZONES", "r3_nvramclear_timezones",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000020,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions6,
        { "NVRAMCLEAROPTIONS_FILTERS", "r3_nvramclear_filters",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000040,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions7,
        { "NVRAMCLEAROPTIONS_EVENTLOG", "r3_nvramclear_eventlog",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000080,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions8,
        { "NVRAMCLEAROPTIONS_USERDATA", "r3_nvramclear_userdata",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000100,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions9,
        { "NVRAMCLEAROPTIONS_DECLINEDLOG", "r3_nvramclear_declinedlog",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000200,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions10,
        { "NVRAMCLEAROPTIONS_ALARMLOG", "r3_nvramclear_alarmlog",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000400,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions11,
        { "NVRAMCLEAROPTIONS_LRUCACHE", "r3_nvramclear_lrucache",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00000800,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions12,
        { "NVRAMCLEAROPTIONS_DBHASH", "r3_nvramclear_dbhash",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00001000,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions13,
        { "NVRAMCLEAROPTIONS_CFGSYSTEM", "r3_nvramclear_cfgsystem",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00002000,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions14,
        { "NVRAMCLEAROPTIONS_UNUSED", "r3_nvramclear_unused",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00004000,
          NULL, HFILL }
      },
      { &hf_r3_nvramclearoptions15,
        { "NVRAMCLEAROPTIONS_USEBACKUP", "r3_nvramclear_usebackup",
          FT_BOOLEAN, 16, TFS (&tfs_enabled_disabled), 0x00008000,
          NULL, HFILL }
      },

      { &hf_r3_writeeventlog_user,
        { "User", "r3_writeeventlog_user",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_writeeventlog_event,
        { "Event", "r3_writeeventlog_event",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_eventnames_ext, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_powertableselection,
        { "Table", "r3_powertableselection",
      ...
      { &hf_r3_dpac_action,
        { "Dpac Action", "r3_dpac_action",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_dpac_waittime,
        { "Dpac Waittime", "r3_dpac_waittime",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_dpac_command,
        { "Dpac Command", "r3_dpac_command",
          FT_BYTES, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_dpacreply_stuff,
        { "Dpac Reply Stuff", "r3_dpacreply_stuff",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_dpacreply_length,
        { "Dpac Reply Length", "r3_dpacreply_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_dpacreply_reply,
        { "Dpac Reply", "r3_dpacreply_reply",
          FT_BYTES, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      ...
      { &hf_r3_mfgfield_length,
        { "Field Length", "r3_mfgfield_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_mfgfield,
        { "Field", "r3_mfgfield_field",
          FT_UINT8, BASE_DEC_HEX|BASE_EXT_STRING, &r3_mfgfieldnames_ext, 0x0,
          NULL, HFILL }
      },
#if 0
      { &hf_r3_mfgfield_data,
        { "Field Data", "r3_mfgfield_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
#endif
      ...
      { &hf_r3_hardwareid_board,
        { "Board ID", "r3_hardwareid_board",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_hardwareid_cpuid,
        { "CPU ID", "r3_hardwareid_cpuid",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_hardwareid_cpurev,
        { "CPU Rev", "r3_hardwareid_cpurev",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_testkeypad,
        { "Keypad Char", "r3_test_keypad",
          FT_UINT8, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_testmagcard,
        { "Mag Card", "r3_test_magcard",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_testproxcard,
        { "Prox Card", "r3_test_proxcard",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_nvramdump_record,
        { "Record Number", "r3_nvramdump_record",
          FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_nvramdump_length,
        { "Record Length", "r3_nvramdump_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_nvramdump_data,
        { "Record Data", "r3_nvramdump_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_nvramdumprle_record,
        { "Record Number", "r3_nvramdumprle_record",
          FT_UINT24, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_nvramdumprle_length,
        { "Record Length", "r3_nvramdumprle_length",
          FT_UINT8, BASE_DEC_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_nvramdumprle_data,
        { "Record Data", "r3_nvramdumprle_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      ...
      { &hf_r3_peekpoke_operation,
        { "Operation", "r3_peekpoke_operation",
          FT_UINT8, BASE_HEX_DEC|BASE_EXT_STRING, &r3_peekpokenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_address,
        { "Address", "r3_peekpoke_address",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_length,
        { "Length", "r3_peekpoke_length",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_poke8,
        { "8 Bit Value", "r3_peekpoke_poke8",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_poke16,
        { "16 Bit Value", "r3_peekpoke_poke16",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_poke24,
        { "24 Bit Value", "r3_peekpoke_poke24",
          FT_UINT24, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_poke32,
        { "32 Bit Value", "r3_peekpoke_poke32",
          FT_UINT32, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_peekpoke_pokestring,
        { "String Value", "r3_peekpoke_pokestring",
          FT_BYTES, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_firmwaredownload_length,
        { "Length", "r3_firmwaredownload_length",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_record,
        { "Record Number", "r3_firmwaredownload_record",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_action,
        { "Action", "r3_firmwaredownload_action",
          FT_UINT8, BASE_HEX_DEC|BASE_EXT_STRING, &r3_downloadfirmwarenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_timeout,
        { "Timeout", "r3_firmwaredownload_timeout",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_nvram,
        { "NVRAM", "r3_firmwaredownload_nvram",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_address,
        { "Address", "r3_firmwaredownload_address",
          FT_UINT32, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_bytes,
        { "Bytes", "r3_firmwaredownload_bytes",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_data,
        { "Data", "r3_firmwaredownload_data",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_crc,
        { "CRC", "r3_firmwaredownload_crc",
          FT_UINT16, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_firmwaredownload_crc_bad,
        { "Bad CRC", "r3_firmwaredownload_crc_bad",
          FT_BOOLEAN, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_nvramchecksumvalue,
        { "Value", "r3_nvramchecksum_value",
          FT_UINT32, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_nvramchecksumvalue_fixup,
        { "Fixup", "r3_nvramchecksum_fixup",
          FT_UINT32, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_capabilities,
        { "Capability", "r3_capabilities",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_capabilities_length,
        { "Length", "r3_capabilities_length",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_capabilities_type,
        { "Type", "r3_capabilities_type",
          FT_UINT8, BASE_HEX_DEC|BASE_EXT_STRING, &r3_capabilitiesnames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_capabilities_value,
        { "Value", "r3_capabilities_value",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_lockstate,
        { "Lock State", "r3_lockstate",
          FT_UINT24, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_lockstate_passage,
        { "Passage", "r3_lockstate_passage",
          FT_BOOLEAN, 24, NULL, 0x00000001,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_panic,
        { "Panic", "r3_lockstate_panic",
          FT_BOOLEAN, 24, NULL, 0x00000002,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_lockout,
        { "Lockout", "r3_lockstate_lockout",
          FT_BOOLEAN, 24, NULL, 0x00000004,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_relock,
        { "Relock", "r3_lockstate_relock",
          FT_BOOLEAN, 24, NULL, 0x00000008,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_autoopen,
        { "Auto Open", "r3_lockstate_autoopen",
          FT_BOOLEAN, 24, NULL, 0x00000010,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_nextauto,
        { "Next Auto", "r3_lockstate_nextauto",
          FT_BOOLEAN, 24, NULL, 0x00000020,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_lockstate,
        { "Lock State", "r3_lockstate_lockstate",
          FT_BOOLEAN, 24, NULL, 0x00000040,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_wantstate,
        { "Want State", "r3_lockstate_wantstate",
          FT_BOOLEAN, 24, NULL, 0x00000080,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_remote,
        { "Remote", "r3_lockstate_remote",
          FT_BOOLEAN, 24, NULL, 0x00000100,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_update,
        { "Update", "r3_lockstate_update",
          FT_BOOLEAN, 24, NULL, 0x00000200,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_exceptionspresent,
        { "Exceptions Present", "r3_lockstate_exceptionspresent",
          FT_BOOLEAN, 24, NULL, 0x00000400,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_exceptionsactive,
        { "Exceptions Active", "r3_lockstate_exceptionsactive",
          FT_BOOLEAN, 24, NULL, 0x00000800,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_timezonespresent,
        { "Timezones Presents", "r3_lockstate_timezonespresent",
          FT_BOOLEAN, 24, NULL, 0x00001000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_timezonesactive,
        { "Timezones Active", "r3_lockstate_timezonesactive",
          FT_BOOLEAN, 24, NULL, 0x00002000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_autounlockspresent,
        { "Auto Unlocks Present", "r3_lockstate_autounlockspresent",
          FT_BOOLEAN, 24, NULL, 0x00004000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_autounlocksactive,
        { "Auto Unlocks Active", "r3_lockstate_autounlocksactive",
          FT_BOOLEAN, 24, NULL, 0x00008000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_uapmspresent,
        { "UAPMs Present", "r3_lockstate_uapmspresent",
          FT_BOOLEAN, 24, NULL, 0x00010000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_uapmsactive,
        { "UAPMs Active", "r3_lockstate_uapmsactive",
          FT_BOOLEAN, 24, NULL, 0x00020000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_uapmrelockspresent,
        { "UAPM Relocks Present", "r3_lockstate_uapmrelockspresent",
          FT_BOOLEAN, 24, NULL, 0x00040000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_uapmreslocksactive,
        { "UAPM Relocks Active", "r3_lockstate_uapmreslocksactive",
          FT_BOOLEAN, 24, NULL, 0x00080000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_nvramprotect,
        { "NVRAM Protect", "r3_lockstate_nvramprotect",
          FT_BOOLEAN, 24, NULL, 0x00100000,
          NULL, HFILL }
      },
      { &hf_r3_lockstate_nvramchecksum,
        { "MVRAM Checksum", "r3_lockstate_nvramchecksum",
      ...
      { &hf_r3_mortisestatelog,
        { "Mortise State Log", "r3_mortisestatelog",
          FT_NONE, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
#endif
      { &hf_r3_mortisestatelog_pointer,
        { "Event Pointer", "r3_mortisestatelog_pointer",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_mortisestatelog_mortisetype,
        { "Mortise Type", "r3_mortisestatelog_mortisetype",
          FT_UINT8, BASE_HEX_DEC|BASE_EXT_STRING, &r3_mortisetypenames_ext, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_mortisestatelog_waiting,
        { "Waiting For Door Closed", "r3_mortisestatelog_waiting",
          FT_BOOLEAN, BASE_NONE, TFS (&tfs_true_false ), 0x00,
          NULL, HFILL }
      },
      { &hf_r3_mortisestatelog_state,
        { "State", "r3_mortisestatelog_state",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_mortisestatelog_last,
        { "Last State", "r3_mortisestatelog_laststate",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_mortisestatelog_event,
        { "Event", "r3_mortisestatelog_event",
          FT_UINT8, BASE_HEX_DEC|BASE_EXT_STRING, &r3_mortiseeventnames_ext, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_timerchain_newtick,
        { "New Tick", "r3_timerchain_newtick",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_currentboundary,
        { "Current Boundary", "r3_timerchain_currentboundary",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_tasktag,
        { "Task Tag", "r3_timerchain_tasktag",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_address,
        { "Address", "r3_timerchain_address",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_reload,
        { "Reload", "r3_timerchain_reload",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_boundary,
        { "Boundary", "r3_timerchain_boundary",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_count,
        { "Count", "r3_timerchain_count",
          FT_UINT16, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_timerchain_flags,
        { "Flags", "r3_timerchain_flags",
          FT_UINT32, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_taskflags_taskid,
        { "Task ID", "r3_taskflags_taskid",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_taskflags_flags,
        { "Flags", "r3_taskflags_flags",
          FT_UINT32, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_checkpointlog_entryptr,
        { "Entry Pointer", "r3_checkpointlog_entrypointer",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_checkpointlog_rcon,
        { "RCON", "r3_checkpointlog_rcon",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_checkpointlog_checkpoint,
        { "Checkpoint", "r3_checkpointlog_checkpoint",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_cpuregisters_intcon,
        { "INTCON", "r3_cpuregisters_intcon",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon2,
        { "INTCON2", "r3_cpuregisters_intcon2",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3,
        { "INTCON3", "r3_cpuregisters_intcon3",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1,
        { "PIR1", "r3_cpuregisters_pir1",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2,
        { "PIR2", "r3_cpuregisters_pir2",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3,
        { "PIR3", "r3_cpuregisters_pir3",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1,
        { "PIE1", "r3_cpuregisters_pie1",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2,
        { "PIE2", "r3_cpuregisters_pie2",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3,
        { "PIE3", "r3_cpuregisters_pie3",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1,
        { "IPR1", "r3_cpuregisters_ipr1",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2,
        { "IPR2", "r3_cpuregisters_ipr2",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3,
        { "IPR3", "r3_cpuregisters_ipr3",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon,
        { "RCON", "r3_cpuregisters_rcon",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon,
        { "OSCCON", "r3_cpuregisters_osccon",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta,
        { "RCSTA", "r3_cpuregisters_rcsta",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta,
        { "TXSTA", "r3_cpuregisters_txsta",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2,
        { "RCSTA2", "r3_cpuregisters_rcsta2",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2,
        { "TXSTA2", "r3_cpuregisters_txsta2",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon,
        { "WDTCON", "r3_cpuregisters_wdtcon",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_cpuregisters_intcon_rbif,
        { "INTCON.RBIF", "r3_cpuregisters_intcon_rbif",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_int0if,
        { "INTCON.INT0IF", "r3_cpuregisters_intcon_int0if",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_tmr0if,
        { "INTCON.TMR0IF", "r3_cpuregisters_intcon_tmr0if",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_rbie,
        { "INTCON.RBIE", "r3_cpuregisters_intcon_rbie",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_int0ie,
        { "INTCON.INT0IE", "r3_cpuregisters_intcon_int0ie",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_tmr0ie,
        { "INTCON.TMR0IE", "r3_cpuregisters_intcon_tmr0ie",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_giel,
        { "INTCON.GIEL", "r3_cpuregisters_intcon_giel",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon_gieh,
        { "INTCON.GIEH", "r3_cpuregisters_intcon_gieh",
      ...
      { &hf_r3_cpuregisters_intcon3_int1if,
        { "INTCON3.INT1IF", "r3_cpuregisters_intcon3_int1if",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int2if,
        { "INTCON3.INT2IF", "r3_cpuregisters_intcon3_int2if",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int3if,
        { "INTCON3.INT3IF", "r3_cpuregisters_intcon3_int3if",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int1ie,
        { "INTCON3.INT1IE", "r3_cpuregisters_intcon3_int1ie",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int2ie,
        { "INTCON3.INT2IE", "r3_cpuregisters_intcon3_int2ie",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int3ie,
        { "INTCON3.INT3IE", "r3_cpuregisters_intcon3_int3ie",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int1ip,
        { "INTCON3.INT1IP", "r3_cpuregisters_intcon3_int1ip",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_intcon3_int2ip,
        { "INTCON3.INT2IP", "r3_cpuregisters_intcon3_int2ip",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_tmr1if,
        { "PIR1.TMR1IF", "r3_cpuregisters_pir1_tmr1if",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_tmr2if,
        { "PIR1.TMR2IF", "r3_cpuregisters_pir1_tmr2if",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_ccp1if,
        { "PIR1.CCP1IF", "r3_cpuregisters_pir1_ccp1if",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_ssp1if,
        { "PIR1.SSP1IF", "r3_cpuregisters_pir1_ssp1if",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_tx1if,
        { "PIR1.TX1IF", "r3_cpuregisters_pir1_tx1if",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_rc1if,
        { "PIR1.RC1IF", "r3_cpuregisters_pir1_rc1if",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_adif,
        { "PIR1.ADIF", "r3_cpuregisters_pir1_adif",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir1_pspif,
        { "PIR1.PSPIF", "r3_cpuregisters_pir1_pspif",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_ccp2if,
        { "PIR2.CCP2IF", "r3_cpuregisters_pir2_ccp2if",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_tmr3if,
        { "PIR2.TMR3IF", "r3_cpuregisters_pir2_tmr3if",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_hlvdif,
        { "PIR2.HLVDIF", "r3_cpuregisters_pir2_hlvdif",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_bcl1if,
        { "PIR2.BCL1IF", "r3_cpuregisters_pir2_bcl1if",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_eeif,
        { "PIR2.EEIF", "r3_cpuregisters_pir2_eeif",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_unused5,
        { "PIR2.UNUSED5", "r3_cpuregisters_pir2_unused5",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_cmif,
        { "PIR2.CMIF", "r3_cpuregisters_pir2_cmif",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir2_oscfif,
        { "PIR2.OSCFIF", "r3_cpuregisters_pir2_oscfif",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_ccp3if,
        { "PIR3.CCP3IF", "r3_cpuregisters_pir3_ccp3if",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_ccp4if,
        { "PIR3.CCP4IF", "r3_cpuregisters_pir3_ccp4if",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_ccp5if,
        { "PIR3.CCP5IF", "r3_cpuregisters_pir3_ccp5if",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_tmr4if,
        { "PIR3.TMR4IF", "r3_cpuregisters_pir3_tmr4if",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_tx2if,
        { "PIR3.TX2IF", "r3_cpuregisters_pir3_tx2if",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_rc2if,
        { "PIR3.RC2IF", "r3_cpuregisters_pir3_rc2if",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_bcl2if,
        { "PIR3.BCL2IF", "r3_cpuregisters_pir3_bcl2if",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pir3_ssp2if,
        { "PIR3.SSP2IF", "r3_cpuregisters_pir3_ssp2if",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_tmr1ie,
        { "PIE1.TMR1IE", "r3_cpuregisters_pie1_tmr1ie",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_tmr2ie,
        { "PIE1.TMR2IE", "r3_cpuregisters_pie1_tmr2ie",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_ccp1ie,
        { "PIE1.CCP1IE", "r3_cpuregisters_pie1_ccp1ie",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_ssp1ie,
        { "PIE1.SSP1IE", "r3_cpuregisters_pie1_ssp1ie",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_tx1ie,
        { "PIE1.TX1IE", "r3_cpuregisters_pie1_tx1ie",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_rc1ie,
        { "PIE1.RC1IE", "r3_cpuregisters_pie1_rc1ie",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_adie,
        { "PIE1.ADIE", "r3_cpuregisters_pie1_adie",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie1_pspie,
        { "PIE1.PSPIE", "r3_cpuregisters_pie1_pspie",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_oscfie,
        { "PIE2.OSCFIE", "r3_cpuregisters_pie2_oscfie",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_cmie,
        { "PIE2.CMIE", "r3_cpuregisters_pie2_cmie",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_unused2,
        { "PIE2.UNUSED2", "r3_cpuregisters_pie2_unused2",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_eeie,
        { "PIE2.EEIE", "r3_cpuregisters_pie2_eeie",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_bcl1ie,
        { "PIE2.BCL1IE", "r3_cpuregisters_pie2_bcl1ie",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_hlvdie,
        { "PIE2.HLVDIE", "r3_cpuregisters_pie2_hlvdie",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_tmr3ie,
        { "PIE2.TMR3IE", "r3_cpuregisters_pie2_tmr3ie",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie2_ccp2ie,
        { "PIE2.CCP2IE", "r3_cpuregisters_pie2_ccp2ie",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_ccp3ie,
        { "PIE3.CCP3IE", "r3_cpuregisters_pie3_ccp3ie",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_ccp4ie,
        { "PIE3.CCP4IE", "r3_cpuregisters_pie3_ccp4ie",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_ccp5ie,
        { "PIE3.CCP5IE", "r3_cpuregisters_pie3_ccp5ie",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_tmr4ie,
        { "PIE3.TMR4IE", "r3_cpuregisters_pie3_tmr4ie",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_tx2ie,
        { "PIE3.TX2IE", "r3_cpuregisters_pie3_tx2ie",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_rc2ie,
        { "PIE3.RC2IE", "r3_cpuregisters_pie3_rc2ie",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_bcl2ie,
        { "PIE3.BCL2IE", "r3_cpuregisters_pie3_bcl2ie",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_pie3_ssp2ie,
        { "PIE3.SSP2IE", "r3_cpuregisters_pie3_ssp2ie",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_tmr1ip,
        { "IPR1.TMR1IP", "r3_cpuregisters_ipr1_tmr1ip",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_tmr2ip,
        { "IPR1.TMR2IP", "r3_cpuregisters_ipr1_tmr2ip",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_ccp1ip,
        { "IPR1.CCP1IP", "r3_cpuregisters_ipr1_ccp1ip",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_ssp1ip,
        { "IPR1.SSP1IP", "r3_cpuregisters_ipr1_ssp1ip",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_tx1ip,
        { "IPR1.TX1IP", "r3_cpuregisters_ipr1_tx1ip",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_rc1ip,
        { "IPR1.RC1IP", "r3_cpuregisters_ipr1_rc1ip",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_adip,
        { "IPR1.ADIP", "r3_cpuregisters_ipr1_adip",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr1_pspip,
        { "IPR1.PSPIP", "r3_cpuregisters_ipr1_pspip",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_ccp2ip,
        { "IPR2.CCP2IP", "r3_cpuregisters_ipr2_ccp2ip",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_tmr3ip,
        { "IPR2.TMR3IP", "r3_cpuregisters_ipr2_tmr3ip",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_hlvdip,
        { "IPR2.HLVDIP", "r3_cpuregisters_ipr2_hlvdip",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_bcl1ip,
        { "IPR2.BCL1IP", "r3_cpuregisters_ipr2_bcl1ip",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_eeip,
        { "IPR2.EEIP", "r3_cpuregisters_ipr2_eeip",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_unused5,
        { "IPR2.UNUSED5", "r3_cpuregisters_ipr2_unused5",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_cmip,
        { "IPR2.CMIP", "r3_cpuregisters_ipr2_cmip",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr2_oscfip,
        { "IPR2.OSCFIP", "r3_cpuregisters_ipr2_oscfip",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_ccp2ip,
        { "IPR3.CCP2IP", "r3_cpuregisters_ipr3_ccp2ip",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_ccp4ip,
        { "IPR3.CCP4IP", "r3_cpuregisters_ipr3_ccp4ip",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_ccp5ip,
        { "IPR3.CCP5IP", "r3_cpuregisters_ipr3_ccp5ip",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_tmr4ip,
        { "IPR3.TMR4IP", "r3_cpuregisters_ipr3_tmr4ip",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_tx2ip,
        { "IPR3.TX2IP", "r3_cpuregisters_ipr3_tx2ip",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_rc2ip,
        { "IPR3.RC2IP", "r3_cpuregisters_ipr3_rc2ip",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_bcl2ip,
        { "IPR3.BCL2IP", "r3_cpuregisters_ipr3_bcl2ip",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_ipr3_ssp2ip,
        { "IPR3.SSP2IP", "r3_cpuregisters_ipr3_ssp2ip",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_bor,
        { "RCON./BOR", "r3_cpuregisters_rcon_bor",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_por,
        { "RCON./POR", "r3_cpuregisters_rcon_por",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_pd,
        { "RCON./PD", "r3_cpuregisters_rcon_pd",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_to,
        { "RCON./TO", "r3_cpuregisters_rcon_to",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_unused4,
        { "RCON.UNUSED4", "r3_cpuregisters_rcon_unused4",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_ri,
        { "RCON./RI", "r3_cpuregisters_rcon_ri",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_sboren,
        { "RCON.SBOREN", "r3_cpuregisters_rcon_sboren",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcon_ipen,
        { "RCON.IPEN", "r3_cpuregisters_rcon_ipen",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_scs0,
        { "OSCCON.SCS0", "r3_cpuregisters_osccon_scs0",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_scs1,
        { "OSCCON.SCS1", "r3_cpuregisters_osccon_scs1",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_iofs,
        { "OSCCON.IOFS", "r3_cpuregisters_osccon_iofs",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_osts,
        { "OSCCON.OSTS", "r3_cpuregisters_osccon_osts",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_ircf0,
        { "OSCCON.IRCF0", "r3_cpuregisters_osccon_ircf0",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_ircf1,
        { "OSCCON.IRCF1", "r3_cpuregisters_osccon_ircf1",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_ircf2,
        { "OSCCON.IRCF2", "r3_cpuregisters_osccon_ircf2",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_osccon_idlen,
        { "OSCCON.IDLEN", "r3_cpuregisters_osccon_idlen",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_rx9d,
        { "RCSTA.RX9D", "r3_cpuregisters_rcsta_rx9d",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_oerr,
        { "RCSTA.OERR", "r3_cpuregisters_rcsta_oerr",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_ferr,
        { "RCSTA.FERR", "r3_cpuregisters_rcsta_ferr",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_adden,
        { "RCSTA.ADDEN", "r3_cpuregisters_rcsta_adden",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_cren,
        { "RCSTA.CREN", "r3_cpuregisters_rcsta_cren",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_sren,
        { "RCSTA.SREN", "r3_cpuregisters_rcsta_sren",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_rx9,
        { "RCSTA.RX9", "r3_cpuregisters_rcsta_rx9",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta_spen,
        { "RCSTA.SPEN", "r3_cpuregisters_rcsta_spen",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_tx9d,
        { "TXSTA.TX9D", "r3_cpuregisters_txsta_tx9d",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_trmt,
        { "TXSTA.TRMT", "r3_cpuregisters_txsta_trmt",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_brgh,
        { "TXSTA.BRGH", "r3_cpuregisters_txsta_brgh",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_sendb,
        { "TXSTA.SENDB", "r3_cpuregisters_txsta_sendb",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_sync,
        { "TXSTA.SYNC", "r3_cpuregisters_txsta_sync",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_txen,
        { "TXSTA.TXEN", "r3_cpuregisters_txsta_txen",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_tx9,
        { "TXSTA.TX9", "r3_cpuregisters_txsta_tx9",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta_csrc,
        { "TXSTA.CSRC", "r3_cpuregisters_txsta_csrc",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_rx9d,
        { "RCSTA2.RX9D", "r3_cpuregisters_rcsta2_rx9d",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_oerr,
        { "RCSTA2.OERR", "r3_cpuregisters_rcsta2_oerr",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_ferr,
        { "RCSTA2.FERR", "r3_cpuregisters_rcsta2_ferr",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_adden,
        { "RCSTA2.ADDEN", "r3_cpuregisters_rcsta2_adden",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_cren,
        { "RCSTA2.CREN", "r3_cpuregisters_rcsta2_cren",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_sren,
        { "RCSTA2.SREN", "r3_cpuregisters_rcsta2_sren",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_rx9,
        { "RCSTA2.RX9", "r3_cpuregisters_rcsta2_rx9",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_rcsta2_spen,
        { "RCSTA2.SPEN", "r3_cpuregisters_rcsta2_spen",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_tx9d,
        { "TXSTA2.TX9D", "r3_cpuregisters_txsta2_tx9d",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_trmt,
        { "TXSTA2.TRMT", "r3_cpuregisters_txsta2_trmt",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_brgh,
        { "TXSTA2.BRGH", "r3_cpuregisters_txsta2_brgh",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_sendb,
        { "TXSTA2.SENDB", "r3_cpuregisters_txsta2_sendb",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_sync,
        { "TXSTA2.SYNC", "r3_cpuregisters_txsta2_sync",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_txen,
        { "TXSTA2.TXEN", "r3_cpuregisters_txsta2_txen",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_tx9,
        { "TXSTA2.TX9", "r3_cpuregisters_txsta2_tx9",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_txsta2_csrc,
        { "TXSTA2.CSRC", "r3_cpuregisters_txsta2_csrc",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_swdten,
        { "WDTCON.SWDTEN", "r3_cpuregisters_wdtcon_swdten",
          FT_BOOLEAN, 8, NULL, 0x01,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused1,
        { "WDTCON.UNUSED1", "r3_cpuregisters_wdtcon_unused1",
          FT_BOOLEAN, 8, NULL, 0x02,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused2,
        { "WDTCON.UNUSED2", "r3_cpuregisters_wdtcon_unused2",
          FT_BOOLEAN, 8, NULL, 0x04,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused3,
        { "WDTCON.UNUSED3", "r3_cpuregisters_wdtcon_unused3",
          FT_BOOLEAN, 8, NULL, 0x08,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused4,
        { "WDTCON.UNUSED4", "r3_cpuregisters_wdtcon_unused4",
          FT_BOOLEAN, 8, NULL, 0x10,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused5,
        { "WDTCON.UNUSED5", "r3_cpuregisters_wdtcon_unused5",
          FT_BOOLEAN, 8, NULL, 0x20,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused6,
        { "WDTCON.UNUSED6", "r3_cpuregisters_wdtcon_unused6",
          FT_BOOLEAN, 8, NULL, 0x40,
          NULL, HFILL }
      },
      { &hf_r3_cpuregisters_wdtcon_unused7,
        { "WDTCON.UNUSED7", "r3_cpuregisters_wdtcon_unused7",
          FT_BOOLEAN, 8, NULL, 0x80,
          NULL, HFILL }
      },

      { &hf_r3_dumpm41t81_reg00,
        { "REG 0x00", "r3_m41t81_reg00",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg01,
        { "REG 0x01", "r3_m41t81_reg01",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg02,
        { "REG 0x02", "r3_m41t81_reg02",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg03,
        { "REG 0x03", "r3_m41t81_reg03",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg04,
        { "REG 0x04", "r3_m41t81_reg04",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg05,
        { "REG 0x05", "r3_m41t81_reg05",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg06,
        { "REG 0x06", "r3_m41t81_reg06",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg07,
        { "REG 0x07", "r3_m41t81_reg07",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg08,
        { "REG 0x08", "r3_m41t81_reg08",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg09,
        { "REG 0x09", "r3_m41t81_reg09",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0a,
        { "REG 0x0a", "r3_m41t81_reg0a",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0b,
        { "REG 0x0b", "r3_m41t81_reg0b",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0c,
        { "REG 0x0c", "r3_m41t81_reg0c",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0d,
        { "REG 0x0d", "r3_m41t81_reg0d",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0e,
        { "REG 0x0e", "r3_m41t81_reg0e",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0f,
        { "REG 0x0f", "r3_m41t81_reg0f",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg10,
        { "REG 0x10", "r3_m41t81_reg10",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg11,
        { "REG 0x11", "r3_m41t81_reg11",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg12,
        { "REG 0x12", "r3_m41t81_reg12",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg13,
        { "REG 0x13", "r3_m41t81_reg13",
          FT_UINT8, BASE_HEX_DEC, NULL, 0x0,
          NULL, HFILL }
      },

      { &hf_r3_dumpm41t81_reg00_sec1,
        { ".1 Seconds", "r3_m41t81_reg00_sec1",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg00_sec01,
        { ".01 Seconds", "r3_m41t81_reg00_sec01",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg01_st,
        { "ST", "r3_m41t81_reg01_st",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg01_10sec,
        { "10 Seconds", "r3_m41t81_reg01_10sec",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg01_1sec,
        { "1 Seconds", "r3_m41t81_reg01_1sec",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg02_notused,
        { "(not used)", "r3_m41t81_reg02_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg02_10min,
        { "10 Minutes", "r3_m41t81_reg02_10min",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg02_1min,
        { "1 Minutes", "r3_m41t81_reg02_1min",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg03_cbe,
        { "CBE", "r3_m41t81_reg03_cbe",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg03_cb,
        { "CB", "r3_m41t81_reg03_cb",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg03_10hour,
        { "10 Hours", "r3_m41t81_reg03_10hour",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg03_1hour,
        { "1 Hours", "r3_m41t81_reg03_1hour",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg04_notused,
        { "(not used)", "r3_m41t81_reg04_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg04_dow,
        { "DOW", "r3_m41t81_reg04_dow",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg05_notused,
        { "(not used)", "r3_m41t81_reg05_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg05_10day,
        { "10 Day", "r3_m41t81_reg05_10day",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg05_1day,
        { "1 Day", "r3_m41t81_reg05_1day",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg06_notused,
        { "(not used)", "r3_m41t81_reg06_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg06_10month,
        { "10 Month", "r3_m41t81_reg06_10month",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg06_1month,
        { "1 Month", "r3_m41t81_reg06_1month",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg07_10year,
        { "10 Year", "r3_m41t81_reg07_10year",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg07_1year,
        { "1 Year", "r3_m41t81_reg07_1year",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg08_out,
        { "OUT", "r3_m41t81_reg08_out",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg08_ft,
        { "FT", "r3_m41t81_reg08_ft",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      ...
      { &hf_r3_dumpm41t81_reg08_cal,
        { "CAL", "r3_m41t81_reg08_cal",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg09_notused,
        { "(not used)", "r3_m41t81_reg09_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg09_bmb,
        { "BMB", "r3_m41t81_reg09_bmb",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg09_rb,
        { "RB", "r3_m41t81_reg09_rb",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0a_afe,
        { "AFE", "r3_m41t81_reg0a_afe",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0a_sqwe,
        { "SQWE", "r3_m41t81_reg0a_sqwe",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0a_abe,
        { "ABE", "r3_m41t81_reg0a_abe",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0a_10monthalm,
        { "10 Month Alarm", "r3_m41t81_reg0a_10monthalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0a_1monthalm,
        { "1 Month Alarm", "r3_m41t81_reg0a_1monthalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0b_rpt5,
        { "RPT5", "r3_m41t81_reg0b_rpt5",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0b_rpt4,
        { "RPT4", "r3_m41t81_reg0b_rpt4",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0b_10dayalm,
        { "10 Day Alarm", "r3_m41t81_reg0b_10dayalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0b_1dayalm,
        { "1 Day Alarm", "r3_m41t81_reg0b_1dayalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0c_rpt3,
        { "RPT3", "r3_m41t81_reg0c_rpt3",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0c_ht,
        { "HT", "r3_m41t81_reg0c_ht",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0c_10houralm,
        { "10 Hour Alarm", "r3_m41t81_reg0c_10houralm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0c_1houralm,
        { "1 Hour Alarm", "r3_m41t81_reg0c_1houralm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0d_rpt2,
        { "RPT2", "r3_m41t81_reg0d_rpt2",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0d_10minalm,
        { "10 Min Alarm", "r3_m41t81_reg0d_10minalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0d_1minalm,
        { "1 Min Alarm", "r3_m41t81_reg0d_1minalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0e_rpt1,
        { "RPT1", "r3_m41t81_reg0e_rpt1",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0e_10secalm,
        { "10 Sec Alarm", "r3_m41t81_reg0e_10secalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0e_1secalm,
        { "1 Sec Alarm", "r3_m41t81_reg0e_1secalm",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0f_wdf,
        { "WDF", "r3_m41t81_reg0f_wdf",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0f_af,
        { "AF", "r3_m41t81_reg0f_af",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg0f_notused,
        { "(not used)", "r3_m41t81_reg0f_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg10_notused,
        { "(not used)", "r3_m41t81_reg10_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg11_notused,
        { "(not used)", "r3_m41t81_reg11_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg12_notused,
        { "(not used)", "r3_m41t81_reg12_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg13_rs,
        { "RS", "r3_m41t81_reg13_rs",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_dumpm41t81_reg13_notused,
        { "(not used)", "r3_m41t81_reg13_notused",
          FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_sn_manufacturer,
        { "Manufacturer", "r3_sn_manufacturer",
          FT_STRING, BASE_NONE, NULL, 0x0,
          NULL, HFILL }
      },
      { &hf_r3_sn_year,
