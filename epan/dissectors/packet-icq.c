...
proto_register_icq(void)
{
    static hf_register_info hf[] = {
        { &hf_icq_version,
          {"Version", "icq_version", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_type,
          {"Client/Server", "icq_client", FT_BOOLEAN, BASE_NONE, TFS(&tfs_client_server), 0x0, NULL, HFILL }},
        { &hf_icq_msg_type,
          {"Type", "icq_msg_type", FT_UINT16, BASE_DEC, VALS(msgTypeCode), 0x0, NULL, HFILL }},
        { &hf_icq_uin,
          {"UIN", "icq_uin", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_sessionid,
          {"Session ID", "icq_sessionid", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_client_cmd,
          {"Client command", "icq_client_cmd", FT_UINT16, BASE_DEC, VALS(clientCmdCode), 0x0, NULL, HFILL }},
        { &hf_icq_server_cmd,
          {"Server command", "icq_server_cmd", FT_UINT16, BASE_DEC, VALS(serverCmdCode), 0x0, NULL, HFILL }},
        { &hf_icq_checkcode,
          {"Checkcode", "icq_checkcode", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_checkcode_key,
          {"Key", "icq_checkcode_key", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_seqnum1,
          {"Seq Number 1", "icq_seqnum1", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_seqnum2,
          {"Seq Number 2", "icq_seqnum2", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_group,
          {"Group", "icq_group", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_ack_random,
          {"Random", "icq_ack_random", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_keep_alive_random,
          {"Random", "icq_keep_alive_random", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_status,
          {"Client command", "icq_status", FT_UINT32, BASE_DEC, VALS(statusCode), 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_subcmd,
          {"Subcommand", "icq_meta_user_subcmd", FT_UINT16, BASE_DEC, VALS(serverMetaSubCmdCode), 0x0, NULL, HFILL }},
        /* Generated from convert_proto_tree_add_text.pl */
        { &hf_icq_msg_length, { "Length", "icq_msg_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_msg, { "Msg", "icq_msg", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_msg_authorization, { "Authorization", "icq_msg_authorization", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_x1, { "X1", "icq_x1", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_num_uin_pairs, { "Number of pairs", "icq_num_uin_pairs", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_text_code_length, { "Length", "icq_text_code_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_text_code, { "Text", "icq_text_code", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_receiver_uin, { "Receiver UIN", "icq_receiver_uin", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_login_time, { "Time", "icq_login_time", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_login_port, { "Port", "icq_login_port", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_login_password, { "Password", "icq_login_password", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_login_ip, { "IP", "icq_login_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_number_of_uins, { "Number of uins", "icq_number_of_uins", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_user_online_ip, { "IP", "icq_user_online_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_user_online_port, { "Port", "icq_user_online_port", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_user_online_realip, { "RealIP", "icq_user_online_realip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_user_online_version, { "Version", "icq_user_online_version", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_multi_num_packets, { "Number of pkts", "icq_multi_num_packets", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_result, { "Result", "icq_meta_user_result", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_length, { "Length", "icq_meta_user_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_found_authorization, { "Authorization", "icq_meta_user_found_authorization", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_x2, { "x2", "icq_meta_user_x2", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_x3, { "x3", "icq_meta_user_x3", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_about, { "About", "icq_meta_user_about", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_countrycode, { "Countrycode", "icq_meta_user_countrycode", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_timezone, { "Timezone", "icq_meta_user_timezone", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_info_authorization, { "Authorization", "icq_meta_user_info_authorization", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_webaware, { "Webaware", "icq_meta_user_webaware", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x0, NULL, HFILL }},
        { &hf_icq_meta_user_hideip, { "HideIP", "icq_meta_user_hideip", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x0, NULL, HFILL }},
        { &hf_icq_rand_user_ip, { "IP", "icq_rand_user_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_rand_user_port, { "Port", "icq_rand_user_port", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_rand_user_realip, { "RealIP", "icq_rand_user_realip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_rand_user_class, { "Class", "icq_rand_user_class", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_rand_user_tcpversion, { "TCPVersion", "icq_rand_user_tcpversion", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_no_parameters, { "No parameters", "icq_no_parameters", FT_NONE, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_login_reply_ip, { "IP", "icq_login_reply_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_nickname, { "Nickname", "icq_nickname", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_first_name, { "First name", "icq_first_name", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_last_name, { "Last name", "icq_last_name", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_email, { "Email", "icq_email", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_nickname_uint_string, { "Nickname", "icq_nickname", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_first_name_uint_string, { "First name", "icq_first_name", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_last_name_uint_string, { "Last name", "icq_last_name", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_email_uint_string, { "Email", "icq_email", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_primary_email, { "Primary email", "icq_primary_email", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_secondary_email, { "Secondary email", "icq_secondary_email", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_old_email, { "Old email", "icq_old_email", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_city, { "City", "icq_city", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_state, { "State", "icq_state", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_phone, { "Phone", "icq_phone", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_fax, { "Fax", "icq_fax", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_street, { "Street", "icq_street", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_cellphone, { "Cellphone", "icq_cellphone", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_zip, { "Zip", "icq_zip", FT_UINT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_description, { "Description", "icq_description", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_url, { "URL", "icq_url", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_text, { "Text", "icq_text", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_unknown, { "Unknown", "icq_unknown", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_reason, { "Reason", "icq_reason", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_msg_contact, { "Contact", "icq_msg_contact", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_icq_recv_time, { "Time", "icq_recv_time", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
    };
