...
proto_register_fr(void)
{
  static hf_register_info hf[] = {
    ...
    { &hf_fr_oui,
      { "Organization Code", "fr_snap_oui",
        FT_UINT24, BASE_OUI, NULL, 0x0,
        NULL, HFILL }},

    { &hf_fr_pid,
      { "Protocol ID", "fr_snap_pid",
    ...
    { &hf_fr_first_addr_octet,
      { "First address octet", "fr_first_addr_octet",
        FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},

    { &hf_fr_second_addr_octet,
      { "Second address octet", "fr_second_addr_octet",
        FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},

    { &hf_fr_third_addr_octet,
      { "Third address octet", "fr_third_addr_octet",
        FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
