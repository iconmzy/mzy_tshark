...
proto_register_btl2cap(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_btl2cap_le_result,
          { "LE Result",           "btl2cap_le_result",
            FT_UINT16, BASE_HEX, VALS(le_result_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_credits,
          { "Credits",               "btl2cap_credits",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            "L2CAP Channel Identifier", HFILL }
        },
        { &hf_btl2cap_initial_credits,
          { "Initial Credits",       "btl2cap_initial_credits",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            "L2CAP Channel Identifier", HFILL }
        },
        { &hf_btl2cap_le_psm,
          { "LE PSM",           "btl2cap_le_psm",
        ...
        { &hf_btl2cap_connect_in_frame,
            { "Connect in frame",                            "btl2cap_connect_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_disconnect_in_frame,
            { "Disconnect in frame",                         "btl2cap_disconnect_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragments,
        { "SDU fragments", "btl2cap_le_sdu_fragments",
            FT_NONE, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment,
        { "SDU fragment", "btl2cap_le_sdu_fragment",
            FT_FRAMENUM, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment_overlap,
        { "SDU fragment overlap", "btl2cap_le_sdu_fragment_overlap",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment_overlap_conflicts,
        { "SDU fragment overlapping with conflicting data", "btl2cap_le_sdu_fragment_overlap_conflicts",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment_multiple_tails,
        { "SDU has multiple tail fragments", "btl2cap_le_sdu_fragment_multiple_tails",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment_too_long_fragment,
        { "SDU fragment too long", "btl2cap_le_sdu_fragment_too_long_fragment",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment_error,
        { "SDU defragmentation error", "btl2cap_le_sdu_fragment_error",
            FT_FRAMENUM, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_fragment_count,
        { "SDU fragment count", "btl2cap_le_sdu_fragment_count",
            FT_UINT32, BASE_DEC, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_reassembled_in,
        { "Reassembled in", "btl2cap_le_sdu_reassembled_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_reassembled_length,
        { "Reassembled SDU length", "btl2cap_le_sdu_reassembled_length",
            FT_UINT32, BASE_DEC, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_btl2cap_le_sdu_length,
        { "SDU Length", "btl2cap_le_sdu_length",
