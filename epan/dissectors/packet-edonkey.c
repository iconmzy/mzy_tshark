...
void proto_register_edonkey(void) {
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_kademlia_search_condition_argument_uint64,
            { "64bit Argument", "edonkey_kademlia_search_condition_argument_uint64",
                FT_UINT64, BASE_DEC_HEX, NULL, 0, "Kademlia Search Condition Argument 64bit Value", HFILL } },
        { &hf_edonkey_unparsed_data_length,
            { "eDonkey unparsed data length", "edonkey_unparsed",
                FT_UINT32, BASE_DEC_HEX, NULL, 0, "eDonkey trailing or unparsed data length", HFILL } },

      /* Generated from convert_proto_tree_add_text.pl */
      { &hf_edonkey_list_size, { "List Size", "edonkey_list_size", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_meta_tag_value_revision, { "Meta Tag Value", "edonkey_meta_tag_value_revision", FT_UINT32, BASE_CUSTOM, CF_FUNC(edonkey_fmt_revision), 0x0, NULL, HFILL }},
      { &hf_edonkey_meta_tag_value_uint, { "Meta Tag Value", "edonkey_meta_tag_value_uint", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_boolean_array_length, { "Boolean Array Length", "edonkey_boolean_array_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_blob_length, { "BLOB Length", "edonkey_blob_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_kademlia_string, { "String", "edonkey_kademlia_string", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_emule_public_key_length, { "Public key length", "edonkey_emule_public_key_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_emule_signature_length, { "Signature length", "edonkey_emule_signature_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_obfuscation_settings, { "Obfuscation Settings", "edonkey_obfuscation_settings", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_start_offset, { "Start Offset", "edonkey_start_offset", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_start_offset_64, { "Start Offset", "edonkey_start_offset64", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_end_offset, { "End Offset", "edonkey_end_offset", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_end_offset_64, { "End Offset", "edonkey_end_offset64", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_emule_file_length, { "File Length", "edonkey_emule_file_length", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_overnet_peer_type, { "Peer Type", "edonkey_overnet_peer_type", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_more_search_file_results, { "More", "edonkey_more_search_file_results", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x0, NULL, HFILL }},
      { &hf_edonkey_file_size, { "File size", "edonkey_file_size", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_large_file_size, { "Large file size", "edonkey_large_file_size", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_number_of_users, { "Number of Users", "edonkey_number_of_users", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_number_of_files, { "Number of Files", "edonkey_number_of_files", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_message_data, { "Message Data", "edonkey_message_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_emule_version, { "Version", "edonkey_emule_version", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_emule_queue_ranking, { "Queue Ranking", "edonkey_emule_queue_ranking", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_emule_ident_state, { "State", "edonkey_emule_state", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(emule_ident_state_rvals), 0x0, NULL, HFILL }},
      { &hf_edonkey_emule_rndchallenge, { "Rndchallenge", "edonkey_emule_rndchallenge", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_emule_sig_ip_used, { "Sig IP Used", "edonkey_emule_sig_ip_used", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_packed_length, { "Packed Length", "edonkey_emule_packed_length", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_compressed_message_data, { "Compressed Message Data", "edonkey_emule_compressed_message_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_challenge, { "Challenge", "edonkey_challenge", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_max_number_of_users, { "Max number of Users", "edonkey_max_number_of_users", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_search_type, { "Search Type", "edonkey_search_type", FT_UINT8, BASE_DEC, VALS(edonkey_search_type_vals), 0x0, NULL, HFILL }},
      { &hf_edonkey_search_range_min, { "Search Range Min", "edonkey_search_range_min", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_search_range_max, { "Search Range Max", "edonkey_search_range_max", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_kademlia_uload, { "uLoad", "edonkey_kademlia_uload", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_kademlia_start_position, { "Start position", "edonkey_kademlia_start_position", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_kademlia_filesize, { "Filesize", "edonkey_kademlia_filesize", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_kademlia_restrictive, { "Restrictive", "edonkey_kademlia_restrictive", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_broken_compressed_data, { "Broken Compressed data", "edonkey_broken_compressed_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_search_limit, { "Search Limit", "edonkey_search_limit", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_edonkey_search_limit_type, { "Limit Type", "edonkey_search_limit_type", FT_UINT8, BASE_DEC, VALS(edonkey_search_conds), 0x0, NULL, HFILL }},
      { &hf_edonkey_search_ops, { "Search Operator", "edonkey_search_ops", FT_UINT8, BASE_HEX, VALS(edonkey_search_ops), 0x0, NULL, HFILL }},
      { &hf_edonkey_user_hash_length, { "User hash length", "edonkey_user_hash_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
    };
