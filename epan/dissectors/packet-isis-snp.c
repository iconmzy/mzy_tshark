...
proto_register_isis_csnp(void)
{
    static hf_register_info hf[] = {
        ...
        { "PDU length",        "isis_csnp_pdu_length", FT_UINT16,
          BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_source_id,
        { "Source-ID", "isis_csnp_source_id",
            FT_SYSTEM_ID, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_start_lsp_id,
        { "Start LSP-ID", "isis_csnp_start_lsp_id",
            FT_SYSTEM_ID, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_end_lsp_id,
        { "End LSP-ID", "isis_csnp_end_lsp_id",
            FT_SYSTEM_ID, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_lsp_id,
        { "LSP-ID", "isis_csnp_lsp_id",
            FT_SYSTEM_ID, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_lsp_seq_num,
        { "LSP Sequence Number",        "isis_csnp_lsp_seq_num", FT_UINT32,
          BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_lsp_remain_life,
        { "Remaining Lifetime",        "isis_csnp_lsp_remain_life", FT_UINT16,
          BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_lsp_checksum,
        { "LSP checksum",        "isis_csnp_lsp_checksum", FT_UINT16,
          BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_checksum,
        { "Checksum",        "isis_csnp_checksum", FT_UINT16,
          BASE_HEX, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_checksum_status,
        { "Checksum Status",        "isis_csnp_checksum_status", FT_UINT8,
          BASE_NONE, VALS(proto_checksum_vals), 0x0, NULL, HFILL }},
        { &hf_isis_csnp_clv_type,
        { "Type",        "isis_csnp_clv_type", FT_UINT8,
          BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_clv_length,
        { "Length",        "isis_csnp_clv_length", FT_UINT8,
          BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_ip_authentication,
        { "IP Authentication",        "isis_csnp_ip_authentication", FT_STRING,
          BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_authentication,
        { "Authentication",        "isis_csnp_authentication", FT_BYTES,
          BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_isis_csnp_instance_identifier,
        { "Instance Identifier", "isis_csnp_iid", FT_UINT16,
          BASE_DEC, NULL, 0x0, NULL, HFILL } },
        { &hf_isis_csnp_supported_itid,
        { "Supported ITID", "isis_csnp_supported_itid", FT_UINT16,
           BASE_DEC, NULL, 0x0, NULL, HFILL }},
    };
