...
void proto_register_a21(void)
{
	static hf_register_info hf_a21[] = {
		  { &hf_a21_message_type,
			 {"Message Type", "a21_message_type",
			  FT_UINT8, BASE_DEC, VALS(a21_message_type_vals), 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_element_identifier,
			 {"A21 Element Identifier", "a21_element_identifier",
		  ...
		  { &hf_a21_corr_id_corr_value,
			 {"Correlation Value", "a21_corr_id_corr_value",
			  FT_UINT32, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_mn_id_msid_value,
			 {"MSID Value", "a21_mn_id_msid_value",
			  FT_UINT8, BASE_DEC, NULL, 0xf8,
			  NULL, HFILL }
		  },
		  { &hf_a21_mn_id_identity_digit_1,
			 {"Identity Digit 1", "a21_mn_id_identity_digit_1",
			  FT_UINT8, BASE_DEC, NULL, 0x08,
			  NULL, HFILL }
		  },
		  { &hf_a21_mn_id_odd_even_indicator,
			 {"Odd/Even Indicator", "a21_mn_id_odd_even_indicator",
			  FT_UINT8, BASE_DEC, NULL, 0x08,
			  NULL, HFILL }
		  },
		  { &hf_a21_mn_id_type_of_identity,
			 {"Type of Identity", "a21_mn_id_type_of_identity",
		  ...
		  { &hf_a21_reserved,
			 {"Reserved", "a21_reserved",
			  FT_UINT8, BASE_DEC, NULL, 0xf0,
			  NULL, HFILL }
		  },
		  { &hf_a21_msg_tran_ctrl_paging_msg,
			 {"Paging Message", "a21_msg_tran_ctrl_paging_msg",
			  FT_UINT8, BASE_DEC, NULL, 0x08,
			  NULL, HFILL }
		  },
		  { &hf_a21_msg_tran_ctrl_simul_xmit_with_next,
			 {"Simul Xmit with Next", "a21_msg_tran_ctrl_simul_xmit_with_next",
			  FT_UINT8, BASE_DEC, NULL, 0x04,
			  NULL, HFILL }
		  },
		  { &hf_a21_msg_tran_ctrl_ackrequired,
			 {"AckRequired", "a21_msg_tran_ctrl_ackrequired",
			  FT_UINT8, BASE_DEC, NULL, 0x02,
			  NULL, HFILL }
		  },
		  { &hf_a21_msg_tran_ctrl_3GXLogicalChannel,
			 {"3GXLogicalChannel", "a21_msg_tran_ctrl_3GXLogicalChannel",
			  FT_UINT8, BASE_DEC, NULL, 0x01,
			  NULL, HFILL }
		  },
		  { &hf_a21_msg_tran_ctrl_protocol_revision,
			 {"ProtocolRevision", "a21_msg_tran_ctrl_protocol_revision",
			  FT_UINT8, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_1x_lac_en_pdu,
			 {"1x LAC Encapsulated PDU", "a21_1x_lac_en_pdu",
			  FT_UINT24, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_pilot_list_num_of_pilots,
			 {"Number of Pilots", "a21_pilot_list_num_of_pilots",
			  FT_UINT8, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_cause_value,
			 {"A21 Cause Value", "a21_cause_value",
			  FT_UINT8, BASE_DEC, VALS(a21_cause_vals), 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_mscid_market_id,
			 {"Market ID", "a21_mscid_market_id",
			  FT_UINT16, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_mscid_switch_number,
			 {"Switch Number", "a21_mscid_switch_number",
			  FT_UINT8, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_event,
		  ...
		  { &hf_a21_hrpd_sector_id_len,
			 {"HRPD Sector id Length", "a21_hrpd_sector_id_len",
			  FT_UINT8, BASE_DEC, NULL, 0x0,
			  NULL, HFILL }
		  },
		  { &hf_a21_ch_hrpd_sector_id,
		      { "HRPD Sector id", "a21_hrpd_sector_id",
		      FT_UINT8, BASE_HEX, NULL, 0x0,
		      NULL, HFILL }
		  },
		  { &hf_a21_ch_reference_pilot,
		      { "Reference Pilot", "a21_ch_reference_pilot",
		      FT_UINT8, BASE_DEC, NULL, 0x80,
		      NULL, HFILL }
		  },
		  { &hf_a21_ch_pilot_pn,
		      { "Pilot PN", "a21_ch_pilot_pn",
		      FT_UINT16, BASE_DEC, NULL, 0x01ff,
		      NULL, HFILL }
		  },
		  { &hf_a21_ch_pilot_pn_phase,
		      { "Pilot PN Phase", "a21_ch_pilot_pn_phase",
		      FT_UINT16, BASE_DEC, NULL, 0x7fff,
		      NULL, HFILL }
		  },
		  { &hf_a21_ch_pilot_strength,
		      { "Pilot Strength", "a21_ch_pilot_strength",
		      FT_UINT8, BASE_DEC, NULL, 0x3f,
		      NULL, HFILL }
		  },
		  { &hf_a21_ch_pilot_ow_delay_flag,
		      { "Pilot OneWay Delay", "a21_ch_pilot_onew_delay",
		      FT_UINT8, BASE_DEC, VALS(a21_ch_pilot_ow_delay_values), 0x40,
		      NULL, HFILL }
		  },
		  { &hf_a21_ch_pilot_ow_delay,
		      { "Pilot OneWay Delay (units of 100ns)", "a21_ch_pilot_onew_delay_value",
		      FT_UINT16, BASE_DEC, NULL, 0x0,
		      NULL, HFILL }
		  },
		  { &hf_a21_sc0,
