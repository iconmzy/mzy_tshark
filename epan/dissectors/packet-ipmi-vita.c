...
static hf_register_info hf_ipmi_vita[] = {
	{ &hf_vita_ipmc,
		{ "IPMC Identifier", "ipmi_vita_ipmc",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_tier,
		{ "Tier Functionality", "ipmi_vita_ipmc_tier",
			FT_UINT8, BASE_HEX, VALS(str_vita_ipmc_tiers), 0x3, NULL, HFILL }},
	{ &hf_vita_layer,
		{ "Layer Functionality", "ipmi_vita_ipmc_layer",
			FT_UINT8, BASE_HEX, VALS(str_vita_ipmc_layers), 0x30, NULL, HFILL }},
	{ &hf_vita_ipmb,
		{ "IPMB Capabilities", "ipmi_vita_ipmb",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_ipmb_itfs,
		{ "Number of supported interfaces", "ipmi_vita_ipmc_itfs",
			FT_UINT8, BASE_HEX, VALS(str_vita_ipmb_itfs), 0x3, NULL, HFILL }},
	{ &hf_vita_ipmb_freq,
		{ "Maximum operating frequency", "ipmi_vita_ipmc_freq",
			FT_UINT8, BASE_HEX, VALS(str_vita_ipmb_freq), 0x30, NULL, HFILL }},
	{ &hf_vita_vso,
		{ "VSO Standard", "ipmi_vita_vso",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_vso_std,
		{ "VSO Standard", "ipmi_vita_vso_std",
			FT_UINT8, BASE_HEX, VALS(str_vita_vso_std), 0x3, NULL, HFILL }},
	{ &hf_vita_rev,
		{ "VSO Specification Revision", "ipmi_vita_vso_rev",
			FT_UINT8, BASE_CUSTOM, CF_FUNC(ipmi_fmt_version), 0, NULL, HFILL }},
	{ &hf_vita_max_fruid,
		{ "Max FRU Device ID", "ipmi_vita_max_fruid",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_ipmc_fruid,
		{ "FRU Device ID for IPMC", "ipmi_vita_ipmc_fruid",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fruid,
		{ "FRU Device ID", "ipmi_vita_fruid",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_addr_key_type,
		{ "Address Key Type", "ipmi_vita_key_type",
			FT_UINT8, BASE_HEX, VALS(str_vita_addr_key_types), 0, NULL, HFILL }},
	{ &hf_vita_addr_key,
		{ "Address Key", "ipmi_vita_key",
			FT_UINT8, BASE_HEX_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_site_type,
		{ "Site Type", "ipmi_vita_site_type",
			FT_UINT8, BASE_HEX|BASE_EXT_STRING, &str_vita_site_types_ext, 0, NULL, HFILL }},
	{ &hf_vita_hw_addr,
		{ "Hardware Address", "ipmi_vita_hwaddr",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_ipmb_addr,
		{ "IPMB Address", "ipmi_vita_ipmb_addr",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_site_num,
		{ "Site Number", "ipmi_vita_site_num",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_ipmbl_addr,
		{ "Address on IPMI Channel 7", "ipmi_vita_ipmbl_addr",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_identifier,
		{ "Chassis Identifier",
			"ipmi_vita_chassis_identifier", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	{ &hf_vita_chassis_identifier_type,
		{ "Type",
			"ipmi_vita_chassis_identifier_type", FT_UINT8, BASE_DEC, NULL, 0xc0, NULL, HFILL }},
	{ &hf_vita_chassis_identifier_length,
		{ "Length",
			"ipmi_vita_chassis_identifier_length", FT_UINT8, BASE_DEC, NULL, 0x3f, NULL, HFILL }},
	{ &hf_vita_reserved,
		{ "Reserved", "ipmi_vita_reserved",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_control,
		{ "FRU Control", "ipmi_vita_fru_control",
			FT_UINT8, BASE_DEC, VALS(str_vita_fru_controls), 0, NULL, HFILL }},
	{ &hf_vita_led_count,
		{ "LED Count", "ipmi_vita_led_count",
			FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_id,
		{ "LED ID", "ipmi_vita_led_id",
			FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_caps,
		{ "LED Color Capabilities", "ipmi_vita_led_caps",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_cap_blue,
		{ "LED supports BLUE", "ipmi_vita_led_cap_blue",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_led_cap_red,
		{ "LED supports RED", "ipmi_vita_led_cap_red",
			FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
	{ &hf_vita_led_cap_green,
		{ "LED supports GREEN", "ipmi_vita_led_cap_green",
			FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},
	{ &hf_vita_led_cap_amber,
		{ "LED supports AMBER", "ipmi_vita_led_cap_amber",
			FT_BOOLEAN, 8, NULL, 0x10, NULL, HFILL }},
	{ &hf_vita_led_cap_orange,
		{ "LED supports ORANGE", "ipmi_vita_led_cap_orange",
			FT_BOOLEAN, 8, NULL, 0x20, NULL, HFILL }},
	{ &hf_vita_led_cap_white,
		{ "LED supports WHITE", "ipmi_vita_led_cap_white",
			FT_BOOLEAN, 8, NULL, 0x40, NULL, HFILL }},
	{ &hf_vita_led_def_loc_color,
		{ "Default LED Color in Local Control State", "ipmi_vita_led_def_loc_color",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_def_ovr_color,
		{ "Default LED Color in Override State", "ipmi_vita_led_def_ovr_color",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_flags,
		{ "LED Flags", "ipmi_vita_led_flags",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_flag_pwr,
		{ "LED is powered from Payload power", "ipmi_vita_led_flag_pwr",
			FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
	{ &hf_vita_led_flag_hw_restrict,
		{ "LED has other hardware restrictions", "ipmi_vita_led_flag_hw_restrict",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_led_color,
		{ "LED Color Value", "ipmi_vita_led_color",
			FT_UINT8, BASE_HEX, VALS(str_vita_led_colors), 0x0F, NULL, HFILL }},
	{ &hf_vita_led_ovr_func,
		{ "Override State LED Function", "ipmi_vita_led_ovr_func",
			FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(str_vita_led_func), 0, NULL, HFILL }},
	{ &hf_vita_led_ovr_duration,
		{ "Override State On-Duration", "ipmi_vita_led_ovr_duration",
			FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_ovr_color,
		{ "Override State Color", "ipmi_vita_led_ovr_color",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_lamp_test_duration,
		{ "Lamp Test Duration", "ipmi_vita_led_lamp_duration",
			FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_loc_func,
		{ "Local Control LED Function", "ipmi_vita_led_loc_func",
			FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(str_vita_led_func), 0, NULL, HFILL }},
	{ &hf_vita_led_loc_duration,
		{ "Local Control On-Duration", "ipmi_vita_led_loc_duration",
			FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_loc_color,
		{ "Local Control Color", "ipmi_vita_led_loc_color",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_states,
		{ "LED States", "ipmi_vita_led_states",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_led_state_local,
		{ "Local Control State", "ipmi_vita_led_state_loc",
			FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
	{ &hf_vita_led_state_override,
		{ "Override State", "ipmi_vita_led_state_ovr",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_led_state_lamp_test,
		{ "Lamp Test", "ipmi_vita_led_state_lamp",
			FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
	{ &hf_vita_led_state_hw_restrict,
		{ "Hardware Restriction", "ipmi_vita_led_state_hw",
			FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},
	{ &hf_vita_ipmba_state,
		{ "IPMB-A State", "ipmi_vita_ipmba_state",
			FT_UINT8, BASE_HEX|BASE_RANGE_STRING, RVALS(str_vita_ipmb_state), 0, NULL, HFILL }},
	{ &hf_vita_ipmbb_state,
		{ "IPMB-B State", "ipmi_vita_ipmbb_state",
			FT_UINT8, BASE_HEX|BASE_RANGE_STRING, RVALS(str_vita_ipmb_state), 0, NULL, HFILL }},
	{ &hf_vita_ipmb_state,
		{ "IPMB State", "ipmi_vita_ipmb_ovr",
			FT_BOOLEAN, 8, TFS(&str_vita_ipmb_override), 0x01, NULL, HFILL }},
	{ &hf_vita_ipmb_link_id,
		{ "IPMB Link ID", "ipmi_vita_ipmb_link_id",
			FT_UINT8, BASE_DEC_HEX|BASE_RANGE_STRING, RVALS(str_vita_ipmb_link_id), 0xFE, NULL, HFILL }},
	{ &hf_vita_fru_policy_mask_bits,
		{ "FRU Activation Policy Mask Bits", "ipmi_vita_fru_policy_mask",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_policy_set_bits,
		{ "FRU Activation Policy Set Bits", "ipmi_vita_fru_policy_set",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_policy_bits,
		{ "FRU Activation Policies", "ipmi_vita_fru_policy_bits",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_activation_locked,
		{ "Activation Locked", "ipmi_vita_fru_policy_al",
			FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
	{ &hf_vita_fru_deactivation_locked,
		{ "Deactivation Locked", "ipmi_vita_fru_policy_dl",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_fru_commanded_deactivation_ignored,
		{ "Commanded Deactivation Ignored", "ipmi_vita_fru_policy_cdi",
			FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
	{ &hf_vita_fru_default_activation_locked,
		{ "Default Activation Locked", "ipmi_vita_fru_policy_dal",
			FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},
	{ &hf_vita_fru_activation,
		{ "FRU Activation/Deactivation", "ipmi_vita_fru_activation",
			FT_UINT8, BASE_DEC, VALS(str_vita_fru_activation), 0, NULL, HFILL }},
	{ &hf_vita_record_id,
		{ "Record ID", "ipmi_vita_record_id",
			FT_UINT16, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_min_level,
		{ "Minimum Speed Level", "ipmi_vita_fan_min",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_max_level,
		{ "Maximum Speed Level", "ipmi_vita_fan_max",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_norm_level,
		{ "Normal Operating Level", "ipmi_vita_fan_norm",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_properties,
		{ "Fan Tray Properties", "ipmi_vita_fan_props",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_prop_local_control,
		{ "Local Control Supported", "ipmi_vita_fan_prop_lc",
			FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},
	{ &hf_vita_fan_override_level,
		{ "Override Fan Level", "ipmi_vita_fan_ovr",
			FT_UINT8, BASE_HEX, VALS(str_vita_fan_levels), 0, NULL, HFILL }},
	{ &hf_vita_fan_local_level,
		{ "Local Control Fan Level", "ipmi_vita_fan_loc",
			FT_UINT8, BASE_HEX, VALS(str_vita_fan_levels), 0, NULL, HFILL }},
	{ &hf_vita_fan_local_control,
		{ "Local Control Enable State", "ipmi_vita_fan_lc",
			FT_UINT8, BASE_DEC, VALS(str_vita_fan_local_control), 0, NULL, HFILL }},
	{ &hf_vita_ipmb_link_key_type,
		{ "IPMB Link Info Key Type", "ipmi_vita_ipmb_link_key_type",
			FT_UINT8, BASE_DEC, VALS(str_vita_ipmb_link_key_types), 0, NULL, HFILL }},
	{ &hf_vita_ipmb_link_key_value,
		{ "IPMB Link Info Key", "ipmi_vita_ipmb_link_key_value",
				FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_ipmb_link_number,
		{ "IPMB Link Number", "ipmi_vita_ipmb_link_number",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_ipmb_sensor_number,
		{ "IPMB Sensor Number", "ipmi_vita_ipmb_sensor_number",
			FT_UINT8, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_active_chmc_ipmb_addr,
		{ "Active Chassis Manager IPMB Address", "ipmi_vita_active_chmc_ipmb_addr",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_backup_chmc_ipmb_addr,
		{ "Backup Chassis Manager IPMB Address", "ipmi_vita_backup_chmc_ipmb_addr",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_number,
		{ "Fan Tray Site Number", "ipmi_vita_fan_num",
			FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fan_policy,
		{ "Fan Enable State", "ipmi_vita_fan_policy",
			FT_UINT8, BASE_DEC, VALS(str_vita_fan_policies), 0, NULL, HFILL }},
	{ &hf_vita_fan_policy_timeout,
		{ "Fan Policy Timeout", "ipmi_vita_fan_policy_timeout",
			FT_UINT8, BASE_DEC, VALS(str_vita_fan_policy_timeouts), 0, NULL, HFILL }},
	{ &hf_vita_fan_coverage,
		{ "Coverage", "ipmi_vita_fan_coverage",
			FT_UINT8, BASE_DEC, VALS(str_vita_fan_coverages), 0, NULL, HFILL }},
	{ &hf_vita_fru_control_caps,
		{ "FRU Control Capabilities Mask", "ipmi_vita_fru_control_caps",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_control_cap_cold,
		{ "Capable of issuing a cold reset", "ipmi_vita_fru_control_cap_cold",
			FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
	{ &hf_vita_fru_control_cap_warm,
		{ "Capable of issuing a warm reset", "ipmi_vita_fru_control_cap_warm",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_fru_control_cap_grace,
		{ "Capable of issuing a graceful reboot", "ipmi_vita_fru_control_cap_grace",
			FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
	{ &hf_vita_fru_control_cap_diag,
		{ "Capable of issuing a diagnostic interrupt", "ipmi_vita_fru_control_cap_diag",
			FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},
	{ &hf_vita_fru_control_cap_pwr,
		{ "Capable of controlling payload power", "ipmi_vita_fru_control_cap_pwr",
			FT_BOOLEAN, 8, NULL, 0x10, NULL, HFILL }},
	{ &hf_vita_fru_lock_operation,
		{ "FRU Inventory Device Lock Operation", "ipmi_vita_fru_lock_op",
			FT_UINT8, BASE_DEC, VALS(str_vita_fru_lock_operations), 0, NULL, HFILL }},
	{ &hf_vita_fru_lock_id,
		{ "FRU Inventory Device Lock ID", "ipmi_vita_fru_lock_id",
			FT_UINT16, BASE_HEX_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_lock_timestamp,
		{ "FRU Inventory Device Last Commit Timestamp", "ipmi_vita_fru_lock_stamp",
			FT_UINT32, BASE_HEX_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_write_offset,
		{ "FRU Inventory offset to write", "ipmi_vita_fru_write_offset",
			FT_UINT16, BASE_DEC_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_write_data,
		{ "Data to write", "ipmi_vita_fru_write_data",
			FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_write_count,
		{ "Written byte count", "ipmi_vita_fru_write_count",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_addr_number,
		{ "Address Number", "ipmi_vita_chassis_addr_num",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_addr_timestamp,
		{ "Chassis IP Address Last Change Timestamp", "ipmi_vita_chassis_stamp",
			FT_UINT32, BASE_HEX_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_addr_count,
		{ "Address Count", "ipmi_vita_chassis_addr_count",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_max_unavail,
		{ "Maximum Unavailable Time", "ipmi_vita_chassis_max_unavail",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_addr_type,
		{ "Address Type", "ipmi_vita_chassis_addr_type",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_addr,
		{ "Address", "ipmi_vita_chassis_addr",
			FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},
	{ &hf_vita_chassis_addr_chmc,
		{ "Chassis Manager IP Address", "ipmi_vita_chassis_addr_chmc",
			FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},
	{ &hf_vita_chassis_addr_format,
		{ "Address Type", "ipmi_vita_chassis_addr_format",
			FT_UINT8, BASE_HEX|BASE_RANGE_STRING, RVALS(str_vita_chassis_addr_formats), 0x7F, NULL, HFILL }},
	{ &hf_vita_ipv4_addr,
		{ "IPv4 Address", "ipmi_vita_ipv4_addr",
			FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},
	{ &hf_vita_rmcp_port,
		{ "RMCP Port", "ipmi_vita_rmcp_port",
			FT_UINT16, BASE_HEX_DEC, NULL, 0, NULL, HFILL }},
	{ &hf_vita_persistent_control_state,
		{ "FRU Persistent Control Current State", "ipmi_vita_pers_state",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_persistent_control_cold,
		{ "Persistent Cold Reset State", "ipmi_vita_pers_state_cold",
			FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
	{ &hf_vita_persistent_control_warm,
		{ "Persistent Warm Reset State", "ipmi_vita_pers_state_warm",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_persistent_control_mask,
		{ "FRU Persistent Control Selection Mask", "ipmi_vita_pers_mask",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_persistent_control_set,
		{ "FRU Persistent Control Selection", "ipmi_vita_pers_set",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_persistent_control_caps,
		{ "FRU Persistent Control Capabilities Mask", "ipmi_vita_pers_caps",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_persistent_control_cap_cold,
		{ "Capable of asserting a persistent cold reset", "ipmi_vita_pers_cap_cold",
			FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
	{ &hf_vita_persistent_control_cap_warm,
		{ "Capable of asserting a persistent warm reset", "ipmi_vita_pers_cap_warm",
			FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
	{ &hf_vita_fru_state_sensor_num,
		{ "FRU State Sensor Number", "ipmi_vita_sensor_fru_state",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_health_sensor_num,
		{ "FRU Health Sensor Number", "ipmi_vita_sensor_fru_health",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_voltage_sensor_num,
		{ "FRU Voltage Sensor Number", "ipmi_vita_sensor_fru_voltage",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_fru_temp_sensor_num,
		{ "FRU Temperature Sensor Number", "ipmi_vita_sensor_fru_temp",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_payload_test_results_sensor_num,
		{ "Payload Test Results Sensor Number", "ipmi_vita_sensor_payload_test_res",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
	{ &hf_vita_payload_test_status_sensor_num,
		{ "Payload Test Status Sensor Number", "ipmi_vita_sensor_payload_test_status",
			FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }}
};
