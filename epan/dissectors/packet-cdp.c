    ...
    while (tvb_reported_length_remaining(tvb, offset) != 0) {
        ...
        case TYPE_IOS_VERSION:
            if (tree) {
                ...
                proto_tree_add_item(tlv_tree, hf_cdp_software_version, tvb, offset + 4, length - 4, ENC_ASCII|ENC_NA);
            }
            offset += length;
            break;
...
proto_register_cdp(void)
{
    static hf_register_info hf[] = {
        { &hf_cdp_version,
        { "Version",            "cdp_version",  FT_UINT8, BASE_DEC, NULL, 0x0,
          NULL, HFILL }},

        { &hf_cdp_ttl,
        { "TTL",                "cdp_ttl", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_second_seconds, 0x0,
          NULL, HFILL }},

        { &hf_cdp_checksum,
        { "Checksum",           "cdp_checksum", FT_UINT16, BASE_HEX, NULL, 0x0,
          NULL, HFILL }},

        { &hf_cdp_checksum_status,
                { "Checksum Status",       "cdp_checksum_status", FT_UINT8, BASE_NONE, VALS(proto_checksum_vals), 0x0,
                        NULL, HFILL }},

        { &hf_cdp_tlvlength,
        { "Length",             "cdp_tlv_len", FT_UINT16, BASE_DEC, NULL, 0x0,
          NULL, HFILL }},

        { &hf_cdp_nrgyz_tlvtype,
        { "TLV Type",               "cdp_nrgyz_tlv_type", FT_UINT16, BASE_HEX, VALS(type_nrgyz_vals), 0x0,
          NULL, HFILL }},

        { &hf_cdp_nrgyz_tlvlength,
        { "TLV Length",             "cdp_nrgyz_tlv_len", FT_UINT16, BASE_DEC, NULL, 0x0,
          NULL, HFILL }},

        { &hf_cdp_deviceid,
        {"Device ID", "cdp_deviceid", FT_STRING, BASE_NONE,
         NULL, 0, NULL, HFILL }},

        { &hf_cdp_platform,
        {"Platform", "cdp_platform", FT_STRING, BASE_NONE,
         NULL, 0, NULL, HFILL }},

        { &hf_cdp_portid,
        {"Sent through Interface", "cdp_portid", FT_STRING, BASE_NONE,
                NULL, 0, NULL, HFILL }},

        { &hf_cdp_capabilities,
        {"Capabilities", "cdp_capabilities", FT_UINT32, BASE_HEX,
                NULL, 0, NULL, HFILL }},

        { &hf_cdp_capabilities_router,
        {"Router", "cdp_capabilities_router", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x01, NULL, HFILL }},

        { &hf_cdp_capabilities_trans_bridge,
        {"Transparent Bridge", "cdp_capabilities_trans_bridge", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x02, NULL, HFILL }},

        { &hf_cdp_capabilities_src_bridge,
        {"Source Route Bridge", "cdp_capabilities_src_bridge", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x04, NULL, HFILL }},

        { &hf_cdp_capabilities_switch,
        {"Switch", "cdp_capabilities_switch", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x08, NULL, HFILL }},

        { &hf_cdp_capabilities_host,
        {"Host", "cdp_capabilities_host", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x10, NULL, HFILL }},

        { &hf_cdp_capabilities_igmp_capable,
        {"IGMP capable", "cdp_capabilities_igmp_capable", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x20, NULL, HFILL }},

        { &hf_cdp_capabilities_repeater,
        {"Repeater", "cdp_capabilities_repeater", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x40, NULL, HFILL }},

        { &hf_cdp_capabilities_voip_phone,
        {"VoIP Phone", "cdp_capabilities_voip_phone", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x80, NULL, HFILL }},

        { &hf_cdp_capabilities_remote,
        {"Remotely Managed Device", "cdp_capabilities_remote", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x0100, NULL, HFILL }},

        { &hf_cdp_capabilities_cvta,
        {"CVTA/STP Dispute Resolution/Cisco VT Camera", "cdp_capabilities_cvta", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x0200, NULL, HFILL }},

        { &hf_cdp_capabilities_mac_relay,
        {"Two Port Mac Relay", "cdp_capabilities_mac_relay", FT_BOOLEAN, 32,
                TFS(&tfs_yes_no), 0x0400, NULL, HFILL }},

        { &hf_cdp_spare_poe_tlv,
        { "Spare Pair PoE", "cdp_spare_poe_tlv", FT_UINT8, BASE_HEX,
                NULL, 0x0, NULL, HFILL }
        },

        { &hf_cdp_spare_poe_tlv_poe,
        { "PSE Four-Wire PoE", "cdp_spare_poe_tlv_poe", FT_BOOLEAN, 8,
                TFS(&tfs_supported_not_supported), 0x01, NULL, HFILL }
        },

        { &hf_cdp_spare_poe_tlv_spare_pair_arch,
        { "PD Spare Pair Architecture", "cdp_spare_poe_tlv_spare_pair_arch", FT_BOOLEAN, 8,
                TFS(&tfs_shared_independent), 0x02, NULL, HFILL }
        },

        { &hf_cdp_spare_poe_tlv_req_spare_pair_poe,
        { "PD Request Spare Pair PoE", "cdp_spare_poe_tlv_req_spare_pair_poe", FT_BOOLEAN, 8,
                TFS(&tfs_on_off), 0x04, NULL, HFILL }
        },

        { &hf_cdp_spare_poe_tlv_pse_spare_pair_poe,
        { "PSE Spare Pair PoE", "cdp_spare_poe_tlv_pse_spare_pair_poe", FT_BOOLEAN, 8,
                TFS(&tfs_on_off), 0x08, NULL, HFILL }
        },

      /* Generated from convert_proto_tree_add_text.pl */
      { &hf_cdp_odr_default_gateway, { "ODR Default gateway", "cdp_odr_default_gateway", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_ip_prefix, { "IP Prefix", "cdp_ip_prefix", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_oui, { "OUI", "cdp_oui", FT_UINT24, BASE_OUI, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_master_ip, { "Cluster Master IP", "cdp_cluster_master_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_ip, { "IP?", "cdp_cluster_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_version, { "Version?", "cdp_cluster_version", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_sub_version, { "Sub Version?", "cdp_cluster_sub_version", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_status, { "Status?", "cdp_cluster_status", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_unknown, { "UNKNOWN", "cdp_cluster_unknown", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_commander_mac, { "Cluster Commander MAC", "cdp_cluster_commander_mac", FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_switch_mac, { "Switch's MAC", "cdp_cluster_switch_mac", FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_cluster_management_vlan, { "Management VLAN", "cdp_cluster_management_vlan", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_hello_unknown, { "Unknown", "cdp_hello_unknown", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_vtp_management_domain, { "VTP Management Domain", "cdp_vtp_management_domain", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_native_vlan, { "Native VLAN", "cdp_native_vlan", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_duplex, { "Duplex", "cdp_duplex", FT_BOOLEAN, BASE_NONE, TFS(&tfs_full_half), 0x0, NULL, HFILL }},
      { &hf_cdp_data, { "Data", "cdp_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_voice_vlan, { "Voice VLAN", "cdp_voice_vlan", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_power_consumption, { "Power Consumption", "cdp_power_consumption", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_mw, 0x0, NULL, HFILL }},
      { &hf_cdp_mtu, { "MTU", "cdp_mtu", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_trust_bitmap, { "Trust Bitmap", "cdp_trust_bitmap", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_untrusted_port_cos, { "Untrusted port CoS", "cdp_untrusted_port_cos", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_system_name, { "System Name", "cdp_system_name", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_system_object_identifier, { "System Object Identifier", "cdp_system_object_identifier", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_location_unknown, { "UNKNOWN", "cdp_location_unknown", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_location, { "Location", "cdp_location", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_management_id, { "Management-ID", "cdp_management_id", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_power_requested, { "Power Requested", "cdp_power_requested", FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_mw, 0x0, NULL, HFILL }},
      { &hf_cdp_power_available, { "Power Available", "cdp_power_available", FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_mw, 0x0, NULL, HFILL }},
      { &hf_cdp_encrypted_data, { "Encrypted Data", "cdp_encrypted_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_seen_sequence, { "Seen Sequence?", "cdp_seen_sequence", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_sequence_number, { "Sequence Number", "cdp_sequence_number", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_model_number, { "Model Number", "cdp_model_number", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_unknown_pad, { "Unknown Pad", "cdp_unknown_pad", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_hardware_version_id, { "Hardware Version ID", "cdp_hardware_version_id", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_system_serial_number, { "System Serial Number", "cdp_system_serial_number", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_unknown_values, { "Unknown Values", "cdp_nrgyz_unknown_values", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_len_tlv_table, { "Length of TLV table", "cdp_len_tlv_table", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_num_tlvs_table, { "Number of TLVs in table", "cdp_num_tlvs_table", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_address, { "Address", "cdp_address", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_unknown_field, { "Unknown Field", "cdp_nrgyz_reply_to_unknown_field", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_port, { "Port", "cdp_nrgyz_reply_to_port", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_ip_address, { "IP Address", "cdp_nrgyz_ip_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_ip6_address, { "IPv6 Address", "cdp_nrgyz_ipv6_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_ip_address, { "IP Address", "cdp_nrgyz_reply_to_ip_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_backup_server_port, { "Backup server Port?", "cdp_nrgyz_reply_to_backup_server_port", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_backup_server_ip, { "Backup Server IP?", "cdp_nrgyz_reply_to_backup_server_ip", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_name, { "Name", "cdp_nrgyz_reply_to_name", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_domain, { "Domain", "cdp_nrgyz_reply_to_domain", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_nrgyz_reply_to_role, { "Role", "cdp_nrgyz_reply_to_role", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_cdp_software_version, { "Software version", "cdp_software_version", FT_STRINGZ, BASE_NONE, NULL, 0x0, NULL, HFILL }},
    };
