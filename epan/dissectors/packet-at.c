...
proto_register_at_command(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_at_command_line_prefix,
           { "Command Line Prefix",              "at_command_line_prefix",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_parameter,
           { "Parameter",                        "at_parameter",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_unknown_parameter,
           { "Unknown Parameter",                "at_unknown_parameter",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_role,
        ...
        { &hf_cmer_disp,
           { "Display",                          "at_cmer_disp",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cmer_ind,
           { "Indicator",                        "at_cmer_ind",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cmer_bfr,
        ...
        { &hf_cme_error,
           { "CME Error (Numeric)",              "at_cme_error",
           FT_UINT8, BASE_DEC, VALS(cme_error_vals), 0,
           NULL, HFILL}
        },
        { &hf_cme_error_verbose,
           { "CME Error (Verbose)",              "at_cme_error_verbose",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cmee,
        ...
        { &hf_cmux_n1,
           { "Maximum Frame Size",               "at_n1",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cmux_n2,
           { "Maximum Number of Re-transmissions",  "at_n2",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cmux_port_speed,
           { "Transmission Rate",                "at_port_speed",
        ...
        { &hf_cmux_t1,
           { "Acknowledgement Timer",            "at_t1",
           FT_UINT8, BASE_DEC, NULL, 0,
           "Acknowledgement timer in units of ten milliseconds",
           HFILL}
        },
        { &hf_cmux_t2,
           { "Response Timer",                   "at_t2",
           FT_UINT8, BASE_DEC, NULL, 0,
           "Response timer for the multiplexer control channel in units of ten milliseconds",
           HFILL}
        },
        { &hf_cmux_t3,
           { "Wake Up Response Timer",           "at_t3",
           FT_UINT8, BASE_DEC, NULL, 0,
           "Wake up response timer in seconds",
           HFILL}
        },
        { &hf_cmux_transparency,
           { "Transparency Mechanism",           "at_transparency",
           FT_UINT8, BASE_DEC, VALS(cmux_transparency_vals), 0,
           NULL,
           HFILL}
        },
        { &hf_chld_mode,
           { "Mode",                             "at_chld_mode_value",
           FT_UINT8, BASE_DEC, VALS(chld_vals), 0,
           NULL, HFILL}
        },
        { &hf_chld_mode_1x,
           { "Mode: Releases specified active call only",  "at_chld_mode",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_chld_mode_2x,
           { "Mode:  Request private consultation mode with specified call - place all calls on hold EXCEPT the call indicated by x",  "at_chld_mode",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_chld_supported_modes,
           { "Supported Modes",                  "at_chld_supported_modes",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cimi_imsi,
        ...
        { &hf_ciev_indicator_index,
           { "Indicator Index",                  "at_ciev_indicator_index",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL}
        },
        { &hf_vts_dtmf,
        ...
        { &hf_cops_format,
           { "Format",                           "at_cops_format",
           FT_UINT8, BASE_DEC, VALS(cops_format_vals), 0,
           NULL, HFILL}
        },
        { &hf_cops_operator,
           { "Operator",                         "at_cops_operator",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cops_act,
        ...
        { &hf_at_subaddress,
           { "Subaddress",                       "at_subaddress",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_at_subaddress_type,
           { "Subaddress Type",                  "at_subaddress_type",
           FT_UINT8, BASE_DEC | BASE_RANGE_STRING, RVALS(at_type_vals), 0,
           NULL, HFILL}
        },
        { &hf_cnum_speed,
        ...
        { &hf_cnum_service,
           { "Service",                          "at_cnum_service",
           FT_UINT8, BASE_DEC, VALS(cnum_service_vals), 0,
           NULL, HFILL}
        },
        { &hf_cnum_itc,
           { "Information Transfer Capability",  "at_cnum_itc",
        ...
        { &hf_ccwa_show_result_code,
           { "Show Result Code Presentation Status",       "at_ccwa_presentation_status",
        ...
        { &hf_cgmi_manufacturer_id,
           { "Manufacturer Identification",       "at_cgmi_manufacturer_id",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cgmm_model_id,
           { "Model Identification",              "at_cgmm_model_id",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_cgmr_revision_id,
           { "Revision Identification",           "at_cgmr_revision_id",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_gmi_manufacturer_id,
           { "Manufacturer Identification",       "at_gmi_manufacturer_id",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_gmm_model_id,
           { "Model Identification",              "at_gmm_model_id",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_gmr_revision_id,
           { "Revision Identification",           "at_gmr_revision_id",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_zpas_network,
           { "Network type",                      "at_zpas_network",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_zpas_srv_domain,
           { "Service domain",                    "at_zpas_srv_domain",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_zusim_usim_card,
           { "USIM card type",                    "at_zusim_usim_card",
           FT_UINT8, BASE_DEC, VALS(zusim_usim_card_vals), 0,
           "The type of the current (U)SIM card",
           HFILL}
        },
        { &hf_indicator[0],
           { "Indicator 1",                      "at_indicator_1",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[1],
           { "Indicator 2",                      "at_indicator_2",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[2],
           { "Indicator 3",                      "at_indicator_3",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[3],
           { "Indicator 4",                      "at_indicator_4",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[4],
           { "Indicator 5",                      "at_indicator_5",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[5],
           { "Indicator 6",                      "at_indicator_6",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[6],
           { "Indicator 7",                      "at_indicator_7",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[7],
           { "Indicator 8",                      "at_indicator_8",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[8],
           { "Indicator 9",                      "at_indicator_9",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[9],
           { "Indicator 10",                     "at_indicator_10",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[10],
           { "Indicator 11",                     "at_indicator_11",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[11],
           { "Indicator 12",                     "at_indicator_12",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[12],
           { "Indicator 13",                     "at_indicator_13",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[13],
           { "Indicator 14",                     "at_indicator_14",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[14],
           { "Indicator 15",                     "at_indicator_15",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[15],
           { "Indicator 16",                     "at_indicator_16",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[16],
           { "Indicator 17",                     "at_indicator_17",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[17],
           { "Indicator 18",                     "at_indicator_18",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[18],
           { "Indicator 19",                     "at_indicator_19",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
        { &hf_indicator[19],
           { "Indicator 20",                     "at_indicator_20",
           FT_STRING, BASE_NONE, NULL, 0,
           NULL, HFILL}
        },
    };
