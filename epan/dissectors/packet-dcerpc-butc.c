...
/* INCLUDED FILE : ETH_HFARR */
		{ &hf_butc_opnum,
		  { "Operation", "butc_opnum", FT_UINT16, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_rc,
		  { "Return code", "butc_rc", FT_UINT32, BASE_HEX,
		  VALS(NT_errors), 0,
		 NULL, HFILL }},

		{ &hf_butc_Restore_flags_TC_RESTORE_CREATE,
		  { "TC_RESTORE_CREATE", "butc_Restore_flags_TC_RESTORE_CREATE", FT_BOOLEAN, 32,
		  TFS(&TC_RESTORE_CREATE_tfs), 0x00000001,
		 NULL, HFILL }},

		{ &hf_butc_Restore_flags_TC_RESTORE_INCR,
		  { "TC_RESTORE_INCR", "butc_Restore_flags_TC_RESTORE_INCR", FT_BOOLEAN, 32,
		  TFS(&TC_RESTORE_INCR_tfs), 0x00000002,
		 NULL, HFILL }},

		{ &hf_butc_afsNetAddr_type,
		  { "type", "butc_afsNetAddr_type", FT_UINT16, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_afsNetAddr_data,
		  { "data", "butc_afsNetAddr_data", FT_UINT8, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_vid,
		  { "vid", "butc_tc_dumpDesc_vid", FT_UINT64, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_name,
		  { "name", "butc_tc_dumpDesc_name", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_partition,
		  { "partition", "butc_tc_dumpDesc_partition", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_date,
		  { "date", "butc_tc_dumpDesc_date", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_cloneDate,
		  { "cloneDate", "butc_tc_dumpDesc_cloneDate", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_hostAddr,
		  { "hostAddr", "butc_tc_dumpDesc_hostAddr", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_spare1,
		  { "spare1", "butc_tc_dumpDesc_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_spare2,
		  { "spare2", "butc_tc_dumpDesc_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_spare3,
		  { "spare3", "butc_tc_dumpDesc_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpDesc_spare4,
		  { "spare4", "butc_tc_dumpDesc_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_frag,
		  { "frag", "butc_tc_restoreDesc_frag", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_tapeName,
		  { "tapeName", "butc_tc_restoreDesc_tapeName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_position,
		  { "position", "butc_tc_restoreDesc_position", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_origVid,
		  { "origVid", "butc_tc_restoreDesc_origVid", FT_UINT64, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_vid,
		  { "vid", "butc_tc_restoreDesc_vid", FT_UINT64, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_partition,
		  { "partition", "butc_tc_restoreDesc_partition", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_flags,
		  { "flags", "butc_tc_restoreDesc_flags", FT_UINT32, BASE_HEX,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_hostAddr,
		  { "hostAddr", "butc_tc_restoreDesc_hostAddr", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_realDumpId,
		  { "realDumpId", "butc_tc_restoreDesc_realDumpId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_spare2,
		  { "spare2", "butc_tc_restoreDesc_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_spare3,
		  { "spare3", "butc_tc_restoreDesc_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_spare4,
		  { "spare4", "butc_tc_restoreDesc_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_oldName,
		  { "oldName", "butc_tc_restoreDesc_oldName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreDesc_newName,
		  { "newName", "butc_tc_restoreDesc_newName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_dumpID,
		  { "dumpID", "butc_tc_dumpStat_dumpID", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_bytesDumped,
		  { "bytesDumped", "butc_tc_dumpStat_bytesDumped", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_volumeBeingDumped,
		  { "volumeBeingDumped", "butc_tc_dumpStat_volumeBeingDumped", FT_UINT64, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_numVolErrs,
		  { "numVolErrs", "butc_tc_dumpStat_numVolErrs", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_flags,
		  { "flags", "butc_tc_dumpStat_flags", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_spare1,
		  { "spare1", "butc_tc_dumpStat_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_spare2,
		  { "spare2", "butc_tc_dumpStat_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_spare3,
		  { "spare3", "butc_tc_dumpStat_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpStat_spare4,
		  { "spare4", "butc_tc_dumpStat_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_size,
		  { "size", "butc_tc_tapeLabel_size", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_size_ext,
		  { "size_ext", "butc_tc_tapeLabel_size_ext", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_spare1,
		  { "spare1", "butc_tc_tapeLabel_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_spare2,
		  { "spare2", "butc_tc_tapeLabel_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_spare3,
		  { "spare3", "butc_tc_tapeLabel_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_spare4,
		  { "spare4", "butc_tc_tapeLabel_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_nameLen,
		  { "nameLen", "butc_tc_tapeLabel_nameLen", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeLabel_name,
		  { "name", "butc_tc_tapeLabel_name", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_id,
		  { "id", "butc_tc_tapeSet_id", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_tapeServer,
		  { "tapeServer", "butc_tc_tapeSet_tapeServer", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_format,
		  { "format", "butc_tc_tapeSet_format", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_maxTapes,
		  { "maxTapes", "butc_tc_tapeSet_maxTapes", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_a,
		  { "a", "butc_tc_tapeSet_a", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_b,
		  { "b", "butc_tc_tapeSet_b", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_expDate,
		  { "expDate", "butc_tc_tapeSet_expDate", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_expType,
		  { "expType", "butc_tc_tapeSet_expType", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_spare1,
		  { "spare1", "butc_tc_tapeSet_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_spare2,
		  { "spare2", "butc_tc_tapeSet_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_spare3,
		  { "spare3", "butc_tc_tapeSet_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tapeSet_spare4,
		  { "spare4", "butc_tc_tapeSet_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tcInfo_tcVersion,
		  { "tcVersion", "butc_tc_tcInfo_tcVersion", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tcInfo_spare1,
		  { "spare1", "butc_tc_tcInfo_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tcInfo_spare2,
		  { "spare2", "butc_tc_tcInfo_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tcInfo_spare3,
		  { "spare3", "butc_tc_tcInfo_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_tcInfo_spare4,
		  { "spare4", "butc_tc_tcInfo_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreArray_tc_restoreArray_len,
		  { "tc_restoreArray_len", "butc_tc_restoreArray_tc_restoreArray_len", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_restoreArray_tc_restoreArray_val,
		  { "tc_restoreArray_val", "butc_tc_restoreArray_tc_restoreArray_val", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpArray_tc_dumpArray_len,
		  { "tc_dumpArray_len", "butc_tc_dumpArray_tc_dumpArray_len", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpArray_tc_dumpArray,
		  { "tc_dumpArray", "butc_tc_dumpArray_tc_dumpArray", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_dumpPath,
		  { "dumpPath", "butc_tc_dumpInterface_dumpPath", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_volumeSetName,
		  { "volumeSetName", "butc_tc_dumpInterface_volumeSetName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_dumpName,
		  { "dumpName", "butc_tc_dumpInterface_dumpName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_tapeSet,
		  { "tapeSet", "butc_tc_dumpInterface_tapeSet", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_parentDumpId,
		  { "parentDumpId", "butc_tc_dumpInterface_parentDumpId", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_dumpLevel,
		  { "dumpLevel", "butc_tc_dumpInterface_dumpLevel", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_spare1,
		  { "spare1", "butc_tc_dumpInterface_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_spare2,
		  { "spare2", "butc_tc_dumpInterface_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_spare3,
		  { "spare3", "butc_tc_dumpInterface_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_dumpInterface_spare4,
		  { "spare4", "butc_tc_dumpInterface_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitchVol_nKBytes,
		  { "nKBytes", "butc_tc_statusInfoSwitchVol_nKBytes", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitchVol_volumeName,
		  { "volumeName", "butc_tc_statusInfoSwitchVol_volumeName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitchVol_volsFailed,
		  { "volsFailed", "butc_tc_statusInfoSwitchVol_volsFailed", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitchVol_spare1,
		  { "spare1", "butc_tc_statusInfoSwitchVol_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitchLabel_tapeLabel,
		  { "tapeLabel", "butc_tc_statusInfoSwitchLabel_tapeLabel", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitchLabel_spare1,
		  { "spare1", "butc_tc_statusInfoSwitchLabel_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitch_TCOP_NONE_none,
		  { "none", "butc_tc_statusInfoSwitch_none", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitch_TCOP_DUMP_vol,
		  { "vol", "butc_tc_statusInfoSwitch_vol", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},
		...
		{ &hf_butc_tc_statusInfoSwitch_TCOP_LABELTAPE_label,
		  { "label", "butc_tc_statusInfoSwitch_label", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},
		...
		{ &hf_butc_tc_statusInfoSwitch_TCOP_SCANTAPE_spare1,
		  { "spare1", "butc_tc_statusInfoSwitch_spare1", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitch_TCOP_STATUS_spare2,
		  { "spare2", "butc_tc_statusInfoSwitch_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitch_TCOP_SAVEDB_spare3,
		  { "spare3", "butc_tc_statusInfoSwitch_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitch_TCOP_RESTOREDB_spare4,
		  { "spare4", "butc_tc_statusInfoSwitch_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tc_statusInfoSwitch_TCOP_SPARE_spare5,
		  { "spare5", "butc_tc_statusInfoSwitch_spare5", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_taskName,
		  { "taskName", "butc_tciStatusS_taskName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_flags,
		  { "flags", "butc_tciStatusS_flags", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_lastPolled,
		  { "lastPolled", "butc_tciStatusS_lastPolled", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_info,
		  { "info", "butc_tciStatusS_info", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_taskId,
		  { "taskId", "butc_tciStatusS_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_spare2,
		  { "spare2", "butc_tciStatusS_spare2", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_spare3,
		  { "spare3", "butc_tciStatusS_spare3", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_tciStatusS_spare4,
		  { "spare4", "butc_tciStatusS_spare4", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_PerformDump_tcdiPtr,
		  { "tcdiPtr", "butc_BUTC_PerformDump_tcdiPtr", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_PerformDump_dumps,
		  { "dumps", "butc_BUTC_PerformDump_dumps", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_PerformDump_dumpID,
		  { "dumpID", "butc_BUTC_PerformDump_dumpID", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_PerformRestore_dumpSetName,
		  { "dumpSetName", "butc_BUTC_PerformRestore_dumpSetName", FT_STRING, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_PerformRestore_restores,
		  { "restores", "butc_BUTC_PerformRestore_restores", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_PerformRestore_dumpID,
		  { "dumpID", "butc_BUTC_PerformRestore_dumpID", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_AbortDump_dumpID,
		  { "dumpID", "butc_BUTC_AbortDump_dumpID", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_LabelTape_label,
		  { "label", "butc_BUTC_LabelTape_label", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_LabelTape_taskId,
		  { "taskId", "butc_BUTC_LabelTape_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_ReadLabel_taskId,
		  { "taskId", "butc_BUTC_ReadLabel_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_ScanDumps_addDbFlag,
		  { "addDbFlag", "butc_BUTC_ScanDumps_addDbFlag", FT_INT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_ScanDumps_taskId,
		  { "taskId", "butc_BUTC_ScanDumps_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_TCInfo_tciptr,
		  { "tciptr", "butc_BUTC_TCInfo_tciptr", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_SaveDb_taskId,
		  { "taskId", "butc_BUTC_SaveDb_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_RestoreDb_taskId,
		  { "taskId", "butc_BUTC_RestoreDb_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_EndStatus_taskId,
		  { "taskId", "butc_BUTC_EndStatus_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_GetStatus_taskId,
		  { "taskId", "butc_BUTC_GetStatus_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_GetStatus_statusPtr,
		  { "statusPtr", "butc_BUTC_GetStatus_statusPtr", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_RequestAbort_taskId,
		  { "taskId", "butc_BUTC_RequestAbort_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_ScanStatus_taskId,
		  { "taskId", "butc_BUTC_ScanStatus_taskId", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_ScanStatus_statusPtr,
		  { "statusPtr", "butc_BUTC_ScanStatus_statusPtr", FT_NONE, BASE_NONE,
		  NULL, 0,
		 NULL, HFILL }},

		{ &hf_butc_BUTC_ScanStatus_flags,
		  { "flags", "butc_BUTC_ScanStatus_flags", FT_UINT32, BASE_DEC,
		  NULL, 0,
		 NULL, HFILL }},
