...
void proto_register_mqttsn(void)
{
    static hf_register_info hf_mqttsn[] = {
        ...
        { &hf_mqttsn_msg_len,
            { "Message Length", "mqttsn_msg_len",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_msg_type,
            { "Message Type", "mqttsn_msg_type",
        ...
        { &hf_mqttsn_clean_session,
            { "Clean Session", "mqttsn_clean_session",
                FT_BOOLEAN, 8, TFS(&tfs_yes_no), MQTTSN_MASK_CLEAN,
                NULL, HFILL }
        },
        { &hf_mqttsn_topic_id_type,
            { "Topic ID Type", "mqttsn_topic_id_type",
        ...
        { &hf_mqttsn_retain,
            { "Retain", "mqttsn_retain",
                FT_BOOLEAN, 8, TFS(&tfs_yes_no), MQTTSN_MASK_RETAIN,
                NULL, HFILL }
        },
        { &hf_mqttsn_return_code,
            { "Return Code", "mqttsn_return_code",
                FT_UINT8, BASE_HEX, VALS(mqttsn_return_vals), 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_gw_id,
            { "Gateway ID", "mqttsn_gw_id",
                FT_UINT8, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_gw_addr,
            { "Gateway Address", "mqttsn_gw_addr",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_adv_interv,
            { "Advertise Interval", "mqttsn_adv_interv",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_radius,
            { "Broadcast Radius", "mqttsn_radius",
                FT_UINT8, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_protocol_id,
            { "Protocol ID", "mqttsn_protocol_id",
                FT_UINT8, BASE_HEX, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_topic_id,
            { "Topic ID", "mqttsn_topic_id",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_msg_id,
            { "Message ID", "mqttsn_msg_id",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_topic,
            { "Topic Name", "mqttsn_topic",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_topic_name_or_id,
            { "Topic Name/ID", "mqttsn_topic_name_or_id",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_sleep_timer,
            { "Sleep Timer", "mqttsn_sleep_timer",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_will_topic,
            { "Will Topic", "mqttsn_will_topic",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_will_msg,
            { "Will Message", "mqttsn_will_msg",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_pub_msg,
            { "Message", "mqttsn_pub_msg",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_client_id,
            { "Client ID", "mqttsn_client_id",
                FT_STRING, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_keep_alive,
            { "Keep Alive", "mqttsn_keep_alive",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_mqttsn_control_info,
            { "Control", "mqttsn_control_info",
                FT_UINT8, BASE_HEX, NULL, MQTTSN_MASK_CONTROL,
                NULL, HFILL }
        },
        { &hf_mqttsn_wireless_node_id,
            { "Wireless Node ID", "mqttsn_wireless_node_id",
                FT_UINT16, BASE_DEC, NULL, 0x0,
                NULL, HFILL }
        }
    };
