...
/* Setup list of header fields  See Section 1.6.1 for details*/
    static hf_register_info hf[] = {
        ...
        { &hf_h264_profile_idc,
            { "Profile_idc",           "h264_profile_idc",
            FT_UINT8, BASE_DEC, VALS(h264_profile_idc_values), 0xff,
            NULL, HFILL }
        },
        { &hf_h264_rbsp_stop_bit,
            { "rbsp_stop_bit",           "h264_rbsp_stop_bit",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_rbsp_trailing_bits,
            { "rbsp_trailing_bits",           "h264_rbsp_trailing_bits",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_constraint_set0_flag,
            { "Constraint_set0_flag",           "h264_constraint_set0_flag",
            FT_UINT8, BASE_DEC, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_h264_constraint_set1_flag,
            { "Constraint_set1_flag",           "h264_constraint_set1_flag",
            FT_UINT8, BASE_DEC, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_h264_constraint_set2_flag,
            { "Constraint_set2_flag",           "h264_constraint_set2_flag",
            FT_UINT8, BASE_DEC, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_h264_constraint_set3_flag,
            { "Constraint_set3_flag",           "h264_constraint_set3_flag",
            FT_UINT8, BASE_DEC, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_h264_constraint_set4_flag,
            { "Constraint_set4_flag",           "h264_constraint_set4_flag",
            FT_UINT8, BASE_DEC, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_h264_constraint_set5_flag,
            { "Constraint_set5_flag",           "h264_constraint_set5_flag",
            FT_UINT8, BASE_DEC, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_h264_reserved_zero_2bits,
            { "Reserved_zero_2bits",           "h264_reserved_zero_2bits",
            FT_UINT8, BASE_DEC, NULL, 0x03,
            NULL, HFILL }
        },
        { &hf_h264_level_idc,
            { "Level_id",           "h264_level_id",
            FT_UINT8, BASE_DEC, NULL, 0xff,
            NULL, HFILL }
        },
        { &hf_h264_nal_unit,
            { "NAL unit",           "h264_nal_unit",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_forbidden_zero_bit,
            { "Forbidden_zero_bit",           "h264_forbidden_zero_bit",
            FT_UINT8, BASE_DEC, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_h264_nal_ref_idc,
            { "Nal_ref_idc",           "h264_nal_ref_idc",
            FT_UINT8, BASE_DEC, NULL, 0x60,
            NULL, HFILL }
        },
        {&hf_h264_nal_unit_type,
            { "Nal_unit_type",           "h264_nal_unit_type",
            FT_UINT8, BASE_DEC, VALS(h264_nal_unit_type_vals), 0x1f,
            NULL, HFILL }
        },
        { &hf_h264_seq_parameter_set_id,
            { "seq_parameter_set_id",           "h264_seq_parameter_set_id",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_chroma_format_idc,
            { "chroma_format_id",           "h264_chroma_format_id",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_residual_colour_transform_flag,
            { "residual_colour_transform_flag",           "h264_residual_colour_transform_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_bit_depth_luma_minus8,
            { "bit_depth_luma_minus8",           "h264_bit_depth_luma_minus8",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_bit_depth_chroma_minus8,
            { "bit_depth_chroma_minus8",           "h264_bit_depth_chroma_minus8",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_qpprime_y_zero_transform_bypass_flag,
            { "qpprime_y_zero_transform_bypass_flag",           "h264_qpprime_y_zero_transform_bypass_flag",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_seq_scaling_matrix_present_flag,
            { "seq_scaling_matrix_present_flag",           "h264_seq_scaling_matrix_present_flag",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_seq_scaling_list_present_flag,
            { "seq_scaling_list_present_flag",           "h264_seq_scaling_list_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_delta_scale,
            { "delta_scale",           "h264_delta_scale",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_log2_max_frame_num_minus4,
            { "log2_max_frame_num_minus4",           "h264_log2_max_frame_num_minus4",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_order_cnt_type,
            { "pic_order_cnt_type",           "h264_pic_order_cnt_type",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_log2_max_pic_order_cnt_lsb_minus4,
            { "log2_max_pic_order_cnt_lsb_minus4",           "h264_log2_max_pic_order_cnt_lsb_minus4",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_delta_pic_order_always_zero_flag,
            { "delta_pic_order_always_zero_flag",           "h264_delta_pic_order_always_zero_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_offset_for_non_ref_pic,
            { "offset_for_non_ref_pic",           "h264_offset_for_non_ref_pic",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_offset_for_top_to_bottom_field,
            { "offset_for_top_to_bottom_field",           "h264_offset_for_top_to_bottom_field",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_ref_frames_in_pic_order_cnt_cycle,
            { "num_ref_frames_in_pic_order_cnt_cycle",           "h264_num_ref_frames_in_pic_order_cnt_cycle",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_offset_for_ref_frame,
            { "offset_for_ref_frame",           "h264_offset_for_ref_frame",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_ref_frames,
            { "num_ref_frames",           "h264_num_ref_frames",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_gaps_in_frame_num_value_allowed_flag,
            { "gaps_in_frame_num_value_allowed_flag",           "h264_gaps_in_frame_num_value_allowed_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_width_in_mbs_minus1,
            { "pic_width_in_mbs_minus1",           "h264_pic_width_in_mbs_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_height_in_map_units_minus1,
            { "pic_height_in_map_units_minus1",           "h264_pic_height_in_map_units_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_frame_mbs_only_flag,
            { "frame_mbs_only_flag",           "h264_frame_mbs_only_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_mb_adaptive_frame_field_flag,
            { "mb_adaptive_frame_field_flag",           "h264_mb_adaptive_frame_field_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_direct_8x8_inference_flag,
            { "direct_8x8_inference_flag",           "h264_direct_8x8_inference_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_frame_cropping_flag,
            { "frame_cropping_flag",           "h264_frame_cropping_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_frame_crop_left_offset,
            { "frame_crop_left_offset",           "h264_frame_crop_left_offset",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_frame_crop_right_offset,
            { "frame_crop_right_offset",           "h264_frame_crop_right_offset",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_frame_crop_top_offset,
            { "frame_crop_top_offset",           "h264_frame_crop_top_offset",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_frame_crop_bottom_offset,
            { "frame_crop_bottom_offset",           "h264_frame_crop_bottom_offset",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_vui_parameters_present_flag,
            { "vui_parameters_present_flag",           "h264_vui_parameters_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_parameter_set_id,
            { "pic_parameter_set_id",           "h264_pic_parameter_set_id",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_entropy_coding_mode_flag,
            { "entropy_coding_mode_flag",           "h264_entropy_coding_mode_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_order_present_flag,
            { "pic_order_present_flag",           "h264_pic_order_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_slice_groups_minus1,
            { "num_slice_groups_minus1",           "h264_num_slice_groups_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_slice_group_map_type,
            { "slice_group_map_type",           "h264_slice_group_map_type",
            FT_UINT32, BASE_DEC, VALS(h264_slice_group_map_type_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_ref_idx_l0_active_minus1,
            { "num_ref_idx_l0_active_minus1",           "h264_num_ref_idx_l0_active_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_ref_idx_l1_active_minus1,
            { "num_ref_idx_l1_active_minus1",           "h264_num_ref_idx_l1_active_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_weighted_pred_flag,
            { "weighted_pred_flag",           "h264_weighted_pred_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_weighted_bipred_idc,
            { "weighted_bipred_idc",           "h264_weighted_bipred_idc",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_init_qp_minus26,
            { "pic_init_qp_minus26",           "h264_pic_init_qp_minus26",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_init_qs_minus26,
            { "pic_init_qs_minus26",           "h264_pic_init_qs_minus26",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_chroma_qp_index_offset,
            { "chroma_qp_index_offset",           "h264_chroma_qp_index_offset",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_deblocking_filter_control_present_flag,
            { "deblocking_filter_control_present_flag",           "h264_deblocking_filter_control_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_constrained_intra_pred_flag,
            { "constrained_intra_pred_flag",           "h264_constrained_intra_pred_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_redundant_pic_cnt_present_flag,
            { "redundant_pic_cnt_present_flag",           "h264_redundant_pic_cnt_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_transform_8x8_mode_flag,
            { "transform_8x8_mode_flag",           "h264_transform_8x8_mode_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_scaling_matrix_present_flag,
            { "pic_scaling_matrix_present_flag",           "h264_pic_scaling_matrix_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_second_chroma_qp_index_offset,
            { "second_chroma_qp_index_offset",           "h264_second_chroma_qp_index_offset",
            FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },

        { &hf_h264_aspect_ratio_info_present_flag,
            { "aspect_ratio_info_present_flag",           "h264_aspect_ratio_info_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_aspect_ratio_idc,
            { "aspect_ratio_idc",           "h264_aspect_ratio_idc",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sar_width,
            { "sar_width",           "h264_sar_width",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sar_height,
            { "sar_height",           "h264_sar_height",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_overscan_info_present_flag,
            { "overscan_info_present_flag",           "h264_overscan_info_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_overscan_appropriate_flag,
            { "overscan_appropriate_flag",           "h264_overscan_appropriate_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_video_signal_type_present_flag,
            { "video_signal_type_present_flag",           "h264_video_signal_type_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_video_format,
            { "video_format",           "h264_video_format",
            FT_UINT8, BASE_DEC, VALS(h264_video_format_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_h264_video_full_range_flag,
            { "video_full_range_flag",           "h264_video_full_range_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_colour_description_present_flag,
            { "colour_description_present_flag",           "h264_colour_description_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_colour_primaries,
            { "colour_primaries",           "h264_colour_primaries",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_transfer_characteristics,
            { "transfer_characteristics",           "h264_transfer_characteristics",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_matrix_coefficients,
            { "matrix_coefficients",           "h264_matrix_coefficients",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_chroma_loc_info_present_flag,
            { "chroma_loc_info_present_flag",           "h264_chroma_loc_info_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_chroma_sample_loc_type_top_field,
            { "chroma_sample_loc_type_top_field",           "h264_chroma_sample_loc_type_top_field",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_chroma_sample_loc_type_bottom_field,
            { "chroma_sample_loc_type_bottom_field",           "h264_chroma_sample_loc_type_bottom_field",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_timing_info_present_flag,
            { "timing_info_present_flag",           "h264_timing_info_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_units_in_tick,
            { "num_units_in_tick",           "h264_num_units_in_tick",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_time_scale,
            { "time_scale",           "h264_time_scale",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_fixed_frame_rate_flag,
            { "fixed_frame_rate_flag",           "h264_fixed_frame_rate_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_nal_hrd_parameters_present_flag,
            { "nal_hrd_parameters_present_flag",           "h264_nal_hrd_parameters_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_vcl_hrd_parameters_present_flag,
            { "vcl_hrd_parameters_present_flag",           "h264_vcl_hrd_parameters_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_low_delay_hrd_flag,
            { "low_delay_hrd_flag",           "h264_low_delay_hrd_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pic_struct_present_flag,
            { "pic_struct_present_flag",           "h264_pic_struct_present_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_bitstream_restriction_flag,
            { "bitstream_restriction_flag",           "h264_bitstream_restriction_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_motion_vectors_over_pic_boundaries_flag,
            { "motion_vectors_over_pic_boundaries_flag",           "h264_motion_vectors_over_pic_boundaries_flag",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_max_bytes_per_pic_denom,
            { "max_bytes_per_pic_denom",           "h264_max_bytes_per_pic_denom",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_max_bits_per_mb_denom,
            { "max_bits_per_mb_denom",           "h264_max_bits_per_mb_denom",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_log2_max_mv_length_horizontal,
            { "max_mv_length_horizontal",           "h264_max_mv_length_horizontal",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_log2_max_mv_length_vertical,
            { "log2_max_mv_length_vertical",           "h264_log2_max_mv_length_vertical",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_num_reorder_frames,
            { "num_reorder_frames",           "h264_num_reorder_frames",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_max_dec_frame_buffering,
            { "max_dec_frame_buffering",           "h264_max_dec_frame_buffering",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_cpb_cnt_minus1,
            { "cpb_cnt_minus1",           "h264_cpb_cnt_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_bit_rate_scale,
            { "bit_rate_scale",           "h264_bit_rate_scale",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_cpb_size_scale,
            { "cpb_size_scale",           "h264_cpb_size_scale",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_bit_rate_value_minus1,
            { "bit_rate_value_minus1",           "h264_bit_rate_value_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_cpb_size_value_minus1,
            { "cpb_size_value_minus1",           "h264_cpb_size_value_minus1",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_cbr_flag,
            { "cbr_flag",           "h264_cbr_flag",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_initial_cpb_removal_delay_length_minus1,
            { "initial_cpb_removal_delay_length_minus1",           "h264_initial_cpb_removal_delay_length_minus1",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_cpb_removal_delay_length_minus1,
            { "cpb_removal_delay_length_minus1",           "h264_cpb_removal_delay_length_minus1",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_dpb_output_delay_length_minus11,
            { "dpb_output_delay_length_minus11",           "h264_dpb_output_delay_length_minus11",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_time_offset_length,
            { "time_offset_length",           "h264_time_offset_length",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_first_mb_in_slice,
            { "first_mb_in_slice",           "h264_first_mb_in_slice",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_slice_type,
        ...
        { &hf_h264_slice_id,
            { "slice_id",           "h264_slice_id",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_payloadsize,
            { "PayloadSize",           "h264_payloadsize",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_payloadtype,
            { "payloadType",           "h264_payloadtype",
...
#endif
        { &hf_h264_par_profile,
                { "Profile", "h264_par_profile",
                FT_UINT8, BASE_HEX, NULL, 0x00,
            NULL, HFILL}},
        { &hf_h264_par_profile_b,
                { "Baseline Profile", "h264_par_profile_base",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL}},
        { &hf_h264_par_profile_m,
                { "Main Profile", "h264_par_profile_main",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL}},
        { &hf_h264_par_profile_e,
                { "Extended Profile.", "h264_par_profile_ext",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL}},
        { &hf_h264_par_profile_h,
                { "High Profile", "h264_par_profile_high",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL}},
        { &hf_h264_par_profile_h10,
                { "High 10 Profile", "h264_par_profile_high10",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL}},
        { &hf_h264_par_profile_h4_2_2,
                { "High 4:2:2 Profile", "h264_par_profile_high4_2_2",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL}},
        { &hf_h264_par_profile_h4_4_4,
                { "High 4:4:4 Profile", "h264_par_profile_high4_4_4",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL}},
        { &hf_h264_par_AdditionalModesSupported,
                { "AdditionalModesSupported", "h264_AdditionalModesSupported",
            FT_UINT8, BASE_HEX, NULL, 0x00,
            NULL, HFILL}},
#if 0
        { &hf_h264_par_add_mode_sup,
                { "Additional Modes Supported", "h264_add_mode_sup",
            FT_UINT8, BASE_HEX, NULL, 0x00,
            NULL, HFILL}},
#endif
        { &hf_h264_par_add_mode_sup_rcdo,
                { "Reduced Complexity Decoding Operation (RCDO) support", "h264_add_mode_sup_rcdo",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL}},
        { &hf_h264_par_ProfileIOP,
                { "ProfileIOP", "h264_ProfileIOP",
            FT_UINT8, BASE_HEX, NULL, 0x00,
            NULL, HFILL}},
        { &hf_h264_par_constraint_set0_flag,
                { "constraint_set0_flag", "h264_par_constraint_set0_flag",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL}},
        { &hf_h264_par_constraint_set1_flag,
                { "constraint_set1_flag", "h264_par_constraint_set1_flag",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL}},
        { &hf_h264_par_constraint_set2_flag,
                { "constraint_set2_flag", "h264_par_constraint_set2_flag",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL}},
        /* Packization Values */
        { &hf_h264_nalu_size,
            { "NAL Unit Size", "h264_nalu_size",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_don,
            { "Decoder Order Number", "h264_don",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_dond,
            { "MTAP Decoder Order Number Delta", "h264_don_delta",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_ts_offset16,
            { "MTAP TS Offset", "h264_ts_offset16",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_ts_offset24,
            { "MTAP TS Offset", "h264_ts_offset24",
            FT_UINT24, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_nal_extension_subtype,
            { "Extension Header Subtype", "h264_nal_hdr_extension_subtype",
            FT_UINT8, BASE_DEC, VALS(h264_subtype_values), 0xF8,
            NULL, HFILL }
        },
        { &hf_h264_nal_extension_j,
            { "Extension Header J - DON Present Indicator", "h264_nal_hdr_extension_j",
            FT_BOOLEAN, 8, NULL, 0x4,
            NULL, HFILL }
        },
        { &hf_h264_nal_extension_k,
            { "Extension Header K", "h264_nal_hdr_extension_k",
            FT_BOOLEAN, 8, NULL, 0x2,
            NULL, HFILL }
        },
        { &hf_h264_nal_extension_l,
            { "Extension Header L", "h264_nal_hdr_extension_l",
        ...
        { &hf_h264_sei_ms_lpb,
            { "Layer Presence", "h264_sei_ms_layout_lpb",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layout_p,
            { "Layer Description Present", "h264_sei_ms_layout_p",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layout_ldsize,
            { "Layer Description Size", "h264_sei_ms_layout_desc_ldsize",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_coded_width,
            { "Coded Width", "h264_sei_ms_layout_desc_coded_width",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_coded_height,
            { "Coded Height", "h264_sei_ms_layout_desc_coded_height",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_display_width,
            { "Display Width", "h264_sei_ms_layout_desc_display_width",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_display_height,
            { "Display Height", "h264_sei_ms_layout_desc_display_height",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_bitrate,
            { "Bitrate", "h264_sei_ms_layout_desc_bitrate",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_frame_rate,
            { "Frame Rate Index", "h264_sei_ms_layout_desc_frame_rate",
            FT_UINT8, BASE_DEC, VALS(h264_sei_ms_frame_values), 0xF8,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_layer_type,
            { "Layer Type", "h264_sei_ms_layout_desc_layer_type",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_prid,
            { "Priority ID", "h264_sei_ms_layout_desc_prid",
            FT_UINT8, BASE_DEC, NULL, 0xFC,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_layer_desc_cb,
            { "Constrained Baseline", "h264_sei_ms_layout_desc_constrained_baseline",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        /* MS Bitstream SEI */
        { &hf_h264_sei_ms_bitstream_ref_frame_cnt,
            { "Reference Frame Count", "h264_sei_ms_bitstream_info_ref_frm_cnt",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_bitstream_num_nalus,
            { "Number of NAL units", "h264_sei_ms_bitstrea3416m_info_num_nalus",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_iso_sec_info,
            { "Unparsed iso_iec information", "h264_sei_iso_sec_info",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        /* MS Crop SEI */
        { &hf_h264_sei_ms_crop_num_data,
            { "Number of Data Entries", "h264_sei_ms_crop_num_data",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_crop_info_type,
            { "Info Type", "h264_sei_ms_crop_info_type",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_crop_confidence_level,
            { "Confidence Level", "h264_sei_ms_crop_confidence_level",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_crop_frame_left_offset,
            { "Left Offset", "h264_sei_ms_crop_left_offset",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_crop_frame_right_offset,
            { "Right Offset", "h264_sei_ms_crop_right_offset",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_crop_frame_top_offset,
            { "Top Offset", "h264_sei_ms_crop_top_offset",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_sei_ms_crop_frame_bottom_offset,
            { "Bottom Offset", "h264_sei_ms_crop_bottom_offset",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        ...
        { &hf_h264_nal_hdr_ext_svc,
            { "SVC Extension / Reserved", "h264_nal_hdr_ext_r",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_i,
            { "IDR Picture", "h264_nal_hdr_ext_i",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_prid,
            { "Priority ID", "h264_nal_hdr_ext_prid",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_n,
            { "No Inter Layer Prediction", "h264_nal_hdr_ext_n",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_did,
            { "Dependency ID", "h264_nal_hdr_ext_did",
            FT_UINT8, BASE_DEC, NULL, 0x70,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_qid,
            { "Quality ID", "h264_nal_hdr_ext_qid",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_tid,
            { "Temporal ID", "h264_nal_hdr_ext_tid",
            FT_UINT8, BASE_DEC, NULL, 0xe0,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_u,
            { "Use Ref Base Picture", "h264_nal_hdr_ext_u",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_d,
            { "Discardable", "h264_nal_hdr_ext_d",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_o,
            { "Output", "h264_nal_hdr_ext_o",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_h264_nal_hdr_ext_rr,
            { "Reserved", "h264_nal_hdr_ext_rr",
            FT_UINT8, BASE_HEX, NULL, 0x03,
            NULL, HFILL }
        },
        /* PACSI Values */
        { &hf_h264_pacsi_x,
            { "X - A,P,C Field Indicator", "h264_pacsi_x",
            FT_BOOLEAN, 8, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_y,
            { "Y - Pic Fields Indicator", "h264_pacsi_y",
            FT_BOOLEAN, 8, NULL, 0x40,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_t,
            { "T - DONC Field Indicator", "h264_pacsi_t",
            FT_BOOLEAN, 8, NULL, 0x20,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_a,
            { "A - Anchor Layer", "h264_pacsi_a",
            FT_BOOLEAN, 8, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_p,
            { "P - Redundant Slice", "h264_pacsi_p",
            FT_BOOLEAN, 8, NULL, 0x08,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_c,
            { "C - Intra Slice", "h264_pacsi_c",
            FT_BOOLEAN, 8, NULL, 0x04,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_s,
            { "S - First Nal Unit of Layer", "h264_pacsi_s",
            FT_BOOLEAN, 8, NULL, 0x02,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_e,
            { "E - Last Nal Unit of Layer", "h264_pacsi_e",
            FT_BOOLEAN, 8, NULL, 0x01,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_tl0picidx,
            { "TL0PICIDX", "h264_pacsi_tl0picidx",
            FT_UINT8, BASE_DEC, NULL, 0xFF,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_idrpicid,
            { "IDRPICID - IDR Picture ID", "h264_pacsi_idrpicid",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_h264_pacsi_donc,
            { "DONC - Cross Session Decoder Order Number", "h264_pacsi_donc",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
