...
proto_register_ieee1905(void)
{
    static hf_register_info hf[] = {
        ...
        { &hf_ieee1905_bridge_flag,
          { "IEEE 802.1 bridge flag", "ieee1905_bridgeFlag",
            FT_UINT8, BASE_DEC, VALS(ieee1905_bridge_flag_vals), 0, NULL, HFILL }},

        { &hf_ieee1905_packet_errors,
          { "Packet errors", "ieee1905_packetErrors",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_transmitted_packets,
          { "Transmitted packets", "ieee1905_transmittedPackets",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_mac_throughput_capacity,
          { "MAC throughput capacity", "ieee1905_macThroughputCapacity",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_link_availability,
          { "Link availability", "ieee1905_linkAvailability",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_phy_rate,
          { "Phy rate", "ieee1905_phyRate",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_packets_received,
          { "Packets received", "ieee1905_packets_received",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        ...
        { &hf_ieee1905_local_interface_count,
          { "Local interface count", "ieee1905_dev_info_local_int_cnt",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_media_type,
          { "Media type", "ieee1905_dev_info_media_type",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_media_type_high,
          { "Media type bits 15 to 8", "ieee1905_media_type_bits_15_to_8",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_media_type_low,
          { "Media type bits 7 to 0", "ieee1905_media_type_bits_7_to_0",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_media_spec_info_len,
          { "Special info length", "ieee1905_dev_info_spec_info_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_media_spec_info,
          { "Special info", "ieee1905_dev_info_spec_info",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bridging_tuples_cnt,
          { "Bridging tuples count", "ieee1905_bridging_info_tuples_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bridging_mac_address_cnt,
          { "Bridging MAC address count", "ieee1905_bridging_info_mac_addr_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bridging_mac_address,
          { "Bridging MAC address", "ieee1905_bridging_info_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_interface_mac,
          { "Local interface MAC address", "ieee1905_local_intf_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_non_1905_neighbor_mac,
          { "Non 1905 neighbor MAC address", "ieee1905_non_1905_neighbor_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_neighbor_flags,
          { "IEEE1905 neighbor flags", "ieee1905_neighbor_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bridges_flag,
          { "IEEE1905 bridges", "ieee1905_bridges",
            FT_BOOLEAN, 8, TFS(&tfs_bridges_flag), 0x80, NULL, HFILL }},

        { &hf_ieee1905_link_metric_result_code,
          { "IEEE1905 link metric result code", "ieee1905_link_metric_result_code",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_vendor_specific_oui,
          { "Vendor specific OUI", "ieee1905_vendor_specific_oui",
            FT_UINT24, BASE_OUI, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_vendor_specific_info,
          { "Vendor specific information", "ieee1905_vendor_specific_info",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_searched_role,
          { "Searched role", "ieee1905_searched_role",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_supported_role,
          { "Supported role", "ieee1905_supported_role",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_auto_config_freq_band,
          { "Auto config frequency band", "ieee1905_auto_config_freq_band",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_supported_freq_band,
          { "Supported frequency band", "ieee1905_supported_freq_band",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_event_notification_media_types,
          { "Media types", "ieee1905_event_notif_media_types",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_sender_al_id,
          { "Sender AL ID", "ieee1905_sender_al_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_push_button_event_msg_id,
          { "Push button event message ID", "ieee1905_sender_msg_id",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_sender_joining_interface,
          { "Joining MAC address of sender", "ieee1905_sender_joining_intf",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_new_device_interface,
          { "New device MAC address", "ieee1905_new_device_intf",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_device_al_mac,
          { "1905 device AL MAC address", "ieee1905_device_al_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_oui,
          { "Local interface OUI", "ieee1905_local_intf_oui",
            FT_UINT24, BASE_OUI, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_variant,
          { "Local interface variant index", "ieee1905_local_intf_variant",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_variant_name,
          { "Local interface variant name", "ieee1905_local_intf_variant_name",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_url_count,
          { "Local interface URL octet count", "ieee1905_local_intf_url_byte_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_spec_count,
          { "Local interface media specific count", "ieee1905_local_intf_media_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_url,
          { "Local interface XML description URL", "ieee1905_local_intf_url",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_local_intf_spec,
          { "Local interface media specific info", "ieee1905_local_intf_spec_info",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_id_friendly_name,
          { "Device Id Friendly name", "ieee1905_device_id_friendly_name",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_id_manuf_name,
          { "Device Id Manufacturer name", "ieee1905_device_id_manuf_name",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_id_manuf_model,
          { "Device Id Manufacturer model", "ieee1905_device_id_manuf_model",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_control_url,
          { "Device control URL", "ieee1905_device_control_url",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv4_type_count,
          { "Count of IPv4 entries", "ieee1905_ipv4_type_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_mac_address,
          { "MAC address", "ieee1905_ipv4_type_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv4_addr_count,
          { "IPv4 address count", "ieee1905_ipv4_type_addr_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_addr_type,
          { "IPv4 address type", "ieee1905_ipv4_type_addr_type",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv4_addr,
          { "IPv4 address", "ieee1905_ipv4_type_ipv4_addr",
            FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dhcp_server,
          { "DHCP server", "ieee1905_ipv4_type_dhcp_server",
            FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv6_type_count,
          { "Count of IPv6 entries", "ieee1905_ipv6_type_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv6_addr_count,
          { "IPv4 address count", "ieee1905_ipv6_type_addr_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv6_addr_type,
          { "IPv6 address type", "ieee1905_ipv6_type_addr_type",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv6_addr,
          { "IPv6 address", "ieee1905_ipv6_type_ipv6_addr",
            FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ipv6_dhcp_server,
          { "DHCP server", "ieee1905_ipv6_type_dhcp_server",
            FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_generic_phy_media_types,
          { "Generic Phy media type count", "ieee1905_button_push_phy_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_profile_version,
          { "1905 profile version type", "ieee1905_profile_version",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_off_intf_count,
          { "Powered off interface count", "ieee1905_power_off_intf_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_change_intf_count,
          { "Power change local interface count", "ieee1905_power_chg_intf_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_change_mac_addr,
          { "Power change interface MAc addr", "ieee1905_power_chg_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_change_state,
          { "Power change requested state", "ieee1905_power_chg_state",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_status_intf_count,
          { "Power status local interface count", "ieee1905_power_sts_intf_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_status_mac_addr,
          { "Power status interface MAc addr", "ieee1905_power_sts_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_power_status_state,
          { "Power change status", "ieee1905_power_sts_state",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_l2_neighbor_intf_count,
          { "L2 neighbor interface count", "ieee1905_l2_neighbor_intf_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_l2_local_intf_mac_addr,
          { "L2 neighbor local interface MAC addr", "ieee1905_l2_neighbor_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_l2_neighbor_dev_count,
          { "L2 neighbor device count", "ieee1905_l2_neighbor_dev_count",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_l2_neighbor_mac_addr,
          { "L2 neighbor interface MAC address", "ieee1905_l2_neighbor_neighbor_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_l2_behind_mac_addr_count,
          { "L2 neighbor behind MAC addr count", "ieee1905_l2_neighbor_neighbor_behind_count",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_l2_behind_mac_addr,
          { "L2 neighbor behind MAC addr", "ieee1905_l2_neighbor_neighbor_behind_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_supported_service_count,
          { "Supported service count", "ieee1905_supported_service_service_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_supported_service,
          { "Supported service", "ieee1905_supported_service_service",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_searched_service_count,
          { "Searched service count", "ieee1905_searched_service_service_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_searched_service,
          { "Searched service", "ieee1905_searched_service_service",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_identifier,
          { "AP radio identifier", "ieee1905_ap_radio_identifier",
           FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_operatonal_bss_radio_count,
          { "AP operational BSS radio count", "ieee1905_ap_bss_radio_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_operational_intf_count,
          { "AP operational interface count", "ieee1905_ap_bss_intf_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_local_intf_mac_addr,
          { "AP operational local interface MAC addr", "ieee1905_ap_bss_local_intf_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_local_intf_ssid_len,
          { "AP operational BSS local interface SSID len", "ieee1905_ap_bss_local_intf_ssid_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_local_intf_ssid,
          { "AP operational BSS local interface SSID", "ieee1905_ap_bss_local_intf_ssid",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_capabilities_flags,
          { "AP capabilities flags", "ieee1905_ap_capability_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_rpt_unsuccessful_associations,
          { "Report Unsuccessful Associations", "ieee1905_rpt_unsuccessful_assoc",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_sta_metrics_oper_flag,
          { "STA link metric reporting operational channels", "ieee1905_link_metric_oper",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x80, NULL, HFILL }},

        { &hf_ieee1905_unassoc_sta_metrics_non_oper_flag,
          { "STA link metric reporting non-operational channels", "ieee1905_link_metric_non_oper",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x40, NULL, HFILL }},

        { &hf_ieee1905_agent_init_steering,
          { "Agent-initiated RSSI-based Steering", "ieee1905_agent_init_steering",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x20, NULL, HFILL }},

        { &hf_ieee1905_rpt_unsuccessful_assoc_report,
          { "Unsuccessful Association Attempts", "ieee1905_report_unsuccessful_associations",
        ...
        { &hf_ieee1905_higher_layer_protocol,
          { "Higher layer protocol", "ieee1905_higher_layer_proto",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_higher_layer_data,
          { "Higher layer data", "ieee1905_higher_layer_data",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_backhaul_station_mac,
          { "Associated backhaul station MAC address", "ieee1905_assoc_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_target_bssid,
          { "Target BSS BSSID", "ieee1905_assoc_target_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_steering_status,
          { "Status code", "ieee1905_assoc_status",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_operating_class,
          { "Backhaul operating class", "ieee1905_assoc_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_channel_number,
          { "Backhaul beacon channel number", "ieee1905_assoc_channel_num",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_assoc_bssid,
          { "Target BSSID", "ieee1905_assoc_ctrl_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_association_control,
          { "Association control", "ieee1905_assoc_ctrl_control",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_association_control_validity,
          { "Request validity period", "ieee1905_assoc_ctrl_validity",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_assoc_sta_count,
          { "STA control list count", "ieee1905_assoc_ctrl_sta_list_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_assoc_mac_addr,
          { "Target STA MAC address", "ieee1905_assoc_ctrl_target_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_btm_reporter_bssid,
          { "BTM report source BSSID", "ieee1905_btm_report_source_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_btm_sta_mac_addr,
          { "BTM report target MAC address", "ieee1905_btm_report_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_btm_report_status,
          { "BTM status code", "ieee1905_btm_report_status",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_btm_report_bssid,
          { "BTM target BSSID", "ieee1905_btm_report_target_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_source_bss_bssid,
          { "Source BSS BSSID", "ieee1905_steering_req_source_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_request_flags,
          { "Steering request flags", "ieee1905_steering_req_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_op_window,
          { "Steering opportunity window", "ieee1905_steering_req_window",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_request_mode_flag,
          { "Mode", "ieee1905_steering_req_mode",
            FT_BOOLEAN, 8, TFS(&tfs_ieee1905_steering_request_mode_flag), 0x80, NULL, HFILL }},

        { &hf_ieee1905_btm_disassoc_imminent_flag,
          { "BTM disassociation imminent", "ieee1905_steering_req_disassoc_imminent",
            FT_BOOLEAN, 8, TFS(&tfs_ieee1905_btm_disassoc_imminent_flag), 0x40, NULL, HFILL }},

        { &hf_ieee1905_btm_abridged_flag,
          { "BTM abridged", "ieee1905_steering_req_btm_abridged",
            FT_BOOLEAN, 8, TFS(&tfs_ieee1905_btm_abridged_flag), 0x20, NULL, HFILL }},

        { &hf_ieee1905_steering_req_reserved,
          { "Reserved", "ieee1905_steering_req_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x1F, NULL, HFILL }},

        { &hf_ieee1905_steering_btm_disass_timer,
          { "BTM disassociation timer", "ieee1905_steering_req_disass_timer",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_sta_count,
          { "STA list count", "ieee1905_steering_req_sta_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_target_bssid_count,
          { "Target BSSID list count", "ieee1905_steering_req_bssid_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_sta_mac,
          { "Target MAC address", "ieee1905_steering_req_target_mac",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_target_bssid,
          { "Target BSSID", "ieee1905_steering_req_target_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_oper_class,
          { "Target BSS operating class", "ieee1905_steering_req_oper_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_req_target_channel,
          { "Target BSS channel number", "ieee1905_steering_req_target_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_bssid,
          { "Client BSSID", "ieee1905_client_info_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_mac_addr,
          { "Client MAC address", "ieee1905_client_info_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_capability_result,
          { "Result code", "ieee1905_client_capability_result",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_client_capability_frame,
          { "(Re)Association frame body", "ieee1905_client_capability_frame",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_association_flag,
          { "Association event", "ieee1905_assoc_event_assoc_event",
            FT_BOOLEAN, 8, TFS(&tfs_ieee1905_association_event_flag), 0x20, NULL, HFILL }},

        { &hf_ieee1905_association_client_mac_addr,
          { "Client mac address", "ieee1905_assoc_event_client_mac",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_association_agent_bssid,
          { "Multi-AP agent BSSID", "ieee1905_assoc_event_agent_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_association_event_flags,
          { "Association event flags", "ieee1905_assoc_event_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_max_bss,
          { "Maximum BSS support", "ieee1905_radio_basic_cap_max_bss",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_classes,
          { "Operating class count", "ieee1905_radio_basic_op_classes",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_class,
          { "Operating class", "ieee1905_radio_basic_op_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_eirp,
          { "Maximum transmit power EIRP", "ieee1905_radio_basic_max_power",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_non_op_count,
          { "Number of non-operable channels", "ieee1905_radio_basic_non_op_channels",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_basic_non_op_channel,
          { "Statically non-operable channel", "ieee1905_radio_basic_non_op_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_max_supported_tx_streams,
          { "Maximum supported Tx spatial streams", "ieee1905_ap_ht_max_tx_streams",
            FT_UINT8, BASE_HEX, VALS(max_supported_tx_streams_vals), 0xC0, NULL, HFILL}},

        { &hf_ieee1905_max_supported_rx_streams,
          { "Maximum supported Rx spatial streams", "ieee1905_ap_ht_max_rx_streams",
            FT_UINT8, BASE_HEX, VALS(max_supported_rx_streams_vals), 0x30, NULL, HFILL}},

        { &hf_ieee1905_short_gi_20mhz_flag,
          { "Short GI support for 20 MHz", "ieee1905_ap_ht_short_gi_20mhz",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x08, NULL, HFILL}},

        { &hf_ieee1905_short_gi_40mhz_flag,
          { "Short GI support for 40 MHz", "ieee1905_ap_ht_short_gi_40mhz",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x04, NULL, HFILL}},

        { &hf_ieee1905_ht_support_40mhz_flag,
          { "HT support for 40MHz", "ieee1905_ap_ht_ht_support_40mhz",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x02, NULL, HFILL}},

        { &hf_ieee1905_ap_ht_capabilities_radio_id,
          { "Radio unique ID", "ieee1905_ap_ht_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ht_cap_flags,
          { "Capabilities", "ieee1905_ap_ht_caps",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_vht_max_supported_tx_streams,
          { "Maximum supported Tx spatial streams", "ieee1905_ap_vht_max_tx_streams",
            FT_UINT16, BASE_HEX, VALS(vht_he_max_supported_tx_streams_vals), 0xE000, NULL, HFILL}},

        { &hf_ieee1905_vht_max_supported_rx_streams,
          { "Maximum supported Rx spatial streams", "ieee1905_ap_vht_max_rx_streams",
            FT_UINT16, BASE_HEX, VALS(vht_he_max_supported_rx_streams_vals), 0x1C00, NULL, HFILL}},

        { &hf_ieee1905_short_gi_80mhz_flag,
          { "Short GI support for 80 MHz", "ieee1905_ap_vht_short_gi_80mhz",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0200, NULL, HFILL}},

        { &hf_ieee1905_short_gi_160mhz_flag,
          { "Short GI support for 160 and 80+80 MHz", "ieee1905_ap_vht_short_gi_160mhz",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0100, NULL, HFILL}},

        { &hf_ieee1905_vht_support_80plus_mhz_flag,
          { "VHT support for 80+80 MHz", "ieee1905_ap_vht_vht_80plus_mhz",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x80, NULL, HFILL}},

        { &hf_ieee1905_vht_support_160_mhz_flag,
          { "VHT support for 160 MHz", "ieee1905_ap_vht_vht_160mhz",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x40, NULL, HFILL}},

        { &hf_ieee1905_su_beamformer_capable_flag,
          { "SU beamformer capable", "ieee1905_ap_vht_su_beamformer",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x20, NULL, HFILL}},

        { &hf_ieee1905_mu_beamformer_capable_flag,
          { "MU beamformer capable", "ieee1905_ap_vht_mu_beamformer",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x10, NULL, HFILL}},

        { &hf_ieee1905_ap_vht_capabilities_radio_id,
          { "Radio unique ID", "ieee1905_ap_vht_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_vht_cap_flags,
          { "Capabilities", "ieee1905_ap_vht_caps",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_vht_supported_vht_tx_mcs,
          { "Supported VHY Tx MCS", "ieee1905_vht_supported_tx_mcs",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_vht_supported_vht_rx_mcs,
          { "Supported VHY Rx MCS", "ieee1905_vht_supported_rx_mcs",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_clients_bss_count,
          { "Included BSS count", "ieee1905_assoc_client_bss_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_bssid,
          { "Associated BSS", "ieee1905_assoc_client_bss",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_client_count,
          { "Associated client count", "ieee1905_assoc_client_client_count",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_client_mac,
          { "Associated client MAC address", "ieee1905_assoc_client_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_client_last_assoc,
          { "Time since last association", "ieee1905_assoc_client_time_since",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_pref_preference,
          { "Preference", "ieee1905_channel_pref_pref",
            FT_UINT8, BASE_HEX, VALS(channel_preference_prefs_vals), 0xF0, NULL, HFILL}},
        { &hf_ieee1905_channel_pref_reason,
          { "Reason code", "ieee1905_channel_pref_reason",
            FT_UINT8, BASE_HEX, VALS(channel_preference_reason_vals), 0x0F, NULL, HFILL}},

        { &hf_ieee1905_channel_preference_radio_id,
          { "Radio unique ID", "ieee1905_channel_pref_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_preference_class_count,
          { "Operating class count", "ieee1905_channel_prefs_class_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_pref_class,
          { "Operating class", "ieee1905_channel_prefs_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_pref_channel_count,
          { "Channel list count", "ieee1905_channel_prefs_channel_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_pref_channel,
          { "Channel number", "ieee1905_channel_prefs_channel_no",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_prefs_flags,
          { "Channel preference flags", "ieee1905_channel_prefs_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_trans_power_limit_radio_id,
          { "Radio unique ID", "ieee1905_transmit_power_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_trans_power_limit_eirp,
          { "Transmit power limit EIRP per 20MHz", "ieee1905_transmit_power_eirp",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_select_resp_radio_id,
          { "Radio unique ID", "ieee1905_channel_select_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_metrics_radio_id,
          { "Radio unique ID", "ieee1905_radio_metrics_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_select_resp_code,
          { "Response coce", "ieee1905_channel_select_response_code",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_op_channel_report_radio_id,
          { "Radio unique ID", "ieee1905_operating_channel_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_op_channel_report_classes,
          { "Currently operating classes", "ieee1905_operating_channel_classes",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_op_channel_class,
          { "Operating class", "ieee1905_operating_channel_op_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_op_channel_number,
          { "Operating channel number", "ieee1905_operating_channel_chan_num",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_op_channel_eirp,
          { "Current transmit power EIRP", "ieee1905_operating_channel_eirp",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_radio_id,
          { "Radio unique ID", "ieee1905_ap_he_capability_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_mcs_length,
          { "Supported HE MCS length", "ieee1905_ap_he_capability_he_mcs_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_tx_mcs_le_80_mhz,
          { "Supported Tx HE-MCS <= 80 MHz",
            "ieee1905_ap_he_capability_supported_tx_he_mcs_le_80mhz",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_1ss,
          { "Max Tx HE-MCS for 1 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_1_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_1_ss_vals),
            0xC000, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_2ss,
          { "Max Tx HE-MCS for 2 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_2_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_2_ss_vals),
            0x3000, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_3ss,
          { "Max Tx HE-MCS for 3 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_3_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_3_ss_vals),
            0x0C00, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_4ss,
          { "Max Tx HE-MCS for 4 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_4_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_4_ss_vals),
            0x0300, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_5ss,
          { "Max Tx HE-MCS for 5 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_5_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_5_ss_vals),
            0x00C0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_6ss,
          { "Max Tx HE-MCS for 6 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_6_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_6_ss_vals),
            0x0030, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_7ss,
          { "Max Tx HE-MCS for 7 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_7_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_7_ss_vals),
            0x000C, NULL, HFILL }},

        { &hf_ieee1905_ap_he_tx_mcs_map_8ss,
          { "Max Tx HE-MCS for 8 SS",
            "ieee1905_ap_he_capability_max_tx_he_mcs_8_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_8_ss_vals),
            0x0003, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_rx_mcs_le_80_mhz,
          { "Supported Rx HE-MCS <= 80 MHz",
            "ieee1905_ap_he_capability_supported_rx_he_mcs_le_80mhz",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_1ss,
          { "Max Rx HE-MCS for 1 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_1_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_1_ss_vals),
            0xC000, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_2ss,
          { "Max Rx HE-MCS for 2 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_2_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_2_ss_vals),
            0x3000, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_3ss,
          { "Max Rx HE-MCS for 3 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_3_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_3_ss_vals),
            0x0C00, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_4ss,
          { "Max Rx HE-MCS for 4 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_4_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_4_ss_vals),
            0x0300, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_5ss,
          { "Max Rx HE-MCS for 5 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_5_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_5_ss_vals),
            0x00C0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_6ss,
          { "Max Rx HE-MCS for 6 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_6_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_6_ss_vals),
            0x0030, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_7ss,
          { "Max Rx HE-MCS for 7 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_7_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_7_ss_vals),
            0x000C, NULL, HFILL }},

        { &hf_ieee1905_ap_he_rx_mcs_map_8ss,
          { "Max Rx HE-MCS for 8 SS",
            "ieee1905_ap_he_capability_max_rx_he_mcs_8_ss",
            FT_UINT16, BASE_DEC, VALS(max_he_mcs_8_ss_vals),
            0x0003, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_tx_mcs_160_mhz,
          { "Supported Tx HE-MCS 160 MHz",
            "ieee1905_ap_he_capability_supported_tx_he_mcs_160mhz",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_rx_mcs_160_mhz,
          { "Supported Rx HE-MCS 160 MHz",
            "ieee1905_ap_he_capability_supported_rx_he_mcs_160mhz",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_tx_mcs_80p80_mhz,
          { "Supported Tx HE-MCS 80+80 MHz",
            "ieee1905_ap_he_capability_supported_tx_he_mcs_80p80mhz",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_he_cap_rx_mcs_80p80_mhz,
          { "Supported Rx HE-MCS 80+80 MHz",
            "ieee1905_ap_he_capability_supported_rx_he_mcs_80p80mhz",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_metrics_mac_count,
          {"MAC Addresses for this channel",
           "ieee1905_unassoc_sta_link_metrics_mac_count",
           FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_link_metrics_query_mac,
          { "STA MAC address", "ieee1905_unassoc_sta_link_metrics_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_reporting_interval,
          { "AP metrics reporting interval", "ieee1905_sta_metric_policy_ap_interval",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_metric_reporting_policy_radio_id,
          { "Radio ID", "ieee1905_metric_reporing_policy_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_metric_reporting_radio_count,
          { "Radio count", "ieee1905_sta_metric_policy_radio_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_metric_rcpi_threshold,
          { "RCPI reporting threshold", "ieee1905_sta_metric_policy_rcpi_threshold",
        ...
        { &hf_ieee1905_metric_reporting_rcpi_hysteresis,
          {"STA Metrics Reporting RCPI Hysteresis Margin Override",
            "ieee1905_sta_metric_policy_rcpi_hysteresis_margin_override",
            FT_UINT8, BASE_CUSTOM, CF_FUNC(rcpi_hysteresis_custom),
            0, NULL, HFILL }},

        { &hf_ieee1905_metrics_policy_flags,
          {"STA Metrics Reporting Policy Flags",
            "ieee1905_sta_metrics_policy_flags",
          FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_inclusion,
          { "Associated STA Traffic Stats Inclusion Policy",
             "ieee1905_sta_metrics_policy_flags_sta_traffic_stats_inclusion",
          FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_link_metrics_inclusion,
          { "Associated STA Link Metrics Inclusion Policy",
             "ieee1905_sta_metrics_policy_flags_sta_link_metrics_inclusion",
          FT_BOOLEAN, 8, NULL, 0x40, NULL, HFILL }},

        { &hf_ieee1905_assoc_wf6_status_policy_inclusion,
          { "Associated Wi-Fi6 STA Status Inclusion Policy",
            "ieee1905_sta_metrics_policy_flags_wf6_sta_status_inclusion",
            FT_BOOLEAN, 8, NULL, 0x20, NULL, HFILL }},

        { &hf_ieee1905_reporting_policy_flags_reserved,
          { "Reserved", "ieee1905_sta_metrics_policy_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x1F, NULL, HFILL }},

        { &hf_ieee1905_metrics_channel_util_threshold,
          { "Utilization Reporting threshold", "ieee1905_sta_metric_policy_utilization_threshold",
            FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metric_query_bssid_cnt,
          { "BSSID Count", "ieee1905_ap_metrics_query_bssid_cnt",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metric_query_bssid,
          { "Query BSSID", "ieee1905_ap_metrics_query_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_sta_mac_address_type,
          { "MAC address", "ieee1905_sta_mac_addr_type_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_mac_addr,
          { "MAC address", "ieee1905_assoc_sta_link_metrics_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_bssid_count,
          { "Number of BSSIDs for STA", "ieee1905_assoc_sta_link_metrics_bssid_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_link_metrics_bssid,
          { "STA BSSID", "ieee1905_assoc_sta_link_metrics_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_link_metrics_time_delta,
          { "Measurement time delta", "ieee1905_assoc_sta_link_metrics_time_delta",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_link_metrics_dwn_rate,
          { "Downlink data rate", "ieee1905_assoc_sta_link_metrics_down_rate",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_link_metrics_up_rate,
          { "Uplink data rate", "ieee1905_assoc_sta_link_metrics_up_rate",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_link_metrics_rssi,
          { "Measured uplink RSSI for STA", "ieee1905_assoc_sta_link_metrics_rssi",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_wf6_sta_mac_addr,
          { "MAC address", "ieee1905_assoc_wf6_sta_status_report_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_wf6_sta_tid_count,
          { "Number of Wi-Fi 6 TIDs",
            "ieee1905_assoc_wf6_sta_status_report_tid_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_wf6_sta_tid,
          { "TID", "ieee1905_assoc_wf6_sta_status_report_tid",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_wf6_sta_queue_size,
          { "Queue Size", "ieee1905_assoc_wf6_sta_status_report_queue_size",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_ext_link_metrics_mac_addr,
          { "Associated STA MAC Address",
            "ieee1905_assoc_sta_extended_link_metrics_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_ext_link_metrics_count,
          { "BSSID count", "ieee1905_assoc_sta_extended_link_metrics_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_extended_metrics_bssid,
          { "BSSID", "ieee1905_assoc_sta_extended_link_metrics_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_extended_metrics_lddlr,
          { "Last Data Downlink Rate",
            "ieee1905_assoc_sta_extended_link_metrics_lddlr",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_extended_metrics_ldulr,
          { "Last Data Uplink Rate",
            "ieee1905_assoc_sta_extended_link_metrics_ldulr",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_extended_metrics_ur,
          { "Utilization Receive",
            "ieee1905_assoc_sta_extended_link_metrics_ur",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_extended_metrics_tr,
          { "Utilization Transmit",
            "ieee1905_assoc_sta_extended_link_metrics_ut",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_sta_link_metrics_class,
          { "Operating class", "ieee1905_unassoc_sta_link_metrics_operaring_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_sta_link_channel_count,
          { "Channel count", "ieee1905_unassoc_sta_link_metrics_channel_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_metrics_channel,
          { "Channel number", "ieee1905_unassoc_sta_link_metrics_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_he_max_supported_tx_streams,
          { "Maximum supported Tx spatial streams", "ieee1905_he_cap_max_tx_streams",
            FT_UINT16, BASE_HEX, VALS(vht_he_max_supported_tx_streams_vals), 0xE000, NULL, HFILL}},

        { &hf_ieee1905_he_max_supported_rx_streams,
          { "Maximum supported Rx spatial streams", "ieee1905_he_cap_max_rx_streams",
            FT_UINT16, BASE_HEX, VALS(vht_he_max_supported_rx_streams_vals), 0x1C00, NULL, HFILL}},

        { &hf_ieee1905_he_support_80plus_mhz_flag,
          { "HE support for 80+80 MHz", "ieee1905_ap_he_he_80plus_mhz",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported),
            0x0200, NULL, HFILL}},

        { &hf_ieee1905_he_support_160mhz_flag,
          { "HE support for 160 MHz", "ieee1905_ap_he_he_160_mhz",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0100, NULL, HFILL}},

        { &hf_ieee1905_he_su_beamformer_capable_flag,
          { "SU beanformer capable", "ieee1905_ap_he_su_beamformer",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0080, NULL, HFILL}},

        { &hf_ieee1905_he_mu_beamformer_capable_flag,
          { "MU beamformer capable", "ieee1905_ap_he_mu_beamformer",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0040, NULL, HFILL}},

        { &hf_ieee1905_ul_mu_mimo_capable_flag,
          { "UL MU-MIMO capable", "ieee1905_ap_he_ul_mu_mimo",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0020, NULL, HFILL}},

        { &hf_ieee1905_ul_mu_mimo_ofdma_capable_flag,
          { "UL MU-MIMO OFDMA capable", "ieee1905_ap_he_he_ul_mu_mimo_ofdma",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0010, NULL, HFILL}},

        { &hf_ieee1905_dl_mu_mimo_ofdma_capable_flag,
          { "DL MU-MIMO OFDMA capable", "ieee1905_ap_he_he_dl_mu_mimo_ofdma",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0008, NULL, HFILL}},

        { &hf_ieee1905_ul_ofdma_capable,
          { "UL OFDMA capable", "ieee1905_ap_he_he_ul_ofdma",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0004, NULL, HFILL}},

        { &hf_ieee1905_dl_ofdma_capable,
          { "DL OFDMA capable", "ieee1905_ap_he_he_dl_ofdma",
            FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x0002, NULL, HFILL}},

        { &hf_ieee1905_he_cap_flags,
          { "Capabilities", "ieee1905_ap_he_caps",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_policy_local_disallowed_count,
          { "Local steering disallowed STA count", "ieee1905_steering_policy_local_disallow_sta",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_disallowed_mac_addr,
          { "Local steering disallowed MAC address", "ieee1905_steering_policy_local_disallow_mac",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_btm_steering_disallowed_count,
          { "BTM steering disallowed count", "ieee1905_steering_policy_btm_disall_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_btm_steering_disallowed_mac_addr,
          { "Local steering disallowed MAC address", "ieee1905_steering_policy_local_disallow_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_policy_radio_count,
          { "Steering policy radio count", "ieee1905_steering_policy_radio_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_policy_radio_id,
          { "Radio unique ID", "ieee1905_steering_policy_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_policy_policy,
          { "Steering policy", "ieee1905_steering_policy_policy",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_policy_util,
          { "Channel utilization threshold", "ieee1905_steering_policy_utilization_threshold",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_steering_policy_rssi_threshold,
          { "RSSI steering threshold", "ieee1905_steering_policy_rssi_threshold",
            FT_INT8, BASE_DEC|BASE_UNIT_STRING, &units_dbm, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_restriction_radio_id,
          { "Radio unique ID", "ieee1905_radio_restriction_radio_id",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_restriction_op_class_count,
          { "Restricted operating classes", "ieee1905_radio_restriction_classes",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_restriction_op_class,
          { "Restricted operating class", "ieee1905_radio_restriction_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_restriction_chan_count,
          { "Channel count", "ieee1905_radio_restriction_channel_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_restriction_channel,
          { "Restricted channel", "ieee1905_radio_restriction_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_restriction_min_separation,
          { "Minimum separation", "ieee1905_radio_restriction_min_sep",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_include_estimated_spi_ac_eq_be,
          { "Include Estimated Service Parameters Information for AC=BE",
             "ieee1905_ap_metrics_include_ac_eq_be_params",
           FT_BOOLEAN, 8, TFS(&tfs_included_not_included), 0x80, NULL, HFILL }},

        { &hf_ieee1905_include_estimated_spi_ac_eq_bk,
          { "Include Estimated Service Parameters Information for AC=BK",
             "ieee1905_ap_metrics_include_ac_eq_bk_params",
           FT_BOOLEAN, 8, TFS(&tfs_included_not_included), 0x40, NULL, HFILL }},

        { &hf_ieee1905_include_estimated_spi_ac_eq_vo,
          { "Include Estimated Service Parameters Information for AC=VO",
             "ieee1905_ap_metrics_include_ac_eq_vo_params",
           FT_BOOLEAN, 8, TFS(&tfs_included_not_included), 0x20, NULL, HFILL }},

        { &hf_ieee1905_include_estimated_spi_ac_eq_vi,
          { "Include Estimated Service Parameters Information for AC=VI",
             "ieee1905_ap_metrics_include_ac_eq_vi_params",
           FT_BOOLEAN, 8, TFS(&tfs_included_not_included), 0x10, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_agent_bssid,
          { "Multi-AP agent BSSID", "ieee1905_ap_metrics_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_channel_utilization,
          { "Channel utilization", "ieee1905_ap_metrics_channel_util",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_sta_count,
          { "BSS STA count", "ieee1905_ap_metrics_sta_count",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_flags,
          { "Estimated Service Parameters Flags", "ieee1905_ap_metrics_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_service_params_be,
          { "Estimated service parameters AC=BE", "ieee1905_ap_metrics_est_param_be",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_service_params_bk,
          { "Estimated service parameters AC=BK", "ieee1905_ap_metrics_est_param_bk",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_service_params_vo,
          { "Estimated service parameters AC=VO", "ieee1905_ap_metrics_est_param_vo",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_metrics_service_params_vi,
          { "Estimated service parameters AC=VI", "ieee1905_ap_metrics_est_param_vi",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_sta_link_metric_op_class,
          { "Operating class", "ieee1905_unassoc_sta_link_metrics_op_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_sta_link_metric_sta_count,
          { "STA count", "ieee1905_unassoc_sta_link_metrics_sta_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        ...
        { &hf_ieee1905_unassoc_link_metric_delta,
          { "Time delta (ms)", "ieee1905_unassoc_sta_link_metrics_delta",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_mac_addr,
          { "Associated STA MAC address", "ieee1905_beacon_metrics_assoc_sta_mac",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_unassoc_link_metric_uplink_rssi,
          { "Uplink RSSI", "ieee1905_unassoc_sta_link_metrics_rssi",
            FT_INT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_op_class,
          { "Operating class", "ieee1905_beacon_metrics_op_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_channel,
          { "Channel number", "ieee1905_beacon_metrics_channel_number",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_bssid,
          { "BSSID", "ieee1905_beacon_metrics_bssid",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_detail,
          { "Reporting detail", "ieee1905_beacon_metrics_detail",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_ssid_len,
          { "SSID length", "ieee1905_beacon_metrics_ssid_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_query_ssid,
          { "SSID", "ieee1905_beacon_metrics_ssid",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_channel_count,
          { "Channel reports number", "ieee1905_beacon_metrics_report_number",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_report_len,
          { "Channel report length", "ieee1905_beacon_metrics_report_length",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_report_op_class,
          { "Channel report operating class", "ieee1905_beacon_metrics_op_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        ...
        { &hf_ieee1905_measurement_report,
          { "Measurement Report", "ieee1905_measurement_report",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_response_mac_addr,
          { "STA MAC address", "ieee1905_beacon_metrics_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_response_reserved,
          { "Reserved", "ieee1905_beacon_metrics_reserved",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_beacon_metrics_response_meas_num,
          { "Number of Measurements", "ieee1905_beacon_metrics_number_of_measurements",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_mac_addr,
          { "Associated STA MAC address", "ieee1905_assoc_sta_traffic_stats_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_bytes_sent,
          { "Bytes Sent", "ieee1905_assoc_sta_traffic_stats_bytes_sent",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_bytes_rcvd,
          { "Bytes Received", "ieee1905_assoc_sta_traffic_stats_bytes_rcvd",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_packets_sent,
          { "Packets Sent", "ieee1905_assoc_sta_traffic_stats_packets_sent",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_packets_rcvd,
          { "Packets Received", "ieee1905_assoc_sta_traffic_stats_packets_rcvd",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_tx_pkt_errs,
          { "Tx Packet Errors", "ieee1905_assoc_sta_traffic_stats_tx_pkt_errs",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_rx_pkt_errs,
          { "Rx Packet Errors", "ieee1905_assoc_sta_traffic_stats_rx_packet_errs",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_assoc_sta_traffic_stats_retrans_count,
          { "Retransmission Count", "ieee1905_assoc_sta_traffic_stats_retrans_count",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_error_code_value,
          { "Reason code", "ieee1905_error_code_reason",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_error_code_mac_addr,
          { "MAC address of error-code STA", "ieee1905_error_code_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_rep_policy,
          { "Reporting Policy", "ieee1905_channel_scan_reporting_policy",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_pol_report,
          { "Report Independent Channel Scans",
            "ieee1905_channel_scan_reporting_policy_report_independent_channel_scans",
            FT_BOOLEAN, 8, TFS(&report_independent_scans_tfs), 0x01, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_pol_reserved,
          { "Reserved", "ieee1905_channel_scan_reporting_policy_reserved",
            FT_UINT8, BASE_HEX, NULL, 0xFE, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capabilities_radio_num,
          { "Number of radios", "ieee1905_channel_scan_capabilities_num_radios",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_radio_id,
          { "Radio Unique ID", "ieee1905_channel_scan_capabilities_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_flags,
          { "Flags", "ieee1905_channel_scan_capabilities_flags",
            FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_flags_on_boot_only,
          { "On boot only", "ieee1905_channel_scan_capabilities_flags_on_boot_only",
            FT_BOOLEAN, 8, TFS(&channel_scan_capa_flags_on_boot_only_tfs),
            0x80, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_flags_scan_impact,
          { "Scan Impact", "ieee1905_channel_scan_capabilities_flags_scan_impact",
            FT_UINT8, BASE_HEX, VALS(channel_scan_capa_flags_impact_vals), 0x60,
            NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_flags_reserved,
          { "Reserved", "ieee1905_channel_scan_capabilities_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x1F, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_min_scan_interval,
          { "Minimum Scan Interval", "ieee1905_channel_scan_capabilities_min_scan_interval",
            FT_UINT32, BASE_DEC | BASE_UNIT_STRING, &units_seconds,
            0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_class_num,
          { "Number of Operating Classes",
            "ieee1905_channel_scan_capabilities_num_operating_classes",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_oper_class,
          { "Operating Class", "ieee1905_channel_scan_capabilities_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_oper_class_chan_cnt,
          { "Number of Channels", "ieee1905_channel_scan_capabilities_operating_class_num_channels",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_capa_channel,
          { "Channel", "ieee1905_channel_scan_capabilities_operating_class_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_flags,
          { "Flags", "ieee1905_channel_scan_request_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_flags_fresh_scan,
          { "Perform Fresh Scan", "ieee1905_channel_scan_request_flags_perform_fresh_scan",
            FT_BOOLEAN, 8, TFS(&perform_fresh_scan_tfs), 0x80, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_flags_reserved,
          { "Reserved", "ieee1905_channel_scan_request_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x7F, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_radio_num,
          { "Number of Radios", "ieee1905_channel_scan_request_number_radios",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_radio_id,
          { "Radio Unique ID", "ieee1905_channel_scan_request_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_class_num,
          { "Number of Operating Classes",
            "ieee1905_channel_scan_request_num_operating_classes",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_oper_class,
          { "Operating Class", "ieee1905_channel_scan_request_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_oper_class_chan_cnt,
          { "Number of Channels", "ieee1905_channel_scan_request_operating_class_num_channels",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_request_channel,
          { "Channel", "ieee1905_channel_scan_request_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_radio_id,
          { "Radio Unique ID", "ieee1905_channel_scan_result_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_oper_class,
          { "Operating Class", "ieee1905_channel_scan_result_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_channel,
          { "Channel", "ieee1905_channel_scan_result_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_status,
          { "Status", "ieee1905_channel_scan_result_status",
            FT_UINT8, BASE_HEX|BASE_RANGE_STRING, RVALS(channel_scan_result_status_rvals),
            0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_timestamp_len,
          { "Timestamp Length", "ieee1905_channel_scan_result_timestamp_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_timestamp_string,
          { "Timestamp", "ieee1905_channel_scan_result_timestamp",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_utilization,
          { "Utilization", "ieee1905_channel_scan_result_utilization",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_noise,
          { "Noise", "ieee1905_channel_scan_result_noise",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_metrics_noise,
          { "Noise", "ieee1905_radio_metrics_noise",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_metrics_transmit,
          { "Transmit", "ieee1905_radio_metrics_transmit",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_metrics_receive_self,
          { "ReceiveSelf", "ieee1905_radio_metrics_receive_self",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_metrics_receive_other,
          { "ReceiveOther", "ieee1905_radio_metrics_receive_other",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_bssid,
          { "BSSID", "ieee1905_ap_extended_metrics_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_unicast_sent,
          { "UnicastBytesSent",
            "ieee1905_ap_extended_metrics_unicast_bytes_sent",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_unicast_rcvd,
          { "UnicastBytesReceived",
            "ieee1905_ap_extended_metrics_unicast_bytes_received",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_multicast_sent,
          { "MulticastBytesSent",
            "ieee1905_ap_extended_metrics_multicast_bytes_sent",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_multicast_rcvd,
          { "MulticastBytesReceived",
            "ieee1905_ap_extended_metrics_multicast_bytes_received",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_bcast_sent,
          { "BroadcastBytesSent",
            "ieee1905_ap_extended_metrics_Broadcast_bytes_sent",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_extended_metrics_bcast_rcvd,
          { "BroadcastBytesReceived",
            "ieee1905_ap_extended_metrics_broadcast_bytes_received",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_neigh_num,
          { "Number of Neighbors", "ieee1905_channel_scan_result_number_of_neighbors",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_bssid,
          { "BSSID", "ieee1905_channel_scan_result_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_ssid_len,
          { "SSID Length", "ieee1905_channel_scan_result_ssid_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_ssid,
          { "SSID", "ieee1905_channel_scan_result_ssid",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_sig_level,
          { "Signal Strength", "ieee1905_channel_scan_result_signal_strength",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_bw_len,
          { "Channel BW Length", "ieee1905_channel_scan_result_channel_bw_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_bw,
          { "Channel BW", "ieee1905_channel_scan_result_channel_bw",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_neigh_flags,
          { "Neighbor Flags", "ieee1905_channel_scan_result_neighbor_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_load_element_present,
          { "Utilization Present", "ieee1905_channel_scan_result_neighbor_flags_load_element_present",
            FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_util,
          { "Channel Utilization", "ieee1905_channel_scan_result_channel_util",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_sta_count,
          { "Station Count", "ieee1905_channel_scan_result_station_count",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_neigh_reserved,
          { "Reserved", "ieee1905_channel_scan_result_neighbor_flags_reserved",
            FT_UINT8, BASE_DEC, NULL, 0x7F, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_scan_duration,
          { "Scan Duration", "ieee1905_channel_scan_result_scan_duration",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_flags,
          { "Flags", "ieee1905_channel_scan_result_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_scan_type,
          { "Scan Type", "ieee1905_channel_scan_result_flags_scan_type",
            FT_BOOLEAN, 8, TFS(&channel_scan_result_type_tfs), 0x80, NULL, HFILL }},

        { &hf_ieee1905_channel_scan_result_scan_flags_reserved,
          { "Reserved", "ieee1905_channel_scan_result_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x7F, NULL, HFILL }},

        { &hf_ieee1905_timestamp_length,
          { "Timestamp Length", "ieee1905_timestamp_length",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_timestamp_string,
          { "Timestamp", "ieee1905_timestamp_timestamp",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_1905_layer_sec_capa_onboarding,
          { "Onboarding Protocols Supported", "ieee1905_1905_layer_security_capability_onboarding_protocols_supported",
        ...
        { &hf_ieee1905_1905_layer_sec_capa_mic_sup,
          { "Message Integrity Algorithms Supported",
            "ieee1905_1905_layer_security_capability_message_integrity_algorithms_supported",
        ...
        { &hf_ieee1905_1905_layer_sec_capa_enc_alg_sup,
          { "Message Encryption Algorithms Supported",
            "ieee1905_1905_layer_security_capability_message_encryption_algorithms_supported",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING, RVALS(message_encryption_algorithms_sup_rvals),
            0, NULL, HFILL }},

        { &hf_ieee1905_ap_wf6_capa_radio_id,
          { "Radio ID", "ieee1905_ap_wifi_6_capabilities_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_role_count,
          { "Role Count", "ieee1905_ap_wifi_6_capabilities_role_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_agent_role_flags,
          { "Role Flags", "ieee1905_ap_wifi_6_capabilities_role_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_capa_agents_role,
          { "Agent's Role", "ieee1905_ap_wifi_6_capabilities_agents_role",
            FT_UINT8, BASE_HEX, VALS(ap_wf6_agent_role_vals),
            0xC0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_capa_he_160_support,
          { "Support for HE 160 MHz",
            "ieee1905_ap_wifi_6_capabilities_support_for_he_160",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x20, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_capa_he_80p80_support,
          { "Support for HE 80+80 MHz",
            "ieee1905_ap_wifi_6_capabilities_support_for_he_80_p_80",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x10, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_capa_reserved,
          { "Reserved", "ieee1905_ap_wifi_6_capabilities_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x0F, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_he_supported_flags,
          { "HE Support flags",
            "ieee1905_ap_wifi_6_capabilities_he_support_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_su_beamformer,
          { "SU Beamformer", "ieee1905_ap_wifi_6_capabilities_su_beamformer",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x80, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_su_beamformee,
          { "SU Beamformee", "ieee1905_ap_wifi_6_capabilities_su_beamformee",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x40, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_mu_beamformer_status,
          { "MU Beamformer Status",
            "ieee1905_ap_wifi_6_capabilities_mu_beamformer_status",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x20, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_beamformee_sts_le_80mhz,
          { "Beamformee STS <= 80MHz",
            "ieee1905_ap_wifi_6_capabilities_beamformee_sts_le_80mhz",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x10, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_beamformee_sts_gt_80mhz,
          { "Beamformee STS > 80MHz",
            "ieee1905_ap_wifi_6_capabilities_beamformee_sts_gt_80mhz",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x08, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_ul_mu_mimo,
          { "UL MU MIMO", "ieee1905_ap_wifi_6_capabilities_us_mu_mimo",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x04, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_ul_ofdma,
          { "UL OFDMA", "ieee1905_ap_wifi_6_capabilities_ul_ofdma",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x02, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_dl_ofdma,
          { "DL OFDMA", "ieee1905_ap_wifi_6_capabilities_dl_ofdma",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x01, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_mimo_max_flags,
          { "MIMO Max Users flags",
            "ieee1905_ap_wifi_6_capabilities_mimo_max_users_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_max_ap_dl_mu_mimo_tx,
          { "Max AP DL MU-MIMO TX",
            "ieee1905_ap_wifi_6_capabilities_max_ap_dl_mu_mimo_tx",
            FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_max_ap_ul_mu_mimi_rx,
          { "Max AP UL MU-MIMO RX",
            "ieee1905_ap_wifi_6_capabilities_max_ap_ul_mu_mimo_rx",
            FT_UINT8, BASE_DEC, NULL, 0x0F, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_dl_ofdma_max_tx,
          { "Max users per DL OFDMA TX in AP role",
            "ieee1905_ap_wifi_6_capabilities_ap_max_users_per_dl_ofdma_tx",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_ul_ofdma_max_rx,
          { "Max users per UL OFDMA RX in AP role",
            "ieee1905_ap_wifi_6_capabilities_ap_max_users_per_ul_ofdma_rx",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_flags,
          { "General flags", "ieee1905_ap_wifi_6_capabilities_general_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_rts,
          { "RTS", "ieee1905_ap_wifi_6_capabilities_general_flags_rts",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x80, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_mu_rts,
          { "MU RTS", "ieee1905_ap_wifi_6_capabilities_general_flags_mu_rts",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x40, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_multi_bssid,
          { "Multi-BSSID",
            "ieee1905_ap_wifi_6_capabilities_general_flags_multi_bssid",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x20, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_mu_edca,
          { "MU EDCA", "ieee1905_ap_wifi_6_capabilities_general_flags_mu_edca",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x10, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_twt_requester,
          { "TWT Requester",
            "ieee1905_ap_wifi_6_capabilities_general_flags_twt_requester",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x08, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_twt_responder,
          { "TWT Responder",
            "ieee1905_ap_wifi_6_capabilities_general_flags_twt_responder",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x04, NULL, HFILL}},

        { &hf_ieee1905_ap_wf6_gen_reserved,
          { "Reserved",
            "ieee1905_ap_wifi_6_capabilities_general_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x03, NULL, HFILL }},

        { &hf_ieee1905_agent_list_bytes,
          { "Agent List", "ieee1905_agent_list_agent_list_data",
            FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_loop_prevention_mech_setting,
          {"Loop Prevention Mechanism Setting",
           "ieee1905_loop_prevention_mechanism_setting_setting",
           FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_loop_prevention_mechanism,
          { "Loop Prevention Mechanism",
           "ieee1905_loop_prevention_mechanism_setting_loop_prevention_mech",
           FT_UINT8, BASE_HEX, VALS(loop_prev_mech_vals), 0xC0, NULL, HFILL }},

        { &hf_ieee1905_loop_prevention_preferred_backhaul_intf,
          { "Preferred Backhaul Interface",
           "ieee1905_loop_prevention_mechanism_setting_preferred_backhaul_intf",
        ...
        { &hf_ieee1905_loop_detection_sequence_number,
          { "Loop Detection Sequence Number",
            "ieee1905_loop_detection_sequence_number_sequence_number",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_loop_prevention_reserved,
          { "Reserved",
           "ieee1905_loop_prevention_mechanism_setting_reserved",
           FT_UINT8, BASE_HEX, NULL, 0x0F, NULL, HFILL }},

        { &hf_ieee1905_group_integrity_key_id,
          { "Group Integrity Key ID",
            "ieee1905_group_integrity_key_group_integrity_key_id",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_group_integrity_key_len,
          { "Group Integrity Key ID Length",
            "ieee1905_group_integrity_key_group_integrity_key_id_len",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_group_integrity_key_bytes,
          { "Group Integrity Key",
            "ieee1905_group_integrity_key_group_integrity_key",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_group_integrity_key_mic_alg,
          { "MIC Algorithm", "ieee1905_group_integrity_key_mic_algorithm",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING, RVALS(group_integrity_key_mic_alg_rvals),
            0, NULL, HFILL }},

        { &hf_ieee1905_mic_group_temporal_key_id,
          { "Group Temporal Key ID", "ieee1905_mic_group_temporal_key_id",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_1905_gtk_key_id,
          { "MIC Version", "ieee1905_mic_group_temporal_key_id_mic_version",
            FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
        ...
        { &hf_ieee1905_mic_reserved,
          { "Reserved", "ieee1905_mic_group_temporal_key_id_reserved",
             FT_UINT8, BASE_HEX, NULL, 0x0F, NULL, HFILL }},

        { &hf_ieee1905_mic_integrity_transmission_counter,
          { "Integrity Transmission Counter",
            "ieee1905_mic_integrity_transmission_counter",
            FT_UINT48, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_mic_source_la_mac_id,
          {"Source LA MAC ID", "ieee1905_mic_source_la_max_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_mic_length,
          { "MIC Length", "ieee1905_mic_mic_length",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_mic_bytes,
          { "MIC", "ieee1905_mic_mic_bytes",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_encrypted_enc_transmission_count,
          { "Encryption Transmission Counter",
            "ieee1905_encrypted_encryption_transmission_counter",
            FT_UINT48, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_encrypted_dest_al_mac_addr,
          { "Destination 1905 AL MAC Address",
            "ieee1905_encrypted_destination_1905_al_mac",
            FT_ETHER, ENC_NA, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_encrypted_source_la_mac_id,
          { "Source AL MAC", "ieee1905_encrypted_source_al_mac",
            FT_ETHER, ENC_NA, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_encrypted_enc_output_field_len,
          { "AES-SIV Encrypted Output Length",
            "ieee1905_encrypted_aes_siv_encrypted_output_length",
            FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_encrypted_enc_output_field,
          { "AES-SIV Encryption Output",
            "ieee1905_encrypted_aes_siv_encryption_output",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_radio_count,
          { "Number of Radios", "ieee1905_cac_request_number_of_radios",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_radio_id,
          { "Radio ID", "ieee1905_cac_request_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_op_class,
          { "Operating class", "ieee1905_cac_request_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_channel,
          { "Channel", "ieee1905_cac_request_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_flags,
          { "Request flags", "ieee1905_cac_request_flags",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_method,
          { "CAC Method", "ieee1905_cac_request_flags_cac_method",
            FT_UINT8, BASE_DEC, VALS(cac_request_method_vals),
            0xE0, NULL, HFILL }},

        { &hf_ieee1905_cac_request_completion_action,
          { "Successful Completion Action",
            "ieee1905_cac_request_flags_successful_completion_action",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING,
            RVALS(cac_completion_action_vals), 0x18, NULL, HFILL }},

        { &hf_ieee1905_cac_request_completion_unsuccess,
          { "Unsuccessful Completion Action",
            "ieee1905_cac_request_flags_unsuccessful_completion_action",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING,
            RVALS(cac_completion_action_vals), 0x06, NULL, HFILL }},

        { &hf_ieee1905_cac_request_reserved,
          { "Reserved", "ieee1905_cac_request_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x01, NULL, HFILL }},

        { &hf_ieee1905_cac_termination_radio_count,
          { "Number of Radios", "ieee1905_cac_termination_number_of_radios",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_terminate_radio_id,
          { "Radio ID", "ieee1905_cac_termination_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_terminate_op_class,
          { "Operating class", "ieee1905_cac_termination_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_terminate_channel,
          { "Channel", "ieee1905_cac_termination_channel",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_terminate_action,
          { "CAC Termination Action", "ieee1905_cac_termination_action",
        ...
        { &hf_ieee1905_cac_completion_rep_radio_count,
          { "Number of radios",
            "ieee1905_cac_completion_report_number_of_radios",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_completion_radio_id,
          { "Radio ID", "ieee1905_cac_completion_report_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_completion_op_class,
          { "Operating class", "ieee1905_cac_completion_report_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_completion_channel,
          { "Channel", "ieee1905_cac_completion_report_channel",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_completion_status,
          { "CAC Completion Status",
            "ieee1905_cac_completion_report_cac_completion_status",
            FT_UINT8, BASE_HEX | BASE_RANGE_STRING,
            RVALS(cac_completion_status_rvals), 0, NULL, HFILL }},

        { &hf_ieee1905_cac_completion_radar_count,
          { "Radar detected count",
            "ieee1905_cac_completion_report_radar_detected_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_cac_comp_radar_op_class,
          { "Operating class",
            "ieee1905_cac_completion_report_radar_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_comp_radar_channel,
          { "Channel", "ieee1905_cac_completion_report_radar_channel",
            FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_active_chan,
          { "Available Channel Count",
            "ieee1905_cac_status_report_available_channel_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_avail_op_class,
          { "Operating Class",
            "ieee1905_cac_status_report_available_channel_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_avail_channel,
          { "Channel",
            "ieee1905_cac_status_report_available_channel_channel",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_avail_minutes,
          { "Minutes since CAC completed",
            "ieee1905_cac_status_report_available_channel_minutes_since",
            FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_non_occ_cnt,
          { "Non-occupied Channel Count",
            "ieee1905_cac_status_report_non_occupied_channel_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_non_occ_op_class,
          { "Operating Class",
            "ieee1905_cac_status_report_non_occupied_channel_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_non_occ_channel,
          { "Channel",
            "ieee1905_cac_status_report_non_occupied_channel_channel",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_non_occ_seconds,
          { "Seconds remaining",
            "ieee1905_cac_status_report_non_occupied_channel_second_remaining",
            FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_active_cac_cnt,
          { "Active CAC Channel Count",
            "ieee1905_cac_status_report_active_cac_channel_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_active_cac_op_class,
          { "Operating Class",
            "ieee1905_cac_status_report_active_cac_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_active_cac_channel,
          { "Channel",
            "ieee1905_cac_status_report_active_cac_channel",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_status_rpt_active_cac_seconds,
          { "Seconds remaining",
            "ieee1905_cac_status_report_active_cac_seconds_remaining",
            FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capa_country_code,
          { "Country Code", "ieee1905_cac_capabilities_country_code",
            FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capa_radio_cnt,
          { "Number of radios", "ieee1905_cac_capabilities_number_of_radios",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_radio_id,
          { "Radio ID", "ieee1905_cac_capabilities_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_types_num,
          { "Number of types", "ieee1905_cac_capabilities_number_of_types",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_cac_mode,
          { "CAC mode supported",
            "ieee1905_cac_capabilities_cac_mode_supported",
            FT_UINT8, BASE_HEX | BASE_RANGE_STRING,
            RVALS(cac_mode_supported_rvals), 0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_cac_seconds,
          { "Seconds required to complete CAC",
            "ieee1905_cac_capabilities_seconds_required_to_complete_cac",
            FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_op_class_num,
          { "Operating Class number",
            "ieee1905_cac_capabilities_operating_class_number",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_op_class,
          { "Operating Class", "ieee1905_cac_capabilities_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabilities_channel_cnt,
          { "Number of channels",
            "ieee1905_cac_capabilities_number_of_channels",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_cac_capabillity_channel,
          { "Channel", "ieee1905_cac_capabilities_channel",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_multi_ap_version,
          { "Multi-AP Profile", "ieee1905_multi_ap_version",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING,
        ...
        { &hf_ieee1905_max_total_serv_prio_rules,
          { "Max Total Number Service Prioritization Rules",
            "ieee1905_r2_ap_capabilities_max_total_service_prio_rules",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_r2_ap_capa_reserved,
          { "Reserved", "ieee1905_r2_ap_capabilities_reserved",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_r2_ap_capa_flags,
          { "Flags", "ieee1905_r2_ap_capabilities_flags",
            FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_byte_counter_units,
          { "Byte Counter Units", "ieee1905_r2_ap_capabilities_byte_counter_units",
            FT_UINT8, BASE_DEC, VALS(byte_counter_units_vals), 0xC0, NULL, HFILL}},

        { &hf_ieee1905_basic_service_prio_flag,
          { "Basic Service Prioritization", "ieee1905_r2_ap_capabilities_basic_service_prioritization",
            FT_BOOLEAN, 8, TFS(&tfs_enabled_disabled), 0x20, NULL, HFILL }},

        { &hf_ieee1905_enhanced_service_prio_flag,
          { "Enhanced Service Prioritization", "ieee1905_r2_ap_capabilities_enhanced_service_prioritization" ,
        ...
        { &hf_ieee1905_max_vid_count,
          { "Max Total Number of VIDs", "ieee1905_r2_ap_capabilities_max_total_number_of_vids",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_default_802_1q_settings_primary_vlan,
          { "Primary VLAN ID", "ieee1905_service_prioritization_rule_primary_vlan_id",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_default_802_1q_settings_flags,
          { "Flags", "ieee1905_service_prioritization_rule_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_default_802_1q_settings_default_pcp,
          { "Primary PCP", "ieee1905_service_prioritization_rule_flags_primary_pcp",
            FT_UINT8, BASE_HEX, NULL, 0xE0, NULL, HFILL }},

        { &hf_ieee1905_default_802_1q_settings_reserved,
          { "Reserved", "ieee1905_service_prioritization_rule_fkags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x1F, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_advanced_capa_radio_id,
          { "Radio Unique ID", "ieee1905_ap_advanced_capabilities_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_radio_advanced_capa_flags,
          { "AP Radio Advanced Capabilities Flags",
            "ieee1905_ap_advanced_capabilities_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_traffic_separation_policy_num_ssids,
          { "Number of SSIDs", "ieee1905_traffic_separation_policy_num_ssids",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_traffic_separation_policy_ssid_len,
          { "SSID Length", "ieee1905_traffic_separation_policy_ssid_length",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_traffic_separation_policy_ssid,
          { "SSID", "ieee1905_traffic_separation_policy_ssid",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_traffic_separation_policy_vlanid,
          { "VLAN ID", "ieee1905_traffic_separation_policy_vlan_id",
            FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_radio_count,
          { "Radio Count", "ieee1905_bss_config_report_radio_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_radio_id,
          { "Radio ID", "ieee1905_bss_config_report_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_flags,
          { "Report Flags", "ieee1905_bss_config_report_report_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_backhaul_bss,
          { "Backhaul BSS", "ieee1905_bss_config_report_backhaul_bss",
            FT_BOOLEAN, 8, TFS(&tfs_used_notused), 0x80, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_fronthaul_bss,
          { "Fronthaul BSS", "ieee1905_bss_config_report_fronthaul_bss",
            FT_BOOLEAN, 8, TFS(&tfs_used_notused), 0x40, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_r1_disallowed_status,
          { "R1 Disallowed Status",
            "ieee1905_bss_config_report_r1_disallowed_status",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_disallowed), 0x20, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_r2_disallowed_status,
          { "R2 Disallowed Status",
            "ieee1905_bss_config_report_r2_disallowed_status",
            FT_BOOLEAN, 8, TFS(&tfs_allowed_disallowed), 0x10, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_multiple_bssid_set,
          { "Multiple BSSID Set",
            "ieee1905_bss_config_report_multiple_bssid_set",
            FT_BOOLEAN, 8, TFS(&tfs_transmitted_non_transmitted),
            0x08, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_transmitted_bssid,
          { "Transmitted BSSID",
            "ieee1905_bss_config_report_transmitted_bssid",
            FT_BOOLEAN, 8, TFS(&tfs_transmitted_non_transmitted),
            0x04, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_reserved,
          { "Reserved", "ieee1905_bss_config_report_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x03, NULL, HFILL }},
        ...
        { &hf_ieee1905_bss_config_report_bss_cnt,
          { "BSS Count", "ieee1905_bss_config_report_bss_count",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hs_ieee1902_bss_config_report_mac,
          { "Local Interface MAC addr",
            "ieee1905_bss_config_report_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1902_bss_config_report_ssid_len,
          { "SSID Length", "ieee1905_bss_config_report_ssid_length",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bss_config_report_ssid,
          { "SSID", "ieee1905_bss_config_report_ssid",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_packet_filtering_policy_bssid_num,
          { "Number of BSSIDs", "ieee1905_packet_filtering_policy_num_bssids",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_packet_filtering_policy_bssid,
          { "BSSID", "ieee1905_packet_filtering_policy_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_packet_filtering_policy_mac_count,
          { "Number of Permitted Destination MAC Addresses",
            "ieee1905_packet_filtering_policy_num_permitted_mac_addr",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_packet_filtering_policy_mac_addr,
          { "Permitted Destination MAC Address",
            "ieee1905_packet_filtering_policy_permitted_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_bssid_tlv_bssid,
          { "BSSID", "ieee1905_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_id,
          { "Rule Identifier", "ieee1905_service_prio_rule_id",
            FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_flags,
          { "Flags", "ieee1905_service_prio_rule_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_add_remove_filter_bit,
          { "Add-Remove Filter", "ieee1905_service_prio_rule_flags_add_remove",
            FT_BOOLEAN, 8, TFS(&tfs_add_remove), 0x80, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_flags_reserved,
          { "Reserved", "ieee1905_service_prio_rule_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x7F, NULL, HFILL }},


        { &hf_ieee1905_service_prio_rule_precedence,
          { "Rule Precedence", "ieee1905_service_prio_rule_precedence",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_output,
          { "Rule Output", "ieee1905_service_prio_rule_output",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_match_flags,
          { "Match flags", "ieee1905_service_prio_rule_match_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_always,
          { "Match Always", "ieee1905_service_prio_rule_match_match_always",
            FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_reserved,
          { "Reserved", "ieee1905_service_prio_rule_match_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x40, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_up_in_qos,
          { "Match Up in 802.11 QoS Control",
            "ieee1905_service_prio_rule_match_match_up_802_11_qos",
            FT_BOOLEAN, 8, NULL, 0x20, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_up_control_match,
          { "UP in 802.11 QoS Control Match Sense Flag",
            "ieee1905_service_prio_rule_match_up_in_802_11_qos_control",
            FT_BOOLEAN, 8, NULL, 0x10, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_source_mac,
          { "Match Source MAC Address",
            "ieee1905_service_prio_rule_match_match_source_mac",
            FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_source_mac_sense,
          { "Source MAC Address Match Sense",
            "ieee1905_service_prio_rule_match_source_mac_address_match_sense",
            FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_dest_mac,
          { "Match Destination MAC address",
            "ieee1905_service_prio_rule_match_match_destination_mac",
            FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_match_dest_mac_sense,
          { "Destination MAC Address Match Sense",
            "ieee1905_service_prio_rule_match_destination_mac_address_match_sense",
            FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_up_control,
          { "UP in 802.11 QoS Control",
            "ieee1905_service_prio_rule_up_in_802_11_qos_control",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_source_mac,
          { "Source MAC Address", "ieee1905_service_prio_rule_source_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_service_prio_rule_dest_mac,
          { "Destination MAC Address", "ieee1905_service_prio_rule_destination_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dscp_mapping_table_val,
          { "PCP Value", "ieee1905_dscp_mapping_table_pcp_value",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_r2_error_reason_code,
          { "Reason Code", "ieee1905_profile_2_error_reason_code",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING, RVALS(r2_error_code_rvals),
            0, NULL, HFILL }},

        { &hf_ieee1905_r2_error_bssid,
          { "BSSID", "ieee1905_profile_2_error_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_advance_capa_backhaul_bss_traffic_sep,
          { "Traffic Separation on combined fronthaul and R1-only backhaul",
            "ieee1905_ap_advanced_capabilities_traffic_sep_on_combined_fronthaul_and_r1_only_backhaul",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x80, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_advance_capa_combined_r1_r2_backhaul,
          { "Traffic Separation on combined R1 and R2 and above backhaul",
            "ieee1905_ap_advanced_capabilities_traffic_sep_on_combined_r1_and_r2_and_backhaul",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported),
            0x40, NULL, HFILL }},

        { &hf_ieee1905_ap_radio_advance_capa_reserved,
          { "Reserved", "ieee1905_ap_advanced_capabilities_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x3F, NULL, HFILL }},

        { &hf_ieee1905_assoc_status_notif_num_bssid,
          { "Number of BSSIDs",
            "ieee1905_association_status_notification_num_bssids",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_assoc_status_notif_bssid,
          { "BSSID of operated BSS",
            "ieee1905_associated_status_notification_bssid_of_operated_bss",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_assoc_status_notif_status,
          { "Status", "ieee1905_associated_status_notification_status",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING,
            RVALS(assoc_status_notif_status_rvals), 0x0, NULL, HFILL }},

        { &hf_ieee1905_source_info_mac_addr,
          { "Tunneled Source MAC Address",
            "ieee1905_source_info_tunneled_source_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_tunneled_message_type,
          { "Tunneled protocol payload type",
            "ieee1905_tunneled_message_type_tunneled_payload_type",
            FT_UINT8, BASE_DEC | BASE_RANGE_STRING,
            RVALS(tunneled_message_type_rvals), 0x0, NULL, HFILL }},

        { &hf_ieee1905_tunneled_data,
          { "Tunneled protocol payload",
            "ieee1905_tunneled_tunneled_protocol_payload",
            FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_status_code_status,
          { "Status Code", "ieee1905_status_code_status_code",
            FT_UINT16, BASE_HEX|BASE_EXT_STRING, &ieee80211_status_code_ext, 0,
            NULL, HFILL }},

        { &hf_ieee1905_disassociation_reason_code,
          { "Reason Code", "ieee1905_disassociation_reason_code_reason_code",
            FT_UINT16, BASE_HEX|BASE_EXT_STRING, &ieee80211_reason_code_ext, 0,
            NULL, HFILL }},

        { &hf_ieee1905_backhaul_sta_radio_id,
          { "Radio ID", "ieee1905_backhaul_sta_radio_capabilities_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_sta_radio_capabilities,
          { "Flags", "ieee1905_backhaul_sta_radio_capabilities_flags",
            FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_sta_radio_capa_mac_included,
          { "MAC address included",
            "ieee1905_backhaul_sta_radio_capabilities_mac_address_included",
            FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},

        { &hf_ieee1905_backhaul_sta_radio_capa_reserved,
          { "Reserved", "ieee1905_backhaul_sta_radio_capabilities_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x7F, NULL, HFILL }},

        { &hf_ieee1905_backhaul_sta_addr,
          { "Backhaul STA MAC address",
            "ieee1905_backhaul_sta_radio_capabilities_backhaul_sta_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_akm_backhaul_suite_oui,
          { "Backhaul Suite OUI",
            "ieee1905_akm_suite_capabilities_backhaul_backhaul_akm_suite_oui",
            FT_UINT24, BASE_OUI, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_akm_backhaul_suite_type,
          { "Backhaul AKM Suite type",
            "ieee1905_akm_suite_capabilities_backhaul_akm_suite_type",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_backhaul_akm_suite_capa_count,
          { "Backhaul AKM Suite count",
            "ieee1905_akm_suite_capabilities_backhaul_akm_suite_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_akm_fronthaul_suite_oui,
          { "Fronthaul Suite OUI",
            "ieee1905_akm_suite_capabilities_backhaul_fronthaul_akm_suite_oui",
            FT_UINT24, BASE_OUI, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_akm_fronthaul_suite_type,
          { "Fronthaul AKM Suite type",
            "ieee1905_akm_suite_capabilities_fronthaul_akm_suite_type",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_fronthaul_akm_suite_capa_count,
          { "Fronthaul AKM Suite count",
            "ieee1905_akm_suite_capabilities_fronthaul_akm_suite_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_encap_dpp_flags,
          { "Flags", "ieee1905_1905_encap_dpp_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_enrollee_mac_present,
          { "Enrollee Mac Address Present",
            "ieee1905_1905_encap_dpp_flags_enrollee_mac_address_present",
            FT_BOOLEAN, 8, NULL, 0x80, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_reserved,
          { "Reserved",
            "ieee1905_1905_encap_dpp_flags_reserved",
            FT_BOOLEAN, 8, NULL, 0x40, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_frame_type_flag,
          { "DPP Frame Indicator",
            "ieee1905_1905_encap_dpp_flags_dpp_frame_indicator",
            FT_BOOLEAN, 8, TFS(&tfs_dpp_frame_indicator), 0x20, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_reserved2,
          { "Reserved", "ieee1905_1905_encap_dpp_flags_reserved2",
            FT_UINT8, BASE_HEX, NULL, 0x1F, NULL, HFILL }},

        { &hf_ieee1905_encap_dpp_sta_mac,
          { "Destination STA MAC address",
            "ieee1905_1905_encap_dpp_destination_sta_mac_address",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_frame_type,
          { "Frame Type", "ieee1905_1905_encap_dpp_frame_type",
            FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_frame_length,
          { "Frame Length", "ieee1905_1905_encap_dpp_frame_length",
            FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_dpp_oui,
          { "OUI", "ieee1905_1905_encap_dpp_oui",
            FT_UINT24, BASE_OUI, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_public_action,
          { "Public Action", "ieee1905_1905_encap_dpp_public_action",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &ff_pa_action_codes_ext, 0,
            NULL, HFILL }},

        { &hf_ieee1905_dpp_encap_dpp_subtype,
          { "WFA Subtype", "ieee1905_1905_encap_dpp_subtype",
            FT_UINT8, BASE_DEC, VALS(wfa_subtype_vals), 0,
            NULL, HFILL }},

        { &hf_ieee1905_dpp_bootstrapping_uri_radio_id,
          { "Radio ID", "ieee1905_dpp_bootstrapping_uri_notification_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_bootstrapping_uri_local_mac_addr,
          { "MAC Address of Local Interface",
            "ieee1905_dpp_bootstrapping_uri_notification_mac_addr_local_intf",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_bootstrapping_uri_bsta_mac_addr,
          { "MAC Address of bSTA",
            "ieee1905_dpp_bootstrapping_uri_notification_mac_addr_bsta",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_bootstrapping_uri_received,
          { "DPP Bootstrapping URI",
            "ieee1905_dpp_bootstrapping_uri_notification_dpp_bootstrapping_uri",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dpp_advertise_cce_flag,
          { "Advertise CCE", "ieee1905_dpp_advertise_cce_flag",
            FT_BOOLEAN, 8, TFS(&tfs_enabled_disabled), 0x01, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_value_flags,
          { "Chirp Value Flags", "ieee1905_dpp_chirp_value_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_enrollee_mac_addr_present,
          { "Enrollee MAC Address Present",
            "ieee1905_dpp_chirp_value_flags_enrollee_mac_addr_present",
            FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x80, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_hash_validity,
          { "Hash Validity Bit", "ieee1905_dpp_chirp_value_flags_hash_validity_bit",
            FT_BOOLEAN, 8, TFS(&tfs_chirp_hash_validity_bit),
            0x40, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_reserved,
          { "Reserved", "ieee1905_dpp_chirp_value_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x3F, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_enrollee_mac_addr,
          { "Destination STA MAC Address",
            "ieee1905_dpp_chirp_value_dest_mac_addr",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_value_hash_length,
          { "Hash Length", "ieee1905_dpp_chirp_value_hash_length",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dpp_chirp_value_hash_value,
          { "Hash Value", "ieee1905_dpp_chirp_value_hash_value",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_lsn,
          { "Serial Number Length", "ieee1905_device_inventory_lsn",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_serial,
          { "Serial Number", "ieee1905_device_inventory_serial_number",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_lsv,
          { "Software Version Length", "ieee1905_device_inventory_lsv",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_sw_vers,
          { "Software Version", "ieee1905_device_inventory_software_version",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_lee,
          { "Execution Env Length", "ieee1905_device_inventory_lee",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_exec_env,
          { "Execution Env", "ieee1905_device_inventory_execution_env",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_num_radios,
          { "Number of Radios", "ieee1905_device_inventory_number_of_radios",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_radio_id,
          { "Radio ID", "ieee1905_device_inventory_radio_id",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_lcv,
          { "Chipset Vendor Length", "ieee1905_device_inventory_lcv",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_dev_inventory_chp_ven,
          { "Chipset Vendor", "ieee1905_device_inventory_chipset_vendor",
            FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_req_src_bssid,
          { "Src BSSID", "ieee1905_r2_steering_request_src_bssid",
            FT_ETHER, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_req_flags,
          { "Flags", "ieee1905_r2_steering_request_flags",
            FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_request_mode_flag,
          { "Request Mode", "ieee1905_r2_steering_request_flags_request_mode",
            FT_BOOLEAN, 8, TFS(&tfs_ieee1905_steering_request_mode_flag),
            0x80, NULL, HFILL }},

        { &hf_ieee1905_r2_btm_disassoc_imminent_flag,
          { "BTM Disassociation Imminent",
            "ieee1905_r2_steering_request_flags_btm_disassociation_imminent",
            FT_BOOLEAN, 8, NULL, 0x40, NULL, HFILL }},

        { &hf_ieee1905_r2_btm_abridged_flag,
          { "BTM Abridged", "ieee1905_r2_steering_request_flags_btm_abridged",
            FT_BOOLEAN, 8, NULL, 0x20, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_req_reserved,
          { "Reserved", "ieee1905_r2_steering_request_flags_reserved",
            FT_UINT8, BASE_HEX, NULL, 0x1F, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_op_window,
          { "Steering Opportunity window",
            "ieee1905_r2_steering_request_steering_opportunity_window",
            FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_btm_dissasoc_tmr,
          { "BTM Disassociation Timer",
            "ieee1905_r2_steering_request_btm_disassociation_timer",
            FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_sta_count,
          { "STA List Count", "ieee1905_r2_steering_request_sta_list_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_sta_mac,
          { "AMB capable STA MAC",
            "ieee1905_r2_steering_request_amb_capable_sta_mac",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_target_count,
          { "Target BSSID Count",
            "ieee1905_r2_steering_request_target_bssid_count",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_target_bssid,
          { "Target BSSID", "ieee1905_r2_steering_request_target_bssid",
            FT_ETHER, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_target_op_class,
          { "Target Operating Class",
            "ieee1905_r2_steering_request_target_operating_class",
            FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_target_channel,
          { "Target Channel",
            "ieee1905_r2_steering_request_target_channel",
            FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_r2_steering_reason,
          { "Reason code", "ieee1905_r2_steering_request_reason_code",
            FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_metric_collection_interval,
          { "Collection Interval", "ieee1905_metric_collection_interval_interval",
            FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_max_reporting_rate,
          { "Maximum Reporting Rate", "ieee1905_unsuccessful_assoc_max_report_rate",
            FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_bss_configuration_request,
          { "Configuration Request Object",
            "ieee1905_bss_configuration_request_configuration_request_object",
            FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_bss_configuration_response,
          { "Configuration Response Object",
            "ieee1905_bss_configuration_response_configuration_response_object",
            FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_dpp_message_public_action,
          { "Public Action", "ieee1905_dpp_message_public_action",
            FT_UINT8, BASE_HEX|BASE_EXT_STRING, &ff_pa_action_codes_ext, 0,
            NULL, HFILL }},

        { &hf_ieee1905_extra_tlv_data,
          { "Extraneous TLV data", "ieee1905_extra_tlv_data",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},

        { &hf_ieee1905_data,
          { "Extraneous message data", "ieee1905_data",
            FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_ieee1905_fragments,
          { "IEEE1905 Message Fragments", "ieee1905_fragments",
            FT_NONE, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment,
          { "IEEE1905 Message Fragment", "ieee1905_fragment",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_overlap,
          { "IEEE1905 Message Fragment Overlap", "ieee1905_fragment_overlap",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_overlap_conflicts,
          { "IEEE1905 Message Fragment Overlap Conflict",
            "ieee1905_fragment_overlap_conflicts",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_multiple_tails,
          { "IEEE1905 Message has multiple tail fragments",
            "ieee1905_fragment_multiple_tails",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_too_long_fragment,
          { "IEEE1905 Message Fragment too long",
            "ieee1905_fragment_too_long",
            FT_BOOLEAN, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_error,
          { "IEEE1905 Message defragmentation error",
            "ieee1905_fragment_error",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_count,
          { "IEEE1905 Message Fragment count", "ieee1905_fragment_count",
            FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_reassembled_in,
          { "Reassembled in", "ieee1905_fragment_reassembled_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0, NULL, HFILL }},

        { &hf_ieee1905_fragment_reassembled_length,
          { "IEEE1905 Message length", "ieee1905_fragment_reassembled_length",
            FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
