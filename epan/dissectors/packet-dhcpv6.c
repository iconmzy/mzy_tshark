...
proto_register_dhcpv6(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        /* DHCPv6 header */
        { &hf_dhcpv6_msgtype,
          { "Message type", "dhcpv6_msgtype", FT_UINT8, BASE_DEC | BASE_EXT_STRING, &msgtype_vals_ext, 0x0, NULL, HFILL }},
        { &hf_dhcpv6_hopcount,
          { "Hopcount", "dhcpv6_hopcount", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_dhcpv6_xid,
          { "Transaction ID", "dhcpv6_xid", FT_UINT24, BASE_HEX, NULL, 0, NULL, HFILL}},
        { &hf_dhcpv6_linkaddr,
          { "Link address", "dhcpv6_linkaddr", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL}},
        { &hf_dhcpv6_peeraddr,
          { "Peer address", "dhcpv6_peeraddr", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL}},
        /* Generic option stuff */
        { &hf_option_type_num,
          { "Option", "dhcpv6_option_type", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &opttype_vals_ext, 0x0, NULL, HFILL}},
        { &hf_option_length,
          { "Length", "dhcpv6_option_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL}},
        { &hf_option_type_str,
          { "Option", "dhcpv6_option_type_str", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL}},

        /* OPTION_CLIENT_FQDN */
        { &hf_clientfqdn_bad_msgtype,
          { "Illegal Message Type", "dhcpv6_clientfqdn_bad_msgtype", FT_UINT8, BASE_HEX | BASE_EXT_STRING, &msgtype_vals_ext, 0x0, NULL, HFILL }},
        { &hf_clientfqdn_flags,
          { "Flags", "dhcpv6_client_fqdn_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
        /* Client's preferences */
        { &hf_clientfqdn_client_s,
          { "S bit", "dhcpv6_clientfqdn_client_s", FT_BOOLEAN, 8, TFS(&fqdn_s), 0x1,
            "Whether or not the client prefers to perform AAAA RR (FQDN-to-address) updates", HFILL}},
        { &hf_clientfqdn_client_n,
          { "N bit", "dhcpv6_clientfqdn_client_n", FT_BOOLEAN, 8, TFS(&fqdn_n), 0x4,
        ...
        { &hf_empty_domain_name,
          { "Empty domain name - field length", "dhcpv6_domain_field_len", FT_UINT16, BASE_DEC, NULL, 0,
            "Indicates that the client requests the server to provide an FQDN name", HFILL}},
        { &hf_dhcpv6_non_dns_encoded_name,
          { "Non-DNS encoded name. Label length exceeds 63", "dhcpv6_bogus_label_length",
            FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_dhcpv6_domain_field_len_exceeded,
          { "Remaining length in the domain name field exceeded", "dhcpv6_domain_field_len_exceeded", FT_UINT8, BASE_DEC,
            NULL, 0, NULL, HFILL }},
        { &hf_dhcpv6_decoded_portion,
          { "Portion successfully decoded", "dhcpv6_decoded_portion", FT_STRING, STR_ASCII, NULL, 0, NULL, HFILL}},
        { &hf_dhcpv6_encoded_fqdn_len_gt_255,
          { "DNS-encoded labels of FQDN exceed 255 octets", "dhcpv6_encoded_fqdn_gt_255", FT_UINT16, BASE_DEC, NULL, 0,
            "Encoded length is greater than 255 [RFC 1035 3.1.]", HFILL}},
        { &hf_dhcpv6_root_only_domain_name,
          { "Root only domain name", "dhcpv6_root_only_domain_name", FT_STRING, BASE_NONE, NULL, 0,
            "The root domain cannot be resolved", HFILL}},
        { &hf_dhcpv6_tld,
          { "Top Level Domain name", "dhcpv6_tld", FT_STRING, STR_ASCII, NULL, 0,
            "Likely to fail because most TLDs do not have an IP address", HFILL}},
        { &hf_dhcpv6_partial_name_preceded_by_fqdn,
          { "Partial name preceded by FQDN", "dhcpv6_partial_name_preceded_by_fqdn", FT_STRING, STR_ASCII, NULL, 0,
            "Partial domain names must be the only name in the domain field", HFILL}},

        { &hf_remoteid_enterprise,
          { "Enterprise ID", "dhcpv6_remoteid_enterprise", FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0, "RemoteID Enterprise Number", HFILL }},
        { &hf_duid_bytes,
          { "DUID", "dhcpv6_duid_bytes", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_duid_type,
          { "DUID Type", "dhcpv6_duid_type", FT_UINT16, BASE_DEC, VALS(duidtype_vals), 0x0, NULL, HFILL}},
        { &hf_duidllt_time,
          { "DUID Time", "dhcpv6_duidllt_time", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL}},
        { &hf_duidllt_link_layer_addr,
          { "Link-layer address", "dhcpv6_duidllt_link_layer_addr", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_duidllt_hwtype,
          { "Hardware type", "dhcpv6_duidllt_hwtype", FT_UINT16, BASE_DEC, VALS(arp_hrd_vals), 0, "DUID LLT Hardware Type", HFILL }},
        { &hf_duidll_hwtype,
          { "Hardware type", "dhcpv6_duidll_hwtype", FT_UINT16, BASE_DEC, VALS(arp_hrd_vals), 0, "DUID LL Hardware Type", HFILL }},
        { &hf_duiden_enterprise,
          { "Enterprise ID", "dhcpv6_duiden_enterprise", FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0, "DUID EN Enterprise Number", HFILL }},
        { &hf_duiden_identifier,
          { "Identifier", "dhcpv6_duiden_identifier", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_duidll_link_layer_addr,
          { "Link-layer address", "dhcpv6_duidll_link_layer_addr", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_duiduuid_bytes,
          { "UUID", "dhcpv6_duiduuid_bytes", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_iaid,
          { "IAID", "dhcpv6_iaid", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_iaid_t1,
          { "T1", "dhcpv6_iaid_t1", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_iaid_t2,
          { "T2", "dhcpv6_iaid_t2", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_iata,
          { "IATA", "dhcpv6_iata", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_iaaddr_ip,
          { "IPv6 address", "dhcpv6_iaaddr_ip", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_iaaddr_pref_lifetime,
          { "Preferred lifetime", "dhcpv6_iaaddr_pref_lifetime", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_iaaddr_valid_lifetime,
          { "Valid lifetime", "dhcpv6_iaaddr_valid_lifetime", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_requested_option_code,
          { "Requested Option code", "dhcpv6_requested_option_code", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &opttype_vals_ext, 0, NULL, HFILL }},
        { &hf_option_preference,
          { "Pref-value", "dhcpv6_option_preference", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_elapsed_time,
          { "Elapsed time", "dhcpv6_elapsed_time", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_milliseconds, 0, NULL, HFILL}},
        { &hf_auth_protocol,
          { "Protocol", "dhcpv6_auth_protocol", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_auth_algorithm,
          { "Algorithm", "dhcpv6_auth_algorithm", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_auth_rdm,
          { "RDM", "dhcpv6_auth_rdm", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_auth_replay_detection,
          { "Replay Detection", "dhcpv6_auth_replay_detection", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_auth_info,
          { "Authentication Information", "dhcpv6_auth_info", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_auth_realm,
          { "DHCP realm", "dhcpv6_auth_realm", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_auth_key_id,
          {"Key ID", "dhcpv6_auth_key_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
        { &hf_auth_md5_data,
          {"HMAC-MD5 data", "dhcpv6_auth_md5_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_opt_unicast,
          { "IPv6 address", "dhcpv6_unicast", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_opt_status_code,
          { "Status Code", "dhcpv6_status_code", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &statuscode_vals_ext, 0, NULL, HFILL }},
        { &hf_opt_status_msg,
          { "Status Message", "dhcpv6_status_msg", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_vendorclass_enterprise,
          { "Enterprise ID", "dhcpv6_vendorclass_enterprise", FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0, "Vendor Class Enterprise Number", HFILL }},
        { &hf_vendorclass_data,
          { "vendor-class-data", "dhcpv6_vendorclass_data", FT_STRINGZ, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_vendoropts_enterprise,
          { "Enterprise ID", "dhcpv6_vendoropts_enterprise", FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0, "Vendor opts Enterprise Number", HFILL }},
        { &hf_vendoropts_enterprise_option_code,
          { "Option code", "dhcpv6_vendoropts_enterprise_option_code", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_vendoropts_enterprise_option_length,
          { "Option length", "dhcpv6_vendoropts_enterprise_option_length", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_vendoropts_enterprise_option_data,
          { "Option data", "dhcpv6_vendoropts_enterprise_option_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_interface_id,
          { "Interface-ID", "dhcpv6_interface_id", FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_reconf_msg,
          { "Reconfigure message type", "dhcpv6_reconf_msg", FT_UINT8, BASE_DEC | BASE_EXT_STRING, &msgtype_vals_ext, 0, NULL, HFILL }},
        { &hf_sip_server_domain_search_fqdn,
          { "SIP Server Domain Search FQDN", "dhcpv6_sip_server_domain_search_fqdn", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_sip_server_a,
          { "SIP server address", "dhcpv6_sip_server_a", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_dns_servers,
          { "DNS server address", "dhcpv6_dns_server", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_domain_search_list_entry,
          { "List entry", "dhcpv6_search_list_entry", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_nis_servers,
          { "NIS server address", "dhcpv6_nis_server", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_nisp_servers,
          { "NISP server address", "dhcpv6_nisp_server", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_nis_fqdn,
          { "NIS FQDN", "dhcpv6_nis_fqdn", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_nisp_fqdn,
          { "NISP FQDN", "dhcpv6_nisp_fqdn", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_sntp_servers,
          { "SNTP server address", "dhcpv6_sntp_server", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_opt_lifetime,
          { "Lifetime", "dhcpv6_lifetime", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_bcmcs_servers_fqdn,
          { "BCMCS server FQDN", "dhcpv6_bcmcs_server_fqdn", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_bcmcs_servers_a,
          { "BCMCS server address", "dhcpv6_bcmcs_server_a", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_remoteid_enterprise_id,
          { "Remote-ID", "dhcpv6_remoteid_enterprise_id", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_subscriber_id,
          { "Subscriber-ID", "dhcpv6_subscriber_id", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_client_fqdn,
          { "Client Domain Name", "dhcpv6_client_domain", FT_STRING, STR_ASCII, NULL, 0x0, NULL, HFILL } },
        { &hf_pana_agent,
          { "PANA agents address", "dhcpv6_pana_agent", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_opt_timezone,
          { "Time-zone", "dhcpv6_timezone", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_opt_tzdb,
          { "TZ-database", "dhcpv6_tzdb", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_lq_query,
          { "Query-type", "dhcpv6_lq_query", FT_UINT8, BASE_DEC, VALS(lq_query_vals), 0, NULL, HFILL }},
        { &hf_lq_query_link_address,
          { "Link address", "dhcpv6_lq_query_link_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_clt_time,
          { "Clt_time", "dhcpv6_clt_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_lq_relay_data_peer_addr,
          { "Peer address", "dhcpv6_lq_relay_data_peer_addr", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_lq_relay_data_msg,
          { "DHCPv6 relay message", "dhcpv6_lq_relay_data_msg", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_lq_client_link,
          { "LQ client links address", "dhcpv6_lq_client_link", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_capwap_ac_v6,
          { "CAPWAP Access Controllers address", "dhcpv6_capwap_ac_v6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_aftr_name,
          { "DS-Lite AFTR Name", "dhcpv6_aftr_name", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_iaprefix_pref_lifetime,
          { "Preferred lifetime", "dhcpv6_iaprefix_pref_lifetime", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_iaprefix_valid_lifetime,
          { "Valid lifetime", "dhcpv6_iaprefix_valid_lifetime", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL}},
        { &hf_iaprefix_pref_len,
          { "Prefix length", "dhcpv6_iaprefix_pref_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_iaprefix_pref_addr,
          { "Prefix address", "dhcpv6_iaprefix_pref_addr", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_mip6_ha,
          { "Home Agent", "dhcpv6_mip6_home_agent", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_mip6_hoa,
          { "Home Address", "dhcpv6_mip6_home_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_nai,
          { "NAI", "dhcpv6_nai", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_pd_exclude_pref_len,
          { "Prefix length", "dhcpv6_pd_exclude_pref_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_pd_exclude_subnet_id,
          { "IPv6 subnet ID", "dhcpv6_pd_exclude_subnet_id", FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_ntpserver_type,
          { "Suboption", "dhcpv6_ntpserver_option_type", FT_UINT16, BASE_DEC, VALS(ntp_server_opttype_vals), 0x0, NULL, HFILL}},
        { &hf_option_ntpserver_length,
          { "Length", "dhcpv6_ntpserver_option_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL}},
        { &hf_option_ntpserver_addr,
          { "NTP Server Address", "dhcpv6_ntpserver_addr", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_option_ntpserver_mc_addr,
          { "NTP Multicast Address", "dhcpv6_ntpserver_mc_addr", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_option_captive_portal,
          { "Captive Portal", "dhcpv6_captive_portal", FT_STRING, BASE_NONE, NULL, 0x0, "The contact URI for the captive portal that the user should connect to", HFILL }},
        { &hf_option_s46_option_code,
          { "S46 Option code", "dhcpv6_option_code", FT_UINT16, BASE_HEX, VALS(s46_opt_code_vals), 0x0, NULL, HFILL }},
        { &hf_option_failover_binding_status,
          { "Failover Binding Status", "dhcpv6_failover_binding_status", FT_UINT8, BASE_DEC, VALS(failover_binding_status_vals), 0x0, NULL, HFILL }},
        { &hf_option_failover_connect_flags,
          { "Flags", "dhcpv6_failover_connect_flags", FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_connect_reserved_flag,
          { "Reserved", "dhcpv6_failover_connect_flags_reserved", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0xfffe, NULL, HFILL }},
        { &hf_option_failover_connect_f_flag,
          { "Fixed PD Length (F)", "dhcpv6_failover_connect_flags_f", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0x0001, NULL, HFILL }},
        { &hf_option_failover_dns_hostname,
          { "DNS Hostname", "dhcpv6_failover_dns_hostname", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_dns_zonename,
          { "DNS Zone Name", "dhcpv6_failover_dns_zonename", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_dns_flags,
          { "Flags", "dhcpv6_failover_dns_flags", FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_dns_reserved_flag,
          { "Reserved", "dhcpv6_failover_dns_flags_reserved", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0xfff0, NULL, HFILL }},
        { &hf_option_failover_dns_u_flag,
          { "Using Requested FQDN (U)", "dhcpv6_failover_dns_flags_u", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0x0008, NULL, HFILL }},
        { &hf_option_failover_dns_s_flag,
          { "Synthesized Name (S)", "dhcpv6_failover_dns_flags_s", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0x0004, NULL, HFILL }},
        { &hf_option_failover_dns_r_flag,
          { "Rev Uptodate (R)", "dhcpv6_failover_dns_flags_r", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0x0002, NULL, HFILL }},
        { &hf_option_failover_dns_f_flag,
          { "Fwd Uptodate (F)", "dhcpv6_failover_dns_flags_f", FT_BOOLEAN, 16, TFS(&tfs_true_false), 0x0001, NULL, HFILL }},
        { &hf_option_failover_expiration_time,
          { "Expiration Time", "dhcpv6_failover_expiration_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_max_unacked_bndupd,
          { "Max number of unacked BNDUPD messages", "dhcpv6_failover_max_unacked_bndupd", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_mclt,
          { "Maximum Client Lead Time (MCLT)", "dhcpv6_failover_mclt", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_partner_lifetime,
          { "Partner Lifetime", "dhcpv6_failover_partner_lifetime", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_partner_lifetime_sent,
          { "Partner Lifetime Sent", "dhcpv6_failover_partner_lifetime_sent", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_partner_downtime,
          { "Partner Down Time", "dhcpv6_failover_partner_down_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_partner_raw_clt_time,
          { "Partner Raw Client Time", "dhcpv6_failover_partner_raw_clt_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_major_version,
          { "Protocol Major Version", "dhcpv6_failover_protocol_major_version", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_minor_version,
          { "Protocol Minor Version", "dhcpv6_failover_protocol_minor_version", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_keepalive_time,
          { "Keepalive Time", "dhcpv6_failover_keepalive_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_reconfigure_time,
          { "Reconfigure Time", "dhcpv6_failover_reconfigure_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_reconfigure_key,
          { "Reconfigure Key", "dhcpv6_failover_reconfigure_key", FT_BYTES, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_relationship_name,
          { "Relationship Name", "dhcpv6_failover_relationship_name", FT_STRING, STR_UNICODE, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_server_flags,
          { "Flags", "dhcpv6_failover_server_flags", FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_server_reserved_flag,
          { "Reserved", "dhcpv6_failover_server_flags_reserved", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0xf8, NULL, HFILL }},
        { &hf_option_failover_server_a_flag,
          { "Ack Startup (A)", "dhcpv6_failover_server_flags_a", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x04, NULL, HFILL }},
        { &hf_option_failover_server_s_flag,
          { "Startup (S)", "dhcpv6_failover_server_flags_s", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x02, NULL, HFILL }},
        { &hf_option_failover_server_c_flag,
          { "Communicated (C)", "dhcpv6_failover_server_flags_c", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x01, NULL, HFILL }},
        { &hf_option_failover_server_state,
          { "Server State", "dhcpv6_failover_server_state", FT_UINT8, BASE_DEC, VALS(failover_server_state_vals), 0, NULL, HFILL }},
        { &hf_option_failover_start_time_of_state,
          { "Start Time of State", "dhcpv6_failover_start_time_of_state", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_failover_state_expiration_time,
          { "State Expiration Time", "dhcpv6_failover_state_expiration_time", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_relay_port,
          { "Downstream Source Port", "dhcpv6_relay_port", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
        { &hf_option_ntpserver_fqdn,
          { "NTP Server FQDN", "dhcpv6_ntpserver_fqdn", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_packetcable_ccc_suboption,
          { "Sub element", "dhcpv6_packetcable_ccc_suboption", FT_UINT16, BASE_DEC, VALS(pkt_ccc_opt_vals), 0, NULL, HFILL }},
        { &hf_packetcable_ccc_pri_dhcp,
          { "Primary DHCP", "dhcpv6_packetcable_ccc_pri_dhcp", FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_ccc_sec_dhcp,
          { "Secondary DHCP", "dhcpv6_packetcable_ccc_sec_dhcp", FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_suboption,
          { "Sub element", "dhcpv6_packetcable_cccV6_suboption", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &pkt_cccV6_opt_vals_ext, 0, NULL, HFILL }},
        { &hf_modem_capabilities_encoding_type,
          { "Type", "dhcpv6_docsis_cccV6_tlv5_suboption", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &modem_capabilities_encoding_ext, 0, NULL, HFILL }},
        { &hf_eue_capabilities_encoding_type,
          { "Type", "dhcpv6_packetcable_cccV6_tlv5_suboption", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &eue_capabilities_encoding_ext, 0, NULL, HFILL }},
        { &hf_capabilities_encoding_length,
          { "Length", "dhcpv6_cccV6_tlv5_suboption_length", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_capabilities_encoding_bytes,
          { "Value", "dhcpv6_cccV6_tlv5_suboption_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
        { &hf_capabilities_encoding_number,
          { "Value", "dhcpv6_cccV6_tlv5_suboption_value_number", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_pri_dss,
          { "Primary SSID", "dhcpv6_packetcable_cccV6_pri_dss", FT_STRINGZ, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_sec_dss,
          { "Secondary SSID", "dhcpv6_packetcable_cccV6_sec_dss", FT_STRINGZ, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_prov_srv_type,
          { "Type", "dhcpv6_packetcable_cccV6_prov_srv_type", FT_UINT8, BASE_DEC, VALS(pkt_cccV6_prov_srv_type_vals), 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_prov_srv_fqdn,
          { "FQDN", "dhcpv6_packetcable_cccV6_prov_srv_fqdn", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_prov_srv_ipv6,
          { "IPv6 address", "dhcpv6_packetcable_cccV6_prov_srv_ipv6", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_as_krb_nominal_timeout,
          { "Nominal Timeout", "dhcpv6_packetcable_cccV6_as_krb_nominal_timeout", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_as_krb_max_timeout,
          { "Maximum Timeout", "dhcpv6_packetcable_cccV6_as_krb_max_timeout", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_as_krb_max_retry_count,
          { "Maximum Retry Count", "dhcpv6_packetcable_cccV6_as_krb_max_retry_count", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_ap_krb_nominal_timeout,
          { "Nominal Timeout", "dhcpv6_packetcable_cccV6_ap_krb_nominal_timeout", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_ap_krb_max_timeout,
          { "Maximum Timeout", "dhcpv6_packetcable_cccV6_ap_krb_max_timeout", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_ap_krb_max_retry_count,
          { "Maximum Retry Count", "dhcpv6_packetcable_cccV6_ap_krb_max_retry_count", FT_UINT32, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_krb_realm,
          { "KRB Realm", "dhcpv6_packetcable_cccV6_krb_realm", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_tgt_flag,
          { "TGT Flags", "dhcpv6_packetcable_cccV6_tgt_flag", FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_tgt_flag_fetch,
          { "Fetch TGT", "dhcpv6_packetcable_cccV6_tgt_flag_fetch", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x01, NULL, HFILL }},
        { &hf_packetcable_cccV6_prov_timer,
          { "Provisioning timer", "dhcpv6_packetcable_cccV6_prov_timer", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_sec_tcm,
          { "SEC TCM Flags", "dhcpv6_packetcable_cccV6_sec_tcm", FT_UINT16, BASE_HEX, NULL, 0, NULL, HFILL }},
        { &hf_packetcable_cccV6_sec_tcm_provisioning_server,
          { "Provisioning Server", "dhcpv6_packetcable_cccV6_sec_tcm_provisioning_server", FT_BOOLEAN, 16, TFS(&tfs_on_off), 0x01, NULL, HFILL }},
        { &hf_packetcable_cccV6_sec_tcm_call_manager_server,
          { "Call Manager Servers", "dhcpv6_packetcable_cccV6_tgt_flag_call_manager_server", FT_BOOLEAN, 16, TFS(&tfs_on_off), 0x02, NULL, HFILL }},
        { &hf_cablelabs_opts,
          { "Suboption", "dhcpv6_cablelabs_opt", FT_UINT16, BASE_DEC | BASE_EXT_STRING, &cl_vendor_subopt_values_ext, 0, NULL, HFILL }},
        { &hf_cablelabs_ipv6_server,
          { "IPv6 address", "dhcpv6_cablelabs_ipv6_server", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL}},
        { &hf_cablelabs_docsis_version_number,
          { "DOCSIS Version Number", "dhcpv6_cablelabs_docsis_version_number", FT_UINT16, BASE_CUSTOM, CF_FUNC(cablelabs_fmt_docsis_version), 0x0, NULL, HFILL}},
        { &hf_cablelabs_interface_id,
          { "Interface-ID", "dhcpv6_cablelabs_interface_id", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_cablelabs_interface_id_link_address,
          { "Link Address", "dhcpv6_cablelabs_interface_id_link_address", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_rule_flags,
          { "Flags", "dhcpv6_s46_rule_flags", FT_UINT8, BASE_HEX, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_rule_reserved_flag,
          { "Reserved", "dhcpv6_s46_rule_flags_reserved", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0xfe, NULL, HFILL }},
        { &hf_option_s46_rule_fmr_flag,
          { "Forwarding Mapping Rule", "dhcpv6_s46_rule_flags_fmr", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x01, NULL, HFILL }},
        { &hf_option_s46_rule_ea_len,
          { "EA-bit length", "dhcpv6_s46_rule_ea_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_rule_ipv4_pref_len,
          { "IPv4 prefix length", "dhcpv6_s46_rule_ipv4_pref_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_rule_ipv4_prefix,
          { "IPv4 prefix", "dhcpv6_s46_rule_ipv4_prefix", FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_rule_ipv6_pref_len,
          { "IPv6 prefix length", "dhcpv6_s46_rule_ipv6_prefix_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_rule_ipv6_prefix,
          { "IPv6 prefix", "dhcpv6_s46_rule_ipv6_prefix", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_br_address,
          { "BR address", "dhcpv6_s46_br_address", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_dmr_pref_len,
          { "IPv6 prefix length", "dhcpv6_s46_dmr_dmr_pref_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_dmr_prefix,
          { "IPv6 prefix", "dhcpv6_s46_dmr_dmr_prefix", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_v4v6bind_ipv4_address,
          { "IPv4 Address", "dhcpv6_s46_v4v6bind_ipv4_address", FT_IPv4, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_v4v6bind_ipv6_pref_len,
          { "IPv6 prefix length", "dhcpv6_s46_v4v6bind_ipv6_pref_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_v4v6bind_ipv6_prefix,
          { "IPv6 prefix", "dhcpv6_s46_v4v6bind_ipv6_prefix", FT_IPv6, BASE_NONE, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_portparam_offset,
          { "Offset", "dhcpv6_s46_portparam_offset", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_portparam_psid_len,
          { "PSID length", "dhcpv6_s46_portparam_psid_len", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_option_s46_portparam_psid,
          { "PSID", "dhcpv6_s46_portparam_psid", FT_UINT16, BASE_DEC, NULL, 0, NULL, HFILL }},
        { &hf_opt_mudurl,
          { "MUDURL", "dhcpv6_mudurl", FT_STRING, BASE_NONE, NULL, 0, NULL, HFILL }}
    };
