...
void proto_register_idn(void) {
	static hf_register_info hf[] = {
		...
		{ &idn_sequence,
			{ "Sequence counter", "idn_sequence",
			FT_UINT16, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_total_size,
			{ "Total Size", "idn_total_size",
			FT_UINT16, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_struct_size,
			{ "Struct Size", "idn_struct_size",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_protocol_version,
			{ "Protocol Version", "idn_protocol_version",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_protocol_version_major,
			{ "Major", "idn_protocol_version_major",
			FT_UINT8, BASE_DEC,
			NULL, 0xF0,
			NULL, HFILL }
		},
		{ &idn_protocol_version_minor,
			{ "Minor", "idn_idn_protocol_version_minor",
			FT_UINT8, BASE_DEC,
			NULL, 0x0F,
			NULL, HFILL }
		},
		...
		{ &idn_entry_size,
			{ "Entry Size", "idn_entry_size",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_relay_count,
			{ "Relay Count", "idn_relay_count",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_service_count,
			{ "Service Count", "idn_service_count",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_cnl,
			{ "Channel configuration and routing information (CNL)", "idn_cnl",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_most_significant_bit_cnl,
			{ "Most significant bit (always 1)", "idn_most_significant_bit_cnl",
			FT_UINT8, BASE_DEC,
			NULL, 0x80,
			NULL, HFILL }
		},
		{ &idn_cclf,
			{ "Channel Configuration and Last Fragment bit (CCLF)", "idn_cclf",
			FT_UINT8, BASE_DEC,
			NULL, 0x40,
			NULL, HFILL }
		},
		{ &idn_channel_id,
			{ "Channel ID (opened Channels)", "idn_channel_id",
			FT_UINT8, BASE_DEC,
			NULL, 0x3F,
			NULL, HFILL }
		},
		{ &idn_chunk_type,
			{ "Chunk Type", "idn_chunk_type",
			FT_UINT8, BASE_HEX,
			VALS(chunk_type), 0x0,
			NULL, HFILL }
		},
		{ &idn_timestamp,
			{ "Timestamp", "idn_timestamp",
			FT_UINT32, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_scwc,
			{ "Service Configuration Word Count (SCWC)", "idn_scwc",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_cfl,
			{ "Channel and service configuration Flags (CFL)", "idn_cfl",
			FT_UINT8, BASE_HEX,
			VALS(cfl_string), 0x0,
			NULL, HFILL }
		},
		{ &idn_sdm,
			{ "Service Data Match (SDM)", "idn_sdm",
			FT_UINT8, BASE_DEC,
			NULL, 0x30,
			NULL, HFILL }
		},
		...
		{ &idn_service_id,
			{ "Service ID", "idn_service_id",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_relay_number,
			{ "Relay Number", "idn_relay_number",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_service_mode,
			{ "Service Mode", "idn_service_mode",
			FT_UINT8, BASE_HEX,
			VALS(service_mode_string), 0x0,
			NULL, HFILL }
		},
		{ &idn_chunk_header_flags,
			{ "Chunk Header Flags", "idn_chunk_header_flags",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_two_bits_reserved_1,
			{ "Reserved", "idn_zero_zero",
			FT_UINT8, BASE_DEC,
			NULL, 0xC0,
			NULL, HFILL }
		},
		...
		{ &idn_scm,
			{ "Service configuration match (SCM)", "idn_scm",
			FT_UINT8, BASE_DEC,
			NULL, 0x30,
			NULL, HFILL }
		},
		{ &idn_three_bits_reserved,
			{ "Reserved", "idn_three_bit_reserved",
			FT_UINT8, BASE_DEC,
			NULL, 0xE,
			NULL, HFILL }
		},
		...
		{ &idn_dlim,
			{ "Delimiter (DLIM)", "idn_dlim",
			FT_UINT8, BASE_DEC,
			NULL, 0x1,
			NULL, HFILL }
		},
		{ &idn_duration,
			{ "Duration", "idn_frame_sample_duration",
			FT_UINT24, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_chunk_data_sequence,
			{ "Sequence", "idn_octet_segment_sequence",
			FT_UINT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_offset,
			{ "Offset", "idn_octet_segment_sequence",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_reserved,
			{ "Reserved", "idn_reserved",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		...
		{ &idn_boundary,
			{ "Void (32-bit boundary)", "idn_gts_boundary",
			FT_UINT32, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_gts_word,
			{ "16-bit word", "idn_gts_word",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		...
		{ &idn_gts_space_modifier,
			{ "Space Modifier", "idn_gts_space_modifier",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		...
		{ &idn_gts_category,
			{ "Category", "idn_gts_category",
			FT_UINT16, BASE_DEC,
			NULL, 0xF000,
			NULL, HFILL }
		},
		{ &idn_gts_subcategory,
			{ "Subcategory", "idn_gts_subcategory",
			FT_UINT16, BASE_DEC,
			NULL, 0xF00,
			NULL, HFILL }
		},
		{ &idn_gts_identifier,
			{ "Identifier", "idn_gts_identifier",
			FT_UINT16, BASE_DEC,
			NULL, 0xF0,
			NULL, HFILL }
		},
		{ &idn_gts_parameter,
			{ "Parameter", "idn_gts_parameter",
			FT_UINT16, BASE_DEC,
			NULL, 0xF,
			NULL, HFILL }
		},
		{ &idn_gts_glin,
			{ "Graphic Space Linearity (GLIN)", "idn_gts_glin",
			FT_UINT16, BASE_DEC,
			VALS(gts_glin), 0xC0,
			NULL, HFILL }
		},
		{ &idn_gts_clin,
			{ "Color Space Linearity (CLIN)", "idn_gts_clin",
			FT_UINT16, BASE_DEC,
			VALS(gts_clin), 0x30,
			NULL, HFILL }
		},
		{ &idn_gts_cbal,
			{ "Color Balance (CBAL)", "idn_gts_cbal",
			FT_UINT16, BASE_DEC,
			VALS(gts_cbal), 0xC,
			NULL, HFILL }
		},
		{ &idn_gts_ctim,
			{ "Color Timing (CTIM)", "idn_gts_ctim",
			FT_UINT16, BASE_DEC,
			VALS(gts_ctim), 0x3,
			NULL, HFILL }
		},
		{ &idn_gts_nop,
			{ "No Operation (NOP)", "idn_gts_nop",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_gts_precision,
			{ "Precision", "idn_gts_precision",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_gts_cscl,
			{ "Color scale (CSCL)", "idn_gts_cscl",
			FT_UINT16, BASE_DEC,
			NULL, 0xC0,
			NULL, HFILL }
		},
		{ &idn_gts_iscl,
			{ "Intensity scale (ISCL)", "idn_gts_iscl",
			FT_UINT16, BASE_DEC,
			NULL, 0x30,
			NULL, HFILL }
		},
		{ &idn_gts_sht,
			{ "Shutter (SHT)", "idn_gts_sht",
			FT_UINT16, BASE_DEC,
			NULL, 0xF,
			NULL, HFILL }
		},
		{ &idn_gts_u4,
			{ "Optional(U4), used as X-prime", "idn_gts_u4",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		...
		{ &idn_gts_wavelength_prefix,
			{ "Wavelength Prefix", "idn_gts_wavelength_prefix",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_gts_intensity,
			{ "Intensity/blanking", "idn_gts_intensity",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_gts_beam_brush,
			{ "Beam-Brush", "idn_gts_beam_brush",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_gts_sample,
			{ "Sample", "idn_gts_sample",
			FT_INT8, BASE_DEC,
			NULL, 0x0,
			NULL, HFILL }
		},
		...
		{ &idn_dmx_identifier,
			{ "Identifier", "idn_gts_dmx_identifier",
			FT_UINT8, BASE_DEC,
			NULL, 0xF0,
			NULL, HFILL }
		},
		{ &idn_dmx_parameter,
			{ "Parameter", "idn_gts_dmx_parameter",
			FT_UINT8, BASE_DEC,
			NULL, 0xF,
			NULL, HFILL }
		},
		{ &idn_dmx_void,
			{ "Void", "idn_gts_dmx_void",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_octet,
			{ "Octet", "idn_gts_dmx_octet",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_dmx_dls,
			{ "Dimmer Level Subset", "idn_dmx_dls",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		...
		{ &idn_dmx_unknown,
			{ "Unknown", "idn_dmx_unknown",
			FT_UINT8, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		},
		{ &idn_result_code,
			{ "Result Code", "idn_result_code",
			FT_UINT8, BASE_DEC,
			VALS(result_code), 0x0,
			NULL, HFILL }
		},
		{ &idn_event_flags,
			{ "Event Flags", "idn_event_flags",
			FT_UINT16, BASE_HEX,
			NULL, 0x0,
			NULL, HFILL }
		}
