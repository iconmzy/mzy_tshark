...
proto_register_netbios(void)
{
	...
	static hf_register_info hf_netb[] = {
		{ &hf_netb_cmd,
		  { "Command", "netbios_command", FT_UINT8, BASE_HEX | BASE_EXT_STRING,
		    &cmd_vals_ext, 0x0, NULL, HFILL }},

		{ &hf_netb_hdr_len,
		  { "Length", "netbios_hdr_len", FT_UINT16, BASE_DEC,
		    NULL, 0x0, "Header Length", HFILL }},

		{ &hf_netb_delimiter,
		  { "Delimiter", "netbios_delimiter", FT_UINT16, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_xmit_corrl,
		  { "Transmit Correlator", "netbios_xmit_corrl", FT_UINT16, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_resp_corrl,
		  { "Response Correlator", "netbios_resp_corrl", FT_UINT16, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_call_name_type,
		  { "Caller's Name Type", "netbios_call_name_type", FT_UINT8, BASE_HEX,
		    VALS(name_types), 0x0, NULL, HFILL }},

		{ &hf_netb_nb_name_type,
		  { "NetBIOS Name Type", "netbios_nb_name_type", FT_UINT8, BASE_HEX |BASE_EXT_STRING,
		    &nb_name_type_vals_ext, 0x0, NULL, HFILL }},

		{ &hf_netb_nb_name,
		  { "NetBIOS Name", "netbios_nb_name", FT_STRING, BASE_NONE,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_version,
		  { "NetBIOS Version", "netbios_version", FT_BOOLEAN,  8,
		    TFS( &netb_version_str), 0x01, NULL, HFILL }},

		{ &hf_netbios_no_receive_flags,
		  { "Flags", "netbios_no_receive_flags", FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_netbios_no_receive_flags_send_no_ack,
		  { "SEND.NO.ACK data received", "netbios_no_receive_flags_send_no_ack", FT_BOOLEAN,  8,
		    TFS( &tfs_no_yes), 0x02, NULL, HFILL }},

		{ &hf_netb_largest_frame,
		  { "Largest Frame", "netbios_largest_frame", FT_UINT8, BASE_DEC,
		    VALS(max_frame_size_vals), 0x0E, NULL, HFILL }},

		{ &hf_netb_status_buffer_len,
		  { "Length of status buffer", "netbios_status_buffer_len", FT_UINT16, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_status,
		  { "Status", "netbios_status", FT_UINT8, BASE_DEC,
		    VALS(status_vals), 0x0, NULL, HFILL }},

		{ &hf_netb_name_type,
		  { "Name type", "netbios_name_type", FT_UINT16, BASE_DEC,
		    VALS(name_types), 0x0, NULL, HFILL }},

		{ &hf_netb_max_data_recv_size,
		  { "Maximum data receive size", "netbios_max_data_recv_size", FT_UINT16, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_termination_indicator,
		  { "Termination indicator", "netbios_termination_indicator", FT_UINT16, BASE_HEX,
		    VALS(termination_indicator_vals), 0x0, NULL, HFILL }},

		{ &hf_netb_num_data_bytes_accepted,
		  { "Number of data bytes accepted", "netbios_num_data_bytes_accepted", FT_UINT16, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_local_ses_no,
		  { "Local Session No.", "netbios_local_session", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_remote_ses_no,
		  { "Remote Session No.", "netbios_remote_session", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_flags,
		  { "Flags", "netbios_flags", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_flags_send_no_ack,
		  { "Handle SEND.NO.ACK", "netbios_flags_send_no_ack", FT_BOOLEAN,  8,
		    TFS( &tfs_yes_no), 0x80, NULL, HFILL }},

		{ &hf_netb_flags_ack,
		  { "Acknowledge", "netbios_flags_ack", FT_BOOLEAN, 8,
		    TFS( &tfs_set_notset), 0x08, NULL, HFILL }},

		{ &hf_netb_flags_ack_with_data,
		  { "Acknowledge with data", "netbios_flags_ack_with_data", FT_BOOLEAN, 8,
		    TFS( &tfs_allowed_not_allowed), 0x04, NULL, HFILL }},

		{ &hf_netb_flags_ack_expected,
		  { "Acknowledge expected", "netbios_flags_ack_expected", FT_BOOLEAN,  8,
		    TFS( &tfs_yes_no), 0x02, NULL, HFILL }},

		{ &hf_netb_flags_recv_cont_req,
		  { "RECEIVE_CONTINUE requested", "netbios_flags_recv_cont_req", FT_BOOLEAN,  8,
		    TFS( &tfs_yes_no), 0x01, NULL, HFILL }},

		{ &hf_netb_data2,
		  { "DATA2 value", "netbios_data2", FT_UINT16, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_data2_frame,
		  { "Data length exceeds maximum frame size", "netbios_data2_frame", FT_BOOLEAN, 16,
		    TFS(&tfs_yes_no), 0x8000, NULL, HFILL }},

		{ &hf_netb_data2_user,
		  { "Data length exceeds user's buffer", "netbios_data2_user", FT_BOOLEAN, 16,
		    TFS(&tfs_yes_no), 0x4000, NULL, HFILL }},

		{ &hf_netb_data2_status,
		  { "Status data length", "netbios_data2_status", FT_UINT16, BASE_DEC,
		    NULL, 0x3FFF, NULL, HFILL }},

		{ &hf_netb_datagram_mac,
		  { "Sender's MAC Address", "netbios_datagram_mac", FT_ETHER, BASE_NONE,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_datagram_bcast_mac,
		  { "Sender's Node Address",	"netbios_datagram_bcast_mac", FT_ETHER, BASE_NONE,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_resync_indicator,
		  { "Re-sync indicator", "netbios_resync_indicator", FT_UINT16, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_status_request,
		  { "Status request", "netbios_status_request", FT_UINT8, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_local_session_no,
		  { "Local Session No.", "netbios_local_session_no", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_state_of_name,
		  { "State of name", "netbios_state_of_name", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_status_response,
		  { "Status response", "netbios_status_response", FT_UINT8, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_fragment_overlap,
		  { "Fragment overlap",	"netbios_fragment_overlap", FT_BOOLEAN, BASE_NONE,
		    NULL, 0x0, "Fragment overlaps with other fragments", HFILL }},

		{ &hf_netb_fragment_overlap_conflict,
		  { "Conflicting data in fragment overlap", "netbios_fragment_overlap_conflict",
		    FT_BOOLEAN, BASE_NONE,
		    NULL, 0x0, "Overlapping fragments contained conflicting data", HFILL }},

		{ &hf_netb_fragment_multiple_tails,
		  { "Multiple tail fragments found", "netbios_fragment_multipletails",
		    FT_BOOLEAN, BASE_NONE,
		    NULL, 0x0, "Several tails were found when defragmenting the packet", HFILL }},

		{ &hf_netb_fragment_too_long_fragment,
		  { "Fragment too long",	"netbios_fragment_toolongfragment", FT_BOOLEAN, BASE_NONE,
		    NULL, 0x0, "Fragment contained data past end of packet", HFILL }},

		{ &hf_netb_fragment_error,
		  { "Defragmentation error",	"netbios_fragment_error", FT_FRAMENUM, BASE_NONE,
		    NULL, 0x0, "Defragmentation error due to illegal fragments", HFILL }},

		{ &hf_netb_fragment_count,
		  { "Fragment count",	"netbios_fragment_count", FT_UINT32, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_fragment,
		  { "NetBIOS Fragment",		"netbios_fragment", FT_FRAMENUM, BASE_NONE,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_fragments,
		  { "NetBIOS Fragments",	"netbios_fragments", FT_NONE, BASE_NONE,
		    NULL, 0x0, NULL, HFILL }},

		{ &hf_netb_reassembled_length,
		  {"Reassembled NetBIOS length",	"netbios_reassembled_length", FT_UINT32, BASE_DEC,
