...
proto_register_isi(void)
{
	static hf_register_info hf[] = {
		{ &hf_isi_rdev,
		  { "Receiver Device", "isi_rdev", FT_UINT8, BASE_HEX,
		    VALS(hf_isi_device), 0x0, NULL, HFILL }},
		{ &hf_isi_sdev,
		  { "Sender Device", "isi_sdev", FT_UINT8, BASE_HEX,
		    VALS(hf_isi_device), 0x0, NULL, HFILL }},
		{ &hf_isi_res,
		  { "Resource", "isi_res", FT_UINT8, BASE_HEX,
		    VALS(hf_isi_resource), 0x0, NULL, HFILL }},
		{ &hf_isi_len,
		  { "Length", "isi_len", FT_UINT16, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_robj,
		  { "Receiver Object", "isi_robj", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sobj,
		  { "Sender Object", "isi_sobj", FT_UINT8, BASE_HEX,
		    NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_id,
		  { "Packet ID", "isi_id", FT_UINT8, BASE_DEC,
		    NULL, 0x0, NULL, HFILL }}
    };

	static hf_register_info simauth_hf[] = {
		{ &hf_isi_sim_auth_payload,
		  { "Payload", "isi_sim_auth_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_cmd,
		  { "Command", "isi_sim_auth_cmd", FT_UINT8, BASE_HEX, VALS(isi_sim_auth_id), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_pw_type,
		  { "Password Type", "isi_sim_auth_type", FT_UINT8, BASE_HEX, VALS(isi_sim_auth_pw_type), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_pin,
		  { "PIN", "isi_sim_auth_pin", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_puk,
		  { "PUK", "isi_sim_auth_puk", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_new_pin,
		  { "New PIN", "isi_sim_auth_new_pin", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_protection_req,
		  { "Protection Request", "isi_sim_auth_request_protection", FT_UINT8, BASE_HEX, VALS(isi_sim_auth_protection_req), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_protection_rsp,
		  { "Protection Response", "isi_sim_auth_response_protection", FT_BOOLEAN, BASE_HEX, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_status_rsp,
		  { "Status Response", "isi_sim_auth_response_status", FT_UINT8, BASE_HEX, VALS(isi_sim_auth_resp), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_indication,
		  { "Indication", "isi_sim_auth_indication", FT_UINT8, BASE_HEX, VALS(isi_sim_auth_indication), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_auth_indication_cfg,
		  { "Configuration", "isi_sim_auth_cfg", FT_UINT8, BASE_HEX, VALS(isi_sim_auth_indication_cfg), 0x0, NULL, HFILL }}
	};

	static hf_register_info sim_hf[] = {
		{ &hf_isi_sim_payload,
		  { "Payload", "isi_sim_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_message_id,
		  { "Message ID", "isi_sim_msg_id", FT_UINT8, BASE_HEX, VALS(isi_sim_message_id), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_service_type,
		  { "Service Type", "isi_sim_service_type", FT_UINT8, BASE_HEX, VALS(isi_sim_service_type), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_cause,
		  { "Cause", "isi_sim_cause", FT_UINT8, BASE_HEX|BASE_EXT_STRING, &isi_sim_cause_ext, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_secondary_cause,
		  { "Secondary Cause", "isi_sim_secondary_cause", FT_UINT8, BASE_HEX|BASE_EXT_STRING, &isi_sim_cause_ext, 0x0, NULL, HFILL }},
		{&hf_isi_sim_subblock_count,
		  { "Subblock Count", "isi_sim_subblock_count", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{&hf_isi_sim_subblock_size,
		  { "Subblock Size", "isi_sim_subblock_size", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_pb_subblock,
		  { "Subblock", "isi_sim_pb_subblock", FT_UINT8, BASE_HEX, VALS(isi_sim_pb_subblock), 0x0, NULL, HFILL }},
		{ &hf_isi_sim_pb_type,
		  { "Phonebook Type", "isi_sim_pb_type", FT_UINT8, BASE_HEX, VALS(isi_sim_pb_type), 0x0, NULL, HFILL }},
		{&hf_isi_sim_pb_location,
		  { "Phonebook Location", "isi_sim_pb_location", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{&hf_isi_sim_pb_tag_count,
		  { "Tag Count", "isi_sim_pb_tag_count", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sim_pb_tag,
		  { "Phonebook Item Type", "isi_sim_pb_tag", FT_UINT8, BASE_HEX, VALS(isi_sim_pb_tag), 0x0, NULL, HFILL }},
		/* {&hf_isi_sim_imsi_byte_1,
		  { "IMSI Byte 1", "isi_sim_imsi_byte1", FT_UINT16, BASE_HEX, NULL, 0xF0, NULL, HFILL }},*/
		{&hf_isi_sim_imsi_length,
		  { "IMSI Length", "isi_sim_imsi_length", FT_UINT8, BASE_DEC, NULL, 0, NULL, HFILL }},
	};

	static hf_register_info gps_hf[] = {
		{ &hf_isi_gps_payload,
		  { "Payload", "isi_gps_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_cmd,
		  { "Command", "isi_gps_cmd", FT_UINT8, BASE_HEX, VALS(isi_gps_id), 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sub_pkgs,
		  { "Number of Subpackets", "isi_gps_pkgs", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sub_type,
		  { "Subpacket Type", "isi_gps_sub_type", FT_UINT8, BASE_HEX, VALS(isi_gps_sub_id), 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sub_len,
		  { "Subpacket Length", "isi_gps_sub_len", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_status,
		  { "Status", "isi_gps_status", FT_UINT8, BASE_HEX, VALS(isi_gps_status), 0x0, NULL, HFILL }},
		{ &hf_isi_gps_year,
		  { "Year", "isi_gps_date_year", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_month,
		  { "Month", "isi_gps_date_month", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_day,
		  { "Day", "isi_gps_date_day", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_hour,
		  { "Hour", "isi_gps_time_hour", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_minute,
		  { "Minute", "isi_gps_time_minute", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_second,
		  { "Second", "isi_gps_time_second", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_latitude,
		  { "Latitude", "isi_gps_lat", FT_DOUBLE, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_longitude,
		  { "Longitude", "isi_gps_lon", FT_DOUBLE, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_eph,
		  { "Position Accuracy", "isi_gps_eph", FT_FLOAT, BASE_NONE, NULL, 0x0, "EPH (position accuracy) in meter", HFILL }},
		{ &hf_isi_gps_altitude,
		  { "Altitude", "isi_gps_alt", FT_INT16, BASE_DEC, NULL, 0x0, "Altitude in meter", HFILL }},
		{ &hf_isi_gps_epv,
		  { "Altitude Accuracy", "isi_gps_epv", FT_FLOAT, BASE_NONE, NULL, 0x0, "EPV (altitude accuracy) in meter", HFILL }},
		{ &hf_isi_gps_course,
		  { "Course", "isi_gps_course", FT_FLOAT, BASE_NONE, NULL, 0x0, "Course in degree", HFILL }},
		{ &hf_isi_gps_epd,
		  { "Course Accuracy", "isi_gps_epd", FT_FLOAT, BASE_NONE, NULL, 0x0, "EPD (course accuracy) in degree", HFILL }},
		{ &hf_isi_gps_speed,
		  { "Speed", "isi_gps_speed", FT_FLOAT, BASE_NONE, NULL, 0x0, "Speed in km/h", HFILL }},
		{ &hf_isi_gps_eps,
		  { "Speed Accuracy", "isi_gps_eps", FT_FLOAT, BASE_NONE, NULL, 0x0, "EPS (speed accuracy) in km/h", HFILL }},
		{ &hf_isi_gps_climb,
		  { "Climb", "isi_gps_climb", FT_FLOAT, BASE_NONE, NULL, 0x0, "Climb in km/h", HFILL }},
		{ &hf_isi_gps_satellites,
		  { "Visible Satellites", "isi_gps_satellites", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_prn,
		  { "Pseudorandom Noise (PRN)", "isi_gps_sat_prn", FT_UINT8, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sat_used,
		  { "in use", "isi_gps_sat_used", FT_BOOLEAN, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sat_strength,
		  { "Signal Strength", "isi_gps_sat_strength", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sat_elevation,
		  { "Elevation", "isi_gps_sat_elevation", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_sat_azimuth,
		  { "Azimuth", "isi_gps_sat_azimuth", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_epc,
		  { "Climb Accuracy", "isi_gps_epc", FT_FLOAT, BASE_NONE, NULL, 0x0, "EPC (climb accuracy) in km/h", HFILL }},
		{ &hf_isi_gps_mcc,
		  { "Mobile Country Code (MCC)", "isi_gps_gsm_mcc", FT_UINT16, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_mnc,
		  { "Mobile Network Code (MNC)", "isi_gps_gsm_mnc", FT_UINT16, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_lac,
		  { "Location Area Code (LAC)", "isi_gps_gsm_lac", FT_UINT16, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_cid,
		  { "Cell ID (CID)", "isi_gps_gsm_cid", FT_UINT16, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gps_ucid,
		  { "Cell ID (UCID)", "isi_gps_gsm_ucid", FT_UINT32, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }}
	};

	static hf_register_info gss_hf[] = {
		{ &hf_isi_gss_payload,
		  { "Payload", "isi_gss_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gss_message_id,
		  { "Message ID", "isi_gss_msg_id", FT_UINT8, BASE_HEX, VALS(isi_gss_message_id), 0x0, NULL, HFILL }},
#if 0
		{ &hf_isi_gss_subblock,
		  { "Subblock", "isi_gss_subblock", FT_UINT8, BASE_HEX, VALS(isi_gss_subblock), 0x0, NULL, HFILL }},
#endif
		{ &hf_isi_gss_operation,
		  { "Operation", "isi_gss_operation", FT_UINT8, BASE_HEX, VALS(isi_gss_operation), 0x0, NULL, HFILL }},
		{ &hf_isi_gss_subblock_count,
		  { "Subblock Count", "isi_gss_subblock_count", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_gss_cause,
		  { "Cause", "isi_gss_cause", FT_UINT8, BASE_HEX, VALS(isi_gss_cause), 0x0, NULL, HFILL }},
		{ &hf_isi_gss_common_message_id,
		  { "Common Message ID", "isi_gss_common_msg_id", FT_UINT8, BASE_HEX, VALS(isi_gss_common_message_id), 0x0, NULL, HFILL }},
	};

	static hf_register_info ss_hf[] = {
		{ &hf_isi_ss_payload,
		  { "Payload", "isi_ss_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_ss_message_id,
		  { "Message ID", "isi_ss_msg_id", FT_UINT8, BASE_HEX, VALS(isi_ss_message_id), 0x0, NULL, HFILL }},
		{ &hf_isi_ss_ussd_type,
		  { "USSD Type", "isi_ss_ussd_type", FT_UINT8, BASE_HEX, VALS(isi_ss_ussd_type), 0x0, NULL, HFILL }},
		{ &hf_isi_ss_subblock_count,
		  { "Subblock Count", "isi_ss_subblock_count", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_ss_subblock,
		  { "Subblock", "isi_ss_subblock", FT_UINT8, BASE_HEX, VALS(isi_ss_subblock), 0x0, NULL, HFILL }},
		{ &hf_isi_ss_operation,
		  { "Operation", "isi_ss_operation", FT_UINT8, BASE_HEX, VALS(isi_ss_operation), 0x0, NULL, HFILL }},
		{ &hf_isi_ss_service_code,
		  { "Service Code", "isi_ss_service_code", FT_UINT8, BASE_HEX, VALS(isi_ss_service_code), 0x0, NULL, HFILL }},
		{ &hf_isi_ss_status_indication,
		  { "Status Indication", "isi_ss_status_indication", FT_UINT8, BASE_HEX, VALS(isi_ss_status_indication), 0x0, NULL, HFILL }},
		{ &hf_isi_ss_ussd_length,
		  { "Length", "isi_ss_ussd_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_ss_common_message_id,
		  { "Common Message ID", "isi_ss_common_msg_id", FT_UINT8, BASE_HEX, VALS(isi_ss_common_message_id), 0x0, NULL, HFILL }},
	};

	static hf_register_info network_hf[] = {
		{ &hf_isi_network_payload,
		  { "Payload", "isi_network_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_cmd,
		  { "Command", "isi_network_cmd", FT_UINT8, BASE_HEX, VALS(isi_network_id), 0x0, NULL, HFILL }},
		{ &hf_isi_network_data_sub_pkgs,
		  { "Number of Subpackets", "isi_network_pkgs", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_status_sub_type,
		  { "Subpacket Type", "isi_network_sub_type", FT_UINT8, BASE_HEX, VALS(isi_network_status_sub_id), 0x0, NULL, HFILL }},
		{ &hf_isi_network_status_sub_len,
		  { "Subpacket Length", "isi_network_sub_len", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_status_sub_lac,
		  { "Location Area Code (LAC)", "isi_network_sub_lac", FT_UINT16, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_status_sub_cid,
		  { "Cell ID (CID)", "isi_network_sub_cid", FT_UINT32, BASE_HEX_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_status_sub_msg_len,
		  { "Message Length", "isi_network_sub_msg_len", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_status_sub_msg,
		  { "Message", "isi_network_sub_msg", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_cell_info_sub_type,
		  { "Subpacket Type", "isi_network_sub_type", FT_UINT8, BASE_HEX, VALS(isi_network_cell_info_sub_id), 0x0, NULL, HFILL }},
		{ &hf_isi_network_cell_info_sub_len,
		  { "Subpacket Length", "isi_network_sub_len", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_cell_info_sub_operator,
		  { "Operator Code", "isi_network_sub_operator", FT_UINT24, BASE_HEX, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_network_gsm_band_900,
		  { "900 Mhz Band", "isi_network_sub_gsm_band_900", FT_BOOLEAN, 32, NULL, 0x00000001, NULL, HFILL }},
		{ &hf_isi_network_gsm_band_1800,
		  { "1800 Mhz Band", "isi_network_sub_gsm_band_1800", FT_BOOLEAN, 32, NULL, 0x00000002, NULL, HFILL }},
		{ &hf_isi_network_gsm_band_1900,
		  { "1900 Mhz Band", "isi_network_sub_gsm_band_1900", FT_BOOLEAN, 32, NULL, 0x00000004, NULL, HFILL }},
		{ &hf_isi_network_gsm_band_850,
		  { "850 Mhz Band", "isi_network_sub_gsm_band_850", FT_BOOLEAN, 32, NULL, 0x00000008, NULL, HFILL }}
	};

	static hf_register_info sms_hf[] = {
		{ &hf_isi_sms_payload,
		  { "Payload", "isi_sms_payload", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sms_message_id,
		  { "Message ID", "isi_sms_msg_id", FT_UINT8, BASE_HEX, VALS(isi_sms_message_id), 0x0, NULL, HFILL }},
		{ &hf_isi_sms_routing_command,
		  { "SMS Routing Command", "isi_sms_routing_command", FT_UINT8, BASE_HEX, VALS(isi_sms_routing_command), 0x0, NULL, HFILL }},
		{ &hf_isi_sms_routing_mode,
		  { "Routing Mode", "isi_sms_routing_mode", FT_UINT8, BASE_HEX, VALS(isi_sms_routing_mode), 0x0, NULL, HFILL }},
		{ &hf_isi_sms_route,
		  { "Message Route", "isi_sms_route", FT_UINT8, BASE_HEX, VALS(isi_sms_route), 0x0, NULL, HFILL }},
		{ &hf_isi_sms_subblock_count,
		  { "Subblock Count", "isi_sms_subblock_count", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
		{ &hf_isi_sms_send_status,
		  { "Sending Status", "isi_sms_sending_status", FT_UINT8, BASE_HEX, VALS(isi_sms_send_status), 0x0, NULL, HFILL }},
#if 0
		{ &hf_isi_sms_subblock,
		  { "Subblock", "isi_sms_subblock", FT_UINT8, BASE_HEX, VALS(isi_sms_subblock), 0x0, NULL, HFILL }},
#endif
		{ &hf_isi_sms_common_message_id,
		  { "Common Message ID", "isi_sms_common_msg_id", FT_UINT8, BASE_HEX, VALS(isi_sms_common_message_id), 0x0, NULL, HFILL }},
	};
