...
proto_register_bthci_acl(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_bthci_acl_continuation_to,
          { "This is a continuation to the PDU in frame",    "bthci_acl_continuation_to",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            "This is a continuation to the PDU in frame #", HFILL }
        },
        { &hf_bthci_acl_reassembled_in,
          { "This PDU is reassembled in frame",              "bthci_acl_reassembled_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            "This PDU is reassembled in frame #", HFILL }
        },
        { &hf_bthci_acl_connect_in,
            { "Connect in frame",                            "bthci_acl_connect_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_disconnect_in,
            { "Disconnect in frame",                         "bthci_acl_disconnect_in",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_src_bd_addr,
            { "Source BD_ADDR",                              "bthci_acl_src_bd_addr",
            FT_ETHER, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_src_name,
            { "Source Device Name",                          "bthci_acl_src_name",
            FT_STRINGZ, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_src_role,
            { "Source Role",                                "bthci_acl_src_role",
            FT_UINT32, BASE_DEC, VALS(role_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_dst_bd_addr,
            { "Destination BD_ADDR",                         "bthci_acl_dst_bd_addr",
            FT_ETHER, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_dst_name,
            { "Destination Device Name",                     "bthci_acl_dst_name",
            FT_STRINGZ, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_dst_role,
            { "Destination Role",                            "bthci_acl_dst_role",
            FT_UINT32, BASE_DEC, VALS(role_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_role_last_change_in_frame,
            { "Last Role Change in Frame",                   "bthci_acl_last_change_in_frame_role",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_mode,
            { "Current Mode",                                "bthci_acl_mode",
            FT_INT32, BASE_DEC, VALS(mode_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bthci_acl_mode_last_change_in_frame,
            { "Last Mode Change in Frame",                   "bthci_acl_last_change_in_frame_mode",
            FT_FRAMENUM, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
    };
