...
proto_register_ipp(void)
{
    static hf_register_info hf[] = {
      /* Generated from convert_proto_tree_add_text.pl */
      { &hf_ipp_version, { "version", "ipp_version", FT_UINT16, BASE_CUSTOM, CF_FUNC(ipp_fmt_version), 0x0, NULL, HFILL }},
      { &hf_ipp_operation_id, { "operation-id", "ipp_operation_id", FT_UINT16, BASE_HEX, VALS(operation_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_status_code, { "status-code", "ipp_status_code", FT_UINT16, BASE_HEX, VALS(status_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_request_id, { "request-id", "ipp_request_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_name, { "name", "ipp_name", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_memberattrname, { "memberAttrName", "ipp_memberattrname", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_boolean_value, { "boolean value", "ipp_boolean_value", FT_BOOLEAN, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_integer_value, { "integer value", "ipp_integer_value", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value, { "enum value", "ipp_enum_value", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_printer_state, { "printer-state", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(printer_state_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_job_state, { "job-state", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(job_state_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_document_state, { "document-state", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(document_state_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_operations_supported, { "operations-supported", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(operation_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_finishings, { "finishings", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(finishings_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_orientation, { "orientation", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(orientation_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_print_quality, { "print-quality", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(quality_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_enum_value_transmission_status, { "transmission-status", "ipp_enum_value", FT_INT32, BASE_DEC, VALS(transmission_status_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_outofband_value, { "out-of-band value", "ipp_outofband_value", FT_UINT8, BASE_HEX, VALS(tag_vals), 0x0, NULL, HFILL }},
      { &hf_ipp_charstring_value, { "string value", "ipp_charstring_value", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_octetstring_value, { "octetString value", "ipp_octetstring_value", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_datetime_value, { "dateTime value", "ipp_datetime_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_resolution_value, { "resolution value", "ipp_resolution_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_rangeofinteger_value, { "rangeOfInteger value", "ipp_rangeofinteger_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_textwithlanguage_value, { "textWithLanguage value", "ipp_textwithlanguage_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_namewithlanguage_value, { "nameWithLanguage value", "ipp_namewithlanguage_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_unknown_value, { "unknown value", "ipp_unknown_value", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_ipp_response_in, { "Response In", "ipp_response_in", FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_RESPONSE), 0x0, "The response to this IPP request is in this frame", HFILL }},
      { &hf_ipp_response_to, { "Request In", "ipp_response_to", FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_REQUEST), 0x0, "This is a response to the IPP request in this frame", HFILL }},
      { &hf_ipp_response_time, { "Response Time", "ipp_response_time", FT_RELATIVE_TIME, BASE_NONE, NULL, 0x0, "The time between the Request and the Response", HFILL }}
    };
    static gint *ett[] = {
        &ett_ipp,
        &ett_ipp_as,
