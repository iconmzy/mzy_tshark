...
proto_register_bvlc(void)
{
	static hf_register_info hf[] = {
		...
		{ &hf_bvlc_orig_source_addr,
			{ "IP",             "bvlc_orig_source_addr",
			FT_IPv6, BASE_NONE, NULL, 0,
			"ORIG IP", HFILL }
		},
		{ &hf_bvlc_orig_source_port,
			{ "Port",           "bvlc_orig_source_port",
			FT_UINT16, BASE_DEC, NULL, 0,
			"ORIG Port", HFILL }
		},
	};
