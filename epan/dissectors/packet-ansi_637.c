...
proto_register_ansi_637(void)
{
    ...
    static hf_register_info hf_tele[] = {
        { &hf_ansi_637_tele_msg_type,
            { "Message Type",
            "ansi_637_tele_msg_type",
            FT_UINT24, BASE_DEC, VALS(ansi_tele_msg_type_strings), 0xf00000,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_msg_id,
            { "Message ID",
            "ansi_637_tele_msg_id",
            FT_UINT24, BASE_DEC, NULL, 0x0ffff0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_length,
            { "Length", "ansi_637_tele_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_msg_status,
            { "Message Status",
            "ansi_637_tele_msg_status",
            FT_UINT8, BASE_DEC | BASE_EXT_STRING, &ansi_tele_msg_status_strings_ext, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_msg_header_ind,
            { "Header Indicator",
            "ansi_637_tele_msg_header_ind",
            FT_UINT24, BASE_DEC, VALS(ansi_tele_msg_header_ind_strings), 0x000008,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_msg_rsvd,
            { "Reserved",
            "ansi_637_tele_msg_rsvd",
            FT_UINT24, BASE_DEC, NULL, 0x000007,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_subparam_id,
            { "Teleservice Subparam ID", "ansi_637_tele_subparam_id",
            FT_UINT8, BASE_DEC | BASE_EXT_STRING, &ansi_tele_param_strings_ext, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_user_data_text,
            { "Encoded user data", "ansi_637_tele_user_data_text",
            FT_STRING, STR_UNICODE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_user_data_encoding,
            { "Encoding", "ansi_637_tele_user_data_encoding",
            FT_UINT16, BASE_DEC, NULL, 0xf800,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_user_data_message_type,
            { "Message Type (see TIA/EIA/IS-91)", "ansi_637_tele_user_data_message_type",
            FT_UINT16, BASE_DEC, NULL, 0x07f8,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_user_data_num_fields,
            { "Number of fields", "ansi_637_tele_user_data_num_fields",
            FT_UINT16, BASE_DEC, NULL, 0x07f8,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_response_code,
            { "Response Code", "ansi_637_tele_response_code",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_message_center_ts_year,
            { "Timestamp (Year)", "ansi_637_tele_message_center_ts_year",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_message_center_ts_month,
            { "Timestamp (Month)", "ansi_637_tele_message_center_ts_month",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_message_center_ts_day,
            { "Timestamp (Day)", "ansi_637_tele_message_center_ts_day",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_message_center_ts_hours,
            { "Timestamp (Hours)", "ansi_637_tele_message_center_ts_hours",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_message_center_ts_minutes,
            { "Timestamp (Minutes)", "ansi_637_tele_message_center_ts_minutes",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_message_center_ts_seconds,
            { "Timestamp (Seconds)", "ansi_637_tele_message_center_ts_seconds",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_ts_year,
            { "Timestamp (Year)", "ansi_637_tele_validity_period_ts_year",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_ts_month,
            { "Timestamp (Month)", "ansi_637_tele_validity_period_ts_month",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_ts_day,
            { "Timestamp (Day)", "ansi_637_tele_validity_period_ts_day",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_ts_hours,
            { "Timestamp (Hours)", "ansi_637_tele_validity_period_ts_hours",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_ts_minutes,
            { "Timestamp (Minutes)", "ansi_637_tele_validity_period_ts_minutes",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_ts_seconds,
            { "Timestamp (Seconds)", "ansi_637_tele_validity_period_ts_seconds",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_validity_period_relative_validity,
            { "Validity", "ansi_637_tele_validity_period_relative_validity",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_ts_year,
            { "Timestamp (Year)", "ansi_637_tele_deferred_del_ts_year",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_ts_month,
            { "Timestamp (Month)", "ansi_637_tele_deferred_del_ts_month",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_ts_day,
            { "Timestamp (Day)", "ansi_637_tele_deferred_del_ts_day",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_ts_hours,
            { "Timestamp (Hours)", "ansi_637_tele_deferred_del_ts_hours",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_ts_minutes,
            { "Timestamp (Minutes)", "ansi_637_tele_deferred_del_ts_minutes",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_ts_seconds,
            { "Timestamp (Seconds)", "ansi_637_tele_deferred_del_ts_seconds",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_deferred_del_relative,
            { "Delivery Time", "ansi_637_tele_deferred_del_relative",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_priority_indicator,
            { "Priority", "ansi_637_tele_priority_indicator",
            FT_UINT8, BASE_DEC, VALS(tele_param_priority_ind_strings), 0xc0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_privacy_indicator,
            { "Privacy", "ansi_637_tele_privacy_indicator",
            FT_UINT8, BASE_DEC, VALS(tele_param_privacy_ind_strings), 0xc0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_reply_option_user_ack_req,
            { "User Acknowledgement Requested", "ansi_637_tele_reply_option_user_ack_req",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_reply_option_dak_req,
            { "Delivery Acknowledgement Requested", "ansi_637_tele_reply_option_dak_req",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_reply_option_read_ack_req,
            { "Read Acknowledgement Requested", "ansi_637_tele_reply_option_read_ack_req",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_reply_option_report_req,
            { "Delivery/Submit Report Requested", "ansi_637_tele_reply_option_report_req",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_num_messages,
            { "Number of voice mail messages", "ansi_637_tele_num_messages_count",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_alert_msg_delivery_priority,
            { "Privacy", "ansi_637_tele_alert_msg_delivery_priority",
            FT_UINT8, BASE_DEC, VALS(tele_param_alert_priority_strings), 0xc0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_language,
            { "Language", "ansi_637_tele_language",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cb_num_digit_mode,
            { "Digit Mode", "ansi_637_tele_cb_num_digit_mode",
            FT_BOOLEAN, 8, TFS(&tfs_digit_mode_8bit_4bit), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cb_num_ton,
            { "Type of Number", "ansi_637_tele_cb_num_ton",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_num_type_vals), 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cb_num_plan,
            { "Numbering Plan", "ansi_637_tele_cb_num_plan",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_num_plan_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cb_num_num_fields,
            { "Number of fields", "ansi_637_tele_cb_num_num_fields",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        ...
        { &hf_ansi_637_tele_cmas_encoding,
            { "Encoding", "ansi_637_tele_cmas_encoding",
            FT_UINT16, BASE_DEC, NULL, 0xf800,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_num_fields,
            { "Number of fields", "ansi_637_tele_cmas_num_fields",
            FT_UINT16, BASE_DEC, NULL, 0x07f8,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_protocol_version,
            { "CMAE_protocol_version", "ansi_637_tele_cmas_protocol_version",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_record_type,
            { "E_RECORD_TYPE", "ansi_637_tele_cmas_record_type",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_record_len,
            { "E_RECORD_LENGTH", "ansi_637_tele_cmas_record_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_char_set,
            { "CMAE_char_set", "ansi_637_tele_cmas_char_set",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_category,
            { "CMAE_category", "ansi_637_tele_cmas_category",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_response_type,
            { "CMAE_response_type", "ansi_637_tele_cmas_response_type",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_severity,
            { "CMAE_severity", "ansi_637_tele_cmas_severity",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_urgency,
            { "CMAE_urgency", "ansi_637_tele_cmas_urgency",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_certainty,
            { "CMAE_certainty", "ansi_637_tele_cmas_certainty",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_identifier,
            { "CMAE_identifier", "ansi_637_tele_cmas_identifier",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_alert_handling,
            { "CMAE_alert_handling", "ansi_637_tele_cmas_alert_handling",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_expires_year,
            { "CMAE_expires (Year)", "ansi_637_tele_cmas_expires_year",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_expires_month,
            { "CMAE_expires (Month)", "ansi_637_tele_cmas_expires_month",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_expires_day,
            { "CMAE_expires (Day)", "ansi_637_tele_cmas_expires_day",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_expires_hours,
            { "CMAE_expires (Hours)", "ansi_637_tele_cmas_expires_hours",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_expires_minutes,
            { "CMAE_expires (Minutes)", "ansi_637_tele_cmas_expires_minutes",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_expires_seconds,
            { "CMAE_expires (Seconds)", "ansi_637_tele_cmas_expires_seconds",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_language,
            { "CMAE_language", "ansi_637_tele_cmas_language",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_cmas_text,
            { "CMAE_alert_text", "ansi_637_tele_cmas_text",
            FT_STRING, STR_UNICODE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_mult_enc_user_data_encoding,
            { "Encoding", "ansi_637_tele_mult_enc_user_data_encoding",
            FT_UINT8, BASE_DEC, VALS(ansi_tsb58_encoding_vals), 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_mult_enc_user_data_num_fields,
            { "Number of fields", "ansi_637_tele_mult_enc_user_data_num_fields",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_mult_enc_user_data_text,
            { "Encoded user data", "ansi_637_tele_mult_enc_user_data_text",
            FT_STRING, STR_UNICODE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_encoding,
            { "Encoding", "ansi_637_tele_srvc_cat_prog_data_encoding",
            FT_UINT8, BASE_DEC, VALS(ansi_tsb58_encoding_vals), 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_operation_code,
            { "Operation code", "ansi_637_tele_srvc_cat_prog_data_operation_code",
            FT_UINT8, BASE_DEC, VALS(tele_param_srvc_cat_prog_data_op_code_vals), 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_category,
            { "Operation code", "ansi_637_tele_srvc_cat_prog_data_category",
            FT_UINT16, BASE_DEC|BASE_EXT_STRING, &ansi_tsb58_srvc_cat_vals_ext, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_language,
            { "Operation code", "ansi_637_tele_srvc_cat_prog_data_language",
            FT_UINT8, BASE_DEC|BASE_EXT_STRING, &ansi_tsb58_language_ind_vals_ext, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_max_messages,
            { "Maximum number of messages", "ansi_637_tele_srvc_cat_prog_data_max_messages",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_alert_option,
            { "Alert option", "ansi_637_tele_srvc_cat_prog_data_alert_option",
            FT_UINT8, BASE_DEC, VALS(tele_param_srvc_cat_prog_data_alert_option_vals), 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_num_fields,
            { "Number of fields", "ansi_637_tele_srvc_cat_prog_data_num_fields",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_tele_srvc_cat_prog_data_text,
            { "Encoded program data", "ansi_637_tele_srvc_cat_prog_data_text",
            FT_STRING, STR_UNICODE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_637_msb_first_field,
            { "Most significant bits of first field", "ansi_637_tele_msb_first_field",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_637_lsb_last_field,
            { "Least significant bits of last field", "ansi_637_tele_lsb_last_field",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
    };
