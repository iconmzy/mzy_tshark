...
proto_register_aodv(void)
{
    static hf_register_info hf[] = {
        ...
        { &hf_aodv_flags_rreq_join,
          { "RREQ Join", "aodv_flags_rreq_join",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREQ_JOIN,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rreq_repair,
          { "RREQ Repair", "aodv_flags_rreq_repair",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREQ_REP,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rreq_gratuitous,
          { "RREQ Gratuitous RREP", "aodv_flags_rreq_gratuitous",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREQ_GRATRREP,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rreq_destinationonly,
          { "RREQ Destination only", "aodv_flags_rreq_destinationonly",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREQ_DESTONLY,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rreq_unknown,
          { "RREQ Unknown Sequence Number", "aodv_flags_rreq_unknown",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREQ_UNKNSEQ,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rrep_repair,
          { "RREP Repair", "aodv_flags_rrep_repair",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREP_REP,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rrep_ack,
          { "RREP Acknowledgement", "aodv_flags_rrep_ack",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RREP_ACK_REQ,
            NULL, HFILL }
        },
        { &hf_aodv_flags_rerr_nodelete,
          { "RERR No Delete", "aodv_flags_rerr_nodelete",
            FT_BOOLEAN, 16, TFS(&tfs_set_notset), RERR_NODEL,
            NULL, HFILL }
        },
        { &hf_aodv_prefix_sz,
          { "Prefix Size", "aodv_prefix_sz",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_aodv_hopcount,
          { "Hop Count", "aodv_hopcount",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_aodv_rreq_id,
          { "RREQ Id", "aodv_rreq_id",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_aodv_dest_ip,
          { "Destination IP", "aodv_dest_ip",
            FT_IPv4, BASE_NONE, NULL, 0x0,
            "Destination IP Address", HFILL }
        },
        { &hf_aodv_dest_ipv6,
          { "Destination IPv6", "aodv_dest_ipv6",
            FT_IPv6, BASE_NONE, NULL, 0x0,
            "Destination IPv6 Address", HFILL}
        },
        { &hf_aodv_dest_seqno,
          { "Destination Sequence Number", "aodv_dest_seqno",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_aodv_orig_ip,
          { "Originator IP", "aodv_orig_ip",
            FT_IPv4, BASE_NONE, NULL, 0x0,
            "Originator IP Address", HFILL }
        },
        { &hf_aodv_orig_ipv6,
          { "Originator IPv6", "aodv_orig_ipv6",
            FT_IPv6, BASE_NONE, NULL, 0x0,
            "Originator IPv6 Address", HFILL}
        },
        { &hf_aodv_orig_seqno,
          { "Originator Sequence Number", "aodv_orig_seqno",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_aodv_lifetime,
          { "Lifetime", "aodv_lifetime",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_aodv_destcount,
          { "Destination Count", "aodv_destcount",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "Unreachable Destinations Count", HFILL }
        },
        { &hf_aodv_unreach_dest_ip,
          { "Unreachable Destination IP", "aodv_unreach_dest_ip",
            FT_IPv4, BASE_NONE, NULL, 0x0,
            "Unreachable Destination IP Address", HFILL }
        },
        { &hf_aodv_unreach_dest_ipv6,
          { "Unreachable Destination IPv6", "aodv_unreach_dest_ipv6",
            FT_IPv6, BASE_NONE, NULL, 0x0,
            "Unreachable Destination IPv6 Address", HFILL}
        },
#if 0
        { &hf_aodv_unreach_dest_seqno,
          { "Unreachable Destination Sequence Number", "aodv_unreach_dest_seqno",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
#endif
        { &hf_aodv_ext_type,
          { "Extension Type", "aodv_ext_type",
            FT_UINT8, BASE_DEC, VALS(exttype_vals), 0x0,
            "Extension Format Type", HFILL}
        },
        { &hf_aodv_ext_length,
          { "Extension Length", "aodv_ext_length",
            FT_UINT8, BASE_DEC|BASE_UNIT_STRING, &units_byte_bytes, 0x0,
            "Extension Data Length", HFILL}
        },
        { &hf_aodv_ext_interval,
          { "Hello Interval", "aodv_hello_interval",
            FT_UINT32, BASE_DEC, NULL, 0x0,
            "Hello Interval Extension", HFILL}
         },
        { &hf_aodv_ext_timestamp,
          { "Timestamp", "aodv_timestamp",
