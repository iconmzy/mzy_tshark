...
proto_register_rsvp(void)
{
    ...
    static hf_register_info rsvpf_info[] = {
        ...
        {&hf_rsvp_filter[RSVPF_PATH],
         { "Path Message", "rsvp_path",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_RESV],
         { "Resv Message", "rsvp_resv",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_PATHERR],
         { "Path Error Message", "rsvp_perr",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_RESVERR],
         { "Resv Error Message", "rsvp_rerr",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_PATHTEAR],
         { "Path Tear Message", "rsvp_ptear",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_RESVTEAR],
         { "Resv Tear Message", "rsvp_rtear",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_RCONFIRM],
         { "Resv Confirm Message", "rsvp_resvconf",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_RTEARCONFIRM],
         { "Resv Tear Confirm Message", "rsvp_rtearconf",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_BUNDLE],
         { "Bundle Message", "rsvp_bundle",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ACK],
         { "Ack Message", "rsvp_ack",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SREFRESH],
         { "Srefresh Message", "rsvp_srefresh",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_HELLO],
         { "HELLO Message", "rsvp_hello",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_class_length,
         { "Length", "rsvp_class_length",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_reserved,
         { "Reserved", "rsvp_ctype_reserved",
           FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_switching_granularity,
         { "Switching granularity", "rsvp_switching_granularity",
           FT_UINT16, BASE_DEC, VALS(rsvp_switching_granularity_vals), 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_NOTIFY],
         { "Notify Message", "rsvp_notify",
           FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_HELLO_OBJ],
         { "HELLO Request/Ack", "rsvp_hello_obj",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_FLOWSPEC],
         { "FLOWSPEC", "rsvp_flowspec",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_FILTER_SPEC],
         { "FILTERSPEC", "rsvp_filter",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SENDER],
         { "SENDER TEMPLATE", "rsvp_sender",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_TSPEC],
         { "SENDER TSPEC", "rsvp_tspec",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_RECOVERY_LABEL],
         { "RECOVERY LABEL", "rsvp_recovery_label",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_UPSTREAM_LABEL],
         { "UPSTREAM LABEL", "rsvp_upstream_label",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SUGGESTED_LABEL],
         { "SUGGESTED LABEL", "rsvp_suggested_label",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_LABEL_SET],
         { "LABEL SET", "rsvp_label_set",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ACCEPTABLE_LABEL_SET],
         { "ACCEPTABLE LABEL SET", "rsvp_acceptable_label_set",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_PROTECTION],
         { "PROTECTION", "rsvp_protection",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV],
         { "DIFFSERV", "rsvp_diffserv",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_RESTART_CAP],
         { "RESTART CAPABILITY", "rsvp_restart",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_LINK_CAP],
         { "LINK CAPABILITY", "rsvp_link",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_LABEL_REQUEST],
         { "LABEL REQUEST", "rsvp_label_request",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_ATTRIBUTE],
         { "SESSION ATTRIBUTE", "rsvp_session_attribute",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_EXPLICIT_ROUTE],
         { "EXPLICIT ROUTE", "rsvp_explicit_route",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_RECORD_ROUTE],
         { "RECORD ROUTE", "rsvp_record_route",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_MESSAGE_ID],
         { "MESSAGE-ID", "rsvp_msgid",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_MESSAGE_ID_ACK],
         { "MESSAGE-ID ACK", "rsvp_msgid_ack",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_MESSAGE_ID_LIST],
         { "MESSAGE-ID LIST", "rsvp_msgid_list",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_LSP_TUNNEL_IF_ID],
         { "LSP INTERFACE-ID", "rsvp_lsp_tunnel_if_id",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS],
         { "ADMIN STATUS", "rsvp_admin_status",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_REFLECT],
         { "Reflect", "rsvp_admin_status_reflect",
           FT_BOOLEAN, 32, NULL, 0x80000000,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_HANDOVER],
         { "Handover", "rsvp_admin_status_handover",
           FT_BOOLEAN, 32, NULL, 0x40,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_LOCKOUT],
         { "Lockout", "rsvp_admin_status_lockout",
           FT_BOOLEAN, 32, NULL, 0x20,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_INHIBIT],
         { "Inhibit Alarm Communication", "rsvp_admin_status_inhibit",
           FT_BOOLEAN, 32, NULL, 0x10,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_CALL_MGMT],
         { "Call Management", "rsvp_admin_status_callmgmt",
           FT_BOOLEAN, 32, NULL, 0x08,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_TESTING],
         { "Testing", "rsvp_admin_status_testing",
           FT_BOOLEAN, 32, NULL, 0x04,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_DOWN],
         { "Administratively down", "rsvp_admin_status_down",
           FT_BOOLEAN, 32, NULL, 0x02,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ADMIN_STATUS_DELETE],
         { "Delete in progress", "rsvp_admin_status_delete",
           FT_BOOLEAN, 32, NULL, 0x01,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_LSP_ATTRIBUTES],
         { "LSP ATTRIBUTES", "rsvp_lsp_attributes",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_ASSOCIATION],
         { "ASSOCIATION", "rsvp_association",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_CALL_ATTRIBUTES],
         { "CALL ATTRIBUTES", "rsvp_call_attributes",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_NOTIFY_REQUEST],
         { "NOTIFY REQUEST", "rsvp_notify_request",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_GENERALIZED_UNI],
         { "GENERALIZED UNI", "rsvp_generalized_uni",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_CALL_ID],
         { "CALL ID", "rsvp_call_id",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_3GPP2_OBJECT],
         { "3GPP2 OBJECT", "rsvp_3gpp2_object",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        {&hf_rsvp_filter[RSVPF_PRIVATE_OBJ],
         { "Private object", "rsvp_obj_private",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_UNKNOWN_OBJ],
         { "Unknown object", "rsvp_obj_unknown",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        /* Session fields */
        {&hf_rsvp_filter[RSVPF_SESSION_IP],
         { "Destination address", "rsvp_session_ip",
           FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_SHORT_CALL_ID],
         { "Short Call ID", "rsvp_session_short_call_id",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_PORT],
         { "Port number", "rsvp_session_port",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_PROTO],
         { "Protocol", "rsvp_session_proto",
           FT_UINT8, BASE_DEC, VALS(proto_vals), 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_TUNNEL_ID],
         { "Tunnel ID", "rsvp_session_tunnel_id",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_EXT_TUNNEL_ID],
         { "Extended tunnel ID", "rsvp_session_ext_tunnel_id",
           FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SESSION_EXT_TUNNEL_ID_IPV6],
         { "Extended tunnel ID", "rsvp_session_ext_tunnel_id_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_JUNIPER],
         { "Juniper", "rsvp_juniper",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_SENDER_IP],
         { "Sender IPv4 address", "rsvp_sender_ip",
           FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SENDER_PORT],
         { "Sender port number", "rsvp_sender_port",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SENDER_LSP_ID],
         { "LSP ID", "rsvp_sender_lsp_id",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_SENDER_SHORT_CALL_ID],
         { "Short Call ID", "rsvp_sender_short_call_id",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_DIFFSERV_MAPNB],
         { "MAPnb", "rsvp_diffserv_mapnb",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           MAPNB_DESCRIPTION, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_MAP],
         { "MAP", "rsvp_diffserv_map",
           FT_NONE, BASE_NONE, NULL, 0x0,
           MAP_DESCRIPTION, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_MAP_EXP],
         { "EXP", "rsvp_diffserv_map_exp",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           EXP_DESCRIPTION, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_PHBID],
         { PHBID_DESCRIPTION, "rsvp_diffserv_phbid",
           FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_PHBID_DSCP],
         { PHBID_DSCP_DESCRIPTION, "rsvp_diffserv_phbid_dscp",
           FT_UINT16, BASE_DEC, NULL, PHBID_DSCP_MASK,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_PHBID_CODE],
         { PHBID_CODE_DESCRIPTION, "rsvp_diffserv_phbid_code",
           FT_UINT16, BASE_DEC, NULL, PHBID_CODE_MASK,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_PHBID_BIT14],
         { PHBID_BIT14_DESCRIPTION, "rsvp_diffserv_phbid_bit14",
           FT_UINT16, BASE_DEC, VALS(phbid_bit14_vals), PHBID_BIT14_MASK,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_DIFFSERV_PHBID_BIT15],
         { PHBID_BIT15_DESCRIPTION, "rsvp_diffserv_phbid_bit15",
        ...
        {&hf_rsvp_filter[RSVPF_GUNI_SRC_IPV4],
         { "Source TNA", "rsvp_guni_srctna_ipv4",
           FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_GUNI_DST_IPV4],
         { "Destination TNA", "rsvp_guni_dsttna_ipv4",
           FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_GUNI_SRC_IPV6],
         { "Source TNA", "rsvp_guni_srctna_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_GUNI_DST_IPV6],
         { "Destination TNA", "rsvp_guni_dsttna_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_filter[RSVPF_CALL_ID_SRC_ADDR_IPV4],
         { "Source Transport Network Address", "rsvp_callid_srcaddr_ipv4",
           FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_filter[RSVPF_CALL_ID_SRC_ADDR_IPV6],
         { "Source Transport Network Address", "rsvp_callid_srcaddr_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_callid_srcaddr_ether,
         { "Source Transport Network Address", "rsvp_callid_srcaddr_ether",
           FT_ETHER, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },

        {&hf_rsvp_callid_srcaddr_bytes,
         { "Source Transport Network Address", "rsvp_callid_srcaddr_bytes",
           FT_ETHER, BASE_NONE, NULL, 0x0,
           NULL, HFILL }
        },
        ...
        {&hf_rsvp_3gpp_obj_tid,
         { "Transaction ID", "rsvp_3gpp_obj_tid",
           FT_UINT32, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_ie_len,
         { "Length", "rsvp_3gpp_obj_length",
           FT_UINT32, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_ie_type,
         { "IE Type", "rsvp_3gpp_obj_ie_type",
           FT_UINT32, BASE_DEC, VALS(rsvp_3gpp_object_ie_type_vals), 0,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_ue_ipv4_addr,
         { "UE IPv4 address", "rsvp_3gpp_obj_ue_ipv4_addr",
           FT_IPv4, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_ue_ipv6_addr,
         { "UE IPv6 address", "rsvp_3gpp_obj_ue_ipv6_addr",
           FT_IPv6, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_tft_d,
         { "Direction(D)", "rsvp_3gpp_obj_tft_d",
           FT_UINT32, BASE_DEC, VALS(rsvp_3gpp_object_tft_d_vals), 0xc0000000,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_tft_ns,
         { "Non-Specific bit(NS)", "rsvp_3gpp_obj_tft_ns",
           FT_UINT32, BASE_DEC, NULL, 0x08000000,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_tft_sr_id,
         { "SR_ID", "rsvp_3gpp_obj_tft_sr_id",
           FT_UINT32, BASE_DEC, NULL, 0x07000000,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_tft_p,
         { "Persistency(P)", "rsvp_3gpp_obj_tft_p",
           FT_UINT32, BASE_DEC, NULL, 0x00010000,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_tft_opcode,
         { "TFT Operation Code", "rsvp_3gpp_obj_tft_opcode",
           FT_UINT32, BASE_DEC, VALS(rsvp_3gpp_obj_tft_opcode_vals), 0x000ff00,
           NULL, HFILL }
        },
        {&hf_rsvp_3gpp_obj_tft_n_pkt_flt,
         { "Number of Packet filters", "rsvp_3gpp_obj_tft_n_pkt_flt",
           FT_UINT32, BASE_DEC, NULL, 0x00000ff,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_flow_id,
         { "Flow Identifier", "rsvp_3gpp_obj_flow_id",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_ev_prec,
         { "Packet filter evaluation precedence", "rsvp_3gpp_obj_pf_ev_prec",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_len,
         { "Packet filter length", "rsvp_3gpp_obj_pf_len",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_type,
         { "PF Type", "rsvp_3gpp_obj_pf_type",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_cont_len,
         { "Length", "rsvp_3gpp_obj_pf_cont_len",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_comp_type_id,
         { "PF component identifier", "rsvp_3gpp_obj_pf_comp_type_id",
           FT_UINT8, BASE_DEC, VALS(rsvp_3gpp_obj_pf_comp_type_id_vals), 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_src_ipv4,
         { "IPv4 Source Address", "rsvp_3gpp_obj_pf_src_ipv4",
           FT_IPv4, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_dst_ipv4,
         { "IPv4 Destination Address", "rsvp_3gpp_obj_pf_dst_ipv4",
           FT_IPv4, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_ipv4_mask,
         { "IPv4 Mask", "rsvp_3gpp_obj_pf_ipv4_mask",
           FT_UINT32, BASE_HEX, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_src_ipv6,
         { "IPv6 Source Address", "rsvp_3gpp_obj_pf_src_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_dst_ipv6,
         { "IPv6 Destination Address", "rsvp_3gpp_obj_pf_dst_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_ipv6_prefix_length,
         { "IPv6 Prefix length", "rsvp_3gpp_obj_pf_ipv6_prefix_length",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_prot_next,
         { "Protocol field(IPv4) or Next Header(IPv6)", "rsvp_3gpp_obj_pf_prot_next",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_dst_port,
         { "Single Destination Port", "rsvp_3gpp_obj_pf_dst_port",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_src_port,
         { "Single Source Port", "rsvp_3gpp_obj_pf_src_port",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_ipsec_spi,
         { "IPsec SPI", "rsvp_3gpp_obj_pf_ipsec_spi",
           FT_UINT32, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_tos_tc,
         { "Type of Service (IPv4)/Traffic Class (IPv6)", "rsvp_3gpp_obj_pf_tos_tc",
           FT_UINT8, BASE_HEX, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_flow_lbl,
         { "Flow label", "rsvp_3gpp_obj_pf_flow_lbl",
           FT_UINT24, BASE_DEC, NULL, 0x0fffff,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_ipv6,
         { "IPv6 Address", "rsvp_3gpp_obj_pf_ipv6",
           FT_IPv6, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_treatment,
         { "PF Treatment", "rsvp_3gpp_obj_pf_treatment",
           FT_UINT8, BASE_DEC, VALS(rsvp_3gpp_obj_pf_treatment_vals), 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_pf_hint,
         { "PF Hint", "rsvp_3gpp_obj_pf_hint",
           FT_UINT32, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_obj_tft_qos_list_len,
         { "QoS List Length", "rsvp_3gpp_obj_qos_list_len",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_r_qos_blob_len,
         { "R_QOS_SUB_BLOB_LEN", "rsvp_3gpp_obj_r_qos_blob_len",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_r_qos_blob_flow_pri,
         { "FLOW_PRIORITY", "rsvp_3gpp_obj_r_qos_blob_flow_pri",
           FT_UINT8, BASE_DEC, NULL, 0xf0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_r_qos_blob_num_qos_att_set,
         { "NUM_QoS_ATTRIBUTE_SETS", "rsvp_3gpp_obj_r_qos_blob_num_qos_att_set",
           FT_UINT8, BASE_DEC, NULL, 0x0e,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_att_set_len,
         { "QoS_ATTRIBUTE_SET_LEN", "rsvp_3gpp_obj_r_qos_blob_qos_att_set_len",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_set_id,
         { "QoS_ATTRIBUTE_SET_ID", "rsvp_3gpp_obj_r_qos_blob_qos_attribute_set_id",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_verbose,
         { "VERBOSE", "rsvp_3gpp_obj_r_qos_blob_verbose",
           FT_BOOLEAN, 8, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_prof_id,
         { "ProfileID", "rsvp_3gpp_obj_r_qos_blob_prof_id",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_traff_cls,
         { "Traffic_Class", "rsvp_3gpp_obj_r_qos_blob_traff_cls",
           FT_UINT8, BASE_DEC, VALS(rsvp_3gpp_obj_traffic_class_vals), 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_peak_rate,
         { "Peak_Rate", "rsvp_3gpp_obj_r_qos_blob_peak_rate",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_bucket_size,
         { "Bucket_Size", "rsvp_3gpp_obj_r_qos_blob_bucket_size",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_token_rate,
         { "Token_Rate", "rsvp_3gpp_obj_r_qos_blob_token_rate",
           FT_UINT16, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_max_latency,
         { "Max_Latency", "rsvp_3gpp_obj_r_qos_blob_max_latency",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_max_loss_rte,
         { "Max_Loss_Rate", "rsvp_3gpp_obj_r_qos_blob_max_loss_rte",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_delay_var_sensitive,
         { "Delay_Var_Sensitive", "rsvp_3gpp_obj_r_qos_blob_delay_var_sensitive",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_attribute_reserved,
         { "Reserved", "rsvp_3gpp_obj_r_qos_blob_reserved",
           FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_r_qos_blob,
         { "R_QOS_SUB_BLOB", "rsvp_3gpp_obj_r_qos_blob",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL }
        },
        { &hf_rsvp_3gpp_qos_result,
         { "Result Code", "rsvp_3gpp_obj_qos_result_code",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL }
        },

        { &hf_rsvp_xro_sobj_lbit,
          { "L(oose) bit", "rsvp_xro_sobj_lbit",
            FT_UINT8, BASE_DEC,VALS(rsvp_xro_sobj_lbit_vals), 0x80,
            NULL, HFILL
          }
        },
        { &hf_rsvp_rro_sobj_dbit,
          { "D(irection) bit", "rsvp_rro_sobj_dbit",
        ...
        { &hf_rsvp_xro_sobj_ipv4_addr,
         { "IPv4 prefix", "rsvp_xro_sobj_ipv4_addr",
           FT_IPv4, BASE_NONE, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_xro_sobj_ipv4_prefix,
         { "Prefix Length", "rsvp_xro_sobj_ipv4_prefix",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_xro_sobj_ipv4_attr,
         { "Attribute", "rsvp_xro_sobj_ipv4_attr",
        ...
        { &hf_rsvp_xro_sobj_ipv6_attr,
         { "Attribute", "rsvp_xro_sobj_ipv6_attr",
           FT_UINT8, BASE_DEC, VALS(rsvp_xro_sobj_ip_attr_vals), 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_xro_sobj_srlg_res,
         { "Reserved", "rsvp_xro_sobj_srlg_res",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_juniper_padlength,
         { "Padlength", "rsvp_juniper_padlength",
           FT_UINT16, BASE_DEC, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_juniper_type,
         { "Juniper type", "rsvp_juniper_type",
        ...
        { &hf_rsvp_juniper_length,
         { "Juniper length", "rsvp_juniper_length",
           FT_UINT8, BASE_DEC, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_juniper_attrib_metric1,
         { "Metric 1", "rsvp_juniper_attrib_metric1",
           FT_UINT16, BASE_HEX, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_juniper_attrib_metric2,
         { "Metric 2", "rsvp_juniper_attrib_metric2",
           FT_UINT16, BASE_HEX, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_juniper_attrib_ccc_status,
         { "CCC Status", "rsvp_juniper_attrib_ccc_status",
           FT_UINT16, BASE_HEX, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_juniper_attrib_path,
         { "Path type", "rsvp_juniper_attrib_path",
        ...
        { &hf_rsvp_juniper_attrib_unknown,
         { "Unknown", "rsvp_juniper_attrib_unknown",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL
         }
        },
        ...
        { &hf_rsvp_ctype_s2l_sub_lsp,
         { "C-Type", "rsvp_ctype_s2l_sub_lsp",
           FT_UINT32, BASE_DEC, VALS(rsvp_c_type_s2l_sub_lsp_vals), 0,
           NULL, HFILL
         }
        },
        { &hf_rsvp_s2l_sub_lsp_destination_ipv4_address,
         { "IPv4 S2L Sub-LSP destination address", "rsvp_s2l_sub_lsp_destination_ipv4_address",
           FT_IPv4, BASE_NONE, NULL, 0,
           NULL, HFILL
         }
        },
        { &hf_rsvp_s2l_sub_lsp_destination_ipv6_address,
         { "IPv6 S2L Sub-LSP destination address", "rsvp_s2l_sub_lsp_destination_ipv6_address",
           FT_IPv6, BASE_NONE, NULL, 0,
           NULL, HFILL
         }
        },
        { &hf_rsvp_s2l_sub_lsp_data,
         { "Data", "rsvp_s2l_sub_lsp_data",
           FT_BYTES, BASE_NONE, NULL, 0,
           NULL, HFILL
         }
        },
      ...
      /* Generated from convert_proto_tree_add_text.pl */
      { &hf_rsvp_session_flags, { "Flags", "rsvp_session_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_destination_address, { "Destination address", "rsvp_session_destination_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_protocol, { "Protocol", "rsvp_session_protocol", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_destination_port, { "Destination port", "rsvp_session_destination_port", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_dscp, { "DSCP", "rsvp_session_dscp", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &dscp_vals_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_extended_ipv4_address, { "Extended IPv4 Address", "rsvp_session_extended_ipv4_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_p2mp_id, { "P2MP ID", "rsvp_session_p2mp_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_data, { "Data", "rsvp_session_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_length, { "Length", "rsvp_ifid_tlv_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_ipv4_address, { "IPv4 address", "rsvp_ifid_tlv_ipv4_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_ipv6_address, { "IPv6 address", "rsvp_ifid_tlv_ipv6_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlvinterface_id, { "Interface-ID", "rsvp_ifid_tlv_interface_id", FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_label, { "Label", "rsvp_ifid_tlv_label", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_node_id, { "Node ID", "rsvp_ifid_tlv_node_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_area, { "Area", "rsvp_ifid_tlv_area", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_autonomous_system, { "Autonomous System", "rsvp_ifid_tlv_autonomous_system", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_error_string, { "Error String", "rsvp_ifid_tlv_error_string", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_data, { "Data", "rsvp_ifid_tlv_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ifid_tlv_padding, { "Padding", "rsvp_ifid_tlv_padding", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_hop, { "C-Type", "rsvp_ctype_hop", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_hop_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_hop_neighbor_address_ipv4, { "Neighbor address", "rsvp_hop_neighbor_address_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_hop_logical_interface, { "Logical interface", "rsvp_hop_logical_interface", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_hop_neighbor_address_ipv6, { "Neighbor address", "rsvp_neighbor_address_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_hop_data, { "Data", "rsvp_hop_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_time_values, { "C-Type", "rsvp_ctype_time_values", FT_UINT32, BASE_DEC,  VALS(rsvp_c_type_time_values_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_time_values_data, { "Data", "rsvp_time_values_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_error, { "C-Type", "rsvp_ctype_error", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_error_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_error_error_node_ipv4, { "Error node", "rsvp_error_error_node_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_error_error_node_ipv6, { "Error node", "rsvp_error_error_node_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_error_data, { "Data", "rsvp_error_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_error_error_code, { "Error code", "rsvp_error_error_code", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &rsvp_error_codes_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_scope, { "C-Type", "rsvp_ctype_scope", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_scope_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_scope_ipv4_address, { "IPv4 Address", "rsvp_scope_ipv4_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_scope_ipv6_address, { "IPv6 Address", "rsvp_scope_ipv6_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_scope_data, { "Data", "rsvp_scope_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_style, { "C-Type", "rsvp_ctype_style", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_style_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_style_flags, { "Flags", "rsvp_style_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_style_style, { "Style", "rsvp_style_style", FT_UINT24, BASE_HEX, VALS(style_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_style_data, { "Data", "rsvp_style_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_confirm, { "C-Type", "rsvp_ctype_confirm", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_confirm_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_confirm_receiver_address_ipv4, { "Receiver address", "rsvp_confirm_receiver_address_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_confirm_receiver_address_ipv6, { "Receiver address", "rsvp_confirm_receiver_address_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_confirm_data, { "Data", "rsvp_confirm_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_template, { "C-Type", "rsvp_ctype_template", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_template_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_source_address_ipv6, { "Source address", "rsvp_template_filter_source_address_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_source_port, { "Source port", "rsvp_template_filter_source_port", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_ipv4_tunnel_sender_address, { "IPv4 Tunnel Sender Address", "rsvp_template_filter_ipv4_tunnel_sender_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_ipv6_tunnel_sender_address, { "IPv6 Tunnel Sender Address", "rsvp_template_filter_ipv6_tunnel_sender_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_sub_group_originator_id, { "Sub-Group Originator ID", "rsvp_template_filter_sub_group_originator_id", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_sub_group_id, { "Sub-Group ID", "rsvp_template_filter_sub_group_id", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_template_filter_data, { "Data", "rsvp_template_filter_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_length, { "Length", "rsvp_eth_tspec_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_profile, { "Profile", "rsvp_eth_tspec_profile", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_index, { "Index", "rsvp_eth_tspec_index", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_reserved, { "Reserved", "rsvp_eth_tspec_reserved", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_el2cp, { "EL2CP", "rsvp_eth_tspec_el2cp", FT_UINT8, BASE_DEC, VALS(el2cp_val_str), 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_il2cp, { "IL2CP", "rsvp_eth_tspec_il2cp", FT_UINT8, BASE_DEC, VALS(il2cp_val_str), 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_cir, { "CIR", "rsvp_eth_tspec_cir", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_cbs, { "CBS", "rsvp_eth_tspec_cbs", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_eir, { "EIR", "rsvp_eth_tspec_eir", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_eth_tspec_ebs, { "EBS", "rsvp_eth_tspec_ebs", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_tspec, { "C-Type", "rsvp_ctype_tspec", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_tspec_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_message_format_version, { "Message format version", "rsvp_tspec_message_format_version", FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
      { &hf_rsvp_tspec_service_header, { "Service header", "rsvp_tspec_service_header", FT_UINT8, BASE_DEC, VALS(qos_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_token_bucket_rate, { "Token bucket rate", "rsvp_tspec_token_bucket_rate", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_token_bucket_size, { "Token bucket size", "rsvp_tspec_token_bucket_size", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_peak_data_rate, { "Peak data rate", "rsvp_tspec_peak_data_rate", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_hint, { "Hint", "rsvp_tspec_hint", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_compression_factor, { "Compression Factor", "rsvp_tspec_compression_factor", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_signal_type_sonet, { "Signal Type", "rsvp_tspec_signal_type", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &gmpls_sonet_signal_type_str_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_requested_concatenation, { "Requested Concatenation (RCC)", "rsvp_tspec_requested_concatenation", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_number_of_contiguous_components, { "Number of Contiguous Components (NCC)", "rsvp_tspec_number_of_contiguous_components", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_number_of_virtual_components, { "Number of Virtual Components (NVC)", "rsvp_tspec_number_of_virtual_components", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_multiplier, { "Multiplier (MT)", "rsvp_tspec_multiplier", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_transparency, { "Transparency (T)", "rsvp_tspec_transparency", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_profile, { "Profile (P)", "rsvp_tspec_profile", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_signal_type_g709, { "Signal Type", "rsvp_tspec_signal_type", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_g709_signal_type_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_number_of_multiplexed_components, { "Number of Multiplexed Components (NMC)", "rsvp_number_of_multiplexed_components", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_mtu, { "MTU", "rsvp_tspec_mtu", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_tspec_data, { "Data", "rsvp_tspec_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_flowspec, { "C-Type", "rsvp_ctype_flowspec", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_flowspec_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_message_format_version, { "Message format version", "rsvp_flowspec_message_format_version", FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
      { &hf_rsvp_flowspec_service_header, { "Service header", "rsvp_flowspec_service_header", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &intsrv_services_str_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_token_bucket_rate, { "Token bucket rate", "rsvp_flowspec_token_bucket_rate", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_token_bucket_size, { "Token bucket size", "rsvp_flowspec_token_bucket_size", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_peak_data_rate, { "Peak data rate", "rsvp_flowspec_peak_data_rate", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_rate, { "Rate", "rsvp_flowspec_rate", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_slack_term, { "Slack term", "rsvp_flowspec_slack_term", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_signal_type_sonet, { "Signal Type", "rsvp_flowspec_signal_type", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &gmpls_sonet_signal_type_str_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_requested_concatenation, { "Requested Concatenation (RCC)", "rsvp_flowspec_requested_concatenation", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_number_of_contiguous_components, { "Number of Contiguous Components (NCC)", "rsvp_flowspec_number_of_contiguous_components", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_number_of_virtual_components, { "Number of Virtual Components (NVC)", "rsvp_flowspec_number_of_virtual_components", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_multiplier, { "Multiplier (MT)", "rsvp_flowspec_multiplier", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_transparency, { "Transparency (T)", "rsvp_flowspec_transparency", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_profile, { "Profile (P)", "rsvp_flowspec_profile", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_signal_type_g709, { "Signal Type", "rsvp_flowspec_signal_type", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_g709_signal_type_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_number_of_multiplexed_components, { "Number of Multiplexed Components (NMC)", "rsvp_flowspec_number_of_multiplexed_components", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_mtu, { "MTU", "rsvp_flowspec_mtu", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_flowspec_m, { "m", "rsvp_flowspec_m", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_adspec, { "C-Type", "rsvp_ctype_adspec", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_adspec_message_format_version, { "Message format version", "rsvp_adspec_message_format_version", FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
      { &hf_rsvp_adspec_service_header, { "Service header", "rsvp_adspec_service_header", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &intsrv_services_str_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_integrity, { "C-Type", "rsvp_ctype_integrity", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_integrity_flags, { "Flags", "rsvp_integrity_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_integrity_key_identifier, { "Key Identifier", "rsvp_integrity_key_identifier", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_integrity_sequence_number, { "Sequence Number", "rsvp_integrity_sequence_number", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_integrity_hash, { "Hash", "rsvp_integrity_hash", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_policy, { "C-Type", "rsvp_ctype_policy", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_policy_data, { "Data", "rsvp_policy_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_label_request, { "C-Type", "rsvp_ctype_label_request", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_label_request_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_label_request_l3pid, { "L3PID", "rsvp_label_request_l3pid", FT_UINT16, BASE_HEX, VALS(etype_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_label_request_min_vpi, { "Min VPI", "rsvp_label_request_min_vpi", FT_UINT16, BASE_DEC, NULL, 0x7f, NULL, HFILL }},
      { &hf_rsvp_label_request_min_vci, { "Min VCI", "rsvp_label_request_min_vci", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_request_max_vpi, { "Max VPI", "rsvp_label_request_max_vpi", FT_UINT16, BASE_DEC, NULL, 0x7f, NULL, HFILL }},
      { &hf_rsvp_label_request_max_vci, { "Max VCI", "rsvp_label_request_max_vci", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_request_lsp_encoding_type, { "LSP Encoding Type", "rsvp_label_request_lsp_encoding_type", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_lsp_enc_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_label_request_switching_type, { "Switching Type", "rsvp_label_request_switching_type", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_switching_type_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_g_pid, { "G-PID", "rsvp_label_request_g_pid", FT_UINT16, BASE_HEX|BASE_RANGE_STRING, RVALS(gmpls_gpid_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_label_request_data, { "Data", "rsvp_label_request_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_label, { "Label", "rsvp_label_label", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_generalized_label, { "Generalized Label", "rsvp_label_generalized_label", FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_generalized_label_evpl_vlad_id, { "VLAN ID", "rsvp_label_generalized_label_evpl_vlad_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_data, { "Data", "rsvp_label_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_set_action, { "Action", "rsvp_label_set_action", FT_UINT8, BASE_DEC, VALS(action_type_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_attribute, { "C-Type", "rsvp_ctype_attribute", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_attribute_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_exclude_any, { "Exclude-Any", "rsvp_session_attribute_exclude_any", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_include_any, { "Include-Any", "rsvp_session_attribute_include_any", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_include_all, { "Include-All", "rsvp_session_attribute_include_all", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_setup_priority, { "Setup priority", "rsvp_session_attribute_setup_priority", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_hold_priority, { "Hold priority", "rsvp_session_attribute_hold_priority", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_flags, { "Flags", "rsvp_session_attribute_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_name_length, { "Name length", "rsvp_session_attribute_name_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_name, { "Name", "rsvp_session_attribute_name", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_session_attribute_data, { "Data", "rsvp_session_attribute_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_length, { "Length", "rsvp_ero_rro_subobjects_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_ipv4_hop, { "IPv4 hop", "rsvp_ero_rro_subobjects_ipv4_hop", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_prefix_length, { "Prefix length", "rsvp_ero_rro_subobjects_prefix_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_flags, { "Flags", "rsvp_ero_rro_subobjects_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_ipv6_hop, { "IPv6 hop", "rsvp_ero_rro_subobjects_ipv6_hop", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_label, { "Label", "rsvp_ero_rro_subobjects_label", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_router_id, { "Router-ID", "rsvp_ero_rro_subobjects_router_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_interface_id, { "Interface-ID", "rsvp_ero_rro_subobjects_interface_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_path_key, { "Path Key", "rsvp_ero_rro_subobjects_path_key", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_pce_id_ipv4, { "PCE-ID", "rsvp_ero_rro_subobjects_pce_id_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_pce_id_ipv6, { "PCE-ID", "rsvp_ero_rro_subobjects_pce_id_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_private_length, { "Length", "rsvp_ero_rro_subobjects_private_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_subobjects_private_data, { "Data", "rsvp_ero_rro_subobjects_private_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_explicit_route, { "C-Type", "rsvp_ctype_explicit_route", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_explicit_route_data, { "Data", "rsvp_explicit_route_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_record_route, { "C-Type", "rsvp_ctype_record_route", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_record_route_data, { "Data", "rsvp_record_route_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_exclude_route, { "C-Type", "rsvp_ctype_exclude_route", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_exclude_route_data, { "Data", "rsvp_exclude_route_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_message_id, { "C-Type", "rsvp_ctype_message_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_flags, { "Flags", "rsvp_message_id_flags", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_epoch, { "Epoch", "rsvp_message_id_epoch", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_message_id, { "Message-ID", "rsvp_message_id_message_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_data, { "Data", "rsvp_message_id_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_message_id_ack, { "C-Type", "rsvp_ctype_message_id_ack", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_ack_flags, { "Flags", "rsvp_message_id_ack_flags", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_ack_epoch, { "Epoch", "rsvp_message_id_ack_epoch", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_ack_message_id, { "Message-ID", "rsvp_message_id_ack_message_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_ack_data, { "Data", "rsvp_message_id_ack_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_message_id_list, { "C-Type", "rsvp_ctype_message_id_list", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_list_flags, { "Flags", "rsvp_message_id_list_flags", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_list_epoch, { "Epoch", "rsvp_message_id_list_epoch", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_list_message_id, { "Message-ID", "rsvp_message_id_list_message_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_id_list_data, { "Data", "rsvp_message_id_list_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_hello, { "C-Type", "rsvp_ctype_hello", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_hello_source_instance, { "Source Instance", "rsvp_hello_source_instance", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_hello_destination_instance, { "Destination Instance", "rsvp_hello_destination_instance", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_dclass, { "C-Type", "rsvp_ctype_dclass", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_dclass_dscp, { "DSCP", "rsvp_dclass_dscp", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &dscp_vals_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_dclass_data, { "Data", "rsvp_dclass_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_admin_status, { "C-Type", "rsvp_ctype_admin_status", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_admin_status_bits, { "Admin Status", "rsvp_admin_status_bits", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_admin_status_data, { "Data", "rsvp_admin_status_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_lsp_attributes, { "C-Type", "rsvp_ctype_lsp_attributes", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_attributes_tlv, { "LSP attributes TLV", "rsvp_lsp_attributes_tlv", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_attributes_tlv_data, { "Data", "rsvp_lsp_attributes_tlv_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_association, { "C-Type", "rsvp_ctype_association", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_association_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_association_type, { "Association type", "rsvp_association_type", FT_UINT16, BASE_DEC, VALS(association_type_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_association_id, { "Association ID", "rsvp_association_id", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_association_source_ipv4, { "Association source", "rsvp_association_source_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_association_source_ipv6, { "Association source", "rsvp_association_source_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_association_routing_area_id, { "Routing Area ID", "rsvp_association_routing_area_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_association_node_id, { "Node ID", "rsvp_association_node_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_association_padding, { "Padding", "rsvp_association_padding", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_association_data, { "Data", "rsvp_association_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_tunnel_if_id, { "C-Type", "rsvp_ctype_tunnel_if_id", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_tunnel_if_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_length, { "Length", "rsvp_lsp_tunnel_if_id_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_component_link_identifier, { "Component link identifier", "rsvp_lsp_tunnel_if_id_component_link_identifier", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_component_link_identifier_ipv4, { "Component link identifier", "rsvp_lsp_tunnel_if_id_component_link_identifier_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_lsp_encoding_type, { "LSP Encoding Type", "rsvp_lsp_tunnel_if_id_lsp_encoding_type", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_lsp_enc_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_switching_type, { "Switching Type", "rsvp_lsp_tunnel_if_id_switching_type", FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_switching_type_rvals), 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_signal_type, { "Signal Type", "rsvp_lsp_tunnel_if_id_signal_type", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &gmpls_sonet_signal_type_str_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_connection_id, { "Sub Interface/Connection ID", "rsvp_lsp_tunnel_if_id_connection_id", FT_UINT64, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_sc_pc_id, { "SC PC ID", "rsvp_lsp_tunnel_if_id_sc_pc_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_sc_pc_scn_address, { "SC PC SCN Address", "rsvp_lsp_tunnel_if_id_sc_pc_scn_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_router_id, { "Router ID", "rsvp_lsp_tunnel_if_id_router_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_interface_id, { "Interface ID", "rsvp_lsp_tunnel_if_id_interface_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_ipv4_interface_address, { "IPv4 interface address", "rsvp_lsp_tunnel_if_id_ipv4_interface_address", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_target_igp_instance, { "Target IGP instance", "rsvp_lsp_tunnel_if_id_target_igp_instance", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_action, { "Action", "rsvp_lsp_tunnel_if_id_action", FT_UINT8, BASE_DEC, VALS(lsp_tunnel_if_id_action_str), 0xF0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_ipv6_interface_address, { "IPv6 interface address", "rsvp_lsp_tunnel_if_id_ipv6_interface_address", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_lsp_tunnel_if_id_data, { "Data", "rsvp_lsp_tunnel_if_id_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_notify_request_notify_node_address_ipv4, { "Notify node address", "rsvp_notify_request_notify_node_address_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_notify_request_notify_node_address_ipv6, { "Notify node address", "rsvp_notify_request_notify_node_address_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_notify_request_data, { "Data", "rsvp_notify_request_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ctype_call_id, { "C-Type", "rsvp_ctype_call_id", FT_UINT32, BASE_DEC, VALS(rsvp_c_type_call_id_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_call_id_data, { "Data", "rsvp_call_id_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_call_id_address_type, { "Address type", "rsvp_call_id_address_type", FT_UINT8, BASE_DEC, VALS(address_type_vals), 0x0, NULL, HFILL }},
      { &hf_rsvp_call_id_reserved, { "Reserved", "rsvp_call_id_reserved", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_call_id_international_segment, { "International Segment", "rsvp_call_id_international_segment", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_call_id_national_segment, { "National Segment", "rsvp_call_id_national_segment", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_call_id_local_identifier, { "Local Identifier", "rsvp_call_id_local_identifier", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_restart_cap_data, { "Data", "rsvp_restart_cap_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_protection_info_link_flags, { "Link Flags", "rsvp_protection_info_link_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_protection_info_data, { "Data", "rsvp_protection_info_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_setup_priority, { "Setup Priority", "rsvp_fast_reroute_setup_priority", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_hold_priority, { "Hold Priority", "rsvp_fast_reroute_hold_priority", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_hop_limit, { "Hop Limit", "rsvp_fast_reroute_hop_limit", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_flags, { "Flags", "rsvp_fast_reroute_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_bandwidth, { "Bandwidth", "rsvp_fast_reroute_bandwidth", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_include_any, { "Include-Any", "rsvp_fast_reroute_include_any", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_exclude_any, { "Exclude-Any", "rsvp_fast_reroute_exclude_any", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_include_all, { "Include-All", "rsvp_fast_reroute_include_all", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_fast_reroute_data, { "Data", "rsvp_fast_reroute_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_detour_data, { "Data", "rsvp_detour_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_diffserv_data, { "Data", "rsvp_diffserv_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_diffserv_aware_te_data, { "Data", "rsvp_diffserv_aware_te_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_version, { "RSVP Version", "rsvp_version", FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
      { &hf_rsvp_flags, { "Flags", "rsvp_flags", FT_UINT8, BASE_HEX, NULL, 0x0F, NULL, HFILL }},
      { &hf_rsvp_sending_ttl, { "Sending TTL", "rsvp_sending_ttl", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_length, { "Message length", "rsvp_message_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_length, { "Length", "rsvp_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_extended_tunnel_id, { "Extended Tunnel ID", "rsvp_extended_tunnel_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_extended_tunnel_ipv6, { "Extended Tunnel ID", "rsvp_extended_tunnel_id_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_extended_tunnel, { "Extended Tunnel ID", "rsvp_extended_tunnel", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_refresh_interval, { "Refresh interval", "rsvp_refresh_interval", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_minimum_policed_unit, { "Minimum policed unit [m]", "rsvp_minimum_policed_unit", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_maximum_packet_size, { "Maximum packet size [M]", "rsvp_maximum_packet_size", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_hf_rsvp_adspec_break_bit, { "Break bit", "rsvp_adspec_break_bit", FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x80, NULL, HFILL }},
      { &hf_rsvp_label_request_m, { "M (Merge in Data Plane)", "rsvp_label_request_m", FT_BOOLEAN, 8, TFS(&tfs_can_cannot), 0x80, NULL, HFILL }},
      { &hf_rsvp_dlci_length, { "DLCI Length", "rsvp_label_request_dlci_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_min_dlci, { "Min DLCI", "rsvp_label_request_min_dlci", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_max_dlci, { "Max DLCI", "rsvp_label_request_max_dlci", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ero_rro_autonomous_system, { "Autonomous System", "rsvp_ero_rro_subobjects_autonomous_system", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_nsap_length, { "NSAP Length", "rsvp_nsap_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_gen_uni_data, { "Data", "rsvp_gen_uni_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_gen_uni_logical_port_id, { "Logical Port ID", "rsvp_gen_uni_logical_port_id", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_gen_uni_service_level, { "Service Level", "rsvp_gen_uni_service_level", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_restart_cap_restart_time, { "Restart Time", "rsvp_restart_cap_restart_time", FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_milliseconds, 0x0, NULL, HFILL }},
      { &hf_rsvp_restart_cap_recovery_time, { "Recovery Time", "rsvp_restart_cap_recovery_time", FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_milliseconds, 0x0, NULL, HFILL }},
      { &hf_rsvp_detour_plr_id, { "PLR ID", "rsvp_detour_plr_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_detour_avoid_node_id, { "Avoid Node ID", "rsvp_detour_avoid_node_id", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_message_checksum, { "Message Checksum", "rsvp_message_checksum", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_call_attributes_endpont_id, { "Endpoint ID", "rsvp_call_attributes_endpoint_id", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_isis_area_id, { "IS-IS Area Identifier", "rsvp_isis_area_id", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_adspec_type, { "Adspec Type", "rsvp_adspec_type", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &adspec_params_ext, 0x0, NULL, HFILL }},
      { &hf_rsvp_adspec_len, { "Length", "rsvp_adspec_len", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_adspec_uint, { "Adspec uint", "rsvp_adspec_uint", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_adspec_float, { "Adspec float", "rsvp_adspec_float", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_adspec_bytes, { "Adspec bytes", "rsvp_adspec_bytes", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_wavelength_freq, { "Freq", "rsvp_wavelength_freq", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_wavelength_grid, { "Grid", "rsvp_wavelength_grid", FT_UINT8, BASE_DEC, VALS(lambda_grid_vals), 0xE0, NULL, HFILL }},
      { &hf_rsvp_wavelength_cs1, { "Channel Spacing", "rsvp_wavelength_cs1", FT_UINT8, BASE_DEC, VALS(grid1_cs_vals), 0x1E, NULL, HFILL }},
      { &hf_rsvp_wavelength_cs2, { "Channel Spacing", "rsvp_wavelength_cs2", FT_UINT8, BASE_DEC, VALS(grid2_cs_vals), 0x1E, NULL, HFILL }},
      { &hf_rsvp_wavelength_cs3, { "Channel Spacing", "rsvp_wavelength_cs3", FT_UINT8, BASE_DEC, VALS(grid3_cs_vals), 0x1E, NULL, HFILL }},
      { &hf_rsvp_wavelength_channel_spacing, { "Channel Spacing", "rsvp_wavelength_channel_spacing", FT_UINT8, BASE_DEC, NULL, 0x1E, NULL, HFILL }},
      { &hf_rsvp_wavelength_n, { "Central Frequency", "rsvp_wavelength_n", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_wavelength_m, { "Channel Width (m)", "rsvp_wavelength_m", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_wavelength_wavelength, { "Wavelength", "rsvp_wavelength_wavelength", FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_nanometers, 0x0, NULL, HFILL }},
      { &hf_rsvp_sonet_s, { "S", "rsvp_sonet_s", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_sonet_u, { "U", "rsvp_sonet_u", FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
      { &hf_rsvp_sonet_k, { "K", "rsvp_sonet_k", FT_UINT8, BASE_DEC, NULL, 0x0F, NULL, HFILL }},
      { &hf_rsvp_sonet_l, { "L", "rsvp_sonet_l", FT_UINT8, BASE_DEC, NULL, 0xF0, NULL, HFILL }},
      { &hf_rsvp_sonet_m, { "M", "rsvp_sonet_m", FT_UINT8, BASE_DEC, NULL, 0x0F, NULL, HFILL }},
      { &hf_rsvp_g709_t3, { "t3", "rsvp_g709_t3", FT_UINT16, BASE_DEC, NULL, 0x03F0, NULL, HFILL }},
      { &hf_rsvp_g709_t2, { "t2", "rsvp_g709_t2", FT_UINT8, BASE_DEC, NULL, 0x0E, NULL, HFILL }},
      { &hf_rsvp_g709_t1, { "t1", "rsvp_g709_t1", FT_UINT8, BASE_DEC, NULL, 0x01, NULL, HFILL }},
      { &hf_rsvp_ctype_label_set, { "C-Type", "rsvp_ctype_label_set", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_set_type, { "Label type", "rsvp_label_set_type", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_label_set_subchannel, { "Subchannel", "rsvp_label_set_subchannel", FT_UINT32, BASE_DEC_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_nsap_address, { "NSAP address", "rsvp_nsap_address", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_class_diversity, { "Diversity", "rsvp_class_diversity", FT_UINT8, BASE_DEC, VALS(ouni_guni_diversity_str), 0xF0, NULL, HFILL }},
      { &hf_rsvp_egress_label_type, { "Label type", "rsvp_egress_label_type", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_egress_label, { "Label", "rsvp_egress_label", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_source_transport_network_addr, { "Source Transport Network addr", "rsvp_source_transport_network_addr", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_ie_data, { "IE Data", "rsvp_ie_data", FT_BYTES, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_3gpp_obj_pf_dst_port_range, { "Destination Port range", "rsvp_3gpp_obj_pf_dst_port_range", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_rsvp_3gpp_obj_pf_src_port_range, { "Source Port range", "rsvp_3gpp_obj_pf_src_port_range", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
    };
