...
proto_register_ansi_a(void)
{
    ...
    static hf_register_info hf[] = {
        { &hf_ansi_a_bsmap_msgtype,
            { "BSMAP Message Type", "ansi_a_bsmap_msgtype",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_dtap_msgtype,
            { "DTAP Message Type", "ansi_a_bsmap_dtap_msgtype",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_protocol_disc,
            { "Protocol Discriminator", "ansi_a_bsmap_protocol_disc",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_reserved_octet,
            { "Reserved Octet", "ansi_a_bsmap_reserved_octet",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ti_flag,
            { "Transaction Identifier (TI) Flag", "ansi_a_bsmap_ti_flag",
            FT_BOOLEAN, 8, TFS(&tfs_allocated_by_receiver_sender), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_ti_ti,
            { "Transaction Identifier (TI)", "ansi_a_bsmap_ti_ti",
            FT_UINT8, BASE_DEC, NULL, 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm_svrc_type,
            { "CM Service Type", "ansi_a_bsmap_cm_srvc_type",
            FT_UINT8, BASE_DEC, VALS(dtap_cm_service_type_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_elem_id,
            { "Element ID", "ansi_a_bsmap_elem_id",
        ...
        { &hf_ansi_a_length,
            { "Length", "ansi_a_bsmap_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_esn,
            { "ESN", "ansi_a_bsmap_esn",
            FT_UINT32, BASE_HEX, 0, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_imsi,
            { "IMSI", "ansi_a_bsmap_imsi",
            FT_STRING, BASE_NONE, 0, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_meid,
            { "MEID", "ansi_a_bsmap_meid",
            FT_STRING, BASE_NONE, 0, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cld_party_bcd_num,
            { "Called Party BCD Number", "ansi_a_bsmap_cld_party_bcd_num",
            FT_STRING, BASE_NONE, 0, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cld_party_ascii_num,
            { "Called Party ASCII Number", "ansi_a_bsmap_cld_party_ascii_num",
            FT_STRING, BASE_NONE, 0, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_clg_party_ascii_num,
            { "Calling Party ASCII Number", "ansi_a_bsmap_clg_party_ascii_num",
            FT_STRING, BASE_NONE, 0, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cell_ci,
            { "Cell CI", "ansi_a_bsmap_cell_ci",
            FT_UINT16, BASE_HEX, 0, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cell_lac,
            { "Cell LAC", "ansi_a_bsmap_cell_lac",
            FT_UINT16, BASE_HEX, 0, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cell_mscid,
            { "Cell MSCID", "ansi_a_bsmap_cell_mscid",
            FT_UINT24, BASE_HEX, 0, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_pdsn_ip_addr,
            { "PDSN IP Address", "ansi_a_bsmap_pdsn_ip_addr",
            FT_IPv4, BASE_NONE, NULL, 0,
            "IP Address", HFILL }
        },
        { &hf_ansi_a_s_pdsn_ip_addr,
            { "Source PDSN Address", "ansi_a_bsmap_s_pdsn_ip_addr",
            FT_IPv4, BASE_NONE, NULL, 0,
            "IP Address", HFILL }
        },
        { &hf_ansi_a_anchor_ip_addr,
            { "Anchor PDSN Address", "ansi_a_bsmap_anchor_pdsn_ip_addr",
            FT_IPv4, BASE_NONE, NULL, 0,
            "IP Address", HFILL }
        },
        { &hf_ansi_a_anchor_pp_ip_addr,
            { "Anchor P-P Address", "ansi_a_bsmap_anchor_pp_ip_addr",
            FT_IPv4, BASE_NONE, NULL, 0,
            "IP Address", HFILL }
        },
        { &hf_ansi_a_so,
            { "Service Option", "ansi_a_bsmap_so",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_1,
            { "Cause", "ansi_a_bsmap_cause_1",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_2,
            { "Cause", "ansi_a_bsmap_cause_2",
            FT_UINT16, BASE_DEC, NULL, 0x7fff,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_info_rec_signal_type,
            { "Signal Type", "ansi_a_bsmap_ms_info_rec_signal_type",
            FT_UINT8, BASE_HEX, VALS(ansi_a_ms_info_rec_signal_type_vals), 0xc0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_info_rec_signal_alert_pitch,
            { "Alert Type", "ansi_a_bsmap_ms_info_rec_signal_alert_pitch",
            FT_UINT8, BASE_HEX, VALS(ansi_a_ms_info_rec_signal_alert_pitch_vals), 0x30,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_info_rec_signal_tone,
            { "Signal", "ansi_a_bsmap_ms_info_rec_signal_tone",
            FT_UINT16, BASE_HEX, VALS(ansi_a_ms_info_rec_signal_tone_vals), 0x0fc0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_info_rec_signal_isdn_alert,
            { "Signal", "ansi_a_bsmap_ms_info_rec_signal_isdn_alert",
            FT_UINT16, BASE_HEX, VALS(ansi_a_ms_info_rec_signal_isdn_alert_vals), 0x0fc0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_info_rec_signal_is54b_alert,
            { "Signal", "ansi_a_bsmap_ms_info_rec_signal_is54b_alert",
            FT_UINT16, BASE_HEX, VALS(ansi_a_ms_info_rec_signal_is54b_alert_vals), 0x0fc0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_info_rec_call_waiting_ind,
            { "Call Waiting Indicator", "ansi_a_bsmap_ms_info_rec_call_waiting_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_extension_8_80,
            { "Extended", "ansi_a_bsmap_extended",
            FT_UINT8, BASE_DEC, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_reserved_bits_8_generic,
            { "Reserved bit(s)", "ansi_a_bsmap_reserved",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        ...
        { &hf_ansi_a_channel_number,
            { "Channel Number", "ansi_a_bsmap_channel_number_channel_number",
        ...
        { &hf_ansi_a_speech_or_data_indicator,
            { "Speech or Data Indicator", "ansi_a_bsmap_channel_type_speech_or_data_indicator",
            FT_UINT8, BASE_HEX, VALS(ansi_a_speech_or_data_indicator_vals), 0x00,
            NULL, HFILL }
        },
        { &hf_ansi_a_chan_rate_and_type,
            { "Channel Rate and Type", "ansi_a_bsmap_channel_type_rate_and_type",
            FT_UINT8, BASE_HEX, VALS(ansi_a_channel_rate_and_type_vals), 0x00,
            NULL, HFILL }
        },
        { &hf_ansi_a_speech_enc_or_data_rate,
            { "Speech Encoding Algorithm/data rate + Transparency Indicator", "ansi_a_bsmap_channel_type_speech_enc_or_data_rate",
            FT_UINT8, BASE_HEX, VALS(ansi_a_speech_enc_or_data_rate_vals), 0x00,
            NULL, HFILL }
        },
        { &hf_ansi_a_chan_type_data_ext,
            { "Extension", "ansi_a_bsmap_channel_type_data_ext",
            FT_UINT8, BASE_DEC, NULL, 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_chan_type_data_transparent,
            { "Transparent", "ansi_a_bsmap_channel_type_data_transparent",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_return_cause,
            { "Return Cause", "ansi_a_bsmap_return_cause_cause",
            FT_UINT8, BASE_DEC, VALS(ansi_a_return_cause_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_rf_chan_id_color_code,
            { "Color Code", "ansi_a_bsmap_rf_channel_id_color_code",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rf_chan_id_n_amps_based,
            { "N-AMPS", "ansi_a_bsmap_rf_channel_id_n_amps_based",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_rf_chan_id_amps_based,
            { "ANSI/EIA/TIA-553", "ansi_a_bsmap_rf_channel_id_amps_based",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_rf_chan_id_timeslot,
            { "Timeslot Number", "ansi_a_bsmap_rf_channel_id_timeslot",
            FT_UINT8, BASE_DEC, VALS(ansi_a_rf_chan_id_timeslot_number_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_rf_chan_id_channel_number,
            { "Channel Number", "ansi_a_bsmap_rf_channel_id_channel_number",
            FT_UINT16, BASE_DEC, NULL, 0x07ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_sr_id,
            { "SR_ID", "ansi_a_bsmap_sr_id",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_sid,
            { "SID", "ansi_a_bsmap_sid",
            FT_UINT16, BASE_DEC, NULL, 0x7fff,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_hho,
            { "Hard Handoff", "ansi_a_bsmap_is95_chan_id_hho",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_num_chans_add,
            { "Number of Channels to Add", "ansi_a_bsmap_is95_chan_id_num_chans_add",
            FT_UINT8, BASE_DEC, NULL, 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_frame_offset,
            { "Frame Offset", "ansi_a_bsmap_is95_chan_id_frame_offset",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_walsh_code_chan_idx,
            { "Walsh Code Channel Index", "ansi_a_bsmap_is95_chan_id_walsh_code_chan_idx",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_pilot_pn,
            { "Pilot PN Code", "ansi_a_bsmap_is95_chan_id_pilot_pn",
            FT_UINT24, BASE_DEC, NULL, 0xff8000,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_power_combined,
            { "Power Combined", "ansi_a_bsmap_is95_chan_id_power_combined",
            FT_BOOLEAN, 24, TFS(&tfs_yes_no), 0x004000,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_freq_incl,
            { "Frequency Included", "ansi_a_bsmap_is95_chan_id_freq_incl",
            FT_BOOLEAN, 24, TFS(&tfs_yes_no), 0x002000,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_chan_id_channel_number,
            { "Channel Number", "ansi_a_bsmap_is95_chan_id_channel_number",
            FT_UINT24, BASE_DEC, NULL, 0x0007ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_enc_info_enc_parm_id,
            { "Encryption Parameter Identifier", "ansi_a_bsmap_enc_info_parm_id",
            FT_UINT8, BASE_DEC, VALS(ansi_a_enc_info_ident_vals), 0x7c,
            NULL, HFILL }
        },
        { &hf_ansi_a_enc_info_status,
            { "Status", "ansi_a_bsmap_enc_info_status",
            FT_UINT8, BASE_DEC, VALS(ansi_a_enc_info_status_vals), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_enc_info_available,
            { "Available", "ansi_a_bsmap_enc_info_available",
            FT_UINT8, BASE_DEC, VALS(ansi_a_enc_info_available_vals), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_mob_p_rev,
            { "MOB_P_REV", "ansi_a_bsmap_cm2_mob_p_rev",
            FT_UINT8, BASE_DEC, NULL, 0xe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_see_list,
            { "See List of Entries", "ansi_a_bsmap_cm2_see_list",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_rf_power_cap,
            { "RF Power Capability", "ansi_a_bsmap_cm2_rf_power_cap",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_rf_power_cap_vals), 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_nar_an_cap,
            { "NAR_AN_CAP", "ansi_a_bsmap_cm2_nar_an_cap",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_is95,
            { "IS-95 supported", "ansi_a_bsmap_cm2_is95",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_slotted,
            { "Operating in slotted mode", "ansi_a_bsmap_cm2_slotted",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_dtx,
            { "DTX capable", "ansi_a_bsmap_cm2_dtx",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_mobile_term,
            { "Mobile Term; can receive incoming calls", "ansi_a_bsmap_cm2_mobile_term",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_analog_cap,
            { "ANSI/EIA/TIA-553; supports analog capabilities", "ansi_a_bsmap_cm2_ansi_eia_tia_553",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_psi,
            { "PACA Supported Indicator (PSI)", "ansi_a_bsmap_cm2_psi",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_len,
            { "SCM Length", "ansi_a_bsmap_cm2_scm_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm,
            { "Station Class Mark", "ansi_a_bsmap_cm2_scm",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_ext_scm_ind,
            { "Extended SCM Indicator", "ansi_a_bsmap_cm2_scm_ext_scm_ind",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_scm_ext_scm_ind_vals), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_dual_mode,
            { "Dual Mode", "ansi_a_bsmap_cm2_scm_dual_mode",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_scm_dual_mode_vals), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_slotted,
            { "Slotted Class", "ansi_a_bsmap_cm2_scm_slotted_class",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_scm_slotted_class_vals), 0x20,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_meid_configured,
            { "MEID support indicator", "ansi_a_bsmap_cm2_scm_meid_configured",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_scm_meid_configured_vals), 0x10,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_25MHz_bandwidth,
            { "25 MHz Bandwidth", "ansi_a_bsmap_cm2_scm_25MHz_bandwidth",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_transmission,
            { "Transmission", "ansi_a_bsmap_cm2_scm_transmission",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_scm_transmission_vals), 0x04,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_power_class,
            { "Power Class for Band Class 0 Analog Operation", "ansi_a_bsmap_cm2_scm_power_class",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cm2_scm_power_class_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_band_class_count,
            { "Count of Band Class Entries", "ansi_a_bsmap_cm2_scm_band_class_count",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cm2_scm_band_class_entry_len,
            { "Band Class Entry Length", "ansi_a_bsmap_cm2_scm_band_class_entry_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_band_class,
            { "Band Class", "ansi_a_bsmap_cm2_scm_bc_entry_band_class",
            FT_UINT8, BASE_DEC, VALS(ansi_a_band_class_vals), 0x1f,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode0_1,
            { "Air Interface OP_MODE0:  CDMA mode in Band Class 1 and Band Class 4", "ansi_a_bsmap_cm2_scm_bc_entry_opmode0",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode1_1,
            { "Air Interface OP_MODE1:  CDMA mode in Band Class 0 and Band Class 3", "ansi_a_bsmap_cm2_scm_bc_entry_opmode1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode2_1,
            { "Air Interface OP_MODE2:  Reserved (Previously Analog mode)", "ansi_a_bsmap_cm2_scm_bc_entry_opmode2",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode3_1,
            { "Air Interface OP_MODE3:  Reserved (Previously Wide analog mode)", "ansi_a_bsmap_cm2_scm_bc_entry_opmode3",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode4_1,
            { "Air Interface OP_MODE4:  Reserved (Previously Narrow analog mode)", "ansi_a_bsmap_cm2_scm_bc_entry_opmode4",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode0_2,
            { "Air Interface OP_MODE0:  CDMA mode", "ansi_a_bsmap_cm2_scm_bc_entry_opmode0",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode1_2,
            { "Air Interface OP_MODE1:  CDMA mode", "ansi_a_bsmap_cm2_scm_bc_entry_opmode1",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        ...
        { &hf_ansi_a_scm_band_class_entry_opmode5_2,
            { "Air Interface OP_MODE5:  DS-41", "ansi_a_bsmap_cm2_scm_bc_entry_opmode5",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_opmode6_2,
            { "Air Interface OP_MODE6:  MC-MAP", "ansi_a_bsmap_cm2_scm_bc_entry_opmode6",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_scm_band_class_entry_p_rev,
            { "Band Class MS Protocol Level", "ansi_a_bsmap_cm2_scm_bc_entry_p_rev",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_meid_mid_digit_1,
            { "MEID Hex Digit 1", "ansi_a_bsmap_mid_digit_1",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_imsi_mid_digit_1,
            { "Identity Digit 1", "ansi_a_bsmap_mid_digit_1",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_odd_even_ind,
            { "Odd/Even Indicator", "ansi_a_bsmap_mid_odd_even_ind",
            FT_UINT8, BASE_DEC, VALS(ansi_a_mid_odd_even_ind_vals), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_type_of_id,
            { "Type of Identity", "ansi_a_bsmap_mid_type_of_identity",
            FT_UINT8, BASE_DEC, VALS(ansi_a_mid_type_vals), 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_broadcast_priority,
            { "Priority", "ansi_a_bsmap_mid_broadcast_priority",
            FT_UINT8, BASE_DEC, VALS(ansi_a_mid_broadcast_priority_vals), 0xc0,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_broadcast_message_id,
            { "Message ID", "ansi_a_bsmap_mid_broadcast_message_id",
            FT_UINT8, BASE_DEC, NULL, 0x2f,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_broadcast_zone_id,
            { "Zone ID", "ansi_a_bsmap_mid_broadcast_zone_id",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_broadcast_srvc_cat,
            { "Service Category", "ansi_a_bsmap_mid_broadcast_srvc_cat",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_broadcast_language,
            { "Language", "ansi_a_bsmap_mid_broadcast_language",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_mid_unused,
            { "Unused", "ansi_a_bsmap_mid_unused",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_sci_sign,
            { "SCI Sign", "ansi_a_bsmap_slot_cycle_index_sign",
            FT_UINT8, BASE_DEC, NULL, 0x08,
            "1 indicates a negative sign is associated with the SCI", HFILL }
        },
        { &hf_ansi_a_sci,
            { "Slot Cycle Index", "ansi_a_bsmap_slot_cycle_index",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_prio_call_priority,
            { "Call Priority Level", "ansi_a_bsmap_prio_call_priority",
            FT_UINT8, BASE_DEC, NULL, 0x3c,
            NULL, HFILL }
        },
        { &hf_ansi_a_prio_queue_allowed,
            { "Queuing allowed", "ansi_a_bsmap_prio_queuing_allowed",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_prio_preempt_allowed,
            { "Preemption allowed", "ansi_a_bsmap_prio_preempt_allowed",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_mob_p_rev,
            { "MOB_P_REV", "ansi_a_bsmap_mob_p_rev",
            FT_UINT8, BASE_DEC, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_1_ext,
            { "Extension", "ansi_a_bsmap_cause_ext",
            FT_UINT8, BASE_DEC, NULL, 0x80,
            NULL, HFILL }
        },
        ...
        { &hf_ansi_a_cell_id_disc,
            { "Cell Identification Discriminator", "ansi_a_bsmap_cell_id_discriminator",
            FT_UINT8, BASE_DEC, VALS(cell_disc_vals), 0x00,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic,
            { "CIC", "ansi_a_bsmap_cic",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic_pcm_multi,
            { "PCM Multiplexer", "ansi_a_bsmap_cic_pcm_multi",
            FT_UINT16, BASE_DEC, NULL, 0xffe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic_timeslot,
            { "Timeslot", "ansi_a_bsmap_cic_timeslot",
            FT_UINT16, BASE_DEC, NULL, 0x001f,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic_ext_cic,
            { "CIC", "ansi_a_bsmap_cic_ext_cic",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic_ext_pcm_multi,
            { "PCM Multiplexer", "ansi_a_bsmap_cic_ext_pcm_multi",
            FT_UINT16, BASE_DEC, NULL, 0xffe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic_ext_timeslot,
            { "Timeslot", "ansi_a_bsmap_cic_ext_timeslot",
            FT_UINT16, BASE_DEC, NULL, 0x001f,
            NULL, HFILL }
        },
        { &hf_ansi_a_cic_ext_circuit_mode,
            { "Circuit Mode", "ansi_a_bsmap_cic_ext_circuit_mode",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ssci_mopd,
            { "Mobile Originated Position Determination", "ansi_a_bsmap_ssci_mopd",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_ssci_geci,
            { "Global Emergency Call Indication", "ansi_a_bsmap_ssci_geci",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_downlink_re_num_cells,
            { "Number of Cells", "ansi_a_bsmap_downlink_re_num_cells",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_downlink_re_sig_str_raw,
            { "Downlink Signal Strength Raw", "ansi_a_bsmap_downlink_re_sig_str_raw",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_downlink_re_cdma_towd,
            { "CDMA Target One Way Delay", "ansi_a_bsmap_downlink_re_cdma_towd",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_downlink_re_entry_env_len,
            { "Environment Length", "ansi_a_bsmap_downlink_re_entry_env_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ho_pow_lev_num_cells,
            { "Number of Cells", "ansi_a_bsmap_ho_pow_lev_num_cells",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ho_pow_lev_id_type,
            { "ID Type", "ansi_a_bsmap_ho_pow_lev_id_type",
            FT_UINT8, BASE_DEC, NULL, 0x60,
            NULL, HFILL }
        },
        { &hf_ansi_a_ho_pow_lev_pow_lev,
            { "Handoff Power Level", "ansi_a_bsmap_ho_pow_lev_pow_lev",
            FT_UINT8, BASE_DEC, NULL, 0x1f,
            NULL, HFILL }
        },
        { &hf_ansi_a_uz_id,
            { "UZID", "ansi_a_bsmap_uzid",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_info_rec_req,
            { "Information Record Type", "ansi_a_bsmap_info_rec_rev_ms",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_otd,
            { "OTD", "ansi_a_bsmap_is2000_chan_id_otd",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            "1 indicates mobile is using OTD", HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_count,
            { "Physical Channel Count", "ansi_a_bsmap_is2000_chan_id_chan_count",
            FT_UINT8, BASE_DEC, NULL, 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_frame_offset,
            { "Frame Offset", "ansi_a_bsmap_is2000_chan_id_frame_offset",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_chan_type,
            { "Physical Channel Type", "ansi_a_bsmap_is2000_chan_id_chan_chan_type",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_rev_fch_gating,
            { "Rev_FCH_Gating", "ansi_a_bsmap_is2000_chan_id_chan_rev_fch_gating",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x8000,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_rev_pilot_gating_rate,
            { "Reverse Pilot Gating Rate", "ansi_a_bsmap_is2000_chan_id_chan_rev_pilot_gating_rate",
        ...
        { &hf_ansi_a_is2000_chan_id_chan_qof_mask,
            { "QOF Mask", "ansi_a_bsmap_is2000_chan_id_chan_qof_mask",
            FT_UINT16, BASE_DEC, NULL, 0x1800,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_walsh_code_chan_idx,
            { "Walsh Code Channel Index", "ansi_a_bsmap_is2000_chan_id_chan_walsh_code_chan_idx",
            FT_UINT16, BASE_DEC, NULL, 0x7ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_pilot_pn_code,
            { "Pilot PN Code", "ansi_a_bsmap_is2000_chan_id_chan_pilot_pn_code",
            FT_UINT24, BASE_DEC, NULL, 0xff8000,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_power_combined,
            { "Power Combined", "ansi_a_bsmap_is2000_chan_id_chan_power_combined",
            FT_BOOLEAN, 24, TFS(&tfs_yes_no), 0x001000,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_freq_incl,
            { "Frequency Included", "ansi_a_bsmap_is2000_chan_id_chan_freq_incl",
            FT_BOOLEAN, 24, TFS(&tfs_yes_no), 0x000800,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_channel_number,
            { "Channel Number (ARFCN)", "ansi_a_bsmap_is2000_chan_id_chan_channel_number",
            FT_UINT24, BASE_DEC, NULL, 0x0007ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_fdc_length,
            { "FDC Length", "ansi_a_bsmap_is2000_chan_id_chan_fdc_length",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_fdc_band_class,
            { "FDC Length", "ansi_a_bsmap_is2000_chan_id_chan_fdc_band_class",
            FT_UINT16, BASE_DEC, VALS(ansi_a_band_class_vals), 0xf800,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_fdc_fwd_chan_freq,
            { "FDC Forward Channel Frequency", "ansi_a_bsmap_is2000_chan_id_chan_fdc_fwd_chan_freq",
            FT_UINT16, BASE_DEC, NULL, 0x07ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_chan_id_chan_fdc_rev_chan_freq,
            { "FDC Reverse Channel Frequency", "ansi_a_bsmap_is2000_chan_id_chan_fdc_rev_chan_freq",
            FT_UINT16, BASE_DEC, NULL, 0xffe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_ms_meas_chan_id_band_class,   /* IOS 5 (MS Measured Channel Identity) */
            { "Band Class", "ansi_a_bsmap_is95_ms_meas_chan_id_band_class",
            FT_UINT16, BASE_DEC, VALS(ansi_a_band_class_vals), 0xf800,
            NULL, HFILL }
        },
        { &hf_ansi_a_is95_ms_meas_chan_id_channel_number,
            { "Channel Number (ARFCN)", "ansi_a_bsmap_is95_ms_meas_chan_id_channel_number",
            FT_UINT16, BASE_DEC, NULL, 0x07ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_clg_party_ascii_num_ton,
            { "Type of Number", "ansi_a_bsmap_clg_party_ascii_num_ton",
            FT_UINT8, BASE_DEC, VALS(ansi_a_clg_party_ascii_num_ton_vals), 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_clg_party_ascii_num_plan,
            { "Numbering Plan Identification", "ansi_a_bsmap_clg_party_ascii_num_plan",
            FT_UINT8, BASE_DEC, VALS(ansi_a_clg_party_ascii_num_plan_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_clg_party_ascii_num_pi,
            { "Presentation Indicator", "ansi_a_bsmap_clg_party_ascii_num_pi",
        ...
        { &hf_ansi_a_clg_party_ascii_num_si,
            { "Screening Indicator", "ansi_a_bsmap_clg_party_ascii_num_si",
            /* not a typo, MS Info Rec and CLG Party ASCII have the same definition for this field */
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_clg_pn_si_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_lai_mcc,
            { "Mobile Country Code (MCC)", "ansi_a_bsmap_lai_mcc",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_lai_mnc,
            { "Mobile Network Code (MNC)", "ansi_a_bsmap_lai_mnc",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_lai_lac,
            { "Location Area Code", "ansi_a_bsmap_lai_lac",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rej_cause,
            { "Reject Cause Value", "ansi_a_bsmap_rej_cause",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_chlg_param_rand_num_type,
            { "Random Number Type", "ansi_a_bsmap_auth_chlg_param_rand_num_type",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_chlg_param_rand,
            { "RAND/RANDU/RANDBS/RANDSSD Value", "ansi_a_bsmap_auth_chlg_param_rand",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_resp_param_sig_type,
            { "Auth Signature Type", "ansi_a_bsmap_auth_resp_param_sig_type",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_resp_param_sig,
            { "Auth Signature", "ansi_a_bsmap_auth_resp_param_sig",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_param_count_count,
            { "Count", "ansi_a_bsmap_auth_param_count_count",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_mwi_num_messages,
            { "Number of Messages", "ansi_a_bsmap_mwi_num_messages",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_signal_signal_value,
            { "Signal Value", "ansi_a_bsmap_signal_signal_value",
            FT_UINT8, BASE_DEC, VALS(ansi_a_signal_signal_vals), 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_signal_alert_pitch,
            { "Alert Pitch", "ansi_a_bsmap_signal_alert_pitch",
            FT_UINT8, BASE_DEC, VALS(ansi_a_signal_alert_pitch_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_clg_party_bcd_num_ton,
            { "Type of Number", "ansi_a_bsmap_clg_party_bcd_num_ton",
        ...
        { &hf_ansi_a_clg_party_bcd_num_plan,
            { "Numbering Plan Identification", "ansi_a_bsmap_clg_party_bcd_num_plan",
            /* not a typo, CLG and CLD have the same definition for this field */
            FT_UINT8, BASE_DEC, VALS(ansi_a_cld_party_bcd_num_plan_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_qos_params_packet_priority,
            { "Packet Priority", "ansi_a_bsmap_qos_params_packet_priority",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_l3_coding_standard,
            { "Coding Standard", "ansi_a_bsmap_cause_l3_coding_standard",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cause_l3_coding_standard_vals), 0x60,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_l3_location,
            { "Location", "ansi_a_bsmap_cause_l3_location",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cause_l3_location_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_l3_class,
            { "Class", "ansi_a_bsmap_cause_l3_class",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cause_l3_class_vals), 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_l3_value_without_class,
            { "Value (Without class)", "ansi_a_bsmap_cause_l3_value_without_class",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_cause_l3_value,
            { "Value", "ansi_a_bsmap_cause_l3_value",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_conf_param_randc,
            { "RANDC", "ansi_a_bsmap_auth_conf_param_randc",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_xmode_tfo_mode,
            { "TFO Mode", "ansi_a_bsmap_xmode_tfo_mode",
            FT_BOOLEAN, 8, TFS(&tfs_ansi_a_xmode_tfo_mode), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_reg_type_type,
            { "Location Registration Type", "ansi_a_bsmap_reg_type_type",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_tag_value,
            { "Tag value", "ansi_a_bsmap_tag_value",
            FT_UINT32, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_band_class,
            { "Band Class", "ansi_a_bsmap_hho_params_band_class",
            FT_UINT8, BASE_DEC, VALS(ansi_a_band_class_vals), 0x1f,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_num_pream_frames,
            { "Number of Preamble Frames", "ansi_a_bsmap_hho_params_num_pream_frames",
            FT_UINT8, BASE_DEC, NULL, 0xe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_reset_l2,
            { "Reset L2", "ansi_a_bsmap_hho_params_reset_l2",
            FT_BOOLEAN, 8, TFS(&tfs_l2_reset_dont_reset), 0x10,
            "1 means reset Layer 2 Ack", HFILL }
        },
        { &hf_ansi_a_hho_params_reset_fpc,
            { "Reset FPC", "ansi_a_bsmap_hho_params_reset_fpc",
            FT_BOOLEAN, 8, TFS(&tfs_fpc_reset_dont_reset), 0x08,
            "1 means reset counters", HFILL }
        },
        { &hf_ansi_a_hho_params_enc_mode,
            { "Encryption Mode", "ansi_a_bsmap_hho_params_enc_mode",
            FT_BOOLEAN, 8, TFS(&tfs_enabled_disabled), 0x06,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_private_lcm,
            { "Private LCM", "ansi_a_bsmap_hho_params_private_lcm",
            FT_BOOLEAN, 8, TFS(&tfs_use_dont_use), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_rev_pwr_cntl_delay_incl,
            { "Rev_Pwr_Cntl_Delay_Incl", "ansi_a_bsmap_hho_params_rev_pwr_cntl_delay_incl",
            FT_BOOLEAN, 8, TFS(&tfs_use_dont_use), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_rev_pwr_cntl_delay,
            { "Rev_Pwr_Cntl_Delay", "ansi_a_bsmap_hho_params_rev_pwr_cntl_delay",
            FT_UINT8, BASE_DEC, NULL, 0x60,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_nom_pwr_ext,
            { "Nom_Pwr_Ext", "ansi_a_bsmap_hho_params_nom_pwr_ext",
            FT_UINT8, BASE_DEC, NULL, 0x10,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_nom_pwr,
            { "Nom_Pwr", "ansi_a_bsmap_hho_params_nom_pwr",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_fpc_subchan_info,
            { "FPC Subchannel Information", "ansi_a_bsmap_hho_params_fpc_subchan_info",
            FT_UINT8, BASE_DEC, NULL, 0x3e,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_fpc_subchan_info_incl,
            { "FPC Subchannel Info Included", "ansi_a_bsmap_hho_params_fpc_subchan_info_incl",
            FT_BOOLEAN, 8, TFS(&tfs_use_dont_use), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_pwr_cntl_step,
            { "Power Control Step", "ansi_a_bsmap_hho_params_pwr_cntl_step",
            FT_UINT8, BASE_DEC, NULL, 0x0e,
            NULL, HFILL }
        },
        { &hf_ansi_a_hho_params_pwr_cntl_step_incl,
            { "Power Control Step Included", "ansi_a_bsmap_hho_params_pwr_cntl_step_incl",
            FT_BOOLEAN, 8, TFS(&tfs_use_dont_use), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_sw_ver_major,
            { "IOS Major Revision Level", "ansi_a_bsmap_sw_ver_major",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_sw_ver_minor,
            { "IOS Minor Revision Level", "ansi_a_bsmap_sw_ver_minor",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_sw_ver_point,
            { "IOS Point Release Level", "ansi_a_bsmap_sw_ver_point",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_so_proprietary_ind,
            { "Proprietary Indicator", "ansi_a_bsmap_so_proprietary_ind",
            FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x8000,
            NULL, HFILL }
        },
        { &hf_ansi_a_so_revision,
            { "Service Option Revision", "ansi_a_bsmap_so_revision",
            FT_UINT16, BASE_DEC, NULL, 0x7000,
            NULL, HFILL }
        },
        { &hf_ansi_a_so_base_so_num,
            { "Base Service Option Number", "ansi_a_bsmap_so_base_so_num",
            FT_UINT16, BASE_DEC, NULL, 0x0fff,
            NULL, HFILL }
        },
        { &hf_ansi_a_soci,
            { "Service Option Connection Identifier", "ansi_a_bsmap_soci",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_so_list_num,
            { "Number of Service Option instances", "ansi_a_bsmap_so_list_num",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_so_list_sr_id,
            { "SR_ID", "ansi_a_bsmap_so_list_sr_id",
            FT_UINT8, BASE_DEC, NULL, 0x38,
            NULL, HFILL }
        },
        { &hf_ansi_a_so_list_soci,
            { "SOCI", "ansi_a_bsmap_so_list_soci",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_nid,
            { "NID", "ansi_a_bsmap_nid",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_pzid,
            { "PZID", "ansi_a_bsmap_pzid",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_adds_user_part_burst_type,
            { "Data Burst Type", "ansi_a_bsmap_adds_user_part_burst_type",
            FT_UINT8, BASE_DEC, VALS(ansi_a_adds_vals), 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_adds_user_part_ext_burst_type,
            { "Extended Burst Type", "ansi_a_bsmap_adds_user_part_ext_burst_type",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_adds_user_part_ext_data,
            { "Data", "ansi_a_bsmap_adds_user_part_ext_data",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_adds_user_part_unknown_data,
            { "Data", "ansi_a_bsmap_adds_user_part_unknown_data",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_amps_hho_params_enc_mode,
            { "Encryption Mode", "ansi_a_bsmap_amps_hho_params_enc_mode",
            FT_BOOLEAN, 8, TFS(&tfs_enabled_disabled), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_num_fill_bits,
            { "Bit-Exact Length Fill Bits", "ansi_a_bsmap_is2000_scr_num_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_for_mux_option,
            { "FOR_MUX_OPTION:  Forward Traffic Channel multiplex option", "ansi_a_bsmap_is2000_scr_for_mux_opt",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_rev_mux_option,
            { "REV_MUX_OPTION:  Reverse Traffic Channel multiplex option", "ansi_a_bsmap_is2000_scr_rev_mux_opt",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_for_fch_rate,
            { "FOR_RATES:  Transmission rates of the Forward Fundamental Channel", "ansi_a_bsmap_is2000_scr_for_fch_rate",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_rev_fch_rate,
            { "REV_RATES:  Transmission rates of the Reverse Fundamental Channel", "ansi_a_bsmap_is2000_scr_rev_fch_rate",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_num_socr,
            { "NUM_CON_REC:  Number of service option connection records", "ansi_a_bsmap_is2000_scr_num_socr",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_soc_ref,
            { "CON_REF:  Service option connection reference", "ansi_a_bsmap_is2000_scr_socr_soc_ref",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_so,
            { "SERVICE_OPTION", "ansi_a_bsmap_is2000_scr_socr_so",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_for_chan_type,
            { "FOR_TRAFFIC", "ansi_a_bsmap_is2000_scr_socr_for_chan_type",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rev_chan_type,
            { "REV_TRAFFIC", "ansi_a_bsmap_is2000_scr_socr_rev_chan_type",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_ui_enc_mode,
            { "UI_ENCRYPT_MODE:  Encryption mode indicator for user information privacy", "ansi_a_bsmap_is2000_scr_socr_ui_enc_mode",
            FT_UINT8, BASE_DEC, NULL, 0xe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_sr_id,
            { "SR_ID:  Service reference identifier", "ansi_a_bsmap_is2000_scr_socr_sr_id",
            FT_UINT8, BASE_DEC, NULL, 0x1c,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rlp_info_incl,
            { "RLP_INFO_INCL:  RLP information included indicator", "ansi_a_bsmap_is2000_scr_socr_rlp_info_incl",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rlp_blob_len,
            { "RLP_BLOB_LEN", "ansi_a_bsmap_is2000_scr_socr_rlp_blob_len",
            FT_UINT16, BASE_DEC, NULL, 0x01E0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rlp_blob_msb,
            { "RLP_BLOB (MSB)", "ansi_a_bsmap_is2000_scr_socr_rlp_blob_msb",
            FT_UINT8, BASE_DEC, NULL, 0x1f,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rlp_blob,
            { "RLP_BLOB", "ansi_a_bsmap_is2000_scr_socr_rlp_blob",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rlp_blob_lsb,
            { "RLP_BLOB (LSB)", "ansi_a_bsmap_is2000_scr_socr_rlp_blob_lsb",
            FT_UINT8, BASE_DEC, NULL, 0xe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_fch_cc_incl,
            { "FCH_CC_INCL:  Channel configuration for the Fundamental Channel included indicator", "ansi_a_bsmap_is2000_scr_socr_fch_cc_incl",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_fch_frame_size_support_ind,
            { "FCH_FRAME_SIZE:  Fundamental Channel frame size supported indicator", "ansi_a_bsmap_is2000_scr_socr_fch_frame_size_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_for_fch_rc,
            { "FOR_FCH_RC:  Forward Fundamental Channel Radio Configuration", "ansi_a_bsmap_is2000_scr_socr_for_fch_rc",
            FT_UINT8, BASE_DEC, NULL, 0x3e,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_scr_socr_rev_fch_rc,
            { "REV_FCH_RC", "ansi_a_bsmap_is2000_scr_socr_rev_fch_rc",
            FT_UINT16, BASE_DEC, NULL, 0x01F0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_nn_scr_num_fill_bits,
            { "Bit-Exact Length Fill Bits", "ansi_a_bsmap_is2000_nn_scr_num_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_nn_scr_content,
            { "IS-2000 Non-Negotiable Service Configuration Record Content", "ansi_a_bsmap_is2000_nn_scr_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_nn_scr_fill_bits,
            { "Fill Bits", "ansi_a_bsmap_is2000_nn_scr_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_rev_pdch_support_ind,
            { "REV_PDCH:  IS-2000 R-PDCH supported", "ansi_a_bsmap_is2000_mob_cap_rev_pdch_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_for_pdch_support_ind,
            { "FOR_PDCH:  IS-2000 F-PDCH supported", "ansi_a_bsmap_is2000_mob_cap_for_pdch_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_eram_support_ind,
            { "ERAM:  Enhanced Rate Adaptation Mode supported", "ansi_a_bsmap_is2000_mob_cap_eram_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_dcch_support_ind,
            { "DCCH:  IS-2000 DCCH supported", "ansi_a_bsmap_is2000_mob_cap_dcch_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_fch_support_ind,
            { "FCH:  IS-2000 FCH supported", "ansi_a_bsmap_is2000_mob_cap_fch_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_otd_support_ind,
            { "OTD:  Orthogonal Transmit Diversity supported", "ansi_a_bsmap_is2000_mob_cap_otd_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_enh_rc_cfg_support_ind,
            { "Enhanced RC CFG Supported:  Radio configuration in radio class 2 supported", "ansi_a_bsmap_is2000_mob_cap_enh_rc_cfg_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_qpch_support_ind,
            { "QPCH Supported:  Quick Paging Channel supported", "ansi_a_bsmap_is2000_mob_cap_qpch_support_ind",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_fch_info_octet_len,
            { "FCH Information:  Bit-Exact Length Octet Count", "ansi_a_bsmap_is2000_mob_cap_fch_info_octet_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_fch_info_geo_loc_type,
            { "Geo Location Type", "ansi_a_bsmap_is2000_mob_cap_fch_info_geo_loc_type",
        ...
        { &hf_ansi_a_is2000_mob_cap_fch_info_geo_loc_incl,
            { "Geo Location Included", "ansi_a_bsmap_is2000_mob_cap_fch_info_geo_loc_incl",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_fch_info_num_fill_bits,
            { "Bit-Exact Length Fill Bits", "ansi_a_bsmap_is2000_mob_cap_fch_info_num_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_fch_info_content,
            { "FCH Information Content", "ansi_a_bsmap_is2000_mob_cap_fch_info_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_fch_info_fill_bits,
            { "Fill Bits", "ansi_a_bsmap_is2000_mob_cap_fch_info_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_dcch_info_octet_len,
            { "DCCH Information:  Bit-Exact Length Octet Count", "ansi_a_bsmap_is2000_mob_cap_dcch_info_octet_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_dcch_info_num_fill_bits,
            { "Bit-Exact Length Fill Bits", "ansi_a_bsmap_is2000_mob_cap_dcch_info_num_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_dcch_info_content,
            { "DCCH Information Content", "ansi_a_bsmap_is2000_mob_cap_dcch_info_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_dcch_info_fill_bits,
            { "Fill Bits", "ansi_a_bsmap_is2000_mob_cap_dcch_info_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_for_pdch_info_octet_len,
            { "FOR_PDCH Information:  Bit-Exact Length Octet Count", "ansi_a_bsmap_is2000_mob_cap_for_pdch_info_octet_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_for_pdch_info_num_fill_bits,
            { "Bit-Exact Length Fill Bits", "ansi_a_bsmap_is2000_mob_cap_for_pdch_info_num_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_for_pdch_info_content,
            { "FOR_PDCH Information Content", "ansi_a_bsmap_is2000_mob_cap_for_pdch_info_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_for_pdch_info_fill_bits,
            { "Fill Bits", "ansi_a_bsmap_is2000_mob_cap_for_pdch_info_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_rev_pdch_info_octet_len,
            { "REV_PDCH Information:  Bit-Exact Length Octet Count", "ansi_a_bsmap_is2000_mob_cap_rev_pdch_info_octet_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_rev_pdch_info_num_fill_bits,
            { "Bit-Exact Length Fill Bits", "ansi_a_bsmap_is2000_mob_cap_rev_pdch_info_num_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_rev_pdch_info_content,
            { "REV_PDCH Information Content", "ansi_a_bsmap_is2000_mob_cap_rev_pdch_info_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_rev_pdch_info_fill_bits,
            { "Fill Bits", "ansi_a_bsmap_is2000_mob_cap_rev_pdch_info_fill_bits",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support,
            { "VP Algorithms Supported", "ansi_a_bsmap_is2000_mob_cap_vp_support",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a7,
            { "VP Algorithm A7", "ansi_a_bsmap_is2000_mob_cap_vp_support_a7",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_no_voice_privacy), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a6,
            { "VP Algorithm A6", "ansi_a_bsmap_is2000_mob_cap_vp_support_a6",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_no_voice_privacy), 0x20,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a5,
            { "VP Algorithm A5", "ansi_a_bsmap_is2000_mob_cap_vp_support_a5",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_no_voice_privacy), 0x10,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a4,
            { "VP Algorithm A4", "ansi_a_bsmap_is2000_mob_cap_vp_support_a4",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_no_voice_privacy), 0x08,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a3,
            { "VP Algorithm A3", "ansi_a_bsmap_is2000_mob_cap_vp_support_a3",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_no_voice_privacy), 0x04,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a2,
            { "VP Algorithm A2", "ansi_a_bsmap_is2000_mob_cap_vp_support_a2",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_aes), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_mob_cap_vp_support_a1,
            { "VP Algorithm A1", "ansi_a_bsmap_is2000_mob_cap_vp_support_a1",
            FT_BOOLEAN, 8, TFS(&tfs_reserved_private_long_code), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_protocol_type,
            { "Protocol Type", "ansi_a_bsmap_protocol_type",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_cld_pn_num_type,
            { "Forward MS Information Record Called Party Number:  Number Type", "ansi_a_bsmap_fwd_ms_info_rec_cld_pn_num_type",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_num_type_vals), 0xe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_cld_pn_num_plan,
            { "Forward MS Information Record Called Party Number:  Number Plan", "ansi_a_bsmap_fwd_ms_info_rec_cld_pn_num_plan",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_num_plan_vals), 0x1e,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_cld_pn_num,
            { "Forward MS Information Record Called Party Number:  Number", "ansi_a_bsmap_fwd_ms_info_rec_cld_pn_num",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_clg_pn_num_type,
            { "Forward MS Information Record Calling Party Number:  Number Type", "ansi_a_bsmap_fwd_ms_info_rec_clg_pn_num_type",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_num_type_vals), 0xe000,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_clg_pn_num_plan,
            { "Forward MS Information Record Calling Party Number:  Number Plan", "ansi_a_bsmap_fwd_ms_info_rec_clg_pn_num_plan",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_num_plan_vals), 0x1e00,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_clg_pn_num,
            { "Forward MS Information Record Calling Party Number:  Number", "ansi_a_bsmap_fwd_ms_info_rec_clg_pn_num",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_clg_pn_pi,
            { "Forward MS Information Record Calling Party Number:  PI", "ansi_a_bsmap_fwd_ms_info_rec_clg_pn_pi",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_clg_pn_pi_vals), 0x0180,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_clg_pn_si,
            { "Forward MS Information Record Calling Party Number:  SI", "ansi_a_bsmap_fwd_ms_info_rec_clg_pn_si",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_clg_pn_si_vals), 0x0060,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_mw_num,
            { "Number of messages waiting", "ansi_a_bsmap_fwd_ms_info_rec_mw_num",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_fwd_ms_info_rec_content,
            { "Forward MS Information Record Content", "ansi_a_bsmap_fwd_ms_info_rec_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_cld_pn_num_type,
            { "Reverse MS Information Record Called Party Number:  Number Type", "ansi_a_bsmap_rev_ms_info_rec_cld_pn_num_type",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_num_type_vals), 0xe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_cld_pn_num_plan,
            { "Reverse MS Information Record Called Party Number:  Number Plan", "ansi_a_bsmap_rev_ms_info_rec_cld_pn_num_plan",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ms_info_rec_num_plan_vals), 0x1e,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_cld_pn_num,
            { "Reverse MS Information Record Called Party Number:  Number", "ansi_a_bsmap_rev_ms_info_rec_cld_pn_num",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_clg_pn_num_type,
            { "Reverse MS Information Record Calling Party Number:  Number Type", "ansi_a_bsmap_rev_ms_info_rec_clg_pn_num_type",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_num_type_vals), 0xe000,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_clg_pn_num_plan,
            { "Reverse MS Information Record Calling Party Number:  Number Plan", "ansi_a_bsmap_rev_ms_info_rec_clg_pn_num_plan",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_num_plan_vals), 0x1e00,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_clg_pn_pi,
            { "Reverse MS Information Record Calling Party Number:  PI", "ansi_a_bsmap_rev_ms_info_rec_clg_pn_pi",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_clg_pn_pi_vals), 0x0180,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_clg_pn_si,
            { "Reverse MS Information Record Calling Party Number:  SI", "ansi_a_bsmap_rev_ms_info_rec_clg_pn_si",
            FT_UINT16, BASE_DEC, VALS(ansi_a_ms_info_rec_clg_pn_si_vals), 0x0060,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_clg_pn_num,
            { "Reverse MS Information Record Calling Party Number:  Number", "ansi_a_bsmap_rev_ms_info_rec_clg_pn_num",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_so_info_fwd_support,
            { "Forward Support", "ansi_a_bsmap_rev_ms_info_rec_so_info_fwd_support",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_so_info_rev_support,
            { "Reverse Support", "ansi_a_bsmap_rev_ms_info_rec_so_info_rev_support",
            FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_so_info_so,
            { "Service Option", "ansi_a_bsmap_rev_ms_info_rec_so_info_so",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_ms_info_rec_content,
            { "Reverse MS Information Record Content", "ansi_a_bsmap_rev_ms_info_rec_content",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_srch_win_a,
            { "Search Window A Size (Srch_Win_A)", "ansi_a_bsmap_ext_ho_dir_params_srch_win_a",
            FT_UINT8, BASE_DEC, VALS(ansi_a_srch_win_sizes_vals), 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_srch_win_n,
            { "Search Window N Size (Srch_Win_N)", "ansi_a_bsmap_ext_ho_dir_params_srch_win_n",
            FT_UINT8, BASE_DEC, VALS(ansi_a_srch_win_sizes_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_srch_win_r,
            { "Search Window R Size (Srch_Win_R)", "ansi_a_bsmap_ext_ho_dir_params_srch_win_r",
            FT_UINT8, BASE_DEC, VALS(ansi_a_srch_win_sizes_vals), 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_t_add,
            { "Add Pilot Threshold (T_Add)", "ansi_a_bsmap_ext_ho_dir_params_t_add",
            FT_UINT16, BASE_DEC, NULL, 0x0fc0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_t_drop,
            { "Drop Pilot Threshold (T_Drop)", "ansi_a_bsmap_ext_ho_dir_params_t_drop",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_t_comp,
            { "Compare Threshold (T_Comp)", "ansi_a_bsmap_ext_ho_dir_params_t_comp",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_t_tdrop,
            { "Drop Timer Value (T_TDrop)", "ansi_a_bsmap_ext_ho_dir_params_t_tdrop",
            FT_UINT8, BASE_DEC, VALS(ansi_a_t_tdrop_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_nghbor_max_age,
            { "Neighbor Max Age (Nghbor_Max_AGE)", "ansi_a_bsmap_ext_ho_dir_params_nghbor_max_age",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_target_bs_values_incl,
            { "Target BS Values Included", "ansi_a_bsmap_ext_ho_dir_params_target_bs_values_incl",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ext_ho_dir_params_target_bs_values_incl_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_soft_slope,
            { "SOFT_SLOPE", "ansi_a_bsmap_ext_ho_dir_params_soft_slope",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_add_intercept,
            { "ADD_INTERCEPT", "ansi_a_bsmap_ext_ho_dir_params_add_intercept",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_drop_intercept,
            { "DROP_INTERCEPT", "ansi_a_bsmap_ext_ho_dir_params_drop_intercept",
            FT_UINT8, BASE_DEC, NULL, 0x3f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ext_ho_dir_params_target_bs_p_rev,
            { "Target BS P_REV", "ansi_a_bsmap_ext_ho_dir_params_target_bs_p_rev",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cdma_sowd_sowd,
            { "CDMA Serving One Way Delay", "ansi_a_bsmap_cdma_sowd_sowd",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cdma_sowd_resolution,
            { "Resolution", "ansi_a_bsmap_cdma_sowd_resolution",
            FT_UINT8, BASE_DEC, VALS(ansi_a_cdma_sowd_resolution_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_cdma_sowd_timestamp,
            { "CDMA Serving One Way Delay Time Stamp", "ansi_a_bsmap_cdma_sowd_timestamp",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_re_res_prio_incl,
            { "Include Priority", "ansi_a_bsmap_re_res_prio_incl",
            FT_BOOLEAN, 8, TFS(&tfs_prio_incl_yes_no), 0x40,
            NULL, HFILL }
        },
        { &hf_ansi_a_re_res_forward,
            { "Forward", "ansi_a_bsmap_re_res_forward",
            FT_UINT8, BASE_DEC, VALS(ansi_a_re_res_vals), 0x30,
            NULL, HFILL }
        },
        { &hf_ansi_a_re_res_reverse,
            { "Reverse", "ansi_a_bsmap_re_res_reverse",
            FT_UINT8, BASE_DEC, VALS(ansi_a_re_res_vals), 0x0c,
            NULL, HFILL }
        },
        { &hf_ansi_a_re_res_alloc,
            { "Alloc", "ansi_a_bsmap_re_res_alloc",
            FT_BOOLEAN, 8, TFS(&tfs_alloc_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_re_res_avail,
            { "Avail", "ansi_a_bsmap_re_res_avail",
            FT_BOOLEAN, 8, TFS(&tfs_avail_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_cld_party_ascii_num_ton,
            { "Type of Number", "ansi_a_bsmap_cld_party_ascii_num_ton",
            /* Should actually be as defined by ATIS-1000607.2000 (but I don't have that) */
            FT_UINT8, BASE_DEC, VALS(ansi_a_cld_party_bcd_num_ton_vals), 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_cld_party_ascii_num_plan,
            { "Numbering Plan Identification", "ansi_a_bsmap_cld_party_ascii_num_plan",
            /* Should actually be as defined by ATIS-1000607.2000 (but I don't have that) */
            FT_UINT8, BASE_DEC, VALS(ansi_a_cld_party_bcd_num_plan_vals), 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_band_class,
            { "Band Class", "ansi_a_bsmap_band_class",
            FT_UINT8, BASE_DEC, VALS(ansi_a_band_class_vals), 0x1f,
            NULL, HFILL }
        },
        { &hf_ansi_a_is2000_cause,
            { "Cause", "ansi_a_bsmap_is2000_cause",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_auth_event,
            { "Event", "ansi_a_bsmap_auth_event",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_psmm_count,
            { "PSMM Count", "ansi_a_bsmap_psmm_count",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_geo_loc,
            { "Calling Geodetic Location (CGL)", "ansi_a_bsmap_geo_loc",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cct_group_all_circuits,
            { "All Circuits", "ansi_a_bsmap_cct_group_all_circuits",
            FT_BOOLEAN, 8, TFS(&tfs_avail_yes_no), 0x02,
            NULL, HFILL }
        },
        { &hf_ansi_a_cct_group_inclusive,
            { "Inclusive", "ansi_a_bsmap_cct_group_inclusive",
            FT_BOOLEAN, 8, TFS(&tfs_avail_yes_no), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_cct_group_count,
            { "Count", "ansi_a_bsmap_cct_group_count",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cct_group_first_cic,
            { "First CIC", "ansi_a_bsmap_cct_group_first_cic",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cct_group_first_cic_pcm_multi,
            { "First CIC PCM Multiplexer", "ansi_a_bsmap_cct_group_first_cic_pcm_multi",
            FT_UINT16, BASE_DEC, NULL, 0xffe0,
            NULL, HFILL }
        },
        { &hf_ansi_a_cct_group_first_cic_timeslot,
            { "First CIC Timeslot", "ansi_a_bsmap_cct_group_first_cic_timeslot",
            FT_UINT16, BASE_DEC, NULL, 0x001f,
            NULL, HFILL }
        },
        { &hf_ansi_a_paca_timestamp_queuing_time,
            { "PACA Queuing Time", "ansi_a_bsmap_paca_timestamp_queuing_time",
            FT_UINT32, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_paca_order_action_reqd,
            { "PACA Action Required", "ansi_a_bsmap_paca_order_action_reqd",
            FT_UINT8, BASE_DEC, VALS(ansi_a_paca_order_action_reqd_vals), 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_paca_reoi_pri,
            { "PACA Reorigination Indicator (PRI)", "ansi_a_bsmap_paca_reoi_pri",
            FT_BOOLEAN, 8, TFS(&tfs_reoi_pri_reorig_no_reorig), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_sess_max_frames,
            { "Max Frames", "ansi_a_bsmap_a2p_bearer_sess_max_frames",
            FT_UINT8, BASE_DEC, NULL, 0x38,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_sess_ip_addr_type,
            { "Session IP Address Type", "ansi_a_bsmap_a2p_bearer_sess_ip_addr_type",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ip_addr_type_vals), 0x06,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_sess_addr_flag,
            { "Session Address Flag", "ansi_a_bsmap_a2p_bearer_sess_addr_flag",
            FT_BOOLEAN, 8, TFS(&tfs_a2p_bearer_sess_addr_flag), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_sess_ipv4_addr,
            { "Session IP Address", "ansi_a_bsmap_a2p_bearer_sess_ipv4_addr",
            FT_IPv4, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_sess_ipv6_addr,
            { "Session IP Address", "ansi_a_bsmap_a2p_bearer_sess_ipv6_addr",
            FT_IPv6, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_sess_udp_port,
            { "Session UDP Port", "ansi_a_bsmap_a2p_bearer_sess_udp_port",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_num_formats,
            { "Number of Bearer Formats", "ansi_a_bsmap_a2p_bearer_form_num_formats",
            FT_UINT8, BASE_DEC, NULL, 0xfc,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_ip_addr_type,
            { "Bearer IP Address Type", "ansi_a_bsmap_a2p_bearer_form_ip_addr_type",
            FT_UINT8, BASE_DEC, VALS(ansi_a_ip_addr_type_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_len,
            { "Bearer Format Length", "ansi_a_bsmap_a2p_bearer_form_format_len",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_tag_type,
            { "Bearer Format Tag Type", "ansi_a_bsmap_a2p_bearer_form_format_tag_type",
            FT_UINT8, BASE_DEC, VALS(ansi_a_a2p_bearer_form_format_tag_type_vals), 0x70,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_format_id,
            { "Bearer Format ID", "ansi_a_bsmap_a2p_bearer_form_format_format_id",
        ...
        { &hf_ansi_a_a2p_bearer_form_format_rtp_payload_type,
            { "RTP Payload Type", "ansi_a_bsmap_a2p_bearer_form_format_rtp_payload_type",
            FT_UINT8, BASE_DEC, NULL, 0xfe,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_bearer_addr_flag,
            { "Bearer Address Flag", "ansi_a_bsmap_a2p_bearer_form_format_bearer_addr_flag",
            FT_BOOLEAN, 8, TFS(&tfs_a2p_bearer_form_format_bearer_addr_flag), 0x01,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_ipv4_addr,
            { "Bearer IP Address", "ansi_a_bsmap_a2p_bearer_form_format_ipv4_addr",
            FT_IPv4, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_ipv6_addr,
            { "Bearer IP Address", "ansi_a_bsmap_a2p_bearer_form_format_ipv6_addr",
            FT_IPv6, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_udp_port,
            { "Bearer UDP Port", "ansi_a_bsmap_a2p_bearer_form_format_udp_port",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_ext_len,
            { "Extension Length", "ansi_a_bsmap_a2p_bearer_form_format_ext_len",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_a2p_bearer_form_format_ext_id,
            { "Extension ID", "ansi_a_bsmap_a2p_bearer_form_format_ext_id",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_des_freq_band_class,
            { "Band Class", "ansi_a_bsmap_ms_des_freq_band_class",
            FT_UINT16, BASE_DEC, VALS(ansi_a_band_class_vals), 0xf800,
            NULL, HFILL }
        },
        { &hf_ansi_a_ms_des_freq_cdma_channel,
            { "CDMA Channel", "ansi_a_bsmap_ms_des_freq_cdma_channel",
            FT_UINT16, BASE_DEC, NULL, 0x07ff,
            NULL, HFILL }
        },
        { &hf_ansi_a_plcm_id_plcm_type,
            { "PLCM_TYPE", "ansi_a_bsmap_plcm_id_plcm_type",
            FT_UINT8, BASE_DEC, NULL, 0xf0,
            NULL, HFILL }
        },
        { &hf_ansi_a_bdtmf_trans_info_dtmf_off_len,
            { "DTMF Off Length", "ansi_a_bsmap_bdtmf_trans_info_dtmf_off_len",
            FT_UINT8, BASE_DEC, VALS(ansi_a_bdtmf_trans_info_dtmf_off_len_vals), 0x38,
            NULL, HFILL }
        },
        { &hf_ansi_a_bdtmf_trans_info_dtmf_on_len,
            { "DTMF On Length", "ansi_a_bsmap_bdtmf_trans_info_dtmf_on_len",
            FT_UINT8, BASE_DEC, VALS(ansi_a_bdtmf_trans_info_dtmf_on_len_vals), 0x07,
            NULL, HFILL }
        },
        { &hf_ansi_a_bdtmf_chars_num_chars,
            { "DTMF Number of Characters", "ansi_a_bsmap_bdtmf_chars_num_chars",
            FT_UINT8, BASE_DEC, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_bdtmf_chars_digits,
            { "DTMF Digits", "ansi_a_bsmap_bdtmf_chars_digits",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_encryption_parameter_value,
            { "Encryption Parameter value", "ansi_a_bsmap_encryption_parameter_value",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_layer3_info,
            { "Layer 3 Information", "ansi_a_bsmap_layer3_info",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_manufacturer_software_info,
            { "Manufacturer/Carrier Software Information", "ansi_a_bsmap_manufacturer_software_info",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_circuit_bitmap,
            { "Circuit Bitmap", "ansi_a_bsmap_circuit_bitmap",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_extension_parameter_value,
            { "Extension Parameter value", "ansi_a_bsmap_extension_parameter_value",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_msb_first_digit,
            { "MSB of first digit", "ansi_a_bsmap_msb_first_digit",
            FT_UINT8, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_dcch_cc_incl,
            { "DCCH_CC_INCL (Channel configuration for the Dedicated Control Channel included indicator)", "ansi_a_bsmap_dcch_cc_incl",
            FT_UINT8, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_for_sch_cc_incl,
            { "FOR_SCH_CC_INCL (Channel configuration for the Dedicated Control Channel included indicator)", "ansi_a_bsmap_for_sch_cc_incl",
            FT_UINT8, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_rev_sch_cc_incl,
            { "REV_SCH_CC_INCL (Channel configuration for the Dedicated Control Channel included indicator)", "ansi_a_bsmap_rev_sch_cc_incl",
            FT_UINT8, BASE_HEX, NULL, 0,
            NULL, HFILL }
        },
        { &hf_ansi_a_plcm42,
            { "PLCM_42", "ansi_a_bsmap_plcm42",
