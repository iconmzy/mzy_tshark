...
proto_register_dhcp(void)
{
	...
	static hf_register_info hf[] = {
		...
		{ &hf_dhcp_hw_type,
		  { "Hardware type", "dhcp_hw_type",
		    FT_UINT8, BASE_HEX, VALS(arp_hrd_vals), 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_hw_len,
		  { "Hardware address length", "dhcp_hw_len",
		...
		{ &hf_dhcp_id,
		  { "Transaction ID", "dhcp_id",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_secs,
		  { "Seconds elapsed", "dhcp_secs",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_flags,
		  { "Bootp flags", "dhcp_flags",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_flags_broadcast,
		  { "Broadcast flag", "dhcp_flags_bc",
		    FT_BOOLEAN, 16, TFS(&flag_set_broadcast), BOOTP_BC,
		    NULL, HFILL }},

		{ &hf_dhcp_flags_reserved,
		  { "Reserved flags", "dhcp_flags_reserved",
		    FT_UINT16, BASE_HEX, NULL, BOOTP_MBZ,
		    NULL, HFILL }},

		{ &hf_dhcp_ip_client,
		  { "Client IP address", "dhcp_ip_client",
		    FT_IPv4, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_ip_your,
		  { "Your (client) IP address", "dhcp_ip_your",
		    FT_IPv4, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_ip_server,
		  { "Next server IP address", "dhcp_ip_server",
		    FT_IPv4, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_ip_relay,
		  { "Relay agent IP address", "dhcp_ip_relay",
		    FT_IPv4, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_hw_addr,
		  { "Client hardware address", "dhcp_hw_addr",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_hw_addr_padding,
		  { "Client hardware address padding", "dhcp_hw_addr_padding",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_hw_ether_addr,
		  { "Client MAC address", "dhcp_hw_mac_addr",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_server,
		  { "Server host name", "dhcp_server",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_file,
		  { "Boot file name", "dhcp_file",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_cookie,
		  { "Magic cookie", "dhcp_cookie",
		    FT_IPv4, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_vendor_specific_options,
		  { "Bootp vendor specific options", "dhcp_vendor_specific_options",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},
		...
		{ &hf_dhcp_pkt_mta_cap_len,
		  { "MTA DC Length", "dhcp_vendor_pktc_mta_cap_len",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "PacketCable MTA Device Capabilities Length", HFILL }},

		{ &hf_dhcp_pkt_mta_cap_type,
		  { "Type", "dhcp_vendor_pktc_mta_cap_type",
		    FT_UINT8, BASE_DEC, VALS(pkt_mdc_type_vals), 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_supp_flow_secure,
		  { "Secure Flow (Full Secure Provisioning Flow)", "dhcp_vendor_pktc_mdc_supp_flow_secure",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_supp_flow_hybrid,
		  { "Hybrid Flow", "dhcp_vendor_pktc_mdc_supp_flow_hybrid",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_supp_flow_basic,
		  { "Basic Flow", "dhcp_vendor_pktc_mdc_supp_flow_basic",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_mta,
		  { "PacketCable 1.5 MTA MIB", "dhcp_vendor_pktc_mdc_cl_mib_mta",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_signaling,
		  { "PacketCable 1.5 Signaling MIB", "dhcp_vendor_pktc_mdc_cl_mib_signaling",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_management_event,
		  { "PacketCable 1.5 Management Event MIB", "dhcp_vendor_pktc_mdc_cl_mib_management_event",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_mta_extension,
		  { "PacketCable 1.5 MTA Extension MIB", "dhcp_vendor_pktc_mdc_cl_mib_mta_extension",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x08,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_mta_signaling_extension,
		  { "PacketCable 1.5 Signaling Extension MIB", "dhcp_vendor_pktc_mdc_cl_mib_signaling_extension",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x10,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_mta_mem_extension,
		  { "PacketCable 1.5 MEM Extension MIB", "dhcp_vendor_pktc_mdc_cl_mib_mem_extension",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x20,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_cl_reserved,
		  { "Reserved", "dhcp_vendor_pktc_mdc_cl_mib_reserved",
		    FT_UINT8, BASE_HEX, NULL, 0xC0,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_ietf_mta,
		  { "IETF MTA MIB", "dhcp_vendor_pktc_mdc_ietf_mib_mta",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_ietf_signaling,
		  { "IETF Signaling MIB", "dhcp_vendor_pktc_mdc_ietf_mib_signaling",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_ietf_management_event,
		  { "IETF Management Event MIB", "dhcp_vendor_pktc_mdc_ietf_mib_management_event",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_ietf_reserved,
		  { "Reserved", "dhcp_vendor_pktc_mdc_ietf_mib_reserved",
		    FT_UINT8, BASE_HEX, NULL, 0xF8,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_mta,
		  { "PacketCable 1.5 MTA MIB", "dhcp_vendor_pktc_mdc_euro_mib_mta",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_signaling,
		  { "PacketCable 1.5 Signaling MIB", "dhcp_vendor_pktc_mdc_euro_mib_signaling",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_management_event,
		  { "PacketCable 1.5 Management Event MIB", "dhcp_vendor_pktc_mdc_euro_mib_management_event",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_mta_extension,
		  { "PacketCable 1.5 MTA Extension MIB", "dhcp_vendor_pktc_mdc_euro_mib_mta_extension",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x08,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_mta_signaling_extension,
		  { "PacketCable 1.5 Signaling Extension MIB", "dhcp_vendor_pktc_mdc_euro_mib_signaling_extension",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x10,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_mta_mem_extension,
		  { "PacketCable 1.5 MEM Extension MIB", "dhcp_vendor_pktc_mdc_euro_mib_mem_extension",
		    FT_BOOLEAN, 8, TFS(&tfs_present_not_present), 0x20,
		    NULL, HFILL }},

		{ &hf_dhcp_pkt_mdc_mib_euro_reserved,
		  { "Reserved", "dhcp_vendor_pktc_mdc_euro_mib_reserved",
		    FT_UINT8, BASE_HEX, NULL, 0xC0,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_len,
		  { "CM DC Length", "dhcp_vendor_docsis_cm_cap_len",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "DOCSIS Cable Modem Device Capabilities Length", HFILL }},

		{ &hf_dhcp_docsis_cm_cap_type,
		  { "CM DC Type", "dhcp_docsis_cm_cap_type",
		    FT_UINT16, BASE_DEC, VALS(docsis_cm_cap_type_vals), 0x0,
		    "Docsis Cable Modem Device Capability type", HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ranging_hold_off_cm,
		  { "CM", "dhcp_docsis_cm_cap_ranging_hold_off_cm",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ranging_hold_off_eps,
		  { "ePS or eRouter", "dhcp_docsis_cm_cap_ranging_hold_off_eps",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ranging_hold_off_emta,
		  { "EMTA or EDVA", "dhcp_docsis_cm_cap_ranging_hold_off_emta",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ranging_hold_off_dsg,
		  { "DSG/eSTB", "dhcp_docsis_cm_cap_ranging_hold_off_dsg",
		    FT_BOOLEAN, 16, TFS(&tfs_supported_not_supported), 0x08,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_stpid,
		  { "[IEEE 802.1ad] S-TPID", "dhcp_docsis_cm_cap_mpls_stpid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_svid,
		  { "[IEEE 802.1ad] S-VID", "dhcp_docsis_cm_cap_mpls_svid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_spcp,
		  { "[IEEE 802.1ad] S-PCP", "dhcp_docsis_cm_cap_mpls_spcp",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_sdei,
		  { "[IEEE 802.1ad] S-DEI", "dhcp_docsis_cm_cap_mpls_sdei",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x08,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_ctpid,
		  { "[IEEE 802.1ad] C-TPID", "dhcp_docsis_cm_cap_mpls_ctpid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x10,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_cvid,
		  { "[IEEE 802.1ad] C-VID", "dhcp_docsis_cm_cap_mpls_cvid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x20,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_cpcp,
		  { "[IEEE 802.1ad] C-PCP", "dhcp_docsis_cm_cap_mpls_cpcp",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x40,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_ccfi,
		  { "[IEEE 802.1ad] C-CFI", "dhcp_docsis_cm_cap_mpls_ccfi",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x80,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_stci,
		  { "[IEEE 802.1ad] S-TCI", "dhcp_docsis_cm_cap_mpls_stci",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x100,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_ctci,
		  { "[IEEE 802.1ad] C-TCI", "dhcp_docsis_cm_cap_mpls_ctci",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x200,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_itpid,
		  { "[IEEE 802.1ad] I-TPID", "dhcp_docsis_cm_cap_mpls_itpid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x400,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_isid,
		  { "[IEEE 802.1ad] I-SID", "dhcp_docsis_cm_cap_mpls_isid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x800,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_itci,
		  { "[IEEE 802.1ad] I-TCI", "dhcp_docsis_cm_cap_mpls_itci",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x1000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_ipcp,
		  { "[IEEE 802.1ad] I-PCP", "dhcp_docsis_cm_cap_mpls_ipcp",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x2000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_idei,
		  { "[IEEE 802.1ad] I-DEI", "dhcp_docsis_cm_cap_mpls_idei",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x4000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_iuca,
		  { "[IEEE 802.1ad] I-UCA", "dhcp_docsis_cm_cap_mpls_iuca",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x8000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_btpid,
		  { "[IEEE 802.1ad] B-TPID", "dhcp_docsis_cm_cap_mpls_btpid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x10000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_btci,
		  { "[IEEE 802.1ad] B-TCI", "dhcp_docsis_cm_cap_mpls_btci",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x20000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_bpcp,
		  { "[IEEE 802.1ad] B-PCP", "dhcp_docsis_cm_cap_mpls_bpcp",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x40000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_bdei,
		  { "[IEEE 802.1ad] B-DEI", "dhcp_docsis_cm_cap_mpls_bdei",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x80000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_bvid,
		  { "[IEEE 802.1ad] B-VID", "dhcp_docsis_cm_cap_mpls_bvid",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x100000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_bda,
		  { "[IEEE 802.1ad] B-DA", "dhcp_docsis_cm_cap_mpls_bda",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x200000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_bsa,
		  { "[IEEE 802.1ad] B-SA", "dhcp_docsis_cm_cap_mpls_bsa",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x200000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_tc,
		  { "MPLS TC", "dhcp_docsis_cm_cap_mpls_tc",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x200000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_mpls_label,
		  { "MPLS Label", "dhcp_docsis_cm_cap_mpls_label",
		    FT_BOOLEAN, 32, TFS(&tfs_supported_not_supported), 0x200000,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ussymrate_160,
		  { "160 ksps symbol rate", "dhcp_docsis_cm_cap_ussymrate_160",
		    FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x01,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ussymrate_320,
		  { "320 ksps symbol rate", "dhcp_docsis_cm_cap_ussymrate_320",
		    FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x02,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ussymrate_640,
		  { "640 ksps symbol rate", "dhcp_docsis_cm_cap_ussymrate_640",
		    FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x04,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ussymrate_1280,
		  { "1280 ksps symbol rate", "dhcp_docsis_cm_cap_ussymrate_1280",
		    FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x08,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ussymrate_2560,
		  { "2560 ksps symbol rate", "dhcp_docsis_cm_cap_ussymrate_2560",
		    FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x10,
		    NULL, HFILL }},

		{ &hf_dhcp_docsis_cm_cap_ussymrate_5120,
		  { "5120 ksps symbol rate", "dhcp_docsis_cm_cap_ussymrate_5120",
		    FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x20,
		    NULL, HFILL }},

		{ &hf_dhcp_client_identifier_uuid,
		  { "Client Identifier (UUID)", "dhcp_client_id_uuid",
		    FT_GUID, BASE_NONE, NULL, 0x0,
		    "Client Machine Identifier (UUID)", HFILL }},

		{ &hf_dhcp_client_hardware_address,
		  { "Client hardware address", "dhcp_client_hardware_address",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_client_id_iaid,
		  { "IAID", "dhcp_client_id_iaid",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_client_id_duid_type,
		  { "DUID Type", "dhcp_client_id_duid_type",
		    FT_UINT16, BASE_DEC, VALS(duidtype_vals), 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_client_identifier_duid_llt_hw_type,
		  { "Hardware type", "dhcp_client_id_duid_llt_hw_type",
		...
		{ &hf_dhcp_option_path_mtu_plateau_table_item,
		  { "Path MTU Plateau Table Item", "dhcp_option_path_mtu_plateau_table_item",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		...
		{ &hf_dhcp_option_ethernet_encapsulation,
		  { "Ethernet Encapsulation", "dhcp_option_ethernet_encapsulation",
		    FT_BOOLEAN, BASE_NONE, TFS(&tfs_enabled_disabled), 0x00,
		    "Option 36: Ethernet Encapsulation", HFILL }},

		{ &hf_dhcp_option_tcp_default_ttl,
		  { "TCP Default TTL", "dhcp_option_tcp_default_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		...
		{ &hf_dhcp_option_nis_domain,
		  { "Network Information Service Domain", "dhcp_option_nis_domain",
		    FT_STRINGZ, BASE_NONE, NULL, 0x0,
		    "Option 40: Network Information Service Domain", HFILL }},

		{ &hf_dhcp_option_nis_server,
		  { "Network Information Service Server", "dhcp_option_nis_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 41: Network Information Service Server", HFILL }},

		{ &hf_dhcp_option_ntp_server,
		  { "Network Time Protocol Server", "dhcp_option_ntp_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 42: Network Time Protocol Server", HFILL }},


		{ &hf_dhcp_option43_value,
		  { "Value", "dhcp_option_vendor_value",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 43: Suboption value", HFILL }},

		{ &hf_dhcp_option43_value_8,
		  { "Value", "dhcp_option_vendor_value_uint",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		...
		{ &hf_dhcp_option43_value_stringz,
		  { "Value", "dhcp_option_vendor_value_string",
		    FT_STRINGZ, BASE_NONE, NULL, 0x0,
		    "Option 43: Suboption Z-String value", HFILL }},

		{ &hf_dhcp_option43_value_ip_address,
		  { "Value", "dhcp_option_vendor_value_address",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 43: Suboption IP address", HFILL }},


		{ &hf_dhcp_option43_pxeclient_suboption,
		  { "Option 43 Suboption", "dhcp_option_vendor_pxeclient_suboption",
		...
		{ &hf_dhcp_option43_pxeclient_end,
		 ...
		 { "Option 43 Suboption", "dhcp_option_vendor_cisco_suboption",
		...
		{ &hf_dhcp_option43_alcatel_sip_url,
		  { "SIP URL", "dhcp_option_vendor_alu_sip_url",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    "Option 43:Alcatel 67 SIP URL", HFILL }},

		{ &hf_dhcp_option43_alcatel_end,
		  { "Alcatel End", "dhcp_option_vendor_alu_end",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 43:Alcatel 255 End", HFILL }},

		{ &hf_dhcp_option43_arubaap_controllerip,
		  { "Aruba Controller IP", "dhcp_option_vendor_arubaap_controllerip",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    "Address IP of Aruba controller", HFILL }},

		{ &hf_dhcp_option43_arubaiap,
		  { "Aruba Instant AP", "dhcp_option_vendor_arubaiap",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    "nameorg,amp-ip-address,password", HFILL }},

		{ &hf_dhcp_option43_arubaiap_nameorg,
		  { "Name Organisation", "dhcp_option_vendor_arubaiap_name_org",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_arubaiap_ampip,
		  { "AMP IP Address", "dhcp_option_vendor_arubaiap_amp_ip",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    "Address IP of Airwave server (AMP)", HFILL }},

		{ &hf_dhcp_option43_arubaiap_password,
		  { "Password", "dhcp_option_vendor_arubaiap_password",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    "Password for Instant AP Airwave server (AMP)", HFILL }},


		{ &hf_dhcp_option43_bsdp_suboption,
		  { "Option 43 Suboption", "dhcp_option_vendor_bsdp_suboption",
		    FT_UINT8, BASE_DEC, VALS(option43_cl_suboption_vals), 0x0,
		    "Option 43:BSDP Suboption", HFILL }},

		{ &hf_dhcp_option43_bsdp_message_type,
		  { "Message Type", "dhcp_option_vendor_bsdp_message_type",
		    FT_UINT8, BASE_DEC, VALS(o43_bsdp_message_type_vals), 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_version,
		  { "Version", "dhcp_option_vendor_bsdp_version",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_server_identifier,
		  { "Server Identifier", "dhcp_option_vendor_bsdp_server_identifier",
		    FT_IPv4, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_server_priority,
		  { "Server Priority", "dhcp_option_vendor_bsdp_server_priority",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_reply_port,
		  { "Reply Port", "dhcp_option_vendor_bsdp_reply_port",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_list_path,
		  { "Boot Image List Path", "dhcp_option_vendor_bsdp_boot_image_list_path",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_index,
		  { "Boot Image Index", "dhcp_option_vendor_bsdp_boot_image_index",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_default_boot_image_id,
		  { "Default Boot Image ID", "dhcp_option_vendor_bsdp_default_boot_image_id",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_selected_boot_image_id,
		  { "Selected Boot Image ID", "dhcp_option_vendor_bsdp_selected_boot_image_id",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_list,
		  { "Boot Image List", "dhcp_option_vendor_bsdp_boot_image_list",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_image_desc,
		  { "Boot Image Description", "dhcp_option_vendor_bsdp_boot_image_desc",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_name_len,
		  { "Boot Image Name Length", "dhcp_option_vendor_bsdp_boot_image_name_len",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_name,
		  { "Boot Image Name", "dhcp_option_vendor_bsdp_boot_image_name",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_netboot_firmware,
		  { "NetBoot 1.0 Firmware", "dhcp_option_vendor_bsdp_netboot_firmware",
		    FT_NONE, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_attributes_filter_list,
		  { "Boot Image Attributes Filter List", "dhcp_option_vendor_bsdp_attributes_filter_list",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_attribute,
		  { "Boot Image Attribute", "dhcp_option_vendor_bsdp_boot_image_attribute",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_attribute_install,
		  { "Install", "dhcp_option_vendor_bsdp_boot_image_attribute_install",
		    FT_UINT16, BASE_HEX, VALS(o43_bsdp_boot_image_install_vals), 0x8000,
		    "Boot Image Attribute Install", HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_attribute_kind,
		  { "Kind", "dhcp_option_vendor_bsdp_boot_image_attribute_kind",
		    FT_UINT16, BASE_HEX, VALS(o43_bsdp_boot_image_kind_vals), 0x7f00,
		    "Boot Image Attribute Kind", HFILL }},

		{ &hf_dhcp_option43_bsdp_boot_image_attribute_reserved,
		  { "Reserved", "dhcp_option_vendor_bsdp_boot_image_attribute_reserved",
		    FT_UINT16, BASE_HEX, NULL, 0x00ff,
		    "Boot Image Attribute Reserved", HFILL }},

		{ &hf_dhcp_option43_bsdp_message_size,
		  { "Message Size", "dhcp_option_vendor_bsdp_message_size",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},


		{ &hf_dhcp_option_netbios_over_tcpip_name_server,
		  { "NetBIOS over TCP/IP Name Server", "dhcp_option_netbios_over_tcpip_name_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 44: NetBIOS over TCP/IP Name Server", HFILL }},

		{ &hf_dhcp_option_netbios_over_tcpip_dd_name_server,
		  { "NetBIOS over TCP/IP Datagram Distribution Name Server", "dhcp_option_netbios_over_tcpip_dd_name_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 45: NetBIOS over TCP/IP Datagram Distribution Name Server", HFILL }},

		{ &hf_dhcp_option_netbios_over_tcpip_node_type,
		  { "NetBIOS over TCP/IP Node Type", "dhcp_option_netbios_over_tcpip_node_type",
		...
		{ &hf_dhcp_option_mobile_ip_home_agent,
		  { "Mobile IP Home Agent", "dhcp_option_mobile_ip_home_agent",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		...
		{ &hf_dhcp_option_pop3_server,
		  { "POP3 Server", "dhcp_option_pop3_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		...
		{ &hf_dhcp_option_default_www_server,
		  { "Default WWW Server", "dhcp_option_default_www_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 72: Default WWW Server", HFILL }},

		{ &hf_dhcp_option_default_finger_server,
		  { "Default Finger Server", "dhcp_option_default_finger_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 73: Default Finger Server", HFILL }},

		{ &hf_dhcp_option_default_irc_server,
		  { "Default IRC Server", "dhcp_option_default_irc_server",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		...
		{ &hf_dhcp_option82_value_ip_address,
		  { "Value", "dhcp_option_agent_information_option_value_address",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 82: Suboption IP address", HFILL }},

		{ &hf_dhcp_option82_value_stringz,
		  { "Value", "dhcp_option_agent_information_option_value_string",
		    FT_STRINGZ, BASE_NONE, NULL, 0x0,
		    "Option 82: Suboption Z-String value", HFILL }},

		{ &hf_dhcp_option82_padding,
		  { "Padding", "dhcp_option_agent_information_option_padding",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 82:0 Padding", HFILL }},

		{ &hf_dhcp_option82_agent_circuit_id,
		  { "Agent Circuit ID", "dhcp_option_agent_information_option_agent_circuit_id",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 82:1 Agent Circuit ID", HFILL }},

		{ &hf_dhcp_option82_agent_remote_id,
		  { "Agent Remote ID", "dhcp_option_agent_information_option_agent_remote_id",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 82:2 Agent Remote ID", HFILL }},

		{ &hf_dhcp_option82_reserved,
		  { "Reserved", "dhcp_option_agent_information_option_reserved",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 82:3 Reserved", HFILL }},

		{ &hf_dhcp_option82_docsis_device_class,
		  { "DOCSIS Device Class", "dhcp_option_agent_information_option_docsis_device_class",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    "Option 82:4 DOCSIS Device Class", HFILL }},

		{ &hf_dhcp_option82_link_selection,
		  { "Link selection", "dhcp_option_agent_information_option_link_selection",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 82:5 Link selection", HFILL }},

		{ &hf_dhcp_option82_subscriber_id,
		  { "Subscriber ID", "dhcp_option_agent_information_option_subscriber_id",
		    FT_STRINGZ, BASE_NONE, NULL, 0x0,
		    "Option 82:6 Subscriber ID", HFILL }},

		{ &hf_dhcp_option82_radius_attributes,
		  { "RADIUS Attributes", "dhcp_option_agent_information_option_radius_attributes",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 82:7 RADIUS Attributes", HFILL }},

		{ &hf_dhcp_option82_authentication,
		  { "Authentication", "dhcp_option_agent_information_option_authentication",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 82:8 Authentication", HFILL }},

		{ &hf_dhcp_option82_vi,
		  { "Vendor-Specific Information", "dhcp_option_agent_information_option_vi",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    "Option 82:9 Vendor-Specific Information", HFILL }},

		{ &hf_dhcp_option82_vi_enterprise,
		  { "Enterprise", "dhcp_option_agent_information_option_vi_enterprise",
		    FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
		    "Option 82:9 VI Enterprise", HFILL }},

		{ &hf_dhcp_option82_vi_data_length,
		  { "Data Length", "dhcp_option_agent_information_option_vi_data_length",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 82:9 VI Data Length", HFILL }},

		{ &hf_dhcp_option82_vi_cl_option,
		  { "Option", "dhcp_option_agent_information_option_vi_cl_option",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 82:9 VI CL Option", HFILL }},

		{ &hf_dhcp_option82_vi_cl_length,
		  { "Length", "dhcp_option_agent_information_option_vi_cl_length",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 82:9 VI CL Length", HFILL }},

		{ &hf_dhcp_option82_vi_cl_tag,
		  { "Tag", "dhcp_option_agent_information_option_vi_cl_tag",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 82:9 VI CL Tag", HFILL }},

		{ &hf_dhcp_option82_vi_cl_tag_length,
		  { "Tag Length", "dhcp_option_agent_information_option_vi_cl_tag_length",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 82:9 VI CL Tag Length", HFILL }},

		{ &hf_dhcp_option82_vi_cl_docsis_version,
		  { "DOCSIS Version Number", "dhcp_option_agent_information_option_vi_cl_docsis_version",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    "Option 82:9 VI CL DOCSIS Version Number", HFILL }},

		{ &hf_dhcp_option82_flags,
		  { "Flags", "dhcp_option_agent_information_option_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    "Option 82:10 Flags", HFILL }},

		{ &hf_dhcp_option82_server_id_override,
		  { "Server ID Override", "dhcp_option_agent_information_option_server_id_override",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 82:11 Server ID Override", HFILL }},

		{ &hf_dhcp_option82_relay_agent_id,
		  { "Relay Agent Identifier", "dhcp_option_agent_information_option_relay_agent_id",
		    FT_BYTES, BASE_NONE, NULL, 0x00,
		    "Option 82:12 Relay Agent Identifier", HFILL }},

		{ &hf_dhcp_option82_option_ani_att,
		  { "Access Technology Type", "dhcp_option_agent_information_option_ani_att",
		    FT_UINT8, BASE_DEC, NULL, 0x00,
		    "Option 82:13 Access Technology Type", HFILL }},

		{ &hf_dhcp_option82_option_ani_att_res,
		  { "Access Technology Type", "dhcp_option_agent_information_option_ani_att_res",
		    FT_UINT8, BASE_DEC, NULL, 0x00,
		    "Option 82:13 Access Technology Type Reserved", HFILL }},

		{ &hf_dhcp_option82_option_ani_att_att,
		  { "Access Technology Type", "dhcp_option_agent_information_option_ani_att_att",
		    FT_UINT8, BASE_DEC, NULL, 0x00,
		    "Option 82:13 Access Technology Type Value", HFILL }},

		{ &hf_dhcp_option82_option_ani_network_name,
		  { "Access Network Name", "dhcp_option_agent_information_option_ani_network_name",
		    FT_STRING, BASE_NONE, NULL, 0x00,
		    "Option 82:14 Access Network Name", HFILL }},

		{ &hf_dhcp_option82_option_ani_ap_name,
		  { "Access Point Name", "dhcp_option_agent_information_option_ani_ap_name",
		    FT_STRING, BASE_NONE, NULL, 0x00,
		    "Option 82:15 Access Point Name", HFILL }},

		{ &hf_dhcp_option82_option_ani_ap_bssid,
		  { "Access Point BSSID", "dhcp_option_agent_information_option_ani_ap_bssid",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    "Option 82:16 Access Point BSSID", HFILL }},

		{ &hf_dhcp_option82_option_ani_operator_id,
		  { "Access Network Operator ID", "dhcp_option_agent_information_option_ani_operator_id",
		    FT_BYTES, BASE_NONE, NULL, 0x00,
		    "Option 82:17 Access Network Operator ID", HFILL }},

		{ &hf_dhcp_option82_option_ani_operator_realm,
		  { "Access Network Operator Realm", "dhcp_option_agent_information_option_ani_operator_realm",
		    FT_STRING, BASE_NONE, NULL, 0x00,
		    "Option 82:18 Access Network Operator Realm", HFILL }},

		{ &hf_dhcp_option82_option_source_port,
		  { "Source Port", "dhcp_option_agent_information_option_source_port",
		    FT_UINT16, BASE_DEC, NULL, 0x00,
		    "Option 82:19 Source Port", HFILL }},

		{ &hf_dhcp_option82_link_selection_cisco,
		  { "Link selection (Cisco proprietary)", "dhcp_option_agent_information_option_link_selection_cisco",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 82:150 Link selection (Cisco proprietary)", HFILL }},

		{ &hf_dhcp_option82_vrf_name_vpn_id,
		  { "VRF name/VPN ID", "dhcp_option_agent_information_option_vrf_name_vpn_id",
		    FT_BYTES, BASE_NONE, NULL, 0x00,
		    "Option 82:151 VRF name/VPN ID", HFILL }},

		{ &hf_dhcp_option82_vrf_name_global,
		  { "Global, default VPN", "dhcp_option_agent_information_option_vrf_name_global",
		    FT_UINT8, BASE_DEC, NULL, 0x00,
		    "Option 82:151 Global, default VPN", HFILL }},

		{ &hf_dhcp_option82_vrf_name,
		  { "VRF name", "dhcp_option_agent_information_option_vrf_name",
		    FT_STRING, BASE_NONE, NULL, 0x00,
		    "Option 82:151 VRF name", HFILL }},

		{ &hf_dhcp_option82_vrf_name_vpn_id_oui,
		  { "VRF name/VPN ID OUI", "dhcp_option_agent_information_option_vrf_name_vpn_id_oui",
		    FT_UINT24, BASE_HEX, NULL, 0x00,
		    "Option 82:151 VRF name/VPN ID OUI", HFILL }},

		{ &hf_dhcp_option82_vrf_name_vpn_id_index,
		  { "VRF name/VPN ID Index", "dhcp_option_agent_information_option_vrf_name_vpn_id_index",
		    FT_UINT32, BASE_HEX, NULL, 0x00,
		    "Option 82:151 VRF name/VPN ID Index", HFILL }},

		{ &hf_dhcp_option82_server_id_override_cisco,
		  { "Server ID Override (Cisco proprietary)", "dhcp_option_agent_information_option_server_id_override_cisco",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 82:152 Server ID Override (Cisco proprietary)", HFILL }},


		{ &hf_dhcp_option_isns_functions,
		  { "iSNS Functions", "dhcp_option_isns_functions",
		    FT_UINT16, BASE_HEX, NULL, 0x00,
		    "iSNS: the functions supported by the iSNS servers", HFILL }},

		{ &hf_dhcp_option_isns_functions_enabled,
		  { "Function Fields Enabled", "dhcp_option_isns_functions_enabled",
		...
		{ &hf_dhcp_option_isns_functions_dd_authorization,
		  { "Discovery Domain based Authorization", "dhcp_option_isns_functions_dd_base_authorization",
		...
		{ &hf_dhcp_option_isns_functions_sec_policy_distibution,
		  { "Security Policy Distribution", "dhcp_option_isns_functions_sec_policy_distribution",
		    FT_BOOLEAN, 16, TFS(&tfs_isns_functions_sec_distrib), F_ISNS_FUNCTIONS_SEC_POLICY,
		    NULL, HFILL }},

		{ &hf_dhcp_option_isns_functions_reserved,
		  { "Reserved flags", "dhcp_option_isns_functions_reserved",
		    FT_UINT16, BASE_HEX, NULL, F_ISNS_FUNCTIONS_RESERVED,
		    NULL, HFILL }},

		{ &hf_dhcp_option_isns_discovery_domain_access,
		  { "Discovery Domain Access flags", "dhcp_option_isns_discovery_domain_access",
		    FT_UINT16, BASE_HEX, NULL, 0x00,
		    "iSNS: the types of iSNS clients that are allowed to modify Discovery Domains", HFILL }},

		{ &hf_dhcp_option_isns_discovery_domain_access_enabled,
		  { "Discovery Domain Enabled", "dhcp_option_isns_discovery_domain_access_enabled",
		...
		{ &hf_dhcp_option_dhcp_authentication_alg_delay,
		  { "Delay Algorithm", "dhcp_option_dhcp_authentication_alg_delay",
		...
		{ &hf_dhcp_option_dhcp_authentication_algorithm,
		  { "Algorithm", "dhcp_option_dhcp_authentication_algorithm",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Option 90: Authentication Algorithm", HFILL }},

		{ &hf_dhcp_option_dhcp_authentication_rdm,
		  { "Replay Detection Method", "dhcp_option_dhcp_authentication_rdm",
		...
		{ &hf_dhcp_option125_value_ip_address,
		  { "Value", "dhcp_option_vi_value_address",
		    FT_IPv4, BASE_NONE, NULL, 0x00,
		    "Option 125: Suboption IP address value", HFILL }},

		{ &hf_dhcp_option125_value_stringz,
		  { "Value", "dhcp_option_vi_value_string",
		    FT_STRINGZ, BASE_NONE, NULL, 0x0,
		    "Option 125: Suboption Z-String value", HFILL }},

		{ &hf_dhcp_option125_tr111_suboption,
		  { "Option 125 Suboption", "dhcp_option_vi_tr111_suboption",
		...
		{ &hf_dhcp_option_bulk_lease_status_code,
		  { "Status Code", "dhcp_option_bulk_lease_status_code",
		...
		{ &hf_dhcp_option_bulk_lease_data_source,
		  { "Data Source", "dhcp_option_bulk_lease_data_source",
		...
		{ &hf_dhcp_option_pcp_list_length,
		  { "List-Length", "dhcp_option_pcp_list_length",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		...
		{ &hf_dhcp_option43_cisco_unknown,
		  { "Unknown", "dhcp_option_vendor_cisco_unknown",
		    FT_BYTES, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_unknown1,
		  { "Unknown1", "dhcp_option_vendor_cisco_unknown1",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_unknown2,
		  { "Unknown2", "dhcp_option_vendor_cisco_unknown2",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_unknown3,
		  { "Unknown3", "dhcp_option_vendor_cisco_unknown3",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_nodeid,
		  { "Node ID", "dhcp_option_vendor_cisco_nodeid",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_unknown5,
		  { "Unknown5", "dhcp_option_vendor_cisco_unknown5",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_unknown6,
		  { "Unknown6", "dhcp_option_vendor_cisco_unknown6",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_model,
		  { "Model", "dhcp_option_vendor_cisco_model",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_apicuuid,
		  { "APIC UUID", "dhcp_option_vendor_cisco_apicuuid",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_fabricname,
		  { "Fabricname", "dhcp_option_vendor_cisco_fabricname",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_unknown10,
		  { "Unknown10", "dhcp_option_vendor_cisco_unknown10",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_serialno,
		  { "SerialNo", "dhcp_option_vendor_cisco_serialno",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},

		{ &hf_dhcp_option43_cisco_clientint,
		  { "Client Int", "dhcp_option_vendor_cisco_clientint",
		    FT_STRING, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }},
	};
