...
void proto_register_9P(void)
{
	static hf_register_info hf[] = {
		{&hf_9P_msgsz,
		 {"Msg length", "9p_msglen", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "9P Message Length", HFILL}},
		{&hf_9P_msgtype,
		 {"Msg Type", "9p_msgtype", FT_UINT8, BASE_DEC | BASE_EXT_STRING, &ninep_msg_type_ext, 0x0,
		  "Message Type", HFILL}},
		{&hf_9P_tag,
		 {"Tag", "9p_tag", FT_UINT16, BASE_DEC, NULL, 0x0,
		  "9P Tag", HFILL}},
		{&hf_9P_oldtag,
		 {"Old tag", "9p_oldtag", FT_UINT16, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_parmsz,
		 {"Param length", "9p_paramsz", FT_UINT16, BASE_DEC, NULL, 0x0,
		  "Parameter length", HFILL}},
		{&hf_9P_maxsize,
		 {"Max msg size", "9p_maxsize", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Max message size", HFILL}},
		{&hf_9P_fid,
		 {"Fid", "9p_fid", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "File ID", HFILL}},
		{&hf_9P_nqid,
		 {"Nr Qids", "9p_nqid", FT_UINT16, BASE_DEC, NULL, 0x0,
		  "Number of Qid results", HFILL}},
		{&hf_9P_mode,
		 {"Mode", "9p_mode", FT_UINT8, BASE_HEX, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_mode_rwx,
		 {"Open/Create Mode", "9p_mode_rwx", FT_UINT8, BASE_OCT | BASE_EXT_STRING, &ninep_mode_vals_ext, _9P_MODEMASK,
		  NULL, HFILL}},
		{&hf_9P_mode_t,
		 {"Trunc", "9p_mode_trunc", FT_BOOLEAN, 8, TFS(&tfs_set_notset), _9P_OTRUNC,
		  "Truncate", HFILL}},
		{&hf_9P_mode_c,
		 {"Remove on close", "9p_mode_orclose", FT_BOOLEAN, 8, TFS(&tfs_set_notset), _9P_ORCLOSE,
		  NULL, HFILL}},
		{&hf_9P_extension,
		 {"Extension string", "9p_extension", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Link target for DSYMLINK mode, major+minor for DMDEVICE, empty for normal files", HFILL}},
		{&hf_9P_iounit,
		 {"I/O Unit", "9p_iounit", FT_UINT32, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_count,
		 {"Count", "9p_count", FT_UINT32, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_offset,
		 {"Offset", "9p_offset", FT_UINT64, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_perm,
		 {"Permissions", "9p_perm", FT_UINT32, BASE_OCT, NULL, 0x0,
		  "Permission bits", HFILL}},
		{&hf_9P_qidpath,
		 {"Qid path", "9p_qidpath", FT_UINT64, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_dm_dir,
		 {"Directory", "9p_dm_dir", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x80000000,
		  NULL, HFILL}},
		{&hf_9P_dm_append,
		 {"Append only", "9p_dm_append", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x40000000,
		  NULL, HFILL}},
		{&hf_9P_dm_exclusive,
		 {"Exclusive use", "9p_dm_exclusive", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x20000000,
		  NULL, HFILL}},
		{&hf_9P_dm_mount,
		 {"Mounted channel", "9p_dm_mount", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x10000000,
		  NULL, HFILL}},
		{&hf_9P_dm_auth_file,
		 {"Authentication file", "9p_dm_auth_file", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x08000000,
		  NULL, HFILL}},
		{&hf_9P_dm_temp_file,
		 {"Temporary file (not backed up)", "9p_dm_temp_file", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x04000000,
		  NULL, HFILL}},
		{&hf_9P_dm_read_owner,
		 {"Read permission for owner", "9p_dm_read_owner", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000400,
		  NULL, HFILL}},
		{&hf_9P_dm_write_owner,
		 {"Write permission for owner", "9p_dm_write_owner", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000200,
		  NULL, HFILL}},
		{&hf_9P_dm_exec_owner,
		 {"Execute permission for owner", "9p_dm_exec_owner", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000100,
		  NULL, HFILL}},
		{&hf_9P_dm_read_group,
		 {"Read permission for group", "9p_dm_read_group", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000040,
		  NULL, HFILL}},
		{&hf_9P_dm_write_group,
		 {"Write permission for group", "9p_dm_write_group", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000020,
		  NULL, HFILL}},
		{&hf_9P_dm_exec_group,
		 {"Execute permission for group", "9p_dm_exec_group", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000010,
		  NULL, HFILL}},
		{&hf_9P_dm_read_others,
		 {"Read permission for others", "9p_dm_read_others", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000004,
		  NULL, HFILL}},
		{&hf_9P_dm_write_others,
		 {"Write permission for others", "9p_dm_write_others", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000002,
		  NULL, HFILL}},
		{&hf_9P_dm_exec_others,
		 {"Execute permission for others", "9p_dm_exec_others", FT_BOOLEAN, 32, TFS(&tfs_yes_no), 0x00000001,
		  NULL, HFILL}},
		{&hf_9P_qidvers,
		 {"Qid version", "9p_qidvers", FT_UINT32, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_qidtype,
		 {"Qid type", "9p_qidtype", FT_UINT8, BASE_HEX, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_qidtype_dir,
		 {"Directory", "9p_qidtype_dir", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80,
		  NULL, HFILL}},
		{&hf_9P_qidtype_append,
		 {"Append only", "9p_qidtype_append", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x40,
		  NULL, HFILL}},
		{&hf_9P_qidtype_exclusive,
		 {"Exclusive use", "9p_qidtype_exclusive", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x20,
		  NULL, HFILL}},
		{&hf_9P_qidtype_mount,
		 {"Mounted channel", "9p_qidtype_mount", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
		  NULL, HFILL}},
		{&hf_9P_qidtype_auth_file,
		 {"Authentication file", "9p_qidtype_auth_file", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
		  NULL, HFILL}},
		{&hf_9P_qidtype_temp_file,
		 {"Temporary file (not backed up)", "9p_qidtype_temp_file", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
		  NULL, HFILL}},
		{&hf_9P_statmode,
		 {"Mode", "9p_statmode", FT_UINT32, BASE_OCT, NULL, 0x0,
		  "File mode flags", HFILL}},
		{&hf_9P_stattype,
		 {"Type", "9p_stattype", FT_UINT16, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_atime,
		 {"Atime", "9p_atime", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
		  "Access Time", HFILL}},
		{&hf_9P_mtime,
		 {"Mtime", "9p_mtime", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
		  "Modified Time", HFILL}},
		{&hf_9P_ctime,
		 {"Ctime", "9p_ctime", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
		  "Creation Time", HFILL}},
		{&hf_9P_btime,
		 {"Btime", "9p_btime", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
		  "Btime (Synchronization information)", HFILL}},
		{&hf_9P_length,
		 {"Length", "9p_length", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "File Length", HFILL}},
		{&hf_9P_dev,
		 {"Dev", "9p_dev", FT_UINT32, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_wname,
		 {"Wname", "9p_wname", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Path Name Element", HFILL}},
		{&hf_9P_version,
		 {"Version", "9p_version", FT_STRING, BASE_NONE, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_afid,
		 {"Afid", "9p_afid", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Authenticating FID", HFILL}},
		{&hf_9P_uname,
		 {"Uname", "9p_uname", FT_STRING, BASE_NONE, NULL, 0x0,
		  "User Name", HFILL}},
		{&hf_9P_aname,
		 {"Aname", "9p_aname", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Access Name", HFILL}},
		{&hf_9P_ename,
		 {"Ename", "9p_ename", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Error", HFILL}},
		{&hf_9P_enum,
		 {"Enum", "9p_enum", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Error", HFILL}},
#if 0
		{&hf_9P_name,
		 {"Name", "9p_name", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Name of file", HFILL}},
#endif
		{&hf_9P_sdlen,
		 {"Stat data length", "9p_sdlen", FT_UINT16, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_filename,
		 {"File name", "9p_filename", FT_STRING, BASE_NONE, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_user,
		 {"User", "9p_user", FT_STRING, BASE_NONE, NULL, 0x0,
		  "User name", HFILL}},
		{&hf_9P_group,
		 {"Group", "9p_group", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Group name", HFILL}},
		{&hf_9P_uid,
		 {"Uid", "9p_uid", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "User id", HFILL}},
		{&hf_9P_gid,
		 {"Gid", "9p_gid", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Group id", HFILL}},
		{&hf_9P_muid,
		 {"Muid", "9p_muid", FT_STRING, BASE_NONE, NULL, 0x0,
		  "Last modifiers uid", HFILL}},
		{&hf_9P_newfid,
		 {"New fid", "9p_newfid", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "New file ID", HFILL}},
		{&hf_9P_dfid,
		 {"Directory fid", "9p_dfid", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Directory ID", HFILL}},
		{&hf_9P_nwalk,
		 {"Nr Walks", "9p_nwalk", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Nr of walk items", HFILL}},
		{&hf_9P_nlink,
		 {"nlink", "9p_nlink", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Number of links", HFILL}},
		{&hf_9P_getattr_flags,
		 {"getattr_flags", "9p_getattr_flags", FT_UINT64, BASE_HEX, NULL, _9P_GETATTR_ALL,
		  "Getattr flags", HFILL}},
		{&hf_9P_getattr_mode,
		 {"Mode", "9p_getattr_mode", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_MODE,
		  NULL, HFILL}},
		{&hf_9P_getattr_nlink,
		 {"Nlink", "9p_getattr_nlink", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_NLINK,
		  NULL, HFILL}},
		{&hf_9P_getattr_uid,
		 {"UID", "9p_getattr_uid", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_UID,
		  NULL, HFILL}},
		{&hf_9P_getattr_gid,
		 {"GID", "9p_getattr_gid", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_GID,
		  NULL, HFILL}},
		{&hf_9P_getattr_rdev,
		 {"Rdev", "9p_getattr_rdev", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_RDEV,
		  NULL, HFILL}},
		{&hf_9P_getattr_atime,
		 {"Atime", "9p_getattr_atime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_ATIME,
		  NULL, HFILL}},
		{&hf_9P_getattr_mtime,
		 {"Mtime", "9p_getattr_mtime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_MTIME,
		  NULL, HFILL}},
		{&hf_9P_getattr_ctime,
		 {"Ctime", "9p_getattr_ctime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_CTIME,
		  NULL, HFILL}},
		{&hf_9P_getattr_ino,
		 {"Inode", "9p_getattr_inode", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_INO,
		  NULL, HFILL}},
		{&hf_9P_getattr_size,
		 {"Size", "9p_getattr_size", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_SIZE,
		  NULL, HFILL}},
		{&hf_9P_getattr_blocks,
		 {"Blocks", "9p_getattr_blocks", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_BLOCKS,
		  NULL, HFILL}},
		{&hf_9P_getattr_btime,
		 {"Btime", "9p_getattr_btime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_BTIME,
		  NULL, HFILL}},
		{&hf_9P_getattr_gen,
		 {"Gen", "9p_getattr_gen", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_GEN,
		  NULL, HFILL}},
		{&hf_9P_getattr_dataversion,
		 {"Data version", "9p_getattr_dataversion", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_GETATTR_DATA_VERSION,
		  NULL, HFILL}},
		{&hf_9P_setattr_flags,
		 {"setattr_flags", "9p_setattr_flags", FT_UINT32, BASE_HEX, NULL, _9P_SETATTR_ALL,
		  "Setattr flags", HFILL}},
		{&hf_9P_setattr_mode,
		 {"Mode", "9p_setattr_mode", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_MODE,
		  NULL, HFILL}},
		{&hf_9P_setattr_uid,
		 {"UID", "9p_setattr_uid", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_UID,
		  NULL, HFILL}},
		{&hf_9P_setattr_gid,
		 {"GID", "9p_setattr_gid", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_GID,
		  NULL, HFILL}},
		{&hf_9P_setattr_size,
		 {"Size", "9p_setattr_size", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_SIZE,
		  NULL, HFILL}},
		{&hf_9P_setattr_atime,
		 {"Atime", "9p_setattr_atime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_ATIME,
		  NULL, HFILL}},
		{&hf_9P_setattr_mtime,
		 {"Mtime", "9p_setattr_mtime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_MTIME,
		  NULL, HFILL}},
		{&hf_9P_setattr_ctime,
		 {"Ctime", "9p_setattr_ctime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_CTIME,
		  NULL, HFILL}},
		{&hf_9P_setattr_atime_set,
		 {"Atime set", "9p_setattr_atimeset", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_ATIME_SET,
		  NULL, HFILL}},
		{&hf_9P_setattr_mtime_set,
		 {"Mtime set", "9p_setattr_mtimeset", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_SETATTR_MTIME_SET,
		  NULL, HFILL}},
		{&hf_9P_unlinkat_flags,
		 {"unlinkat flags", "9p_unlinkat_flags", FT_UINT32, BASE_HEX, NULL, 0,
		  NULL, HFILL}},
		{&hf_9P_rdev,
		 {"rdev", "9p_rdev", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Device associated with file", HFILL}},
		{&hf_9P_size,
		 {"Size", "9p_size", FT_UINT64, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_blksize,
		 {"Blksize", "9p_blksize", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Block size", HFILL}},
		{&hf_9P_blocks,
		 {"Blocks", "9p_blocks", FT_UINT64, BASE_DEC, NULL, 0x0,
		  NULL, HFILL}},
		{&hf_9P_gen,
		 {"Gen", "9p_gen", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "inode generation number", HFILL}},
		{&hf_9P_dataversion,
		 {"Dataversion", "9p_dataversion", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Data version", HFILL}},
		{&hf_9P_fstype,
		 {"fstype", "9p_fstype", FT_UINT32, BASE_HEX, NULL, 0x0,
		  "Filesystem type", HFILL}},
		{&hf_9P_bfree,
		 {"bfree", "9p_bfree", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Free blocks", HFILL}},
		{&hf_9P_bavail,
		 {"bavail", "9p_bavail", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Available blocks", HFILL}},
		{&hf_9P_files,
		 {"files", "9p_files", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Total files", HFILL}},
		{&hf_9P_ffree,
		 {"ffree", "9p_ffree", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Free files", HFILL}},
		{&hf_9P_fsid,
		 {"fsid", "9p_fsid", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Filesystem id", HFILL}},
		{&hf_9P_namelen,
		 {"namelen", "9p_namelen", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Max name length", HFILL}},
		{&hf_9P_mknod_major,
		 {"mknod_major", "9p_mknod_major", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Major node number", HFILL}},
		{&hf_9P_mknod_minor,
		 {"mknod_minor", "9p_mknod_minor", FT_UINT32, BASE_DEC, NULL, 0x0,
		  "Minor node number", HFILL}},
		{&hf_9P_lflags,
		 {"lflags", "9p_lcreate_flags", FT_UINT32, BASE_HEX, NULL, 0x0,
		  "Lcreate flags", HFILL}},
		/* rdonly is 0x00, check instead that we are neither wronly nor rdwrite */
		{&hf_9P_lflags_rdonly,
		 {"Read only", "9p_lflags_rdonly", FT_BOOLEAN, 32, TFS(&tfs_no_yes), _9P_DOTL_WRONLY|_9P_DOTL_RDWR,
		  NULL, HFILL}},
		{&hf_9P_lflags_wronly,
		 {"Write only", "9p_lflags_wronly", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_WRONLY,
		  NULL, HFILL}},
		{&hf_9P_lflags_rdwr,
		 {"Read Write", "9p_lflags_rdwr", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_RDWR,
		  NULL, HFILL}},
		{&hf_9P_lflags_create,
		 {"Create", "9p_lflags_create", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_CREATE,
		  NULL, HFILL}},
		{&hf_9P_lflags_excl,
		 {"Exclusive", "9p_lflags_excl", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_EXCL,
		  NULL, HFILL}},
		{&hf_9P_lflags_noctty,
		 {"noctty", "9p_lflags_noctty", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_NOCTTY,
		  NULL, HFILL}},
		{&hf_9P_lflags_trunc,
		 {"Truncate", "9p_lflags_trunc", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_TRUNC,
		  NULL, HFILL}},
		{&hf_9P_lflags_append,
		 {"Append", "9p_lflags_append", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_APPEND,
		  NULL, HFILL}},
		{&hf_9P_lflags_nonblock,
		 {"Nonblock", "9p_lflags_nonblock", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_NONBLOCK,
		  NULL, HFILL}},
		{&hf_9P_lflags_dsync,
		 {"dsync", "9p_lflags_dsync", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_DSYNC,
		  NULL, HFILL}},
		{&hf_9P_lflags_fasync,
		 {"fasync", "9p_lflags_fasync", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_FASYNC,
		  NULL, HFILL}},
		{&hf_9P_lflags_direct,
		 {"Direct", "9p_lflags_direct", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_DIRECT,
		  NULL, HFILL}},
		{&hf_9P_lflags_largefile,
		 {"Large File", "9p_lflags_largefile", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_LARGEFILE,
		  NULL, HFILL}},
		{&hf_9P_lflags_directory,
		 {"Directory", "9p_lflags_directory", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_DIRECTORY,
		  NULL, HFILL}},
		{&hf_9P_lflags_nofollow,
		 {"No follow", "9p_lflags_nofollow", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_NOFOLLOW,
		  NULL, HFILL}},
		{&hf_9P_lflags_noatime,
		 {"No atime", "9p_lflags_noatime", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_NOATIME,
		  NULL, HFILL}},
		{&hf_9P_lflags_cloexec,
		 {"cloexec", "9p_lflags_cloexec", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_CLOEXEC,
		  NULL, HFILL}},
		{&hf_9P_lflags_sync,
		 {"Sync", "9p_lflags_sync", FT_BOOLEAN, 32, TFS(&tfs_yes_no), _9P_DOTL_SYNC,
		  NULL, HFILL}},
		{&hf_9P_xattr_flag,
		 {"xattr_flag", "9p_xattr_flag", FT_UINT32, BASE_HEX, NULL, 0x0,
		  "Xattr flag", HFILL}},
		{&hf_9P_lock_type,
		 {"lock_type", "9p_lock_type", FT_UINT32, BASE_HEX | BASE_EXT_STRING, &ninep_lock_type_ext, 0x0,
		  "Lock type", HFILL}},
		{&hf_9P_lock_flag,
		 {"lock_flag", "9p_lock_flag", FT_UINT32, BASE_HEX | BASE_EXT_STRING, &ninep_lock_flag_ext, 0x0,
		  "Lock flag", HFILL}},
		{&hf_9P_lock_start,
		 {"lock_start", "9p_lock_start", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Lock start", HFILL}},
		{&hf_9P_lock_length,
		 {"lock_length", "9p_lock_length", FT_UINT64, BASE_DEC, NULL, 0x0,
		  "Lock length", HFILL}},
		{&hf_9P_lock_procid,
		 {"lock_procid", "9p_lock_procid", FT_UINT32, BASE_HEX, NULL, 0x0,
		  "Lock procid", HFILL}},
		{&hf_9P_lock_status,
		 {"lock_status", "9p_lock_status", FT_UINT8, BASE_HEX | BASE_EXT_STRING, &ninep_lock_status_ext, 0x0,
		  "Lock status", HFILL}},
		{&hf_9P_unknown_message,
		 {"Message data", "9p_message_data", FT_BYTES, BASE_NONE, NULL, 0x0,
		  NULL, HFILL}}
	};
