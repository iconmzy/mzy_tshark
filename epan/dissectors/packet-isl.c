...
proto_register_isl(void)
{
  static hf_register_info hf[] = {
    { &hf_isl_dst,
      { "Destination",        "isl_dst", FT_ETHER, BASE_NONE, NULL, 0x0,
        "Destination Address", HFILL }},
    { &hf_isl_type,
      { "Type",               "isl_type", FT_UINT8, BASE_DEC,
        VALS(type_vals), 0xF0, NULL, HFILL }},
    { &hf_isl_user_eth,
      { "User",               "isl_user_eth", FT_UINT8, BASE_DEC,
        VALS(user_vals), 0x03, "Priority while passing through switch", HFILL }},
    { &hf_isl_user,
      { "User",               "isl_user", FT_UINT8, BASE_HEX, NULL, 0x0F,
        "User-defined bits", HFILL }},
    { &hf_isl_src,
      { "Source",             "isl_src", FT_ETHER, BASE_NONE, NULL, 0x0,
        "Source Hardware Address", HFILL }},
    { &hf_isl_addr,
      { "Source or Destination Address", "isl_addr", FT_ETHER, BASE_NONE, NULL, 0x0,
        "Source or Destination Hardware Address", HFILL }},
    { &hf_isl_len,
      { "Length",             "isl_len", FT_UINT16, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_isl_hsa,
      { "HSA",                "isl_hsa", FT_UINT24, BASE_HEX, NULL, 0x0,
        "High bits of source address", HFILL }},
    { &hf_isl_dsap,
      { "DSAP",               "isl_dsap", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_isl_ssap,
      { "SSAP",               "isl_ssap", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_isl_control,
      { "Control",            "isl_control", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_isl_vlan_id,
      { "VLAN ID",            "isl_vlan_id", FT_UINT16, BASE_DEC, NULL,
        0xFFFE, "Virtual LAN ID (Color)", HFILL }},
    { &hf_isl_bpdu,
      { "BPDU/CDP/VTP",               "isl_bpdu", FT_BOOLEAN, 16,
        TFS(&tfs_yes_no), 0x0001, "BPDU/CDP/VTP indicator", HFILL }},
    { &hf_isl_index,
      { "Index",              "isl_index", FT_UINT16, BASE_DEC, NULL, 0x0,
        "Port index of packet source", HFILL }},
    { &hf_isl_reserved,
      { "Reserved",           "isl_reserved", FT_UINT16, BASE_HEX, NULL, 0x0,
        "ISL Reserved", HFILL }},
#if 0
    { &hf_isl_crc,
      { "CRC",                "isl_crc", FT_UINT32, BASE_HEX, NULL, 0x0,
        "CRC field of encapsulated frame", HFILL }},
#endif
    { &hf_isl_src_vlan_id,
      { "Source VLAN ID",     "isl_src_vlan_id", FT_UINT16, BASE_DEC, NULL,
        0xFFFE, "Source Virtual LAN ID (Color)", HFILL }},
    { &hf_isl_explorer,
      { "Explorer",           "isl_explorer", FT_BOOLEAN, 16,
        TFS(&explorer_tfs), 0x0001, NULL, HFILL }},
    { &hf_isl_dst_route_descriptor,
      { "Destination route descriptor",       "isl_dst_route_desc",
        FT_UINT16, BASE_HEX, NULL, 0x0,
        "Route descriptor to be used for forwarding", HFILL }},
    { &hf_isl_src_route_descriptor,
      { "Source-route descriptor",    "isl_src_route_desc",
        FT_UINT16, BASE_HEX, NULL, 0x0,
        "Route descriptor to be used for source learning", HFILL }},
    { &hf_isl_fcs_not_incl,
      { "FCS Not Included",   "isl_fcs_not_incl", FT_BOOLEAN, 9,
        NULL, 0x40, NULL, HFILL }},
    { &hf_isl_esize,
      { "Esize",      "isl_esize", FT_UINT8, BASE_DEC, NULL,
        0x3F, "Frame size for frames less than 64 bytes", HFILL }},
    { &hf_isl_trailer,
      { "Trailer",    "isl_trailer", FT_BYTES, BASE_NONE, NULL, 0x0,
