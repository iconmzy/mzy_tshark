...
proto_register_amr(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_amr_reserved,
            { "Reserved",           "amr_reserved",
            FT_UINT8, BASE_DEC, NULL, 0x0f,
            "Reserved bits", HFILL }
        },
        { &hf_amr_payload_decoded_as,
            { "Payload decoded as",           "amr_payload_decoded_as",
