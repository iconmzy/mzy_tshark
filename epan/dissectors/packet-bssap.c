...
proto_register_bssap(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_bssap_plus_message_type,
          { "Message Type", "bssap_plus_msg_type",
        ...
        { &hf_bssap_plus_ie_len,
          { "Length indicator", "bssap_plus_ie_len",
        FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL}},

        { &hf_bssap_extension,
          { "Extension", "bssap_extension",
            FT_BOOLEAN, 8, TFS(&tfs_no_extension_extension), 0x80,
            NULL, HFILL }},

        { &hf_bssap_type_of_number,
          { "Type of number", "bssap_type_of_number",
            FT_UINT8, BASE_HEX, VALS(gsm_a_dtap_type_of_number_values), 0x70,
            NULL, HFILL }},

        { &hf_bssap_numbering_plan_id,
          { "Numbering plan identification", "bssap_number_plan",
            FT_UINT8, BASE_HEX, VALS(gsm_a_dtap_numbering_plan_id_values), 0x0f,
            NULL, HFILL }},

        { &hf_bssap_sgsn_number,
          { "SGSN number", "bssap_sgsn_number",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},

#if 0
        { &hf_bssap_vlr_number,
          { "VLR number", "bssap_vlr_number",
            FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
#endif

        { &hf_bssap_cell_global_id_ie,
          { "Cell global identity IE", "bssap_cell_global_id_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_channel_needed_ie,
          { "Channel needed IE", "bssap_channel_needed_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_dlink_tnl_pld_cntrl_amd_inf_ie,
          { "Downlink Tunnel Payload Control and Info IE", "bssap_dlink_tnl_pld_cntrl_amd_inf_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_ulink_tnl_pld_cntrl_amd_inf_ie,
          { "Uplink Tunnel Payload Control and Info IE", "bssap_ulink_tnl_pld_cntrl_amd_inf_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_emlpp_prio_ie,
          { "eMLPP Priority IE", "bssap_emlpp_prio_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_gprs_erroneous_msg_ie,
          { "Erroneous message IE", "bssap_erroneous_msg_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_gprs_loc_upd_type_ie,
          { "GPRS location update type IE", "bssap_loc_upd_type_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_Gs_cause_ie,
          { "Gs Cause IE", "bssap_Gs_cause_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_imei_ie,
          { "IMEI IE", "bssap_imei_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_imeisv_ie,
          { "IMEISV IE", "bssap_imeisv_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_imsi_ie,
          { "IMSI IE", "bssap_imsi_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_imsi_det_from_gprs_serv_type_ie,
          { "IMSI detach from GPRS service type IE", "bssap_msi_det_from_gprs_serv_type_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_imsi_det_from_non_gprs_serv_type_ie,
          { "IMSI detach from non-GPRS service IE", "bssap_msi_det_from_non_gprs_serv_type_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_info_req_ie,
          { "Information requested IE", "bssap_info_req_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_loc_area_id_ie,
          { "Location area identifier IE", "bssap_loc_area_id_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_loc_inf_age_ie,
          { "Location information age IE", "bssap_loc_inf_age_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_mm_information_ie,
          { "MM information IE", "bssap_mm_information",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_mobile_id_ie,
          { "Mobile identity IE", "bssap_mobile_id_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_mobile_stn_cls_mrk1_ie,
          { "Mobile station classmark 1 IE", "bssap_mobile_stn_cls_mrk1_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_mobile_station_state_ie,
          { "Mobile station state IE", "bssap_mobile_station_state_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_ptmsi_ie,
          { "PTMSI IE", "bssap_ptmsi_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_reject_cause_ie,
          { "Reject cause IE", "bssap_reject_cause_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_service_area_id_ie,
          { "Service area identification IE", "bssap_service_area_id_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            "Mobile station classmark 1", HFILL }},

        { &hf_bssap_sgsn_nr_ie,
          { "SGSN number IE", "bssap_sgsn_nr_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_tmsi_ie,
          { "TMSI IE", "bssap_tmsi_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_tmsi_status_ie,
          { "TMSI status IE", "bssap_tmsi_status_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_vlr_number_ie,
          { "VLR number IE", "bssap_vlr_number_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_global_cn_id_ie,
          { "Global CN-Id IE", "bssap_global_cn_id_ie",
            FT_NONE, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_plus_ie_data,
          { "IE Data", "bssap_ie_data",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssap_call_priority,
          { "eMLPP Priority", "bssap_call_priority",
            FT_UINT8, BASE_DEC, VALS(bssap_call_priority_values), 0x07,
            NULL, HFILL}},

        { &hf_bssap_gprs_loc_upd_type,
          { "GPRS location update type", "bssap_gprs_loc_upd_type",
            FT_UINT8, BASE_DEC, VALS(bssap_plus_GPRS_loc_upd_type_values), 0x0,
            NULL, HFILL}},

        { &hf_bssap_Gs_cause,
          { "Gs cause", "bssap_Gs_cause",
        ...
        { &hf_bssap_imsi_det_from_gprs_serv_type,
          { "IMSI detach from GPRS service type", "bssap_imsi_det_from_gprs_serv_type",
            FT_UINT8, BASE_DEC, VALS(bssap_Gs_cause_values), 0x0,
            NULL, HFILL}},

        { &hf_bssap_info_req,
          { "Information requested", "bssap_info_req",
            FT_UINT8, BASE_DEC, VALS(bssap_info_req_values), 0x0,
            NULL, HFILL}},

        { &hf_bssap_loc_inf_age,
          { "AgeOfLocationInformation in minutes", "bssap_loc_inf_age",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL}},

        { &hf_bssap_mobile_station_state,
          { "Mobile station state", "bssap_mobile_station_state",
        ...
        { &hf_bssap_tmsi_status,
          { "TMSI status", "bssap_tmsi_status",
            FT_BOOLEAN, 8, TFS(&bssap_tmsi_flag), 0x01,
            NULL, HFILL }},

        { &hf_bssap_tom_prot_disc,
          { "TOM Protocol Discriminator", "bssap_Tom_prot_disc",
            FT_UINT8, BASE_DEC, VALS(bssap_tom_prot_disc_values), 0x78,
            NULL, HFILL}},

        { &hf_bssap_e_bit,
          { "E: Cipher Request", "bssap_e_bit",
            FT_BOOLEAN, 8, TFS(&bssap_E_flag), 0x04,
            NULL, HFILL }},

        { &hf_bssap_tunnel_prio,
          { "Tunnel Priority", "bssap_tunnel_prio",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL}},

        { &hf_bssap_global_cn_id,
          { "Global CN-Id", "bssap_global_cn_id",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL}},

        { &hf_bssap_plmn_id,
          { "PLMN-Id", "bssap_plmn_id",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL}},
        ...
        { &hf_bssap_cell_global_id,
          { "Cell global identity", "bssap_cell_global_id",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL}},

        { &hf_bssap_extraneous_data,
          { "Extraneous data", "bssap_extraneous_data",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL}},

        { &hf_bssap_conditional_ie,
          { "Conditional IE", "bssap_conditional_ie",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL}},
    };
