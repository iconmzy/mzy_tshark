...
void proto_register_avsp(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        {&hf_avsp_ts_64_tai,
            {"Timestamp (TAI)", "avsp_64ts",
                FT_NONE, BASE_NONE,
                NULL, 0x0,
                NULL, HFILL}
        },
        {&hf_avsp_ts_64_utc,
            {"Timestamp (UTC)", "avsp_64ts",
                FT_NONE, BASE_NONE,
                NULL, 0x0,
                NULL, HFILL}
        },
        ...
        {&hf_avsp_ts_64_ns,
            {"Nanoseconds", "avsp_64ns",
                FT_UINT32, BASE_DEC,
                NULL, 0x0,
                NULL, HFILL}
        },
        {&hf_avsp_ts_48_tai,
            {"Timestamp (TAI)", "avsp_48ts",
                FT_NONE, BASE_NONE,
                NULL, 0x0,
                NULL, HFILL}
        },
        {&hf_avsp_ts_48_utc,
            {"Timestamp (UTC)", "avsp_48ts",
                FT_NONE, BASE_NONE,
                NULL, 0x0,
                NULL, HFILL}
        },
