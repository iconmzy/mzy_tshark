...
register_radius_fields(const char *unused _U_)
{
	hf_register_info base_hf[] = {
		{ &hf_radius_req,
		{ "Request", "radius_req", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
			"TRUE if RADIUS request", HFILL }},
		{ &hf_radius_rsp,
		{ "Response", "radius_rsp", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
			"TRUE if RADIUS response", HFILL }},
		{ &hf_radius_req_frame,
		{ "Request Frame", "radius_reqframe", FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_REQUEST), 0,
			NULL, HFILL }},
		{ &hf_radius_rsp_frame,
		{ "Response Frame", "radius_rspframe", FT_FRAMENUM, BASE_NONE, FRAMENUM_TYPE(FT_FRAMENUM_RESPONSE), 0,
			NULL, HFILL }},
		{ &hf_radius_time,
		{ "Time from request", "radius_time", FT_RELATIVE_TIME, BASE_NONE, NULL, 0,
			"Timedelta between Request and Response", HFILL }},
		{ &hf_radius_code,
		{ "Code", "radius_code", FT_UINT8, BASE_DEC|BASE_EXT_STRING, &radius_pkt_type_codes_ext, 0x0,
			NULL, HFILL }},
		{ &hf_radius_id,
		{ "Identifier",	"radius_id", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_authenticator,
		{ "Authenticator",	"radius_authenticator", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_authenticator_valid,
		{ "Valid Authenticator", "radius_authenticator_valid", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
			"TRUE if Authenticator is valid", HFILL }},
		{ &hf_radius_authenticator_invalid,
		{ "Invalid Authenticator", "radius_authenticator_invalid", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
			"TRUE if Authenticator is invalid", HFILL }},
		{ &hf_radius_length,
		{ "Length", "radius_length", FT_UINT16, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &(no_dictionary_entry.hf),
		{ "Unknown-Attribute", "radius_Unknown_Attribute", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &(no_dictionary_entry.hf_len),
		{ "Unknown-Attribute Length", "radius_Unknown_Attribute_length", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_chap_password,
		{ "CHAP-Password", "radius_CHAP_Password", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_chap_ident,
		{ "CHAP Ident", "radius_CHAP_Ident", FT_UINT8, BASE_HEX, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_chap_string,
		{ "CHAP String", "radius_CHAP_String", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_framed_ip_address,
		{ "Framed-IP-Address", "radius_Framed-IP-Address", FT_IPv4, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_login_ip_host,
		{ "Login-IP-Host", "radius_Login-IP-Host", FT_IPv4, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_framed_ipx_network,
		{ "Framed-IPX-Network", "radius_Framed-IPX-Network", FT_IPXNET, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_cosine_vpi,
		{ "Cosine-VPI", "radius_Cosine-Vpi", FT_UINT16, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_cosine_vci,
		{ "Cosine-VCI", "radius_Cosine-Vci", FT_UINT16, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_dup,
		{ "Duplicate Message ID", "radius_dup", FT_UINT32, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_req_dup,
		{ "Duplicate Request Frame Number", "radius_req_dup", FT_FRAMENUM, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_rsp_dup,
		{ "Duplicate Response Frame Number", "radius_rsp_dup", FT_FRAMENUM, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter,
		{ "Ascend Data Filter", "radius_ascenddatafilter", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_type,
		{ "Type", "radius_ascenddatafilter_type", FT_UINT8, BASE_DEC, VALS(ascenddf_filtertype), 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_filteror,
		{ "Filter or forward", "radius_ascenddatafilter_filteror", FT_UINT8, BASE_DEC, VALS(ascenddf_filteror), 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_inout,
		{ "Indirection", "radius_ascenddatafilter_inout", FT_UINT8, BASE_DEC, VALS(ascenddf_inout), 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_spare,
		{ "Spare", "radius_ascenddatafilter_spare", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_src_ipv4,
		{ "Source IPv4 address", "radius_ascenddatafilter_src_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_dst_ipv4,
		{ "Destination IPv4 address", "radius_ascenddatafilter_dst_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_src_ipv6,
		{ "Source IPv6 address", "radius_ascenddatafilter_src_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_dst_ipv6,
		{ "Destination IPv6 address", "radius_ascenddatafilter_dst_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_src_ip_prefix,
		{ "Source IP prefix", "radius_ascenddatafilter_src_prefix_ip", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_dst_ip_prefix,
		{ "Destination IP prefix", "radius_ascenddatafilter_dst_prefix_ip", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_protocol,
		{ "Protocol", "radius_ascenddatafilter_protocol", FT_UINT8, BASE_DEC, VALS(ascenddf_proto), 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_established,
		{ "Established", "radius_ascenddatafilter_established", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_src_port,
		{ "Source Port", "radius_ascenddatafilter_src_port", FT_UINT16, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_dst_port,
		{ "Destination Port", "radius_ascenddatafilter_dst_port", FT_UINT16, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_src_port_qualifier,
		{ "Source Port Qualifier", "radius_ascenddatafilter_src_port_qualifier", FT_UINT8, BASE_DEC, VALS(ascenddf_portq), 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_dst_port_qualifier,
		{ "Destination Port Qualifier", "radius_ascenddatafilter_dst_port_qualifier", FT_UINT8, BASE_DEC, VALS(ascenddf_portq), 0x0,
			NULL, HFILL }},
		{ &hf_radius_ascend_data_filter_reserved,
		{ "Reserved", "radius_ascenddatafilter_reserved", FT_UINT16, BASE_HEX, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_vsa_fragment,
		{ "VSA fragment", "radius_vsa_fragment", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_eap_fragment,
		{ "EAP fragment", "radius_eap_fragment", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp,
		{ "AVP", "radius_avp", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_length,
		{ "Length", "radius_avp_length", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_type,
		{ "Type", "radius_avp_type", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_vendor_id,
		{ "Vendor ID", "radius_avp_vendor_id", FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_vendor_type,
		{ "Type", "radius_avp_vendor_type", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_vendor_len,
		{ "Length", "radius_avp_vendor_len", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_extended_type,
		{ "Extended Type", "radius_avp_extended_type", FT_UINT8, BASE_DEC, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_avp_extended_more,
		{ "Extended More", "radius_avp_extended_more", FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x80,
			NULL, HFILL }},
		{ &hf_radius_egress_vlanid_tag,
		{ "Tag", "radius_egress_vlanid_tag", FT_UINT32, BASE_HEX, VALS(egress_vlan_tag_vals), 0xFF000000,
			NULL, HFILL }},
		{ &hf_radius_egress_vlanid_pad,
		{ "Pad", "radius_egress_vlanid_pad", FT_UINT32, BASE_HEX, NULL, 0x00FFF000,
			NULL, HFILL }},
		{ &hf_radius_egress_vlanid,
		{ "Vlan ID", "radius_egress_vlanid", FT_UINT32, BASE_DEC, NULL, 0x00000FFF,
			NULL, HFILL }},
		{ &hf_radius_egress_vlan_name_tag,
		{ "Tag", "radius_egress_vlan_name_tag", FT_UINT8, BASE_HEX, VALS(egress_vlan_tag_vals), 0x0,
			NULL, HFILL }},
		{ &hf_radius_egress_vlan_name,
		{ "Vlan Name", "radius_egress_vlan_name", FT_STRING, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
		{ &hf_radius_3gpp_ms_tmime_zone,
		{ "Timezone", "radius_3gpp_ms_tmime_zone", FT_BYTES, BASE_NONE, NULL, 0x0,
			NULL, HFILL }},
	};
