...
proto_register_rtsp(void)
{
    ...
    static hf_register_info hf[] = {
        { &hf_rtsp_request,
            { "Request", "rtsp_request", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_response,
            { "Response", "rtsp_response", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_method,
            { "Method", "rtsp_method", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_content_type,
            { "Content-type", "rtsp_content-type", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_content_length,
            { "Content-length", "rtsp_content-length", FT_UINT32, BASE_DEC, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_url,
            { "URL", "rtsp_url", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_status,
            { "Status", "rtsp_status", FT_UINT32, BASE_DEC, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_session,
            { "Session", "rtsp_session", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_transport,
            { "Transport", "rtsp_transport", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_rdtfeaturelevel,
            { "RDTFeatureLevel", "rtsp_rdt-feature-level", FT_UINT32, BASE_DEC, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_X_Vig_Msisdn,
            { "X-Vig-Msisdn", "rtsp_X_Vig_Msisdn", FT_STRING, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_rtsp_magic,
            { "Magic", "rtsp_magic", FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }},
        { &hf_rtsp_channel,
            { "Channel", "rtsp_channel", FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }},
        { &hf_rtsp_length,
            { "Length", "rtsp_length", FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }},
        { &hf_rtsp_data,
            { "Data", "rtsp_data", FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }},
    };
