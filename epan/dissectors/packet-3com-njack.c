...
proto_register_njack(void)
{
	...
	/* NJACK header */
		{ &hf_njack_magic,
		{ "Magic",	"njack_magic", FT_STRING, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_type,
		{ "Type",	"njack_type", FT_UINT8, BASE_HEX, NULL,
			0x0, NULL, HFILL }},

	/* TLV fields */
		{ &hf_njack_tlv_type,
		{ "TlvType",	"njack_tlv_type", FT_UINT8, BASE_HEX | BASE_EXT_STRING, &njack_cmd_vals_ext,
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_length,
		{ "TlvLength",	"njack_tlv_length", FT_UINT8, BASE_HEX, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_data,
		{ "TlvData",   "njack_tlv_data", FT_BYTES, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_version,
		{ "TlvFwVersion",   "njack_tlv_version", FT_IPv4, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_snmpwrite,
		{ "TlvTypeSnmpwrite",	"njack_tlv_snmpwrite", FT_UINT8, BASE_DEC, VALS(njack_snmpwrite),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_dhcpcontrol,
		{ "TlvTypeDhcpControl",	  "njack_tlv_dhcpcontrol", FT_UINT8, BASE_DEC, VALS(njack_dhcpcontrol),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_devicemac,
		{ "TlvTypeDeviceMAC",	"njack_tlv_devicemac", FT_ETHER, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

		/* XXX dummy entries, to be replaced */
		{ &hf_njack_tlv_typeip,
		{ "TlvTypeIP",	 "njack_tlv_typeip", FT_IPv4, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_typestring,
		{ "TlvTypeString",   "njack_tlv_typestring", FT_STRING, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

		/* 1st tab */
		{ &hf_njack_tlv_scheduling,
		{ "TlvTypeScheduling",	 "njack_tlv_scheduling", FT_UINT8, BASE_DEC, VALS(njack_scheduling),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_addtagscheme,
		{ "TlvAddTagScheme",   "njack_tlv_addtagscheme", FT_UINT8, BASE_DEC, VALS(njack_addtagscheme),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_portingressmode,
		{ "TlvTypePortingressmode",   "njack_tlv_portingressmode", FT_UINT8, BASE_DEC, VALS(njack_portingressmode),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_maxframesize,
		{ "TlvTypeMaxframesize",   "njack_tlv_maxframesize", FT_UINT8, BASE_DEC, VALS(njack_maxframesize),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_countermode,
		{ "TlvTypeCountermode",	  "njack_tlv_countermode", FT_UINT8, BASE_DEC, VALS(njack_countermode),
			0x0, NULL, HFILL }},

		{ &hf_njack_tlv_powerforwarding,
		{ "TlvTypePowerforwarding",   "njack_tlv_powerforwarding", FT_UINT8, BASE_DEC, VALS(njack_powerforwarding),
			0x0, NULL, HFILL }},

	/* Type 0x07: set */
		{ &hf_njack_set_length,
		{ "SetLength",	"njack_set_length", FT_UINT16, BASE_HEX, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_set_salt,
		{ "Salt",	"njack_set_salt", FT_UINT32, BASE_HEX, NULL,
			0x0, NULL, HFILL }},

		{ &hf_njack_set_authdata,
		{ "Authdata",	"njack_tlv_authdata", FT_BYTES, BASE_NONE, NULL,
			0x0, NULL, HFILL }},

	/* Type 0x08: set result */
		{ &hf_njack_setresult,
		{ "SetResult",	 "njack_setresult", FT_UINT8, BASE_HEX, VALS(njack_setresult_vals),
			0x0, NULL, HFILL }},
	...
	/* Type 0x0c get response */
		...
		{ "Unknown1",	"njack_getresp_unknown1", FT_UINT8, BASE_HEX, NULL,
			0x0, NULL, HFILL }},
