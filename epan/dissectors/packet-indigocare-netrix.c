...
proto_register_netrix(void)
{
	...
	{ &hf_netrix_header_type,
		{ "Header Type", "netrix_header",
		FT_UINT32, BASE_DEC,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_systeminfo_type,
		{ "Ack", "netrix_systeminfo",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_groupcall_type,
		{ "Group call", "netrix_groupcall",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_profilecall_type,
		{ "Profile call", "netrix_profilecall",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_get_conversiontable_type,
		{ "Get conversiontable", "netrix_getconversiontable",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_get_conversiontable_none_type,
		{ "Get conversiontable: no results", "netrix_getconversiontable_noresult",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_get_conversiontable_result_type,
		{ "Get conversiontable result", "netrix_getconversiontable_result",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_search_conversiontables_type,
		{ "Search conversiontables", "netrix_searchconversiontables",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_search_conversiontables_none_type,
		{ "Search converstiontables: no results", "netrix_searchconversiontables_noresult",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_header_boschcall_type,
		{ "Bosch call", "netrix_boschcall",
		FT_NONE, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	...
	{ &hf_netrix_systeminfo_computername_type,
		{ "Computername", "netrix_systeminfo_computername",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_systeminfo_ipaddress_type,
		{ "IP Address", "netrix_systeminfo_ipaddress",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_systeminfo_version_type,
		{ "Version", "netrix_systeminfo_version",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_systeminfo_beep_type,
		{ "Beep", "netrix_systeminfo_beep",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_groupnumber_type,
		{ "Groupnumber", "netrix_groupcall_groupnumber",
		FT_UINT32, BASE_DEC,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_type_type,
		{ "MSG1 (Type)", "netrix_groupcall_type",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_addition_type,
		{ "MSG2 (Addition)", "netrix_groupcall_addition",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_idboschloc_type,
		{ "MSG3 (ID / Bosch Loc)", "netrix_groupcall_idboschloc",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_name_type,
		{ "MSG4 (Name)", "netrix_groupcall_name",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_room_type,
		{ "MSG5 (Room)", "netrix_groupcall_room",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_groupcall_location_type,
		{ "MSG6 (Location)", "netrix_groupcall_location",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_groupnumber_type,
		{ "Profilenumber", "netrix_profilecall_profilenumber",
		FT_UINT32, BASE_DEC,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_type_type,
		{ "MSG1 (Type)", "netrix_profilecall_type",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_addition_type,
		{ "MSG2 (Addition)", "netrix_profilecall_addition",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_idboschloc_type,
		{ "MSG3 (ID / Bosch Loc)", "netrix_profilecall_idboschloc",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_name_type,
		{ "MSG4 (Name)", "netrix_profilecall_name",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_room_type,
		{ "MSG5 (Room)", "netrix_profilecall_room",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_profilecall_location_type,
		{ "MSG6 (Location)", "netrix_profilecall_location",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_get_conversiontable_table_type,
		{ "Table", "netrix_getconversiontable_table",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_get_conversiontable_key_type,
		{ "Key", "netrix_getconversiontable_key",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_get_conversiontable_value_type,
		{ "Value", "netrix_getconversiontable_value",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_search_conversiontables_key_type,
		{ "Key", "netrix_searchconversiontables_key",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	},
	{ &hf_netrix_search_conversiontables_table_type,
		{ "Table", "netrix_searchconversiontables_table",
		FT_STRING, BASE_NONE,
		NULL, 0x0,
		NULL, HFILL }
	}
