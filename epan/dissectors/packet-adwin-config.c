...
proto_register_adwin_config(void)
{
	static hf_register_info hf[] = {
		...
		{ &hf_adwin_config_server_version,
		  { "Server version", "adwin_config_server_version",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		...
		{ &hf_adwin_config_server_version_beta,
		  { "server version (beta part)", "adwin_config_server_version_beta",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		...
		{ &hf_adwin_config_socketshutdowns,
		  { "Socket shutdowns", "adwin_config_socketshutdowns",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		...
		{ &hf_adwin_config_status,
		  { "Status", "adwin_config_status",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_adwin_config_status_bootloader,
		  { "Status Bootloader", "adwin_config_status_bootloader",
