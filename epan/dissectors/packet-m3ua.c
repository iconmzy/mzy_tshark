...
proto_register_m3ua(void)
{
  ...
  static hf_register_info hf[] = {
    { &hf_version,                          { "Version",                      "m3ua_version",                               FT_UINT8,  BASE_DEC,  VALS(protocol_version_values),                0x0, NULL,                              HFILL } },
    { &hf_reserved,                         { "Reserved",                     "m3ua_reserved",                              FT_UINT8,  BASE_HEX,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_v5_message_class,                 { "Message class",                "m3ua_message_class",                         FT_UINT8,  BASE_DEC,  VALS(v5_message_class_values),                0x0, NULL,                              HFILL } },
    { &hf_message_class,                    { "Message class",                "m3ua_message_class",                         FT_UINT8,  BASE_DEC,  VALS(message_class_values),                   0x0, NULL,                              HFILL } },
    { &hf_message_type,                     { "Message Type",                 "m3ua_message_type",                          FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_message_length,                   { "Message length",               "m3ua_message_length",                        FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_v5_parameter_tag,                 { "Parameter Tag",                "m3ua_parameter_tag",                         FT_UINT16, BASE_DEC,  VALS(v5_parameter_tag_values),                0x0, NULL,                              HFILL } },
    { &hf_v6_parameter_tag,                 { "Parameter Tag",                "m3ua_parameter_tag",                         FT_UINT16, BASE_DEC,  VALS(v6_parameter_tag_values),                0x0, NULL,                              HFILL } },
    { &hf_v7_parameter_tag,                 { "Parameter Tag",                "m3ua_parameter_tag",                         FT_UINT16, BASE_DEC,  VALS(v7_parameter_tag_values),                0x0, NULL,                              HFILL } },
    { &hf_parameter_tag,                    { "Parameter Tag",                "m3ua_parameter_tag",                         FT_UINT16, BASE_DEC,  VALS(parameter_tag_values),                   0x0, NULL,                              HFILL } },
    { &hf_parameter_length,                 { "Parameter length",             "m3ua_parameter_length",                      FT_UINT16, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_parameter_value,                  { "Parameter value",              "m3ua_parameter_value",                       FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_parameter_padding,                { "Padding",                      "m3ua_parameter_padding",                     FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
#if 0
    { &hf_parameter_trailer,                { "Trailer",                      "m3ua_parameter_trailer",                      FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
#endif
    { &hf_network_appearance,               { "Network appearance",           "m3ua_network_appearance",                    FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_info_string,                      { "Info string",                  "m3ua_info_string",                           FT_STRING, BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_routing_context,                  { "Routing context",              "m3ua_routing_context",                       FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_diagnostic_information,           { "Diagnostic information",       "m3ua_diagnostic_information",                FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_heartbeat_data,                   { "Heartbeat data",               "m3ua_heartbeat_data",                        FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_v5_error_code,                    { "Error code",                   "m3ua_error_code",                            FT_UINT32, BASE_DEC,  VALS(v5_error_code_values),                   0x0, NULL,                              HFILL } },
    { &hf_v6_error_code,                    { "Error code",                   "m3ua_error_code",                            FT_UINT32, BASE_DEC,  VALS(v6_error_code_values),                   0x0, NULL,                              HFILL } },
    { &hf_v7_error_code,                    { "Error code",                   "m3ua_error_code",                            FT_UINT32, BASE_DEC,  VALS(v7_error_code_values),                   0x0, NULL,                              HFILL } },
    { &hf_error_code,                       { "Error code",                   "m3ua_error_code",                            FT_UINT32, BASE_DEC,  VALS(error_code_values),                      0x0, NULL,                              HFILL } },
    { &hf_status_type,                      { "Status type",                  "m3ua_status_type",                           FT_UINT16, BASE_DEC,  VALS(status_type_values),                     0x0, NULL,                              HFILL } },
    { &hf_status_info,                      { "Status info",                  "m3ua_status_info",                           FT_UINT16, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_asp_identifier,                   { "ASP identifier",               "m3ua_asp_identifier",                        FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_affected_point_code_mask,         { "Mask",                         "m3ua_affected_point_code_mask",              FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_affected_point_code_pc,           { "Affected point code",          "m3ua_affected_point_code_pc",                FT_UINT24, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_cause,                            { "Unavailability cause",         "m3ua_unavailability_cause",                  FT_UINT16, BASE_DEC,  VALS(unavailability_cause_values),            0x0, NULL,                              HFILL } },
    { &hf_user,                             { "User Identity",                "m3ua_user_identity",                         FT_UINT16, BASE_DEC,  VALS(user_identity_values),                   0x0, NULL,                              HFILL } },
    { &hf_reason,                           { "Reason",                       "m3ua_reason",                                FT_UINT32, BASE_DEC,  VALS(reason_values),                          0x0, NULL,                              HFILL } },
    { &hf_v5_traffic_mode_type,             { "Traffic mode Type",            "m3ua_traffic_mode_type",                     FT_UINT32, BASE_DEC,  VALS(v5_traffic_mode_type_values),            0x0, NULL,                              HFILL } },
    { &hf_v6_traffic_mode_type,             { "Traffic mode Type",            "m3ua_traffic_mode_type",                     FT_UINT32, BASE_DEC,  VALS(v6_traffic_mode_type_values),            0x0, NULL,                              HFILL } },
    { &hf_v7_traffic_mode_type,             { "Traffic mode Type",            "m3ua_traffic_mode_type",                     FT_UINT32, BASE_DEC,  VALS(v7_traffic_mode_type_values),            0x0, NULL,                              HFILL } },
    { &hf_traffic_mode_type,                { "Traffic mode Type",            "m3ua_traffic_mode_type",                     FT_UINT32, BASE_DEC,  VALS(traffic_mode_type_values),               0x0, NULL,                              HFILL } },
    { &hf_congestion_reserved,              { "Reserved",                     "m3ua_congestion_reserved",                   FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_congestion_level,                 { "Congestion level",             "m3ua_congestion_level",                      FT_UINT8,  BASE_DEC,  VALS(congestion_level_values),                0x0, NULL,                              HFILL } },
    { &hf_concerned_dest_reserved,          { "Reserved",                     "m3ua_concerned_reserved",                    FT_BYTES,  BASE_NONE, NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_concerned_dest_pc,                { "Concerned DPC",                "m3ua_concerned_dpc",                         FT_UINT24, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_local_rk_identifier,              { "Local routing key identifier", "m3ua_local_rk_identifier",                   FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_dpc_mask,                         { "Mask",                         "m3ua_dpc_mask",                              FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_dpc_pc,                           { "Destination point code",       "m3ua_dpc_pc",                                FT_UINT24, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_si,                               { "Service indicator",            "m3ua_si",                                    FT_UINT8,  BASE_DEC,  VALS(user_identity_values),                   0x0, NULL,                              HFILL } },
    { &hf_ssn,                              { "Subsystem number",             "m3ua_ssn",                                   FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_opc_list_mask,                    { "Mask",                         "m3ua_opc_list_mask",                         FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_opc_list_pc,                      { "Originating point code",       "m3ua_opc_list_pc",                           FT_UINT24, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_cic_range_mask,                   { "Mask",                         "m3ua_cic_range_mask",                        FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_cic_range_pc,                     { "Originating point code",       "m3ua_cic_range_pc",                          FT_UINT24, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_cic_range_lower,                  { "Lower CIC value",              "m3ua_cic_range_lower",                       FT_UINT16, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_cic_range_upper,                  { "Upper CIC value",              "m3ua_cic_range_upper",                       FT_UINT16, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_li,                               { "Length indicator",             "m3ua_protocol_data_2_li",                    FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_protocol_data_opc,                { "OPC",                          "m3ua_protocol_data_opc",                     FT_UINT32, BASE_DEC,  NULL,                                         0x0, "Originating Point Code",          HFILL } },
    { &hf_protocol_data_dpc,                { "DPC",                          "m3ua_protocol_data_dpc",                     FT_UINT32, BASE_DEC,  NULL,                                         0x0, "Destination Point Code",          HFILL } },
    { &hf_protocol_data_mtp3_opc,           { "OPC",                          "mtp3_opc",                                   FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_protocol_data_mtp3_dpc,           { "DPC",                          "mtp3_dpc",                                   FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_protocol_data_mtp3_pc,            { "PC",                           "mtp3_pc",                                    FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_protocol_data_si,                 { "SI",                           "m3ua_protocol_data_si",                      FT_UINT8,  BASE_DEC,  VALS(mtp3_service_indicator_code_short_vals), 0x0, "Service Indicator",               HFILL } },
    { &hf_protocol_data_ni,                 { "NI",                           "m3ua_protocol_data_ni",                      FT_UINT8,  BASE_DEC,  VALS(mtp3_network_indicator_vals),            0x0, "Network Indicator",               HFILL } },
    { &hf_protocol_data_mtp3_ni,            { "NI",                           "mtp3_ni",                                    FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_protocol_data_mp,                 { "MP",                           "m3ua_protocol_data_mp",                      FT_UINT8,  BASE_DEC,  NULL,                                         0x0, "Message Priority",                HFILL } },
    { &hf_protocol_data_sls,                { "SLS",                          "m3ua_protocol_data_sls",                     FT_UINT8,  BASE_DEC,  NULL,                                         0x0, "Signalling Link Selection",       HFILL } },
    { &hf_protocol_data_mtp3_sls,           { "SLS",                          "mtp3_sls",                                   FT_UINT8,  BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_correlation_identifier,           { "Correlation Identifier",       "m3ua_correlation_identifier",                FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_registration_status,              { "Registration status",          "m3ua_registration_status",                   FT_UINT32, BASE_DEC,  VALS(registration_status_values),             0x0, NULL,                              HFILL } },
    { &hf_deregistration_status,            { "Deregistration status",        "m3ua_deregistration_status",                 FT_UINT32, BASE_DEC,  VALS(deregistration_status_values),           0x0, NULL,                              HFILL } },
    { &hf_registration_result_identifier,   { "Local RK-identifier value",    "m3ua_registration_result_identifier",        FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_registration_result_status,       { "Registration status",          "m3ua_registration_results_status",           FT_UINT32, BASE_DEC,  VALS(registration_result_status_values),      0x0, NULL,                              HFILL } },
    { &hf_registration_result_context,      { "Routing context",              "m3ua_registration_result_routing_context",   FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_v6_deregistration_result_status,  { "De-Registration status",       "m3ua_deregistration_results_status",         FT_UINT32, BASE_DEC,  VALS(v6_deregistration_result_status_values), 0x0, NULL,                              HFILL } },
    { &hf_v6_deregistration_result_context, { "Routing context",              "m3ua_deregistration_result_routing_context", FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
    { &hf_heuristic_standard,               { "Heuristic standard",           "m3ua_heuristic_standard",                    FT_UINT32, BASE_DEC,  NULL,                                         0x0, NULL,                              HFILL } },
  };
