...
proto_register_ipoib(void)
{
  static hf_register_info hf[] = {
    { &hf_daddr,
      { "Destination address", "ipoib_daddr",
        FT_NONE, BASE_NONE, NULL, 0x0,
        NULL, HFILL}},
    { &hf_daddr_qpn,
      { "Destination QPN", "ipoib_daddr_qpn",
        FT_UINT24, BASE_HEX, NULL, 0x0,
        NULL, HFILL}},
    { &hf_dgid,
      { "Destination GID", "ipoib_dgid",
        FT_IPv6, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_grh,
      { "Global Route Header", "ipoib_grh",
        FT_NONE, BASE_NONE, NULL, 0x0,
        NULL, HFILL}},
    { &hf_grh_ip_version, {
       "IP Version", "ipoib_grh_ipver",
       FT_UINT8, BASE_DEC, NULL, 0xF0,
       NULL, HFILL}},
    { &hf_grh_traffic_class, {
       "Traffic Class", "ipoib_grh_tclass",
       FT_UINT16, BASE_DEC, NULL, 0x0FF0,
       NULL, HFILL}},
    { &hf_grh_flow_label, {
       "Flow Label", "ipoib_grh_flowlabel",
       FT_UINT32, BASE_DEC, NULL, 0x000FFFFF,
       NULL, HFILL}},
    { &hf_grh_sqpn,
      { "Source QPN", "ipoib_grh_sqpn",
        FT_UINT24, BASE_HEX, NULL, 0x0,
        NULL, HFILL}},
    { &hf_grh_sgid,
      { "Source GID", "ipoib_grh_sgid",
        FT_IPv6, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_type,
      { "Type", "ipoib_type",
