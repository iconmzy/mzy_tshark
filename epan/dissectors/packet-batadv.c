...
void proto_register_batadv(void)
{
	...
	static hf_register_info hf[] = {
		{ &hf_batadv_packet_type,
		  { "Packet Type", "batadv_batman_packet_type",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_version,
		  { "Version", "batadv_batman_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_flags,
		  { "Flags", "batadv_batman_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_ttl,
		  { "Time to Live", "batadv_batman_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_gwflags,
		  { "Gateway Flags", "batadv_batman_gwflags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_gwflags_dl_speed,
		  { "Download Speed", "batadv_batman_gwflags_dl_speed",
		    FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_kbit, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_gwflags_ul_speed,
		  { "Upload Speed", "batadv_batman_gwflags_ul_speed",
		    FT_UINT32, BASE_DEC|BASE_UNIT_STRING, &units_kbit, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_tq,
		  { "Transmission Quality", "batadv_batman_tq",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_seqno,
		  { "Sequence number", "batadv_batman_seq",
		...
		{ &hf_batadv_batman_orig,
		  { "Originator", "batadv_batman_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_prev_sender,
		  { "Received from", "batadv_batman_prev_sender",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_num_tt,
		  { "Number of TTs", "batadv_batman_num_tt",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_tt_num_changes,
		  { "Number of TT Changes", "batadv_batman_tt_num_changes",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_ttvn,
		  { "TT Version", "batadv_batman_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_tt_crc,
		  { "CRC of TT", "batadv_batman_tt_crc",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_flags_directlink,
		  { "DirectLink", "batadv_batman_flags_directlink",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x40,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_flags_vis_server,
		  { "VIS_SERVER", "batadv_batman_flags_vis_server",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x20,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_flags_primaries_first_hop,
		  { "PRIMARIES_FIRST_HOP", "batadv_batman_flags_primaries_first_hop",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x10,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_flags_not_best_next_hop,
		  { "NOT_BEST_NEXT_HOP", "batadv_batman_flags_not_best_next_hop",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x8,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_version,
		  { "Version", "batadv_iv_ogm_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_ttl,
		  { "Time to Live", "batadv_iv_ogm_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_flags,
		  { "Flags", "batadv_iv_ogm_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_seqno,
		  { "Sequence number", "batadv_iv_ogm_seq",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_orig,
		  { "Originator", "batadv_iv_ogm_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_prev_sender,
		  { "Received from", "batadv_iv_ogm_prev_sender",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_tq,
		  { "Transmission Quality", "batadv_iv_ogm_tq",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_tvlv_len,
		  { "Length of TVLV", "batadv_iv_ogm_tvlv_len",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_flags_not_best_next_hop,
		  { "NOT_BEST_NEXT_HOP", "batadv_iv_ogm_flags_not_best_next_hop",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x1,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_flags_primaries_first_hop,
		  { "PRIMARIES_FIRST_HOP", "batadv_iv_ogm_flags_primaries_first_hop",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x2,
		    NULL, HFILL }
		},
		{ &hf_batadv_iv_ogm_flags_directlink,
		  { "DirectLink", "batadv_iv_ogm_flags_directlink",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x4,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_version,
		  { "Version", "batadv_ogm2_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_ttl,
		  { "Time to Live", "batadv_ogm2_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_flags,
		  { "Flags", "batadv_ogm2_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_seqno,
		  { "Sequence number", "batadv_ogm2_seq",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_orig,
		  { "Originator", "batadv_ogm2_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_tvlv_len,
		  { "Length of TVLV", "batadv_ogm2_tvlv_len",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_ogm2_throughput,
		  { "Throughput", "batadv_ogm2_throughput",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_batman_tt,
		  { "Translation Table", "batadv_batman_tt",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_elp_version,
		  { "Version", "batadv_elp_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_elp_orig,
		  { "Originator", "batadv_elp_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_elp_seqno,
		  { "Sequence number", "batadv_elp_seq",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_elp_interval,
		  { "ELP Interval", "batadv_elp_interval",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_bcast_version,
		  { "Version", "batadv_bcast_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_bcast_orig,
		  { "Originator", "batadv_bcast_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_bcast_seqno,
		  { "Sequence number", "batadv_bcast_seq",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		...
		{ &hf_batadv_bcast_ttl,
		  { "Time to Live", "batadv_bcast_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_icmp_version,
		  { "Version", "batadv_icmp_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_icmp_msg_type,
		  { "Message Type", "batadv_icmp_msg_type",
		    FT_UINT8, BASE_DEC, VALS(icmp_packettypenames), 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_icmp_dst,
		  { "Destination", "batadv_icmp_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_icmp_orig,
		  { "Originator", "batadv_icmp_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_icmp_ttl,
		  { "Time to Live", "batadv_icmp_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_uid,
		...
		{ &hf_batadv_icmp_seqno,
		  { "Sequence number", "batadv_icmp_seq",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_rr_pointer,
		  { "Pointer", "batadv_icmp_rr_pointer",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_rr_ether,
		  { "RR MAC", "batadv_icmp_rr_ether",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_tp_subtype,
		  { "Subtype", "batadv_icmp_tp_subtype",
		    FT_UINT8, BASE_DEC, VALS(icmp_tp_packettypenames), 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_tp_session,
		  { "Session", "batadv_icmp_tp_session",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_tp_seqno,
		  { "Sequence number", "batadv_icmp_tp_seqno",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_icmp_tp_timestamp,
		  { "Timestamp", "batadv_icmp_tp_timestamp",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_unicast_version,
		  { "Version", "batadv_unicast_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_dst,
		  { "Destination", "batadv_unicast_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_ttl,
		  { "Time to Live", "batadv_unicast_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_ttvn,
		  { "TT Version", "batadv_unicast_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_4addr_version,
		  { "Version", "batadv_unicast_4addr_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_4addr_dst,
		  { "Destination", "batadv_unicast_4addr_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_4addr_ttl,
		  { "Time to Live", "batadv_unicast_4addr_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_4addr_ttvn,
		  { "TT Version", "batadv_unicast_4addr_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_4addr_src,
		  { "Source", "batadv_unicast_4addr_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_4addr_subtype,
		  { "Subtype", "batadv_unicast_4addr_subtype",
		    FT_UINT8, BASE_DEC, VALS (unicast_4addr_typenames), 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_version,
		  { "Version", "batadv_unicast_frag_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_dst,
		  { "Destination", "batadv_unicast_frag_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_ttl,
		  { "Time to Live", "batadv_unicast_frag_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_ttvn,
		  { "TT Version", "batadv_unicast_frag_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_flags,
		  { "Flags", "batadv_unicast_frag_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_flags_head,
		  { "Head", "batadv_unicast_frag_flags_head",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x01,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_flags_largetail,
		  { "Largetail", "batadv_unicast_frag_flags_largetail",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x02,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_orig,
		  { "Originator", "batadv_unicast_frag_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_seqno,
		  { "Sequence number", "batadv_unicast_frag_seq",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_no,
		  { "Fragment number", "batadv_unicast_frag_no",
		    FT_UINT8, BASE_DEC, NULL, 0xF0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_priority,
		  { "Priority", "batadv_unicast_frag_priority",
		    FT_UINT8, BASE_DEC, NULL, 0xE,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_frag_total_size,
		  { "Complete Size", "batadv_unicast_frag_total_size",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_tvlv_version,
		  { "Version", "batadv_unicast_tvlv_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_tvlv_ttl,
		  { "Time to Live", "batadv_unicast_tvlv_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_tvlv_dst,
		  { "Destination", "batadv_unicast_tvlv_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_tvlv_src,
		  { "Source", "batadv_unicast_tvlv_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_unicast_tvlv_len,
		  { "Length of TVLV", "batadv_unicast_tvlv_len",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_version,
		  { "Version", "batadv_vis_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_type,
		  { "Type", "batadv_vis_type",
		    FT_UINT8, BASE_DEC, VALS(vis_packettypenames), 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_seqno,
		  { "Sequence number", "batadv_vis_seq",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		...
		{ &hf_batadv_vis_entries,
		  { "Entries", "batadv_vis_entries",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    "Number of entries", HFILL}
		},
		{ &hf_batadv_vis_ttl,
		  { "Time to Live", "batadv_vis_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_vis_vis_orig,
		  { "Originator", "batadv_vis_vis_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_target_orig,
		  { "Target Originator", "batadv_vis_target_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_sender_orig,
		  { "Forwarding Originator", "batadv_vis_sender_orig",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_entry_src,
		  { "Source", "batadv_vis_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_entry_dst,
		  { "Destination", "batadv_vis_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_vis_entry_quality,
		  { "Quality", "batadv_vis_quality",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_version,
		  { "Version", "batadv_tt_query_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_ttl,
		  { "Time to Live", "batadv_tt_query_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_tt_query_flags,
		  { "Flags", "batadv_tt_query_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_flags_type,
		  { "Query Type", "batadv_tt_query_flags_type",
		    FT_UINT8, BASE_HEX, VALS (tt_query_type_v14), TT_TYPE_MASK,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_flags_full_table,
		  { "Full Table", "batadv_tt_query_flags_full_table",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), TT_FULL_TABLE,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_dst,
		  { "Destination", "batadv_tt_query_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_src,
		  { "Source", "batadv_tt_query_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_ttvn,
		  { "TT Version", "batadv_tt_query_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_tt_crc,
		  { "CRC of TT", "batadv_tt_query_tt_crc",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_query_entries,
		  { "Entries", "batadv_tt_query_entries",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    "Number of entries", HFILL }
		},
		{ &hf_batadv_roam_adv_version,
		  { "Version", "batadv_roam_adv_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_roam_adv_ttl,
		  { "Time to Live", "batadv_roam_adv_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_roam_adv_src,
		  { "Source", "batadv_roam_adv_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_roam_adv_dst,
		  { "Destination", "batadv_roam_adv_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_roam_adv_client,
		  { "Client", "batadv_roam_adv_client",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_version,
		  { "Version", "batadv_coded_version",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_ttl,
		  { "Time to Live", "batadv_coded_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_coded_first_ttvn,
		  { "TT Version (First)", "batadv_coded_first_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_coded_first_source,
		  { "Source (First)", "batadv_coded_first_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_first_orig_dest,
		  { "Original Destination (First)", "batadv_coded_first_orig_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_first_crc,
		  { "CRC (First)", "batadv_coded_first_crc",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_second_ttl,
		  { "Time to Live (Second)", "batadv_coded_second_ttl",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_coded_second_ttvn,
		  { "TT Version (Second)", "batadv_coded_second_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL}
		},
		{ &hf_batadv_coded_second_dest,
		  { "Destination (Second)", "batadv_coded_second_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_second_source,
		  { "Source (Second)", "batadv_coded_second_src",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_second_orig_dest,
		  { "Original Destination (Second)", "batadv_coded_second_orig_dst",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_second_crc,
		  { "CRC (Second)", "batadv_coded_second_crc",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_coded_coded_len,
		  { "Length", "batadv_coded_length",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_msg_fragments,
		  {"Message fragments", "batadv_unicast_frag_fragments",
		    FT_NONE, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_entry,
		  { "Entry", "batadv_tt_entry_entry",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_entry_flags,
		  { "Flags", "batadv_tt_entry_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_entry_flags_change_del,
		  { "Delete", "batadv_tt_entry_flags_change_del",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), TT_CHANGE_DEL,
		    NULL, HFILL }
		},
		{ &hf_batadv_tt_entry_flags_client_roam,
		  { "Client Roam", "batadv_tt_entry_flags_client_roam",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), TT_CLIENT_ROAM,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment,
		  {"Message fragment", "batadv_unicast_frag_fragment",
		    FT_FRAMENUM, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment_overlap,
		  {"Message fragment overlap", "batadv_unicast_frag_fragment_overlap",
		    FT_BOOLEAN, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment_overlap_conflicts,
		   {"Message fragment overlapping with conflicting data",
		    "batadv_unicast_frag_fragment_overlap_conflicts",
		    FT_BOOLEAN, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment_multiple_tails,
		  {"Message has multiple tail fragments",
		    "batadv_unicast_frag_fragment_multiple_tails",
		    FT_BOOLEAN, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment_too_long_fragment,
		  {"Message fragment too long", "batadv_unicast_frag_fragment_too_long_fragment",
		    FT_BOOLEAN, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment_error,
		  {"Message defragmentation error", "batadv_unicast_frag_fragment_error",
		    FT_FRAMENUM, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_fragment_count,
		  {"Message fragment count", "batadv_unicast_frag_fragment_count",
		    FT_UINT32, BASE_DEC, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_reassembled_in,
		  {"Reassembled in", "batadv_msg_reassembled_in",
		    FT_FRAMENUM, BASE_NONE, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_msg_reassembled_length,
		  {"Reassembled length", "batadv_msg_reassembled_length",
		    FT_UINT32, BASE_DEC, NULL, 0x00,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_type,
		  { "Type", "batadv_tvlv_length",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_version,
		  { "Version", "batadv_tvlv_version",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_len,
		  { "Length", "batadv_tvlv_len",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_mcast_flags,
		  { "Flags", "batadv_tvlv_mcast_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_mcast_flags_unsnoopables,
		  { "Unsnoopables", "batadv_tvlv_mcast_flags_unsnoopables",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x1,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_mcast_flags_ipv4,
		  { "IPv4", "batadv_tvlv_mcast_flags_ipv4",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x2,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_mcast_flags_ipv6,
		  { "IPv6", "batadv_tvlv_mcast_flags_ipv6",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x4,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_mcast_flags_no_rtr4,
		  { "No IPv4 multicast router", "batadv_tvlv_mcast_flags_no_rtr4",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x8,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_mcast_flags_no_rtr6,
		  { "No IPv6 multicast router", "batadv_tvlv_mcast_flags_no_rtr6",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0x10,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_gw_download,
		  { "Download Speed", "batadv_tvlv_gw_dl_speed",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_gw_upload,
		  { "Upload Speed", "batadv_tvlv_gw_ul_speed",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_roam_addr,
		  { "Address", "batadv_batman_addr",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_roam_vid,
		  { "VID", "batadv_tvlv_roam_vid",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_vid_vlan,
		  { "VLAN ID", "batadv_tvlv_vid_vlan",
		    FT_UINT16, BASE_DEC, NULL, 0x7fff,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_vid_tagged,
		  { "VLAN Tagged", "batadv_tvlv_vid_tagged",
		    FT_UINT16, BASE_DEC, NULL, 0x8000,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_flags,
		  { "Flags", "batadv_tvlv_tt_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_flags_type,
		  { "Query Type", "batadv_tvlv_tt_flags_type",
		    FT_UINT8, BASE_HEX, VALS(tvlv_tt_typenames),
		    BATADV_TVLVL_TT_TYPE_MASK,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_flags_full_table,
		  { "Full Table", "batadv_tvlv_tt_flags_full_table",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset),
		    BATADV_TVLVL_TT_FULL_TABLE,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_ttvn,
		  { "TT Version", "batadv_tvlv_tt_ttvn",
		    FT_UINT8, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_num_vlan,
		  { "VLAN Entries", "batadv_tvlv_tt_num_vlan",
		    FT_UINT16, BASE_DEC, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_vlan_crc,
		  { "CRC", "batadv_tvlv_tt_vlan_crc",
		    FT_UINT32, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_vlan_crc_status,
		  { "Checksum Status", "batadv_tvlv_tt_vlan_crc_status",
		    FT_UINT8,   BASE_NONE, VALS(proto_checksum_vals), 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_vlan_vid,
		  { "VID", "batadv_tvlv_tt_vlan_vid",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_flags,
		  { "Flags", "batadv_tvlv_tt_change_flags",
		    FT_UINT8, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_flags_del,
		  { "Delete", "batadv_tvlv_tt_change_flags_del",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset),
		    BATADV_TVLVL_TT_CHANGE_DEL,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_flags_roam,
		  { "Client Roam", "batadv_tvlv_tt_change_flags_roam",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset),
		    BATADV_TVLVL_TT_CHANGE_ROAM,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_flags_wifi,
		  { "Wifi Client", "batadv_tvlv_tt_change_flags_wifi",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset),
		    BATADV_TVLVL_TT_CHANGE_WIFI,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_flags_isolate,
		  { "Isolate", "batadv_tvlv_tt_change_flags_isolate",
		    FT_BOOLEAN, 8, TFS(&tfs_set_notset),
		    BATADV_TVLVL_TT_CHANGE_ISOLATE,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_addr,
		  { "Address", "batadv_tvlv_tt_change_addr",
		    FT_ETHER, BASE_NONE, NULL, 0x0,
		    NULL, HFILL }
		},
		{ &hf_batadv_tvlv_tt_change_vid,
		  { "VID", "batadv_tvlv_tt_change_vid",
		    FT_UINT16, BASE_HEX, NULL, 0x0,
		    NULL, HFILL }
		},
	};
