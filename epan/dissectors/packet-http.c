...
proto_register_http(void)
{
	static hf_register_info hf[] = {
	    { &hf_http_notification,{ "Notification", "http_notification",FT_BOOLEAN, BASE_NONE, NULL, 0x0,"TRUE if HTTP notification", HFILL }},
	    { &hf_http_response,{ "Response", "http_response",FT_BOOLEAN, BASE_NONE, NULL, 0x0,"TRUE if HTTP response", HFILL }},
	    { &hf_http_request,{ "Request", "http_request",FT_BOOLEAN, BASE_NONE, NULL, 0x0,"TRUE if HTTP request", HFILL }},
	    { &hf_http_response_number,{ "Response number", "http_response_number",FT_UINT32, BASE_DEC, NULL, 0x0,NULL, HFILL }},
	    { &hf_http_request_number,
	      { "Request number", "http_request_number",FT_UINT32, BASE_DEC, NULL, 0x0,NULL, HFILL }},
	    { &hf_http_basic,
	      { "Credentials", "http_authbasic",FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    { &hf_http_citrix,
	      { "Citrix AG Auth", "http_authcitrix",FT_BOOLEAN, BASE_NONE, NULL, 0x0,"TRUE if CitrixAGBasic Auth", HFILL }},
	    { &hf_http_citrix_user,
	      { "Citrix AG Username", "http_authcitrix_user",FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    { &hf_http_citrix_domain,
	      { "Citrix AG Domain", "http_authcitrix_domain",FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    { &hf_http_citrix_passwd,
	      { "Citrix AG Password", "http_authcitrix_password",
		FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    { &hf_http_citrix_session,
	      { "Citrix AG Session ID", "http_authcitrix_session",
		FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    { &hf_http_response_line,
	      { "Response line", "http_response_line",
		FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    { &hf_http_request_line,
	      { "Request line", "http_request_line",
		FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL }},
	    ...
	    { &hf_http_request_full_uri,
	      { "Full request URI", "http_request_full_uri",
		FT_STRING, BASE_NONE, NULL, 0x0,
	    ...
	    { &hf_http_proxy_connect_host,
	      { "Proxy-Connect-Hostname", "http_proxy_connect_host",
		FT_STRING, BASE_NONE, NULL, 0x0,
		"HTTP Proxy Connect Hostname", HFILL }},
	    { &hf_http_proxy_connect_port,
	      { "Proxy-Connect-Port", "http_proxy_connect_port",
		FT_UINT16, BASE_DEC, NULL, 0x0,
	    ...
	    { &hf_http_content_length_header,
	      { "Content-Length", "http_content_length_header",
		FT_STRING, BASE_NONE, NULL, 0x0,
	    ...
	    { &hf_http_sec_websocket_accept,
	      { "Sec-WebSocket-Accept", "http_sec_websocket_accept",
		FT_STRING, BASE_NONE, NULL, 0x0,
		NULL, HFILL }},
		...
		NULL, HFILL }},
	    { &hf_http_file_data,
	      { "File Data", "http_file_data",
		FT_STRING, STR_UNICODE, NULL, 0,
		NULL, HFILL }},
	    { &hf_http_unknown_header,
	      { "Unknown header", "http_unknown_header",
		FT_STRING, BASE_NONE, NULL, 0,
		NULL, HFILL }},
        { &hf_http_keep_alive,
