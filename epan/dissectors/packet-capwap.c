...
proto_register_capwap_control(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_capwap_header_hlen,
            { "Header Length", "capwap_header_length",
        ...
        { &hf_capwap_control_header,
            { "Control Header", "capwap_control_header",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_control_header_msg_type,
            { "Message Type", "capwap_control_header_message_type",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_control_header_msg_type_enterprise_nbr,
            { "Message Type (Enterprise Number)", "capwap_control_header_message_type_enterprise_number",
              FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_control_header_msg_type_enterprise_specific,
            { "Message Type (Enterprise Specific)", "capwap_control_header_message_type_enterprise_specific",
              FT_UINT32, BASE_DEC, VALS(message_type), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_control_header_seq_number,
            { "Sequence Number", "capwap_control_header_sequence_number",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_control_header_msg_element_length,
            { "Message Element Length", "capwap_control_header_message_element_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_control_header_flags,
            { "Flags", "capwap_control_header_flags",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        ...
        { &hf_capwap_msg_element_type_ac_descriptor_stations,
            { "Stations", "capwap_control_message_element_ac_descriptor_stations",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_limit,
            { "Limit Stations", "capwap_control_message_element_ac_descriptor_limit",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_active_wtp,
            { "Active WTPs", "capwap_control_message_element_ac_descriptor_active_wtp",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_max_wtp,
            { "Max WTPs", "capwap_control_message_element_ac_descriptor_max_wtp",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        /* AC Descriptor Security Flags... */
        { &hf_capwap_msg_element_type_ac_descriptor_security,
            { "Security Flags", "capwap_control_message_element_ac_descriptor_security",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_security_s,
            { "AC supports the pre-shared", "capwap_control_message_element_ac_descriptor_security_s",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x04,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_security_x,
            { "AC supports X.509 Certificate", "capwap_control_message_element_ac_descriptor_security_x",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x02,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_security_r,
            { "Reserved", "capwap_control_message_element_ac_descriptor_security_r",
              FT_BOOLEAN, 8, TFS(&tfs_set_notset), 0xF9,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ac_descriptor_rmac_field,
            { "R-MAC Field", "capwap_control_message_element_ac_descriptor_rmac_field",
              FT_UINT8, BASE_DEC, VALS(rmac_field_vals), 0x0,
              NULL, HFILL }
            },
        { &hf_capwap_msg_element_type_ac_descriptor_reserved,
            { "Reserved", "capwap_control_message_element_ac_descriptor_reserved",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        /* AC Descriptor DTLS Policy Flags... */
        { &hf_capwap_msg_element_type_ac_descriptor_dtls_policy,
            { "DTLS Policy Flags", "capwap_control_message_element_ac_descriptor_dtls_policy",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_dtls_policy_d,
            { "DTLS-Enabled Data Channel Supported", "capwap_control_message_element_ac_descriptor_dtls_policy_d",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x04,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_dtls_policy_c,
            { "Clear Text Data Channel Supported", "capwap_control_message_element_ac_descriptor_dtls_policy_c",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x02,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_descriptor_dtls_policy_r,
            { "Reserved", "capwap_control_message_element_ac_descriptor_dtls_policy_r",
              FT_UINT8, BASE_HEX, 0x0, 0xF9,
              "Must be zero", HFILL }
        },

        { &hf_capwap_msg_element_type_ac_information,
            { "AC Information", "capwap_control_message_element_ac_information",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ac_information_vendor,
            { "AC Information Vendor", "capwap_control_message_element_ac_information_vendor",
              FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_information_type,
            { "AC Information Type", "capwap_control_message_element_ac_information_type",
              FT_UINT16, BASE_DEC, VALS(ac_information_type_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_information_length,
            { "AC Information Length", "capwap_control_message_element_ac_information_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ac_information_value,
            { "AC Information Value", "capwap_control_message_element_ac_information_value",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_information_hardware_version,
            { "AC Hardware Version", "capwap_control_message_element_ac_information_hardware_version",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_information_software_version,
            { "AC Software Version", "capwap_control_message_element_ac_information_software_version",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_ipv4_list,
            { "AC IPv4 List", "capwap_control_message_element_message_element_ac_ipv4_list",
              FT_IPv4, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_ipv6_list,
            { "AC IPv6 List", "capwap_control_message_element_message_element_ac_ipv6_list",
              FT_IPv6, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        /* CAPWAP Control IPvX Address*/
        { &hf_capwap_msg_element_type_capwap_control_ipv4,
            { "CAPWAP Control IP Address", "capwap_control_message_element_message_element_capwap_control_ipv4",
              FT_IPv4, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_capwap_control_ipv6,
            { "CAPWAP Control IP Address", "capwap_control_message_element_message_element_capwap_control_ipv6",
              FT_IPv6, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_capwap_control_wtp_count,
            { "CAPWAP Control WTP Count", "capwap_control_message_element_capwap_control_wtp_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_capwap_timers_discovery,
            { "CAPWAP Timers Discovery (Sec)", "capwap_control_message_element_capwap_timers_discovery",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_capwap_timers_echo_request,
            { "CAPWAP Timers Echo Request (Sec)", "capwap_control_message_element_capwap_timers_echo_request",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_decryption_error_report_period_radio_id,
            { "Decryption Error Report Period Radio ID", "capwap_control_message_element_decryption_error_report_period_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_decryption_error_report_period_interval,
            { "Decryption Error Report Report Interval (Sec)", "capwap_control_message_element_decryption_error_report_period_interval",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_delete_station_radio_id,
            { "Radio ID", "capwap_control_message_element_delete_station_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              "Representing the radio, whose value is between one (1) and 31", HFILL }
        },
        { &hf_capwap_msg_element_type_delete_station_length,
            { "Mac Length", "capwap_control_message_element_delete_station_length",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              "The length of the MAC Address field", HFILL }
        },
        { &hf_capwap_msg_element_type_delete_station_mac_eui48,
            { "MAC address", "capwap_control_message_element_delete_station_mac_eui48",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_delete_station_mac_eui64,
            { "MAC address", "capwap_control_message_element_delete_station_mac_eui64",
              FT_EUI64, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_delete_station_mac_data,
            { "MAC address", "capwap_control_message_element_delete_station_mac_data",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_name,
            { "AC Name", "capwap_control_message_element_ac_name",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ac_name_with_priority,
            { "AC Name Priority", "capwap_control_message_element_ac_name_with_priority",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ac_timestamp,
            { "AC Timestamp", "capwap_control_message_element_ac_timestamp",
              FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_add_station_radio_id,
            { "Radio ID", "capwap_control_message_element_add_station_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              "Representing the radio, whose value is between one (1) and 31", HFILL }
        },
        { &hf_capwap_msg_element_type_add_station_length,
            { "Mac Length", "capwap_control_message_element_add_station_length",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              "The length of the MAC Address field", HFILL }
        },
        { &hf_capwap_msg_element_type_add_station_mac_eui48,
            { "MAC address", "capwap_control_message_element_add_station_mac_eui48",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_add_station_mac_eui64,
            { "MAC address", "capwap_control_message_element_add_station_mac_eui64",
              FT_EUI64, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_add_station_mac_data,
            { "MAC address", "capwap_control_message_element_add_station_mac_data",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_add_station_vlan_name,
            { "Vlan Name", "capwap_control_message_element_add_station_vlan_name",
              FT_STRING, BASE_NONE, NULL, 0x0,
              "Containing the VLAN Name on which the WTP is to locally bridge user data", HFILL }
        },

        { &hf_capwap_msg_element_type_discovery_type,
            { "Discovery Type", "capwap_control_message_element_discovery_type",
              FT_UINT8, BASE_DEC, VALS(discovery_type_vals), 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_idle_timeout,
            { "Idle Timeout (Sec)", "capwap_control_message_element_idle_timeout",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_location_data,
            { "Location Data", "capwap_control_message_element_location_data",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_maximum_message_length,
            { "Maximum Message Length", "capwap_control_message_element_maximum_message_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_capwap_local_ipv4_address,
            { "CAPWAP Local IPv4 Address", "capwap_control_message_element_capwap_local_ipv4_address",
              FT_IPv4, BASE_NONE, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_radio_admin_id,
            { "Radio Administrative ID", "capwap_control_message_element_radio_admin_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_radio_admin_state,
            { "Radio Administrative State", "capwap_control_message_element_radio_admin_state",
              FT_UINT8, BASE_DEC, VALS(radio_admin_state_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_radio_op_state_radio_id,
            { "Radio Operational ID", "capwap_control_message_element_radio_op_state_radio_id",
               FT_UINT8, BASE_DEC, NULL, 0x0,
               NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_radio_op_state_radio_state,
            { "Radio Operational State", "capwap_control_message_element_radio_op_state_radio_state",
              FT_UINT8, BASE_DEC, VALS(radio_op_state_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_radio_op_state_radio_cause,
            { "Radio Operational Cause", "capwap_control_message_element_radio_op_state_radio_cause",
               FT_UINT8, BASE_DEC, VALS(radio_op_cause_vals), 0x0,
               NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_result_code,
            { "Result Code", "capwap_control_message_element_result_code",
              FT_UINT32, BASE_DEC, VALS(result_code_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_session_id,
            { "Session ID", "capwap_control_message_element_session_id",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_statistics_timer,
            { "Statistics Timer (Sec)", "capwap_control_message_element_statistics_timer",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_vsp_vendor_identifier,
            { "Vendor Identifier", "capwap_control_message_element_vsp_vendor_identifier",
              FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_vsp_vendor_element_id,
            { "Vendor Element ID", "capwap_control_message_element_vsp_vendor_element_id",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_vsp_vendor_data,
            { "Vendor Data", "capwap_control_message_element_vsp_vendor_data",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_wtp_board_data,
            { "WTP Board Data", "capwap_control_message_element_wtp_board_data",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_vendor,
            { "WTP Board Data Vendor", "capwap_control_message_element_wtp_board_data_vendor",
               FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
               NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_type,
            { "Board Data Type", "capwap_control_message_element_wtp_board_data_type",
              FT_UINT16, BASE_DEC, VALS(board_data_type_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_length,
            { "Board Data Length", "capwap_control_message_element_wtp_board_data_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_value,
            { "Board Data Value", "capwap_control_message_element_wtp_board_data_value",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_wtp_board_data_wtp_model_number,
            { "WTP Model Number", "capwap_control_message_element_wtp_board_data_wtp_model_number",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_wtp_serial_number,
            { "WTP Serial Number", "capwap_control_message_element_wtp_board_data_wtp_serial_number",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_wtp_board_id,
            { "WTP Board ID", "capwap_control_message_element_wtp_board_data_wtp_board_id",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_wtp_board_revision,
            { "WTP Board Revision", "capwap_control_message_element_wtp_board_data_wtp_board_revision",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_board_data_base_mac_address,
            { "Base Mac Address", "capwap_control_message_element_wtp_board_data_base_mac_address",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_wtp_descriptor_max_radios,
            { "Max Radios", "capwap_control_message_element_wtp_descriptor_max_radios",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_radio_in_use,
            { "Radio in use", "capwap_control_message_element_wtp_descriptor_radio_in_use",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_number_encrypt,
            { "Encryption Capabilities (Number)", "capwap_control_message_element_wtp_descriptor_number_encrypt",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_encrypt,
            { "Encryption Capabilities", "capwap_control_message_element_wtp_descriptor_encrypt",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_encrypt_reserved,
            { "Reserved (Encrypt)", "capwap_control_message_element_wtp_descriptor_encrypt_reserved",
              FT_UINT8, BASE_DEC, NULL, 0xE0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_encrypt_wbid,
            { "Encrypt WBID", "capwap_control_message_element_wtp_descriptor_encrypt_wbid",
              FT_UINT8, BASE_DEC, VALS(type_wbid), 0x1F,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_encrypt_capabilities,
            { "Encryption Capabilities", "capwap_control_message_element_wtp_descriptor_encrypt_capabilities",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_wtp_descriptor,
            { "WTP Descriptor", "capwap_control_message_element_wtp_descriptor",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_vendor,
            { "WTP Descriptor Vendor", "capwap_control_message_element_wtp_descriptor_vendor",
              FT_UINT32, BASE_ENTERPRISES, STRINGS_ENTERPRISES, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_type,
            { "Descriptor Type", "capwap_control_message_element_wtp_descriptor_type",
              FT_UINT16, BASE_DEC, VALS(wtp_descriptor_type_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_length,
            { "Descriptor Length", "capwap_control_message_element_wtp_descriptor_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_value,
            { "Descriptor Value", "capwap_control_message_element_wtp_descriptor_value",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_hardware_version,
            { "WTP Hardware Version", "capwap_control_message_element_wtp_descriptor_hardware_version",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_active_software_version,
            { "WTP Active Software Version", "capwap_control_message_element_wtp_descriptor_active_software_version",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_boot_version,
            { "WTP Boot Version", "capwap_control_message_element_wtp_descriptor_boot_version",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_descriptor_other_software_version,
            { "WTP Other Software Version", "capwap_control_message_element_wtp_descriptor_other_software_version",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_fallback,
            { "WTP Fallback", "capwap_control_message_element_wtp_fallback",
              FT_UINT8, BASE_DEC, VALS(wtp_fallback_vals), 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_wtp_frame_tunnel_mode,
            { "WTP Frame Tunnel Mode", "capwap_control_message_element_wtp_frame_tunnel_mode",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_frame_tunnel_mode_n,
            { "Native Frame Tunnel Mode", "capwap_control_message_element_wtp_frame_tunnel_mode_n",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x08,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_frame_tunnel_mode_e,
            { "802.3 Frame Tunnel Mode", "capwap_control_message_element_wtp_frame_tunnel_mode_e",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x04,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_frame_tunnel_mode_l,
            { "Local Bridging", "capwap_control_message_element_wtp_frame_tunnel_mode_l",
              FT_BOOLEAN, 8, TFS(&tfs_true_false), 0x02,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_frame_tunnel_mode_r,
            { "Reserved", "capwap_control_message_element_wtp_frame_tunnel_mode_r",
              FT_UINT8, BASE_HEX, 0x0, 0xF1,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_wtp_mac_type,
            { "WTP MAC Type", "capwap_control_message_element_wtp_mac_type",
        ...
        { &hf_capwap_msg_element_type_wtp_name,
            { "WTP Name", "capwap_control_message_element_wtp_name",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_reboot_count,
            { "Reboot  Count", "capwap_control_message_element_wtp_reboot_statistics_reboot_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_ac_initiated_count,
            { "AC Initiated Count", "capwap_control_message_element_wtp_reboot_statistics_ac_initiated_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_link_failure_count,
            { "Link Failure Count", "capwap_control_message_element_wtp_reboot_statistics_link_failure_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_sw_failure_count,
            { "SW Failure Count", "capwap_control_message_element_wtp_reboot_statistics_sw_failure_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_hw_failure_count,
            { "HW Failure Count", "capwap_control_message_element_wtp_reboot_statistics_hw_failure_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_other_failure_count,
            { "Other Failure Count", "capwap_control_message_element_wtp_reboot_statistics_other_failure_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_unknown_failure_count,
            { "Unknown Failure Count", "capwap_control_message_element_wtp_reboot_statistics_unknown_failure_count",
              FT_UINT16, BASE_DEC, NULL, 0x0,
        ...
        { &hf_capwap_msg_element_type_wtp_reboot_statistics_last_failure_type,
            { "Last Failure Type", "capwap_control_message_element_wtp_reboot_statistics_last_failure_type",
        ...
        { &hf_capwap_msg_element_type_capwap_local_ipv6_address,
            { "CAPWAP Local IPv6 Address", "capwap_control_message_element_capwap_local_ipv6_address",
              FT_IPv6, BASE_NONE, NULL, 0x0,
              "The IP address of the sender", HFILL }
        },

        { &hf_capwap_msg_element_type_capwap_transport_protocol,
            { "CAPWAP Transport Protocol", "capwap_control_message_element_capwap_transport_protocol",
        ...
        { &hf_capwap_msg_element_type_mtu_discovery_padding,
            { "MTU Discovery Padding", "capwap_control_message_element_mtu_discovery_padding",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              "A variable-length pad, filled with the value 0xFF", HFILL }
        },

        { &hf_capwap_msg_element_type_ecn_support,
            { "ECN Support", "capwap_control_message_element_ecn_support",
        ...
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_add_wlan_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_add_wlan_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability,
            { "Capability", "capwap_control_message_element_ieee80211_add_wlan_capability",
              FT_UINT16, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_e,
            { "ESS", "capwap_control_message_element_ieee80211_add_wlan_capability_e",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x8000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_i,
            { "IBSS", "capwap_control_message_element_ieee80211_add_wlan_capability_i",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x4000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_c,
            { "CF-Pollable", "capwap_control_message_element_ieee80211_add_wlan_capability_c",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x2000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_f,
            { "CF-Poll Request", "capwap_control_message_element_ieee80211_add_wlan_capability_f",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x1000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_p,
            { "Privacy", "capwap_control_message_element_ieee80211_add_wlan_capability_p",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0800,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_s,
            { "Short Preamble", "capwap_control_message_element_ieee80211_add_wlan_capability_s",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0400,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_b,
            { "PBCC", "capwap_control_message_element_ieee80211_add_wlan_capability_b",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0200,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_a,
            { "Channel Agility", "capwap_control_message_element_ieee80211_add_wlan_capability_a",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0100,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_m,
            { "Spectrum Management", "capwap_control_message_element_ieee80211_add_wlan_capability_m",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0080,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_q,
            { "QoS", "capwap_control_message_element_ieee80211_add_wlan_capability_q",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0040,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_t,
            { "Short Slot Time", "capwap_control_message_element_ieee80211_add_wlan_capability_t",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0020,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_d,
            { "APSD", "capwap_control_message_element_ieee80211_add_wlan_capability_d",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0010,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_v,
            { "Reserved", "capwap_control_message_element_ieee80211_add_wlan_capability_v",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0008,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_o,
            { "DSSS-OFDM", "capwap_control_message_element_ieee80211_add_wlan_capability_o",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0004,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_k,
            { "Delayed Block ACK", "capwap_control_message_element_ieee80211_add_wlan_capability_k",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0002,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_capability_l,
            { "Immediate Block ACK", "capwap_control_message_element_ieee80211_add_wlan_capability_l",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0001,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_key_index,
            { "Key-Index", "capwap_control_message_element_ieee80211_add_wlan_key_index",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_key_status,
            { "Key Status", "capwap_control_message_element_ieee80211_add_wlan_key_status",
              FT_UINT8, BASE_DEC, VALS(ieee80211_wlan_key_status_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_key_length,
            { "Key Length", "capwap_control_message_element_ieee80211_add_wlan_key_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_key,
            { "Key", "capwap_control_message_element_ieee80211_add_wlan_key",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_group_tsc,
            { "Group TSC", "capwap_control_message_element_ieee80211_add_wlan_group_tsc",
              FT_UINT64, BASE_DEC, NULL, 0x00FFFFFF,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_qos,
            { "QoS", "capwap_control_message_element_ieee80211_add_wlan_qos",
              FT_UINT8, BASE_DEC, VALS(ieee80211_add_wlan_qos_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_auth_type,
            { "Auth Type", "capwap_control_message_element_ieee80211_add_wlan_auth_type",
              FT_UINT8, BASE_DEC, VALS(ieee80211_add_wlan_auth_type_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_mac_mode,
            { "MAC Mode", "capwap_control_message_element_ieee80211_add_wlan_mac_mode",
              FT_UINT8, BASE_DEC, VALS(ieee80211_add_wlan_mac_mode_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_tunnel_mode,
            { "Tunnel Mode", "capwap_control_message_element_ieee80211_add_wlan_tunnel_mode",
        ...
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_suppress_ssid,
            { "Suppress SSID", "capwap_control_message_element_ieee80211_add_wlan_suppress_ssid",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_add_wlan_ssid,
            { "SSID", "capwap_control_message_element_ieee80211_add_wlan_ssid",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_antenna_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_antenna_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_antenna_diversity,
            { "Diversity", "capwap_control_message_element_ieee80211_antenna_diversity",
              FT_UINT8, BASE_DEC, VALS(ieee80211_antenna_diversity_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_antenna_combiner,
            { "Combiner", "capwap_control_message_element_ieee80211_antenna_combiner",
              FT_UINT8, BASE_DEC, VALS(ieee80211_antenna_combiner_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_antenna_count,
            { "Antenna Count", "capwap_control_message_element_ieee80211_antenna_count",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_antenna_selection,
            { "Selection", "capwap_control_message_element_ieee80211_antenna_selection",
        ...
        { &hf_capwap_msg_element_type_ieee80211_assigned_wtp_bssid_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_assigned_wtp_bssid_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_assigned_wtp_bssid_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_assigned_wtp_bssid_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_assigned_wtp_bssid_bssid,
            { "BSSID", "capwap_control_message_element_ieee80211_assigned_wtp_bssid_bssid",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_delete_wlan_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_delete_wlan_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_delete_wlan_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_delete_wlan_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_direct_sequence_control_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_direct_sequence_control_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_direct_sequence_control_reserved,
            { "Reserved", "capwap_control_message_element_ieee80211_direct_sequence_control_reserved",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_direct_sequence_control_current_channel,
            { "Current Channel", "capwap_control_message_element_ieee80211_direct_sequence_control_current_channel",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_direct_sequence_control_current_cca,
            { "Current CCA", "capwap_control_message_element_ieee80211_direct_sequence_control_current_cca",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_direct_sequence_control_energy_detect_threshold,
            { "Energy Detect Threshold", "capwap_control_message_element_ieee80211_direct_sequence_control_energy_detect_threshold",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ie_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_ie_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ie_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_ie_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ie_flags,
            { "Flags", "capwap_control_message_element_ieee80211_ie_flags",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ie_flags_b,
            { "Include IE in Beacons", "capwap_control_message_element_ieee80211_ie_flags_b",
              FT_BOOLEAN, 8, NULL, 0x80,
              "When set, the WTP is to include the Information Element in IEEE 802_11 Beacons associated with the WLAN", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ie_flags_p,
            { "Include IE in  Probe Responses", "capwap_control_message_element_ieee80211_ie_flags_p",
              FT_BOOLEAN, 8, NULL, 0x40,
              "When set, the WTP is to include the Information Element in Probe Responses associated with the WLAN", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ie_flags_rsv,
            { "Reserved", "capwap_control_message_element_ieee80211_ie_flags_rsv",
              FT_UINT8, BASE_HEX, NULL, 0x3F,
              "Must be Zero", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_mac_operation_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_reserved,
            { "Reserved", "capwap_control_message_element_ieee80211_mac_operation_reserved",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_rts_threshold,
            { "RTS Threshold", "capwap_control_message_element_ieee80211_mac_operation_rts_threshold",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_short_retry,
            { "Short Retry", "capwap_control_message_element_ieee80211_mac_operation_short_retry",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_long_retry,
            { "Long Retry", "capwap_control_message_element_ieee80211_mac_operation_long_retry",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_fragmentation_threshold,
            { "Fragmentation Threshold", "capwap_control_message_element_ieee80211_mac_operation_fragmentation_threshold",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_tx_msdu_lifetime,
            { "Tx MDSU Lifetime", "capwap_control_message_element_ieee80211_mac_operation_tx_msdu_lifetime",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_operation_rx_msdu_lifetime,
            { "Rx MDSU Lifetime", "capwap_control_message_element_ieee80211_mac_operation_rx_msdu_lifetime",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mic_countermeasures_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_mic_countermeasures_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mic_countermeasures_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_mic_countermeasures_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mic_countermeasures_mac_address,
            { "MAC Address", "capwap_control_message_element_ieee80211_mic_countermeasures_mac_address",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_multi_domain_capability_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_multi_domain_capability_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_multi_domain_capability_reserved,
            { "Reserved", "capwap_control_message_element_ieee80211_multi_domain_capability_reserved",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_multi_domain_capability_first_channel,
            { "First Channel", "capwap_control_message_element_ieee80211_multi_domain_capability_first_channel",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_multi_domain_capability_number_of_channels,
            { "Number of  Channels", "capwap_control_message_element_ieee80211_multi_domain_capability_number_of_channels",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_multi_domain_capability_max_tx_power_level,
            { "Max TX Power Level", "capwap_control_message_element_ieee80211_multi_domain_capability_max_tx_power_level",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_ofdm_control_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_reserved,
            { "Reserved", "capwap_control_message_element_ieee80211_ofdm_control_reserved",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_current_channel,
            { "Current Channel", "capwap_control_message_element_ieee80211_ofdm_control_current_channel",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support,
            { "Band Support", "capwap_control_message_element_ieee80211_ofdm_control_band_support",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit0,
            { "Operating in the 5.15-5.25 GHz band", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit0",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x01,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit1,
            { "Operating in the 5.25-5.35 GHz band", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit1",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x02,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit2,
            { "Operating in the 5.725-5.825 GHz band", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit2",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x04,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit3,
            { "Operating in the 5.47-5.725 GHz band", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit3",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x08,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit4,
            { "Operating in the lower Japanese 5.25 GHz band", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit4",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x10,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit5,
            { "Operating in the l5.03-5.091 GHz band", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit5",
        ...
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_band_support_bit7,
            { "Reserved", "capwap_control_message_element_ieee80211_ofdm_control_band_support_bit7",
              FT_UINT8, BASE_HEX, NULL, 0x80,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_ofdm_control_ti_threshold,
            { "TI Threshold", "capwap_control_message_element_ieee80211_mofdm_control_ti_threshold",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ieee80211_rate_set_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_rate_set_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_rate_set_rate_set,
            { "Rate Set", "capwap_control_message_element_ieee80211_rate_set_rate_set",
        ...
        { &hf_capwap_msg_element_type_ieee80211_station_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_station_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_association_id,
            { "Association ID", "capwap_control_message_element_ieee80211_station_association_id",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_flags,
            { "Flags", "capwap_control_message_element_ieee80211_station_flags",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_mac_address,
            { "MAC Address", "capwap_control_message_element_ieee80211_station_mac_address",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities,
            { "Capabilities", "capwap_control_message_element_ieee80211_station_capabilities",
              FT_UINT16, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_e,
            { "ESS", "capwap_control_message_element_ieee80211_station_capabilities_e",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x8000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_i,
            { "IBSS", "capwap_control_message_element_ieee80211_station_capabilities_i",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x4000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_c,
            { "CF-Pollable", "capwap_control_message_element_ieee80211_station_capabilities_c",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x2000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_f,
            { "CF-Poll Request", "capwap_control_message_element_ieee80211_station_capabilities_f",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x1000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_p,
            { "Privacy", "capwap_control_message_element_ieee80211_station_capabilities_p",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0800,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_s,
            { "Short Preamble", "capwap_control_message_element_ieee80211_station_capabilities_s",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0400,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_b,
            { "PBCC", "capwap_control_message_element_ieee80211_station_capabilities_b",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0200,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_a,
            { "Channel Agility", "capwap_control_message_element_ieee80211_station_capabilities_a",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0100,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_m,
            { "Spectrum Management", "capwap_control_message_element_ieee80211_station_capabilities_m",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0080,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_q,
            { "QoS", "capwap_control_message_element_ieee80211_station_capabilities_q",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0040,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_t,
            { "Short Slot Time", "capwap_control_message_element_ieee80211_station_capabilities_t",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0020,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_d,
            { "APSD", "capwap_control_message_element_ieee80211_station_capabilities_d",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0010,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_v,
            { "Reserved", "capwap_control_message_element_ieee80211_station_capabilities_v",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0008,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_o,
            { "DSSS-OFDM", "capwap_control_message_element_ieee80211_station_capabilities_o",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0004,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_k,
            { "Delayed Block ACK", "capwap_control_message_element_ieee80211_station_capabilities_k",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0002,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_capabilities_l,
            { "Immediate Block ACK", "capwap_control_message_element_ieee80211_station_capabilities_l",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0001,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_station_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_supported_rates,
            { "Supported Rates", "capwap_control_message_element_ieee80211_station_supported_rates",
              FT_UINT8, BASE_HEX|BASE_EXT_STRING, &ieee80211_supported_rates_vals_ext, 0x0,
              "In Mbit/sec, (B) for Basic Rates", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_mac,
            { "Mac Address", "capwap_control_message_element_ieee80211_station_session_key_mac",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              "The station's MAC Address", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_flags,
            { "Flags", "capwap_control_message_element_ieee80211_station_session_key_flags",
              FT_UINT16, BASE_DEC, NULL, 0x3FFF,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_flags_a,
            { "Flag A", "capwap_control_message_element_ieee80211_station_session_key_flags_a",
              FT_BOOLEAN, 1, NULL, 0x2000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_flags_c,
            { "Flag C", "capwap_control_message_element_ieee80211_station_session_key_flags_c",
              FT_BOOLEAN, 1, NULL, 0x1000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_pairwire_tsc,
            { "Pairwise TSC", "capwap_control_message_element_ieee80211_station_session_key_pairwire_tsc",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              "Transmit Sequence Counter (TSC)", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_pairwire_rsc,
            { "Pairwise RSC", "capwap_control_message_element_ieee80211_station_session_key_pairwire_rsc",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              "Receive Sequence Counter (TSC)", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_station_session_key_key,
            { "Key", "capwap_control_message_element_ieee80211_station_session_key_key",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_supported_rates_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_supported_rates_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_supported_rates_rate,
            { "Rates", "capwap_control_message_element_ieee80211_supported_rates_rate",
              FT_UINT8, BASE_HEX|BASE_EXT_STRING, &ieee80211_supported_rates_vals_ext, 0x0,
              "In Mbit/sec, (B) for Basic Rates", HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_tx_power_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_tx_power_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_tx_power_reserved,
            { "Reserved", "capwap_control_message_element_ieee80211_tx_power_reserved",
              FT_UINT8, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_tx_power_current_tx_power,
            { "Current Tx Power", "capwap_control_message_element_ieee80211_tx_power_current_tx_power",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_tx_power_level_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_tx_power_level_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_tx_power_level_num_levels,
            { "Num Levels", "capwap_control_message_element_ieee80211_tx_power_level_num_levels",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_tx_power_level_power_level,
            { "Power Level", "capwap_control_message_element_ieee80211_tx_power_level_power_level",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_update_wlan_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_wlan_id,
            { "WLAN ID", "capwap_control_message_element_ieee80211_update_wlan_wlan_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability,
            { "Capability", "capwap_control_message_element_ieee80211_update_wlan_capability",
              FT_UINT16, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_e,
            { "ESS", "capwap_control_message_element_ieee80211_update_wlan_capability_e",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x8000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_i,
            { "IBSS", "capwap_control_message_element_ieee80211_update_wlan_capability_i",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x4000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_c,
            { "CF-Pollable", "capwap_control_message_element_ieee80211_update_wlan_capability_c",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x2000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_f,
            { "CF-Poll Request", "capwap_control_message_element_ieee80211_update_wlan_capability_f",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x1000,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_p,
            { "Privacy", "capwap_control_message_element_ieee80211_update_wlan_capability_p",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0800,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_s,
            { "Short Preamble", "capwap_control_message_element_ieee80211_update_wlan_capability_s",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0400,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_b,
            { "PBCC", "capwap_control_message_element_ieee80211_update_wlan_capability_b",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0200,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_a,
            { "Channel Agility", "capwap_control_message_element_ieee80211_update_wlan_capability_a",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0100,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_m,
            { "Spectrum Management", "capwap_control_message_element_ieee80211_update_wlan_capability_m",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0080,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_q,
            { "QoS", "capwap_control_message_element_ieee80211_update_wlan_capability_q",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0040,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_t,
            { "Short Slot Time", "capwap_control_message_element_ieee80211_update_wlan_capability_t",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0020,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_d,
            { "APSD", "capwap_control_message_element_ieee80211_update_wlan_capability_d",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0010,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_v,
            { "Reserved", "capwap_control_message_element_ieee80211_update_wlan_capability_v",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0008,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_o,
            { "DSSS-OFDM", "capwap_control_message_element_ieee80211_update_wlan_capability_o",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0004,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_k,
            { "Delayed Block ACK", "capwap_control_message_element_ieee80211_update_wlan_capability_k",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0002,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_capability_l,
            { "Immediate Block ACK", "capwap_control_message_element_ieee80211_update_wlan_capability_l",
              FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0001,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_key_index,
            { "Key-Index", "capwap_control_message_element_ieee80211_update_wlan_key_index",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_key_status,
            { "Key Status", "capwap_control_message_element_ieee80211_update_wlan_key_status",
              FT_UINT8, BASE_DEC, VALS(ieee80211_wlan_key_status_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_key_length,
            { "Key Length", "capwap_control_message_element_ieee80211_update_wlan_key_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_update_wlan_key,
            { "Key", "capwap_control_message_element_ieee80211_update_wlan_key",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_wtp_radio_info_cfg_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_short_preamble,
            { "Short Preamble", "capwap_control_message_element_ieee80211_wtp_radio_info_short_preamble",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_num_of_bssids,
            { "Num of BSSIDs", "capwap_control_message_element_ieee80211_wtp_radio_info_num_of_bssids",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_dtim_period,
            { "DTIM Period", "capwap_control_message_element_ieee80211_wtp_radio_info_dtim_period",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_bssid,
            { "BSSID", "capwap_control_message_element_ieee80211_wtp_radio_info_bssid",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_beacon_period,
            { "Beacon Period", "capwap_control_message_element_ieee80211_wtp_radio_info_beacon_period",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_cfg_country_string,
            { "Country String", "capwap_control_message_element_ieee80211_wtp_radio_info_country_string",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_info_radio_id,
            { "Radio ID", "capwap_control_message_element_ieee80211_wtp_radio_info_radio_id",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_info_radio_type_reserved,
            { "Radio Type Reserved", "capwap_control_message_element_ieee80211_wtp_info_radio_radio_type_reserved",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_info_radio_type_n,
            { "Radio Type 802.11n", "capwap_control_message_element_ieee80211_wtp_info_radio_radio_type_n",
              FT_BOOLEAN, 4, TFS(&tfs_true_false), 0x0008,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_info_radio_type_g,
            { "Radio Type 802.11g", "capwap_control_message_element_ieee80211_wtp_info_radio_radio_type_g",
              FT_BOOLEAN, 4, TFS(&tfs_true_false), 0x0004,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_info_radio_type_a,
            { "Radio Type 802.11a", "capwap_control_message_element_ieee80211_wtp_info_radio_radio_type_a",
              FT_BOOLEAN, 4, TFS(&tfs_true_false), 0x0002,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_wtp_radio_info_radio_type_b,
            { "Radio Type 802.11b", "capwap_control_message_element_ieee80211_wtp_info_radio_radio_type_b",
              FT_BOOLEAN, 4, TFS(&tfs_true_false), 0x0001,
              NULL, HFILL }
        },

        { &hf_capwap_msg_element_type_ieee80211_supported_mac_profiles_numbers,
            { "Numbers Profiles", "capwap_control_message_element_ieee80211_supported_mac_profiles_numbers",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_supported_mac_profiles_profile,
            { "Profile", "capwap_control_message_element_ieee80211_supported_mac_profiles_profile",
              FT_UINT8, BASE_DEC, VALS(ieee80211_mac_profile_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_msg_element_type_ieee80211_mac_profile,
            { "Profile", "capwap_control_message_element_ieee80211_mac_profile",
              FT_UINT8, BASE_DEC, VALS(ieee80211_mac_profile_vals), 0x0,
              NULL, HFILL }
        },
        ...
        { & hf_capwap_data_keep_alive,
            { "Keep-Alive", "capwap_keep_alive",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { & hf_capwap_data_keep_alive_length,
            { "Message Element Length", "capwap_keep_alive_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        ...
        { &hf_capwap_fortinet_element_id,
            { "Fortinet Element ID", "capwap_control_fortinet_element_id",
              FT_UINT16, BASE_DEC, VALS(fortinet_element_id_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_value,
            { "Fortinet Value", "capwap_control_fortinet_value",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_scan_rid,
            { "Radio ID", "capwap_control_fortinet_ap_scan_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_scan_bgscan_intv,
            { "bg scan interval", "capwap_control_fortinet_ap_scan_bgpscan_interval",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_scan_bgscan_idle,
            { "bg scan idle", "capwap_control_fortinet_ap_scan_bgpscan_idle",
              FT_UINT24, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_scan_bgscan_rpt_intv,
            { "bg scan rpt interval", "capwap_control_fortinet_ap_scan_bgscan_rpt_interval",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_scan_fgscan_rpt_intv,
            { "fg scan rpt interval", "capwap_control_fortinet_ap_scan_fgscan_rpt_interval",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_passive_rid,
            { "Radio ID", "capwap_control_fortinet_passive_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_passive,
            { "Passive", "capwap_control_fortinet_passive",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_daemon_rst,
            { "Daemon RST", "capwap_control_fortinet_daemon_rst",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mac_rid,
            { "Radio ID", "capwap_control_fortinet_mac_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mac_wid,
            { "WLAN ID", "capwap_control_fortinet_mac_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mac_len,
            { "Length", "capwap_control_fortinet_mac_len",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mac,
            { "MAC", "capwap_control_fortinet_mac",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wtp_allow_sn,
            { "Serial Number", "capwap_control_fortinet_wtp_allow_sn",
              FT_STRING, BASE_NONE, NULL, 0x0,
              "WTP Serial Number", HFILL }
        },
        { &hf_capwap_fortinet_wtp_allow_allow,
            { "Allowed", "capwap_control_fortinet_wtp_allow_allowed",
              FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wbh_sta_rid,
            { "Radio ID", "capwap_control_fortinet_wbh_sta_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wbh_sta_len,
            { "Length", "capwap_control_fortinet_wbh_sta_length",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wbh_sta_mac,
            { "STA MAC", "capwap_control_fortinet_wbh_sta_mac",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wbh_sta_bssid,
            { "BSSID", "capwap_control_fortinet_wbh_sta_bssid",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wbh_sta_mhc,
            { "MHC", "capwap_control_fortinet_wbh_sta_mhc",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_htcap_rid,
            { "Radio ID", "capwap_control_fortinet_htcap_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_htcap_mcs,
            { "MCS", "capwap_control_fortinet_htcap_mcs",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_htcap_gi,
            { "HT Short GI", "capwap_control_fortinet_htcap_mcs_gi",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_htcap_bw,
            { "Bandwidth", "capwap_control_fortinet_htcap_mcs_bw",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              "20 or 40Mhz Mode", HFILL }
        },
        { &hf_capwap_fortinet_mvap_sn_length,
            { "SN Length", "capwap_control_fortinet_mvap_sn_length",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mvap_sn,
            { "SN", "capwap_control_fortinet_mvap_sn",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mvap_unknown,
            { "Unknown", "capwap_control_fortinet_mvap_unknown",
              FT_UINT32, BASE_DEC_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mvap_age,
            { "Age", "capwap_control_fortinet_mvap_age",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mvap_period,
            { "Period", "capwap_control_fortinet_mvap_period",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mvap_vfid,
            { "Vfid", "capwap_control_fortinet_mvap_vfid",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mode_rid,
            { "Radio ID", "capwap_control_fortinet_mode_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mode,
            { "Mode", "capwap_control_fortinet_mode",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_coext_rid,
            { "Radio ID", "capwap_control_fortinet_coext_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_coext,
            { "Coext", "capwap_control_fortinet_coext",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_amsdu_rid,
            { "Radio ID", "capwap_control_fortinet_amsdu_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_amsdu,
            { "AMSDU", "capwap_control_fortinet_amsdu",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ps_opt_rid,
            { "Radio ID", "capwap_control_fortinet_ps_opt_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ps_opt,
            { "PS OPT", "capwap_control_fortinet_ps_opt",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_pure_rid,
            { "Radio ID", "capwap_control_fortinet_pure_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_pure,
            { "Pure", "capwap_control_fortinet_pure",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ebptag_ebp,
            { "EBP", "capwap_control_fortinet_ebptag_ebp",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ebptag_tag,
            { "Tag", "capwap_control_fortinet_ebptag_tag",
              FT_ETHER, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_telnet_enable,
            { "Telnet Enable", "capwap_control_fortinet_telnet_enable",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_admin_passwd,
            { "Admin Password", "capwap_control_fortinet_admin_password",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_regcode,
            { "Reg Code", "capwap_control_fortinet_reg_code",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_countrycode_rid,
            { "Radio ID", "capwap_control_fortinet_countrycode_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_countrycode_code,
            { "Country Code", "capwap_control_fortinet_countrycode_code",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_countrycode_string,
            { "Country Code", "capwap_control_fortinet_countrycode_string",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sta_scan_rid,
            { "Radio ID", "capwap_control_fortinet_sta_scan_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sta_scan,
            { "STA Scan", "capwap_control_fortinet_sta_scan",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_fho_rid,
            { "Radio ID", "capwap_control_fortinet_fho_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_fho,
            { "FHO", "capwap_control_fortinet_fho",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        ...
        { &hf_capwap_fortinet_apho,
            { "APHO", "capwap_control_fortinet_apho",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sta_locate_rid,
            { "Radio ID", "capwap_control_fortinet_sta_locate_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sta_locate_enable,
            { "Locate Enable", "capwap_control_fortinet_sta_locate_enable",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sta_locate_interval,
            { "Locate Interval", "capwap_control_fortinet_sta_locate_interval",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sa_rid,
            { "Radio ID", "capwap_control_fortinet_spectrum_analysis_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sa_enable,
            { "Spectrum Analysis Enable", "capwap_control_fortinet_spectrum_analysis_enable",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_sa_ssid,
            { "SSID", "capwap_control_fortinet_spectrum_analysis_ssid",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_darrp_cfg_rid,
            { "Radio ID", "capwap_control_fortinet_darrp_cfg_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_darrp_cfg_enable,
            { "DARRP CFG Enable", "capwap_control_fortinet_darrp_cfg_enable",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_darrp_cfg_interval,
            { "DARRP CFG Interval", "capwap_control_fortinet_darrp_cfg_interval",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_suppress_list_ver,
            { "Ver", "capwap_control_fortinet_ap_suppress_list_ver",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_suppress_list_op,
            { "Op", "capwap_control_fortinet_ap_suppress_list_op",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              "Operation ?", HFILL }
        },
        { &hf_capwap_fortinet_ap_suppress_list_rid,
            { "Radio ID", "capwap_control_fortinet_ap_suppress_list_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_ap_suppress_list_len,
            { "Length", "capwap_control_fortinet_ap_suppress_list_length",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wds_rid,
            { "Radio ID", "capwap_control_fortinet_wds_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wds_wid,
            { "WLAN ID", "capwap_control_fortinet_wds_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wds_enable,
            { "WDS Enable", "capwap_control_fortinet_wds_enable",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_vlan_tag_rid,
            { "Radio ID", "capwap_control_fortinet_vap_vlan_tag_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_vlan_tag_wid,
            { "WLAN ID", "capwap_control_fortinet_vap_vlan_tag_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_vlan_tag,
            { "Vlan ID", "capwap_control_fortinet_vap_vlan_tag",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_bitmap_rid,
            { "Radio ID", "capwap_control_fortinet_bitmap_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_bitmap,
            { "Bitmap", "capwap_control_fortinet_vap_bitmap",
              FT_UINT16, BASE_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mcast_rate_rid,
            { "Radio ID", "capwap_control_fortinet_mcast_rate_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mcast_rate_wid,
            { "WLAN ID", "capwap_control_fortinet_mcast_rate_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mcast_rate,
            { "Multicast Rate", "capwap_control_fortinet_mcast_rate",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_cfg_rid,
            { "Radio ID", "capwap_control_fortinet_cfg_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_cfg_wid,
            { "WLAN ID", "capwap_control_fortinet_cfg_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_cfg_ip,
            { "IP", "capwap_control_fortinet_cfg_ip",
              FT_IPv4, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_cfg_mask,
            { "Mask", "capwap_control_fortinet_cfg_mask",
              FT_IPv4, BASE_NETMASK, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_split_tun_cfg_enable_local_subnet,
            { "Enable Local Subnet", "capwap_control_fortinet_split_tun_cfg_enable_local_subnet",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_split_tun_cfg_cnt,
            { "CNT", "capwap_control_fortinet_split_tun_cfg_cnt",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mgmt_vlan_id,
            { "Vlan ID", "capwap_control_fortinet_mgmt_vlan_id",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_psk_passwd_rid,
            { "Radio ID", "capwap_control_fortinet_vap_psk_passwd_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_psk_passwd_wid,
            { "WLAN ID", "capwap_control_fortinet_vap_psk_passwd_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_vap_psk_passwd_key,
            { "Key", "capwap_control_fortinet_vap_psk_passwd_key",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mesh_eth_bridge_enable,
            { "Mesh Eth Bridge Enable", "capwap_control_fortinet_mesh_eth_bridge_enable",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_mesh_eth_bridge_type,
            { "Mesh Eth Bridge Type", "capwap_control_fortinet_mesh_eth_bridge_type",
              FT_UINT16, BASE_DEC_HEX, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wtp_cap,
            { "WTP CAP", "capwap_control_fortinet_wtp_cap",
              FT_BYTES, SEP_SPACE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_txpwr_rid,
            { "Radio ID", "capwap_control_fortinet_tx_power_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_txpwr,
            { "TX Power", "capwap_control_fortinet_tx_power",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              "In Pourcentage", HFILL }
        },
        { &hf_capwap_fortinet_wids_enable_rid,
            { "Radio ID", "capwap_control_fortinet_wids_enable_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_wids_enable,
            { "WIDS Enable", "capwap_control_fortinet_wids_enable_enable",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_unknown_rid,
            { "Radio ID", "capwap_control_fortinet_unknown_rid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_unknown_wid,
            { "WLAN ID", "capwap_control_fortinet_unknown_wid",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_fortinet_unknown,
            { "Unknown Data", "capwap_control_fortinet_unknown",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        ...
        { &hf_capwap_cisco_element_id,
            { "Cisco Element ID", "capwap_control_cisco_element_id",
              FT_UINT16, BASE_DEC, VALS(cisco_element_id_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_value,
            { "Cisco Value", "capwap_control_cisco_value",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_addr,
            { "Address", "capwap_control_cisco_mwar_address",
              FT_IPv4, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_rad_name,
            { "RAD (AP) Name", "capwap_control_cisco_rad_name",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_type,
            { "Type", "capwap_control_cisco_mwar_type",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_hardware,
            { "Hardware version", "capwap_control_cisco_mwar_hardware",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_software,
            { "Software version", "capwap_control_cisco_mwar_software",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_active_ms,
            { "Active MS", "capwap_control_cisco_mwar_active_ms",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_supported_ms,
            { "Supported MS", "capwap_control_cisco_mwar_supported_ms",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_active_rad,
            { "Active RAD", "capwap_control_cisco_mwar_active_rad",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_mwar_supported_rad,
            { "Supported RAD", "capwap_control_cisco_mwar_supported_rad",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_mode_and_type_mode,
            { "Mode", "capwap_control_cisco_ap_mode_and_type_mode",
              FT_UINT8, BASE_DEC, VALS(cisco_ap_mode_and_type_mode_vals), 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_mode_and_type_type,
            { "Type", "capwap_control_cisco_ap_mode_and_type_type",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_static_ip_addr,
            { "IP Address", "capwap_control_cisco_ap_static_ip_addr",
              FT_IPv4, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_static_ip_netmask,
            { "Netmask", "capwap_control_cisco_ap_static_ip_netmask",
              FT_IPv4, BASE_NETMASK, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_static_ip_gateway,
            { "Gateway", "capwap_control_cisco_ap_static_ip_gateway",
              FT_IPv4, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_static_ip_type,
            { "Type", "capwap_control_cisco_ap_static_ip_type",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_static_ip_reserved,
            { "Reserved", "capwap_control_cisco_ap_static_ip_reserved",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_uptime_current,
            { "AP Uptime Current", "capwap_control_cisco_ap_uptime_current",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_uptime_last,
            { "AP Uptime Last", "capwap_control_cisco_ap_uptime_last",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_group_name,
            { "AP Group Name", "capwap_control_cisco_ap_group_name",
              FT_STRING, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_led_state,
            { "Led State", "capwap_control_cisco_ap_led_state",
              FT_UINT16, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_timesync,
            { "AP TimeSync", "capwap_control_cisco_ap_timesync",
              FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_ap_timesync_type,
            { "Type (?)", "capwap_control_cisco_ap_timesync_type",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_board_data_options_ant_type,
            { "Antenna Type", "capwap_control_cisco_board_data_options_ant_type",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_board_data_options_flex_connect,
            { "Flex Connect", "capwap_control_cisco_board_data_options_flex_connect",
              FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x01,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_board_data_options_ap_type,
            { "AP Type", "capwap_control_cisco_board_data_options_ap_type",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_board_data_options_join_priority,
            { "Join Priority", "capwap_control_cisco_board_data_options_join_priority",
              FT_UINT8, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_capwap_cisco_unknown,
            { "Unknown Data", "capwap_control_cisco_unknown",
              FT_BYTES, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        ...
        /* Fragment entries */
        { &hf_msg_fragments,
            { "Message fragments", "capwap_fragments",
              FT_NONE, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment,
            { "Message fragment", "capwap_fragment",
              FT_FRAMENUM, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment_overlap,
            { "Message fragment overlap", "capwap_fragment_overlap",
              FT_BOOLEAN, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment_overlap_conflicts,
            { "Message fragment overlapping with conflicting data", "capwap_fragment_overlap_conflicts",
              FT_BOOLEAN, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment_multiple_tails,
            { "Message has multiple tail fragments", "capwap_fragment_multiple_tails",
              FT_BOOLEAN, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment_too_long_fragment,
            { "Message fragment too long", "capwap_fragment_too_long_fragment",
              FT_BOOLEAN, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment_error,
            { "Message defragmentation error", "capwap_fragment_error",
              FT_FRAMENUM, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_fragment_count,
            { "Message fragment count", "capwap_fragment_count",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_reassembled_in,
            { "Reassembled in", "capwap_reassembled_in",
              FT_FRAMENUM, BASE_NONE, NULL, 0x0,
              NULL, HFILL }
        },
        { &hf_msg_reassembled_length,
            { "Reassembled CAPWAP length", "capwap_reassembled_length",
              FT_UINT32, BASE_DEC, NULL, 0x0,
              NULL, HFILL }
        }
    };
