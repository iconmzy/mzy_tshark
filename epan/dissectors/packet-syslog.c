...
void proto_register_syslog(void)
{
  ...
  static hf_register_info hf[] = {
    ...
    { &hf_syslog_msu_present,
      { "SS7 MSU present",    "syslog_msu_present",
    ...
    { &hf_syslog_timestamp,
      { "Syslog timestamp", "syslog_timestamp",
        FT_ABSOLUTE_TIME, ABSOLUTE_TIME_UTC, NULL, 0x0,
        NULL,
        HFILL }
    },
    { &hf_syslog_timestamp_old,
      { "Syslog timestamp (RFC3164)", "syslog_timestamp_rfc3164",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL,
        HFILL }
    },
    { &hf_syslog_hostname,
      { "Syslog hostname", "syslog_hostname",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL,
        HFILL }
    },
    { &hf_syslog_appname,
      { "Syslog app name", "syslog_appname",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        "The name of the app that generated this message",
        HFILL }
    },
    { &hf_syslog_procid,
      { "Syslog process id", "syslog_procid",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL,
        HFILL }
    },
    { &hf_syslog_msgid,
      { "Syslog message id", "syslog_msgid",
        FT_STRING, ENC_ASCII, NULL, 0x0,
        NULL,
        HFILL }
    },
