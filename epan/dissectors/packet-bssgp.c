 ...
 */
static void
bssgp_overload(tvbuff_t *tvb, proto_tree *tree, packet_info *pinfo, guint32 offset, guint len)
{
    guint32 curr_offset;
    guint32 consumed;
    guint   curr_len;
...
proto_register_bssgp(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_bssgp_bmax,
          { "Bmax(x 100 or in increments as defined by the Flow Control Granularity IE)", "bssgp_bmax",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_r,
          { "R(x 100 or in increments as defined by the Flow Control Granularity IE)", "bssgp_r",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_r_pfc,
          { "R_PFC(x 100 or in increments as defined by the Flow Control Granularity IE)", "bssgp_r_pfc",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_bucket_size,
          { "Bmax(x 100 or in increments as defined by the Flow Control Granularity IE)", "bssgp_bucket_size",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_bmax_pfc,
          { "Bmax_PFC(x 100 or in increments as defined by the Flow Control Granularity IE)", "bssgp_bmax_pfc",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_omc_id,
          { "OMC identity", "bssgp_omc_id",
        ...
        { &hf_bssgp_peak_rate_gran,
          { "Peak Bit Rate Granularity", "bssgp_peak_rate_gran",
        ...
        { &hf_bssgp_ra_cause,
          { "Radio Cause", "bssgp_ra_cause",
            FT_UINT8, BASE_DEC, VALS(bssgp_radio_cause_vals), 0x00,
            NULL, HFILL }
        },
        { &hf_bssgp_ra_cap_upd_cause,
          { "RA-Cap-UPD Cause", "bssgp_ra_cap_upd_cause",
            FT_UINT8, BASE_DEC, VALS(bssgp_ra_cap_upd_cause_vals), 0x00,
            NULL, HFILL }
        },
        { &hf_bssgp_r_default_ms,
          { "R_default_MS(x 100 or in increments as defined by the Flow Control Granularity IE)", "bssgp_r_default_ms",
            FT_UINT16, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },

        { &hf_bssgp_suspend_ref_no,
          { "Suspend Reference Number", "bssgp_suspend_ref_no",
        ...
        { &hf_bssgp_trace_ref,
          { "Trace Reference", "bssgp_trace_ref",
            FT_UINT16, BASE_DEC, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_bssgp_trigger_id,
          { "Entity Identity", "bssgp_entity_id",
            FT_BYTES, BASE_NONE, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_bssgp_transaction_id,
          { "Transaction Id", "bssgp_transaction_id",
            FT_UINT16, BASE_DEC, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_bssgp_no_of_oct,
          { "Number of octets transferred or deleted", "bssgp_no_of_oct",
            FT_UINT24, BASE_DEC, NULL, 0x00,
            NULL, HFILL }
        },
        { &hf_bssgp_unit_val,
          { "Unit Value", "bssgp_unit_val",
            FT_UINT8, BASE_DEC, VALS(bssgp_unit_vals), 0xe0,
            NULL, HFILL }
        },
        { &hf_bssgp_gprs_timer,
          { "Unit Value", "bssgp_gprs_timer",
            FT_UINT8, BASE_DEC, NULL, 0x1f,
            NULL, HFILL }
        },

        { &hf_bssgp_mbms,
          { "MBMS Procedures", "bssgp_mbms",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x80,
            NULL, HFILL }
        },
        { &hf_bssgp_EnhancedRadioStatus,
          { "Enhanced Radio Status Procedures", "bssgp_enhancedradiostatus",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x40,
            NULL, HFILL }
        },
        { &hf_bssgp_pfcfc,
          { "PFC Flow Control Procedures", "bssgp_pfcfc",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x20,
            NULL, HFILL }
        },
        { &hf_bssgp_rim,
          { "RAN Information Management (RIM) procedures", "bssgp_rim",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x10,
            NULL, HFILL }
        },
        { &hf_bssgp_lcs,
          { "LCS Procedures", "bssgp_lcs",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x08,
            NULL, HFILL }
        },
        { &hf_bssgp_inr,
          { "Inter-NSE re-routing(INR)", "bssgp_inr",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x04,
            NULL, HFILL }
        },
        { &hf_bssgp_cbl,
          { "Current Bucket Level(CBL) Procedures", "bssgp_cbl",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x02,
            NULL, HFILL }
        },
        { &hf_bssgp_pfc,
          { "Packet Flow Context(PFC) Procedures", "bssgp_pfc",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x01,
            NULL, HFILL }
        },
        { &hf_bssgp_bucket_full_ratio,
          { "Ratio of the bucket that is filled up with data", "bssgp_bucket_full_ratio",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "B current x (100 / Bmax)", HFILL }
        },
        { &hf_bssgp_b_pfc,
          { "B_PFC: Bucket Full Ratio of the PFC", "bssgp_b_pfc",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            "B current x (100 / Bmax)", HFILL }
        },

        { &hf_bssgp_precedence,
          { "Precedence", "bssgp_precedence",
            FT_UINT8, BASE_DEC, NULL, 0x07,
            NULL, HFILL }
        },
        { &hf_bssgp_serv_utran_cco,
          { "Service UTRAN CCO", "bssgp_serv_utran_cco",
            FT_UINT8, BASE_DEC, VALS(bssgp_service_utran_cco_vals), 0x07,
            NULL, HFILL }
        },
        { &hf_bssgp_mbms_session_id,
          { "MBMS Session ID", "bssgp_mbms_session_id",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_mbms_cause,
          { "Cause", "bssgp_mbms_cause",
            FT_UINT8, BASE_DEC|BASE_EXT_STRING, &bssgp_mbms_cause_vals_ext, 0x0f,
            NULL, HFILL }
        },
        { &hf_bssgp_mbms_stop_cause,
          { "Stop Cause", "bssgp_mbms_stop_cause",
            FT_UINT8, BASE_DEC|BASE_EXT_STRING, &bssgp_mbms_stop_cause_vals_ext, 0x0f,
            NULL, HFILL }
        },
        { &hf_bssgp_session_inf,
          { "BC/MC", "bssgp_session_inf",
            FT_BOOLEAN, 8, TFS(&tfs_bssgp_bc_mc), 0x01,
            NULL, HFILL }
        },
        { &hf_bssgp_mbms_num_ra_ids,
          { "Number of Routing Area Identifications", "bssgp_mbms_num_ra_ids",
        ...
        { &hf_bssgp_dcn,
        { "DCN(Dedicated Core Network)", "bssgp_dcn",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x20,
            NULL, HFILL }
        },
        { &hf_bssgp_ec_gsm_iot,
          { "EC-GSM-IoT", "bssgp_ec_gsm_iot",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x10,
            NULL, HFILL }
        },
        { &hf_bssgp_csps_coord,
          { "CS/PS COORD", "bssgp_csps_coord",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x08,
            NULL, HFILL }
        },
        { &hf_bssgp_mocn,
        ...
        { &hf_bssgp_gb_if,
          { "Gigabit Interface", "bssgp_gb_if",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x02,
            NULL, HFILL }
        },
        { &hf_bssgp_ps_ho,
          { "PS Handover", "bssgp_ps_ho",
            FT_BOOLEAN, 8, TFS(&tfs_supported_not_supported), 0x01,
            NULL, HFILL }
        },
        { &hf_bssgp_src_to_trg_transp_cont,
          { "Source to Target Transparent Container", "bssgp_src_to_trg_transp_cont",
            FT_BYTES, FT_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_trg_to_src_transp_cont,
          { "Target to Source Transparent Container", "bssgp_trg_to_src_transp_cont",
            FT_BYTES, FT_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_rnc_id,
        ...
        { &hf_bssgp_page_mode,
          { "PAGE_MODE", "bssgp_page_mode",
            FT_UINT8, BASE_DEC, VALS(bssgp_page_mode_vals), 0x03,
            NULL, HFILL }
        },
        { &hf_bssgp_container_id,
          { "Container ID", "bssgp_container_id",
            FT_UINT8, BASE_DEC, NULL, 0x03,
            NULL, HFILL }
        },
        { &hf_bssgp_global_tfi,
          { "Global TFI", "bssgp_global_tfi",
            FT_UINT8, BASE_DEC, VALS(bssgp_global_tfi_vals), 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_ul_tfi,
          { "UPLINK_TFI", "bssgp_ul_tfi",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_dl_tfi,
          { "DOWNLINK_TFI", "bssgp_dl_tfi",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_time_to_MBMS_data_tran,
          { "Time to MBMS Data Transfer", "bssgp_time_to_mbms_data_tran",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_mbms_session_rep_no,
          { "MBMS-Session-Repetition-Number", "bssgp_mbms_session_rep_no",
            FT_UINT8, BASE_DEC, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_ps_ho_cmd,
          { "PS Handover Command", "bssgp_ps_ho_cmd",
            FT_BYTES, BASE_NONE, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_sipsi,
        ...
        { &hf_bssgp_peak_bit_rate,
          { "Peak bit rate", "bssgp_peak_bit_rate",
            FT_UINT16, BASE_DEC, NULL, 0,
            NULL, HFILL }},

        { &hf_bssgp_sys_info_type3_msg,
          { "SYSTEM INFORMATION type 3 message", "bssgp_sys_info_type3_msg",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssgp_trace_type_data,
          { "Trace Type data ( Coding unknown (Specification withdrawn) 3GPP TS 32.008)", "bssgp_trace_type_data",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }},

        { &hf_bssgp_si_item,
          { "SI item", "bssgp_si_item",
            FT_BYTES, BASE_NONE, NULL, 0,
            NULL, HFILL }},
        { &hf_bssgp_edrx_cycle_value,
          { "eDRX Cycle Value", "bssgp_edrx_cycle_value",
            FT_UINT8, BASE_HEX, VALS(bssgp_edrx_cycle_vals), 0x0f,
            NULL, HFILL }},

        { &hf_bssgp_tunpo_minutes,
          { "Minutes", "bssgp_tunpo_minutes",
            FT_UINT8, BASE_DEC, NULL, 0x3F,
            NULL, HFILL } },

        { &hf_bssgp_tunpo_seconds,
          { "Seconds", "bssgp_tunpo_seconds",
            FT_UINT8, BASE_DEC, NULL, 0x3F,
            NULL, HFILL } },

        { &hf_bssgp_ec_dl_coveradge_class,
          { "DL Coverage Class", "bssgp_ec_dl_coveradge_class",
            FT_UINT8, BASE_DEC, VALS(bssgp_ec_dl_coveradge_class_vals), 0x38,
            NULL, HFILL } },

        { &hf_bssgp_ec_ul_coveradge_class,
          { "UL Coverage Class", "bssgp_ec_ul_coveradge_class",
        ...
        { &hf_bssgp_ggsn_pgw_location,
          { "GGSN/P-GW location", "bssgp_ggsn_pgw_location",
            FT_UINT8, BASE_DEC, VALS(bssgp_ggsn_pgw_location_vals), 0x0,
            NULL, HFILL } },

        { &hf_bssgp_pei,
          { "Positioning Event Indicator(PEI)", "bssgp_pei",
            FT_UINT8, BASE_DEC, VALS(bssgp_pei_vals), 0x80,
            NULL, HFILL } },

        { &hf_bssgp_paging_attempt_count,
          { "Paging Attempt Count", "bssgp_paging_attempt_count",
            FT_UINT8, BASE_HEX, VALS(bssgp_paging_attempt_count_vals), 0x7,
            NULL, HFILL } },

        { &hf_bssgp_intended_num_of_pag_attempts,
          { "Intended Number of Paging Attempts", "bssgp_intended_num_of_pag_attempts",
            FT_UINT8, BASE_HEX, VALS(bssgp_intended_num_of_pag_attempts_vals), 0x78,
            NULL, HFILL } },

        { &hf_bssgp_extended_feature_bitmap,
        { "Extended Feature Bitmap", "bssgp_extended_feature_bitmap",
          FT_UINT8, BASE_HEX, NULL, 0x0,
          NULL, HFILL }
        },
        { &hf_bssgp_prio_class_ind,
        { "Priority Class Indicator", "bssgp_prio_class_ind",
            FT_UINT8, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_bssgp_prio_class_flag_b0,
        { "A mobile station configured for 'low access priority'", "bssgp_prio_class_ind_b0",
