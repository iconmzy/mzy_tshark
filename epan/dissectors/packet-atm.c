...
proto_register_atm(void)
{
  static hf_register_info hf[] = {
    { &hf_atm_aal,
      { "AAL",          "atm_aal", FT_UINT8, BASE_DEC, VALS(aal_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_gfc,
      { "GFC",          "atm_GFC", FT_UINT8, BASE_DEC, NULL, 0xF0,
        NULL, HFILL }},
    { &hf_atm_vpi,
      { "VPI",          "atm_vpi", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_atm_vci,
      { "VCI",          "atm_vci", FT_UINT16, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_atm_cid,
      { "CID",          "atm_cid", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},

    { &hf_atm_reserved,
      { "Reserved", "atm_reserved", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},

    { &hf_atm_le_client_client,
      { "LE Client", "atm_le_client_client", FT_UINT16, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_lan_destination_tag,
      { "Tag", "atm_lan_destination_tag", FT_UINT16, BASE_HEX, VALS(le_control_landest_tag_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_lan_destination_mac,
      { "MAC address", "atm_lan_destination_mac", FT_ETHER, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_tlv_type,
      { "TLV Type", "atm_le_control_tlv_type", FT_UINT32, BASE_HEX, VALS(le_tlv_type_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_tlv_length,
      { "TLV Length", "atm_le_control_tlv_length", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_lan_destination_route_desc,
      { "Route descriptor", "atm_lan_destination_route_desc", FT_UINT16, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_lan_destination_lan_id,
      { "LAN ID", "atm_lan_destination_lan_id", FT_UINT16, BASE_DEC, NULL, 0xFFF0,
        NULL, HFILL }},
    { &hf_atm_lan_destination_bridge_num,
      { "Bridge number", "atm_lan_destination_bridge_num", FT_UINT16, BASE_DEC, NULL, 0x000F,
        NULL, HFILL }},
    { &hf_atm_source_atm,
      { "Source ATM address", "atm_source_atm", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_target_atm,
      { "Target ATM address", "atm_target_atm", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_configure_join_frame_lan_type,
      { "LAN type", "atm_le_configure_join_frame_lan_type", FT_UINT8, BASE_HEX, VALS(le_control_lan_type_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_le_configure_join_frame_max_frame_size,
      { "Maximum frame size", "atm_le_configure_join_frame_max_frame_size", FT_UINT8, BASE_HEX, VALS(le_control_frame_size_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_le_configure_join_frame_num_tlvs,
      { "Number of TLVs", "atm_le_configure_join_frame_num_tlvs", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_configure_join_frame_elan_name_size,
      { "ELAN name size", "atm_le_configure_join_frame_elan_name_size", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_registration_frame_num_tlvs,
      { "Number of TLVs", "atm_le_registration_frame_num_tlvs", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_arp_frame_num_tlvs,
      { "Number of TLVs", "atm_le_arp_frame_num_tlvs", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_verify_frame_num_tlvs,
      { "Number of TLVs", "atm_le_verify_frame_num_tlvs", FT_UINT8, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_configure_join_frame_elan_name,
      { "ELAN name", "atm_le_configure_join_frame_elan_name", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_marker,
      { "Marker", "atm_le_control_marker", FT_UINT16, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_protocol,
      { "Protocol", "atm_le_control_protocol", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_version,
      { "Version", "atm_le_control_version", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_opcode,
      { "Opcode", "atm_le_control_opcode", FT_UINT16, BASE_HEX, VALS(le_control_opcode_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_status,
      { "Status", "atm_le_control_status", FT_UINT16, BASE_HEX, VALS(le_control_status_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_transaction_id,
      { "Transaction ID", "atm_le_control_transaction_id", FT_UINT32, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_requester_lecid,
      { "Requester LECID", "atm_le_control_requester_lecid", FT_UINT16, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_flags,
      { "Flags", "atm_le_control_flag", FT_UINT16, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_le_control_flag_v2_capable,
      { "V2 capable", "atm_le_control_flag_v2_capable", FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0002,
        NULL, HFILL }},
    { &hf_atm_le_control_flag_selective_multicast,
      { "Selective multicast", "atm_le_control_flag_selective_multicast", FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0004,
        NULL, HFILL }},
    { &hf_atm_le_control_flag_v2_required,
      { "V2 required", "atm_le_control_flag_v2_required", FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0008,
        NULL, HFILL }},
    { &hf_atm_le_control_flag_proxy,
      { "Proxy", "atm_le_control_flag_flag_proxy", FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0080,
        NULL, HFILL }},
    { &hf_atm_le_control_flag_exclude_explorer_frames,
      { "Exclude explorer frames", "atm_le_control_flag_exclude_explorer_frames", FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0200,
        NULL, HFILL }},
    { &hf_atm_le_control_flag_address,
      { "Address", "atm_le_control_flag_address", FT_BOOLEAN, 16, TFS(&tfs_yes_no), 0x0001,
        NULL, HFILL }},
    { &hf_atm_le_control_topology_change,
      { "Topology change", "atm_le_control_flag_topology_change", FT_BOOLEAN, 16, TFS(&tfs_remote_local), 0x0100,
        NULL, HFILL }},
    { &hf_atm_traffic_type,
      { "Traffic type", "atm_traffic_type", FT_UINT8, BASE_DEC, VALS(aal5_hltype_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_traffic_vcmx,
      { "VC multiplexed traffic type", "atm_traffic_vcmx", FT_UINT8, BASE_DEC, VALS(vcmx_type_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_traffic_lane,
      { "LANE traffic type", "atm_traffic_lane", FT_UINT8, BASE_DEC, VALS(lane_type_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_traffic_ipsilon,
      { "Ipsilon traffic type", "atm_traffic_ipsilon", FT_UINT8, BASE_DEC, VALS(ipsilon_type_vals), 0x0,
        NULL, HFILL }},
    { &hf_atm_cells,
      { "Cells", "atm_cells", FT_UINT16, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal5_uu,
      { "AAL5 UU", "atm_hf_atm_aal5t_uu", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal5_cpi,
      { "AAL5 CPI", "atm_hf_atm_aal5t_cpi", FT_UINT8, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal5_len,
      { "AAL5 len", "atm_aal5t_len", FT_UINT16, BASE_DEC, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal5_crc,
      { "AAL5 CRC", "atm_aal5t_crc", FT_UINT32, BASE_HEX, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_payload_type,
      { "Payload Type", "atm_payload_type", FT_UINT8, BASE_DEC, NULL, 0x0E,
        NULL, HFILL }},
    { &hf_atm_cell_loss_priority,
      { "Cell Loss Priority", "atm_cell_loss_priority", FT_BOOLEAN, 8, TFS(&tfs_low_high_priority), 0x01,
        NULL, HFILL }},
    { &hf_atm_header_error_check,
      { "Header Error Check", "atm_header_error_check", FT_UINT8, BASE_HEX, NULL, 0,
        NULL, HFILL }},
    { &hf_atm_channel,
      { "Channel", "atm_channel", FT_UINT16, BASE_DEC, VALS(atm_channel_vals), 0,
        NULL, HFILL }},
    { &hf_atm_aa1_csi,
      { "CSI", "atm_aa1_csi", FT_UINT8, BASE_DEC, NULL, 0x80,
        NULL, HFILL }},
    { &hf_atm_aa1_seq_count,
      { "Sequence Count", "atm_aa1_seq_count", FT_UINT8, BASE_DEC, NULL, 0x70,
        NULL, HFILL }},
    { &hf_atm_aa1_crc,
      { "CRC", "atm_aa1_crc", FT_UINT8, BASE_DEC, NULL, 0x08,
        NULL, HFILL }},
    { &hf_atm_aa1_parity,
      { "Parity", "atm_aa1_parity", FT_UINT8, BASE_DEC, NULL, 0x07,
        NULL, HFILL }},
    { &hf_atm_aa1_payload,
      { "Payload", "atm_aa1_payload", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal3_4_seg_type,
      { "Segment Type", "atm_aal3_4_seg_type", FT_UINT16, BASE_DEC, VALS(st_vals), 0xC000,
        NULL, HFILL }},
    { &hf_atm_aal3_4_seq_num,
      { "Sequence Number", "atm_aal3_4_seq_num", FT_UINT16, BASE_DEC, NULL, 0x3C00,
        NULL, HFILL }},
    { &hf_atm_aal3_4_multiplex_id,
      { "Multiplex ID", "atm_aal3_4_multiplex_id", FT_UINT16, BASE_DEC, NULL, 0x03FF,
        NULL, HFILL }},
    { &hf_atm_aal3_4_information,
      { "Information", "atm_aal3_4_information", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal3_4_length_indicator,
      { "Length Indicator", "atm_aal3_4_length_indicator", FT_UINT16, BASE_DEC, VALS(st_vals), 0xFC00,
        NULL, HFILL }},
    { &hf_atm_aal3_4_crc,
      { "CRC", "atm_aal3_4_crc", FT_UINT16, BASE_DEC, NULL, 0x03FF,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_type,
      { "OAM Type", "atm_aal_oamcell_type", FT_UINT8, BASE_DEC, VALS(oam_type_vals), 0xF0,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_type_fm,
      { "Function Type", "atm_aal_oamcell_type_fm", FT_UINT8, BASE_DEC, VALS(ft_fm_vals), 0x0F,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_type_pm,
      { "Function Type", "atm_aal_oamcell_type_pm", FT_UINT8, BASE_DEC, VALS(ft_pm_vals), 0x0F,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_type_ad,
      { "Function Type", "atm_aal_oamcell_type_ad", FT_UINT8, BASE_DEC, VALS(ft_ad_vals), 0x0F,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_type_ft,
      { "Function Type", "atm_aal_oamcell_type_ft", FT_UINT8, BASE_DEC, NULL, 0x0F,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_func_spec,
      { "Function-specific information", "atm_aal_oamcell_func_spec", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
    { &hf_atm_aal_oamcell_crc,
      { "CRC-10", "atm_aal_oamcell_crc", FT_UINT16, BASE_HEX, NULL, 0x3FF,
        NULL, HFILL }},
    { &hf_atm_padding,
      { "Padding", "atm_padding", FT_BYTES, BASE_NONE, NULL, 0x0,
        NULL, HFILL }},
