...
proto_register_ayiya(void)
{
    static hf_register_info hf[] = {
        { &hf_id_len,
          { "Identity field length", "ayiya_idlen", FT_UINT8,
            BASE_HEX, NULL, 0x0, NULL, HFILL
          }
        },
        { &hf_id_type,
          { "Identity field type", "ayiya_idtype", FT_UINT8,
            BASE_HEX, VALS(identity_types), 0x0, NULL, HFILL
          }
        },
        { &hf_sig_len,
          { "Signature Length", "ayiya_siglen", FT_UINT8,
            BASE_HEX, NULL, 0x0, NULL, HFILL
          }
        },
        { &hf_hash_method,
          { "Hash method", "ayiya_hashmethod", FT_UINT8,
            BASE_HEX, VALS(hash_methods), 0x0, NULL, HFILL
          }
        },
        { &hf_auth_method,
          { "Authentication method", "ayiya_authmethod", FT_UINT8,
            BASE_HEX, VALS(auth_methods), 0x0, NULL, HFILL
          }
        },
        { &hf_opcode,
          { "Operation Code", "ayiya_opcode", FT_UINT8,
            BASE_HEX, VALS(opcodes), 0x0, NULL, HFILL
          }
        },
        { &hf_next_header,
          { "Next Header", "ayiya_nextheader", FT_UINT8,
            BASE_HEX, NULL, 0x0, NULL, HFILL
          }
        },
        { &hf_epoch,
          { "Epoch", "ayiya_epoch", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL
          }
        },
        { &hf_identity,
          { "Identity", "ayiya_identity", FT_BYTES,
            BASE_NONE, NULL, 0x0, NULL, HFILL
          }
        },
        { &hf_signature,
          { "Signature", "ayiya_signature", FT_BYTES,
            BASE_NONE, NULL, 0x0, NULL, HFILL
          }
        },
    };
