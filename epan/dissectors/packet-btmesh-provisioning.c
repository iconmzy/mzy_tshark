...
proto_register_btmesh_provisioning(void)
{
    static hf_register_info hf[] = {
        ...
        { &hf_btmesh_provisioning_authentication_action_no_oob_action,
            { "No OOB Authentication Action", "provisioning_authentication_action_no_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_action_static_oob_action,
            { "Static OOB Authentication Action", "provisioning_authentication_action_static_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_action_output_oob_action,
            { "Output OOB Authentication Action", "provisioning_authentication_action_output_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_action_input_oob_action,
            { "Input OOB Authentication Action", "provisioning_authentication_action_input_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_size_no_oob_action,
            { "No OOB Authentication Size", "provisioning_authentication_size_no_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_size_static_oob_action,
            { "Static OOB Authentication Size", "provisioning_authentication_size_static_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_size_output_oob_action,
            { "Output OOB Authentication Size", "provisioning_authentication_size_output_oob_action",
        ...
        { &hf_btmesh_provisioning_authentication_size_input_oob_action,
            { "Input OOB Authentication Size", "provisioning_authentication_size_input_oob_action",
        ...
        { &hf_btmesh_provisioning_public_key_x,
            { "Public Key X", "provisioning_public_key_x",
                FT_BYTES, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_btmesh_provisioning_public_key_y,
            { "Public Key Y", "provisioning_public_key_y",
                FT_BYTES, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        ...
        { &hf_btmesh_provisioning_random,
            { "Random", "provisioning_random",
                FT_BYTES, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_btmesh_provisioning_encrypted_provisioning_data,
            { "Encrypted Provisioning Data", "provisioning_encrypted_provisioning_data",
                FT_BYTES, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_btmesh_provisioning_decrypted_provisioning_data_mic,
            { "Decrypted Provisioning Data MIC", "provisioning_decrypted_provisioning_data_mic",
                FT_BYTES, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
        { &hf_btmesh_provisioning_error_code,
            { "Error Code", "provisioning_error_code",
                FT_UINT8, BASE_DEC, VALS(btmesh_provisioning_error_code_format), 0x0,
                NULL, HFILL }
        },
        { &hf_btmesh_provisioning_unknown_data,
            { "Unknown Data", "provisioning_unknown_data",
                FT_BYTES, BASE_NONE, NULL, 0x0,
                NULL, HFILL }
        },
    };
