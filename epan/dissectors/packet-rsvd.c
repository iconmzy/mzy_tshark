...
proto_register_rsvd(void)
{
    ...
    static hf_register_info hf[] = {
                { &hf_svhdx_protocol_id,
                  { "ProtocolId", "rsvd_svhdx_protocol_id", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_protocol_version,
                  { "ProtocolVersion", "rsvd_svhdx_protocol_version", FT_UINT16, BASE_DEC,
                     NULL, 0, NULL, HFILL }},

                { &hf_svhdx_operation_code,
                  { "OperationCode", "rsvd_svhdx_operation_code", FT_UINT32, BASE_HEX,
                     VALS(rsvd_operation_code_vals), 0, "Operation Code", HFILL }},

                { &hf_svhdx_status,
                  { "Status", "rsvd_svhdx_status", FT_UINT32, BASE_HEX | BASE_EXT_STRING,
                    &NT_errors_ext, 0, NULL, HFILL }},


                { &hf_svhdx_request_id,
                  { "RequestId", "rsvd_svhdx_request_id", FT_UINT64, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_length,
                  { "Length", "rsvd_svhdx_length", FT_UINT16, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_reserved1,
                  { "Reserved1", "rsvd_svhdx_scsi_reserved1", FT_UINT16, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_cdb_length,
                  { "CDBLength", "rsvd_svhdx_scsi_cdb_length", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_sense_info_ex_length,
                  { "SenseInfoExLength", "rsvd_svhdx_scsi_sense_info_ex_length", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_data_in,
                  { "DataIn", "rsvd_svhdx_scsi_data_in", FT_UINT8, BASE_HEX,
                    VALS(rsvd_data_in_vals), 0, "SCSI CDB transfer type", HFILL }},

                { &hf_svhdx_tunnel_scsi_reserved2,
                  { "Reserved2", "rsvd_svhdx_scsi_reserved2", FT_UINT8, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_srb_flags,
                  { "SRBFlags", "rsvd_svhdx_scsi_srbflags", FT_UINT32, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_data_transfer_length,
                  { "DataTransferLength", "rsvd_svhdx_scsi_data_transfer_length", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_reserved3,
                  { "Reserved3", "rsvd_svhdx_scsi_reserved3", FT_UINT32, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_cdb,
                  { "CDB", "rsvd_svhdx_scsi_cdb", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_cdb_padding,
                  { "CDBPadding", "rsvd_svhdx_scsi_cdb_padding", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_data,
                  {"Data", "rsvd_svhdx_scsi_data", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_auto_generated_sense,
                  {"AutoGeneratedSenseInfo", "rsvd_svhdx_auto_generated_sense_info", FT_UINT8, BASE_HEX,
                    VALS(rsvd_sense_info_vals), 0x80, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_srb_status,
                  { "SrbStatus", "rsvd_svhdx_srb_status", FT_UINT8, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_status,
                  { "ScsiStatus", "rsvd_svhdx_scsi_status", FT_UINT8, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_scsi_sense_data_ex,
                  { "SenseDataEx", "rsvd_svhdx_scsi_sense_data_ex", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_file_info_server_version,
                  { "ServerVersion", "rsvd_svhdx_file_info_server_version", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_file_info_sector_size,
                  { "SectorSize", "rsvd_svhdx_file_info_sector_size", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_file_info_physical_sector_size,
                  { "PhysicalSectorSize", "rsvd_svhdx_file_info_physical_sector_size", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_file_info_reserved,
                  { "Reserved", "rsvd_svhdx_file_info_reserved", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_file_info_virtual_size,
                  { "VirtualSize", "rsvd_svhdx_file_info_virtual_size", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},


                { &hf_svhdx_tunnel_disk_info_reserved1,
                  { "Reserved1", "rsvd_svhdx_disk_info_reserved1", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_blocksize,
                  { "BlockSize", "rsvd_svhdx_disk_info_blocksize", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_linkage_id,
                  { "LinkageID", "rsvd_svhdx_disk_info_linkage_id", FT_GUID, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_disk_type,
                  { "DiskType", "rsvd_svhdx_disk_info_disk_type", FT_UINT16, BASE_HEX,
                     VALS(rsvd_disk_type_vals), 0, "Disk Type", HFILL }},

                { &hf_svhdx_tunnel_disk_info_disk_format,
                  { "DiskFormat", "rsvd_svhdx_disk_info_disk_format", FT_UINT16, BASE_HEX,
                     VALS(rsvd_disk_format_vals), 0, "Disk Format", HFILL }},

                { &hf_svhdx_tunnel_disk_info_is_mounted,
                  { "IsMounted", "rsvd_svhdx_tunnel_disk_info_is_mounted", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_is_4k_aligned,
                  { "Is4KAligned", "rsvd_svhdx_tunnel_disk_info_is_4k_aligned", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_reserved,
                  { "Reserved", "rsvd_svhdx_disk_info_reserved", FT_UINT16, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_file_size,
                  { "FileSize", "rsvd_svhdx_disk_info_file_size", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_disk_info_virtual_disk_id,
                  { "VirtualDiskId", "rsvd_svhdx_disk_info_virtual_disk_id", FT_GUID, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_validate_disk_reserved,
                  { "Reserved", "rsvd_svhdx_tunnel_validate_disk_reserved", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_validate_disk_is_valid_disk,
                  { "IsValidDisk", "rsvd_svhdx_validate_disk_is_valid_disk", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_status_key,
                  { "StatusKey", "rsvd_svhdx_srb_status_key", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_reserved,
                  { "Reserved", "rsvd_svhdx_srb_status_reserved", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_sense_info_auto_generated,
                  { "SenseInfoAutoGenerated", "rsvd_svhdx_sense_info_auto_generated", FT_UINT8, BASE_HEX,
                    VALS(rsvd_sense_info_vals), 0x80, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_srb_status,
                  { "SrbStatus", "rsvd_svhdx_srb_status_srb_status", FT_UINT8, BASE_HEX,
                    NULL, 0x7f, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_scsi_status,
                  { "SrbStatus", "rsvd_svhdx_srb_status_scsi_status", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_sense_info_ex_length,
                  { "SenseInfoExLength", "rsvd_svhdx_srb_status_sense_info_ex_length", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_srb_status_sense_data_ex,
                  { "Reserved", "rsvd_svhdx_srb_status_sense_data_ex", FT_BYTES, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_safe_virtual_size,
                  { "SafeVirtualSize", "rsvd_svhdx_safe_size", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_transaction_id,
                  { "TransactionId", "rsvd_svhdx_meta_operation_transaction_id", FT_GUID, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_meta_operation_type,
                  { "OperationType", "rsvd_svhdx_meta_operation_type", FT_UINT32, BASE_HEX,
                    VALS(rsvd_meta_operation_type_vals), 0, "Type of meta-operation", HFILL }},

                { &hf_svhdx_tunnel_padding,
                  { "Padding", "rsvd_svhdx_padding", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_resize_new_size,
                  { "NewSize", "rsvd_svhdx_meta_operation_new_size", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_resize_expand_only_flag,
                  { "ExpandOnly", "rsvd_svhdx_meta_operation_expand_only", FT_BOOLEAN, 8,
                    NULL, 0, "Indicates that shared virtual disk size can only expand", HFILL }},

                { &hf_svhdx_tunnel_resize_allow_unsafe_virt_size_flag,
                  { "AllowUnsafeVirtualSize", "rsvd_svhdx_meta_operation_allow_unsafe_virt_size", FT_BOOLEAN, 8,
                ...
                { &hf_svhdx_tunnel_resize_shrink_to_minimum_safe_size_flag,
                  { "ShrinkToMinimumSafeSize", "rsvd_svhdx_meta_operation_shrink_to_minimum_safe_size", FT_BOOLEAN, 8,
                ...
                { &hf_svhdx_tunnel_meta_operation_start_reserved,
                  { "Reserved", "rsvd_svhdx_meta_operation_reserved", FT_UINT8, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_snapshot_type,
                  { "SnapshotType", "rsvd_svhdx_snapshot_type", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_type_vals), 0, "Type of snapshot", HFILL }},

                { &hf_svhdx_tunnel_snapshot_id,
                  { "SnapshotId", "rsvd_svhdx_snapshot_id", FT_GUID, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_flags,
                  { "Flags", "rsvd_svhdx_meta_operation_create_snapshot_flags", FT_UINT32, BASE_HEX,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_flag_enable_change_tracking,
                  { "SVHDX_SNAPSHOT_DISK_FLAG_ENABLE_CHANGE_TRACKING", "rsvd_svhdx_meta_operation_create_snapshot_flag_enable_change_tracking", FT_BOOLEAN, 32,
                ...
                { &hf_svhdx_tunnel_create_snapshot_stage1,
                  { "Stage1", "rsvd_svhdx_meta_operation_create_snapshot_stage1", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_stage_vals), 0, "The first stage", HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_stage2,
                  { "Stage2", "rsvd_svhdx_meta_operation_create_snapshot_stage2", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_stage_vals), 0, "The second stage", HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_stage3,
                  { "Stage3", "rsvd_svhdx_meta_operation_create_snapshot_stage3", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_stage_vals), 0, "The third stage", HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_stage4,
                  { "Stage4", "rsvd_svhdx_meta_operation_create_snapshot_stage4", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_stage_vals), 0, "The fourth stage", HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_stage5,
                  { "Stage5", "rsvd_svhdx_meta_operation_create_snapshot_stage5", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_stage_vals), 0, "The fifth stage", HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_stage6,
                  { "Stage6", "rsvd_svhdx_meta_operation_create_snapshot_stage6", FT_UINT32, BASE_HEX,
                    VALS(svhdx_snapshot_stage_vals), 0, "The sixth stage", HFILL }},

                { &hf_svhdx_tunnel_create_snapshot_parameters_payload_size,
                  { "ParametersPayloadSize", "rsvd_svhdx_meta_operation_create_snapshot_params_payload_size", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_convert_dst_vhdset_name_len,
                  { "DestinationVhdSetNameLength", "rsvd_svhdx_meta_operation_dst_vhdset_name_len", FT_UINT32, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_convert_dst_vhdset_name,
                  { "DestinationVhdSetName", "rsvd_svhdx_meta_operation_dst_vhdset_name", FT_STRING, BASE_NONE,
                    NULL, 0, "Name for the new VHD set be created", HFILL }},

                { &hf_svhdx_tunnel_delete_snapshot_persist_reference,
                  { "PersistReference", "rsvd_svhdx_delete_snapshot_persist_reference", FT_BOOLEAN, 4,
                    NULL, 0, "Indicate if the snapshot needs to be persisted", HFILL }},

                { &hf_svhdx_tunnel_meta_op_query_progress_current_progress,
                  { "CurrentProgressValue", "rsvd_svhdx_query_progress_current_progress", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_meta_op_query_progress_complete_value,
                  { "CompleteValue", "rsvd_svhdx_query_progress_complete_value", FT_UINT64, BASE_DEC,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_vhdset_information_type,
                  { "VHDSetInformationType", "rsvd_svhdx_vhdset_information_type", FT_UINT32, BASE_HEX,
                ...
                { &hf_svhdx_tunnel_vhdset_snapshot_creation_time,
                  { "SnapshotCreationTime", "rsvd_svhdx_vhdset_snapshot_creation_time", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL,
                    NULL, 0, "Time when this object was created", HFILL }},

                { &hf_svhdx_tunnel_vhdset_is_valid_snapshot,
                  { "IsValidSnapshot", "rsvd_svhdx_vhdset_is_valid_snapshot", FT_BOOLEAN, 4,
                    NULL, 0, "Set to 1 when the snapshot is valid", HFILL }},

                { &hf_svhdx_tunnel_vhdset_parent_snapshot_id,
                  { "ParentSnapshotId", "rsvd_svhdx_vhdxset_parent_snapshot_id", FT_GUID, BASE_NONE,
                    NULL, 0, NULL, HFILL }},

                { &hf_svhdx_tunnel_vhdset_log_file_id,
                  { "LogFileId", "rsvd_svhdx_vhdxset_log_file_id", FT_GUID, BASE_NONE,
                    NULL, 0, NULL, HFILL }}
    };
