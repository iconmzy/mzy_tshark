...
#line 1 "./asn1/atn-ulcs/packet-atn-ulcs-hfarr.c"
    ...
    { &hf_atn_ulcs_aarq,
      { "aarq", "atn-ulcs_aarq_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "AARQ_apdu", HFILL }},
    { &hf_atn_ulcs_aare,
      { "aare", "atn-ulcs_aare_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "AARE_apdu", HFILL }},
    { &hf_atn_ulcs_rlrq,
      { "rlrq", "atn-ulcs_rlrq_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "RLRQ_apdu", HFILL }},
    { &hf_atn_ulcs_rlre,
      { "rlre", "atn-ulcs_rlre_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "RLRE_apdu", HFILL }},
    { &hf_atn_ulcs_abrt,
      { "abrt", "atn-ulcs_abrt_element",
        FT_NONE, BASE_NONE, NULL, 0,
        "ABRT_apdu", HFILL }},
    { &hf_atn_ulcs_aarq_apdu_protocol_version,
      { "protocol-version", "atn-ulcs_protocol_version",
        FT_BYTES, BASE_NONE, NULL, 0,
        "T_aarq_apdu_protocol_version", HFILL }},
    { &hf_atn_ulcs_application_context_name,
      { "application-context-name", "atn-ulcs_application_context_name",
        FT_OID, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_called_AP_title,
      { "called-AP-title", "atn-ulcs_called_AP_title",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_AP_title_vals), 0,
        "AP_title", HFILL }},
    { &hf_atn_ulcs_called_AE_qualifier,
      { "called-AE-qualifier", "atn-ulcs_called_AE_qualifier",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_AE_qualifier_vals), 0,
        "AE_qualifier", HFILL }},
    { &hf_atn_ulcs_called_AP_invocation_identifier,
      { "called-AP-invocation-identifier", "atn-ulcs_called_AP_invocation_identifier",
        FT_INT32, BASE_DEC, NULL, 0,
        "AP_invocation_identifier", HFILL }},
    { &hf_atn_ulcs_called_AE_invocation_identifier,
      { "called-AE-invocation-identifier", "atn-ulcs_called_AE_invocation_identifier",
        FT_INT32, BASE_DEC, NULL, 0,
        "AE_invocation_identifier", HFILL }},
    { &hf_atn_ulcs_calling_AP_title,
      { "calling-AP-title", "atn-ulcs_calling_AP_title",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_AP_title_vals), 0,
        "AP_title", HFILL }},
    { &hf_atn_ulcs_calling_AE_qualifier,
      { "calling-AE-qualifier", "atn-ulcs_calling_AE_qualifier",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_AE_qualifier_vals), 0,
        "AE_qualifier", HFILL }},
    { &hf_atn_ulcs_calling_AP_invocation_identifier,
      { "calling-AP-invocation-identifier", "atn-ulcs_calling_AP_invocation_identifier",
        FT_INT32, BASE_DEC, NULL, 0,
        "AP_invocation_identifier", HFILL }},
    { &hf_atn_ulcs_calling_AE_invocation_identifier,
      { "calling-AE-invocation-identifier", "atn-ulcs_calling_AE_invocation_identifier",
        FT_INT32, BASE_DEC, NULL, 0,
        "AE_invocation_identifier", HFILL }},
    { &hf_atn_ulcs_sender_acse_requirements,
      { "sender-acse-requirements", "atn-ulcs_sender_acse_requirements",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ACSE_requirements", HFILL }},
    { &hf_atn_ulcs_mechanism_name,
      { "mechanism-name", "atn-ulcs_mechanism_name",
        FT_OID, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_calling_authentication_value,
      { "calling-authentication-value", "atn-ulcs_calling_authentication_value",
    ...
    { &hf_atn_ulcs_application_context_name_list,
      { "application-context-name-list", "atn-ulcs_application_context_name_list",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_implementation_information,
      { "implementation-information", "atn-ulcs_implementation_information",
        FT_BYTES, BASE_NONE, NULL, 0,
        "Implementation_data", HFILL }},
    { &hf_atn_ulcs_user_information,
      { "user-information", "atn-ulcs_user_information",
        FT_UINT32, BASE_DEC, NULL, 0,
    ...
    { &hf_atn_ulcs_responding_AP_title,
      { "responding-AP-title", "atn-ulcs_responding_AP_title",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_AP_title_vals), 0,
        "AP_title", HFILL }},
    { &hf_atn_ulcs_responding_AE_qualifier,
      { "responding-AE-qualifier", "atn-ulcs_responding_AE_qualifier",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_AE_qualifier_vals), 0,
        "AE_qualifier", HFILL }},
    { &hf_atn_ulcs_responding_AP_invocation_identifier,
      { "responding-AP-invocation-identifier", "atn-ulcs_responding_AP_invocation_identifier",
        FT_INT32, BASE_DEC, NULL, 0,
        "AP_invocation_identifier", HFILL }},
    { &hf_atn_ulcs_responding_AE_invocation_identifier,
      { "responding-AE-invocation-identifier", "atn-ulcs_responding_AE_invocation_identifier",
        FT_INT32, BASE_DEC, NULL, 0,
        "AE_invocation_identifier", HFILL }},
    { &hf_atn_ulcs_responder_acse_requirements,
      { "responder-acse-requirements", "atn-ulcs_responder_acse_requirements",
        FT_BYTES, BASE_NONE, NULL, 0,
        "ACSE_requirements", HFILL }},
    { &hf_atn_ulcs_responding_authentication_value,
      { "responding-authentication-value", "atn-ulcs_responding_authentication_value",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_Authentication_value_vals), 0,
        "Authentication_value", HFILL }},
    { &hf_atn_ulcs_rlrq_apdu_request_reason,
      { "reason", "atn-ulcs_reason",
    ...
    { &hf_atn_ulcs_ap_title_form2,
      { "ap-title-form2", "atn-ulcs_ap_title_form2",
        FT_OID, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_ap_title_form1,
      { "ap-title-form1", "atn-ulcs_ap_title_form1",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_Name_vals), 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_ae_qualifier_form2,
      { "ae-qualifier-form2", "atn-ulcs_ae_qualifier_form2",
        FT_INT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_ae_qualifier_form1,
      { "ae-qualifier-form1", "atn-ulcs_ae_qualifier_form1",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_acse_service_user,
      { "acse-service-user", "atn-ulcs_acse_service_user",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_T_acse_service_user_vals), 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_acse_service_provider,
      { "acse-service-provider", "atn-ulcs_acse_service_provider",
        FT_UINT32, BASE_DEC, VALS(atn_ulcs_T_acse_service_provider_vals), 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_Association_information_item,
      { "EXTERNALt", "atn-ulcs_EXTERNALt_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_charstring,
      { "charstring", "atn-ulcs_charstring",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING", HFILL }},
    { &hf_atn_ulcs_bitstring,
      { "bitstring", "atn-ulcs_bitstring",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING", HFILL }},
    { &hf_atn_ulcs_external,
      { "external", "atn-ulcs_external_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_other,
      { "other", "atn-ulcs_other_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_other_mechanism_name,
      { "other-mechanism-name", "atn-ulcs_other_mechanism_name",
        FT_OID, BASE_NONE, NULL, 0,
        "OBJECT_IDENTIFIER", HFILL }},
    { &hf_atn_ulcs_other_mechanism_value,
      { "other-mechanism-value", "atn-ulcs_other_mechanism_value_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_rdnSequence,
      { "rdnSequence", "atn-ulcs_rdnSequence",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_RDNSequence_item,
      { "RelativeDistinguishedName", "atn-ulcs_RelativeDistinguishedName",
        FT_UINT32, BASE_DEC, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_RelativeDistinguishedName_item,
      { "AttributeTypeAndValue", "atn-ulcs_AttributeTypeAndValue_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_null,
      { "null", "atn-ulcs_null_element",
        FT_NONE, BASE_NONE, NULL, 0,
        NULL, HFILL }},
    { &hf_atn_ulcs_T_aarq_apdu_protocol_version_version1,
      { "version1", "atn_ulcs_T_aarq_apdu_protocol_version_version1",
        FT_BOOLEAN, 8, NULL, 0x80,
        NULL, HFILL }},
    { &hf_atn_ulcs_T_aare_apdu_protocol_version_version1,
      { "version1", "atn_ulcs_T_aare_apdu_protocol_version_version1",
        FT_BOOLEAN, 8, NULL, 0x80,
        NULL, HFILL }},
    { &hf_atn_ulcs_ACSE_requirements_authentication,
      { "authentication", "atn_ulcs_ACSE_requirements_authentication",
        FT_BOOLEAN, 8, NULL, 0x80,
        NULL, HFILL }},
    { &hf_atn_ulcs_ACSE_requirements_application_context_negotiation,
      { "application-context-negotiation", "atn_ulcs_ACSE_requirements_application_context_negotiation",
...
#line 776 "./asn1/atn-ulcs/packet-atn-ulcs-template.c"
        ...
        { "SPDU Parameter Indication",
          "atn-ulcs_ses_parameter-indication",
          FT_UINT8,
          BASE_HEX,
      ...
      {&hf_atn_ses_param_b2,
        { "SRF Parameter B2",
          ...
          HFILL}},
      { &hf_atn_pres_err,
        { "Error Code", "atn-ulcs_pres_cpr-error",
          FT_UINT8,
          BASE_HEX,
          VALS(atn_pres_err),
          PRES_CPR_ER_MASK,
      ...
      { &hf_atn_pres_pdu_type,
        { "PDU type", "atn-ulcs_pres_pdu_type",
          FT_UINT8,
          BASE_HEX,
          NULL,
          ATN_SES_PRES_MASK,
