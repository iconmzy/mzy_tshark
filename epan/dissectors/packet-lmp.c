...
proto_register_lmp(void)
{
    ...
    static hf_register_info lmpf_info[] = {
        ...
        {&hf_lmp_filter[LMPF_MSG],
         { "Message Type", "lmp_msg", FT_UINT8, BASE_DEC, VALS(message_type_vals), 0x0,
           NULL, HFILL }},

        /* Message type shorthands */
        {&hf_lmp_filter[LMPF_MSG_CONFIG],
         { "Config Message", "lmp_msg_config", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_CONFIG_ACK],
         { "ConfigAck Message", "lmp_msg_configack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_CONFIG_NACK],
         { "ConfigNack Message", "lmp_msg_confignack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_HELLO],
         { "HELLO Message", "lmp_msg_hello", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_BEGIN_VERIFY],
         { "BeginVerify Message", "lmp_msg_beginverify", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_BEGIN_VERIFY_ACK],
         { "BeginVerifyAck Message", "lmp_msg_beginverifyack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_BEGIN_VERIFY_NACK],
         { "BeginVerifyNack Message", "lmp_msg_beginverifynack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_END_VERIFY],
         { "EndVerify Message", "lmp_msg_endverify", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_END_VERIFY_ACK],
         { "EndVerifyAck Message", "lmp_msg_endverifyack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TEST],
         { "Test Message", "lmp_msg_test", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TEST_STATUS_SUCCESS],
         { "TestStatusSuccess Message", "lmp_msg_teststatussuccess", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TEST_STATUS_FAILURE],
         { "TestStatusFailure Message", "lmp_msg_teststatusfailure", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TEST_STATUS_ACK],
         { "TestStatusAck Message", "lmp_msg_teststatusack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_LINK_SUMMARY],
         { "LinkSummary Message", "lmp_msg_linksummary", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_LINK_SUMMARY_ACK],
         { "LinkSummaryAck Message", "lmp_msg_linksummaryack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_LINK_SUMMARY_NACK],
         { "LinkSummaryNack Message", "lmp_msg_linksummarynack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_CHANNEL_STATUS],
         { "ChannelStatus Message", "lmp_msg_channelstatus", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_CHANNEL_STATUS_ACK],
         { "ChannelStatusAck Message", "lmp_msg_channelstatusack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_CHANNEL_STATUS_REQ],
         { "ChannelStatusRequest Message", "lmp_msg_channelstatusrequest", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_CHANNEL_STATUS_RESP],
         { "ChannelStatusResponse Message", "lmp_msg_channelstatusresponse", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_MONITOR],
         { "TraceMonitor Message", "lmp_msg_tracemonitor", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_MONITOR_ACK],
         { "TraceMonitorAck Message", "lmp_msg_tracemonitorack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_MONITOR_NACK],
         { "TraceMonitorNack Message", "lmp_msg_tracemonitornack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_MISMATCH],
         { "TraceMismatch Message", "lmp_msg_tracemismatch", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_MISMATCH_ACK],
         { "TraceMismatchAck Message", "lmp_msg_tracemismatchack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_REQUEST],
         { "TraceRequest Message", "lmp_msg_tracerequest", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_REPORT],
         { "TraceReport Message", "lmp_msg_tracereport", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_TRACE_REQUEST_NACK],
         { "TraceRequestNack Message", "lmp_msg_tracerequestnack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_INSERT_TRACE],
         { "InsertTrace Message", "lmp_msg_inserttrace", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_INSERT_TRACE_ACK],
         { "InsertTraceAck Message", "lmp_msg_inserttraceack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_INSERT_TRACE_NACK],
         { "InsertTraceNack Message", "lmp_msg_inserttracenack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_SERVICE_CONFIG],
         { "ServiceConfig Message", "lmp_msg_serviceconfig", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_SERVICE_CONFIG_ACK],
         { "ServiceConfigAck Message", "lmp_msg_serviceconfigack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_SERVICE_CONFIG_NACK],
         { "ServiceConfigNack Message", "lmp_msg_serviceconfignack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_DISCOVERY_RESP],
         { "DiscoveryResponse Message", "lmp_msg_discoveryresp", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_DISCOVERY_RESP_ACK],
         { "DiscoveryResponseAck Message", "lmp_msg_discoveryrespack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_MSG_DISCOVERY_RESP_NACK],
         { "DiscoveryResponseNack Message", "lmp_msg_discoveryrespnack", FT_BOOLEAN, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        /* LMP Message Header Fields ------------------- */

        {&hf_lmp_filter[LMPF_HDR_FLAGS],
         { "LMP Header - Flags", "lmp_hdr_flags", FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_HDR_FLAGS_CC_DOWN],
         { "ControlChannelDown", "lmp_hdr_ccdown", FT_BOOLEAN, 8, NULL, 0x01,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_HDR_FLAGS_REBOOT],
         { "Reboot", "lmp_hdr_reboot", FT_BOOLEAN, 8, NULL, 0x02,
           NULL, HFILL }},

        /* LMP object class filters ------------------------------- */

        {&hf_lmp_filter[LMPF_OBJECT],
         { "LOCAL_CCID", "lmp_object", FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_CCID],
         { "CCID", "lmp_obj_ccid", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_NODE_ID],
         { "NODE_ID", "lmp_obj_Nodeid", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_LINK_ID],
         { "LINK_ID", "lmp_obj_linkid", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_INTERFACE_ID],
         { "INTERFACE_ID", "lmp_obj_interfaceid", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_MESSAGE_ID],
         { "MESSAGE_ID", "lmp_obj_messageid", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_CONFIG],
         { "CONFIG", "lmp_obj_config", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_HELLO],
         { "HELLO", "lmp_obj_hello", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_BEGIN_VERIFY],
         { "BEGIN_VERIFY", "lmp_obj_begin_verify", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_BEGIN_VERIFY_ACK],
         { "BEGIN_VERIFY_ACK", "lmp_obj_begin_verify_ack", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_VERIFY_ID],
         { "VERIFY_ID", "lmp_obj_verifyid", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_TE_LINK],
         { "TE_LINK", "lmp_obj_te_link", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CLASS_DATA_LINK],
         { "DATA_LINK", "lmp_obj_data_link", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_CHANNEL_STATUS],
         { "CHANNEL_STATUS", "lmp_obj_channel_status", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_CHANNEL_STATUS_REQUEST],
         { "CHANNEL_STATUS_REQUEST", "lmp_obj_channel_status_request", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_ERROR],
         { "ERROR", "lmp_obj_error", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_TRACE],
         { "TRACE", "lmp_obj_trace", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_TRACE_REQ],
         { "TRACE REQ", "lmp_obj_trace_req", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_SERVICE_CONFIG],
         { "SERVICE_CONFIG", "lmp_obj_serviceconfig", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_DA_DCN_ADDRESS],
         { "DA_DCN_ADDRESS", "lmp_obj_dadcnaddr", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_CLASS_LOCAL_LAD_INFO],
         { "LOCAL_LAD_INFO", "lmp_obj_localladinfo", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        /* Other LMP Value Filters ------------------------------ */

        {&hf_lmp_filter[LMPF_VAL_CTYPE],
         { "Object C-Type", "lmp_obj_ctype", FT_UINT8, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_LOCAL_CCID],
         { "Local CCID Value", "lmp_local_ccid", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_CCID],
         { "Remote CCID Value", "lmp_remote_ccid", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_LOCAL_NODE_ID],
         { "Local Node ID Value", "lmp_local_nodeid", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_NODE_ID],
         { "Remote Node ID Value", "lmp_remote_nodeid", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_LOCAL_LINK_ID_IPV4],
         { "Local Link ID - IPv4", "lmp_local_linkid_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LINK_ID_IPV6],
         { "Local Link ID - IPv6", "lmp_local_linkid_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LINK_ID_UNNUM],
         { "Local Link ID - Unnumbered", "lmp_local_linkid_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_LINK_ID_IPV4],
         { "Remote Link ID - IPv4", "lmp_remote_linkid_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_LINK_ID_IPV6],
         { "Remote Link ID - IPv6", "lmp_remote_linkid_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_LINK_ID_UNNUM],
         { "Remote Link ID - Unnumbered", "lmp_remote_linkid_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_LOCAL_INTERFACE_ID_IPV4],
         { "Local Interface ID - IPv4", "lmp_local_interfaceid_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_INTERFACE_ID_IPV6],
         { "Local Interface ID - IPv6", "lmp_local_interfaceid_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_INTERFACE_ID_UNNUM],
         { "Local Interface ID - Unnumbered", "lmp_local_interfaceid_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_INTERFACE_ID_IPV4],
         { "Remote Interface ID - IPv4", "lmp_remote_interfaceid_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_INTERFACE_ID_IPV6],
         { "Remote Interface ID - IPv6", "lmp_remote_interfaceid_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_INTERFACE_ID_UNNUM],
         { "Remote Interface ID - Unnumbered", "lmp_remote_interfaceid_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_CHANNEL_STATUS_INTERFACE_ID_IPV4],
         { "Interface ID: IPv4", "lmp_channel_status_interfaceid_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_CHANNEL_STATUS_INTERFACE_ID_IPV6],
         { "Interface ID: IPv6", "lmp_channel_status_interfaceid_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_CHANNEL_STATUS_INTERFACE_ID_UNNUM],
         { "Interface ID: Unnumbered", "lmp_channel_status_interfaceid_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_MESSAGE_ID],
         { "Message-ID Value", "lmp_messageid", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_MESSAGE_ID_ACK],
         { "Message-ID Ack Value", "lmp_messageid_ack", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_CONFIG_HELLO],
         { "HelloInterval", "lmp_hellointerval", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_CONFIG_HELLO_DEAD],
         { "HelloDeadInterval", "lmp_hellodeadinterval", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_HELLO_TXSEQ],
         { "TxSeqNum", "lmp_txseqnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_HELLO_RXSEQ],
         { "RxSeqNum", "lmp_rxseqnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_BEGIN_VERIFY_FLAGS],
         { "Flags", "lmp_begin_verify_flags", FT_UINT16, BASE_HEX, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_BEGIN_VERIFY_FLAGS_ALL_LINKS],
         { "Verify All Links", "lmp_begin_verify_all_links",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_BEGIN_VERIFY_FLAGS_LINK_TYPE],
         { "Data Link Type", "lmp_begin_verify_link_type",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_BEGIN_VERIFY_ENCTYPE],
         { "Encoding Type", "lmp_begin_verify_enctype",
           FT_UINT8, BASE_DEC|BASE_RANGE_STRING, RVALS(gmpls_lsp_enc_rvals), 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_VERIFY_ID],
         { "Verify-ID", "lmp_verifyid", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_TE_LINK_FLAGS],
         { "TE-Link Flags", "lmp_te_link_flags", FT_UINT8, BASE_HEX, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_FLAGS_FAULT_MGMT],
         { "Fault Management Supported", "lmp_te_link_fault_mgmt",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_FLAGS_LINK_VERIFY],
         { "Link Verification Supported", "lmp_te_link_link_verify",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_LOCAL_IPV4],
         { "TE-Link Local ID - IPv4", "lmp_te_link_local_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_LOCAL_IPV6],
         { "TE-Link Local ID - IPv6", "lmp_te_link_local_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_LOCAL_UNNUM],
         { "TE-Link Local ID - Unnumbered", "lmp_te_link_local_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_REMOTE_IPV4],
         { "TE-Link Remote ID - IPv4", "lmp_te_link_remote_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_REMOTE_IPV6],
         { "TE-Link Remote ID - IPv6", "lmp_te_link_remote_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TE_LINK_REMOTE_UNNUM],
         { "TE-Link Remote ID - Unnumbered", "lmp_te_link_remote_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_FLAGS],
         { "Data-Link Flags", "lmp_data_link_flags", FT_UINT8, BASE_HEX, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_FLAGS_PORT],
         { "Data-Link is Individual Port", "lmp_data_link_port",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_FLAGS_ALLOCATED],
         { "Data-Link is Allocated", "lmp_data_link_link_verify",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_LOCAL_IPV4],
         { "Data-Link Local ID - IPv4", "lmp_data_link_local_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_LOCAL_UNNUM],
         { "Data-Link Local ID - Unnumbered", "lmp_data_link_local_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_REMOTE_IPV4],
         { "Data-Link Remote ID - IPv4", "lmp_data_link_remote_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_REMOTE_UNNUM],
         { "Data-Link Remote ID - Unnumbered", "lmp_data_link_remote_unnum", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_SUBOBJ],
         { "Subobject", "lmp_data_link_subobj", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_SUBOBJ_SWITCHING_TYPE],
         { "Interface Switching Capability", "lmp_data_link_switching", FT_UINT8, BASE_DEC|BASE_RANGE_STRING,
           RVALS(gmpls_switching_type_rvals), 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_DATA_LINK_SUBOBJ_LSP_ENCODING],
         { "LSP Encoding Type", "lmp_data_link_encoding", FT_UINT8, BASE_DEC|BASE_RANGE_STRING,
           RVALS(gmpls_lsp_enc_rvals), 0x0, NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_ERROR],
         { "Error Code", "lmp_error", FT_UINT32, BASE_HEX, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_ERROR_VERIFY_UNSUPPORTED_LINK],
         { "Verification - Unsupported for this TE-Link", "lmp_error_verify_unsupported_link",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_VERIFY_UNWILLING],
         { "Verification - Unwilling to Verify at this time", "lmp_error_verify_unwilling",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_VERIFY_TRANSPORT],
         { "Verification - Transport Unsupported", "lmp_error_verify_unsupported_transport",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_VERIFY_TE_LINK_ID],
         { "Verification - TE Link ID Configuration Error", "lmp_error_verify_te_link_id",
           FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_ERROR_VERIFY_UNKNOWN_CTYPE],
         { "Verification - Unknown Object C-Type", "lmp_error_verify_unknown_ctype",
           FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_BAD_PARAMETERS],
         { "Summary - Unacceptable non-negotiable parameters", "lmp_error_summary_bad_params",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_RENEGOTIATE],
         { "Summary - Renegotiate Parameter", "lmp_error_summary_renegotiate",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_BAD_TE_LINK],
         { "Summary - Bad TE Link Object", "lmp_error_summary_bad_te_link",
           FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_BAD_DATA_LINK],
         { "Summary - Bad Data Link Object", "lmp_error_summary_bad_data_link",
           FT_BOOLEAN, 8, NULL, 0x10, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_UNKNOWN_TEL_CTYPE],
         { "Summary - Bad TE Link C-Type", "lmp_error_summary_unknown_tel_ctype",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_UNKNOWN_DL_CTYPE],
         { "Summary - Bad Data Link C-Type", "lmp_error_summary_unknown_dl_ctype",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_SUMMARY_BAD_REMOTE_LINK_ID],
         { "Summary - Bad Remote Link ID", "lmp_error_summary_bad_remote_link_id",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_CONFIG_BAD_PARAMETERS],
         { "Config - Unacceptable non-negotiable parameters", "lmp_error_config_bad_params",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_CONFIG_RENEGOTIATE],
         { "Config - Renegotiate Parameter", "lmp_error_config_renegotiate",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_CONFIG_BAD_CCID],
         { "Config - Bad CC ID", "lmp_error_config_bad_ccid",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_TRACE_UNSUPPORTED_TYPE],
         { "Trace - Unsupported trace type", "lmp_error_trace_unsupported_type",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_TRACE_INVALID_MSG],
         { "Trace - Invalid Trace Message", "lmp_error_trace_invalid_msg",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_TRACE_UNKNOWN_CTYPE],
         { "Trace - Unknown Object C-Type", "lmp_error_trace_unknown_ctype",
           FT_BOOLEAN, 8, NULL, 0x10, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_LAD_AREA_ID_MISMATCH],
         { "LAD - Domain Routing Area ID Mismatch detected", "lmp_error_lad_area_id_mismatch",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_LAD_TCP_ID_MISMATCH],
         { "LAD - TCP ID Mismatch detected", "lmp_error_lad_tcp_id_mismatch",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_LAD_DA_DCN_MISMATCH],
         { "LAD - DA DCN Mismatch detected", "lmp_error_lad_da_dcn_mismatch",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_LAD_CAPABILITY_MISMATCH],
         { "LAD - Capability Mismatch detected", "lmp_error_lad_capability_mismatch",
           FT_BOOLEAN, 8, NULL, 0x08, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_ERROR_LAD_UNKNOWN_CTYPE],
         { "LAD - Unknown Object C-Type", "lmp_error_lad_unknown_ctype",
           FT_BOOLEAN, 8, NULL, 0x10, NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_TRACE_LOCAL_TYPE],
         { "Local Trace Type", "lmp_trace_local_type", FT_UINT16, BASE_DEC,
           VALS(lmp_trace_type_str), 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TRACE_LOCAL_LEN],
         { "Local Trace Length", "lmp_trace_local_length", FT_UINT16, BASE_DEC,
           NULL, 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TRACE_LOCAL_MSG],
         { "Local Trace Message", "lmp_trace_local_msg", FT_STRING, BASE_NONE,
           NULL, 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TRACE_REMOTE_TYPE],
         { "Remote Trace Type", "lmp_trace_remote_type", FT_UINT16, BASE_DEC,
           VALS(lmp_trace_type_str), 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TRACE_REMOTE_LEN],
         { "Remote Trace Length", "lmp_trace_remote_length", FT_UINT16, BASE_DEC,
           NULL, 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_TRACE_REMOTE_MSG],
         { "Remote Trace Message", "lmp_trace_remote_msg", FT_STRING, BASE_NONE,
           NULL, 0x0, NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_TRACE_REQ_TYPE],
         { "Trace Type", "lmp_trace_req_type", FT_UINT16, BASE_DEC,
           VALS(lmp_trace_type_str), 0x0, NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_SP_FLAGS],
         { "Service Config - Supported Signalling Protocols",
           "lmp_service_config_sp", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_SP_FLAGS_RSVP],
         { "RSVP is supported", "lmp_service_config_sp_rsvp",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_SP_FLAGS_LDP],
         { "LDP is supported", "lmp_service_config_sp_ldp",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_TP_FLAGS],
         { "Client Port Service Attributes", "lmp_service_config_cpsa",
           FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_TP_FLAGS_PATH_OVERHEAD],
         { "Path/VC Overhead Transparency Supported",
           "lmp_service_config_cpsa_path_overhead",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_TP_FLAGS_LINE_OVERHEAD],
         { "Line/MS Overhead Transparency Supported",
           "lmp_service_config_cpsa_line_overhead",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_TP_FLAGS_SECTION_OVERHEAD],
         { "Section/RS Overhead Transparency Supported",
           "lmp_service_config_cpsa_section_overhead",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_CCT_FLAGS],
         { "Contiguous Concatenation Types", "lmp_service_config_cct",
           FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL}},
        ...
        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_MIN_NCC],
         { "Minimum Number of Contiguously Concatenated Components",
           "lmp_service_config_cpsa_min_ncc",
           FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_MAX_NCC],
         { "Maximum Number of Contiguously Concatenated Components",
           "lmp_service_config_cpsa_max_ncc",
           FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_MIN_NVC],
         { "Maximum Number of Contiguously Concatenated Components",
           "lmp_service_config_cpsa_min_nvc",
           FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_MAX_NVC],
         { "Minimum Number of Virtually Concatenated Components",
           "lmp_service_config_cpsa_max_nvc",
           FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_CPSA_INTERFACE_ID],
         { "Local interface id of the client interface referred to",
           "lmp_service_config_cpsa_local_ifid",
           FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_TRANSPARENCY_FLAGS],
         { "Network Transparency Flags",
           "lmp_service_config_nsa_transparency",
           FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_TRANSPARENCY_FLAGS_SOH],
         { "Standard SOH/RSOH transparency supported",
           "lmp_service_config_nsa_transparency_soh",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_TRANSPARENCY_FLAGS_LOH],
         { "Standard LOH/MSOH transparency supported",
           "lmp_service_config_nsa_transparency_loh",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_TCM_FLAGS],
         { "TCM Monitoring",
           "lmp_service_config_nsa_tcm",
           FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_TCM_FLAGS_TCM_SUPPORTED],
         { "TCM Monitoring Supported",
           "lmp_service_config_nsa_transparency_tcm",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_NETWORK_DIVERSITY_FLAGS],
         { "Network Diversity Flags",
           "lmp_service_config_nsa_diversity",
           FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_NETWORK_DIVERSITY_FLAGS_NODE],
         { "Node diversity supported",
           "lmp_service_config_nsa_diversity_node",
           FT_BOOLEAN, 8, NULL, 0x01, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_NETWORK_DIVERSITY_FLAGS_LINK],
         { "Link diversity supported",
           "lmp_service_config_nsa_diversity_link",
           FT_BOOLEAN, 8, NULL, 0x02, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_SERVICE_CONFIG_NSA_NETWORK_DIVERSITY_FLAGS_SRLG],
         { "SRLG diversity supported",
           "lmp_service_config_nsa_diversity_srlg",
           FT_BOOLEAN, 8, NULL, 0x04, NULL, HFILL}},

        {&hf_lmp_filter[LMPF_VAL_LOCAL_DA_DCN_ADDR],
         { "Local DA DCN Address", "lmp_local_da_dcn_addr", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_REMOTE_DA_DCN_ADDR],
         { "Remote DA DCN Address", "lmp_remote_da_dcn_addr", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

        {&hf_lmp_filter[LMPF_VAL_LOCAL_LAD_INFO_NODE_ID],
         { "Node ID", "lmp_local_lad_node_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LAD_INFO_AREA_ID],
         { "Area ID", "lmp_local_lad_area_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LAD_INFO_TE_LINK_ID],
         { "TE Link ID", "lmp_local_lad_telink_id", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LAD_INFO_COMPONENT_ID],
         { "Component Link ID", "lmp_local_lad_comp_id", FT_UINT32, BASE_DEC, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LAD_INFO_SC_PC_ID],
         { "SC PC ID", "lmp_local_lad_sc_pc_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LOCAL_LAD_INFO_SC_PC_ADDR],
         { "SC PC Address", "lmp_local_lad_sc_pc_addr", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ],
         { "Subobject", "lmp_lad_info_subobj", FT_NONE, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_PRI_AREA_ID],
         { "SC PC Address", "lmp_lad_pri_area_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_PRI_RC_PC_ID],
         { "SC PC Address", "lmp_lad_pri_rc_pc_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_PRI_RC_PC_ADDR],
         { "SC PC Address", "lmp_lad_pri_rc_pc_addr", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_SEC_AREA_ID],
         { "SC PC Address", "lmp_lad_sec_area_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_SEC_RC_PC_ID],
         { "SC PC Address", "lmp_lad_sec_rc_pc_id", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_SEC_RC_PC_ADDR],
         { "SC PC Address", "lmp_lad_sec_rc_pc_addr", FT_IPv4, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_SWITCHING_TYPE],
         { "Interface Switching Capability", "lmp_lad_switching", FT_UINT8, BASE_DEC|BASE_RANGE_STRING,
           RVALS(gmpls_switching_type_rvals), 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_VAL_LAD_INFO_SUBOBJ_LSP_ENCODING],
         { "LSP Encoding Type", "lmp_lad_encoding", FT_UINT8, BASE_DEC|BASE_RANGE_STRING,
           RVALS(gmpls_lsp_enc_rvals), 0x0, NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CHECKSUM],
         { "Message Checksum", "lmp_checksum", FT_UINT16, BASE_HEX, NULL, 0x0,
           NULL, HFILL }},
        {&hf_lmp_filter[LMPF_CHECKSUM_STATUS],
         { "Checksum Status", "lmp_checksum_status", FT_UINT8, BASE_NONE, VALS(proto_checksum_vals), 0x0,
           NULL, HFILL }},
        {&hf_lmp_data,
         { "Data", "lmp_data", FT_BYTES, BASE_NONE, NULL, 0x0,
           NULL, HFILL }},

      /* Generated from convert_proto_tree_add_text.pl */
      { &hf_lmp_version, { "LMP Version", "lmp_version", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_header_flags, { "Flags", "lmp_header_flags", FT_UINT8, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_header_length, { "Length", "lmp_header_length", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_byte_bytes, 0x0, NULL, HFILL }},
      { &hf_lmp_negotiable, { "Negotiable", "lmp_negotiable", FT_BOOLEAN, 8, TFS(&tfs_yes_no), 0x80, NULL, HFILL }},
      { &hf_lmp_object_length, { "Length", "lmp_object_length", FT_UINT16, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_object_class, { "Object Class", "lmp_object_class", FT_UINT8, BASE_DEC, VALS(lmp_class_vals), 0x0, NULL, HFILL }},
      { &hf_lmp_verify_interval, { "Verify Interval", "lmp_verify_interval", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_milliseconds, 0x0, NULL, HFILL }},
      { &hf_lmp_number_of_data_links, { "Number of Data Links", "lmp_number_of_data_links", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_verify_transport_mechanism, { "Verify Transport Mechanism", "lmp_verify_transport_mechanism", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_transmission_rate, { "Transmission Rate", "lmp_transmission_rate", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_wavelength, { "Wavelength", "lmp_wavelength", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_verifydeadinterval, { "VerifyDeadInterval", "lmp_verifydeadinterval", FT_UINT16, BASE_DEC|BASE_UNIT_STRING, &units_milliseconds, 0x0, NULL, HFILL }},
      { &hf_lmp_verify_transport_response, { "Verify Transport Response", "lmp_verify_transport_response", FT_UINT16, BASE_HEX, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_data_link_local_id_ipv6, { "Data-Link Local ID - IPv6", "lmp_data_link_local_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_data_link_remote_id_ipv6, { "Data-Link Remote ID - IPv6", "lmp_data_link_remote_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_subobject_type, { "Subobject Type", "lmp_subobject_type", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_subobject_length, { "Subobject Length", "lmp_subobject_length", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_minimum_reservable_bandwidth, { "Minimum Reservable Bandwidth", "lmp_minimum_reservable_bandwidth", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_maximum_reservable_bandwidth, { "Maximum Reservable Bandwidth", "lmp_maximum_reservable_bandwidth", FT_FLOAT, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_interface_id_ipv4, { "Interface ID - IPv4", "lmp_interface_id_ipv4", FT_IPv4, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_interface_id_ipv6, { "Interface ID - IPv6", "lmp_interface_id_ipv6", FT_IPv6, BASE_NONE, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_interface_id_unnumbered, { "Interface ID - Unnumbered", "lmp_interface_id_id_unnumbered", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_link, { "Link", "lmp_link", FT_BOOLEAN, 32, TFS(&tfs_active_monitoring_not_allocated), 0x80000000, NULL, HFILL }},
      { &hf_lmp_channel_status, { "Channel Status", "lmp_channel_status", FT_UINT32, BASE_DEC, VALS(channel_status_str), 0x7fffffff, NULL, HFILL }},
      { &hf_lmp_uni_version, { "UNI Version", "lmp_uni_version", FT_UINT8, BASE_DEC, NULL, 0x0, NULL, HFILL }},
      { &hf_lmp_link_type, { "Link Type", "lmp_link_type", FT_UINT8, BASE_DEC, VALS(service_attribute_link_type_str), 0x0, NULL, HFILL }},
      { &hf_lmp_signal_types_sdh, { "Signal Types", "lmp_signal_types", FT_UINT8, BASE_DEC, VALS(service_attribute_signal_types_sdh_str), 0x0, NULL, HFILL }},
      { &hf_lmp_signal_types_sonet, { "Signal Types", "lmp_signal_types", FT_UINT8, BASE_DEC, VALS(service_attribute_signal_types_sonet_str), 0x0, NULL, HFILL }},
      { &hf_lmp_free_timeslots, { "Free timeslots", "lmp_free_timeslots", FT_UINT24, BASE_DEC, NULL, 0x0, NULL, HFILL }},
    };
