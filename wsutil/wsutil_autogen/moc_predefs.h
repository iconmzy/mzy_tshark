...
#define EXTCAP_DIR "/usr/local/lib64/wireshark/extcap"
...
#define PLUGIN_DIR "/usr/local/lib64/wireshark/plugins"
...
#define DATA_DIR "/usr/local/share/wireshark"
#define _STDC_PREDEF_H 1
#define __GCC_ATOMIC_INT_LOCK_FREE 2
#define wsutil_EXPORTS 1
